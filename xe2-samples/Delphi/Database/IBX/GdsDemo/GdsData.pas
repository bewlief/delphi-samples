...
uses
  ...
  DBCtrls, GdsStd, IBDatabase, IBCustomDataSet, IBTable;
...
type
  TStdDataForm = class(TGDSStdForm)
    ...
    PriorBtn: TButton;
    Orders: TIBTable;
    IBTable1ORDERNO: TFloatField;
    IBTable1CUSTNO: TFloatField;
    IBTable1SALEDATE: TDateTimeField;
    IBTable1SHIPDATE: TDateTimeField;
    IBTable1EMPNO: TIntegerField;
    IBTable1SHIPTOCONTACT: TIBStringField;
    IBTable1SHIPTOADDR1: TIBStringField;
    IBTable1SHIPTOADDR2: TIBStringField;
    IBTable1SHIPTOCITY: TIBStringField;
    IBTable1SHIPTOSTATE: TIBStringField;
    IBTable1SHIPTOZIP: TIBStringField;
    IBTable1SHIPTOCOUNTRY: TIBStringField;
    IBTable1SHIPTOPHONE: TIBStringField;
    IBTable1SHIPVIA: TIBStringField;
    IBTable1PO: TIBStringField;
    IBTable1TERMS: TIBStringField;
    IBTable1PAYMENTMETHOD: TIBStringField;
    IBTable1ITEMSTOTAL: TFloatField;
    IBTable1TAXRATE: TFloatField;
    IBTable1FREIGHT: TFloatField;
    IBTable1AMOUNTPAID: TFloatField;
