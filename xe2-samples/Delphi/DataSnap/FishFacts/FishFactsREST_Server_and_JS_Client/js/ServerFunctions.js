...
function TFishFactsServerMethods(connectionInfo)
{
  this.executor = new ServerFunctionExecutor("TFishFactsServerMethods",connectionInfo);
  ...
  this.GetKeys = function() {
    var returnObject = this.executor.executeMethod('GetKeys', "GET", [], arguments[0], true, arguments[1], arguments[2]);
    if (arguments[0] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetKeys_URL = function() {
    return this.executor.getMethodURL("GetKeys", "GET", [], arguments[0])[0];
  };

  /*
   * @param Key [in] - Type on server: string
   * @return result - Type on server: TStream
   */
  this.GetImage = function(Key) {
    var returnObject = this.executor.executeMethod('GetImage', "GET", [Key], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
  ...
  this.GetImage_URL = function(Key) {
    return this.executor.getMethodURL("GetImage", "GET", [Key], arguments[1])[0];
  };

  /*
   * @param AKey [in] - Type on server: string
   * @param ASpeciesName [out] - Type on server: string
   * @param ACategory [out] - Type on server: string
   * @param ACommonName [out] - Type on server: string
   * @param ALengthIn [out] - Type on server: Double
   * @param ALengthCm [out] - Type on server: Double
   * @return result - Type on server: Boolean
   */
  this.GetFacts = function(AKey) {
    var returnObject = this.executor.executeMethod('GetFacts', "GET", [AKey], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.AKey = AKey;
        resultObject.ASpeciesName = resultArray[0];
        resultObject.ACategory = resultArray[1];
        resultObject.ACommonName = resultArray[2];
        resultObject.ALengthIn = resultArray[3];
        resultObject.ALengthCm = resultArray[4];
        resultObject.result = resultArray[5];
        return resultObject;
      }
      return returnObject;
    }
  ...
  this.GetFacts_URL = function(AKey) {
    return this.executor.getMethodURL("GetFacts", "GET", [AKey], arguments[1])[0];
  };

  /*
   * @param AKey [in] - Type on server: string
   * @param ANotes [out] - Type on server: string
   * @return result - Type on server: Boolean
   */
  this.GetNotes = function(AKey) {
    var returnObject = this.executor.executeMethod('GetNotes', "GET", [AKey], arguments[1], true, arguments[2], arguments[3]);
    if (arguments[1] == null) {
      if (returnObject != null && returnObject.result != null && isArray(returnObject.result)) {
        var resultArray = returnObject.result;
        var resultObject = new Object();
        resultObject.AKey = AKey;
        resultObject.ANotes = resultArray[0];
        resultObject.result = resultArray[1];
        return resultObject;
      }
      return returnObject;
  ...
  this.GetNotes_URL = function(AKey) {
    return this.executor.getMethodURL("GetNotes", "GET", [AKey], arguments[1])[0];
  };
}
...
var JSProxyClassList = {
  ...
  "TFishFactsServerMethods": ["ReverseString","GetKeys","GetImage","GetFacts","GetNotes"]
};
