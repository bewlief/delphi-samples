...
type
  ...
  public
    ...
    procedure Logout;
    function LoginUser(UserName: string; var ReturnMessage: string; const ARequestFilter: string = ''): Boolean;
...
const
  ...
  (
    ...
    (Name: 'ReturnMessage'; Direction: 3; DBXType: 26; TypeName: 'string'),
...
function TCompanyTweetClient.LoginUser(UserName: string; var ReturnMessage: string; const ARequestFilter: string): Boolean;
begin
  ...
  FLoginUserCommand.Parameters[1].Value.SetWideString(ReturnMessage);
