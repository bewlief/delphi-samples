...
uses
  ...
  FMX.Dialogs, System.Rtti, FMX.Edit,
...
begin
  BindScopeDB1.DataSource.DataSet.Next;
end;

procedure TForm1.ButtonPriorClick(Sender: TObject);
begin
  BindScopeDB1.DataSource.DataSet.Prior;
end;
...
begin
  ...
  try
    ...
    ButtonPrior.Enabled := not BindScopeDB1.DataSource.DataSet.BOF;
    ButtonNext.Enabled := not BindScopeDB1.DataSource.DataSet.EOF;
