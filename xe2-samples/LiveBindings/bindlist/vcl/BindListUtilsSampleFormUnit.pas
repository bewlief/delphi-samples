...
// Fill from a TBindScopeDB.  Scope is TDataSet.
...
begin
  ...
  FillList(ComboBox1, 'Text', BindScopeDB1, 'Category.AsString + " - " +  Common_Name.AsString');
end;
...
// Fill from TBindScopeDB.  Scope is TField.
...
// Fill from TBindScopeDB using multiple binding expressions.  Scope is TDataSet.
