...
begin
  ...
  try
    ...
    if Assigned(Reader) then
       TDBXDataSetReader.CopyReaderToClientDataSet(Reader, CDSCountry);
...
begin
  ...
  try
    Reader := Cs.GetRegion;
    if Assigned(Reader) then
       TDBXDataSetReader.CopyReaderToClientDataSet(Reader, CDSRegion);
...
begin
  ...
  try
    Reader := Cs.GetState;
    if Assigned(Reader) then
       TDBXDataSetReader.CopyReaderToClientDataSet(Reader, CDSState);
