...
uses SysUtils, Classes, DSCommonServer, DSTCPServerTransport, DSServer,
  ...
  DBXCommon, DSHTTPCommon, DSHTTP, IdHTTPWebBrokerBridge, DSAuth, DSService,
  IndyPeerImpl, Datasnap.DSClientMetadata;
...
begin
  DataSnap_Server_Log.Params.Values['Database'] := GetDatabaseDirectory
    + DB_NAME;
  Employee.Params.Values['Database'] := GetDatabaseDirectory + DBEMPLOYEE_NAME;
