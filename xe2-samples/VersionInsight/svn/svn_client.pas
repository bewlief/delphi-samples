...
{******************************************************************************}
{                                                                              }
{ This unit contains import declarations for libsvn_client.dll,                }
{ Subversion 1.5.0 DLL.                                                        }
{                                                                              }
{******************************************************************************}
...
const
  ...
  sLibSvnDeltaDll = 'libsvn_delta-1.dll';
  sLibSvnDiffDll = 'libsvn_diff-1.dll';
  sLibSvnFsDll = 'libsvn_fs-1.dll';
  sLibSvnRaDll = 'libsvn_ra-1.dll';
  sLibSvnReposDll = 'libsvn_repos-1.dll';
  sLibSvnSubrDll = 'libsvn_subr-1.dll';
  sLibSvnWcDll = 'libsvn_wc-1.dll';
...
var
  ...
  svn_string_find_char_backward: function(str: PSvnString; ch: AnsiChar): TAprSize; cdecl;
  ...
  svn_stringbuf_find_char_backward: function(str: PSvnStringBuf; ch: AnsiChar): TAprSize; cdecl;
...
var
  ...
  svn_io_file_getc: function(out ch: AnsiChar; afile: PAprFile; pool: PAprPool): PSvnError; cdecl;
...
type
  ...
  TSvnAuthSSLClientCertPwPromptFunc = function(out cred: PSvnAuthCredSSLClientCertPw; baton: Pointer; realm: PAnsiChar;
    may_save: TSvnBoolean; pool: PAprPool): PSvnError; cdecl;
  TSvnAuthPlaintextPromptFunc = function(out MaySavePlainText: TSVNBoolean; realm: PAnsiChar; baton: Pointer;
    pool: PAprPool): PSvnError; cdecl;
...
var
  ...
  svn_auth_get_platform_specific_provider: function(out provider: PSvnAuthProviderObject;
    provider_name: PAnsiChar; provider_type: PAnsiChar; pool: PAprPool): PSvnError; cdecl;
  ...
  svn_auth_get_simple_provider2: procedure (out provider: PSvnAuthProviderObject;
    plaintext_prompt_func: TSvnAuthPlaintextPromptFunc; prompt_baton: Pointer; pool: PAprPool); cdecl;
  ...
  svn_auth_get_platform_specific_client_providers: function(out provider: PSvnAuthProviderObject;
    SvnConfig:PSvnConfig; pool: PAprPool): PSvnError; cdecl;
...
function LoadSvnClientLib(const FileName: string = ''; const PathName: string = ''): Boolean;
function LoadSvnDeltaLib(const FileName: string = ''; const PathName: string = ''): Boolean;
function LoadSvnDiffLib(const FileName: string = ''; const PathName: string = ''): Boolean;
function LoadSvnFsLib(const FileName: string = ''; const PathName: string = ''): Boolean;
function LoadSvnRaLib(const FileName: string = ''; const PathName: string = ''): Boolean;
function LoadSvnReposLib(const FileName: string = ''; const PathName: string = ''): Boolean;
function LoadSvnSubrLib(const FileName: string = ''; const PathName: string = ''): Boolean;
function LoadSvnWcLib(const FileName: string = ''; const PathName: string = ''): Boolean;
...
function BuildFileName(const BaseFileName, FileName, Path: string): string;
begin
    if FileName = '' then
      Result := BaseFileName
    else
...
begin
  ...
  if Result then
  begin
    SvnClientLib := LoadDll(sLibSvnClientDll, FileName, PathName);
...
begin
  ...
  if Result then
  begin
    SvnDeltaLib := LoadDll(sLibSvnDeltaDll, FileName, PathName);
...
begin
  ...
  if Result then
  begin
    SvnDiffLib := LoadDll(sLibSvnDiffDll, FileName, PathName);
    Result := SvnDiffLib <> 0;
    if not Result then
...
begin
  ...
  if Result then
  begin
    SvnFsLib := LoadDll(sLibSvnFsDll, FileName, PathName);
    Result := SvnFsLib <> 0;
    if not Result then
...
begin
  ...
  if Result then
  begin
    SvnRaLib := LoadDll(sLibSvnRaDll, FileName, PathName);
    Result := SvnRaLib <> 0;
    if not Result then
...
begin
  ...
  if Result then
  begin
    SvnReposLib := LoadDll(sLibSvnReposDll, FileName, PathName);
...
begin
  ...
  if Result then
  begin
    SvnSubrLib := LoadDll(sLibSvnSubrDll, FileName, PathName);
    Result := SvnSubrLib <> 0;
    if not Result then
    ...
    begin
      ...
      @svn_auth_get_simple_provider2 := GetProcAddress(SvnSubrLib, 'svn_auth_get_simple_provider2');
      ...
      @svn_auth_get_platform_specific_client_providers := GetProcAddress(SvnSubrLib, 'svn_auth_get_platform_specific_client_providers');
      ...
      @svn_auth_get_platform_specific_provider := GetProcAddress(SvnSubrLib, 'svn_auth_get_platform_specific_provider');
...
begin
  ...
  if Result then
  begin
    SvnWcLib := LoadDll(sLibSvnWcDll, FileName, PathName);
    Result := SvnWcLib <> 0;
    if not Result then
...
begin
  ...
  @svn_auth_get_simple_provider2 := nil;
  ...
  @svn_auth_get_platform_specific_client_providers := nil;
  ...
  @svn_auth_get_platform_specific_provider := nil;
