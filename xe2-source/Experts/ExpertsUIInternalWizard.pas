...
type
  ...
  IPageMrWizardImage = interface
  ['{6B5D8B03-6C84-4276-92A0-6F76D50E8315}']
    function GetImage: TBitmap;
    function LoadImage: TBitmap;
  end;

  TCustomPageMrWizard = class(TInterfacedObject, IMrWizard, IPageMrWizardImage)
  strict private
    { Wizard Info }
    FWizard: IWizard;
  ...
  TCustomMrWizardPage = class(TWizardPage, IWizardPage, IWizardPageEvents)
  private
    FID: TGuid;
    { IWizardPage }
...
begin
  ...
  begin
    ...
    Wizard.Finish := LPageIndex = LPageCount;
  end;
end;
...
var
  Intf: IPageMrWizardImage;
begin
  if Supports(Wizard.MrWizard, IPageMrWizardImage, Intf) then
...
begin
  ...
  Wizard.Finish := not HasSelectablePages;
  Wizard.Cancel := True;
