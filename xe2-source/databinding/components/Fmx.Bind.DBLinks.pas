...
uses System.SysUtils, System.Classes, Data.Bind.Components, Data.Bind.DBScope, FMX.Types, FMX.Edit, System.Bindings.Outputs,
  Data.Bind.DBLinks, Data.DB, FMX.Grid, Generics.Collections;
...
begin
  ...
  LItem := BindLink.ParseExpressions.AddExpression;
  LItem.ControlExpression := 'SelectedText(Self)';
  LItem.SourceExpression := 'Text';
...
begin
  ...
  LItem := BindLink.FormatExpressions.AddExpression;
  LItem.ControlExpression := 'Bitmap';
...
begin
  ...
  LItem := BindLink.ParseExpressions.AddExpression;
  LItem.ControlExpression := 'CheckedState(Self)';
  LItem.SourceExpression := 'Text';
