...
begin
  ...
  begin
    ...
    if (CurrLength <= MinLength) and PtInRect(ARect, Crosses[Side]) then
    begin
...
begin
  ...
  begin
    ...
    Brush.Style := bsClear;
    Font.Color := Node.TextColor;
    NodeText := Node.Caption + sLineBreak + Node.Content;

    TextRect(NodeRect, NodeText, [tfCenter, tfWordBreak]);
  end;
end;
