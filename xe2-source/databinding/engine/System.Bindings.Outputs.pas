...
type
  ...
  public
    ...
    property ConvertProc: TConvertProc read FConvertProc;
  ...
  public
    ...
    function GetConverter(AFrom, ATo: PTypeInfo; FindBestMatch: Boolean = True): TConvertProc;
    ...
    try
      ...
      try
        ...
        try
          ...
          if (LocationRec.Location.GetType <> nil) and (LocationRec.Location.GetType.Kind = tkClass) then
          begin
...
function TValueRefConverter.GetConverter(AFrom, ATo: PTypeInfo; FindBestMatch: Boolean): TConvertProc;
var
...
begin
  ...
  if FConversions.ContainsKey(TConvertPair.Create(AFrom, ATo)) then
    Exit(FConversions[TConvertPair.Create(AFrom, ATo)].ConvertProc);
        ...
        begin
          ...
          begin
            if ConvPairFromClass.InheritsFrom(BestFromClass) then
              ...
              begin
                Result := FConversions.Items[ConvPair].ConvertProc;
          ...
          Exit(FConversions.Items[ConvPair].ConvertProc);
      end;
  ...
  begin
    ...
    begin
      ...
      case TypeInf^.Kind of
        ...
        tkInteger: TypeInf := TypeInfo(Integer);
      end;
    end;
  end;
begin
...
begin
  ...
  TValueRefConverterFactory.RegisterConversion([nil], [TypeInfo(Integer), TypeInfo(Extended), TypeInfo(Single)],
    TConverterDescription.Create(
    LProc,
    sIDNilToNumber,
    sNilToNumber,
...
//  TValueRefConverterFactory.RegisterConversion(nil, TypeInfo(Extended),
//    TConverterDescription.Create(
//    LProc,
//    sIDNilToExtended,
//    sNilToExtended,
...
//  );
//
//  TValueRefConverterFactory.RegisterConversion(nil, TypeInfo(Single),
//    TConverterDescription.Create(
//    LProc,
//    sIDNilToSingle,
//    sNilToSingle,
...
//  );
  ...
  TValueRefConverterFactory.RegisterConversion(nil, TypeInfo(TDateTime),
    TConverterDescription.Create(
    LProc,
    sIDNilToTDateTime,
    sNilToTDateTime,
  ...
  TValueRefConverterFactory.RegisterConversion(TypeInfo(Int64), TypeInfo(string),
    TConverterDescription.Create(
    procedure(const I: TValue; var O: TValue)
    begin
  ...
  TValueRefConverterFactory.RegisterConversion(TypeInfo(string), TypeInfo(Integer),
    TConverterDescription.Create(
    procedure(const I: TValue; var O: TValue)
    var
      val: string;
    begin
      ...
      if val = '' then
        ...
        O := TValue.From<Integer>(StrToInt(I.AsString));
    end,
    sIDStringToInteger,
    sStringToInteger,
  ...
  LProc :=
    procedure(const I: TValue; var O: TValue)
    begin
      O := TValue.From<string>(FloatToStr(I.AsExtended));
    end;

  TValueRefConverterFactory.RegisterConversion([TypeInfo(Extended), TypeInfo(Single)], [TypeInfo(String)],
    TConverterDescription.Create(
    LProc,
    sIDFloatToString,
    sFloatToString,
  ...
  LProc :=
    procedure(const I: TValue; var O: TValue)
    begin
      O := TValue.From<Extended>(StrToFloat(I.AsString));
    end;

  TValueRefConverterFactory.RegisterConversion([TypeInfo(string)], [TypeInfo(Extended), TypeInfo(Single)],
    TConverterDescription.Create(
    LProc,
    sIDStrToFloat,
    sStrToFloat,
...
//  TValueRefConverterFactory.RegisterConversion(TypeInfo(Single), TypeInfo(String),
//    TConverterDescription.Create(
//    LProc,
//    sIDSingleToString,
//    sSingleToString,
...
//  );
  ...
  TValueRefConverterFactory.RegisterConversion(TypeInfo(TDateTime), TypeInfo(string),
    TConverterDescription.Create(
    procedure(const I: TValue; var O: TValue)
    begin
      O := TValue.From<string>(DateTimeToStr(I.AsExtended));
    end,
    sIDTDateTimeToStr,
    sTDateTimeToStr,
  ...
  TValueRefConverterFactory.RegisterConversion(TypeInfo(TDate), TypeInfo(string),
    TConverterDescription.Create(
    procedure(const I: TValue; var O: TValue)
    begin
      O := TValue.From<string>(DateToStr(I.AsExtended));
    end,
    sIDTDateToStr,
    sTDateToStr,
    '', True, sTDateToStrDesc, nil)
  );
  ...
  TValueRefConverterFactory.RegisterConversion(TypeInfo(string), TypeInfo(TDate),
    ...
    procedure(const I: TValue; var O: TValue)
    begin
      O := TValue.From<TDate>(StrToDate(I.AsString));
    end,
    sIDStrToTDate,
    sStrToTDate,
  ...
  TValueRefConverterFactory.RegisterConversion([TypeInfo(Extended), TypeInfo(Single)], [TypeInfo(Variant)],
    TConverterDescription.Create(
    LProc,
    sIDFloatToVariant,
    sFloatToVariant,
  ...
  TValueRefConverterFactory.RegisterConversion([TypeInfo(Int64)], [TypeInfo(Variant)],
    TConverterDescription.Create(
    procedure(const I: TValue; var O: TValue)
    begin
  ...
  TValueRefConverterFactory.RegisterConversion([TypeInfo(Integer)], [TypeInfo(Variant)],
    TConverterDescription.Create(
    procedure(const I: TValue; var O: TValue)
    begin
      O := TValue.From<Variant>(I.AsInt64);
