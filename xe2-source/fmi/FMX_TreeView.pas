...
uses
  ...
  FMX_Types, FMX_Layouts, FMX_ListBox, FMX_Controls;
...
{ TTreeView }
  ...
  public
    ...
    function ItemByText(const AText: WideString): TTreeViewItem;
    function ItemByPoint(const X, Y: Single): TTreeViewItem;
    function ItemByIndex(const Idx: Integer): TTreeViewItem;
...
function TCustomTreeView.ItemByText(const AText: WideString): TTreeViewItem;
var
  Item: TTreeViewItem;
  i: Integer;
begin
