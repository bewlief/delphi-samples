...
{$ENDIF}
  ...
  Vcl.ActnList, Vcl.StdCtrls, SvrHTTPIndy, Vcl.Menus, System.IniFiles,
...
uses SvrPropDlg, Winapi.ShellAPI, SvrConst, WebAppDbgAbout, SockAppReg;
...
{$IFDEF MSWINDOWS}
  FWebServer.SearchPath := '$(BDS)\source\webmidas;$(BDS)\demos\websnap\images'; // Do not localize
{$ENDIF}
  LogOn := True;
  ShowAtStartup := True;
