...
uses Winapi.Windows, Winapi.ActiveX, System.Classes, System.Win.StdVCL;
...
const
  ...
  IID_IActiveScriptParse64: TGUID = '{C7EF7658-E1EE-480E-97EA-D52CB4D76D17}';
...
// *********************************************************************//
  IActiveScriptParse64 = interface(IUnknown)
    ['{C7EF7658-E1EE-480E-97EA-D52CB4D76D17}']
    function  InitNew: HResult; stdcall;
    function  AddScriptlet(pstrDefaultName: PWideChar;
                           pstrCode: PWideChar;
                           pstrItemName: PWideChar;
                           pstrSubItemName: PWideChar;
                           pstrEventName: PWideChar;
                           pstrDelimiter: PWideChar;
                           dwSourceContextCookie: UInt64;
                           ulStartingLineNumber: LongWord;
                           dwFlags: LongWord;
                           out pBstrName: WideString;
                           out pexcepinfo: TGUID): HResult; stdcall;
    function  ParseScriptText(pstrCode: PWideChar;
                              pstrItemName: PWideChar;
