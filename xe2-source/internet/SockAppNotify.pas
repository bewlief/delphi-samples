...
uses
  System.RTLConsts, SockAppReg, System.IniFiles, IdGlobal, Winapi.Windows,
  SockConst;
...
procedure TRunningWebAppListener.OnUDPRead(AThread: TIdUDPListenerThread; AData: TBytes;
