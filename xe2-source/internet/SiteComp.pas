...
type
  ...
  ['{CAC16452-9BAD-11D4-A4F2-00C04F6BB853}']
    function GetScriptObject: IInterface; deprecated; 
  end;

  IGetScriptObjectClassKey = interface
  ['{2D98BC03-3595-424C-9F7B-6804F96EF444}']
    function GetScriptObjectClassKey: TClass; deprecated;
  end;
  ...
  ['{1EFF2C50-B384-4089-BDA2-C49399BA1CE0}']
  ...
  ['{58790FBB-D56F-4298-9B0C-C622A0D6DBAB}']
    function GetDisplayStyle(Sender: TComponent): string;
    function GetAdapterEventImage(const AComponentName, AEvent,
      ACaption: WideString): TObject;
  end;
  ...
  ['{E7F5D230-7AF9-46C8-9976-B954BD1152D8}']
...
initialization
  Web.WebCntxt.GetWebEndUserProc := GetWebEndUser;
end.
