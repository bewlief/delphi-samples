...
begin
  ...
  begin
    ...
    begin
      ...
      if PtInRect(UpdateRect, Point(OffsetLeft, OffsetTop)) or
         PtInRect(UpdateRect, Point(OffsetLeft + E.offsetWidth - TagWidth, OffsetTop + E.offsetHeight - TagHeight)) or
         PtInRect(UpdateRect, Point(OffsetLeft + E.offsetWidth - TagWidth, OffsetTop + E.offsetHeight - TagHeight + 4)) then
      begin
