...
{$ENDIF}
{$IFDEF LINUX}
{ MidComp.hpp and XMLIntf.hpp both define IXMLDocument and
  XMLDoc.hpp uses that type.
  The compiler must see XMLDoc.hpp before it sees the IXMLDocument
  introduced in this unit - otherwise, references will cause
  ambiguity errors }
(*$HPPEMIT '#include <XMLDoc.hpp>' *)
{$ENDIF}

uses System.Classes, Web.HTTPApp, Web.HTTPProd, System.Masks, WebComp;
...
{$IFDEF MSWINDOWS}
uses Winapi.Windows, Winapi.Messages, System.SysUtils, Web.WebConst ;
{$ENDIF}
{$IFDEF LINUX}
