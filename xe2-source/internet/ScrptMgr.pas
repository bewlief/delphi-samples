...
{$IFDEF MSWINDOWS}
uses System.Classes, Winapi.Messages, Web.HTTPApp, WebComp, CompProd, System.SysUtils, Data.DB, Datasnap.DBClient,
  PagItems, XMLBrokr, System.Contnrs, MidComp;
{$ENDIF}
{$IFDEF LINUX}
uses Classes, HTTPApp, WebComp, CompProd, SysUtils, DB, DBClient, PagItems, 
  XMLBrokr, Contnrs, MidComp;
{$ENDIF}
...
begin
  ...
  begin
    Result := Objects[I];
    if AnsiCompareFileName(FileName,Result.FileName) = 0 then
      Exit;
  end;
  Result := nil;
end;
