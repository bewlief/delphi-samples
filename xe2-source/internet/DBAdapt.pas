...
{$IFDEF MSWINDOWS}
uses System.Classes, Winapi.Messages, Web.HTTPApp, WebComp, Web.HTTPProd, Data.DB, SiteComp, System.SysUtils,
  WebContnrs, System.Contnrs, AdaptReq, WebAdapt;
{$ENDIF}
{$IFDEF LINUX}
...
uses System.Variants, Web.WebCntxt, AutoAdap, WebDisp, SiteConst;
...
var
  ...
  ProviderSupport2: IProviderSupport2;
...
begin
  ...
  begin
    ...
    if Result = '' then
    begin
      If Supports(DataSet, IProviderSupport2, ProviderSupport2) then 
        Result := ProviderSupport2.PSGetKeyFields
      else If Supports(DataSet, IProviderSupport, ProviderSupport) then 
...
procedure TCustomDataSetAdapter.ImplEndIterator(OwnerData: Pointer);
begin
  if (FDataSet <> nil) then
...
function TCustomDataSetAdapter.ImplStartIterator(
