...
uses
  System.Classes, System.Contnrs, SiteComp, Web.HTTPProd, Web.HTTPApp, Web.WebCntxt, WebScript;
...
uses System.SysUtils, System.Variants, SiteConst, AutoAdap;
...
begin
  if Request <> nil then
    Result := string(Request.InternalPathInfo)
  else
    Result := '';
end;
...
begin
  if Request <> nil then
    Result := string(Request.InternalScriptName)
  else
    Result := '';
end;
