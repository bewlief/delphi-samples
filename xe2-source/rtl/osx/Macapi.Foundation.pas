...
//    function initWithKey(key: NSString; ascending: Boolean; comparator: NSComparator): Pointer; cdecl; overload;
  ...
  NSStringClass = interface(NSObjectClass)
    ...
    {class} function stringWithCString(bytes: PAnsiChar): Pointer; cdecl; overload;
    {class} function stringWithCString(cString: PAnsiChar; encoding: NSStringEncoding): Pointer; cdecl; overload;
//    {class} function stringWithCString(bytes: PAnsiChar; length: NSUInteger): Pointer; cdecl; overload;
    {class} function stringWithCharacters(characters: unichar; length: NSUInteger): Pointer; cdecl;
    ...
    {class} function stringWithUTF8String(nullTerminatedCString: PAnsiChar): Pointer; cdecl;
  end;
  NSString = interface(NSObject)
    ['{510EFCC6-29A8-49B4-AC88-611C43D8D9A2}']
    function UTF8String: PAnsiChar; cdecl;
    function boolValue: Boolean; cdecl;
    function cString: PAnsiChar; cdecl;
    function cStringLength: NSUInteger; cdecl;
    function cStringUsingEncoding(encoding: NSStringEncoding): PAnsiChar; cdecl;
    ...
    function fileSystemRepresentation: PAnsiChar; cdecl;
    ...
    procedure getCString(bytes: PAnsiChar); cdecl; overload;
    procedure getCString(bytes: PAnsiChar; maxLength: NSUInteger); cdecl; overload;
    function getCString(buffer: PAnsiChar; maxLength: NSUInteger; encoding: NSStringEncoding): Boolean; cdecl; overload;
    procedure getCString(bytes: PAnsiChar; maxLength: NSUInteger; range: NSRange; remainingRange: PNSRange); cdecl; overload;
    procedure getCharacters(buffer: unichar); cdecl; overload;
    procedure getCharacters(buffer: unichar; range: NSRange); cdecl; overload;
    function getFileSystemRepresentation(cname: PAnsiChar; maxLength: NSUInteger): Boolean; cdecl;
    ...
    function initWithCString(bytes: PAnsiChar): Pointer; cdecl; overload;
    function initWithCString(nullTerminatedCString: PAnsiChar; encoding: NSStringEncoding): Pointer; cdecl; overload;
//    function initWithCString(bytes: PAnsiChar; length: NSUInteger): Pointer; cdecl; overload;
    function initWithCStringNoCopy(bytes: PAnsiChar; length: NSUInteger; freeWhenDone: Boolean): Pointer; cdecl;
    function initWithCharacters(characters: unichar; length: NSUInteger): Pointer; cdecl;
    function initWithCharactersNoCopy(characters: unichar; length: NSUInteger; freeWhenDone: Boolean): Pointer; cdecl;
    ...
    function initWithUTF8String(nullTerminatedCString: PAnsiChar): Pointer; cdecl;
    ...
    function lossyCString: PAnsiChar; cdecl;
  ...
  NSCoder = interface(NSObject)
    ...
    procedure decodeArrayOfObjCType(itemType: PAnsiChar; count: NSUInteger; at: Pointer); cdecl;
    ...
    procedure decodeValueOfObjCType(type_: PAnsiChar; at: Pointer); cdecl;
    procedure decodeValuesOfObjCTypes(decodeValuesOfObjCTypes: PAnsiChar); cdecl;
    procedure encodeArrayOfObjCType(type_: PAnsiChar; count: NSUInteger; at: Pointer); cdecl;
    ...
    procedure encodeValueOfObjCType(type_: PAnsiChar; at: Pointer); cdecl;
    procedure encodeValuesOfObjCTypes(encodeValuesOfObjCTypes: PAnsiChar); cdecl;
  ...
  NSValueClass = interface(NSObjectClass)
    ...
    {class} function value(value: Pointer; withObjCType: PAnsiChar): Pointer; cdecl;
    {class} function valueWithBytes(value: Pointer; objCType: PAnsiChar): Pointer; cdecl;
  ...
  NSValue = interface(NSObject)
    ...
    function initWithBytes(value: Pointer; objCType: PAnsiChar): Pointer; cdecl;
    function isEqualToValue(value: NSValue): Boolean; cdecl;
    function nonretainedObjectValue: Pointer; cdecl;
    function objCType: PAnsiChar; cdecl;
...
//    {class} function elementWithName(name: NSString; stringValue: NSString): Pointer; cdecl; overload;
  ...
  NSXMLNode = interface(NSObject)
    ...
    function nodesForXPath(xpath: NSString; error: NSError): NSArray; cdecl;
    function objectValue: Pointer; cdecl;
    function objectsForXQuery(xquery: NSString; constants: NSDictionary; error: NSError): NSArray; cdecl; overload;
    function objectsForXQuery(xquery: NSString; error: NSError): NSArray; cdecl; overload;
  ...
  NSFileManager = interface(NSObject)
    ...
    function fileSystemRepresentationWithPath(path: NSString): PAnsiChar; cdecl;
    ...
    function stringWithFileSystemRepresentation(str: PAnsiChar; length: NSUInteger): NSString; cdecl;
  ...
  NSXMLDocument = interface(NSXMLNode)
    ...
    function initWithContentsOfURL(url: NSURL; options: NSUInteger; error: NSError): Pointer; cdecl;
    function initWithData(data: NSData; options: NSUInteger; error: NSError): Pointer; cdecl;
    function initWithRootElement(element: NSXMLElement): Pointer; cdecl;
    function initWithXMLString(string_: NSString; options: NSUInteger; error: NSError): Pointer; cdecl;
    ...
    function objectByApplyingXSLT(xslt: NSData; arguments: NSDictionary; error: NSError): Pointer; cdecl;
    function objectByApplyingXSLTAtURL(xsltURL: NSURL; arguments: NSDictionary; error: NSError): Pointer; cdecl;
    function objectByApplyingXSLTString(xslt: NSString; arguments: NSDictionary; error: NSError): Pointer; cdecl;
    ...
    function validateAndReturnError(error: NSError): Boolean; cdecl;
...
//    function initWithName(name: NSString; stringValue: NSString): Pointer; cdecl; overload;
    function initWithXMLString(string_: NSString; error: NSError): Pointer; cdecl;
    procedure insertChild(child: NSXMLNode; atIndex: NSUInteger); cdecl;
    procedure insertChildren(children: NSArray; atIndex: NSUInteger); cdecl;
...
function NSSTR(Str: string): NSString;
begin
  Result := TNSString.Wrap(TNSString.OCClass.stringWithUTF8String(PAnsiChar(UTF8String(Str))));
end;
...
begin
  ...
  if FwkMod <> 0 then
  begin
    Obj := Pointer(GetProcAddress(FwkMod, PWideChar(ConstStr))^);
    if Obj <> nil then
