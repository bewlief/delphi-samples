...
// ===== Interface declarations =====
  ...
  NSLayoutManager = interface(NSObject)
    ...
    procedure showPackedGlyphs(glyphs: PAnsiChar; length: NSUInteger; glyphRange: NSRange; atPoint: NSPoint; font: NSFont; color: NSColor; printingAdjustment: NSSize); cdecl;
...
//    function convertFont(fontObj: NSFont; toNotHaveTrait: NSFontTraitMask): NSFont; cdecl; overload;
  ...
  NSImageRep = interface(NSObject)
    ...
    function CGImageForProposedRect(proposedDestRect: NSRect; context: NSGraphicsContext; hints: NSDictionary): CGImageRef; cdecl;
  ...
  NSSpeechSynthesizer = interface(NSObject)
    ...
    function objectForProperty(property_: NSString; error: NSError): Pointer; cdecl;
    ...
    function setObject(object_: Pointer; forProperty: NSString; error: NSError): Boolean; cdecl;
...
//    {class} function templatesWithAttributeKeyPaths(keyPaths: NSArray; inEntityDescription: NSEntityDescription): NSArray; cdecl;
  ...
  NSWorkspace = interface(NSObject)
    ...
    function launchApplicationAtURL(url: NSURL; options: NSWorkspaceLaunchOptions; configuration: NSDictionary; error: NSError): NSRunningApplication; cdecl;
    ...
    function setDesktopImageURL(url: NSURL; forScreen: NSScreen; options: NSDictionary; error: NSError): Boolean; cdecl;
    ...
    function typeOfFile(absoluteFilePath: NSString; error: NSError): NSString; cdecl;
    function unmountAndEjectDeviceAtPath(path: NSString): Boolean; cdecl;
    function unmountAndEjectDeviceAtURL(url: NSURL; error: NSError): Boolean; cdecl;
  ...
  NSBezierPathClass = interface(NSObjectClass)
    ...
    {class} procedure drawPackedGlyphs(packedGlyphs: PAnsiChar; atPoint: NSPoint); cdecl;
  ...
  NSBezierPath = interface(NSObject)
    ...
    procedure appendBezierPathWithPackedGlyphs(packedGlyphs: PAnsiChar); cdecl;
  ...
  NSDocumentController = interface(NSObject)
    ...
    function init: Pointer; cdecl;
    function makeDocumentForURL(absoluteDocumentURL: NSURL; withContentsOfURL: NSURL; ofType: NSString; error: NSError): Pointer; cdecl;
    ...
    function makeDocumentWithContentsOfURL(absoluteURL: NSURL; ofType: NSString; error: NSError): Pointer; cdecl; overload;
    function makeUntitledDocumentOfType(type_: NSString): Pointer; cdecl; overload;
    function makeUntitledDocumentOfType(typeName: NSString; error: NSError): Pointer; cdecl; overload;
    ...
    function openUntitledDocumentAndDisplay(displayDocument: Boolean; error: NSError): Pointer; cdecl;
    ...
    function typeForContentsOfURL(inAbsoluteURL: NSURL; error: NSError): NSString; cdecl;
  ...
  NSDocument = interface(NSObject)
    ...
    function dataOfType(typeName: NSString; error: NSError): NSData; cdecl;
    ...
    function fileAttributesToWriteToURL(absoluteURL: NSURL; ofType: NSString; forSaveOperation: NSSaveOperationType; originalContentsURL: NSURL; error: NSError): NSDictionary; cdecl;
    ...
    function fileWrapperOfType(typeName: NSString; error: NSError): NSFileWrapper; cdecl;
    ...
    function init: Pointer; cdecl;
    function initForURL(absoluteDocumentURL: NSURL; withContentsOfURL: NSURL; ofType: NSString; error: NSError): Pointer; cdecl;
    ...
    function initWithContentsOfURL(absoluteURL: NSURL; ofType: NSString; error: NSError): Pointer; cdecl; overload;
    function initWithType(typeName: NSString; error: NSError): Pointer; cdecl;
    ...
    function printInfo: NSPrintInfo; cdecl;
    function printOperationWithSettings(printSettings: NSDictionary; error: NSError): NSPrintOperation; cdecl;
    procedure printShowingPrintPanel(flag: Boolean); cdecl;
    function readFromData(data: NSData; ofType: NSString; error: NSError): Boolean; cdecl;
    function readFromFile(fileName: NSString; ofType: NSString): Boolean; cdecl;
    function readFromFileWrapper(fileWrapper: NSFileWrapper; ofType: NSString; error: NSError): Boolean; cdecl;
    function readFromURL(url: NSURL; ofType: NSString): Boolean; cdecl; overload;
    function readFromURL(absoluteURL: NSURL; ofType: NSString; error: NSError): Boolean; cdecl; overload;
    ...
    function revertToContentsOfURL(absoluteURL: NSURL; ofType: NSString; error: NSError): Boolean; cdecl;
    ...
    function writeSafelyToURL(absoluteURL: NSURL; ofType: NSString; forSaveOperation: NSSaveOperationType; error: NSError): Boolean; cdecl;
    ...
    function writeToURL(absoluteURL: NSURL; ofType: NSString; error: NSError): Boolean; cdecl; overload;
    function writeToURL(absoluteURL: NSURL; ofType: NSString; forSaveOperation: NSSaveOperationType; originalContentsURL: NSURL; error: NSError): Boolean; cdecl; overload;
  ...
  NSAlert = interface(NSObject)
    ...
    procedure setDelegate(delegate: NSAlertDelegate); cdecl;
  ...
  NSPersistentDocument = interface(NSDocument)
    ...
    function configurePersistentStoreCoordinatorForURL(url: NSURL; ofType: NSString; error: NSError): Boolean; cdecl; overload;
    function configurePersistentStoreCoordinatorForURL(url: NSURL; ofType: NSString; modelConfiguration: NSString; storeOptions: NSDictionary; error: NSError): Boolean; cdecl; overload;
//    function managedObjectContext: NSManagedObjectContext; cdecl;
    ...
    function readFromURL(absoluteURL: NSURL; ofType: NSString; error: NSError): Boolean; cdecl;
    function revertToContentsOfURL(inAbsoluteURL: NSURL; ofType: NSString; error: NSError): Boolean; cdecl;
//    procedure setManagedObjectContext(managedObjectContext: NSManagedObjectContext); cdecl;
    function writeToURL(absoluteURL: NSURL; ofType: NSString; forSaveOperation: NSSaveOperationType; originalContentsURL: NSURL; error: NSError): Boolean; cdecl;
  end;
...
//    function convertSize(aSize: NSSize; toView: NSView): NSSize; cdecl; overload;
    ...
    function gState: NSInteger; cdecl;
    procedure getRectsBeingDrawn(rects: NSRect; count: PNSInteger); cdecl;
...
//    function rulerView(ruler: NSRulerView; willMoveMarker: NSRulerMarker; toLocation: Single): Single; cdecl; overload;
    ...
    function superview: NSView; cdecl;
    function tag: NSInteger; cdecl;
    function toolTip: NSString; cdecl;
