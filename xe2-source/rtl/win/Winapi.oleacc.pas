...
function CreateStdAccessibleProxy(hwnd: THandle; pClassName: PWideChar; idObject: LongInt; const riid: TGUID; out ppvObject): HRESULT; stdcall;
{$EXTERNALSYM CreateStdAccessibleProxyA}
function CreateStdAccessibleProxyA(hwnd: THandle; pClassName: PAnsiChar; idObject: LongInt; const riid: TGUID; out ppvObject): HRESULT; stdcall;
{$EXTERNALSYM CreateStdAccessibleProxyW}
function CreateStdAccessibleProxyW(hwnd: THandle; pClassName: PWideChar; idObject: LongInt; const riid: TGUID; out ppvObject): HRESULT; stdcall;
(*
...
// *********************************************************************//
  ...
  {$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IAccessibleDisp)' }
