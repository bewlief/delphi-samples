...
uses Winapi.Windows, Winapi.ActiveX, Winapi.CommCtrl, Winapi.ShellAPI, Winapi.RegStr, Winapi.Messages, Winapi.WinInet, Winapi.UrlMon,
  Winapi.ObjectArray, Winapi.PropSys, Winapi.StructuredQueryCondition, Winapi.msxml;
...
{$HPPEMIT 'struct _PERSIST_FOLDER_TARGET_INFO;'}
{$HPPEMIT 'struct EXTRASEARCH;'}
{$HPPEMIT 'struct _SV2CVW2_PARAMS;'}
{$HPPEMIT 'struct SORTCOLUMN;'}
{$HPPEMIT 'struct CM_COLUMNINFO;'}
{$HPPEMIT 'struct SHELL_ITEM_RESOURCE;'}
{$HPPEMIT 'struct CATEGORY_INFO;'}
{$HPPEMIT 'struct SHDRAGIMAGE;'}
{$HPPEMIT 'struct DESKBANDINFO;'}
{$HPPEMIT 'struct THUMBBUTTON;'}
{$HPPEMIT 'struct tagBANDSITEINFO;'}
{$HPPEMIT 'struct DELEGATEITEMID;'}
{$HPPEMIT 'struct tagSMDATA;'}
{$HPPEMIT 'struct tagSMINFO;'}
{$HPPEMIT 'struct SHCSCHANGENOTIFYSTRUCT;'}
{$HPPEMIT 'struct KNOWNFOLDER_DEFINITION;'}
{$HPPEMIT 'struct NSTCCUSTOMDRAW;'}
{$HPPEMIT 'struct __MIDL_IPreviewHandlerFrame_0001;'}
{$HPPEMIT 'struct tagDATABLOCKHEADER;'}
{$HPPEMIT 'struct tagNT_CONSOLE_PROPS;'}
{$HPPEMIT 'struct tagNT_FE_CONSOLE_PROPS;'}
{$HPPEMIT 'struct tagEXP_DARWIN_LINK;'}
{$HPPEMIT 'struct tagEXP_SPECIAL_FOLDER;'}
{$HPPEMIT 'struct tagEXP_SZ_LINK;'}
{$HPPEMIT 'struct tagEXP_PROPERTYSTORAGE;'}
{$HPPEMIT 'struct tagSHFOLDERCUSTOMSETTINGS;'}
{$HPPEMIT 'struct _browseinfoA;'}
{$HPPEMIT 'struct _browseinfoW;'}
{$HPPEMIT 'struct _EnumImageStoreDATAtag;'}
{$HPPEMIT 'struct tagBANDINFOSFB;'}
{$HPPEMIT 'struct _tagCOMPSTATEINFO;'}
{$HPPEMIT 'struct _tagIE4COMPONENT;'}
{$HPPEMIT 'struct _tagCOMPONENT;'}
{$HPPEMIT 'struct tagSHCOLUMNINFO;'}
{$HPPEMIT 'struct tagSHCOLUMNINIT;'}
{$HPPEMIT 'struct tagSHCOLUMNDATA;'}
...
{$HPPEMIT 'struct tagFILE_ATTRIBUTES_ARRAY;'}
{$HPPEMIT 'struct tagDROPDESCRIPTION;'}
{$HPPEMIT 'struct _SHChangeNotifyEntry;'}
{$HPPEMIT 'struct SHARDAPPIDINFO;'}
{$HPPEMIT 'struct SHARDAPPIDINFOIDLIST;'}
{$HPPEMIT 'struct SHARDAPPIDINFOLINK;'}
{$HPPEMIT 'struct _SHChangeDWORDAsIDList;'}
{$HPPEMIT 'struct _SHChangeUpdateImageIDList;'}
{$HPPEMIT 'struct _SHChangeProductKeyAsIDList;'}
{$HPPEMIT 'struct _SHDESCRIPTIONID;'}
{$HPPEMIT 'struct tagAUTO_SCROLL_DATA;'}
{$HPPEMIT 'struct tagCABINETSTATE;'}
{$HPPEMIT 'struct _openasinfo;'}
{$HPPEMIT 'struct PROPPRG;'}
{$HPPEMIT 'struct _QCMINFO_IDMAP_PLACEMENT;'}
{$HPPEMIT 'struct _QCMINFO_IDMAP;'}
{$HPPEMIT 'struct _QCMINFO;'}
{$HPPEMIT 'struct _TBINFO;'}
{$HPPEMIT 'struct _DETAILSINFO;'}
{$HPPEMIT 'struct _SFVM_PROPPAGE_DATA;'}
{$HPPEMIT 'struct _SFVM_HELPTOPIC_DATA;'}
{$HPPEMIT 'struct _ITEMSPACING;'}
{$HPPEMIT 'struct _SFV_CREATE;'}
{$HPPEMIT 'struct tagDEFCONTEXTMENU;'}
{$HPPEMIT 'struct tagDFMICS;'}
{$HPPEMIT 'struct _CSFV;'}
{$HPPEMIT 'struct _SFV_SETITEMPOS;'}
{$HPPEMIT 'struct tagSHELLSTATEA;'}
{$HPPEMIT 'struct tagSHELLSTATEW;'}
{$HPPEMIT 'struct tagSHELLFLAGSTATE;'}
{$HPPEMIT 'struct tagAAMENUFILENAME;'}
{$HPPEMIT 'struct tagAASHELLMENUITEM;'}
{$HPPEMIT 'struct FOLDERSETTINGS;'}

{$HPPEMIT 'typedef HRESULT (CALLBACK *LPFNDFMCALLBACK)(IShellFolder *psf, HWND hwnd,'}
{$HPPEMIT '     IDataObject *pdtobj, UINT uMsg, WPARAM wParam, LPARAM lParam);'}
{$HPPEMIT 'typedef HRESULT (CALLBACK *LPFNVIEWCALLBACK)(IShellView *psvOuter, IShellFolder *psf,'}
{$HPPEMIT '     HWND hwndMain, UINT uMsg, WPARAM wParam, LPARAM lParam);'}
{$HPPEMIT '#endif'}
...
function SHGetIconOverlayIndex(pszIconPath: PWideChar; 
...
function SHCreateDirectoryEx(hwnd: HWND; pszPath: PWideChar;
...
function SHSetFolderPath(csidl: Integer; hToken: THandle; dwFlags: DWORD; 
  pszPath: PWideChar): HResult; stdcall;
...
function SHGetFolderPathAndSubDir(hwnd: HWND; csidl: Integer; hToken: THandle; 
  dwFlags: DWORD; pszSubDir: PWideChar; pszPath: PWideChar): HResult; stdcall;
{$EXTERNALSYM SHGetFolderPathAndSubDir}
function SHGetFolderPathAndSubDirA(hwnd: HWND; csidl: Integer; hToken: THandle; 
  dwFlags: DWORD; pszSubDir: PAnsiChar; pszPath: PAnsiChar): HResult; stdcall;
...
function PathIsSlow(pszFile: PWideChar; dwAttr: DWORD): BOOL; stdcall;
...
function SHOpenPropSheet(pszCaption: PAnsiChar; ahkeys: PHKEY; cikeys: UINT; 
  var pclsidDefault: TCLSID; const pdtobj: IDataObject; const psb: IShellBrowser;
  pStartPage: PWideChar): BOOL; stdcall;
{$EXTERNALSYM SHOpenPropSheet}
function SHOpenPropSheetA(pszCaption: PAnsiChar; ahkeys: PHKEY; cikeys: UINT; 
  var pclsidDefault: TCLSID; const pdtobj: IDataObject; const psb: IShellBrowser;
  pStartPage: PAnsiChar): BOOL; stdcall;
{$EXTERNALSYM SHOpenPropSheetA}
function SHOpenPropSheetW(pszCaption: PAnsiChar; ahkeys: PHKEY; cikeys: UINT; 
  var pclsidDefault: TCLSID; const pdtobj: IDataObject; const psb: IShellBrowser;
  pStartPage: PWideChar): BOOL; stdcall;
