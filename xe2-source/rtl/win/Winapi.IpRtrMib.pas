...
type
  ...
  {$EXTERNALSYM TMibIcmpStatsEx}  
  PMibIcmpStatsEx = PMIBICMPSTATS_EX;
  {$EXTERNALSYM PMibIcmpStatsEx}  
  ...
  {$EXTERNALSYM TMibIcmpEx}
  PMibIcmpEx = PMIB_ICMP_EX;  
  {$EXTERNALSYM PMibIcmpEx}
  ...
  {$EXTERNALSYM TMibUdpStats}
  PMibUdpStats = PMIB_UDPSTATS;
  {$EXTERNALSYM PMibUdpStats}
...
// #define SIZEOF_UDPTABLE(X) (FIELD_OFFSET(MIB_UDPTABLE, table[0]) + ((X) * sizeof(MIB_UDPROW)) + ALIGN_SIZE)
  ...
  {$EXTERNALSYM TMibTcpStats}
  PMibTcpStats = PMIB_TCPSTATS;
  {$EXTERNALSYM PMibTcpStats}
...
type
  ...
  {$EXTERNALSYM TMibTcpRow}
  PMibTcpRow = PMIB_TCPROW;
  {$EXTERNALSYM PMibTcpRow}
...
type
  ...
  {$EXTERNALSYM TMibIpStats}
  PMibIpStats = PMIB_IPSTATS;
  {$EXTERNALSYM PMibIpStats}
...
type
  ...
  {$EXTERNALSYM TMibIpNetRow}
  PMibIpNetRow = PMIB_IPNETROW;
  {$EXTERNALSYM PMibIpNetRow}
...
type
  ...
  {$EXTERNALSYM TMibIpmCastOif}
  PMibIpmCastOif = PMIB_IPMCAST_OIF;
  {$EXTERNALSYM PMibIpmCastOif}
...
type
  ...
  {$EXTERNALSYM TMibIpmCastOifStats}
  PMibIpmCastOifStats = PMIB_IPMCAST_OIF_STATS;
  {$EXTERNALSYM PMibIpmCastOifStats}
...
type
  ...
  {$EXTERNALSYM TMibMfeStatsTableEx}
  PMibMfeStatsTableEx = PMIB_MFE_STATS_TABLE_EX;
  {$EXTERNALSYM PMibMfeStatsTableEx}
