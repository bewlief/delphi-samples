...
type
  ...
  {$EXTERNALSYM TD3DValue}
  PD3DValue = Winapi.DXTypes.PD3DValue;
  {$EXTERNALSYM PD3DValue}
...
type
  ...
  {$EXTERNALSYM PDSCEffectDesc}
  _DSCEFFECTDESC = record
    dwSize: DWORD;
    dwFlags: DWORD;
...
type
  ...
  {$EXTERNALSYM PDSBufferDesc}
  _DSBUFFERDESC = record
    dwSize: DWORD;
    dwFlags: DWORD;
    dwBufferBytes: DWORD;
    dwReserved: DWORD;
...
{$ENDIF} // DIRECTSOUND_VERSION >= 0x0700
  ...
  {$EXTERNALSYM TDSBufferDesc}

// Older version of this structure:

  PDSBufferDesc1 = ^TDSBufferDesc1;
  {$EXTERNALSYM PDSBufferDesc1}
  _DSBUFFERDESC1 = record
    dwSize: DWORD;
    dwFlags: DWORD;
    dwBufferBytes: DWORD;
    dwReserved: DWORD;
  ...
  {$EXTERNALSYM TDSBufferDesc1}

  PDS3DBuffer = ^TDS3DBuffer;
  {$EXTERNALSYM PDS3DBuffer}
  _DS3DBUFFER = record
    dwSize: DWORD;
  ...
  {$EXTERNALSYM TDS3DBuffer}

  PDS3DListener = ^TDS3DListener;
  {$EXTERNALSYM PDS3DListener}
  _DS3DLISTENER = record
    dwSize: DWORD;
    vPosition: TD3DVector;
    vVelocity: TD3DVector;
  ...
  {$EXTERNALSYM DSCCAPS}
  TDSCcaps = _DSCCAPS;
  {$EXTERNALSYM TDSCcaps}

  PDSCBufferDesc1 = ^TDSCBufferDesc1;
  {$EXTERNALSYM PDSCBufferDesc1}
  _DSCBUFFERDESC1 = record
    dwSize: DWORD;
    dwFlags: DWORD;
    dwBufferBytes: DWORD;
    dwReserved: DWORD;
  ...
  {$EXTERNALSYM TDSCBufferDesc1}

  PDSCBufferDesc = ^TDSCBufferDesc;
  {$EXTERNALSYM PDSCBufferDesc}
  _DSCBUFFERDESC = record
    dwSize: DWORD;
    dwFlags: DWORD;
    dwBufferBytes: DWORD;
    dwReserved: DWORD;
...
{$ENDIF} // DIRECTSOUND_VERSION >= 0x0800
  ...
  {$EXTERNALSYM TDSCBufferDesc}

  PDSCBCaps = ^TDSCBCaps;
  {$EXTERNALSYM PDSCBCaps}
  _DSCBCAPS = record
    dwSize: DWORD;
    dwFlags: DWORD;
    dwBufferBytes: DWORD;
  ...
  TDSCBCaps = _DSCBCAPS;
  {$EXTERNALSYM TDSCBCaps}

  PDSBPositionNotify = ^TDSBPositionNotify;
  {$EXTERNALSYM PDSBPositionNotify}
  _DSBPOSITIONNOTIFY = record
    dwOffset: DWORD;
  ...
  {$EXTERNALSYM TDSBPositionNotify}


type
  REFERENCE_TIME = Winapi.DXTypes.REFERENCE_TIME;
  {$EXTERNALSYM REFERENCE_TIME}
  TReferenceTime = Winapi.DXTypes.TReferenceTime;
  {$EXTERNALSYM TReferenceTime}
  PReferenceTime = Winapi.DXTypes.PReferenceTime;
  {$EXTERNALSYM PReferenceTime}
...
type
  ...
  {$EXTERNALSYM PDSFXDistortion}
  _DSFXDistortion = record
    fGain: Single;
    fEdge: Single;
...
type
  ...
  {$EXTERNALSYM PDSFXCompressor}
  _DSFXCompressor = record
    fGain: Single;
    fAttack: Single;
    fRelease: Single;
    fThreshold: Single;
...
type
  ...
  {$EXTERNALSYM PDSFXI3DL2Reverb}
  _DSFXI3DL2Reverb = record
...
type
  ...
  {$EXTERNALSYM PDSFXWavesReverb}
  _DSFXWavesReverb = record
...
type
  ...
  {$EXTERNALSYM PDSCFXNoiseSuppress}
  _DSCFXNoiseSuppress = record
    fEnable:    BOOL;
  end;
  ...
  {$EXTERNALSYM TDSCFXNoiseSuppress}
