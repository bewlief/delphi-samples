...
function CreateService(hSCManager: SC_HANDLE; lpServiceName, lpDisplayName: PWideChar;
...
function GetServiceKeyName(hSCManager: SC_HANDLE; lpDisplayName: PWideChar;
  lpServiceName: PWideChar; var lpcchBuffer: DWORD): BOOL; stdcall;
{$EXTERNALSYM GetServiceKeyNameA}
function GetServiceKeyNameA(hSCManager: SC_HANDLE; lpDisplayName: PAnsiChar;
  lpServiceName: PAnsiChar; var lpcchBuffer: DWORD): BOOL; stdcall;
{$EXTERNALSYM GetServiceKeyNameW}
function GetServiceKeyNameW(hSCManager: SC_HANDLE; lpDisplayName: PWideChar;
  lpServiceName: PWideChar; var lpcchBuffer: DWORD): BOOL; stdcall;
{$EXTERNALSYM GetServiceDisplayName}
function GetServiceDisplayName(hSCManager: SC_HANDLE; lpServiceName: PWideChar;
  lpDisplayName: PWideChar; var lpcchBuffer: DWORD): BOOL; stdcall;
{$EXTERNALSYM GetServiceDisplayNameA}
function GetServiceDisplayNameA(hSCManager: SC_HANDLE; lpServiceName: PAnsiChar;
  lpDisplayName: PAnsiChar; var lpcchBuffer: DWORD): BOOL; stdcall;
{$EXTERNALSYM GetServiceDisplayNameW}
function GetServiceDisplayNameW(hSCManager: SC_HANDLE; lpServiceName: PWideChar;
  lpDisplayName: PWideChar; var lpcchBuffer: DWORD): BOOL; stdcall;
...
function OpenService(hSCManager: SC_HANDLE; lpServiceName: PWideChar;
  dwDesiredAccess: DWORD): SC_HANDLE; stdcall;
...
function RegisterServiceCtrlHandler(lpServiceName: PWideChar;
...
{$EXTERNALSYM NotifyServiceStartChange}
function NotifyServiceStartChange(hService: SC_HANDLE; dwNotifyMask: DWORD;
  pNotifyBuffer: PSERVICE_NOTIFY): DWORD; stdcall;
{$EXTERNALSYM NotifyServiceStartChangeA}
function NotifyServiceStartChangeA(hService: SC_HANDLE; dwNotifyMask: DWORD;
  pNotifyBuffer: PSERVICE_NOTIFYA): DWORD; stdcall;
{$EXTERNALSYM NotifyServiceStartChangeW}
function NotifyServiceStartChangeW(hService: SC_HANDLE; dwNotifyMask: DWORD;
...
function NotifyServiceStartChange; external advapi32 name 'NotifyServiceStartChangeW' delayed;
function NotifyServiceStartChangeA; external advapi32 name 'NotifyServiceStartChangeA' delayed;
function NotifyServiceStartChangeW; external advapi32 name 'NotifyServiceStartChangeW' delayed;
