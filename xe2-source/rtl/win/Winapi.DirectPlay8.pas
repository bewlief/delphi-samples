...
uses
  Winapi.Windows, Winapi.WinSock, Winapi.DirectSound;
...
type
  ...
  _DPN_SERVICE_PROVIDER_INFO = record
     dwFlags: DWORD;
     guid: TGUID;            // SP Guid
 ...
 ****************************************************************************)
  ...
  _DPNMSG_ADD_PLAYER_TO_GROUP = record
    dwSize: DWORD;            // Size of this structure
  ...
  _DPNMSG_ASYNC_OP_COMPLETE = record
    dwSize: DWORD;          // Size of this structure
  ...
  _DPNMSG_CONNECT_COMPLETE = record
    dwSize: DWORD;                     // Size of this structure
    hAsyncOp: TDPNHandle;              // DirectPlay8 Async operation handle
  ...
  _DPNMSG_ENUM_HOSTS_QUERY = record
    dwSize: DWORD;                        // Size of this structure.
  ...
  _DPNMSG_ENUM_HOSTS_RESPONSE = record
    dwSize: DWORD;                                // Size of this structure
  ...
  _DPNMSG_INDICATE_CONNECT = record
    dwSize: DWORD;                        // Size of this structure
  ...
  _DPNMSG_INDICATED_CONNECT_ABORTED = record
    dwSize: DWORD;            // Size of this structure
  ...
  _DPNMSG_REMOVE_PLAYER_FROM_GROUP = record
    dwSize: DWORD;               // Size of this structure
    dpnidGroup: TDPNID;          // DPNID of group
    pvGroupContext: Pointer;     // Group context value
  ...
  _DPNMSG_TERMINATE_SESSION = record
    dwSize: DWORD;              // Size of this structure
  ...
  _DPNMSG_NAT_RESOLVER_QUERY = record
    dwSize: DWORD;				// Size of this structure.
 ...
 ****************************************************************************)
  ...
  IDirectPlay8Server = interface(IUnknown)
    ...
    function GetGroupInfo(dpnid: TDPNID; pdpnGroupInfo: PDPNGroupInfo; pdwSize: PDWORD; dwFlags: DWORD): HResult; stdcall;                                                      
  ...
  IDirectPlay8Peer = interface(IUnknown)
    ...
    function SetPeerInfo(const pdpnPlayerInfo: TDPNPlayerInfo; pvAsyncContext: Pointer;
      phAsyncHandle: PDPNHandle; dwFlags: DWORD): HResult; stdcall;
    function GetPeerInfo(dpnid: TDPNID; var pdpnPlayerInfo: TDPNPlayerInfo; pdwSize: PDWORD; dwFlags: DWORD): HResult; stdcall;                                                      
 ...
 ****************************************************************************)
  ...
  _DPL_CONNECTION_SETTINGS = record
    dwSize: DWORD;                    // Size of this structure
 ...
 ****************************************************************************)
  ...
  _DPL_MESSAGE_CONNECTION_SETTINGS = record
    dwSize: DWORD;                // Size of this structure
  ...
  _DPL_MESSAGE_DISCONNECT = record
    dwSize: DWORD;                // Size of this structure
  ...
  _DPL_MESSAGE_SESSION_STATUS = record
    dwSize: DWORD;                // Size of this structure
 ...
 ****************************************************************************)
  ...
  DVMSG_CREATEVOICEPLAYER = record
    dwSize: DWORD;                         // Size of this structure
  ...
  DVMSG_DELETEVOICEPLAYER = record
    dwSize: DWORD;                         // Size of this structure
  ...
  DVMSG_PLAYEROUTPUTLEVEL = record
    dwSize: DWORD;                         // Size of this structure
