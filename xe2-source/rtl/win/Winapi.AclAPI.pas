...
function GetAuditedPermissionsFromAclW(var pacl: ACL; var pTrustee: TRUSTEE_W;
         var pSuccessfulAuditedRights: ACCESS_MASK; var pFailedAuditRights: ACCESS_MASK): DWORD; stdcall;
function GetNamedSecurityInfo(pObjectName: PWideChar; ObjectType: SE_OBJECT_TYPE;
...
function GetNamedSecurityInfoA(pObjectName: PAnsiChar; ObjectType: SE_OBJECT_TYPE;
         SecurityInfo: SECURITY_INFORMATION; ppsidOwner, ppsidGroup: PPSID; ppDacl, ppSacl: PACL;
         var ppSecurityDescriptor: PSECURITY_DESCRIPTOR): DWORD; stdcall; {use localfree to release ppSecurityDescriptor}
function GetNamedSecurityInfoW(pObjectName: PWideChar; ObjectType: SE_OBJECT_TYPE;
         SecurityInfo: SECURITY_INFORMATION; ppsidOwner, ppsidGroup: PPSID; ppDacl, ppSacl: PACL;
         var ppSecurityDescriptor: PSECURITY_DESCRIPTOR): DWORD; stdcall; {use localfree to release ppSecurityDescriptor}
...
function SetNamedSecurityInfo(pObjectName: PWideChar; ObjectType: SE_OBJECT_TYPE;
...
procedure BuildExplicitAccessWithName(pExplicitAccess: PEXPLICIT_ACCESS_;
          pTrusteeName: PWideChar; AccessPermissions: DWORD; AccessMode: ACCESS_MODE;
...
procedure BuildImpersonateExplicitAccessWithName(pExplicitAccess: PEXPLICIT_ACCESS_;
          pTrusteeName: PWideChar; pTrustee: PTRUSTEE_; AccessPermissions: DWORD;
...
procedure BuildImpersonateExplicitAccessWithNameW(pExplicitAccess: PEXPLICIT_ACCESS_W;
          pTrusteeName: PWideChar; pTrustee: PTRUSTEE_W; AccessPermissions: DWORD;
          AccessMode: ACCESS_MODE; Inheritance: DWORD); stdcall; {obsolete}

procedure BuildTrusteeWithName(pTrustee: PTRUSTEE_; pName: PWideChar); stdcall;
procedure BuildTrusteeWithNameA(pTrustee: PTRUSTEE_A; pName: PAnsiChar); stdcall;
procedure BuildTrusteeWithNameW(pTrustee: PTRUSTEE_W; pName: PWideChar); stdcall;
...
function GetTrusteeName(var pTrustee: TRUSTEE_): PWideChar; stdcall;
function GetTrusteeNameA(var pTrustee: TRUSTEE_A): PAnsiChar; stdcall;
function GetTrusteeNameW(var pTrustee: TRUSTEE_W): PWideChar; stdcall;
...
procedure BuildExplicitAccessWithName;  external ModName name 'BuildExplicitAccessWithNameW';
...
procedure BuildImpersonateExplicitAccessWithName; external ModName name 'BuildImpersonateExplicitAccessWithNameW';
...
procedure BuildImpersonateTrustee;      external ModName name 'BuildImpersonateTrusteeW';
...
function BuildSecurityDescriptor;      external ModName name 'BuildSecurityDescriptorW';
...
procedure BuildTrusteeWithName;         external ModName name 'BuildTrusteeWithNameW';
...
procedure BuildTrusteeWithSid;          external ModName name 'BuildTrusteeWithSidW';
...
function GetAuditedPermissionsFromAcl; external ModName name 'GetAuditedPermissionsFromAclW';
...
function GetEffectiveRightsFromAcl;    external ModName name 'GetEffectiveRightsFromAclW';
...
function GetExplicitEntriesFromAcl;    external ModName name 'GetExplicitEntriesFromAclW';
...
function GetMultipleTrusteeOperation;  external ModName name 'GetMultipleTrusteeOperationW';
...
function GetMultipleTrustee;           external ModName name 'GetMultipleTrusteeW';
...
function GetNamedSecurityInfo;         external ModName name 'GetNamedSecurityInfoW';
...
function GetTrusteeForm;               external ModName name 'GetTrusteeFormW';
...
function GetTrusteeName;               external ModName name 'GetTrusteeNameW';
...
function GetTrusteeType;               external ModName name 'GetTrusteeTypeW';
...
function LookupSecurityDescriptorParts; external ModName name 'LookupSecurityDescriptorPartsW';
...
function SetEntriesInAcl;              external ModName name 'SetEntriesInAclW';
...
function SetNamedSecurityInfo;         external ModName name 'SetNamedSecurityInfoW';
