...
function ImageList_LoadImageA(Instance: HINST; Bmp: PAnsiChar; CX, Grow: Integer;
  Mask: TColorRef; pType, Flags: UINT): HIMAGELIST; stdcall;
{$EXTERNALSYM ImageList_LoadImageW}
function ImageList_LoadImageW(Instance: HINST; Bmp: PWideChar; CX, Grow: Integer;
  Mask: TColorRef; pType, Flags: UINT): HIMAGELIST; stdcall;
...
function ImageList_LoadBitmap(Instance: HINST; Bmp: PWideChar;
  CX, Grow: Integer; MasK: TColorRef): HIMAGELIST;
{$EXTERNALSYM ImageList_LoadBitmapA}
function ImageList_LoadBitmapA(Instance: HINST; Bmp: PAnsiChar;
  CX, Grow: Integer; MasK: TColorRef): HIMAGELIST;
{$EXTERNALSYM ImageList_LoadBitmapW}
function ImageList_LoadBitmapW(Instance: HINST; Bmp: PWideChar;
  CX, Grow: Integer; MasK: TColorRef): HIMAGELIST;
...
type
  ...
  _HD_TEXTFILTERA = record
    pszText: PAnsiChar;                   // [in] pointer to the buffer containing the filter (ANSI/UNICODE)
    cchTextMax: Integer;               // [in] max size of buffer/edit control buffer
  end;
  {$EXTERNALSYM _HD_TEXTFILTERW}
  _HD_TEXTFILTERW = record
    pszText: PWideChar;                   // [in] pointer to the buffer containing the filter (ANSI/UNICODE)
    cchTextMax: Integer;               // [in] max size of buffer/edit control buffer
  end;
