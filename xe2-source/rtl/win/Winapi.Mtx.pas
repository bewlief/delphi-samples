...
// NOTE: We need _di_<InterfaceName> for every interface
//       used in the interface sections of units that
//       generate .hpp files for C++
...
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IObjectContext);' *)
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IObjectControl);' *)
