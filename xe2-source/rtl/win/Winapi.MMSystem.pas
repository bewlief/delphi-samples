...
function sndPlaySound(lpszSoundName: PWideChar; uFlags: UINT): BOOL; stdcall;
...
function PlaySound(pszSound: PWideChar; hmod: HMODULE; fdwSound: DWORD): BOOL; stdcall;
...
function waveOutGetErrorText(mmrError: MMRESULT; lpText: PWideChar; uSize: UINT): MMRESULT; stdcall;
...
function waveInGetErrorText(mmrError: MMRESULT; lpText: PWideChar; uSize: UINT): MMRESULT; stdcall;
...
function midiOutGetErrorText(mmrError: MMRESULT; pszText: PWideChar; uSize: UINT): MMRESULT; stdcall;
...
function midiInGetErrorText(mmrError: MMRESULT; pszText: PWideChar; uSize: UINT): MMRESULT; stdcall;
...
function mmioStringToFOURCC(sz: PWideChar; uFlags: UINT): FOURCC; stdcall;
...
function mmioOpen(szFileName: PWideChar; lpmmioinfo: PMMIOInfo;
  dwOpenFlags: DWORD): HMMIO; stdcall;
{$EXTERNALSYM mmioOpenA}
function mmioOpenA(szFileName: PAnsiChar; lpmmioinfo: PMMIOInfo;
  dwOpenFlags: DWORD): HMMIO; stdcall;
{$EXTERNALSYM mmioOpenW}
function mmioOpenW(szFileName: PWideChar; lpmmioinfo: PMMIOInfo;
  dwOpenFlags: DWORD): HMMIO; stdcall;
{$EXTERNALSYM mmioRename}
function mmioRename(szFileName, szNewFileName: PWideChar;
...
function mciSendString(lpstrCommand, lpstrReturnString: PWideChar;
...
function mciGetDeviceIDFromElementID(dwElementID: DWORD; lpstrType: PWideChar): MCIDEVICEID; stdcall;
...
function mciGetErrorString(mcierr: MCIERROR; pszText: PWideChar; uLength: UINT): BOOL; stdcall;
