...
uses
  ...
  System.SysUtils, Winapi.Direct3D9, Winapi.DXTypes;
...
type
  ...
  _D3DXFONT_DESC = _D3DXFONT_DESCW;
...
{$ALIGN 1}
  ...
  _XFILECOMPRESSEDANIMATIONSET = record {#pragma pack(push, 1)}
...
(*    D3DXCOMPRESS_DEFAULT     {= 0x00},  // fast compression
  ...
  ID3DXAnimationController = interface(IUnknown)
    ...
    function GetTrackDesc(Track: LongWord; pDesc: PD3DXTrackDesc): HResult; stdcall;                                                   
    ...
    function GetEventDesc(hEvent: TD3DXEventHandle; pDesc: PD3DXEventDesc): HResult; stdcall;                                                   
...
begin
  Result:= (PDWORD(@Left.x)^ = PDWORD(@Right.x)^) and (PDWORD(@Left.z)^ = PDWORD(@Right.z)^);
end;
...
function D3DXVec2Normalize(out vOut: TD3DXVector2; v: PD3DXVector2): PD3DXVector2; external d3dx9mathDLL;

function D3DXVec2Normalize(out vOut: TD3DXVector2; const v: TD3DXVector2): PD3DXVector2;
begin
  Result := D3DXVec2Normalize(vOut, @v);
end;

function D3DXVec2Hermite(out vOut: TD3DXVector2;
   v1, t1, v2, t2: PD3DXVector2; s: Single): PD3DXVector2; external d3dx9mathDLL;

function D3DXVec2Hermite(out vOut: TD3DXVector2;
   const v1, t1, v2, t2: TD3DXVector2; s: Single): PD3DXVector2;
begin
  Result := D3DXVec2Hermite(vOut, @v1, @t1, @v2, @t2, s);
end;

function D3DXVec2CatmullRom(out vOut: TD3DXVector2;
   v0, v1, v2, v3: PD3DXVector2; s: Single): PD3DXVector2; external d3dx9mathDLL;

function D3DXVec2CatmullRom(out vOut: TD3DXVector2;
   const v0, v1, v2, v3: TD3DXVector2; s: Single): PD3DXVector2;
begin
  Result := D3DXVec2CatmullRom(vOut, @v0, @v1, @v2, @v3, s);
end;

function D3DXVec2BaryCentric(out vOut: TD3DXVector2;
   v1, v2, v3: PD3DXVector2; f, g: Single): PD3DXVector2; external d3dx9mathDLL;

function D3DXVec2BaryCentric(out vOut: TD3DXVector2;
   const v1, v2, v3: TD3DXVector2; f, g: Single): PD3DXVector2;
begin
  Result := D3DXVec2BaryCentric(vOut, @v1, @v2, @v3, f, g);
end;

function D3DXVec2Transform(out vOut: TD3DXVector4;
  v: PD3DXVector2; const m: TD3DXMatrix): PD3DXVector4; external d3dx9mathDLL;

function D3DXVec2Transform(out vOut: TD3DXVector4;
  const v: TD3DXVector2; const m: TD3DXMatrix): PD3DXVector4;
begin
  Result := D3DXVec2Transform(vOut, @v, m);
end;

function D3DXVec2TransformCoord(out vOut: TD3DXVector2;
  v: PD3DXVector2; const m: TD3DXMatrix): PD3DXVector2; external d3dx9mathDLL;

function D3DXVec2TransformCoord(out vOut: TD3DXVector2;
  const v: TD3DXVector2; const m: TD3DXMatrix): PD3DXVector2;
begin
  Result := D3DXVec2TransformCoord(vOut, @v, m);
end;
...
function D3DXVec2TransformNormal(out vOut: TD3DXVector2;
  const v: TD3DXVector2; const m: TD3DXMatrix): PD3DXVector2;
begin
  Result := D3DXVec2TransformNormal(vOut, @v, m);
end;
