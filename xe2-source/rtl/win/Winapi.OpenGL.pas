...
// EXT_vertex_array
  ...
  {$EXTERNALSYM TGLARRAYELEMENTEXTPROC}
  ...
  {$EXTERNALSYM TGLDRAWARRAYSEXTPROC}
  ...
  {$EXTERNALSYM TGLVERTEXPOINTEREXTPROC}
  ...
  {$EXTERNALSYM TGLNORMALPOINTEREXTPROC}
  ...
  {$EXTERNALSYM TGLCOLORPOINTEREXTPROC}
  ...
  {$EXTERNALSYM TGLINDEXPOINTEREXTPROC}
  ...
  {$EXTERNALSYM TGLTEXCOORDPOINTEREXTPROC}
  ...
  {$EXTERNALSYM TGLEDGEFLAGPOINTEREXTPROC}
  ...
  {$EXTERNALSYM TGLGETPOINTERVEXTPROC}
...
// WIN_swap_hint
  ...
  {$EXTERNALSYM TGLADDSWAPHINTRECTWINPROC}
...
function gluGetString (name: GLenum): PAnsiChar; stdcall;
...
type
  ...
  {$EXTERNALSYM TGLUquadricErrorProc}
...
type
  ...
  {$EXTERNALSYM TGLUtessCombineProc}
...
type
  ...
  {$EXTERNALSYM TGLUnurbsErrorProc}
