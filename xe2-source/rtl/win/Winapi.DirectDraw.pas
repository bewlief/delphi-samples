...
(*$HPPEMIT '#if defined(_INCLUDE_DVP_HEADER)' *)
 ...
 *)
  ...
  {$EXTERNALSYM PDirectDrawSurface}
 ...
 *)
  ...
  {$EXTERNALSYM TDDVideoPortConnect}
  
(*
 * DDVIDEOPORTCAPS
 *)
  PDDVideoPortCaps = ^TDDVideoPortCaps;
  {$EXTERNALSYM PDDVideoPortCaps}
  _DDVIDEOPORTCAPS = record
 ...
 *)
  ...
  {$EXTERNALSYM PDDVideoPortDesc}
  _DDVIDEOPORTDESC = record
  ...
  {$EXTERNALSYM TDDVideoPortDesc}
  
(*
 * DDVIDEOPORTINFO
 *)
  PDDVideoPortInfo = ^TDDVideoPortInfo;
  {$EXTERNALSYM PDDVideoPortInfo}
  _DDVIDEOPORTINFO = record
  ...
  {$EXTERNALSYM TDDVideoPortInfo}
  
(*
 * DDVIDEOPORTBANDWIDTH
 *)
  PDDVideoPortBandWidth = ^TDDVideoPortBandWidth;
  {$EXTERNALSYM PDDVideoPortBandWidth}
  _DDVIDEOPORTBANDWIDTH = record
    dwSize: DWORD;                 // Size of the structure
    dwCaps: DWORD;
  ...
  {$EXTERNALSYM TDDVideoPortBandWidth}
  
(*
 * DDVIDEOPORTSTATUS
 *)
  PDDVideoPortStatus = ^TDDVideoPortStatus;
  {$EXTERNALSYM PDDVideoPortStatus}
  ...
  {$EXTERNALSYM TDDVideoPortStatus}
  
(*
 * DDVIDEOPORTNOTIFY
 *)
  PDDVideoPortNotify = ^TDDVideoPortNotify;
  {$EXTERNALSYM PDDVideoPortNotify}
  _DDVIDEOPORTNOTIFY = record
  ...
  {$EXTERNALSYM TDDVideoPortNotify}
