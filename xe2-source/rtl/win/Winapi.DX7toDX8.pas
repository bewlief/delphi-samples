...
unit Winapi.DX7toDX8;

interface

uses
  Winapi.Windows, Winapi.Direct3D8;
...
function RGBA_MAKE(r, g, b, a: DWORD): TD3DColor; {$IFDEF SUPPORTS_INLINE} inline;{$ENDIF}
{$EXTERNALSYM RGBA_MAKE}
//#define RGB_MAKE                                D3DCOLOR_XRGB
function RGB_MAKE(r, g, b: DWORD): TD3DColor; {$IFDEF SUPPORTS_INLINE} inline;{$ENDIF}
{$EXTERNALSYM RGB_MAKE}
//#define D3DRGBA                                 D3DCOLOR_COLORVALUE
function D3DRGBA(r, g, b, a: Single): TD3DColor; {$IFDEF SUPPORTS_INLINE} inline;{$ENDIF}
{$EXTERNALSYM D3DRGBA}
//#define D3DRGB(_r,_g,_b)                        D3DCOLOR_COLORVALUE(_r,_g,_b,1.f)
function D3DRGB(r, g, b: Single): TD3DColor; {$IFDEF SUPPORTS_INLINE} inline;{$ENDIF}
{$EXTERNALSYM D3DRGB}
