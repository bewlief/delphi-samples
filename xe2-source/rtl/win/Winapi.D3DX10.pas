...
function D3DX10SaveTextureToFile(
    ...
    pDestFile: PWideChar): HResult; stdcall; external d3dx10dll name 'D3DX10SaveTextureToFileW' delayed;
{$EXTERNALSYM D3DX10SaveTextureToFile}
function D3DX10SaveTextureToFileA(
    pSrcTexture: ID3D10Resource;
    DestFormat: D3DX10_IMAGE_FILE_FORMAT;
    pDestFile: PAnsiChar): HResult; stdcall; external d3dx10dll name 'D3DX10SaveTextureToFileA' delayed;
...
function D3DX10CreateAsyncFileLoader(pFileName: PWideChar; out ppDataLoader: ID3DX10DataLoader): HResult; stdcall; external d3dx10dll name 'D3DX10CreateAsyncFileLoaderW' delayed;
{$EXTERNALSYM D3DX10CreateAsyncFileLoader}
function D3DX10CreateAsyncFileLoaderA(pFileName: PAnsiChar; out ppDataLoader: ID3DX10DataLoader): HResult; stdcall; external d3dx10dll name 'D3DX10CreateAsyncFileLoaderA' delayed;
{$EXTERNALSYM D3DX10CreateAsyncFileLoaderA}
function D3DX10CreateAsyncFileLoaderW(pFileName: PWideChar; out ppDataLoader: ID3DX10DataLoader): HResult; stdcall; external d3dx10dll name 'D3DX10CreateAsyncFileLoaderW' delayed;
...
function D3DX10CreateAsyncResourceLoader(hSrcModule: HMODULE; pSrcResource: PWideChar; out ppDataLoader: ID3DX10DataLoader): HResult; stdcall; external d3dx10dll name 'D3DX10CreateAsyncResourceLoaderW' delayed;
{$EXTERNALSYM D3DX10CreateAsyncResourceLoaderA}
function D3DX10CreateAsyncResourceLoaderA(hSrcModule: HMODULE; pSrcResource: PAnsiChar; out ppDataLoader: ID3DX10DataLoader): HResult; stdcall; external d3dx10dll name 'D3DX10CreateAsyncResourceLoaderA' delayed;
{$EXTERNALSYM D3DX10CreateAsyncResourceLoaderA}
function D3DX10CreateAsyncResourceLoaderW(hSrcModule: HMODULE; pSrcResource: PWideChar; out ppDataLoader: ID3DX10DataLoader): HResult; stdcall; external d3dx10dll name 'D3DX10CreateAsyncResourceLoaderW' delayed;
{$EXTERNALSYM D3DX10CreateAsyncResourceLoaderA}
