...
type
  TGPGraphics = class;
  {$EXTERNALSYM TGPGraphics}
  TGPPen = class;
  {$EXTERNALSYM TGPPen}
  TGPBrush = class;
  {$EXTERNALSYM TGPBrush}
  TGPMatrix = class;
  {$EXTERNALSYM TGPMatrix}
  TGPBitmap = class;
  {$EXTERNALSYM TGPBitmap}
  TGPMetafile = class;
  {$EXTERNALSYM TGPMetafile}
  TGPFontFamily = class;
  {$EXTERNALSYM TGPFontFamily}
  TGPGraphicsPath = class;
  {$EXTERNALSYM TGPGraphicsPath}
  TGPRegion = class;
  {$EXTERNALSYM TGPRegion}
  TGPImage = class;
  {$EXTERNALSYM TGPImage}
  TGPHatchBrush = class;
  {$EXTERNALSYM TGPHatchBrush}
  TGPSolidBrush = class;
  {$EXTERNALSYM TGPSolidBrush}
  TGPLinearGradientBrush = class;
  {$EXTERNALSYM TGPLinearGradientBrush}
  TGPPathGradientBrush = class;
  {$EXTERNALSYM TGPPathGradientBrush}
  TGPFont = class;
  {$EXTERNALSYM TGPFont}
  TGPFontCollection = class;
  {$EXTERNALSYM TGPFontCollection}
  TGPInstalledFontCollection = class;
  {$EXTERNALSYM TGPInstalledFontCollection}
  TGPPrivateFontCollection = class;
  {$EXTERNALSYM TGPPrivateFontCollection}
  TGPImageAttributes = class;
  {$EXTERNALSYM TGPImageAttributes}
  TGPCachedBitmap = class;
  {$EXTERNALSYM TGPCachedBitmap}
...
//--------------------------------------------------------------------------
  ...
  {$EXTERNALSYM TGPGraphicsPathIterator}
...
\**************************************************************************)
  ...
  {$EXTERNALSYM TGPAdjustableArrowCap}
