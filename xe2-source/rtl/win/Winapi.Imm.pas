...
function ImmInstallIME(lpszIMEFileName, lpszLayoutText: PWideChar): HKL; stdcall;
...
function ImmGetDescription(hKl: HKL; PWideChar: PWideChar; uBufLen: UINT): UINT; stdcall;
...
function ImmGetIMEFileName(hKl: HKL; PWideChar: PWideChar; uBufLen: UINT): UINT; stdcall;
...
function ImmGetGuideLine(hImc: HIMC; dwIndex: DWORD; lpBuf: PWideChar; dwBufLen: DWORD): DWORD; stdcall;
...
function ImmGetConversionList(hKl: HKL; hImc: HIMC; lpSrc: PWideChar; lpDst: PCANDIDATELIST; dwBufLen: DWORD; uFlag: UINT ): DWORD; stdcall;
...
function ImmRegisterWord(hKl: HKL; lpszReading: PWideChar; dwStyle: DWORD; lpszRegister: PWideChar): Boolean; stdcall;
...
function ImmUnregisterWord(hKl: HKL; lpszReading: PWideChar; dwStyle: DWORD; lpszUnregister: PWideChar): Boolean; stdcall;
...
function ImmEnumRegisterWord(hKl: HKL; lpfnEnumProc: REGISTERWORDENUMPROC; lpszReading: PWideChar; dwStyle: DWORD; lpszRegister: PWideChar; lpData : pointer): UINT; stdcall;
