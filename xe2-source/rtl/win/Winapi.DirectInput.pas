...
type
  ...
  _DIACTIONFORMAT = _DIACTIONFORMATW;
...
type
  ...
  _DICONFIGUREDEVICESPARAMS = _DICONFIGUREDEVICESPARAMSW;
...
type
  ...
  _DIDEVICEIMAGEINFO = _DIDEVICEIMAGEINFOW;
  ...
  _DIDEVICEIMAGEINFOHEADER = _DIDEVICEIMAGEINFOHEADERW;
