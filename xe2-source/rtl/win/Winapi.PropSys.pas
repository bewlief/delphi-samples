...
{ interface INamedPropertyStore }
  ...
  INamedPropertyStore = interface(IUnknown) 
    ...
    function GetNamedValue(pszName: LPCWSTR; 
      out ppropvar: TPropVariant): HRESULT; stdcall;
  
    function SetNamedValue(pszName: LPCWSTR; 
...
type
  ...
  IPropertyChange = interface(IObjectWithPropertyKey)
    [SID_IPropertyChange]
    function ApplyToPropVariant(propvarIn: TPropVariant; 
...
type
  ...
  IPropertyDescription = interface(IUnknown) 
    ...
    function GetRelativeDescription(propvar1: TPropVariant; 
    ...
    function FormatForDisplay(propvar: TPropVariant; 
      pdfFlags: TPropDescFormatFlags; var ppszDisplay: LPWSTR): HRESULT; stdcall;
  
    function IsValueCanonical(propvar: TPropVariant): HRESULT; stdcall;
  end;
...
type
  ...
  IPropertyDescription2 = interface(IPropertyDescription) 
    ...
    function GetImageReferenceForValue(propvar: TPropVariant; 
