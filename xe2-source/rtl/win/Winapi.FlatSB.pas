...
function FlatSB_SetScrollProp(p1: HWND; index: Integer; newValue: INT_PTR;
...
var
  _FlatSB_GetScrollProp: function(p1: HWND; propIndex: Integer;
    p3: PInteger): Bool; stdcall;
  _FlatSB_SetScrollProp: function(p1: HWND; index: Integer; newValue: IntPtr;
    p4: Bool): Bool; stdcall;
...
function FlatSB_SetScrollProp(p1: HWND; index: Integer; newValue: IntPtr;
  p4: Bool): Bool; stdcall;
begin
