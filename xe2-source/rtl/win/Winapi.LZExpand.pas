...
function GetExpandedName(Source, Buffer: PWideChar): Integer; stdcall;
...
function LZOpenFile(Filename: PWideChar; var ReOpenBuff: TOFStruct; Style: Word): Integer; stdcall;
