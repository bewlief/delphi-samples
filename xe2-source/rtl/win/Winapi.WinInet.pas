...
type
  ...
  URL_COMPONENTS = record
    ...
    lpszUserName: LPTSTR;       { pointer to user name }
    dwUserNameLength: DWORD;    { length of user name }
    lpszPassword: LPTSTR;       { pointer to password }
    dwPasswordLength: DWORD;    { length of password }
    lpszUrlPath: LPTSTR;        { pointer to URL-path }
    dwUrlPathLength: DWORD;     { length of URL-path }
    lpszExtraInfo: LPTSTR;      { pointer to extra information (e.g. ?foo or #foo) }
...
function InternetCrackUrl(lpszUrl: PWideChar; dwUrlLength, dwFlags: DWORD;
...
function InternetCanonicalizeUrl(lpszUrl: PWideChar;
...
function InternetCombineUrl(lpszBaseUrl, lpszRelativeUrl: PWideChar;
  lpszBuffer: PWideChar; var lpdwBufferLength: DWORD;
  dwFlags: DWORD): BOOL; stdcall;
...
function InternetOpen(lpszAgent: PWideChar; dwAccessType: DWORD; 
...
function InternetConnect(hInet: HINTERNET; lpszServerName: PWideChar;
...
function InternetOpenUrl(hInet: HINTERNET; lpszUrl: PWideChar;
...
function InternetGetLastResponseInfo(var lpdwError: DWORD; lpszBuffer: PWideChar;
...
function FtpFindFirstFile(hConnect: HINTERNET; lpszSearchFile: PWideChar;
...
function FtpGetFile(hConnect: HINTERNET; lpszRemoteFile: PWideChar;
...
function FtpPutFile(hConnect: HINTERNET; lpszLocalFile: PWideChar;
  lpszNewRemoteFile: PWideChar; dwFlags: DWORD; dwContext: DWORD_PTR): BOOL; stdcall;
  {$EXTERNALSYM FtpPutFile}
function FtpPutFileA(hConnect: HINTERNET; lpszLocalFile: PAnsiChar;
  lpszNewRemoteFile: PAnsiChar; dwFlags: DWORD; dwContext: DWORD_PTR): BOOL; stdcall;
  {$EXTERNALSYM FtpPutFileA}
function FtpPutFileW(hConnect: HINTERNET; lpszLocalFile: PWideChar;
  lpszNewRemoteFile: PWideChar; dwFlags: DWORD; dwContext: DWORD_PTR): BOOL; stdcall;
  {$EXTERNALSYM FtpPutFileW}

function FtpDeleteFile(hConnect: HINTERNET; lpszFileName: PWideChar): BOOL; stdcall;
...
function FtpRenameFile(hConnect: HINTERNET; lpszExisting: PWideChar;
...
function FtpOpenFile(hConnect: HINTERNET; lpszFileName: PWideChar;
...
function FtpCreateDirectory(hConnect: HINTERNET; lpszDirectory: PWideChar): BOOL; stdcall;
...
function FtpRemoveDirectory(hConnect: HINTERNET; lpszDirectory: PWideChar): BOOL; stdcall;
...
function FtpSetCurrentDirectory(hConnect: HINTERNET; lpszDirectory: PWideChar): BOOL; stdcall;
...
function FtpCommand(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PWideChar; dwContext: DWORD_PTR): BOOL; overload; stdcall;
  {$EXTERNALSYM FtpCommand}
function FtpCommandA(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PAnsiChar; dwContext: DWORD_PTR): BOOL; overload; stdcall;
  {$EXTERNALSYM FtpCommandA}
function FtpCommandW(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PWideChar; dwContext: DWORD_PTR): BOOL; overload; stdcall;
  {$EXTERNALSYM FtpCommandW}
function FtpCommand(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PWideChar; dwContext: DWORD_PTR; phFtpCommand: PHINTERNET): BOOL; overload; stdcall;
  {$EXTERNALSYM FtpCommand}
function FtpCommandA(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PAnsiChar; dwContext: DWORD_PTR; phFtpCommand: PHINTERNET): BOOL; overload; stdcall;
  {$EXTERNALSYM FtpCommandA}
function FtpCommandW(hConnect: HINTERNET; fExpectResponse: BOOL;
  dwFlags: DWORD; lpszCommand: PWideChar; dwContext: DWORD_PTR; phFtpCommand: PHINTERNET): BOOL; overload; stdcall;
  {$EXTERNALSYM FtpCommandW}
...
function GopherCreateLocator(lpszHost: PWideChar; nServerPort: INTERNET_PORT;
...
function GopherGetLocatorType(lpszLocator: PWideChar;
...
function GopherFindFirstFile(hConnect: HINTERNET; lpszLocator: PWideChar;
...
function GopherOpenFile(hConnect: HINTERNET; lpszLocator: PWideChar;
  lpszView: PWideChar; dwFlags: DWORD; dwContext: DWORD_PTR): HINTERNET; stdcall;
  {$EXTERNALSYM GopherOpenFile}
function GopherOpenFileA(hConnect: HINTERNET; lpszLocator: PAnsiChar;
  lpszView: PAnsiChar; dwFlags: DWORD; dwContext: DWORD_PTR): HINTERNET; stdcall;
...
function GopherGetAttribute(hConnect: HINTERNET; lpszLocator: PWideChar;
...
function HttpOpenRequest(hConnect: HINTERNET; lpszVerb: PWideChar;
...
function HttpAddRequestHeaders(hRequest: HINTERNET; lpszHeaders: PWideChar;
...
function HttpSendRequest(hRequest: HINTERNET; lpszHeaders: PWideChar; 
...
function InternetCheckConnection(lpszUrl: PWideChar; dwFlags: DWORD;
...
function InternetCheckConnectionW(lpszUrl: PWideChar; dwFlags: DWORD;
    dwReserved: DWORD): BOOL; stdcall;
...
type
  ...
  INTERNET_CACHE_ENTRY_INFOW = record
    dwStructSize: DWORD;         { version of cache system. ?? do we need this for all entries? }
    lpszSourceUrlName: PWideChar;   { embedded pointer to the URL name UnicodeString. }
...
function CreateUrlCacheEntry(lpszUrlName: PWideChar;
  dwExpectedFileSize: DWORD; lpszFileExtension: PWideChar;
...
function CreateUrlCacheEntryW(lpszUrlName: PWideChar;
  dwExpectedFileSize: DWORD; lpszFileExtension: PWideChar;
  lpszFileName: PWideChar; dwReserved: DWORD): BOOL; stdcall;
  {$EXTERNALSYM CreateUrlCacheEntryW}

function CommitUrlCacheEntry(lpszUrlName, lpszLocalFileName: PWideChar;
...
function RetrieveUrlCacheEntryFile(lpszUrlName: PWideChar;
...
function RetrieveUrlCacheEntryFileW(lpszUrlName: PWideChar;
  var lpCacheEntryInfo: TInternetCacheEntryInfo;
  var lpdwCacheEntryInfoBufferSize: DWORD;
  dwReserved: DWORD): BOOL; stdcall;
  {$EXTERNALSYM RetrieveUrlCacheEntryFileW}

function UnlockUrlCacheEntryFile(lpszUrlName: PWideChar;
  dwReserved: DWORD): BOOL; stdcall;
...
function RetrieveUrlCacheEntryStream(lpszUrlName: PWideChar;
  var lpCacheEntryInfo: TInternetCacheEntryInfo;
...
function RetrieveUrlCacheEntryStreamW(lpszUrlName: PWideChar;
  var lpCacheEntryInfo: TInternetCacheEntryInfo;
  var lpdwCacheEntryInfoBufferSize: DWORD; fRandomRead: BOOL;
  dwReserved: DWORD): THandle; stdcall;
...
function GetUrlCacheEntryInfo(lpszUrlName: PWideChar;
  var lpCacheEntryInfo: TInternetCacheEntryInfo;
...
function GetUrlCacheEntryInfoW(lpszUrlName: PWideChar;
  var lpCacheEntryInfo: TInternetCacheEntryInfo;
  var lpdwCacheEntryInfoBufferSize: DWORD): BOOL; stdcall;
  {$EXTERNALSYM GetUrlCacheEntryInfoW}

function GetUrlCacheEntryInfoEx(lpszUrl: PWideChar;
...
function GetUrlCacheEntryInfoExA(lpszUrl: PAnsiChar;
    lpCacheEntryInfo: PInternetCacheEntryInfo;
    lpdwCacheEntryInfoBufSize: LPDWORD;
    lpszReserved: PAnsiChar; { must pass nil }
    lpdwReserved: LPDWORD; { must pass nil }
...
function GetUrlCacheEntryInfoExW(lpszUrl: PWideChar;
    lpCacheEntryInfo: PInternetCacheEntryInfo;
    lpdwCacheEntryInfoBufSize: LPDWORD;
    lpszReserved: PAnsiChar; { must pass nil }
    lpdwReserved: LPDWORD; { must pass nil }
...
function SetUrlCacheEntryInfo(lpszUrlName: PWideChar;
  var lpCacheEntryInfo: TInternetCacheEntryInfo;
...
function SetUrlCacheEntryInfoW(lpszUrlName: PWideChar;
  var lpCacheEntryInfo: TInternetCacheEntryInfo;
  dwFieldControl: DWORD): BOOL; stdcall;
...
function SetUrlCacheEntryGroup(lpszUrlName: PWideChar; dwFlags: DWORD;
  GroupId: GROUPID;
  pbGroupAttributes: PWideChar; { must pass nil }
  cbGroupAttributes: DWORD;  { must pass 0 }
  lpReserved: Pointer        { must pass nil }
  ): Bool; stdcall;
  {$EXTERNALSYM SetUrlCacheEntryGroup}
function SetUrlCacheEntryGroupA(lpszUrlName: PAnsiChar; dwFlags: DWORD;
  GroupId: GROUPID;
  pbGroupAttributes: PAnsiChar; { must pass nil }
  cbGroupAttributes: DWORD;  { must pass 0 }
  lpReserved: Pointer        { must pass nil }
  ): Bool; stdcall;
  {$EXTERNALSYM SetUrlCacheEntryGroupA}
function SetUrlCacheEntryGroupW(lpszUrlName: PWideChar; dwFlags: DWORD;
  GroupId: GROUPID;
  pbGroupAttributes: PWideChar; { must pass nil }
  cbGroupAttributes: DWORD;  { must pass 0 }
  lpReserved: Pointer        { must pass nil }
...
function FindFirstUrlCacheEntryEx(lpszUrlSearchPattern: PWideChar;
    dwFlags: DWORD;
    dwFilter: DWORD;
    GroupId: GROUPID;
...
function FindFirstUrlCacheEntryExW(lpszUrlSearchPattern: PWideChar;
    dwFlags: DWORD;
    dwFilter: DWORD;
    GroupId: GROUPID;
...
function FindFirstUrlCacheEntry(lpszUrlSearchPattern: PWideChar;
...
function DeleteUrlCacheEntry(lpszUrlName: PWideChar): BOOL; stdcall;
...
function FtpCommand(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PWideChar; dwContext: DWORD_PTR): BOOL; external winetdll name 'FtpCommandW';
function FtpCommandA(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PAnsiChar; dwContext: DWORD_PTR): BOOL; external winetdll name 'FtpCommandA';
function FtpCommandW(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PWideChar; dwContext: DWORD_PTR): BOOL; external winetdll name 'FtpCommandW';
function FtpCommand(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PWideChar; dwContext: DWORD_PTR; phFtpCommand: PHINTERNET): BOOL; external winetdll name 'FtpCommandW';
function FtpCommandA(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PAnsiChar; dwContext: DWORD_PTR; phFtpCommand: PHINTERNET): BOOL; external winetdll name 'FtpCommandA';
function FtpCommandW(hConnect: HINTERNET; fExpectResponse: BOOL; dwFlags: DWORD;
  lpszCommand: PWideChar; dwContext: DWORD_PTR; phFtpCommand: PHINTERNET): BOOL; external winetdll name 'FtpCommandW';
