...
type
  ...
  _DRIVER_INFO_8A = record
    ...
    pszHardwareID: PAnsiChar;
    pszProvider: PAnsiChar;
    pszPrintProcessor: PAnsiChar;
    pszVendorSetup: PAnsiChar;
    pszzColorProfiles: PAnsiChar;
    pszInfPath: PAnsiChar;
    dwPrinterDriverAttributes: DWORD;
    pszzCodeDriverDependencies: PAnsiChar;
  ...
  _DRIVER_INFO_8W = record
    ...
    pszHardwareID: PWideChar;
    pszProvider: PWideChar;
    pszPrintProcessor: PWideChar;
    pszVendorSetup: PWideChar;
    pszzColorProfiles: PWideChar;
    pszInfPath: PWideChar;
    dwPrinterDriverAttributes: DWORD;
    pszzCodeDriverDependencies: PWideChar;
    ftMinInboxDriverVerDate: FILETIME;
    dwlMinInboxDriverVerVersion: DWORDLONG;
  end;
...
function EnumPrinters(Flags: DWORD; Name: PWideChar; Level: DWORD;
...
function OpenPrinter(pPrinterName: PWideChar; var phPrinter: THandle; pDefault: PPrinterDefaults): BOOL; stdcall;
...
function AddPrinter(pName: PWideChar; Level: DWORD; pPrinter: Pointer): THandle; stdcall;
...
function AddPrinterDriver(pName: PWideChar; Level: DWORD; pDriverInfo: Pointer): BOOL; stdcall;
...
function AddPrinterDriverEx(pName: PWideChar; Level: DWORD; pDriverInfo: Pointer;
  dwFileCopyFlags: DWORD): BOOL; stdcall;
{$EXTERNALSYM AddPrinterDriverExA}
function AddPrinterDriverExA(pName: PAnsiChar; Level: DWORD; pDriverInfo: Pointer;
  dwFileCopyFlags: DWORD): BOOL; stdcall;
{$EXTERNALSYM AddPrinterDriverExW}
function AddPrinterDriverExW(pName: PWideChar; Level: DWORD; pDriverInfo: Pointer;
  dwFileCopyFlags: DWORD): BOOL; stdcall;
{$EXTERNALSYM EnumPrinterDrivers}
function EnumPrinterDrivers(pName, pEnvironment: PWideChar; Level: DWORD;
...
function EnumPrinterKey(hPrinter: THandle; pKeyName: PWideChar; pSubKey: PWideChar;
  cbSubkey: DWORD; pcbSubkey: LPDWORD): DWORD; stdcall;
{$EXTERNALSYM EnumPrinterKeyA}
function EnumPrinterKeyA(hPrinter: THandle; pKeyName: PAnsiChar; pSubKey: PAnsiChar;
  cbSubkey: DWORD; pcbSubkey: LPDWORD): DWORD; stdcall;
{$EXTERNALSYM EnumPrinterKeyW}
function EnumPrinterKeyW(hPrinter: THandle; pKeyName: PWideChar; pSubKey: PWideChar;
  cbSubkey: DWORD; pcbSubkey: LPDWORD): DWORD; stdcall;
{$EXTERNALSYM GetPrinterDriver}
function GetPrinterDriver(hPrinter: THandle; pEnvironment: PWideChar; Level: DWORD;
...
function GetPrinterDriverDirectory(pName, pEnvironment: PWideChar; Level: DWORD;
...
function DeletePrinterDriver(pName, pEnvironment, pDriverName: PWideChar): BOOL; stdcall;
...
function DeletePrinterDriverEx(pName: PWideChar; pEnvironment: PWideChar;
  pDriverName: PWideChar; dwDeleteFlag, dwVersionFlag: DWORD): BOOL; stdcall;
{$EXTERNALSYM DeletePrinterDriverExA}
function DeletePrinterDriverExA(pName: PAnsiChar; pEnvironment: PAnsiChar;
  pDriverName: PAnsiChar; dwDeleteFlag, dwVersionFlag: DWORD): BOOL; stdcall;
{$EXTERNALSYM DeletePrinterDriverExW}
function DeletePrinterDriverExW(pName: PWideChar; pEnvironment: PWideChar;
  pDriverName: PWideChar; dwDeleteFlag, dwVersionFlag: DWORD): BOOL; stdcall;
{$EXTERNALSYM DeletePrinterKey}
function DeletePrinterKey(hPrinter: THandle; pKeyName: PWideChar): DWORD; stdcall;
{$EXTERNALSYM DeletePrinterKeyA}
function DeletePrinterKeyA(hPrinter: THandle; pKeyName: PAnsiChar): DWORD; stdcall;
{$EXTERNALSYM DeletePrinterKeyW}
function DeletePrinterKeyW(hPrinter: THandle; pKeyName: PWideChar): DWORD; stdcall;
{$EXTERNALSYM AddPrintProcessor}
function AddPrintProcessor(pName, pEnvironment, pPathName, pPrintProcessorName: PWideChar): BOOL; stdcall;
...
function EnumPrintProcessors(pName, pEnvironment: PWideChar; Level: DWORD; pPrintProcessorInfo: Pointer;
...
function GetPrintProcessorDirectory(pName, pEnvironment: PWideChar; Level: DWORD;
...
function EnumPrintProcessorDatatypes(pName, pPrintProcessorName: PWideChar; Level: DWORD;
...
function DeletePrintProcessor(pName, pEnvironment, pPrintProcessorName: PWideChar): BOOL; stdcall;
...
function AdvancedDocumentProperties(hWnd: HWND; hPrinter: THandle; pDeviceName: PWideChar;
...
function GetPrinterData(hPrinter: THandle; pValueName: PWideChar; pType: PDWORD;
  pData: Pointer; nSize: DWORD; var pcbNeeded: DWORD): DWORD; stdcall;
{$EXTERNALSYM GetPrinterDataA}
function GetPrinterDataA(hPrinter: THandle; pValueName: PAnsiChar; pType: PDWORD;
  pData: Pointer; nSize: DWORD; var pcbNeeded: DWORD): DWORD; stdcall;
{$EXTERNALSYM GetPrinterDataW}
function GetPrinterDataW(hPrinter: THandle; pValueName: PWideChar; pType: PDWORD;
  pData: Pointer; nSize: DWORD; var pcbNeeded: DWORD): DWORD; stdcall;
{$EXTERNALSYM GetPrinterDataEx}
function GetPrinterDataEx(hPrinter: THandle; pKeyName, pValueName: PWideChar;
  pType: LPDWORD; pData: LPBYTE; nSize: DWORD; pcbNeeded: LPDWORD): DWORD; stdcall;
{$EXTERNALSYM GetPrinterDataExA}
function GetPrinterDataExA(hPrinter: THandle; pKeyName, pValueName: PAnsiChar;
  pType: LPDWORD; pData: LPBYTE; nSize: DWORD; pcbNeeded: LPDWORD): DWORD; stdcall;
{$EXTERNALSYM GetPrinterDataExW}
function GetPrinterDataExW(hPrinter: THandle; pKeyName, pValueName: PWideChar;
  pType: LPDWORD; pData: LPBYTE; nSize: DWORD; pcbNeeded: LPDWORD): DWORD; stdcall;
{$EXTERNALSYM EnumPrinterData}
function EnumPrinterData(hPrinter: THandle; dwIndex: DWORD; pValueName: PWideChar;
...
function EnumPrinterDataEx(hPrinter: THandle; pKeyName: PWideChar;
...
function EnumPrinterDataExA(hPrinter: THandle; pKeyName: PAnsiChar;
  pEnumValues: LPBYTE; cbEnumValues: DWORD; pcbEnumValues: LPDWORD;
  pnEnumValues: LPDWORD): DWORD; stdcall;
{$EXTERNALSYM EnumPrinterDataExW}
function EnumPrinterDataExW(hPrinter: THandle; pKeyName: PWideChar;
  pEnumValues: LPBYTE; cbEnumValues: DWORD; pcbEnumValues: LPDWORD;
  pnEnumValues: LPDWORD): DWORD; stdcall;
{$EXTERNALSYM SetPrinterData}
function SetPrinterData(hPrinter: THandle; pValueName: PWideChar; dwType: DWORD;
  pData: Pointer; cbData: DWORD): DWORD; stdcall;
{$EXTERNALSYM SetPrinterDataA}
function SetPrinterDataA(hPrinter: THandle; pValueName: PAnsiChar; dwType: DWORD;
  pData: Pointer; cbData: DWORD): DWORD; stdcall;
{$EXTERNALSYM SetPrinterDataW}
function SetPrinterDataW(hPrinter: THandle; pValueName: PWideChar; dwType: DWORD;
  pData: Pointer; cbData: DWORD): DWORD; stdcall;
{$EXTERNALSYM SetPrinterDataEx}
function SetPrinterDataEx(hPrinter: THandle; pKeyName, pValueName: PWideChar;
  AType: DWORD; pData: LPBYTE; cbData: DWORD): DWORD; stdcall;
{$EXTERNALSYM SetPrinterDataExA}
function SetPrinterDataExA(hPrinter: THandle; pKeyName, pValueName: PAnsiChar;
  AType: DWORD; pData: LPBYTE; cbData: DWORD): DWORD; stdcall;
{$EXTERNALSYM SetPrinterDataExW}
function SetPrinterDataExW(hPrinter: THandle; pKeyName, pValueName: PWideChar;
  AType: DWORD; pData: LPBYTE; cbData: DWORD): DWORD; stdcall;
{$EXTERNALSYM DeletePrinterData}
function DeletePrinterData(hPrinter: THandle; pValueName: PWideChar): DWORD; stdcall;
...
function DeletePrinterDataEx(hPrinter: THandle; pKeyName: PWideChar;
  pValueName: PWideChar): DWORD; stdcall;
{$EXTERNALSYM DeletePrinterDataExA}
function DeletePrinterDataExA(hPrinter: THandle; pKeyName: PAnsiChar;
  pValueName: PAnsiChar): DWORD; stdcall;
{$EXTERNALSYM DeletePrinterDataExW}
function DeletePrinterDataExW(hPrinter: THandle; pKeyName: PWideChar;
  pValueName: PWideChar): DWORD; stdcall;
...
function GetDefaultPrinter(pszBuffer: PWideChar; pcchBuffer: LPDWORD): BOOL; stdcall;
{$EXTERNALSYM GetDefaultPrinterA}
function GetDefaultPrinterA(pszBuffer: PAnsiChar; pcchBuffer: LPDWORD): BOOL; stdcall;
{$EXTERNALSYM GetDefaultPrinterW}
function GetDefaultPrinterW(pszBuffer: PWideChar; pcchBuffer: LPDWORD): BOOL; stdcall;
...
function PrinterMessageBox(hPrinter: THandle; Error: DWORD; hWnd: HWND;
  pText, pCaption: PWideChar; dwType: DWORD): DWORD; stdcall;
{$EXTERNALSYM PrinterMessageBoxA}
function PrinterMessageBoxA(hPrinter: THandle; Error: DWORD; hWnd: HWND;
  pText, pCaption: PAnsiChar; dwType: DWORD): DWORD; stdcall;
...
function DeleteForm(hPrinter: THandle; pFormName: PWideChar): BOOL; stdcall;
...
function EnumMonitors(pName: PWideChar; Level: DWORD; pMonitors: Pointer; cbBuf: DWORD;
  var pcbNeeded, pcReturned: DWORD): BOOL; stdcall;
...
function AddMonitor(pName: PWideChar; Level: DWORD; pMonitors: Pointer): BOOL; stdcall;
...
function DeleteMonitor(pName, pEnvironment, pMonitorName: PWideChar): BOOL; stdcall;
...
function EnumPorts(pName: PWideChar; Level: DWORD; pPorts: Pointer; cbBuf: DWORD;
  var pcbNeeded, pcReturned: DWORD): BOOL; stdcall;
...
function EnumPortsW(pName: PWideChar; Level: DWORD; pPorts: Pointer; cbBuf: DWORD;
  var pcbNeeded, pcReturned: DWORD): BOOL; stdcall;
{$EXTERNALSYM AddPort}
function AddPort(pName: PWideChar; hWnd: HWND; pMonitorName: PWideChar): BOOL; stdcall;
...
function ConfigurePort(pName: PWideChar; hWnd: HWND; pPortName: PWideChar): BOOL; stdcall;
...
function DeletePort(pName: PWideChar; hWnd: HWND; pPortName: PWideChar): BOOL; stdcall;
...
{$EXTERNALSYM SetPort}
function SetPort(pName, pPortName: PWideChar; dwLevel: DWORD; pPortInfo: Pointer): BOOL; stdcall;
...
function AddPrinterConnection(pName: PWideChar): BOOL; stdcall;
...
function DeletePrinterConnection(pName: PWideChar): BOOL; stdcall;
...
function AddPrintProvidor(pName: PWideChar; level: DWORD; pProvidorInfo: Pointer): BOOL; stdcall;
...
function DeletePrintProvidor(pName, pEnvironment, pPrintProvidorName: PWideChar): BOOL; stdcall;
...
function AddPrinterConnection2(hWnd: HWND; pszName: PWideChar; dwLevel: DWORD;
  pConnectionInfo: PPrinterConnectionInfo1): BOOL; stdcall;
{$EXTERNALSYM AddPrinterConnection2A}
function AddPrinterConnection2A(hWnd: HWND; pszName: PAnsiChar; dwLevel: DWORD;
  pConnectionInfo: PPrinterConnectionInfo1): BOOL; stdcall;
{$EXTERNALSYM AddPrinterConnection2W}
function AddPrinterConnection2W(hWnd: HWND; pszName: PWideChar; dwLevel: DWORD;
  pConnectionInfo: PPrinterConnectionInfo1): BOOL; stdcall;
...
function CorePrinterDriverInstalled(pszServer: PWideChar; pszEnvironment: PWideChar;
...
function CorePrinterDriverInstalledA(pszServer: PAnsiChar; pszEnvironment: PAnsiChar;
  CoreDriverGUID: TGUID; ftDriverDate: FILETIME; dwlDriverVersion: DWORDLONG;
  pbDriverInstalled: PBOOL): HRESULT; stdcall;
{$EXTERNALSYM CorePrinterDriverInstalledW}
function CorePrinterDriverInstalledW(pszServer: PWideChar; pszEnvironment: PWideChar;
  CoreDriverGUID: TGUID; ftDriverDate: FILETIME; dwlDriverVersion: DWORDLONG;
  pbDriverInstalled: PBOOL): HRESULT; stdcall;
{$EXTERNALSYM DeletePrinterDriverPackage}
function DeletePrinterDriverPackage(pszServer: PWideChar; pszInfPath: PWideChar;
  pszEnvironment: PWideChar): HRESULT; stdcall;
{$EXTERNALSYM DeletePrinterDriverPackageA}
function DeletePrinterDriverPackageA(pszServer: PAnsiChar; pszInfPath: PAnsiChar;
  pszEnvironment: PAnsiChar): HRESULT; stdcall;
{$EXTERNALSYM DeletePrinterDriverPackageW}
function DeletePrinterDriverPackageW(pszServer: PWideChar; pszInfPath: PWideChar;
  pszEnvironment: PWideChar): HRESULT; stdcall;
...
function GetCorePrinterDrivers(pszServer: PWideChar; pszEnvironment: PWideChar;
  pszzCoreDriverDependencies: PWideChar; cCorePrinterDrivers: DWORD;
  pCorePrinterDrivers: PCorePrinterDriver): HRESULT; stdcall;
{$EXTERNALSYM GetCorePrinterDriversA}
function GetCorePrinterDriversA(pszServer: PAnsiChar; pszEnvironment: PAnsiChar;
  pszzCoreDriverDependencies: PAnsiChar; cCorePrinterDrivers: DWORD;
  pCorePrinterDrivers: PCorePrinterDriverA): HRESULT; stdcall;
{$EXTERNALSYM GetCorePrinterDriversW}
function GetCorePrinterDriversW(pszServer: PWideChar; pszEnvironment: PWideChar;
  pszzCoreDriverDependencies: PWideChar; cCorePrinterDrivers: DWORD;
...
function GetPrinterDriver2(hWnd: HWND; hPrinter: THandle;
  pEnvironment: PWideChar; Level: DWORD; pDriverInfo: LPBYTE; cbBuf: DWORD;
  pcbNeeded: LPDWORD): BOOL; stdcall;
{$EXTERNALSYM GetPrinterDriver2A}
function GetPrinterDriver2A(hWnd: HWND; hPrinter: THandle;
  pEnvironment: PAnsiChar; Level: DWORD; pDriverInfo: LPBYTE; cbBuf: DWORD;
  pcbNeeded: LPDWORD): BOOL; stdcall;
...
function GetPrinterDriverPackagePath(pszServer, pszEnvironment, pszLanguage,
  pszPackageID: PWideChar; pszDriverPackageCab: PWideChar; cchDriverPackageCab: DWORD;
...
function GetPrinterDriverPackagePathA(pszServer, pszEnvironment, pszLanguage,
  pszPackageID: PAnsiChar; pszDriverPackageCab: PAnsiChar; cchDriverPackageCab: DWORD;
  pcchRequiredSize: LPDWORD): HRESULT; stdcall;
...
function OpenPrinter2(pPrinterName: PWideChar; phPrinter: PHANDLE;
  pDefault: PPrinterDefaultsW; pOptions: PPrinterOptionsW): BOOL; stdcall;
{$EXTERNALSYM OpenPrinter2A}
function OpenPrinter2A(pPrinterName: PAnsiChar; phPrinter: PHANDLE;
  pDefault: PPrinterDefaultsA; pOptions: PPrinterOptionsA): BOOL; stdcall;
{$EXTERNALSYM OpenPrinter2W}
function OpenPrinter2W(pPrinterName: PWideChar; phPrinter: PHANDLE;
  pDefault: PPrinterDefaultsW; pOptions: PPrinterOptionsW): BOOL; stdcall;
...
function SetDefaultPrinter(pszPrinter: PWideChar): BOOL; stdcall;
{$EXTERNALSYM SetDefaultPrinterA}
function SetDefaultPrinterA(pszPrinter: PAnsiChar): BOOL; stdcall;
...
function UploadPrinterDriverPackage(pszServer, pszInfPath, pszEnvironment: PWideChar;
  dwFlags: DWORD; hwnd: HWND; pszDestInfPath: PWideChar;
  pcchDestInfPath: PULONG): HRESULT; stdcall;
{$EXTERNALSYM UploadPrinterDriverPackageA}
function UploadPrinterDriverPackageA(pszServer, pszInfPath, pszEnvironment: PAnsiChar;
  dwFlags: DWORD; hwnd: HWND; pszDestInfPath: PAnsiChar;
  pcchDestInfPath: PULONG): HRESULT; stdcall;
{$EXTERNALSYM UploadPrinterDriverPackageW}
function UploadPrinterDriverPackageW(pszServer, pszInfPath, pszEnvironment: PWideChar;
  dwFlags: DWORD; hwnd: HWND; pszDestInfPath: PWideChar;
  pcchDestInfPath: PULONG): HRESULT; stdcall;
{$EXTERNALSYM XcvData}
...
{$ENDIF}
{$IFDEF LINUX}
  winspl = 'libwinspool.drv.borland.so';
{$ENDIF}
