...
(*$HPPEMIT '#include <asptlb.h>'*)

(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IStringList)'*)
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IRequestDictionary)'*)
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IRequest)'*)
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IReadCookie)'*)
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IWriteCookie)'*)
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IResponse)'*)
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IVariantDictionary)'*)
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(ISessionObject)'*)
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IApplicationObject)'*)
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IServer)'*)
(*$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IScriptingContext)'*)

(*$HPPEMIT '// comsvcs.h contains a macro for GetObjectContext that '*)
(*$HPPEMIT '// conflicts with TASPMTSObject::GetObjectContext() '*)
(*$HPPEMIT '// Use CoGetObjectContext directly:( '*)
(*$HPPEMIT '#if defined(GetObjectContext)'*)
(*$HPPEMIT '  #undef GetObjectContext'*)
(*$HPPEMIT '#endif'*)


uses
  Winapi.ActiveX, System.Win.ComObj, Winapi.Mtx;
...
type
  ...
  public
    property Application: IApplicationObject read GetApplication;
    property ObjectContext: IObjectContext read GetObjectContext;
    property Request: IRequest read GetRequest;
    property Response: IResponse read GetResponse;
    property Session: ISessionObject read GetSession;
    property Server: IServer read GetServer;
...
procedure TASPObject.OnStartPage(const AScriptingContext: IUnknown);
begin
...
begin
  Result := IUnknown((Winapi.Mtx.GetObjectContext as IGetContextProperties).GetProperty('Application')) as IApplicationObject;
end;

function TASPMTSObject.GetRequest: IRequest;
begin
  Result := IUnknown((Winapi.Mtx.GetObjectContext as IGetContextProperties).GetProperty('Request')) as IRequest;
end;

function TASPMTSObject.GetResponse: IResponse;
begin
  Result := IUnknown((Winapi.Mtx.GetObjectContext as IGetContextProperties).GetProperty('Response')) as IResponse;
end;

function TASPMTSObject.GetServer: IServer;
begin
  Result := IUnknown((Winapi.Mtx.GetObjectContext as IGetContextProperties).GetProperty('Server')) as IServer;
end;

function TASPMTSObject.GetSession: ISessionObject;
begin
  Result := IUnknown((Winapi.Mtx.GetObjectContext as IGetContextProperties).GetProperty('Session')) as ISessionObject;
end;

function TASPMTSObject.GetObjectContext: IObjectContext;
begin
  Result := Winapi.Mtx.GetObjectContext;
end;
