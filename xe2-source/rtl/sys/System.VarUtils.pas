...
{$IFDEF MSWINDOWS}
uses Winapi.Windows
  {$IFDEF GENERICVARIANTS}
  , Variants
  {$ENDIF}
;
{$ELSE}
  {$IF GenericSafeArrayUsesLibC}
uses Posix.Stdlib, System.Variants;
  {$IFEND}
{$ENDIF}
...
begin
  ...
  case (LSource.VType and varTypeMask) of // strip off modifier flags
    ...
    varOleStr:
      WideString(Pointer(Dest.VOleStr)) := Copy(PPWideChar(LSource.VPointer)^, 1, MaxInt);
    varDispatch:
      ...
      case LSource.VType of
        ...
        varOleStr:
          case VarType of
            ...
            varInt64:
              Dest.VInt64 := StrToInt64(WideString(LSource.VOleStr));
            varUInt64:
              Dest.VUInt64 := StrToInt64(WideString(LSource.VOleStr));
          else
            Result := VAR_TYPEMISMATCH;
          end;
        varDispatch:
        ...
        varInt64:
          case VarType of
            ...
            varOleStr:
              WideString(Pointer(Dest.VOleStr)) := IntToStr(LSource.VInt64);
            varBoolean:
        ...
        varUInt64:
          case VarType of
            ...
            varOleStr:
              WideString(Pointer(Dest.VOleStr)) := IntToStr(LSource.VUInt64);
            varBoolean:
...
var
  ...
  function FindProc(const AName: PAnsiChar; ADefault: Pointer): Pointer;
  begin
    Result := ADefault;
    if LHandle <> 0 then
    begin
