...
begin
  ...
  if ReturnType <> nil then
    ...
    Result := System.Rtti.Invoke(code, argList, CallingConvention, parList[0].ParamType.Handle, IsStatic)
  else
...
begin
  ...
  if ReturnType <> nil then
    ...
    Result := System.Rtti.Invoke(code, argList, CallingConvention, cls.ClassInfo, IsStatic)
  else
