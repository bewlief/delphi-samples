...
uses System.SysUtils, System.Variants, System.VarUtils, System.RTLConsts;
...
begin
  ...
  MethodName := UTF8ToString(PMethodInfoHeader(MethodInfo)^.Name);
  ...
  begin
    ...
    begin
      if ([pfVar, pfOut, pfResult, pfAddress, pfReference] * Param^.Flags = [])
          ...
          and (GetVariantType(Param^.ParamType^) <> varCurrency) then
