  ...
  try
    ...
    begin
      ...
      begin
        ...
        if CheckResult(RegEnumKeyEx(DeleteKey, DWORD(I), PChar(KeyName), Len, nil, nil, nil,
          nil)) then
...
procedure TRegistryIniFile.ReadSubSections(const Section: string; Strings: TStrings;
