...
{$ENDIF}
  ...
  sObserverNoSinglecastFound = 'No single cast observer with ID %s was added to the observer collection';
  sObserverNoMulticastFound = 'No multi cast observer with ID %s was added to the observer collection';
