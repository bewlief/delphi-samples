...
begin
  ...
  begin
    ...
    PropInfo := GetPropInfo(UTF8ToString(Name), Instance, CompIndex);
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        Params := PParamInfo(PByte(Info) + SizeOf(Info^) - SizeOf(ShortString) + 1
...
begin
  Result := System.ObjAuto.GetMethodInfo(FInstance, AName);
  if Result <> nil then
    AInstance := FInstance;
end;
  ...
  try
    ...
    begin
      ...
      case DispatchInfo.Kind of
        ...
        dkMethod:
          begin
            ReturnInfo := PReturnInfo(PByte(DispatchInfo.MethodInfo) + SizeOf(TMethodInfoHeader) - SizeOf(ShortString) + 1 +
