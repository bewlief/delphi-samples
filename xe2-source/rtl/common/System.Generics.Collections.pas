...
uses
  System.SysUtils, System.Classes, System.Generics.Defaults, System.SyncObjs, System.SysConst, System.RTLConsts;
...
begin
  ...
  begin
    ...
    if offset > 0 then
      ...
      FillChar(FItems[Count], (- offset) * SizeOf(FItems[0]), 0);
    Inc(FTail, offset);
  end
