...
type
  TSQLAllocConnect = function(EnvironmentHandle: SQLHENV; var ConnectionHandle: SQLHDBC): SQLRETURN stdcall;

  TSQLAllocEnv = function(var EnvironmentHandle: SQLHENV): SQLRETURN stdcall;

  TSQLAllocHandle = function(HandleType: SQLSMALLINT; InputHandle: SQLHANDLE; var OutputHandle: SQLHANDLE): SQLRETURN stdcall;

  TSQLAllocStmt = function(ConnectionHandle: SQLHDBC; var StatementHandle: SQLHSTMT): SQLRETURN stdcall;

  TSQLBindCol = function(StatementHandle: SQLHSTMT; ColumnNumber: SQLUSMALLINT;
                         TargetType: SQLSMALLINT; TargetValue: SQLPOINTER;
                         BufferLength: SQLLEN; StrLen_or_Ind: PSQLLEN): SQLRETURN stdcall;

  TSQLBindParam = function(StatementHandle: SQLHSTMT; ParameterNumber: SQLUSMALLINT;
  ...
  TSQLCancelHandle = function(HandleType: SQLSMALLINT; InputHandle: SQLHANDLE): SQLRETURN stdcall;

  TSQLCloseCursor = function(StatementHandle: SQLHSTMT): SQLRETURN stdcall;

{$IFDEF WIN64}
  TSQLColAttribute = function(StatementHandle: SQLHSTMT; ColumnNumber, FieldIdentifier: SQLUSMALLINT;
                              CharacterAttribute: SQLPOINTER; BufferLength: SQLSMALLINT;
                              StringLength: PSQLSMALLINT; NumericAttribute: PSQLLEN): SQLRETURN stdcall;
{$ELSE}
  TSQLColAttribute = function(StatementHandle: SQLHSTMT; ColumnNumber, FieldIdentifier: SQLUSMALLINT;
                              CharacterAttribute: SQLPOINTER; BufferLength: SQLSMALLINT;
...
{$ENDIF}
  ...
  TSQLColumns = function(StatementHandle: SQLHSTMT; CatalogName: PSqlChar; NameLength1: SQLSMALLINT;
                         SchemaName: PSqlChar; NameLength2: SQLSMALLINT; TableName: PSqlChar;
                         NameLength3: SQLSMALLINT; ColumnName: PSqlChar; NameLength4: SQLSMALLINT): SQLRETURN stdcall;

  TSQLConnect = function(ConnectionHandle: SQLHDBC; ServerName: PSqlChar; NameLength1: SQLSMALLINT;
                         UserName: PSqlChar; NameLength2: SQLSMALLINT; Authentication: PSqlChar;
                         NameLength3: SQLSMALLINT): SQLRETURN stdcall;

  TSqlCopyDesc = function(SourceDescHandle: SQLHDESC; TargetDescHandle: SQLHDESC): SQLRETURN stdcall;

  TSQLDataSources = function(EnvironmentHandle: SQLHENV; Direction: SQLUSMALLINT;
                             ServerName: PSqlChar; BufferLength1: SQLSMALLINT;
                             var NameLength1Ptr: SQLSMALLINT; Description: PSqlChar;
                             BufferLength2: SQLSMALLINT; var NameLength2Ptr: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDescribeCol = function(StatementHandle: SQLHSTMT; ColumnNumber: SQLUSMALLINT;
                             ColumnName: PSqlChar; BufferLength: SQLSMALLINT;
  ...
  TSQLEndTran = function(HandleType: SQLSMALLINT; Handle: SQLHANDLE; CompletionType: SQLSMALLINT): SQLRETURN stdcall;

  TSQLError = function(EnvironmentHandle: SQLHENV; ConnectionHandle: SQLHDBC;
                       StatementHandle: SQLHSTMT; SqlState: PSqlChar; var NativeError: SQLINTEGER;
  ...
  TSQLFetchScroll = function(StatementHandle: SQLHSTMT; FetchOrientation: SQLSMALLINT;
                             FetchOffset: SQLLEN): SQLRETURN stdcall;

  TSQLFreeConnect = function(ConnectionHandle: SQLHDBC): SQLRETURN stdcall;

  TSQLFreeEnv = function(EnvironmentHandle: SQLHENV): SQLRETURN stdcall;

  TSQLFreeHandle = function(HandleType: SQLSMALLINT; Handle: SQLHANDLE): SQLRETURN stdcall;

  TSQLFreeStmt = function(StatementHandle: SQLHSTMT; Option: SQLUSMALLINT): SQLRETURN stdcall;

  TSQLGetConnectAttr = function(ConnectionHandle: SQLHDBC; Attribute: SQLINTEGER;
                                Value: SQLPOINTER; BufferLength: SQLINTEGER;
                                var StringLengthPtr: SQLINTEGER): SQLRETURN stdcall;

  TSQLGetConnectOption = function(ConnectionHandle: SQLHDBC; Option: SQLUSMALLINT;
                                  Value: SQLPOINTER): SQLRETURN stdcall;

  TSQLGetCursorName = function(StatementHandle: SQLHSTMT; CursorName: PSqlChar;
                               BufferLength: SQLSMALLINT; var NameLengthPtr: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetData = function(StatementHandle: SQLHSTMT; ColumnNumber: SQLUSMALLINT;
                         TargetType: SQLSMALLINT; TargetValue: SQLPOINTER; BufferLength: SQLLEN;
                         StrLen_or_IndPtr: PSQLLEN): SQLRETURN stdcall;

  TSQLGetDescField = function(DescriptorHandle: SQLHDESC; RecNumber: SQLSMALLINT;
                              FieldIdentifier: SQLSMALLINT; Value: SQLPOINTER;
  ...
  TSQLGetDescRec = function(DescriptorHandle: SQLHDESC; RecNumber: SQLSMALLINT;
                            Name: PSqlChar; BufferLength: SQLSMALLINT;
                            var StringLengthPtr: SQLSMALLINT; var TypePtr: SQLSMALLINT;
                            var SubTypePtr: SQLSMALLINT; var LengthPtr: SQLLEN;
                            var PrecisionPtr: SQLSMALLINT; var ScalePtr: SQLSMALLINT;
                            var NullablePtr: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetDiagField = function(HandleType: SQLSMALLINT; Handle: SQLHANDLE;
                              RecNumber: SQLSMALLINT; DiagIdentifier: SQLSMALLINT;
                              DiagInfo: SQLPOINTER; BufferLength: SQLSMALLINT;
                              var StringLength: SQLSMALLINT): SQLRETURN stdcall;
  ...
  TSQLGetEnvAttr = function(EnvironmentHandle: SQLHENV; Attribute: SQLINTEGER; Value: SQLPOINTER;
                            BufferLength: SQLINTEGER; var StringLength: SQLINTEGER): SQLRETURN stdcall;

  TSQLGetFunctions = function(ConnectionHandle: SQLHDBC; FunctionId: SQLUSMALLINT;
                              var Supported: SQLUSMALLINT): SQLRETURN stdcall;

  TSQLGetInfo = function(ConnectionHandle: SQLHDBC; InfoType: SQLUSMALLINT;
                         InfoValue: SQLPOINTER; BufferLength: SQLSMALLINT;
                         var StringLengthPtr: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetStmtAttr = function(StatementHandle: SQLHSTMT; Attribute: SQLINTEGER;
                             Value: SQLPOINTER; BufferLength: SQLINTEGER;
                             var StringLength: SQLINTEGER): SQLRETURN stdcall;

  TSQLGetStmtOption = function(StatementHandle: SQLHSTMT; Option: SQLUSMALLINT; Value: SQLPOINTER): SQLRETURN stdcall;

  TSQLGetTypeInfo = function(StatementHandle: SQLHSTMT; DataType: SQLSMALLINT): SQLRETURN stdcall;

  TSQLNumResultCols = function(StatementHandle: SQLHSTMT; var ColumnCount: SQLSMALLINT): SQLRETURN stdcall;

  TSQLParamData = function(StatementHandle: SQLHSTMT; Value: SQLPOINTER): SQLRETURN stdcall;

  TSQLPrepare = function(StatementHandle: SQLHSTMT; StatementText: PSqlChar;
                         TextLength: SQLINTEGER): SQLRETURN stdcall;

  TSQLPutData = function(StatementHandle: SQLHSTMT; Data: SQLPOINTER; StrLen_or_Ind: SQLLEN): SQLRETURN stdcall;

  TSQLRowCount = function(StatementHandle: SQLHSTMT; var RowCount: SQLLEN): SQLRETURN stdcall;

  TSQLSetConnectAttr = function(ConnectionHandle: SQLHDBC; Attribute: SQLINTEGER;
                                Value: SQLPOINTER; StringLength: SQLINTEGER): SQLRETURN stdcall;

  TSQLSetConnectOption = function(ConnectionHandle: SQLHDBC; Option: SQLUSMALLINT;
                                  Value: SQLULEN): SQLRETURN stdcall;

  TSQLSetCursorName = function(StatementHandle: SQLHSTMT; CursorName: PSqlChar;
                               NameLength: SQLSMALLINT): SQLRETURN stdcall;

  TSQLSetDescField = function(DescriptorHandle: SQLHDESC; RecNumber, FieldIdentifier: SQLSMALLINT;
                              Value: SQLPOINTER; BufferLength: SQLINTEGER): SQLRETURN stdcall;

  TSQLSetDescRec = function(DescriptorHandle: SQLHDESC; RecNumber, _Type, SubType: SQLSMALLINT;
                            Length: SQLLEN; Precision, Scale: SQLSMALLINT;
                            Data: SQLPOINTER; var StringLength: SQLLEN;
                            var Indicator: SQLLEN): SQLRETURN stdcall;

  TSQLSetEnvAttr = function(EnvironmentHandle: SQLHENV; Attribute: SQLINTEGER;
                            Value: SQLPOINTER; StringLength: SQLINTEGER): SQLRETURN stdcall;

  TSQLSetParam = function(StatementHandle: SQLHSTMT; ParameterNumber: SQLUSMALLINT;
                          ValueType, ParameterType: SQLSMALLINT; LengthPrecision: SQLULEN;
                          ParameterScale: SQLSMALLINT; ParameterValue: SQLPOINTER;
                          var StrLen_or_Ind: SQLLEN): SQLRETURN stdcall;

  TSQLSetStmtAttr = function(StatementHandle: SQLHSTMT; Attribute: SQLINTEGER;
                             Value: SQLPOINTER; StringLength: SQLINTEGER): SQLRETURN stdcall;

  TSQLSetStmtOption = function(StatementHandle: SQLHSTMT; Option: SQLUSMALLINT; Value: SQLULEN): SQLRETURN stdcall;

  TSQLSpecialColumns = function(StatementHandle: SQLHSTMT; IdentifierType: SQLUSMALLINT;
                                ...
                                Scope, Nullable: SQLUSMALLINT): SQLRETURN stdcall;

  TSQLStatistics = function(StatementHandle: SQLHSTMT; CatalogName: PSqlChar;
                            NameLength1: SQLSMALLINT; SchemaName: PSqlChar;
                            NameLength2: SQLSMALLINT; TableName: PSqlChar;
                            NameLength3: SQLSMALLINT; Unique, Reserved: SQLUSMALLINT): SQLRETURN stdcall;

  TSQLTables = function(StatementHandle: SQLHSTMT; CatalogName: PSqlChar; NameLength1: SQLSMALLINT;
                        SchemaName: PSqlChar; NameLength2: SQLSMALLINT;
                        TableName: PSqlChar; NameLength3: SQLSMALLINT;
                        TableType: PSqlChar; NameLength4: SQLSMALLINT): SQLRETURN stdcall;

  TSQLTransact = function(EnvironmentHandle: SQLHENV; ConnectionHandle: SQLHDBC;
...
type
  TSQLDriverConnect = function(hdbc: SQLHDBC; hwnd: SQLHWND; szConnStrIn: PSqlChar;
                               cchConnStrIn: SQLSMALLINT; szConnStrOut: PSqlChar;
...
type
  TSQLBrowseConnect = function(hdbc: SQLHDBC; szConnStrIn: PSqlChar; cchConnStrIn: SQLSMALLINT;
                               szConnStrOut: PSqlChar; cchConnStrOutMax: SQLSMALLINT;
                               var pcchConnStrOut: SQLSMALLINT): SQLRETURN stdcall;

  TSQLBulkOperations = function(StatementHandle: SQLHSTMT; Operation: SQLSMALLINT): SQLRETURN stdcall;

  TSQLColumnPrivileges = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar; cchCatalogName: SQLSMALLINT;
                                  szSchemaName: PSqlChar; cchSchemaName: SQLSMALLINT;
                                  szTableName: PSqlChar; cchTableName: SQLSMALLINT;
                                  szColumnName: PSqlChar; cchColumnName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDescribeParam = function(hstmt: SQLHSTMT; ipar: SQLUSMALLINT; var pfSqlType: SQLSMALLINT;
                               var pcbParamDef: SQLULEN; var pibScale: SQLSMALLINT;
                               var pfNullable: SQLSMALLINT): SQLRETURN stdcall;

  TSQLForeignKeys = function(hstmt: SQLHSTMT; szPkCatalogName: PSqlChar; cchPkCatalogName: SQLSMALLINT;
                             szPkSchemaName: PSqlChar; cchPkSchemaName: SQLSMALLINT;
                             szPkTableName: PSqlChar; cchPkTableName: SQLSMALLINT;
                             szFkCatalogName: PSqlChar; cchFkCatalogName: SQLSMALLINT;
                             szFkSchemaName: PSqlChar; cchFkSchemaName: SQLSMALLINT;
                             szFkTableName: PSqlChar; cchFkTableName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLMoreResults = function(hstmt: SQLHSTMT): SQLRETURN stdcall;

  TSQLNativeSql = function(hdbc: SQLHDBC; szSqlStrIn: PSqlChar; cchSqlStrIn: SQLINTEGER;
                           szSqlStr: PSqlChar; cchSqlStrMax: SQLINTEGER; var pcbSqlStr: SQLINTEGER): SQLRETURN stdcall;

  TSQLNumParams = function(hstmt: SQLHSTMT; var pcpar: SQLSMALLINT): SQLRETURN stdcall;

  TSQLPrimaryKeys = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar; cchCatalogName: SQLSMALLINT;
                             szSchemaName: PSqlChar; cchSchemaName: SQLSMALLINT;
                             szTableName: PSqlChar; cchTableName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLProcedureColumns = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar; cchCatalogName: SQLSMALLINT;
                                  szSchemaName: PSqlChar; cchSchemaName: SQLSMALLINT;
                                  szProcName: PSqlChar; cchProcName: SQLSMALLINT;
                                  szColumnName: PSqlChar; cchColumnName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLProcedures = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar; cchCatalogName: SQLSMALLINT;
                            szSchemaName: PSqlChar; cchSchemaName: SQLSMALLINT;
                            szProcName: PSqlChar; cchProcName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLSetPos = function(hstmt: SQLHSTMT; irow: SQLSETPOSIROW; fOption, fLock: SQLUSMALLINT): SQLRETURN stdcall;

  TSQLTablePrivileges = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar; cchCatalogName: SQLSMALLINT;
                                 szSchemaName: PSqlChar; cchSchemaName: SQLSMALLINT;
                                 szTableName: PSqlChar; cchTableName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDrivers = function(henv: SQLHENV; fDirection: SQLUSMALLINT; szDriverDesc: PSqlChar;
                         cchDriverDescMax: SQLSMALLINT; var pcchDriverDesc: SQLSMALLINT;
                         szDriverAttributes: PSqlChar; cchDrvrAttrMax: SQLSMALLINT;
                         var pcchDrvrAttr: SQLSMALLINT): SQLRETURN stdcall;

  TSQLBindParameter = function(hstmt: SQLHSTMT; ipar: SQLUSMALLINT; fParamType, fCType, fSqlType: SQLSMALLINT;
                               cbColDef: SQLULEN; ibScale: SQLSMALLINT; rgbValue: SQLPOINTER;
                               cbValueMax: SQLLEN; pcbValue: PSQLLEN): SQLRETURN stdcall;
...
type
  TSQLAllocHandleStd = function(fHandleType: SQLSMALLINT; hInput: SQLHANDLE; var phOutput: SQLHANDLE): SQLRETURN stdcall;
...
// open a trace log file
  TTraceOpenLogFile = function(szFileName: PWideChar; var lpwszOutputMsg; cbOutputMsg: LongWord): RETCODE stdcall;
  TTraceCloseLogFile = function(): RETCODE stdcall; // Request to close a trace log
  TTraceReturn = procedure(Param1, Param2: RETCODE) stdcall; // Processes trace after FN is called
  TTraceVersion = function(): LongWord stdcall; // Returns trace API version
...
type
  TTraceVSControl = function(Param: LongWord): RETCODE stdcall;
...
{$IFDEF MSWINDOWS}
  TODBCSetTryWaitValue = function(dwValue: LongWord): BOOL stdcall; // In seconds
{$ELSE}
  TODBCSetTryWaitValue = function(dwValue: LongWord): LongBool stdcall; // In seconds
{$ENDIF}
  TODBCGetTryWaitValue = function(): LongWord stdcall; // In Milliseconds(!)
...
// UNICODE versions
{$IFDEF WIN64}
  TSQLColAttributeW = function(hstmt: SQLHSTMT; iCol, iField: SQLUSMALLINT; pCharAttr: SQLPOINTER;
                               cbDescMax: SQLSMALLINT; pcbCharAttr: PSQLSMALLINT;
                               pNumAttr: PSQLLEN): SQLRETURN stdcall;
{$ELSE}
  TSQLColAttributeW = function(hstmt: SQLHSTMT; iCol, iField: SQLUSMALLINT; pCharAttr: SQLPOINTER;
                               cbDescMax: SQLSMALLINT; pcbCharAttr: PSQLSMALLINT;
                               pNumAttr: SQLPOINTER): SQLRETURN stdcall;
{$ENDIF}

  TSQLColAttributesW = function(hstmt: SQLHSTMT; icol, fDescType: SQLUSMALLINT;
                                rgbDesc: SQLPOINTER; cbDescMax: SQLSMALLINT;
                                pcbDesc: PSQLSMALLINT; pfDesc: PSQLLEN): SQLRETURN stdcall;

  TSQLConnectW = function(hdbc: SQLHDBC; szDSN: PSqlWChar; cchDSN: SQLSMALLINT;
                          szUID: PSqlWChar; cchUID: SQLSMALLINT; szAuthStr: PSqlWChar;
                          cchAuthStr: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDescribeColW = function(hstmt: SQLHSTMT; icol: SQLUSMALLINT; szColName: PSqlWChar;
                              cchColNameMax: SQLSMALLINT; var pcchColName: SQLSMALLINT;
                              var pfSqlType: SQLSMALLINT; var pcbColDef: SQLULEN;
                              var pibScale: SQLSMALLINT; var pfNullable: SQLSMALLINT): SQLRETURN stdcall;

  TSQLErrorW = function(henv: SQLHENV; hdbc: SQLHDBC; hstmt: SQLHSTMT; SqlState: PSqlWChar;
                        var pfNativeError: SQLINTEGER; wszErrorMesg: PSqlWChar;
                        cchErrorMsgMax: SQLSMALLINT; var pcchErrorMsg: SQLSMALLINT): SQLRETURN stdcall;

  TSQLExecDirectW = function(hstmt: SQLHSTMT; szSqlStr: PSQLWCHAR; TextLength: SQLINTEGER): SQLRETURN stdcall;

  TSQLGetConnectAttrW = function(hdbc: SQLHDBC; fAttribute: SQLINTEGER; rgbValue: SQLPOINTER;
                                 cbValueMax: SQLINTEGER; var pcbValue: SQLINTEGER): SQLRETURN stdcall;

  TSQLGetCursorNameW = function(hstmt: SQLHSTMT; szCursor: PSqlWChar; cchCursorMax: SQLSMALLINT;
                                var pcchCursor: SQLSMALLINT): SQLRETURN stdcall;

  TSQLSetDescFieldW = function(DescriptorHandle: SQLHDESC; RecNumber, FieldIdentifier: SQLSMALLINT;
                               Value: SQLPOINTER; BufferLength: SQLINTEGER): SQLRETURN stdcall;

  TSQLGetDescFieldW = function(hdesc: SQLHDESC; iRecord, iField: SQLSMALLINT;
                               rgbValue: SQLPOINTER; cbBufferLength: SQLINTEGER;
                               var StringLength: SQLINTEGER): SQLRETURN stdcall;

  TSQLGetDescRecW = function(hdesc: SQLHDESC; iRecord: SQLSMALLINT; szName: PSqlWChar;
                             ...
                             var pScale: SQLSMALLINT; var pNullable: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetDiagFieldW = function(fHandleType: SQLSMALLINT; handle: SQLHANDLE;
                               iRecord, fDiagField: SQLSMALLINT; rgbDiagInfo: SQLPOINTER;
                               cbBufferLength: SQLSMALLINT; var pcbStringLength: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetDiagRecW = function(fHandleType: SQLSMALLINT; handle: SQLHANDLE; iRecord: SQLSMALLINT;
                             szSqlState: PSqlWChar; var pfNativeError: SQLINTEGER;
                             szErrorMsg: PSqlWChar; cchErrorMsgMax: SQLSMALLINT;
                             var pcchErrorMsg: SQLSMALLINT): SQLRETURN stdcall;

  TSQLPrepareW = function(hstmt: SQLHSTMT; szSqlStr: PSqlWChar; cchSqlStr: SQLINTEGER): SQLRETURN stdcall;

  TSQLSetConnectAttrW = function(hdbc: SQLHDBC; fAttribute: SQLINTEGER; rgbValue: SQLPOINTER;
                                 cbValue: SQLINTEGER): SQLRETURN stdcall;

  TSQLSetCursorNameW = function(hstmt: SQLHSTMT; szCursor: PSqlWChar; cchCursor: SQLSMALLINT): SQLRETURN stdcall;

  TSQLColumnsW = function(hstmt: SQLHSTMT; szCatalogName: PSqlWChar; cchCatalogName: SQLSMALLINT;
                          szSchemaName: PSqlWChar; cchSchemaName: SQLSMALLINT;
                          szTableName: PSqlWChar; cchTableName: SQLSMALLINT;
                          szColumnName: PSqlWChar; cchColumnName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetConnectOptionW = function(hdbc: SQLHDBC; fOption: SQLUSMALLINT; pvParam: SQLPOINTER): SQLRETURN stdcall;

  TSQLGetInfoW = function(hdbc: SQLHDBC; fInfoType: SQLUSMALLINT; rgbInfoValue: SQLPOINTER;
                          cbInfoValueMax: SQLSMALLINT; var pcbInfoValue: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetTypeInfoW = function(StatementHandle: SQLHSTMT; DataType: SQLSMALLINT): SQLRETURN stdcall;

  TSQLSetConnectOptionW = function(hdbc: SQLHDBC; fOption: SQLUSMALLINT; vParam: SQLULEN): SQLRETURN stdcall;

  TSQLSpecialColumnsW = function(hstmt: SQLHSTMT; fColType: SQLUSMALLINT;
                                 szCatalogName: PSqlWChar; cchCatalogName: SQLSMALLINT;
                                 szSchemaName: PSqlWChar; cchSchemaName: SQLSMALLINT;
                                 szTableName: PSqlWChar; cchTableName: SQLSMALLINT;
                                 fScope, fNullable: SQLUSMALLINT): SQLRETURN stdcall;

  TSQLStatisticsW = function(hstmt: SQLHSTMT; szCatalogName: PSqlWChar; cchCatalogName: SQLSMALLINT;
                             szSchemaName: PSqlWChar; cchSchemaName: SQLSMALLINT;
                             szTableName: PSqlWChar; cchTableName: SQLSMALLINT;
                             fUnique, fAccuracy: SQLUSMALLINT): SQLRETURN stdcall;

  TSQLTablesW = function(hstmt: SQLHSTMT; szCatalogName: PSqlWChar; cchCatalogName: SQLSMALLINT;
                         szSchemaName: PSqlWChar; cchSchemaName: SQLSMALLINT;
                         szTableName: PSqlWChar; cchTableName: SQLSMALLINT;
                         szTableType: PSqlWChar; cchTableType: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDataSourcesW = function(henv: SQLHENV; fDirection: SQLUSMALLINT; szDSN: PSqlWChar;
                              cchDSNMax: SQLSMALLINT; var pcchDSN: SQLSMALLINT;
                              wszDescription: PSqlWChar; cchDescriptionMax: SQLSMALLINT;
                              var pcchDescription: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDriverConnectW = function(hdbc: SQLHDBC; hwnd: SQLHWND; szConnStrIn: PSqlWChar;
                                cchConnStrIn: SQLSMALLINT; szConnStrOut: PSqlWChar;
                                cchConnStrOutMax: SQLSMALLINT; var pcchConnStrOut: SQLSMALLINT;
                                fDriverCompletion: SQLUSMALLINT): SQLRETURN stdcall;

  TSQLBrowseConnectW = function(hdbc: SQLHDBC; szConnStrIn: PSqlWChar; cchConnStrIn: SQLSMALLINT;
                                szConnStrOut: PSqlWChar; cchConnStrOutMax: SQLSMALLINT;
                                var pcchConnStrOut: SQLSMALLINT): SQLRETURN stdcall;

  TSQLColumnPrivilegesW = function(hstmt: SQLHSTMT; szCatalogName: PSqlWChar;
                                   cchCatalogName: SQLSMALLINT; szSchemaName: PSqlWChar;
                                   cchSchemaName: SQLSMALLINT; szTableName: PSqlWChar;
                                   cchTableName: SQLSMALLINT; szColumnName: PSqlWChar;
                                   cchColumnName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetStmtAttrW = function(hstmt: SQLHSTMT; fAttribute: SQLINTEGER; rgbValue: SQLPOINTER;
                              cbValueMax: SQLINTEGER; var pcbValue: SQLINTEGER): SQLRETURN stdcall;

  TSQLSetStmtAttrW = function(hstmt: SQLHSTMT; fAttribute: SQLINTEGER; rgbValue: SQLPOINTER;
                              cbValueMax: SQLINTEGER): SQLRETURN stdcall;

  TSQLForeignKeysW = function(hstmt: SQLHSTMT; szPkCatalogName: PSqlWChar;
                              ...
                              cchFkTableName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLNativeSqlW = function(hdbc: SQLHDBC; szSqlStrIn: PSqlWChar; cchSqlStrIn: SQLINTEGER;
                            szSqlStr: PSqlWChar; cchSqlStrMax: SQLINTEGER;
                            var pcchSqlStr: SQLINTEGER): SQLRETURN stdcall;

  TSQLPrimaryKeysW = function(hstmt: SQLHSTMT; szCatalogName: PSqlWChar; cchCatalogName: SQLSMALLINT;
                              szSchemaName: PSqlWChar; cchSchemaName: SQLSMALLINT;
                              szTableName: PSqlWChar; cchTableName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLProcedureColumnsW = function(hstmt: SQLHSTMT; szCatalogName: PSqlWChar;
                                   cchCatalogName: SQLSMALLINT; szSchemaName: PSqlWChar;
                                   cchSchemaName: SQLSMALLINT; szProcName: PSqlWChar;
                                   cchProcName: SQLSMALLINT; szColumnName: PSqlWChar;
                                   cchColumnName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLProceduresW = function(hstmt: SQLHSTMT; szCatalogName: PSqlWChar; cchCatalogName: SQLSMALLINT;
                             szSchemaName: PSqlWChar; cchSchemaName: SQLSMALLINT;
                             szProcName: PSqlWChar; cchProcName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLTablePrivilegesW = function(hstmt: SQLHSTMT; szCatalogName: PSqlWChar;
                                  cchCatalogName: SQLSMALLINT; szSchemaName: PSqlWChar;
                                  cchSchemaName: SQLSMALLINT; szTableName: PSqlWChar;
                                  cchTableName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDriversW = function(henv: SQLHENV; fDirection: SQLUSMALLINT; szDriverDesc: PSqlWChar;
                          cchDriverDescMax: SQLSMALLINT; var pcchDriverDesc: SQLSMALLINT;
                          szDriverAttributes: PSqlWChar; cchDrvrAttrMax: SQLSMALLINT;
                          var pcchDrvrAttr: SQLSMALLINT): SQLRETURN stdcall;

// ANSI versions
{$IFDEF WIN64}
  TSQLColAttributeA = function(hstmt: SQLHSTMT; iCol, iField: SQLSMALLINT; pCharAttr: SQLPOINTER;
                               cbCharAttrMax: SQLSMALLINT; var pcbCharAttr: SQLSMALLINT;
                               var pNumAttr: SQLLEN): SQLRETURN stdcall;
{$ELSE}
  TSQLColAttributeA = function(hstmt: SQLHSTMT; iCol, iField: SQLSMALLINT; pCharAttr: SQLPOINTER;
                               cbCharAttrMax: SQLSMALLINT; var pcbCharAttr: SQLSMALLINT;
                               var pNumAttr: SQLPOINTER): SQLRETURN stdcall;
{$ENDIF}

  TSQLColAttributesA = function(hstmt: SQLHSTMT; icol, fDescType: SQLUSMALLINT;
                                rgbDesc: SQLPOINTER; cbDescMax: SQLSMALLINT;
                                var pcbDesc: SQLSMALLINT; var pfDesc: SQLLEN): SQLRETURN stdcall;

  TSQLConnectA = function(hdbc: SQLHDBC; szDSN: PSqlChar; cbDSN: SQLSMALLINT;
                          szUID: PSqlChar; cbUID: SQLSMALLINT; szAuthStr: PSqlChar;
                          cbAuthStr: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDescribeColA = function(hstmt: SQLHSTMT; icol: SQLUSMALLINT; szColName: PSqlChar;
                              cbColNameMax: SQLSMALLINT; var pcbColName: SQLSMALLINT;
                              var pfSqlType: SQLSMALLINT; var pcbColDef: SQLULEN;
                              var pibScale: SQLSMALLINT; var pfNullable: SQLSMALLINT): SQLRETURN stdcall;

  TSQLErrorA = function(henv: SQLHENV; hdbc: SQLHDBC; hstmt: SQLHSTMT; szSqlState: PSqlChar;
                        var pfNativeError: SQLINTEGER; szErrorMsg: PSqlChar;
                        cbErrorMsgMax: SQLSMALLINT; var pcbErrorMsg: SQLSMALLINT): SQLRETURN stdcall;

  TSQLExecDirectA = function(hstmt: SQLHSTMT; szSqlStr: PSqlChar; cbSqlStr: SQLINTEGER): SQLRETURN stdcall;

  TSQLGetConnectAttrA = function(hdbc: SQLHDBC; fAttribute: SQLINTEGER; rgbValue: SQLPOINTER;
                                 cbValueMax: SQLINTEGER; var pcbValue: SQLINTEGER): SQLRETURN stdcall;

  TSQLGetCursorNameA = function(hstmt: SQLHSTMT; szCursor: PSqlChar; cbCursorMax: SQLSMALLINT;
                                var pcbCursor: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetDescFieldA = function(hdesc: SQLHDESC; iRecord, iField: SQLSMALLINT;
                               rgbValue: SQLPOINTER; cbBufferLength: SQLINTEGER;
                               var StringLength: SQLINTEGER): SQLRETURN stdcall;

  TSQLGetDescRecA = function(hdesc: SQLHDESC; iRecord: SQLSMALLINT; szName: PSqlChar;
                             cbNameMax: SQLSMALLINT; var pcbName: SQLSMALLINT;
                             var pfType: SQLSMALLINT; var pfSubType: SQLSMALLINT;
                             var pLength: SQLLEN; var pPrecision: SQLSMALLINT;
                             var pScale: SQLSMALLINT; var pNullable: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetDiagFieldA = function(fHandleType: SQLSMALLINT; handle: SQLHANDLE;
                               iRecord, fDiagField: SQLSMALLINT; rgbDiagInfo: SQLPOINTER;
                               cbDiagInfoMax: SQLSMALLINT; var pcbDiagInfo: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetDiagRecA = function(fHandleType: SQLSMALLINT; handle: SQLHANDLE; iRecord: SQLSMALLINT;
                             szSqlState: PSqlChar; var pfNativeError: SQLINTEGER;
                             szErrorMsg: PSqlChar; cbErrorMsgMax: SQLSMALLINT;
                             var pcbErrorMsg: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetStmtAttrA = function(hstmt: SQLHSTMT; fAttribute: SQLINTEGER; rgbValue: SQLPOINTER;
                              cbValueMax: SQLINTEGER; var pcbValue: SQLINTEGER): SQLRETURN stdcall;

  TSQLGetTypeInfoA = function(StatementHandle: SQLHSTMT; DataType: SQLSMALLINT): SQLRETURN stdcall;

  TSQLPrepareA = function(hstmt: SQLHSTMT; szSqlStr: PSqlChar; cbSqlStr: SQLINTEGER): SQLRETURN stdcall;

  TSQLSetConnectAttrA = function(hdbc: SQLHDBC; fAttribute: SQLINTEGER; rgbValue: SQLPOINTER;
                                 cbValue: SQLINTEGER): SQLRETURN stdcall;

  TSQLSetCursorNameA = function(hstmt: SQLHSTMT; szCursor: PSqlChar; cbCursor: SQLSMALLINT): SQLRETURN stdcall;

  TSQLColumnsA = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar; cbCatalogName: SQLSMALLINT;
                          szSchemaName: PSqlChar; cbSchemaName: SQLSMALLINT;
                          szTableName: PSqlChar; cbTableName: SQLSMALLINT; szColumnName: PSqlChar;
                          cbColumnName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetConnectOptionA = function(hdbc: SQLHDBC; fOption: SQLUSMALLINT; pvParam: SQLPOINTER): SQLRETURN stdcall;

  TSQLGetInfoA = function(hdbc: SQLHDBC; fInfoType: SQLUSMALLINT; rgbInfoValue: SQLPOINTER;
                          cbInfoValueMax: SQLSMALLINT; var pcbInfoValue: SQLSMALLINT): SQLRETURN stdcall;

  TSQLGetStmtOptionA = function(hstmt: SQLHSTMT; fOption: SQLUSMALLINT; pvParam: SQLPOINTER): SQLRETURN stdcall;

  TSQLSetConnectOptionA = function(hdbc: SQLHDBC; fOption: SQLUSMALLINT; vParam: SQLULEN): SQLRETURN stdcall;

  TSQLSetStmtOptionA = function(hstmt: SQLHSTMT; fOption: SQLUSMALLINT; vParam: SQLULEN): SQLRETURN stdcall;

  TSQLSpecialColumnsA = function(hstmt: SQLHSTMT; fColType: SQLUSMALLINT; szCatalogName: PSqlChar;
                                 cbCatalogName: SQLSMALLINT; szSchemaName: PSqlChar;
                                 cbSchemaName: SQLSMALLINT; szTableName: PSqlChar;
                                 cbTableName: SQLSMALLINT; fScope, fNullable: SQLUSMALLINT): SQLRETURN stdcall;

  TSQLStatisticsA = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar; cbCatalogName: SQLSMALLINT;
                             szSchemaName: PSqlChar; cbSchemaName: SQLSMALLINT;
                             szTableName: PSqlChar; cbTableName: SQLSMALLINT;
                             fUnique, fAccuracy: SQLUSMALLINT): SQLRETURN stdcall;

  TSQLTablesA = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar; cbCatalogName: SQLSMALLINT;
                         szSchemaName: PSqlChar; cbSchemaName: SQLSMALLINT;
                         szTableName: PSqlChar; cbTableName: SQLSMALLINT;
                         szTableType: PSqlChar; cbTableType: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDataSourcesA = function(henv: SQLHENV; fDirection: SQLUSMALLINT; szDSN: PSqlChar;
                              cbDSNMax: SQLSMALLINT; var pcbDSN: SQLSMALLINT;
                              szDescription: PSqlChar; cbDescriptionMax: SQLSMALLINT;
                              var pcbDescription: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDriverConnectA = function(hdbc: SQLHDBC; hwnd: SQLHWND; szConnStrIn: PSqlChar;
                                cbConnStrIn: SQLSMALLINT; szConnStrOut: PSqlChar;
                                cbConnStrOutMax: SQLSMALLINT; var pcbConnStrOut: SQLSMALLINT;
                                fDriverCompletion: SQLUSMALLINT): SQLRETURN stdcall;

  TSQLBrowseConnectA = function(hdbc: SQLHDBC; szConnStrIn: PSqlChar; cbConnStrIn: SQLSMALLINT;
                                szConnStrOut: PSqlChar; cbConnStrOutMax: SQLSMALLINT;
                                var pcbConnStrOut: SQLSMALLINT): SQLRETURN stdcall;

  TSQLColumnPrivilegesA = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar;
                                   cbCatalogName: SQLSMALLINT; szSchemaName: PSqlChar;
                                   cbSchemaName: SQLSMALLINT; szTableName: PSqlChar;
                                   cbTableName: SQLSMALLINT; szColumnName: PSqlChar;
                                   cbColumnName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDescribeParamA = function(hstmt: SQLHSTMT; ipar: SQLUSMALLINT; var pfSqlType: SQLSMALLINT;
                                var pcbParamDef: SQLUINTEGER; var pibScale: SQLSMALLINT;
                                var pfNullable: SQLSMALLINT): SQLRETURN stdcall;

  TSQLForeignKeysA = function(hstmt: SQLHSTMT; szPkCatalogName: PSqlChar; cbPkCatalogName: SQLSMALLINT;
                              szPkSchemaName: PSqlChar; cbPkSchemaName: SQLSMALLINT;
                              szPkTableName: PSqlChar; cbPkTableName: SQLSMALLINT;
                              szFkCatalogName: PSqlChar; cbFkCatalogName: SQLSMALLINT;
                              szFkSchemaName: PSqlChar; cbFkSchemaName: SQLSMALLINT;
                              szFkTableName: PSqlChar; cbFkTableName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLNativeSqlA = function(hdbc: SQLHDBC; szSqlStrIn: PSqlChar; cbSqlStrIn: SQLINTEGER;
                            szSqlStr: PSqlChar; cbSqlStrMax: SQLINTEGER;
                            var pcbSqlStr: SQLINTEGER): SQLRETURN stdcall;

  TSQLPrimaryKeysA = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar; cbCatalogName: SQLSMALLINT;
                              szSchemaName: PSqlChar; cbSchemaName: SQLSMALLINT;
                              szTableName: PSqlChar; cbTableName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLProcedureColumnsA = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar;
                                   cbCatalogName: SQLSMALLINT; szSchemaName: PSqlChar;
                                   cbSchemaName: SQLSMALLINT; szProcName: PSqlChar;
                                   cbProcName: SQLSMALLINT; szColumnName: PSqlChar;
                                   cbColumnName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLProceduresA = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar; cbCatalogName: SQLSMALLINT;
                             szSchemaName: PSqlChar; cbSchemaName: SQLSMALLINT;
                             szProcName: PSqlChar; cbProcName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLTablePrivilegesA = function(hstmt: SQLHSTMT; szCatalogName: PSqlChar;
                                  cbCatalogName: SQLSMALLINT; szSchemaName: PSqlChar;
                                  cbSchemaName: SQLSMALLINT; szTableName: PSqlChar;
                                  cbTableName: SQLSMALLINT): SQLRETURN stdcall;

  TSQLDriversA = function(henv: SQLHENV; fDirection: SQLUSMALLINT; szDriverDesc: PSqlChar;
...
{$IFDEF MSWINDOWS}
//For Macros
function SQLAllocHandleStd(fHandleType: SQLSMALLINT; hInput: SQLHANDLE; var phOutput: SQLHANDLE): SQLRETURN; stdcall;
{$EXTERNALSYM SQLAllocHandleStd}
function SQLAllocHandleStd; external 'odbc32.dll' name 'SQLAllocHandleStd';
function SQLSetPos(hstmt: SQLHSTMT; irow: SQLSETPOSIROW; fOption, fLock: SQLUSMALLINT): SQLRETURN; stdcall;
{$EXTERNALSYM SQLSetPos}
function SQLSetPos; external 'odbc32.dll' name 'SQLSetPos';
{$ENDIF}
...
function SQLAllocEnv(phenv: SQLHANDLE): SQLRETURN;
begin
  Result := SQLAllocHandleStd(SQL_HANDLE_ENV, SQLHANDLE(SQL_NULL_HANDLE), phenv);
end;
{$ENDIF}
end.
