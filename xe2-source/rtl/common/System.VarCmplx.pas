...
begin
  if Source.VType = VarType then
    case AVarType of
      ...
      varString:
        VarDataFromLStr(Dest, AnsiString(TComplexVarData(Source).VComplex.AsString));
    else
      VarDataInit(LTemp);
      try
...
begin
  if VarIsComplex(AValue) and
     System.Math.IsZero(TComplexVarData(AValue).VComplex.Imaginary) then
