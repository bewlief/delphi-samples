...
{ !!! units.  Before making modifications to this unit, please see Chris Hesik.  !!! }
{$IFDEF MSWINDOWS}
uses Winapi.Windows, System.SysUtils, System.Classes, Winapi.ActiveX, System.TypInfo, DockForm, DesignIntf, Vcl.Menus,
  Vcl.ActnList, Vcl.Graphics, Vcl.ImgList, Vcl.Forms, Vcl.Controls, Vcl.ComCtrls, Xml.XMLIntf, System.IniFiles, System.Types;
{$ENDIF}
{$IFDEF LINUX}
...
(*$HPPEMIT 'DEFINE_GUID(IID_INTACustomEditorView150,0x8A5E5C0,0xE3D5,0x44E0,0xBE,0xF,0x4A,0xDC,0x93,0xC3,0x69,0xA4);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAEditView,0xBD1A97F8,0x2346,0x4856,0x8A,0x19,0x51,0x78,0x7E,0xAC,0x32,0x40);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_INTAEnvironmentOptionsServices,0x88EAA6AC,0xB8C0,0x42F7,0x9C,0x00,0xE5,0xD3,0x1B,0x81,0x29,0x98);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAPackageInfo,0xF41DB233,0x500B,0x4B0D,0x93,0x10,0x90,0x72,0xE1,0x0E,0xE0,0x69);'*)
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAPackageServices140,0x26EB0E4D,0xF97B,0x11D1,0xAB,0x27,0x00,0xC0,0x4F,0xB1,0x6F,0xB3);'*)
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAPackageServices,0x2C96711A,0x267A,0x4024,0x9C,0x54,0xB1,0x1F,0xCC,0x59,0x6A,0x6F);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAProject140,0xD0090018,0xD879,0x41FC,0x8F,0x83,0xAA,0x4F,0x40,0x09,0x8A,0xCF);'*)
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAProject150,0xA6287B50,0xDA09,0x44EF,0xAA,0x80,0x9D,0x1C,0xAF,0xDE,0x78,0x57);'*)
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAProject,0xF5EA2A72,0x485D,0x49E8,0xB6,0x0A,0xB0,0xE7,0xC7,0xB8,0x0A,0x27);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAProjectOptionsConfigurations,0xBDC06BC9,0xA56C,0x41D2,0xBF,0x41,0xDD,0xA7,0x65,0x70,0x80,0x9A);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAServices,0x86602DE0,0x50BF,0x4AE5,0xBA,0xF4,0xD9,0x43,0x8B,0xD3,0x32,0x18);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAThread140,0xBC146984,0x1E20,0x4695,0x87,0x91,0x25,0xE6,0xA8,0x2F,0x52,0xF7);'*)
(*$HPPEMIT 'DEFINE_GUID(IID_IOTAThread150,0x7030D03B,0xEB04,0x47EC,0x9E,0x3B,0x6D,0xB5,0xD,0x3B,0x89,0x68);'*)
...
(*$HPPEMIT 'DEFINE_GUID(IID_INTAIDEInsightService, 0x6B0977D7,0xDE13,0x4715,0xAB,0x0B,0x37,0x91,0x12,0x6C,0xAB,0xE9);'*)
...
(*$HPPEMIT '    typedef void* _di_INTACustomEditorView150;' *)
...
(*$HPPEMIT '    typedef void* _di_INTAEditorViewServices;' *)
(*$HPPEMIT '    typedef void* _di_INTAEnvironmentOptionsServices;' *)
(*$HPPEMIT '    typedef void* _di_INTAAddinOptions;' *)
(*$HPPEMIT '    typedef void* _di_INTAIDEInsightService;' *)
(*$HPPEMIT '  } /* namespace Toolsapi */ ' *)
  ...
  { Use the IOTAEditReader class to gain read access to an editor buffer:
    ...
    NOTES:
     ...
     o "Buffer" will contain UTF8-encoded data if the editor contains Unicode
       characters
     o The editor currently supports reading data in chunks of 65535 bytes or
       less.  If you need to read more than 65535 bytes of data, you should
       make multiple calls to GetText to read the data.
...
{ If an IOTAHighlighter implements IOTAElisionPreview in addition to
  ...
  IOTAEditView = interface(IOTAEditView145)
  ...
  IOTAProjectOptionsConfigurations = interface(IOTAProjectOptionsConfigurations140)
  ...
  IOTAProject = interface(IOTAProject150)
...
{$ENDIF}
  ...
  TOTAProcessType = (optWin32, optOSX32, optWin64);
  ...
  IOTARepositoryWizard160 = interface(IOTARepositoryWizard80)
    ...
    { Return the framework type strings for the frameworks this wizard supports }
  ...
  IOTAPackageServices = interface(IOTAPackageServices140)
  ...
  IOTAEnvironmentOptions = interface(IOTAEnvironmentOptions140)
...
{$ENDIF}
  ...
  IOTAServices = interface(IOTAServices140)
