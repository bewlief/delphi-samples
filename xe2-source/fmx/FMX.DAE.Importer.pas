...
uses
  System.Classes, System.SysUtils, FMX.Types3D, FMX.Import,
  FMX.DAE.Schema, FMX.Objects3D;
...
var
  ...
  begin
    ...
    for m := 0 to High(ANode.Childs) do
      AddNode(ANode.Childs[m], LTransformation);
  end;
