...
uses
  System.Classes, System.Types, System.UITypes, System.Masks,
  FMX.Types, FMX.Objects, FMX.Ani, FMX.Layouts, FMX.Platform,
  FMX.Controls, FMX.ListBox, FMX.Memo, FMX.Edit, FMX.Menus;
...
function TCalendarBox.GetDefaultStyleLookupName: string;
begin
...
function TCalendarEdit.GetDefaultStyleLookupName: string;
begin
  Result := 'comboeditstyle';
end;
...
procedure TCalendarEdit.SetText(const AValue: string);
var
  TempDate: TDateTime;
begin
  inherited;
