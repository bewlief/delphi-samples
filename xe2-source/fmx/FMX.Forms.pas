...
{$IFDEF MSWINDOWS}
  Winapi.Messages,
{$ENDIF}
  System.TypInfo, System.Math, System.Classes, System.SysUtils, System.Types, System.UITypes, FMX.Types, FMX.Types3D;
...
{$IFDEF MACOS}
  Macapi.ObjectiveC,
{$ENDIF}
  FMX.Dialogs, FMX.Platform, FMX.Menus, FMX.Objects3D, FMX.Layers3D;
...
procedure TApplication.SetStyleFileName(const Value: String);
var
  i: integer;
begin
...
procedure TCommonCustomForm.BeginInternalDrag(Source: TObject; ABitmap: FMX.Types.TBitmap);
var
  D: TDragObject;
begin
