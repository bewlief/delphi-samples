...
Tisc_event_block = function     (event_buffer               : PPAnsiChar;
				 ...
				 id_count                   : UShort;
         event_list                 : array of PAnsiChar): ISC_LONG; cdecl;
...
(********************************)
Tisc_get_client_version = procedure(buffer : PByte); {$IFDEF MSWINDOWS} stdcall; {$ENDIF} {$IFDEF MACOS} cdecl; {$ENDIF}
Tisc_get_client_major_version = function : Integer; {$IFDEF MSWINDOWS} stdcall; {$ENDIF} {$IFDEF MACOS} cdecl; {$ENDIF}
Tisc_get_client_minor_version = function : Integer; {$IFDEF MSWINDOWS} stdcall; {$ENDIF} {$IFDEF MACOS} cdecl; {$ENDIF}
...
(************************************)
  ...
  isc_dpb_last_dpb_constant      =         isc_dpb_sys_encrypt_password;
...
//function getb                   (p: PBSTREAM; GDSLibrary : IGDSLibrary): AnsiChar;
//function putb                   (x: AnsiChar; p: PBSTREAM; GDSLibrary : IGDSLibrary): Int;
//function putbx                  (x: AnsiChar; p: PBSTREAM; GDSLibrary : IGDSLibrary): Int;
...
//  end
//  else
//    result := AnsiChar(GDSLibrary.BLOB_get(p));
//end;
//
//function putb(x: AnsiChar; p: PBSTREAM; GDSLibrary : IGDSLibrary): Int;
//(*  The C-macro reads like this:
