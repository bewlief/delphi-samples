...
{                                                             }
{       Copyright (c) 1998-2009 CodeGear                      }
{                                                             }
...
const
  IBX_Version = 16.16;   // note major side is the Delphi version, the minor side is the interface version
                         //    This was a convention when there were multiple versions supported with interface changes in patches.
