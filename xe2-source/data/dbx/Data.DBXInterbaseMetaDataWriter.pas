...
type
  ...
  private
    procedure FormatStringType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s);
    procedure FormatBlobType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s);
...
procedure TDBXInterbaseCustomMetaDataWriter.MakeSqlDataType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s);
begin
...
procedure TDBXInterbaseCustomMetaDataWriter.FormatStringType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s);
var
  Precision: Integer;
begin
  Precision := Overrides[0];
  if Precision < 0 then
    Precision := ColumnRow.Value[TDBXColumnsIndex.Precision].GetInt32(-1);
...
procedure TDBXInterbaseCustomMetaDataWriter.FormatBlobType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s);
var
...
function TDBXInterbaseMetaDataWriter.GetSqlKeyGeneratedIndexName: UnicodeString;
begin
  Result := '';
end;
