...
{$HPPEMIT '#pragma link "Data.DbxSybaseASE"'}    {Do not Localize}
...
begin
  ...
  Values[TDBXPropertyNames.DriverPackageLoader] := 'TDBXDynalinkDriverLoader,DBXSybaseASEDriver160.bpl';
  ...
  Values[TDBXPropertyNames.MetaDataPackageLoader] := 'TDBXSybaseASEMetaDataCommandFactory,DbxSybaseASEDriver160.bpl';
  Values[TDBXPropertyNames.MetaDataAssemblyLoader] := 'Borland.Data.TDBXSybaseASEMetaDataCommandFactory,Borland.Data.DbxSybaseASEDriver,Version=16.0.0.0,Culture=neutral,PublicKeyToken=' + TDBXPlatform.GetPublicKeyToken;
