...
type
  ...
  private
    FCustomProvider: TDBXInterbaseCustomMetaDataReader;
...
function TDBXInterbaseCustomMetaDataReader.GetSqlIdentifierQuotePrefix: UnicodeString;
begin
  Result := FQuoteChar;
end;

function TDBXInterbaseCustomMetaDataReader.GetSqlIdentifierQuoteSuffix: UnicodeString;
begin
  Result := FQuoteChar;
end;

function TDBXInterbaseCustomMetaDataReader.GetSqlIdentifierQuoteChar: UnicodeString;
begin
  Result := FQuoteChar;
end;
...
function TDBXInterbaseCustomMetaDataReader.FetchColumns(const Catalog: UnicodeString; const Schema: UnicodeString; const Table: UnicodeString): TDBXTable;
var
...
function TDBXInterbaseCustomMetaDataReader.FetchProcedureParameters(const Catalog: UnicodeString; const Schema: UnicodeString; const &Procedure: UnicodeString; const Parameter: UnicodeString): TDBXTable;
var
  ParameterNames: TDBXStringArray;
  ParameterValues: TDBXStringArray;
  Cursor: TDBXTable;
...
function TDBXInterbaseMetaDataReader.GetProductName: UnicodeString;
begin
  Result := 'InterBase';
end;
...
function TDBXInterbaseMetaDataReader.FetchSchemas(const CatalogName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForTables: UnicodeString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForViews: UnicodeString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForColumns: UnicodeString;
begin
...
function TDBXInterbaseMetaDataReader.FetchColumnConstraints(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForIndexes: UnicodeString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForIndexColumns: UnicodeString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForForeignKeys: UnicodeString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForForeignKeyColumns: UnicodeString;
begin
...
function TDBXInterbaseMetaDataReader.FetchSynonyms(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const SynonymName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForProcedures: UnicodeString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForProcedureSources: UnicodeString;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForProcedureParameters: UnicodeString;
begin
  Result := 'SELECT NULL, NULL, P.RDB$PROCEDURE_NAME, P.RDB$PARAMETER_NAME, CASE ' +
            ...
            'WHERE (1<2 OR (:CATALOG_NAME IS NULL)) AND (1<2 OR (:SCHEMA_NAME IS NULL)) AND F.RDB$ARGUMENT_POSITION=0 AND (F.RDB$FUNCTION_NAME = :PARAMETER_NAME OR (:PARAMETER_NAME IS NULL))' + ' ' +
            'ORDER BY 5, 9';
end;

function TDBXInterbaseMetaDataReader.FetchPackages(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInterbaseMetaDataReader.FetchPackageProcedures(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ProcedureType: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInterbaseMetaDataReader.FetchPackageProcedureParameters(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ParameterName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInterbaseMetaDataReader.FetchPackageSources(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInterbaseMetaDataReader.GetSqlForUsers: UnicodeString;
begin
  Result := 'SELECT RDB$USER_NAME FROM RDB$USERS ORDER BY 1';
end;

function TDBXInterbaseMetaDataReader.GetSqlForRoles: UnicodeString;
begin
...
constructor TDBXInterbaseTypeFilterCursor.Create(const Provider: TDBXInterbaseCustomMetaDataReader; const MetadataCollectionName: UnicodeString; const Columns: TDBXValueTypeArray; const Cursor: TDBXTable; const OrdinalTypeName: Integer; const OrdinalFieldType: Integer; const OrdinalSubType: Integer; const OrdinalScale: Integer; const OrdinalDefaultValue: Integer);
begin
...
function TDBXInterbaseTypeFilterCursor.ComputeTypeName: UnicodeString;
var
  SubType: SmallInt;
begin
...
function TDBXInterbaseTypeFilterCursor.ComputeDefaultValue: UnicodeString;
var
