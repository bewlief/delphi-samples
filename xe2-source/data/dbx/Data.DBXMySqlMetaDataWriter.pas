...
type
  ...
  protected
    procedure MakeSqlDataType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s); override;
    function CanCreateIndexAsKey(const Index: TDBXTableRow; const IndexColumns: TDBXTable): Boolean; override;
    procedure MakeSqlCreateIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow; const IndexColumns: TDBXTable); override;
    procedure MakeSqlDropIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow); override;
    procedure MakeSqlDropForeignKey(const Buffer: TDBXStringBuffer; const ForeignKey: TDBXTableRow); override;
  ...
  private
    ...
    function FindCastType(const Column: TDBXTableRow): UnicodeString;
  end;
...
procedure TDBXMySqlCustomMetaDataWriter.MakeSqlDataType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s);
begin
...
procedure TDBXMySqlCustomMetaDataWriter.MakeSqlCreateIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow; const IndexColumns: TDBXTable);
begin
...
procedure TDBXMySqlCustomMetaDataWriter.MakeSqlDropIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow);
begin
...
procedure TDBXMySqlCustomMetaDataWriter.MakeSqlDropForeignKey(const Buffer: TDBXStringBuffer; const ForeignKey: TDBXTableRow);
begin
...
function TDBXMySqlCustomMetaDataWriter.FindCastType(const Column: TDBXTableRow): UnicodeString;
var
...
begin
  ...
  case DbType of
    TDBXDataTypes.AnsiStringType,
    TDBXDataTypes.WideStringType:
      Result := TDBXSQL.Char + TDBXSQL.OpenParen + IntToStr(Column.Value[TDBXColumnsIndex.Precision].AsInt32) + TDBXSQL.CloseParen;
    ...
    TDBXDataTypes.VarBytesType:
      Result := TDBXSQL.Binary + TDBXSQL.OpenParen + IntToStr(Column.Value[TDBXColumnsIndex.Precision].AsInt32) + TDBXSQL.CloseParen;
    else
      Result := NullString;
  end;
end;

procedure TDBXMySqlCustomMetaDataWriter.MakeSqlColumnTypeCast(const Buffer: TDBXStringBuffer; const Column: TDBXTable);
var
  Original: TDBXTableRow;
  OldType: UnicodeString;
...
function TDBXMySqlMetaDataWriter.GetSqlAutoIncrementKeyword: UnicodeString;
begin
...
function TDBXMySqlMetaDataWriter.GetSqlRenameTable: UnicodeString;
begin
