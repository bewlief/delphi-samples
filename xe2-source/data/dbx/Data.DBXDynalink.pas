...
type
  ...
  TDBXWritableRow_SetBytes = function(Handle: TDBXWritableRowHandle;
    Ordinal: TInt32; BlobOffset: Int64; Value: TBytes; LastIndex: TInt32; { dummy to simulate native "open array" }
    ValueOffset: Int64; Length: Int64): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}

  TDBXLoader_GetDriver = function(Count: TInt32;
  ...
  private
    procedure RaiseError(DBXContext: TDBXContext; DBXResult: TDBXErrorCode;
      DBXHandle: TDBXCommonHandle; AdditionalInfo: UnicodeString); overload;
    procedure RaiseError(DBXContext: TDBXContext; DBXResult: TDBXErrorCode;
  ...
  protected
    ...
    procedure SetDynamicBytes(DbxValue: TDbxValue; Offset: Int64;
      const Buffer: TBytes; BufferOffset: Int64; Count: Int64); override;
...
function TDBXDynalinkDriver.GetDriverVersion: UnicodeString;
var
...
{$ENDIF}
  FLibraryHandle := LoadLibrary(TDBXString(LibraryName));
...
function TDBXDynalinkConnection.DBXCallback(Handle: DBXCallbackHandle;
  TraceFlag: TDBXTraceFlag; TraceMessage: TDBXWideString): CBRType; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
begin
...
procedure TDBXDynalinkConnection.DerivedGetCommands(const CommandType: UnicodeString;
  const List: TStrings);
begin
end;
...
function TDBXDynalinkConnection.GetVendorProperty(const Name: UnicodeString): UnicodeString;
var
  ErrorResult: TDBXErrorCode;
  StringVersionBuilder: TDBXWideStringBuilder;
begin
...
procedure TDBXDynalinkByteReader.GetInt8(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
begin
  CheckResult(FMethodTable.FDBXRow_GetFixedBytes(FReaderHandle, Ordinal,
                                            Value,
...
procedure TDBXDynalinkByteReader.GetSingle(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
begin
  CheckResult(FMethodTable.FDBXRow_GetFixedBytes(FReaderHandle, Ordinal,
                                            Value,
...
procedure TDBXDynalinkByteReader.GetUInt16(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
begin
  inherited;
end;

procedure TDBXDynalinkByteReader.GetUInt8(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
begin
  CheckResult(FMethodTable.FDBXRow_GetFixedBytes(FReaderHandle, Ordinal,
                                            Value,
...
function TDBXDynalinkRow.GetObjectTypeName(Ordinal: TInt32): UnicodeString;
var
...
begin
  SetDynamicBytes(DbxValue, 0, TDBXPlatform.WideStrToBytes(Value), 0, Length(Value));
end;
...
procedure TDBXDynalinkRow.SetWideString(DbxValue: TDBXWideStringValue; const Value: UnicodeString);
begin
