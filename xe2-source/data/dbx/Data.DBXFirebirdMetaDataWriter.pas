...
procedure TDBXFirebirdCustomMetaDataWriter.MakeSqlDataType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s);
begin
...
procedure TDBXFirebirdCustomMetaDataWriter.FormatStringType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s);
var
  Precision: Integer;
begin
...
procedure TDBXFirebirdCustomMetaDataWriter.FormatBlobType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s);
var
...
function TDBXFirebirdMetaDataWriter.GetSqlKeyGeneratedIndexName: UnicodeString;
begin
  Result := '';
end;
