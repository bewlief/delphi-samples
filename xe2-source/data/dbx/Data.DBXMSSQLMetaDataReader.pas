...
function TDBXMsSqlCustomMetaDataReader.FetchSynonyms(const Catalog: UnicodeString; const Schema: UnicodeString; const Synonym: UnicodeString): TDBXTable;
var
...
function TDBXMsSqlMetaDataReader.GetProductName: UnicodeString;
begin
  Result := 'Microsoft SQL Server';
end;

function TDBXMsSqlMetaDataReader.GetSqlIdentifierQuotePrefix: UnicodeString;
begin
  Result := '[';
end;

function TDBXMsSqlMetaDataReader.GetSqlIdentifierQuoteSuffix: UnicodeString;
begin
  Result := ']';
end;

function TDBXMsSqlMetaDataReader.GetTableType: UnicodeString;
begin
  Result := 'U';
end;

function TDBXMsSqlMetaDataReader.GetViewType: UnicodeString;
begin
  Result := 'V';
end;

function TDBXMsSqlMetaDataReader.GetSystemTableType: UnicodeString;
begin
  Result := 'S';
end;

function TDBXMsSqlMetaDataReader.GetSystemViewType: UnicodeString;
begin
  Result := 'V';
end;

function TDBXMsSqlMetaDataReader.GetSynonymType: UnicodeString;
begin
  Result := 'SN';
end;
...
function TDBXMsSqlMetaDataReader.GetSqlForCatalogs: UnicodeString;
begin
  Result := 'SELECT name FROM master..sysdatabases';
end;

function TDBXMsSqlMetaDataReader.GetSqlForSchemas: UnicodeString;
var
...
function TDBXMsSqlMetaDataReader.GetSqlForTables: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXMsSqlMetaDataReader.GetSqlForViews: UnicodeString;
begin
...
function TDBXMsSqlMetaDataReader.GetSqlForColumns: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXMsSqlMetaDataReader.GetSqlForColumnConstraints: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXMsSqlMetaDataReader.GetSqlForIndexes: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXMsSqlMetaDataReader.GetSqlForIndexColumns: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXMsSqlMetaDataReader.GetSqlForForeignKeys: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXMsSqlMetaDataReader.GetSqlForForeignKeyColumns: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXMsSqlMetaDataReader.GetSqlForSynonyms: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXMsSqlMetaDataReader.GetSqlForProcedures: UnicodeString;
begin
...
function TDBXMsSqlMetaDataReader.GetSqlForProcedureSources: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXMsSqlMetaDataReader.GetSqlForProcedureParameters: UnicodeString;
begin
...
function TDBXMsSqlMetaDataReader.FetchPackages(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXMsSqlMetaDataReader.FetchPackageProcedures(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ProcedureType: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXMsSqlMetaDataReader.FetchPackageProcedureParameters(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ParameterName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXMsSqlMetaDataReader.FetchPackageSources(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXMsSqlMetaDataReader.GetSqlForUsers: UnicodeString;
begin
  Result := 'SELECT name FROM sysusers WHERE islogin=1 AND (sid IS NOT NULL) ORDER BY 1';
end;

function TDBXMsSqlMetaDataReader.GetSqlForRoles: UnicodeString;
begin
