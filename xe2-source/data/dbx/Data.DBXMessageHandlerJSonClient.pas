...
function TDBXJSonClientInputConnectionHandler.GetProductName: UnicodeString;
begin
  Result := NullString;
end;
...
function TDBXJSonClientOutputConnectionHandler.GetProductName: UnicodeString;
begin
  Result := NullString;
end;
