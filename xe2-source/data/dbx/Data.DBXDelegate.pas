...
type
  ...
  protected
    ...
    procedure SetParameterDirection(const ParameterDirection
        : TDBXParameterDirection); override;
    procedure SetName(const Name: UnicodeString); override;
    procedure SetDisplayName(const Caption: UnicodeString); override;
  ...
  public
    ...
    function GetOrdinal(const Name: UnicodeString): TInt32; override;
...
function TDBXDelegateConnection.GetProductName: UnicodeString;
begin
  Result := FConnection.ProductName;
end;

function TDBXDelegateConnection.GetProductVersion: UnicodeString;
begin
...
function TDBXDelegateConnection.GetVendorProperty(const Name: UnicodeString): UnicodeString;
begin
...
procedure TDBXDelegateConnection.DerivedGetCommands(const CommandType: UnicodeString;
  const List: TStrings);
begin
...
function TDBXDelegateCommand.GetText: UnicodeString;
begin
...
function TDBXDelegateCommand.GetCommandType: UnicodeString;
begin
...
procedure TDBXDelegateCommand.SetCommandType(const Value: UnicodeString);
begin
  Close;
  FCommand.CommandType := Value;
end;

procedure TDBXDelegateCommand.SetText(const Value: UnicodeString);
begin
  Close;
  FCommand.Text := Value;
end;
...
function TDBXDelegateParameterList.GetOrdinal(const Name: UnicodeString): Integer;
begin
...
function TDBXDelegateReader.GetObjectTypeName(Ordinal: TInt32): UnicodeString;
begin
  Result := FReader.GetObjectTypeName(Ordinal);
end;

function TDBXDelegateReader.GetOrdinal(const Name: UnicodeString): TInt32;
begin
...
function TDBXDelegateReader.GetValueByName(const Name: UnicodeString): TDBXValue;
begin
...
function TDBXDelegateWritableValue.GetAsString: UnicodeString;
begin
...
function TDBXDelegateWritableValue.GetWideString: UnicodeString;
begin
...
procedure TDBXDelegateWritableValue.SetAsString(const Value: UnicodeString);
begin
...
procedure TDBXDelegateWritableValue.SetWideString(const Value: UnicodeString);
begin
...
function TDBXDelegateParameter.GetDisplayName: UnicodeString;
begin
...
function TDBXDelegateParameter.GetName: UnicodeString;
begin
...
procedure TDBXDelegateParameter.SetDisplayName(const Caption: UnicodeString);
begin
...
procedure TDBXDelegateParameter.SetName(const Name: UnicodeString);
begin
