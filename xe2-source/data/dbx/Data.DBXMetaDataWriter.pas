...
type
  ...
  public
    ...
    procedure MakeSqlCreate(const Buffer: TDBXStringBuffer; const Item: TDBXTableRow; const Parts: TDBXTable); virtual; abstract;
    procedure MakeSqlAlter(const Buffer: TDBXStringBuffer; const Item: TDBXTableRow; const Parts: TDBXTable); virtual; abstract;
    procedure MakeSqlDrop(const Buffer: TDBXStringBuffer; const Item: TDBXTableRow); virtual; abstract;
    procedure MakeSqlIdentifier(const Buffer: TDBXStringBuffer; const Identifier: UnicodeString); virtual; abstract;
    function CheckColumnSupported(const Column: TDBXTableRow): Boolean; virtual; abstract;
    function GetSqlQuotedIdentifier(const UnquotedIdentifier: UnicodeString): UnicodeString; virtual; abstract;
    function GetSqlUnQuotedIdentifier(const QuotedIdentifier: UnicodeString): UnicodeString; virtual; abstract;
  protected
    ...
    function GetSqlRenameTable: UnicodeString; virtual; abstract;
    function GetSqlAutoIncrementInserts: UnicodeString; virtual; abstract;
    function GetSqlAutoIncrementKeyword: UnicodeString; virtual; abstract;
    function GetSqlKeyGeneratedIndexName: UnicodeString; virtual; abstract;
  ...
  public
    ...
    property SqlRenameTable: UnicodeString read GetSqlRenameTable;
    property SqlAutoIncrementInserts: UnicodeString read GetSqlAutoIncrementInserts;
    property SqlAutoIncrementKeyword: UnicodeString read GetSqlAutoIncrementKeyword;
    property SqlKeyGeneratedIndexName: UnicodeString read GetSqlKeyGeneratedIndexName;
  ...
  public
    ...
    function GetSqlQuotedIdentifier(const UnquotedIdentifier: UnicodeString): UnicodeString; override;
    function GetSqlUnQuotedIdentifier(const QuotedIdentifier: UnicodeString): UnicodeString; override;
    procedure MakeSqlIdentifier(const Buffer: TDBXStringBuffer; const Identifier: UnicodeString); override;
  protected
    ...
    function GetSqlKeyGeneratedIndexName: UnicodeString; override;
    function GetSqlAutoIncrementInserts: UnicodeString; override;
    function GetSqlRenameTable: UnicodeString; override;
    procedure MakeSqlObjectName(const Buffer: TDBXStringBuffer; const CatalogName: UnicodeString; const SchemaName: UnicodeString; const ObjectName: UnicodeString); virtual;
    procedure MakeSqlNullable(const Buffer: TDBXStringBuffer; const Column: TDBXTableRow); virtual;
    procedure MakeSqlDataType(const Buffer: TDBXStringBuffer; const TypeName: UnicodeString; const ColumnRow: TDBXTableRow); overload; virtual;
    procedure MakeSqlDataType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s); overload; virtual;
    function FindDataType(const InTypeName: UnicodeString; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s): TDBXDataTypeDescription; virtual;
    function FindTypeName(const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s; const FailIfNotFound: Boolean): UnicodeString; virtual;
    function FindSimpleColumnTypeMatch(const ColumnRow: TDBXTableRow; const FailIfNotFound: Boolean): UnicodeString; virtual;
    function FindBooleanTypeName(const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s; const FailIfNotFound: Boolean): UnicodeString; virtual;
    function FindStringOrBinaryTypeName(const ColumnRow: TDBXTableRow; const FailIfNotFound: Boolean): UnicodeString; virtual;
    function FindIntegerTypeName(const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s; const FailIfNotFound: Boolean): UnicodeString; virtual;
    function FindDecimalTypeName(const ColumnRow: TDBXTableRow; const FailIfNotFound: Boolean): UnicodeString; virtual;
    function FindFloatTypeName(const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s; const FailIfNotFound: Boolean): UnicodeString; virtual;
    function FindDateTimeTypeName(const ColumnRow: TDBXTableRow; const FailIfNotFound: Boolean): UnicodeString; virtual;
    procedure MakeSqlColumnTypeCast(const Buffer: TDBXStringBuffer; const Column: TDBXTable); virtual;
    function CanCreateIndexAsKey(const Index: TDBXTableRow; const IndexColumns: TDBXTable): Boolean; virtual;
    procedure MakeSqlCreateIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow; const IndexColumns: TDBXTable); virtual;
    procedure MakeSqlDropIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow); virtual;
    procedure MakeSqlCreateKey(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow; const IndexColumns: TDBXTable); virtual;
    procedure MakeSqlConstraintName(const Buffer: TDBXStringBuffer; const Constraint: TDBXTableRow);
    procedure MakeSqlAlterTablePrefix(const Buffer: TDBXStringBuffer; const Item: TDBXTableRow); virtual;
    procedure MakeSqlCreateIndexColumnList(const Buffer: TDBXStringBuffer; const IndexColumns: TDBXTable); virtual;
    procedure MakeSqlDropSecondaryIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow); virtual;
    procedure MakeSqlForeignKeySyntax(const Buffer: TDBXStringBuffer; const ForeignKey: TDBXTableRow; const ForeignKeyColumns: TDBXTable);
    procedure MakeSqlCreateForeignKey(const Buffer: TDBXStringBuffer; const ForeignKey: TDBXTableRow; const ForeignKeyColumns: TDBXTable); virtual;
    procedure MakeSqlDropForeignKey(const Buffer: TDBXStringBuffer; const ForeignKey: TDBXTableRow); virtual;
  private
    procedure MakeSqlCreateTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable);
    procedure MakeSqlAlterTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable);
    function SupportedTableAlteration(const Operation: Integer): Boolean;
    function MakeSqlFullAlterTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable): Boolean;
    function MakeSqlTableRename(const Buffer: TDBXStringBuffer; const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString; const OldCatalogName: UnicodeString; const OldSchemaName: UnicodeString; const OldTableName: UnicodeString): Boolean; overload;
    function MakeSqlColumnRename(const Buffer: TDBXStringBuffer; const ColumnName: UnicodeString; const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString; const OldColumnName: UnicodeString): Boolean;
    procedure MakeSqlColumnDefinition(const Buffer: TDBXStringBuffer; const Column: TDBXTableRow);
    procedure MakeSqlDefaultValue(const Buffer: TDBXStringBuffer; const DefaultValue: UnicodeString; const TypeName: UnicodeString);
    function RemoveMarkersForNullValues(const InFormat: UnicodeString; const Values: TDBXStringArray): UnicodeString;
    ...
    function AddToExternalStatements(const InExternalStatements: TDBXStringBuffer; const Buffer: TDBXStringBuffer; const StartPosition: Integer): TDBXStringBuffer;
    function IsValidSqlIdentifier(const Identifier: UnicodeString): Boolean;
    function IsReservedWord(const Identifier: UnicodeString): Boolean;
    ...
    procedure MakeSqlTableReplacement(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable);
    function CopyColumns(const ColumnTable: TDBXTable): TDBXTable;
    function CopyTable(const Table: TDBXTableRow; const TempTableName: UnicodeString): TDBXTable;
    function ComputeColumnMap(const Columns: TDBXTable): TDBXProperties;
    function GetDefaults(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
    function GetIndexes(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
    function GetIndexColumns(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
    function GetForeignKeyColumns(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
    ...
    procedure DropAllConstraints(const Buffer: TDBXStringBuffer; const Defaults: TDBXTable; const Indexes: TDBXTable; const ForeignKeys: TDBXTable);
    procedure CreateTempOutputTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable; const TempTableName: UnicodeString);
    procedure SetIdentityInsert(const Buffer: TDBXStringBuffer; const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString; const &On: Boolean);
    function CheckForAutoIncrement(const Columns: TDBXTable): Boolean;
    procedure InsertValuesFromOldTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable; const TempTableName: UnicodeString);
    procedure MakeSqlDropTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow);
    procedure ReplaceParameter(const Buffer: TDBXStringBuffer; const Start: Integer; const InParameter: UnicodeString; const Replacement: UnicodeString);
    procedure MakeSqlTableRename(const Buffer: TDBXStringBuffer; const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString; const NewTableName: UnicodeString); overload;
    ...
    function MapColumn(const Parts: TDBXTable; const Table: TDBXTableRow; const ColumnMap: TDBXProperties; const ColIndex: Integer; const IdColumns: Integer; const DroppedColumn: UnicodeString): UnicodeString;
    procedure CreateConstraints(const Buffer: TDBXStringBuffer; const Columns: TDBXValueTypeArray; const Constraints: TDBXTable; const ConstraintColumns: TDBXTable; const CollectionName: UnicodeString; const IdColumns: Integer; const ItemColumns: Integer; const PartColumns: Integer; const Table: TDBXTableRow; const ColumnMap: TDBXProperties; const ColIndex1: Integer; const ColIndex2: Integer);
    procedure CreateIndices(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Indexes: TDBXTable; const IndexColumns: TDBXTable; const ColumnMap: TDBXProperties);
    procedure CreateForeignKeys(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const ForeignKeyColumns: TDBXTable; const ColumnMap: TDBXProperties);
    procedure MakeSqlCreateSecondaryIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow; const IndexColumns: TDBXTable);
    procedure MakeSqlCreateConstraint(const Buffer: TDBXStringBuffer; const Constraint: TDBXTableRow);
    procedure MakeSqlDropConstraint(const Buffer: TDBXStringBuffer; const Constraint: TDBXTableRow);
    procedure MakeSqlCreateView(const Buffer: TDBXStringBuffer; const View: TDBXTableRow; const Columns: TDBXTable);
    procedure MakeSqlAlterView(const Buffer: TDBXStringBuffer; const View: TDBXTableRow; const Columns: TDBXTable);
    procedure MakeSqlDropView(const Buffer: TDBXStringBuffer; const View: TDBXTableRow);
    procedure MakeSqlCreateSynonym(const Buffer: TDBXStringBuffer; const Synonym: TDBXTableRow; const Columns: TDBXTable);
    procedure MakeSqlAlterSynonym(const Buffer: TDBXStringBuffer; const Synonym: TDBXTableRow; const Columns: TDBXTable);
    procedure MakeSqlDropSynonym(const Buffer: TDBXStringBuffer; const Synonym: TDBXTableRow);
  protected
...
procedure TDBXBaseMetaDataWriter.MakeSqlCreate(const Buffer: TDBXStringBuffer; const Item: TDBXTableRow; const Parts: TDBXTable);
var
...
procedure TDBXBaseMetaDataWriter.MakeSqlAlter(const Buffer: TDBXStringBuffer; const Item: TDBXTableRow; const Parts: TDBXTable);
var
  CollectionName: UnicodeString;
begin
  CollectionName := Item.DBXTableName;
...
procedure TDBXBaseMetaDataWriter.MakeSqlDrop(const Buffer: TDBXStringBuffer; const Item: TDBXTableRow);
var
  CollectionName: UnicodeString;
begin
  CollectionName := Item.DBXTableName;
...
function TDBXBaseMetaDataWriter.GetSqlAutoIncrementKeyword: UnicodeString;
begin
  Result := NullString;
end;

function TDBXBaseMetaDataWriter.GetSqlKeyGeneratedIndexName: UnicodeString;
begin
  Result := NullString;
end;

function TDBXBaseMetaDataWriter.GetSqlQuotedIdentifier(const UnquotedIdentifier: UnicodeString): UnicodeString;
begin
...
function TDBXBaseMetaDataWriter.GetSqlUnQuotedIdentifier(const QuotedIdentifier: UnicodeString): UnicodeString;
begin
...
function TDBXBaseMetaDataWriter.GetSqlAutoIncrementInserts: UnicodeString;
begin
  Result := NullString;
end;

function TDBXBaseMetaDataWriter.GetSqlRenameTable: UnicodeString;
begin
  Result := NullString;
end;

procedure TDBXBaseMetaDataWriter.MakeSqlCreateTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable);
var
  Separator: UnicodeString;
  SecondSeparator: UnicodeString;
...
procedure TDBXBaseMetaDataWriter.MakeSqlAlterTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable);
var
  Original: TDBXTableRow;
  CatalogName: UnicodeString;
  SchemaName: UnicodeString;
...
function TDBXBaseMetaDataWriter.MakeSqlFullAlterTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable): Boolean;
var
  MarkerA: Integer;
  MarkerB: Integer;
  &Inline: Boolean;
  OriginalTable: TDBXTableRow;
  ExternalStatements: TDBXStringBuffer;
  ...
  AutoIncrementWord: UnicodeString;
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        &Inline := MakeSqlColumnRename(Buffer, Modified.Value[TDBXColumnsIndex.ColumnName].GetWideString(NullString), OriginalTable.Value[TDBXTablesIndex.CatalogName].GetWideString(NullString), OriginalTable.Value[TDBXTablesIndex.SchemaName].GetWideString(NullString), OriginalTable.Value[TDBXTablesIndex.TableName].GetWideString(NullString), Original.Value[TDBXColumnsIndex.ColumnName].GetWideString(NullString));
        if not &Inline then
        begin
...
function TDBXBaseMetaDataWriter.MakeSqlTableRename(const Buffer: TDBXStringBuffer; const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString; const OldCatalogName: UnicodeString; const OldSchemaName: UnicodeString; const OldTableName: UnicodeString): Boolean;
begin
...
function TDBXBaseMetaDataWriter.MakeSqlColumnRename(const Buffer: TDBXStringBuffer; const ColumnName: UnicodeString; const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString; const OldColumnName: UnicodeString): Boolean;
begin
  Buffer.Append(TDBXSQL.&To);
  Buffer.Append(TDBXSQL.Space);
...
procedure TDBXBaseMetaDataWriter.MakeSqlObjectName(const Buffer: TDBXStringBuffer; const CatalogName: UnicodeString; const SchemaName: UnicodeString; const ObjectName: UnicodeString);
var
  Dot: UnicodeString;
begin
  Dot := TDBXSQL.Empty;
...
procedure TDBXBaseMetaDataWriter.MakeSqlIdentifier(const Buffer: TDBXStringBuffer; const Identifier: UnicodeString);
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlColumnDefinition(const Buffer: TDBXStringBuffer; const Column: TDBXTableRow);
var
  AutoIncrementWord: UnicodeString;
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlNullable(const Buffer: TDBXStringBuffer; const Column: TDBXTableRow);
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlDefaultValue(const Buffer: TDBXStringBuffer; const DefaultValue: UnicodeString; const TypeName: UnicodeString);
begin
...
function TDBXBaseMetaDataWriter.RemoveMarkersForNullValues(const InFormat: UnicodeString; const Values: TDBXStringArray): UnicodeString;
var
  Found: Integer;
  SearchFor: UnicodeString;
...
procedure TDBXBaseMetaDataWriter.MakeSqlDataType(const Buffer: TDBXStringBuffer; const TypeName: UnicodeString; const ColumnRow: TDBXTableRow);
var
...
procedure TDBXBaseMetaDataWriter.MakeSqlDataType(const Buffer: TDBXStringBuffer; const DataType: TDBXDataTypeDescription; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s);
var
  FormattedType: UnicodeString;
  Params: UnicodeString;
  FormatString: UnicodeString;
...
function TDBXBaseMetaDataWriter.FindDataType(const InTypeName: UnicodeString; const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s): TDBXDataTypeDescription;
var
...
function TDBXBaseMetaDataWriter.FindTypeName(const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s; const FailIfNotFound: Boolean): UnicodeString;
var
  ColumnType: Integer;
begin
  ColumnType := ColumnRow.Value[TDBXColumnsIndex.DbxDataType].AsInt32;
...
function TDBXBaseMetaDataWriter.FindSimpleColumnTypeMatch(const ColumnRow: TDBXTableRow; const FailIfNotFound: Boolean): UnicodeString;
var
  WantedColumnType: Integer;
  BestScore: Integer;
  BestTypeName: UnicodeString;
...
function TDBXBaseMetaDataWriter.FindBooleanTypeName(const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s; const FailIfNotFound: Boolean): UnicodeString;
var
  BestScore: Integer;
  BestTypeName: UnicodeString;
  DataTypes: TDBXArrayList;
...
function TDBXBaseMetaDataWriter.FindStringOrBinaryTypeName(const ColumnRow: TDBXTableRow; const FailIfNotFound: Boolean): UnicodeString;
var
  WantedColumnType: Integer;
...
begin
  ...
  PrecisionRequired := ColumnRow.Value[TDBXColumnsIndex.Precision].GetInt32(-1);
...
function TDBXBaseMetaDataWriter.FindIntegerTypeName(const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s; const FailIfNotFound: Boolean): UnicodeString;
var
  ColumnType: Integer;
...
function TDBXBaseMetaDataWriter.FindDecimalTypeName(const ColumnRow: TDBXTableRow; const FailIfNotFound: Boolean): UnicodeString;
var
  PrecisionRequired: Integer;
...
function TDBXBaseMetaDataWriter.FindFloatTypeName(const ColumnRow: TDBXTableRow; const Overrides: TDBXInt32s; const FailIfNotFound: Boolean): UnicodeString;
var
  WantedColumnType: Integer;
  PrecisionRequired: Integer;
  BestScore: Integer;
...
begin
  ...
  begin
    ...
    begin
      if ColumnRow.Value[TDBXColumnsIndex.Precision].IsNull or (ColumnRow.Value[TDBXColumnsIndex.Precision].AsInt32 < PrecisionRequired) then
      begin
...
function TDBXBaseMetaDataWriter.FindDateTimeTypeName(const ColumnRow: TDBXTableRow; const FailIfNotFound: Boolean): UnicodeString;
var
  WantedColumnType: Integer;
  BestScore: Integer;
  BestTypeName: UnicodeString;
...
function TDBXBaseMetaDataWriter.AddToExternalStatements(const InExternalStatements: TDBXStringBuffer; const Buffer: TDBXStringBuffer; const StartPosition: Integer): TDBXStringBuffer;
var
  ExternalStatements: TDBXStringBuffer;
begin
  ExternalStatements := InExternalStatements;
  if ExternalStatements = nil then
    ExternalStatements := TDBXStringBuffer.Create;
  ExternalStatements.Append(SubString(Buffer,StartPosition));
  Result := ExternalStatements;
end;

function TDBXBaseMetaDataWriter.IsValidSqlIdentifier(const Identifier: UnicodeString): Boolean;
var
  UpperOK: Boolean;
  LowerOK: Boolean;
  Index: Integer;
...
function TDBXBaseMetaDataWriter.IsReservedWord(const Identifier: UnicodeString): Boolean;
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlTableReplacement(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable);
var
  OriginalTable: TDBXTableRow;
  TableRename: Boolean;
  NewCatalogName: UnicodeString;
  NewSchemaName: UnicodeString;
  NewTableName: UnicodeString;
  TempTableName: UnicodeString;
  NewTable: TDBXTable;
  NewColumns: TDBXTable;
begin
  OriginalTable := Table.OriginalRow;
...
function TDBXBaseMetaDataWriter.CopyTable(const Table: TDBXTableRow; const TempTableName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
  TableCopy: TDBXTable;
  NewTableName: UnicodeString;
...
function TDBXBaseMetaDataWriter.GetDefaults(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
begin
  Result := FReader.MakeStorage(FReader.FetchColumnConstraints(CatalogName, SchemaName, TableName));
end;

function TDBXBaseMetaDataWriter.GetIndexes(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
begin
  Result := FReader.MakeStorage(FReader.FetchIndexes(CatalogName, SchemaName, TableName));
end;

function TDBXBaseMetaDataWriter.GetIndexColumns(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
begin
  Result := FReader.MakeStorage(FReader.FetchIndexColumns(CatalogName, SchemaName, TableName, NullString));
end;

function TDBXBaseMetaDataWriter.GetForeignKeyColumns(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
var
  ForeignKeyColumns: TDBXTable;
  ImportedKeyColumns: TDBXTable;
begin
...
var
  GeneratedIndexName: UnicodeString;
  Name: UnicodeString;
  Original: TDBXTableRow;
...
procedure TDBXBaseMetaDataWriter.DropAllConstraints(const Buffer: TDBXStringBuffer; const Defaults: TDBXTable; const Indexes: TDBXTable; const ForeignKeys: TDBXTable);
begin
...
procedure TDBXBaseMetaDataWriter.CreateTempOutputTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable; const TempTableName: UnicodeString);
var
...
procedure TDBXBaseMetaDataWriter.SetIdentityInsert(const Buffer: TDBXStringBuffer; const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString; const &On: Boolean);
var
  AutoIncrementInserts: UnicodeString;
begin
...
procedure TDBXBaseMetaDataWriter.InsertValuesFromOldTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Columns: TDBXTable; const TempTableName: UnicodeString);
var
  CurrentColumns: TDBXTable;
  OriginalTable: TDBXTableRow;
  OldCatalogName: UnicodeString;
  OldSchemaName: UnicodeString;
  OldTableName: UnicodeString;
  NewCatalogName: UnicodeString;
  NewSchemaName: UnicodeString;
...
procedure TDBXBaseMetaDataWriter.MakeSqlColumnTypeCast(const Buffer: TDBXStringBuffer; const Column: TDBXTable);
var
  Original: TDBXTableRow;
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlDropTable(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow);
begin
  Buffer.Append(TDBXSQL.Drop);
  Buffer.Append(TDBXSQL.Space);
  Buffer.Append(TDBXSQL.Table);
...
procedure TDBXBaseMetaDataWriter.ReplaceParameter(const Buffer: TDBXStringBuffer; const Start: Integer; const InParameter: UnicodeString; const Replacement: UnicodeString);
var
...
procedure TDBXBaseMetaDataWriter.MakeSqlTableRename(const Buffer: TDBXStringBuffer; const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString; const NewTableName: UnicodeString);
var
  Start: Integer;
begin
  Start := Buffer.Length;
...
function TDBXBaseMetaDataWriter.MapColumn(const Parts: TDBXTable; const Table: TDBXTableRow; const ColumnMap: TDBXProperties; const ColIndex: Integer; const IdColumns: Integer; const DroppedColumn: UnicodeString): UnicodeString;
var
  Original: TDBXTableRow;
  ColumnName: UnicodeString;
  MappedName: UnicodeString;
begin
...
var
  Item: TDBXTable;
  Parts: TDBXTable;
  DroppedColumn: UnicodeString;
  MoreItems: Boolean;
  ItemSource: TDBXTable;
  MoreColumns: Boolean;
begin
  ...
  begin
    ...
    begin
      ...
      Buffer.Append(TDBXSQL.Space);
      Buffer.Append(Format(SCannotRecreateConstraint, [Item.Value[IdColumns - 1].AsString,DroppedColumn]));
      Buffer.Append(TDBXSQL.Nl);
      DroppedColumn := NullString;
    end;
  end;
...
procedure TDBXBaseMetaDataWriter.CreateIndices(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const Indexes: TDBXTable; const IndexColumns: TDBXTable; const ColumnMap: TDBXProperties);
var
  Columns: TDBXValueTypeArray;
begin
...
procedure TDBXBaseMetaDataWriter.CreateForeignKeys(const Buffer: TDBXStringBuffer; const Table: TDBXTableRow; const ForeignKeyColumns: TDBXTable; const ColumnMap: TDBXProperties);
var
  Columns: TDBXValueTypeArray;
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlCreateIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow; const IndexColumns: TDBXTable);
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlDropIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow);
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlCreateKey(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow; const IndexColumns: TDBXTable);
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlCreateSecondaryIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow; const IndexColumns: TDBXTable);
begin
  Buffer.Append(TDBXSQL.&Create);
  Buffer.Append(TDBXSQL.Space);
...
procedure TDBXBaseMetaDataWriter.MakeSqlCreateConstraint(const Buffer: TDBXStringBuffer; const Constraint: TDBXTableRow);
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlConstraintName(const Buffer: TDBXStringBuffer; const Constraint: TDBXTableRow);
var
...
procedure TDBXBaseMetaDataWriter.MakeSqlAlterTablePrefix(const Buffer: TDBXStringBuffer; const Item: TDBXTableRow);
begin
  Buffer.Append(TDBXSQL.Alter);
  Buffer.Append(TDBXSQL.Space);
  Buffer.Append(TDBXSQL.Table);
...
procedure TDBXBaseMetaDataWriter.MakeSqlDropConstraint(const Buffer: TDBXStringBuffer; const Constraint: TDBXTableRow);
var
  ConstraintName: UnicodeString;
begin
  MakeSqlAlterTablePrefix(Buffer, Constraint);
...
procedure TDBXBaseMetaDataWriter.MakeSqlCreateIndexColumnList(const Buffer: TDBXStringBuffer; const IndexColumns: TDBXTable);
var
  Columns: TDBXTable;
  Comma: UnicodeString;
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlDropSecondaryIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow);
begin
  Buffer.Append(TDBXSQL.Drop);
  Buffer.Append(TDBXSQL.Space);
  Buffer.Append(TDBXSQL.Index);
...
procedure TDBXBaseMetaDataWriter.MakeSqlForeignKeySyntax(const Buffer: TDBXStringBuffer; const ForeignKey: TDBXTableRow; const ForeignKeyColumns: TDBXTable);
var
  Columns: TDBXTable;
  Comma: UnicodeString;
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlCreateForeignKey(const Buffer: TDBXStringBuffer; const ForeignKey: TDBXTableRow; const ForeignKeyColumns: TDBXTable);
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlDropForeignKey(const Buffer: TDBXStringBuffer; const ForeignKey: TDBXTableRow);
begin
  MakeSqlDropConstraint(Buffer, ForeignKey);
end;

procedure TDBXBaseMetaDataWriter.MakeSqlCreateView(const Buffer: TDBXStringBuffer; const View: TDBXTableRow; const Columns: TDBXTable);
begin
...
procedure TDBXBaseMetaDataWriter.MakeSqlAlterView(const Buffer: TDBXStringBuffer; const View: TDBXTableRow; const Columns: TDBXTable);
var
...
procedure TDBXBaseMetaDataWriter.MakeSqlDropView(const Buffer: TDBXStringBuffer; const View: TDBXTableRow);
begin
  Buffer.Append(TDBXSQL.Drop);
  Buffer.Append(TDBXSQL.Space);
...
procedure TDBXBaseMetaDataWriter.MakeSqlCreateSynonym(const Buffer: TDBXStringBuffer; const Synonym: TDBXTableRow; const Columns: TDBXTable);
begin
  Buffer.Append(TDBXSQL.&Create);
  Buffer.Append(TDBXSQL.Space);
...
procedure TDBXBaseMetaDataWriter.MakeSqlAlterSynonym(const Buffer: TDBXStringBuffer; const Synonym: TDBXTableRow; const Columns: TDBXTable);
begin
  MakeSqlDropSynonym(Buffer, Synonym);
  MakeSqlCreateSynonym(Buffer, Synonym, Columns);
end;

procedure TDBXBaseMetaDataWriter.MakeSqlDropSynonym(const Buffer: TDBXStringBuffer; const Synonym: TDBXTableRow);
begin
  Buffer.Append(TDBXSQL.Drop);
  Buffer.Append(TDBXSQL.Space);
  Buffer.Append(TDBXSQL.Synonym);
