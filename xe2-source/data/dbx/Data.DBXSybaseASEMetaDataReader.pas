...
type
  ...
  protected
    ...
    /// </remarks>
    function GetSqlForForeignKeyColumnsPart2: UnicodeString; virtual; abstract;
  protected
    ...
    ///   property and supply a query that includes the column names of the table being referenced.
    /// </remarks>
    property SqlForForeignKeyColumnsPart2: UnicodeString read GetSqlForForeignKeyColumnsPart2;
  end;
  ...
  protected
    ...
    function GetSqlForForeignKeyColumnsPart2: UnicodeString; override;
...
function TDBXSybaseASEMetaDataReader.GetProductName: UnicodeString;
begin
  Result := 'Sybase SQL Server';
end;

function TDBXSybaseASEMetaDataReader.GetTableType: UnicodeString;
begin
  Result := 'U';
end;

function TDBXSybaseASEMetaDataReader.GetViewType: UnicodeString;
begin
  Result := 'V';
end;

function TDBXSybaseASEMetaDataReader.GetSystemTableType: UnicodeString;
begin
  Result := 'S';
end;
...
function TDBXSybaseASEMetaDataReader.GetSqlIdentifierQuoteChar: UnicodeString;
begin
  Result := '';
end;

function TDBXSybaseASEMetaDataReader.GetSqlProcedureQuoteChar: UnicodeString;
begin
  Result := '';
end;

function TDBXSybaseASEMetaDataReader.GetSqlIdentifierQuotePrefix: UnicodeString;
begin
  Result := '';
end;

function TDBXSybaseASEMetaDataReader.GetSqlIdentifierQuoteSuffix: UnicodeString;
begin
  Result := '';
end;
...
function TDBXSybaseASEMetaDataReader.GetSqlForSchemas: UnicodeString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForTables: UnicodeString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForViews: UnicodeString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForColumns: UnicodeString;
begin
...
function TDBXSybaseASEMetaDataReader.FetchColumnConstraints(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForIndexes: UnicodeString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForIndexColumns: UnicodeString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForForeignKeys: UnicodeString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForForeignKeyColumns: UnicodeString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForForeignKeyColumnsPart2: UnicodeString;
begin
  Result := 'SELECT DB_NAME(), USER_NAME(ft.uid), ft.name, fk.name, NULL, DB_NAME(), USER_NAME(pt.uid), pt.name, pi.name, NULL, r.keycnt, ' +
...
function TDBXSybaseASEMetaDataReader.FetchSynonyms(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const SynonymName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForProcedures: UnicodeString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForProcedureSources: UnicodeString;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForProcedureParameters: UnicodeString;
begin
...
function TDBXSybaseASEMetaDataReader.FetchPackages(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASEMetaDataReader.FetchPackageProcedures(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ProcedureType: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASEMetaDataReader.FetchPackageProcedureParameters(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ParameterName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASEMetaDataReader.FetchPackageSources(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASEMetaDataReader.GetSqlForUsers: UnicodeString;
begin
  Result := 'SELECT name FROM dbo.sysusers WHERE uid > 0 AND suid >= -1';
end;

function TDBXSybaseASEMetaDataReader.GetSqlForRoles: UnicodeString;
begin
