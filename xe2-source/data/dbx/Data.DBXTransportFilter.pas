...
type
  ...
  private
    function ConsumeLeftover(const Data: TBytes; const Offset: Integer; const Len: Integer): Integer;
    procedure SetLeftover(const Data: TBytes; const Offset: Integer);
    ...
    function RestoreFilterList(const Data: TBytes; const Pos: Integer): Boolean;
    ...
    function FillBuffer(const Buffer: TBytes; const Offset: Integer; const Count: Integer): Boolean;
    ...
    function FilterDataRead(const Data: TBytes; const Count: Integer; const OnlyPublikKeyCryptographs: Boolean): TBytes;
    ...
    function FilterDataWrite(const Data: TBytes; const Count: Integer; const OnlyPublikKeyCryptographs: Boolean): TBytes;
  public
...
function TDBXFilterSocketChannel.ConsumeLeftover(const Data: TBytes; const Offset: Integer; const Len: Integer): Integer;
var
  Size: Integer;
begin
...
procedure TDBXFilterSocketChannel.SetLeftover(const Data: TBytes; const Offset: Integer);
begin
  FLeftover := Data;
  FLeftoverPos := Offset;
end;
...
function TDBXFilterSocketChannel.RestoreFilterList(const Data: TBytes; const Pos: Integer): Boolean;
var
...
function TDBXFilterSocketChannel.FillBuffer(const Buffer: TBytes; const Offset: Integer; const Count: Integer): Boolean;
var
  Len: Integer;
  Size: Integer;
begin
...
function TDBXFilterSocketChannel.Read(const Buffer: TBytes; const Offset: Integer; const Count: Integer): Integer;
var
  PkcFiltersPresent: Boolean;
  ReadCount: Integer;
  ConsistentSize: Integer;
  FilteredBuffer: TBytes;
  FilteredData: TBytes;
begin
...
function TDBXFilterSocketChannel.Write(const Buffer: TBytes; const Offset: Integer; const Count: Integer): Integer;
var
  FilteredData: TBytes;
  i: Integer;
  Filter: TTransportFilter;
...
function TDBXFilterSocketChannel.FilterDataRead(const Data: TBytes; const Count: Integer; const OnlyPublikKeyCryptographs: Boolean): TBytes;
var
  ProcessedData: TBytes;
  Filter: TTransportFilter;
  I: Integer;
begin
...
function TDBXFilterSocketChannel.FilterDataWrite(const Data: TBytes; const Count: Integer; const OnlyPublikKeyCryptographs: Boolean): TBytes;
var
  ProcessedData: TBytes;
  Filter: TTransportFilter;
  I: Integer;
