...
{$HPPEMIT '#pragma link "Data.DbxInformix"'}    {Do not Localize}
...
begin
  ...
  Values[TDBXPropertyNames.DriverPackageLoader] := 'TDBXDynalinkDriverLoader,DBXInformixDriver160.bpl';
  ...
  Values[TDBXPropertyNames.MetaDataPackageLoader] := 'TDBXInformixMetaDataCommandFactory,DbxInformixDriver160.bpl';
  Values[TDBXPropertyNames.MetaDataAssemblyLoader] := 'Borland.Data.TDBXInformixMetaDataCommandFactory,Borland.Data.DbxInformixDriver,Version=16.0.0.0,Culture=neutral,PublicKeyToken=' + TDBXPlatform.GetPublicKeyToken;
