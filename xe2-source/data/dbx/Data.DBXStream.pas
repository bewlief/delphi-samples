...
type
  ...
  public
    ...
    function Decode(const Buf: TBytes; const InBufOff: Integer; const MaxBytes: Integer): Boolean;
    procedure AddNullChar;
    destructor Destroy; override;
  private
    function DecodeChars(const Buf: TBytes; const InBufOff: Integer; const InMaxOff: Integer): Boolean;
  protected
    FHitChar: Boolean;
  ...
  public
    class function UnpackInt(const Buf: TBytes; const InOffset: Integer): Integer; static;
    class procedure PackInt(const Buf: TBytes; const InOffset: Integer; const IVal: Integer); static;
    class function RepackRealForIndex(const SourceBuf: TBytes; const InSourceOff: Integer; const DestBuf: TBytes; const InDestOff: Integer; const &Type: Integer): Integer; static;
    class function UnpackDoubleAsInt64(const Buf: TBytes; const InOffset: Integer): Int64; static;
    class function UnpackDouble(const Buf: TBytes; const Offset: Integer): Double; static;
    class function PackDouble(const Buf: TBytes; const InOffset: Integer; const DValue: Double; const ForIndex: Boolean): Integer; static;
    class function UnpackFloat(const Buf: TBytes; const InOffset: Integer): Single; static;
    class function PackFloat(const Buf: TBytes; const InOffset: Integer; const FValue: Single; const ForIndex: Boolean): Integer; static;
    class function PackAsciiShort(const Buf: TBytes; const InOffset: Integer; const InSVal: Integer; const Compact: Boolean): Integer; static;
    class function PackAsciiInt(const Buf: TBytes; const InOffset: Integer; const InIVal: Integer; const Compact: Boolean): Integer; static;
    class function PackAsciiLong(const Buf: TBytes; const InOffset: Integer; const InLVal: Int64; const Compact: Boolean): Integer; static;
    class function PackStringHeader(const Buffer: TBytes; const InOff: Integer; const Count: Integer): Integer; static;
    class function UnpackAsciiShort(const Buf: TBytes; const InOffset: Integer): SmallInt; static;
    class function UnpackAsciiInt(const Buf: TBytes; const InOffset: Integer): Integer; static;
    class function UnpackAsciiLong(const Buf: TBytes; const InOffset: Integer): Int64; static;
    class function GetBlobHeaderLength(const Buffer: TBytes; const Off: Integer): Integer; static;
    class function GetBlobLength(const Buffer: TBytes; const Off: Integer): Integer; static;
    class function PackBigDecimal(const Buf: TBytes; const InOffset: Integer; const Bytes: TBytes; const InScale: Integer; const Signum: Integer; const InMaxWidth: Integer; const Precision: Integer; const Compact: Boolean): Integer; static;
    class function UnpackBigDecimal(const Buf: TBytes; const InOffset: Integer; const InDest: TBytes; const ReturnLength: TDBXInt32s): TBytes; static;
  protected
    class procedure ComplementIntValue(const Buf: TBytes); static;
  end;

  TDBXJSonError = class(TDBXError)
  public
    constructor Create(const ErrorCode: Integer; const Message: UnicodeString; const Ex: Exception);
  private
  ...
  public
    ...
    procedure FillBuffer(const Bytes: TBytes); overload;
    procedure ReadDataBytes(const Buffer: TBytes; const InReadOff: Integer; const InCount: Integer);
    function ReadBoolean: Boolean;
    function ReadInt: Integer;
    function GetBytes(const Buffer: TBytes; const Offset: Int64; const Count: Int64): Int64;
    function ReadByte: Byte;
  ...
  private
    ...
    function TokenToString(const Token: Integer): UnicodeString;
    procedure UnexpectedString(const ExpectedString: UnicodeString);
    ...
    function NextString(const ExpectedString: UnicodeString; const Offset: Integer; const Count: Integer): Integer; overload;
    function HexToDecimal(const Value: Byte): Integer;
    function NextString(const StartPosition: Integer): Integer; overload;
    function BytesToString(const Count: Integer; const Offset: Integer = 0): UnicodeString;
    procedure TraceRead;
    procedure ReadError;
  ...
  public
    ...
    procedure WritePrepareStart(const CommandHandle: Integer; const Updateable: Boolean; const CommandType: UnicodeString; const Command: UnicodeString);
    procedure WriteExecuteStart;
    procedure WriteExecuteFieldsObject(const CommandHandle: Integer; const Updateable: Boolean; const CommandType: UnicodeString; const Command: UnicodeString);
    procedure WriteParametersObjectStart(const Count: Integer);
    procedure WriteParameter(const DataType: Integer; const SubType: Integer; const ParameterDirection: Integer; const Precision: Integer; const Scale: Integer; const Name: UnicodeString; const ChildPosition: Integer; const Size: Integer);
    ...
    procedure WriteDataObject(const Data: TBytes; const Count: Integer); overload;
    ...
    procedure WriteVendorProperty(const PropertyName: UnicodeString);
    procedure WriteResultEnd;
    procedure WriteResultObject(const Value: Int64);
    procedure WriteRpcError(const Name: UnicodeString; const ErrorCode: Integer; const Message: UnicodeString; const NameValuePairs: TDBXStringArray);
    procedure WriteNamedString(const Name: UnicodeString; const Value: UnicodeString);
    ...
    procedure WriteDataBytes(const SourceBytes: TBytes; const InSourceOffset: Integer; const InCount: Integer);
    procedure WriteString(const Chars: UnicodeString);
    procedure Flush;
  ...
  private
    procedure WriteCommandFields(const CommandHandle: Integer; const Updateable: Boolean; const CommandType: UnicodeString; const Command: UnicodeString);
    procedure WriteBytes(const Bytes: TBytes);
    function BytesToString(const Count: Integer): UnicodeString;
  ...
  private
    ...
    class var CallbackStart: TBytes;
    class var MetadataStart: TBytes;
  public
  ...
  public
    ...
    procedure Store(const InBuffer: TBytes; const InOffset: Integer; const Count: Integer); overload;
    function Read(const Buf: TBytes; const InOffset: Integer; const InSize: Integer): Integer; override;
  ...
  public
    ...
    procedure ReadBytes(const DestBuf: TBytes; const DestOff: Integer; const Count: Integer);
    ...
    function ReadInlineAnsiChars(const RowHandle: Integer; const ByteBuf: TBytes; const MaxChars: Integer): Integer;
    function ReadString(const RowHandle: Integer): UnicodeString;
    function ReadStringBytes(const RowHandle: Integer; const ByteBuf: TBytes; const Offset: Integer): Integer; overload;
    function ReadAnsiStringBytes(const RowHandle: Integer; const ByteBuf: TBytes; const Offset: Integer): Integer;
    function ReadStringBytes(const RowHandle: Integer): TBytes; overload;
    procedure WriteBoolean(const Data: Boolean);
    procedure WriteByte(const Data: Byte);
    procedure WriteShort(const Data: SmallInt);
    ...
    function WriteString(const Data: UnicodeString): Boolean;
    procedure Post;
    procedure Cancel;
  ...
  public
    ...
    function DecodeToWideBytes(const InBuf: TBytes; const InOff: Integer; const OutBuf: TBytes; const MaxBytes: Integer): Boolean;
    function DecodeBytes(const InBuf: TBytes; const InOff: Integer; const MaxBytes: Integer): Boolean;
    function ExtractDecodeByteBuffer: TBytes;
    destructor Destroy; override;
  private
    procedure GrowDecodeByteBuf;
    function DecodeCharsToBytes(const InBuf: TBytes; const InOff: Integer; const DecodeByteBuf: TBytes; const InOutOff: Integer; const InMaxOff: Integer): Boolean;
  private
    FMaxOff: Integer;
  ...
  public
    ...
    function Encode(const Source: UnicodeString; const InDest: TBytes; const DestOff: Integer; const InMaxBytes: Integer; const NullTerm: Boolean): Boolean;
    destructor Destroy; override;
  private
    procedure GrowEncodeBufTo(const OldBuf: TBytes; const NewLength: Integer);
  protected
...
function TDBXCharDecoder.Decode(const Buf: TBytes; const InBufOff: Integer; const MaxBytes: Integer): Boolean;
var
  BufOff: Integer;
  MaxOff: Integer;
  B: Byte;
...
function TDBXCharDecoder.DecodeChars(const Buf: TBytes; const InBufOff: Integer; const InMaxOff: Integer): Boolean;
var
  BufOff: Integer;
  MaxOff: Integer;
  Ch: WideChar;
...
class function TDBXFieldPacker.UnpackInt(const Buf: TBytes; const InOffset: Integer): Integer;
var
  IVal: Integer;
  Offset: Integer;
begin
...
class procedure TDBXFieldPacker.PackInt(const Buf: TBytes; const InOffset: Integer; const IVal: Integer);
var
  Offset: Integer;
begin
  Offset := InOffset;
...
class function TDBXFieldPacker.RepackRealForIndex(const SourceBuf: TBytes; const InSourceOff: Integer; const DestBuf: TBytes; const InDestOff: Integer; const &Type: Integer): Integer;
var
  DestOff: Integer;
  SourceOff: Integer;
  Header: Integer;
...
class function TDBXFieldPacker.UnpackDoubleAsInt64(const Buf: TBytes; const InOffset: Integer): Int64;
var
  Offset: Integer;
  Header: Integer;
  Len: Integer;
...
class function TDBXFieldPacker.UnpackDouble(const Buf: TBytes; const Offset: Integer): Double;
begin
  Result := TDBXPlatform.Int64BitsToDouble(UnpackDoubleAsInt64(Buf, Offset));
end;

class function TDBXFieldPacker.PackDouble(const Buf: TBytes; const InOffset: Integer; const DValue: Double; const ForIndex: Boolean): Integer;
var
  Offset: Integer;
  LValue: Int64;
  LInt: Integer;
...
class function TDBXFieldPacker.UnpackFloat(const Buf: TBytes; const InOffset: Integer): Single;
var
  Offset: Integer;
  Header: Integer;
  Len: Integer;
...
class function TDBXFieldPacker.PackFloat(const Buf: TBytes; const InOffset: Integer; const FValue: Single; const ForIndex: Boolean): Integer;
var
  Offset: Integer;
  IValue: Integer;
begin
...
class function TDBXFieldPacker.PackAsciiShort(const Buf: TBytes; const InOffset: Integer; const InSVal: Integer; const Compact: Boolean): Integer;
var
  Offset: Integer;
  SVal: Integer;
  Digit: Byte;
...
class function TDBXFieldPacker.PackAsciiInt(const Buf: TBytes; const InOffset: Integer; const InIVal: Integer; const Compact: Boolean): Integer;
var
  Offset: Integer;
  IVal: Integer;
  Digit: Byte;
...
class function TDBXFieldPacker.PackAsciiLong(const Buf: TBytes; const InOffset: Integer; const InLVal: Int64; const Compact: Boolean): Integer;
var
  Offset: Integer;
  LVal: Int64;
  Digit: Integer;
...
class function TDBXFieldPacker.PackStringHeader(const Buffer: TBytes; const InOff: Integer; const Count: Integer): Integer;
var
  Off: Integer;
begin
  Off := InOff;
...
class function TDBXFieldPacker.UnpackAsciiShort(const Buf: TBytes; const InOffset: Integer): SmallInt;
var
  Offset: Integer;
  Flags: Byte;
  ShortValue: SmallInt;
...
class function TDBXFieldPacker.UnpackAsciiInt(const Buf: TBytes; const InOffset: Integer): Integer;
var
  Offset: Integer;
  Flags: Byte;
  IntValue: Integer;
...
class function TDBXFieldPacker.UnpackAsciiLong(const Buf: TBytes; const InOffset: Integer): Int64;
var
  Offset: Integer;
  Flags: Byte;
  LongValue: Int64;
...
class function TDBXFieldPacker.GetBlobHeaderLength(const Buffer: TBytes; const Off: Integer): Integer;
begin
...
class function TDBXFieldPacker.GetBlobLength(const Buffer: TBytes; const Off: Integer): Integer;
begin
  Result := ((Buffer[Off + 1]) shl 24) or ((Buffer[Off + 2] and 255) shl 16) or ((Buffer[Off + 3] and 255) shl 8) or ((Buffer[Off + 4] and 255));
end;

class procedure TDBXFieldPacker.ComplementIntValue(const Buf: TBytes);
var
  Carry: Boolean;
  I: Integer;
begin
...
class function TDBXFieldPacker.PackBigDecimal(const Buf: TBytes; const InOffset: Integer; const Bytes: TBytes; const InScale: Integer; const Signum: Integer; const InMaxWidth: Integer; const Precision: Integer; const Compact: Boolean): Integer;
var
  MaxWidth: Integer;
  Scale: Integer;
  Offset: Integer;
...
class function TDBXFieldPacker.UnpackBigDecimal(const Buf: TBytes; const InOffset: Integer; const InDest: TBytes; const ReturnLength: TDBXInt32s): TBytes;
var
  Offset: Integer;
  Dest: TBytes;
  Header: Integer;
...
constructor TDBXJSonError.Create(const ErrorCode: Integer; const Message: UnicodeString; const Ex: Exception);
begin
...
function TDBXJSonStreamReader.TokenToString(const Token: Integer): UnicodeString;
begin
  case Token of
    TDBXTokens.ObjectStartToken:
      Result := '{';
...
procedure TDBXJSonStreamReader.UnexpectedString(const ExpectedString: UnicodeString);
var
  Buffer: UnicodeString;
begin
...
function TDBXJSonStreamReader.NextString(const ExpectedString: UnicodeString; const Offset: Integer; const Count: Integer): Integer;
var
  Index: Integer;
begin
  Index := 0;
...
procedure TDBXJSonStreamReader.FillBuffer(const Bytes: TBytes);
begin
...
function TDBXJSonStreamReader.BytesToString(const Count: Integer; const Offset: Integer): UnicodeString;
var
  Buffer: UnicodeString;
  CurChar: WideChar;
  Position: Integer;
...
procedure TDBXJSonStreamReader.ReadDataBytes(const Buffer: TBytes; const InReadOff: Integer; const InCount: Integer);
var
  MaxCopy: Integer;
  ReadOff: Integer;
  Count: Integer;
...
function TDBXJSonStreamReader.GetBytes(const Buffer: TBytes; const Offset: Int64; const Count: Int64): Int64;
begin
  Result := 0;
end;
...
function TDBXJSonStreamReader.ReadString: UnicodeString;
begin
  NextString;
...
function TDBXJSonStreamReader.GetStringValue: UnicodeString;
begin
...
procedure TDBXJSonStreamWriter.WriteCommandFields(const CommandHandle: Integer; const Updateable: Boolean; const CommandType: UnicodeString; const Command: UnicodeString);
begin
  WriteInt(CommandHandle);
  WriteValueSeparator;
...
procedure TDBXJSonStreamWriter.WritePrepareStart(const CommandHandle: Integer; const Updateable: Boolean; const CommandType: UnicodeString; const Command: UnicodeString);
begin
  WriteBytes(MethodStart);
  WriteBytes(Prepare);
  WriteParamsStart;
...
procedure TDBXJSonStreamWriter.WriteExecuteFieldsObject(const CommandHandle: Integer; const Updateable: Boolean; const CommandType: UnicodeString; const Command: UnicodeString);
begin
...
procedure TDBXJSonStreamWriter.WriteParameter(const DataType: Integer; const SubType: Integer; const ParameterDirection: Integer; const Precision: Integer; const Scale: Integer; const Name: UnicodeString; const ChildPosition: Integer; const Size: Integer);
begin
  WriteValueSeparator;
  WriteArrayStart;
  WriteInt(DataType);
...
procedure TDBXJSonStreamWriter.WriteDataObject(const Data: TBytes; const Count: Integer);
begin
  WriteBytes(DataStart);
  WriteInt(Count);
  WriteValueSeparator;
...
procedure TDBXJSonStreamWriter.WriteVendorProperty(const PropertyName: UnicodeString);
begin
  WriteBytes(MethodStart);
...
procedure TDBXJSonStreamWriter.WriteRpcError(const Name: UnicodeString; const ErrorCode: Integer; const Message: UnicodeString; const NameValuePairs: TDBXStringArray);
begin
...
procedure TDBXJSonStreamWriter.WriteNamedString(const Name: UnicodeString; const Value: UnicodeString);
begin
  WriteString(Name);
  WriteNameSeparator;
  WriteString(Value);
...
procedure TDBXJSonStreamWriter.WriteBytes(const Bytes: TBytes);
var
  Index: Integer;
  Count: Integer;
begin
...
procedure TDBXJSonStreamWriter.WriteDataBytes(const SourceBytes: TBytes; const InSourceOffset: Integer; const InCount: Integer);
var
  Available: Integer;
  Count: Integer;
...
procedure TDBXJSonStreamWriter.WriteString(const Chars: UnicodeString);
var
  Index: Integer;
  Count: Integer;
...
function TDBXJSonStreamWriter.BytesToString(const Count: Integer): UnicodeString;
var
  Buffer: UnicodeString;
  CurChar: WideChar;
  Position: Integer;
begin
  ...
  begin
    CurChar := WideChar(FWriteBuffer[Position]);
    if (CurChar < ' ') or (CurChar > '~') then
    begin
      Buffer := Buffer + '#';
      Buffer := Buffer + IntToStr(Ord(CurChar));
...
procedure TDBXRowBlobStreamReader.Store(const InBuffer: TBytes; const InOffset: Integer; const Count: Integer);
begin
  InitBufferTo(Count);
...
function TDBXRowBlobStreamReader.Read(const Buf: TBytes; const InOffset: Integer; const InSize: Integer): Integer;
var
  Offset: Integer;
  Size: Integer;
  ReturnBytes: Integer;
...
procedure TDBXRowBuffer.ReadBytes(const DestBuf: TBytes; const DestOff: Integer; const Count: Integer);
begin
...
function TDBXRowBuffer.ReadInlineAnsiChars(const RowHandle: Integer; const ByteBuf: TBytes; const MaxChars: Integer): Integer;
var
  EncodedSize: Integer;
  Size: Integer;
begin
...
function TDBXRowBuffer.ReadString(const RowHandle: Integer): UnicodeString;
var
  Size: Integer;
  Reader: TDBXStreamReader;
  FreeReader: Boolean;
...
function TDBXRowBuffer.ReadStringBytes(const RowHandle: Integer; const ByteBuf: TBytes; const Offset: Integer): Integer;
var
  Reader: TDBXStreamReader;
  Size: Integer;
  EncodedSize: Integer;
...
function TDBXRowBuffer.ReadAnsiStringBytes(const RowHandle: Integer; const ByteBuf: TBytes; const Offset: Integer): Integer;
var
  Reader: TDBXStreamReader;
  Size: Integer;
  FreeReader: Boolean;
...
function TDBXRowBuffer.ReadStringBytes(const RowHandle: Integer): TBytes;
var
  Size: Integer;
  Count: Integer;
  FreeReader: Boolean;
...
function TDBXRowBuffer.WriteString(const Data: UnicodeString): Boolean;
var
...
function TDBXStringDecoder.DecodeToWideBytes(const InBuf: TBytes; const InOff: Integer; const OutBuf: TBytes; const MaxBytes: Integer): Boolean;
begin
...
function TDBXStringDecoder.DecodeBytes(const InBuf: TBytes; const InOff: Integer; const MaxBytes: Integer): Boolean;
var
  Off: Integer;
  Complete: Boolean;
  MaxOff: Integer;
...
function TDBXStringDecoder.DecodeCharsToBytes(const InBuf: TBytes; const InOff: Integer; const DecodeByteBuf: TBytes; const InOutOff: Integer; const InMaxOff: Integer): Boolean;
var
  Off: Integer;
  OutOff: Integer;
  MaxOff: Integer;
...
procedure TDBXStringEncoder.GrowEncodeBufTo(const OldBuf: TBytes; const NewLength: Integer);
begin
...
function TDBXStringEncoder.Encode(const Source: UnicodeString; const InDest: TBytes; const DestOff: Integer; const InMaxBytes: Integer; const NullTerm: Boolean): Boolean;
var
  Dest: TBytes;
  MaxBytes: Integer;
  Len: Integer;
