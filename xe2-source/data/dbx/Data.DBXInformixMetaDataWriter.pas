...
type
  ...
  protected
    procedure MakeSqlCreateKey(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow; const IndexColumns: TDBXTable); override;
    procedure MakeSqlCreateForeignKey(const Buffer: TDBXStringBuffer; const ForeignKey: TDBXTableRow; const ForeignKeyColumns: TDBXTable); override;
...
procedure TDBXInformixCustomMetaDataWriter.MakeSqlCreateKey(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow; const IndexColumns: TDBXTable);
begin
...
procedure TDBXInformixCustomMetaDataWriter.MakeSqlCreateForeignKey(const Buffer: TDBXStringBuffer; const ForeignKey: TDBXTableRow; const ForeignKeyColumns: TDBXTable);
begin
...
procedure TDBXInformixCustomMetaDataWriter.MakeSqlDropSecondaryIndex(const Buffer: TDBXStringBuffer; const Index: TDBXTableRow);
var
...
function TDBXInformixMetaDataWriter.GetSqlAutoIncrementKeyword: UnicodeString;
begin
  Result := 'IDENTITY';
end;

function TDBXInformixMetaDataWriter.GetSqlRenameTable: UnicodeString;
begin
