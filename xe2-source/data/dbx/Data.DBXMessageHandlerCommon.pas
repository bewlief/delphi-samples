...
type
  ...
  private
    function GetNestedMessage(const Message: UnicodeString; const Ex: Exception; const Level: Integer): UnicodeString;
    procedure InitDBXErrorMessage(const Message: TDBXErrorMessage);
  private
    FEx: Exception;
    FErrorCode: Integer;
    FErrorMessage: UnicodeString;
    FErrorClassName: UnicodeString;
  public
    property Error: Exception read FEx write SetError;
    property ErrorCode: Integer read FErrorCode write FErrorCode;
    property ErrorClassName: UnicodeString read FErrorClassName write FErrorClassName;
  ...
  public
    property ProductName: UnicodeString read FProductName write FProductName;
  ...
  public
    property Command: UnicodeString read FCommand write FCommand;
    property CommandHandle: Integer read FCommandHandle write FCommandHandle;
    property CommandType: UnicodeString read FCommandType write FCommandType;
  ...
  private
    ...
    FStreamReader: TDBXStreamReader;
    FEos: Boolean;
  public
    property CommandHandle: Integer read FCommandHandle write FCommandHandle;
  ...
  private
    ...
    FPropertyValue: UnicodeString;
  public
    property PropertyName: UnicodeString read FPropertyName write FPropertyName;
    property PropertyValue: UnicodeString read FPropertyValue write FPropertyValue;
  end;
...
function TDBXErrorMessage.GetNestedMessage(const Message: UnicodeString; const Ex: Exception; const Level: Integer): UnicodeString;
var
  ExMessage: UnicodeString;
...
begin
  ...
  begin
    ...
    if StringIsNil(ExMessage) then
      ExMessage := Ex.ToString;
    if (Level > 0) and (StringIndexOf(Message,ExMessage) < 0) then
      ErrorMessage := Message + Format(SCausedBy, [ExMessage])
    else 
...
begin
  if self.FExplicitParameters <> ExplicitParameters then
  begin
    FreeAndNil(self.FExplicitParameters);
    self.FExplicitParameters := ExplicitParameters;
  end;
end;
