...
function TDBXDb2MetaDataReader.GetProductName: UnicodeString;
begin
  Result := 'Db2';
end;

function TDBXDb2MetaDataReader.GetTableType: UnicodeString;
begin
  Result := 'T';
end;

function TDBXDb2MetaDataReader.GetViewType: UnicodeString;
begin
  Result := 'V';
end;

function TDBXDb2MetaDataReader.GetSystemTableType: UnicodeString;
begin
  Result := 'T';
end;

function TDBXDb2MetaDataReader.GetSqlProcedureQuoteChar: UnicodeString;
begin
  Result := '';
end;
...
function TDBXDb2MetaDataReader.GetSqlForSchemas: UnicodeString;
begin
  Result := 'SELECT CAST(NULL AS VARCHAR(1)), SCHEMANAME FROM SYSCAT.SCHEMATA ORDER BY 1';
end;

function TDBXDb2MetaDataReader.GetSqlForTables: UnicodeString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForViews: UnicodeString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForColumns: UnicodeString;
begin
...
function TDBXDb2MetaDataReader.FetchColumnConstraints(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXDb2MetaDataReader.GetSqlForIndexes: UnicodeString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForIndexColumns: UnicodeString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForForeignKeys: UnicodeString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForForeignKeyColumns: UnicodeString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForSynonyms: UnicodeString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForProcedures: UnicodeString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForProcedureSources: UnicodeString;
begin
...
function TDBXDb2MetaDataReader.GetSqlForProcedureParameters: UnicodeString;
begin
...
function TDBXDb2MetaDataReader.FetchPackages(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXDb2MetaDataReader.FetchPackageProcedures(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ProcedureType: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXDb2MetaDataReader.FetchPackageProcedureParameters(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ParameterName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXDb2MetaDataReader.FetchPackageSources(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXDb2MetaDataReader.GetSqlForRoles: UnicodeString;
begin
  Result := 'SELECT NGNAME FROM SYSCAT.NODEGROUPS';
end;

function TDBXDb2MetaDataReader.GetVersion: UnicodeString;
begin
