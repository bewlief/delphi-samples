...
begin
  ...
  Values[TDBXPropertyNames.DriverPackageLoader] := 'TDBXDynalinkDriverLoader,DBXMySQLDriver160.bpl';
  ...
  Values[TDBXPropertyNames.MetaDataPackageLoader] := 'TDBXMySqlMetaDataCommandFactory,DbxMySQLDriver160.bpl';
  Values[TDBXPropertyNames.MetaDataAssemblyLoader] := 'Borland.Data.TDBXMySqlMetaDataCommandFactory,Borland.Data.DbxMySQLDriver,Version=16.0.0.0,Culture=neutral,PublicKeyToken=' + TDBXPlatform.GetPublicKeyToken;
