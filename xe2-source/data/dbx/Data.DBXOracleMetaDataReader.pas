  ...
  public
    type
      ...
      protected
        ...
        function GetWritableValue(const Ordinal: Integer): TDBXWritableValue; override;
      private
        function ComputeColumnName: UnicodeString;
      private
...
function TDBXOracleCustomMetaDataReader.FetchColumns(const Catalog: UnicodeString; const Schema: UnicodeString; const Table: UnicodeString): TDBXTable;
var
...
function TDBXOracleCustomMetaDataReader.FetchIndexColumns(const Catalog: UnicodeString; const Schema: UnicodeString; const Table: UnicodeString; const Index: UnicodeString): TDBXTable;
var
  ParameterNames: TDBXStringArray;
  ParameterValues: TDBXStringArray;
  Cursor: TDBXTable;
...
function TDBXOracleCustomMetaDataReader.TDBXOracleIndexColumnsCursor.ComputeColumnName: UnicodeString;
var
...
function TDBXOracleMetaDataReader.GetProductName: UnicodeString;
begin
  Result := 'Oracle';
end;
...
function TDBXOracleMetaDataReader.GetSqlForSchemas: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForTables: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForViews: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForColumns: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.FetchColumnConstraints(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXOracleMetaDataReader.GetSqlForIndexes: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForIndexColumns: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForForeignKeys: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForForeignKeyColumns: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForSynonyms: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForProcedures: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForProcedureSources: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForProcedureParameters: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForPackages: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForPackageSources: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForPackageProcedures: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForPackageProcedureParameters: UnicodeString;
begin
...
function TDBXOracleMetaDataReader.GetSqlForUsers: UnicodeString;
begin
  Result := 'SELECT USERNAME FROM ALL_USERS ORDER BY 1';
end;

function TDBXOracleMetaDataReader.GetSqlForRoles: UnicodeString;
begin
