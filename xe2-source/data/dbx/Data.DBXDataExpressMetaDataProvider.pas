...
function TDBXDataExpressProviderWriteableContext.CreateTableStorage(const CollectionName: UnicodeString; const Columns: TDBXValueTypeArray): TDBXTable;
begin
...
function TDBXDataExpressProviderWriteableContext.CreateRowStorage(const CollectionName: UnicodeString; const Columns: TDBXValueTypeArray): TDBXTableRow;
var
  Storage: TDBXTable;
begin
