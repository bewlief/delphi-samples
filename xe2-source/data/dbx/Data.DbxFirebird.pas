...
{$HPPEMIT '#pragma link "Data.DbxFirebird"'}    {Do not Localize}
...
begin
  ...
  Values[TDBXPropertyNames.DriverPackageLoader] := 'TDBXDynalinkDriverLoader,DBXFirebirdDriver160.bpl';
  ...
  Values[TDBXPropertyNames.MetaDataPackageLoader] := 'TDBXFirebirdMetaDataCommandFactory,DbxFirebirdDriver160.bpl';
  Values[TDBXPropertyNames.MetaDataAssemblyLoader] := 'Borland.Data.TDBXFirebirdMetaDataCommandFactory,Borland.Data.DbxFirebirdDriver,Version=16.0.0.0,Culture=neutral,PublicKeyToken=' + TDBXPlatform.GetPublicKeyToken;
