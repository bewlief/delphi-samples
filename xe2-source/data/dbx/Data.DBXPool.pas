...
type
  ...
  private
    ...
    function IsEqual(ConnectionBuilder: TDBXConnectionBuilder;
      const ConnectionName: UnicodeString;
      const DelegateSignature: UnicodeString; const DriverName: UnicodeString;
      const DatabaseName: UnicodeString; const UserName: UnicodeString)
      : Boolean;

    function GetConnection(ConnectionBuilder: TDBXConnectionBuilder)
      : TDBXConnection;
  ...
  published
    property MaxConnections
      : Integer read GetMaxConnections write SetMaxConnections;
    property MinConnections
      : Integer read GetMinConnections write SetMinConnections;
    property ConnectTimeout
      : Integer read GetConnectTimeout write SetConnectTimeout;
  end;
...
var
  ...
  DelegateSignature:  UnicodeString;
begin
...
function TDBXPoolDriver.GetDriverVersion: UnicodeString;
begin
...
function TDBXPool.IsEqual(
  ConnectionBuilder:  TDBXConnectionBuilder;
  const ConnectionName:     UnicodeString;
  const DelegateSignature:  UnicodeString;
  const DriverName:         UnicodeString;
  const DatabaseName:       UnicodeString;
  const UserName:           UnicodeString): Boolean;
...
procedure TDBXPoolConnection.DerivedGetCommands(const CommandType: UnicodeString;
  const List: TStrings);
begin
