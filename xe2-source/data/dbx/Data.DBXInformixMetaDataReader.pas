  ...
  public
    type
      ...
      private
        ...
        function ComputeTypeQualifier: UnicodeString;
        function GetQualifier(const FieldQualifier: Integer): UnicodeString;
        function ComputeLiteralValue: UnicodeString;
      private
        FReader: TDBXInformixCustomMetaDataReader;
        FColType: SmallInt;
        FColLength: SmallInt;
        FDefaultType: UnicodeString;
      ...
      public
        constructor Create(const Reader: TDBXInformixCustomMetaDataReader; const Columns: TDBXValueTypeArray; const Parameter: UnicodeString; const Cursor: TDBXTable);
        destructor Destroy; override;
...
function TDBXInformixCustomMetaDataReader.GetSqlIdentifierQuotePrefix: UnicodeString;
begin
  Result := FQuoteChar;
end;

function TDBXInformixCustomMetaDataReader.GetSqlIdentifierQuoteSuffix: UnicodeString;
begin
  Result := FQuoteChar;
end;

function TDBXInformixCustomMetaDataReader.GetSqlIdentifierQuoteChar: UnicodeString;
begin
  Result := FQuoteChar;
end;
...
function TDBXInformixCustomMetaDataReader.FetchColumns(const Catalog: UnicodeString; const Schema: UnicodeString; const Table: UnicodeString): TDBXTable;
var
...
function TDBXInformixCustomMetaDataReader.FetchIndexColumns(const Catalog: UnicodeString; const Schema: UnicodeString; const Table: UnicodeString; const Index: UnicodeString): TDBXTable;
var
  ParameterNames: TDBXStringArray;
  ParameterValues: TDBXStringArray;
  Cursor: TDBXTable;
...
function TDBXInformixCustomMetaDataReader.FetchForeignKeyColumns(const Catalog: UnicodeString; const Schema: UnicodeString; const Table: UnicodeString; const ForeignKeyName: UnicodeString; const PrimaryCatalog: UnicodeString; const PrimarySchema: UnicodeString; const PrimaryTable: UnicodeString; const PrimaryKeyName: UnicodeString): TDBXTable;
var
  ParameterNames: TDBXStringArray;
  ParameterValues: TDBXStringArray;
  Cursor: TDBXTable;
...
function TDBXInformixCustomMetaDataReader.FetchProcedureParameters(const Catalog: UnicodeString; const Schema: UnicodeString; const &Procedure: UnicodeString; const Parameter: UnicodeString): TDBXTable;
var
  ParameterNames: TDBXStringArray;
  ParameterValues: TDBXStringArray;
  Cursor: TDBXTable;
...
procedure TDBXInformixCustomMetaDataReader.ParseProcedure(const Definition: UnicodeString; const &Type: UnicodeString; const Params: TDBXArrayList);
var
...
function TDBXInformixCustomMetaDataReader.ToInt(const Value: UnicodeString): Integer;
begin
  try
...
begin
  ...
  begin
    ...
    FRow.Value[TDBXColumnsIndex.Precision].AsInt32 := ComputePrecision;
    if HasScale then
...
function TDBXInformixCustomMetaDataReader.TDBXInformixColumnsCursor.ComputeTypeName: UnicodeString;
var
...
function TDBXInformixCustomMetaDataReader.TDBXInformixColumnsCursor.ComputeDefaultValue: UnicodeString;
var
  &Type: WideChar;
begin
  ReadTypeInformation;
...
function TDBXInformixCustomMetaDataReader.TDBXInformixColumnsCursor.ComputeTypeQualifier: UnicodeString;
var
  DataType: Integer;
  Qualifier: UnicodeString;
  Qualifier1: Integer;
  Qualifier2: Integer;
begin
  DataType := FColType and 255;
...
function TDBXInformixCustomMetaDataReader.TDBXInformixColumnsCursor.GetQualifier(const FieldQualifier: Integer): UnicodeString;
var
  Qualifier: UnicodeString;
begin
  Qualifier := NullString;
...
function TDBXInformixCustomMetaDataReader.TDBXInformixColumnsCursor.ComputeLiteralValue: UnicodeString;
var
  ComputedDefaultValue: UnicodeString;
  DataType: Integer;
  Index: Integer;
  Types: TDBXDataTypeDescriptionArray;
begin
...
constructor TDBXInformixCustomMetaDataReader.TDBXInformixProcedureParametersCursor.Create(const Reader: TDBXInformixCustomMetaDataReader; const Columns: TDBXValueTypeArray; const Parameter: UnicodeString; const Cursor: TDBXTable);
begin
  ...
  self.FCursor := Cursor;
  self.FBuffer := TDBXStringBuffer.Create;
...
begin
  ...
  begin
    ...
    if StringIsNil(FParameter.FName) then
    ...
    if StringIsNil(FParameter.FMode) then
    ...
    if StringIsNil(FParameter.FTypeName) then
...
function TDBXInformixMetaDataReader.GetProductName: UnicodeString;
begin
  Result := 'Informix Dynamic Server';
end;

function TDBXInformixMetaDataReader.GetTableType: UnicodeString;
begin
  Result := 'T';
end;

function TDBXInformixMetaDataReader.GetViewType: UnicodeString;
begin
  Result := 'V';
end;

function TDBXInformixMetaDataReader.GetSystemTableType: UnicodeString;
begin
  Result := 'T';
end;

function TDBXInformixMetaDataReader.GetSynonymType: UnicodeString;
begin
  Result := 'S';
end;
...
function TDBXInformixMetaDataReader.GetSqlForSchemas: UnicodeString;
begin
...
function TDBXInformixMetaDataReader.GetSqlForTables: UnicodeString;
begin
...
function TDBXInformixMetaDataReader.GetSqlForViews: UnicodeString;
begin
...
function TDBXInformixMetaDataReader.GetSqlForColumns: UnicodeString;
begin
...
function TDBXInformixMetaDataReader.FetchColumnConstraints(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInformixMetaDataReader.GetSqlForIndexes: UnicodeString;
begin
...
function TDBXInformixMetaDataReader.GetSqlForIndexColumns: UnicodeString;
begin
...
function TDBXInformixMetaDataReader.GetSqlForForeignKeys: UnicodeString;
begin
...
function TDBXInformixMetaDataReader.GetSqlForForeignKeyColumns: UnicodeString;
begin
...
function TDBXInformixMetaDataReader.GetSqlForSynonyms: UnicodeString;
begin
...
function TDBXInformixMetaDataReader.GetSqlForProcedures: UnicodeString;
begin
...
function TDBXInformixMetaDataReader.GetSqlForProcedureSources: UnicodeString;
begin
...
function TDBXInformixMetaDataReader.FetchPackages(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInformixMetaDataReader.FetchPackageProcedures(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ProcedureType: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInformixMetaDataReader.FetchPackageProcedureParameters(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ParameterName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInformixMetaDataReader.FetchPackageSources(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXInformixMetaDataReader.GetSqlForUsers: UnicodeString;
begin
  Result := 'SELECT USERNAME FROM INFORMIX.SYSUSERS WHERE USERTYPE <> ''G'' ORDER BY 1';
end;

function TDBXInformixMetaDataReader.GetSqlForRoles: UnicodeString;
begin
  Result := 'SELECT USERNAME FROM INFORMIX.SYSUSERS WHERE USERTYPE = ''G'' ORDER BY 1';
end;
