...
{$ENDIF}
  TDBXRegistryKey               = '\Software\Embarcadero\BDS\9.0\dbExpress'; { Do not localize }
...
//      BlobSizeExact   = $10;
  ...
  TDBXError = class(Exception)
    ...
    public
      ...
      ///<summary>
      ///  UnicodeString containing an explanation of the error.
      ///</summary>
      property Message: UnicodeString read FErrorMessage;
  end;
  ...
  TDBXTraceInfo = packed record
    private
      FTraceMessage:        UnicodeString;
      FTraceFlag:           TDBXTraceFlag;
      FTraceLevel:          TDBXTraceLevel;
      FCustomCategory:      UnicodeString;
    public
      ///<summary>
      ///  Trace information for a trace TDBXTraceEvent.
      ///</summary>
      property Message: UnicodeString read FTraceMessage write FTraceMessage;
      ///<summary>
      ...
      ///</summary>
      property CustomCategory: UnicodeString read FCustomCategory write FCustomCategory;
  end;
  ...
  private
    ...
    class function  OpenConnectionFactory(const DriverFileName, ConnectionFileName: UnicodeString): TDBXConnectionFactory;

    function CreateDelegatePath(const ConnectionName: UnicodeString; DBXProperties: TDBXProperties): TDBXDelegateItem; overload;
    ...
    function HasConnectionPropertiesItem(const ConnectionName : UnicodeString) : TDBXPropertiesItem;
    function GetConnectionPropertiesItem(const ConnectionName : UnicodeString) : TDBXPropertiesItem;
  ...
  private
    ...
    var
      ...
      FConnectionProperties:  TStringList;

    function GetDriver(const DriverName: UnicodeString; DriverProperties: TDBXProperties) : TDBXDelegateDriver; overload;
    function getDriverName(ConnectionProperties: TDBXProperties): UnicodeString;
...
//    procedure CreateDelegatePaths;
  ...
  public
    ...
    function HasConnectionProperties(const ConnectionName : UnicodeString) : TDBXProperties;
    ///<returns><c>TDBXProperties</c> instance of connection properties for <c>ConnectionName</c></returns>
    function GetConnectionProperties(const ConnectionName : UnicodeString) : TDBXProperties;
...
//    property ConnectionFactory: TDBXConnectionFactory read GetConnectionFactory write SetConnectionFactory;
  ...
  private
    FConnectionsFile:   UnicodeString;
    FDriversFile:       UnicodeString;

    function LoadSectionProperties(IniFile: TMemIniFile; Section: String;
                                      LoadConnection: Boolean) : TDBXProperties;
    function LoadDriver(DriverIni: TMemIniFile; const DriverName:  UnicodeString) : TDBXProperties;
...
//    class function LoadIniFile(FileName: String): TMemIniFile; static;
    ...
    property DriversFile: UnicodeString
      read  FDriversFile
      write FDriversFile;
    ///<returns>File name for the connections ini file.</returns>
    property ConnectionsFile: UnicodeString
  ...
  protected
    ...
    function  GetDriverName: UnicodeString; virtual;
    procedure SetDriverName(const DriverName: UnicodeString); virtual;
    ...
    procedure LoadMetaDataCommandFactory(const MetaDataCommandFactoryClassName: UnicodeString; const MetaDataCommandFactoryPackageName: UnicodeString);
    procedure AddCommandFactory(const Name: UnicodeString; OnCreateCommand: TDBXCreateCommandEvent); overload;
    procedure AddCommandFactory(const Name: UnicodeString; CommandFactory: TDBXCommandFactory); overload;
  public
    ///<summary>
    ...
    /// Returns version information for this driver.
    ///</summary>
    property DriverVersion: UnicodeString read GetDriverVersion;
...
//      FItems: TStrings;
    public
      destructor Destroy; override;
      function GetStateItem(Name: UnicodeString): TDBXStateItem;
      procedure AddStateItem(Name: UnicodeString; Item: TDBXStateItem);
      procedure RemoveAndFreeStateItem(Name: UnicodeString);
  end;
  ///<summary>
  ...
  protected
    ...
    procedure DerivedGetCommands(const CommandType: UnicodeString; const List: TStrings); virtual; abstract;
    ...
    function GetConnectionProperty(const Name: UnicodeString): UnicodeString; virtual;
  ...
  public
    ...
    ///  version.
    ///  </summary>
    function GetVendorProperty(const Name: UnicodeString): UnicodeString; virtual;
    ///<returns>
    ...
    ///  connection property.
    ///  </summary>
    property ProductVersion: UnicodeString read GetProductVersion;
    ///<summary>
    ...
    ///  </summary>
    property ConnectionProperty[const Name: UnicodeString]: UnicodeString read GetConnectionProperty;
...
//    property MetaDataReader: TObject read FMetaDataReader write FMetaDataReader;
  ...
  public
    ...
    property ProcedureQuoteChar: UnicodeString read FProcedureQuoteChar;
    ...
    property QuotePrefix: UnicodeString read FQuotePrefix;
    ///<returns>Character to end a quoted identifier.</returns>
    property QuoteSuffix: UnicodeString read FQuoteSuffix;
  ...
  protected
    ...
    procedure SetCommandType(const CommandType: UnicodeString); virtual;
    function  GetCommandType: UnicodeString; virtual;
    function  GetText: UnicodeString; virtual;
    procedure SetText(const Value: UnicodeString); virtual;
  ...
  public
    ...
    ///</summary>
    property CommandType: UnicodeString read GetCommandType write SetCommandType;
    ///<summary>
...
TDBXMorphicCommand = class(TDBXCommand)
  ...
  protected
    ...
    procedure SetCommandType(const Value: UnicodeString); override;
...
TDBXValueList = class
  private
    ...
    FLastOrdinal: TInt32;
    FClosed:      Boolean;
    function FindOrdinal(const Name: UnicodeString; const StartOrdinal, EndOrdinal: TInt32): TInt32; overload; virtual;
    procedure InvalidOrdinal(const Ordinal: TInt32);
    procedure InvalidName(const Name: UnicodeString; const Ordinal: TInt32);
  strict protected
    FDBXContext:  TDBXContext;
  ...
  protected
    ...
    function GetValueByName(const Name: UnicodeString): TDBXValue; virtual;
  ...
  public
    ...
    function GetOrdinal(const Name: UnicodeString): TInt32; overload; virtual;
...
//    property ValueType[const Name: UnicodeString]: TDBXValueType read GetValueTypeByName; overload;
...
//    function GetWritableValueByName(const Name: UnicodeString): TDBXWritableValue; virtual;
  public
    constructor Create(DBXContext: TDBXContext);
...
//    property Value[const Name: UnicodeString]: TDBXWritableValue read GetWritableValueByName; default;
...
//      function IsBlobSizeExact: Boolean;
    ...
    protected
      ...
      procedure SetName(const Name: UnicodeString); virtual;
      procedure SetDisplayName(const Caption: UnicodeString); virtual;
      ...
      function  GetDisplayName: UnicodeString; virtual;
...
//      procedure FailIfReadOnly;
  ...
  public
    ...
    class function DataTypeName(DataType: TDBXType): UnicodeString; static;
    ...
    ///</returns>
    property DisplayName: UnicodeString read FCaption write SetDisplayName;
    ///<returns>
...
//      FDbxContext:            TDBXContext;
  ...
  TDBXParameterList = class
    private
      ...
      function GetParameterByName(const Name: UnicodeString): TDBXParameter;
    ...
    public
      ...
      ///</returns>
      property    Parameter[const Name: UnicodeString]: TDBXParameter read GetParameterByName; default;
  end;
  ...
  TDBXValue = class
    ...
    protected
      ...
      /// <summary>Applies a type conversion to UnicodeString if needed.  If there is no supported
      ///   conversion to this type, an exception is raised.
      /// </summary>
      /// <returns> an UnicodeString representation of the value.</returns>
      function GetAsString: UnicodeString; virtual;
    ...
    public
      ...
      ///<summary>
      ///  Gets the UnicodeString value for TDBXValues with a TDBXDataType of TDBXDataTypes.UnicodeString.
      ///  Throws a TDBXError exception if TDBXValue.IsNull is true.
      ///</summary>
      function GetWideString: UnicodeString; overload; virtual;
      ///<summary>
      ///  Gets the String value for TDBXValues with a TDBXDataType of TDBXDataTypes.UnicodeString.
      ///  Throws a TDBXError exception if TDBXValue.IsNull is true.
      ///</summary>
      ...
      ///</summary>
      function GetWideString(defaultValue: UnicodeString): UnicodeString; overload; virtual;
      ///<summary>
  ...
  TDBXWritableValue = class(TDBXValue)
    ...
    protected
      ...
      procedure SetAsString(const Value: UnicodeString); virtual;
    ...
    public
      ...
      ///<summary>
      ///  Sets the UnicodeString Value for TDBXValues with a TDBXDataType of TDBXDataTypes.UnicodeString.
      ///</summary>
      procedure SetWideString(const Value: UnicodeString); virtual;
      ///<summary>
      ///  Sets the String Value for TDBXValues with a TDBXDataType of TDBXDataTypes.UnicodeString.
      ///</summary>
      ...
      /// <summary>Applies a type conversion to/from UnicodeString if needed.  If there is no supported
      /// conversion to this type, an exception is raised.
      /// </summary>
      ///  <returns> a string representation of the value.</returns>
  ...
  TDBXAnsiStringValue = class(TDBXWritableValue)
    ...
    public
      ...
      /// <summary>Applies a type conversion from AnsiString to UnicodeString.</summary>
      /// <returns> a UnicodeString representation of the value.</returns>
      ...
      /// </summary>
      procedure SetAsString(const Value: UnicodeString); override;
      /// <summary>Sets the value after applying a type conversion from
  ...
  TDBXBooleanValue = class(TDBXWritableValue)
    ...
    public
      ...
      /// <summary>Applies a type conversion from Boolean to UnicodeString.</summary>
      /// <returns> an UnicodeString representation of the value.</returns>
      function GetAsString: UnicodeString; override;
      /// <summary>Returns the Boolean value.</summary>
      /// <returns> the Boolean value.</returns>
      ...
      /// <returns> an Int64 representation of the value.</returns>
      function GetAsInt64: Int64; override;
      /// <summary>Sets the value after applying a type conversion from UnicodeString
      ///   to Boolean.
      /// </summary>
      procedure SetAsString(const Value: UnicodeString); override;
      /// <summary>Sets the Boolean value</summary>
  ...
  TDBXWideStringValue = class(TDBXWritableValue)
    ...
    public
      ...
      /// <returns> True if the value is null.</returns>
      function IsNull: Boolean; override;
      /// <summary>Returns the UnicodeString.</summary>
      /// <returns> the UnicodeString.</returns>
      function GetWideString: UnicodeString; override;
      /// <summary>Returns the UnicodeString.</summary>
      /// <returns> the UnicodeString.</returns>
      function GetAsString: UnicodeString; override;
      /// <summary>Compares the UnicodeString to 'True'</summary>
      /// <returns> a Boolean representation of the string comparison.</returns>
      function GetAsBoolean: Boolean; override;
      /// <summary>Applies a type conversion from UnicodeString to Byte.</summary>
      /// <returns> a Byte representation of the value on success or 0 if the
      ///   conversion fails.
      /// </returns>
      function GetAsUInt8: Byte; override;
      /// <summary>Applies a type conversion from UnicodeString to ShortInt.</summary>
      /// <returns> a ShortInt representation of the value on success or 0 if the
      ///   conversion fails.
      /// </returns>
      function GetAsInt8: ShortInt; override;
      /// <summary>Applies a type conversion from UnicodeString to Word.</summary>
      /// <returns> a Word representation of the value on success or 0 if the
      ///   conversion fails.
      /// </returns>
      function GetAsUInt16: Word; override;
      /// <summary>Applies a type conversion from UnicodeString to SmallInt.</summary>
      /// <returns> a SmallInt representation of the value on success or 0 if the
      ///   conversion fails.
      /// </returns>
      function GetAsInt16: SmallInt; override;
      /// <summary>Applies a type conversion from UnicodeString to LongInt.</summary>
      /// <returns> a LongInt representation of the value on success or 0 if the
      ///   conversion fails.
      /// </returns>
      function GetAsInt32: TInt32; override;
      /// <summary>Applies a type conversion from UnicodeString to Int64.</summary>
      /// <returns> an Int64 representation of the value on success or 0 if the
      ///   conversion fails.
      /// </returns>
      function GetAsInt64: Int64; override;
      /// <summary>Applies a type conversion from UnicodeString to Single.</summary>
      /// <returns> a Single representation of the value on success or 0 if the
      ///   conversion fails.
      /// </returns>
      function GetAsSingle: Single; override;
      /// <summary>Applies a type conversion from UnicodeString to Double.</summary>
      /// <returns> a Double representation of the value on success or 0 if the
      ///   conversion fails.
      /// </returns>
      function GetAsDouble: Double; override;
      /// <summary>Applies a type conversion from UnicodeString to TBcd.</summary>
      /// <returns> a TBcd representation of the value.</returns>
      function GetAsBcd: TBcd; override;
      /// <summary>Applies a type conversion from UnicodeString to TDBXDate.</summary>
      /// <returns> a TDBXDate representation of the value.</returns>
      function GetAsDate: TDBXDate; override;
      /// <summary>Applies a type conversion from UnicodeString to TDBXTime.</summary>
      /// <returns> a TDBXTime representation of the value.</returns>
      function GetAsTime: TDBXTime; override;
      /// <summary>Applies a type conversion from UnicodeString to TSQLTimeStamp.</summary>
  ...
  TDBXInt8Value = class(TDBXWritableValue)
    ...
    public
      ...
      /// <returns> an Int64 representation of the value.</returns>
      function GetAsInt64: Int64; override;
      /// <summary>Applies a type conversion from ShortInt to UnicodeString.</summary>
      /// <returns> a UnicodeString representation of the value.</returns>
      function GetAsString: UnicodeString; override;
  ...
  TDBXUInt8Value = class(TDBXWritableValue)
    ...
    public
      ...
      function GetAsInt64: Int64; override;
      /// <summary>Applies a type conversion from Byte to UnicodeString.</summary>
      /// <returns> an UnicodeString representation of the value.</returns>
      function GetAsString: UnicodeString; override;
  ...
  TDBXInt16Value = class(TDBXWritableValue)
    ...
    public
      ...
      /// <returns> an Int64 representation of the value.</returns>
      function GetAsInt64: Int64; override;
      /// <summary>Applies a type conversion from SmallInt to UnicodeString.</summary>
      /// <returns> an UnicodeString representation of the value.</returns>
      function GetAsString: UnicodeString; override;
  ...
  TDBXUInt16Value = class(TDBXWritableValue)
    ...
    public
      ...
      /// <returns> an Int64 representation of the value.</returns>
      function GetAsInt64: Int64; override;
      /// <summary>Applies a type conversion from Word to UnicodeString.</summary>
      /// <returns> an UnicodeString representation of the value.</returns>
      function GetAsString: UnicodeString; override;
      ...
      /// </summary>
      procedure SetAsInt64(const Value: Int64); override;
      /// <summary>Sets the value after applying a type conversion from UnicodeString to Word.
  ...
  TDBXInt32Value = class(TDBXWritableValue)
    ...
    public
      ...
      /// <summary>Applies a type conversion from LongInt to UnicodeString.</summary>
      /// <returns> an UnicodeString representation of the value.</returns>
      function GetAsString: UnicodeString; override;
  ...
  TDBXInt64Value = class(TDBXWritableValue)
    ...
    public
      ...
      /// <summary>Applies a type conversion from Int64 to UnicodeString.</summary>
      /// <returns> an UnicodeString representation of the value.</returns>
      function GetAsString: UnicodeString; override;
  ...
  TDBXDoubleValue = class(TDBXWritableValue)
    ...
    public
      ...
      /// <summary>Applies a type conversion from Double to UnicodeString.</summary>
      /// <returns> a UnicodeString representation of the value.</returns>
      function GetAsString: UnicodeString; override;
  ...
  TDBXSingleValue = class(TDBXWritableValue)
    ...
    public
      ...
      /// <summary>Applies a type conversion from Single to UnicodeString.</summary>
      /// <returns> an UnicodeString representation of the value.</returns>
      function GetAsString: UnicodeString; override;
  ...
  TDBXBcdValue = class(TDBXWritableValue)
    ...
    public
      ...
      /// <summary>Applies a type conversion from TBcd to UnicodeString.</summary>
      /// <returns> an UnicodeString representation of the value.</returns>
      function GetAsString: UnicodeString; override;
...
//      function  IsNull: Boolean; override;
  ...
  TDBXWideCharsValue = class(TDBXWideStringValue)
    ...
    public
      ...
      destructor Destroy; override;
      function IsNull: Boolean; override;
      procedure SetWideString(const Value: UnicodeString); override;
      function GetWideString: UnicodeString; override;
      function  GetStream(AInstanceOwner: Boolean): TStream; override;
      function GetValueSize: Int64; override;
      function GetBytes(Offset: Int64; const Value: TBytes; BufferOffset, Length: Int64): Int64; overload; override;
      procedure SetDynamicBytes(Offset: Int64; const Buffer: TBytes; BufferOffset, Length: Int64); override;
  ...
  TDBXAnsiCharsValue = class(TDBXAnsiStringValue)
    private
      FCount:               Integer;
      FAnsiChars:           TDBXAnsiChars;
      FRefValue:            AnsiString;
      procedure UpdateType; override;
      procedure SetRowValue; override;
      procedure CopyRowValue(Row: TDBXRow); overload; override;
    protected
      property AnsiCharsCount: Integer Read FCount;
      property AnsiChars: TDBXAnsiChars read FAnsiChars;
    public
      constructor Create(ValueType: TDBXValueType);
      destructor Destroy; override;
      function IsNull: Boolean; override;
...
//      procedure SetAsDateTime(const Value: TDateTime); override;
  ...
  TDBXContext = class
    ...
    protected
      ...
      function Trace(TraceLevel:  TDBXTraceLevel; TraceFlag: TDBXTraceFlag; CustomCategory: UnicodeString; TraceMessage: UnicodeString): CBRType; overload;
      constructor Create(DBXContext: TDBXContext); overload;
    public
      constructor Create; overload;
      destructor Destroy; override;
      ...
      ///</summary>
      function Trace(TraceFlag: TDBXTraceFlag; TraceMessage: UnicodeString): CBRType; overload;
      ///<summary>
      ///  Call the TDBXTraceEvent handler with TraceLevel, TraceFlag and TraceMessage.
      ///</summary>
      function Trace(TraceLevel:  TDBXTraceLevel; TraceFlag: TDBXTraceFlag; TraceMessage: UnicodeString): CBRType; overload;
      ///<summary>
      ///  Call the TDBXTraceEvent handler with TraceLevel, CustomCategory and TraceMessage.
      ///</summary>
      function Trace(TraceLevel:  TDBXTraceLevel; CustomCategory: UnicodeString; TraceMessage: UnicodeString): CBRType; overload;
      ///<summary>
  ...
  TDBXByteReader = class
    ...
    public
      ...
      procedure GetUInt8(Ordinal: TInt32; const Value: TBytes; Offset: TInt32; var IsNull: LongBool); virtual; abstract;
      procedure GetInt8(Ordinal: TInt32; const Value: TBytes; Offset: TInt32; var IsNull: LongBool); virtual; abstract;
      ///<summary>
      ...
      ///</summary>
      procedure GetUInt16(Ordinal: TInt32; const Value: TBytes; Offset: TInt32; var IsNull: LongBool); virtual; abstract;
      ...
      procedure GetSingle(Ordinal: TInt32; const Value: TBytes; Offset: TInt32; var IsNull: LongBool); virtual; abstract;
      ...
      procedure GetTimeStampOffset(Ordinal: TInt32; const Value: TBytes; Offset: TInt32; var IsNull: LongBool); virtual; abstract;
...
//      and allow these to be treated as 16-bit unsigned/signed integers
      ...
      procedure GetSingle(Ordinal: TInt32; const Value: TBytes; Offset: TInt32; var IsNull: LongBool); override;
      ...
      procedure GetTimeStampOffset(Ordinal: TInt32; const Value: TBytes; Offset: TInt32; var IsNull: LongBool); override;
  ...
  TDBXValueTypeList = class
    strict private
      ...
      function FindOrdinal(const Name: UnicodeString; StartOrdinal, EndOrdinal: TInt32): TInt32; virtual;

    private

      function  GetValueType(const Ordinal: TInt32): TDBXValueType; inline;
      function  GetOrdinal(const Name: UnicodeString): TInt32; virtual;
...
//  public
//    function GetOrdinal(const ColumnName: UnicodeString): Integer; virtual; abstract;
...
TDBXDriverHelp = class
  ...
  TDBXDriverRegistry = class
    private
      ...
      var
    private
      FDriverLoaders:         TStringList;
      FDriverClasses:         TStringList;
//      FDriverLoaderClasses:   TStringList;
      FCounter: Integer;

      function  FindDriver(List: TList; const DriverName: UnicodeString): Integer;
      procedure FreeAllDrivers(Loader: TDBXDriverLoader);
      procedure FreeAllLoaders();
      procedure InternalRegisterLoader(const LoaderClassName: UnicodeString; Loader: TDBXDriverLoader);
//      procedure InternalRegisterLoaderClass(LoaderName: UnicodeString; LoaderClass: TDBXDriverLoaderClass);
//      procedure InternalUnregisterLoader(Loader: TDBXDriverLoader);
    ...
    private
      ...
      procedure DriverLoadError(DriverDef: TDBXDriverDef; PackageName: UnicodeString);
...
//      class procedure RegisterLoaderClass(LoaderClassName: UnicodeString; LoaderClass: TDBXDriverLoaderClass);
//      class procedure UnregisterLoader(Loader: TDBXDriverLoader);
  ...
  protected
    ...
    function  GetDriverName: UnicodeString; override;
    procedure SetDriverName(const DriverName: UnicodeString); override;
  ...
  TDBXConnectionBuilder = class
    private
      ...
      FInputConnectionName:       UnicodeString;
      FInputUserName:             UnicodeString;
      FInputPassword:             UnicodeString;
      ...
      function GetDelegationSignature: UnicodeString;
    ...
    public
      ...
      ///</summary>
      property DelegationSignature: UnicodeString read GetDelegationSignature;
      ...
      ///  a TDBXConnectionFactory.
      ///</summary>
      property InputConnectionName: UnicodeString read FInputConnectionName;
      ///<summary>
      ///  First database user name when a connection was requested from
      ///  a TDBXConnectionFactory.
      ///</summary>
      property InputUserName: UnicodeString read FInputUserName;
      ///<summary>
      ///  First database password when a connection was requested from
      ///  a TDBXConnectionFactory.
      ///</summary>
      property InputPassword: UnicodeString read FInputPassword;
      ///<summary>
  ...
  TDBXRow = class
    ...
    protected
      ...
      procedure GetWideString(DbxValue: TDBXWideStringValue; var Value: UnicodeString; var IsNull: LongBool); overload; virtual;
      ...
      procedure SetWideString(DbxValue: TDBXWideStringValue; const Value: UnicodeString); virtual;
      ...
      procedure SetWideChars(DbxValue: TDBXWideStringValue; const Value: UnicodeString); virtual;
      ...
      procedure SetWideMemo(DbxValue: TDBXWideMemoValue; const Value: UnicodeString); virtual;
  ...
  TDBXFormatter = class
    ...
    /// </summary>
    function  DateToString(DBXDateValue:  TDBXDateValue): UnicodeString; virtual; abstract;
    /// <summary>
    ///  Convert String to TDBXDate.
    /// </summary>
    procedure StringToDate(StringValue: UnicodeString; DBXDateValue:  TDBXDateValue); virtual; abstract;

    /// <summary>
    ///  Convert time to String.
    /// </summary>
    function  TimeToString(DBXTimeValue:  TDBXTimeValue): UnicodeString; virtual; abstract;
    /// <summary>
    ...
    /// </summary>
    function  TimestampOffsetToString(DBXTimestampOffsetValue:  TDBXTimestampOffsetValue): UnicodeString; virtual; abstract;
    /// <summary>
    ///  Convert String to TSQLTimestampOffset.
    /// </summary>
    procedure StringToTimestampOffset(StringValue: UnicodeString; DBXTimestampOffsetValue:  TDBXTimestampOffsetValue); virtual; abstract;
  ...
  TDBXBytesStream = class(TDBXStream)
    ...
    public
      ...
      function Write(const Buffer; Count: Longint): Longint; override;
      function ReadBytes(const Buffer: TBytes; Offset, Count: Longint): Longint; override;
      constructor Create(Bytes: TBytes; Size: Int64);
      destructor Destroy; override;
  end;
  ...
  public
    ...
    function ToBytes(const Data: TBytes; const Offset: Integer): Integer; virtual;
    ...
    function CreateJSONValue(const Data: TBytes; const Off: Integer; const Count: Integer): TJSONValue; virtual;
  ...
  public
    ...
    function Info: UnicodeString; virtual; abstract;
...
{$ENDIF}
  ...
  public
    ...
    ///  </returns>
    function GetEncoded: TBytes; virtual; abstract;
  end;
  ...
  public
    ...
    ///  </returns>
    function GetEncoded: TBytes; overload; virtual; abstract;
...
procedure InitializeConnectionFactorySingletonFromINIFile(const DriverFileName, ConnectionFileName: UnicodeString);
...
const
  ...
  DefaultDriverPackageName = 'DbxCommonDriver160.bpl'; // Do not localize
...
type
  ...
  public
    ...
    function  DateToString(DBXDateValue:  TDBXDateValue): UnicodeString; override;
    procedure StringToDate(StringValue: UnicodeString; DBXDateValue:  TDBXDateValue); override;

    function  TimeToString(DBXTimeValue:  TDBXTimeValue): UnicodeString; override;
    procedure StringToTime(StringValue: UnicodeString; DBXTimeValue:  TDBXTimeValue); override;

    function  TimestampToString(DBXTimestampValue:  TDBXTimestampValue): UnicodeString; override;
    procedure StringToTimestamp(StringValue: UnicodeString; DBXTimestampValue:  TDBXTimestampValue); override;

    function  TimestampOffsetToString(DBXTimestampOffsetValue:  TDBXTimestampOffsetValue): UnicodeString; override;
    procedure StringToTimestampOffset(StringValue: UnicodeString; DBXTimestampOffsetValue:  TDBXTimestampOffsetValue); override;

    function  BcdToString(DBXBcdValue:  TDBXBcdValue): UnicodeString; override;
    procedure StringToBcd(StringValue: UnicodeString; DBXBcdValue:  TDBXBcdValue); override;
  end;
...
begin
  Close;
  FreeAndNil(FDBXDefaultFormatter);
  inherited Destroy;
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      try
        NewPrefixLength := Length(NewPrefix);
        ...
        begin
          ...
          if Pos('.', Key) > 0 then
          begin
            if Pos(NewPrefix, Key) = 1 then
              NewProperties.Add(Copy(Key, NewPrefixLength+1, Length(Key)-NewPrefixLength), Value)
            else
...
function TDBXConnectionFactory.GetConnection(const DBXContext: TDBXContext;
  const ConnectionName, UserName, Password: UnicodeString): TDBXConnection;
var
  ConnectionBuilder:    TDBXConnectionBuilder;
  DelegatePath:         TDBXDelegateItem;
...
function TDBXConnectionFactory.GetConnectionDriver(
  const ConnectionName: UnicodeString): TDBXDelegateDriver;
var
...
function TDBXConnectionFactory.GetDriver(
  const DriverName: UnicodeString;
...
function TDBXConnectionFactory.GetDriver(const DriverName: UnicodeString): TDBXDriver;
begin
  Result := GetDriver(DriverName, HasDriverProperties(DriverName));
end;

function TDBXConnectionFactory.getDriverName(
  ConnectionProperties: TDBXProperties): UnicodeString;
begin
...
function TDBXConnectionFactory.HasDriverProperties(
  const DriverName: UnicodeString): TDBXProperties;
var
  Index : TInt32;
begin
      ...
      try
        ...
        begin
          ...
          if Assigned(Props) then
            FDrivers.AddObject(List[I], Props.Clone);
        end
        else
        begin
          Props := TDBXProperties(FDrivers.Objects[index]);
          Driver.FDriverProperties := Props.Clone;
          FDrivers.Objects[index].Free;
          FDrivers.Delete(index);
          FDrivers.AddObject(List[i], Driver.GetDriverProperties.Clone);
        end;
      finally
        FreeAndNil(Driver);
      end;
...
begin
  ...
  begin
    ...
    try
      ...
      FConnectionProperties     := TStringList.Create;
...
class function TDBXConnectionFactory.OpenConnectionFactory(
  const DriverFileName, ConnectionFileName: UnicodeString): TDBXConnectionFactory;
var
...
var
  AppDir:             UnicodeString;
  DriverFileName:     UnicodeString;
  ConnectionFileName: UnicodeString;
...
function TDBXIniFileConnectionFactory.LoadDriver(DriverIni : TMemIniFile; const DriverName: UnicodeString) : TDBXProperties;
begin
...
begin
  ...
  begin
    ...
    try
      ...
      begin
        if FDrivers.IndexOf(EnabledDriverList[index]) < 0 then
          FDrivers.AddObject(EnabledDriverList[index], LoadDriver(DriverFile, EnabledDriverList[index]));
      end;
...
begin
  ...
  if Result = '' then
  begin
    Message := Format(SRequiredProperty, [Name]);
...
begin
  ...
  try
    ...
    begin
      ...
      if Pos < 0 then
        FProperties.Add(Key + '=' + Trim(List.ValueFromIndex[index]))
      else
        FProperties.ValueFromIndex[Pos] := List.ValueFromIndex[index];
    end;
  finally
    FProperties.EndUpdate;
  end;
...
procedure TDBXDriver.AddCommandFactory(const Name: UnicodeString;
...
procedure TDBXDriver.LoadMetaDataCommandFactory(const MetaDataCommandFactoryClassName: UnicodeString; const MetaDataCommandFactoryPackageName: UnicodeString);
var
...
var
  ...
  Index: Integer;
begin
  Drivers := TDBXDriverRegistry.DBXDriverRegistry.FDrivers;
  List := Drivers.LockList;
  try
    Index := TDBXDriverRegistry.DBXDriverRegistry.FindDriver(List, NewName);
    if Index >= 0 then
    begin
      raise TDBXError.Create(TDBXErrorCodes.InvalidArgument,
        Format(SDriverAlreadyLoaded, [NewName]));
    end;

    Index := TDBXDriverRegistry.DBXDriverRegistry.FindDriver(List, Name);
    ...
    if not FoundName then
      TDBXDriverRegistry.DBXDriverRegistry.LoadMetaDataCommandFactory(Self);
...
function TDBXDriver.GetDriverName: UnicodeString;
begin
  Result := FDriverName;
end;
...
procedure TDBXDriver.SetDriverName(const DriverName: UnicodeString);
begin
...
constructor TDBXError.Create(ErrorCode: TDBXErrorCode; const ErrorMessage: UnicodeString);
begin
...
constructor TDBXError.Create(ErrorCode: TDBXErrorCode;
  const ErrorMessage: UnicodeString; const InnerException: Exception);
begin
  Create(ErrorCode, ErrorMessage);  // Delphi runtim automatically sets the InnerException.
end;

class function TDBXError.ErrorCodeToString(ErrorCode: TDBXErrorCode): UnicodeString;
begin
  case ErrorCode of
...
function TDBXValueType.GetDisplayName: UnicodeString;
begin
  Result := FCaption;
end;
...
function TDBXValueType.GetName: UnicodeString;
begin
  Result := FName;
end;
...
procedure TDBXValueType.SetDisplayName(const Caption: UnicodeString);
begin
  FCaption := Caption;
end;
...
procedure TDBXValueType.SetName(const Name: UnicodeString);
begin
  FailIfReadOnlyType;
  FName := Name;
end;
...
class function TDBXValueType.DataTypeName(DataType: TDBXType): UnicodeString;
begin
  with TDBXDataTypes do
    case DataType of
      ...
      UInt8Type           : Result := 'UINT8';
      Int8Type            : Result := 'INT8';
      Int16Type           : Result := 'INT16';
      Int32Type           : Result := 'INT32';
      SingleType          : Result := 'SINGLE';
      DoubleType          : Result := 'DOUBLE';
      BcdType             : Result := 'BCD';
      BytesType           : Result := 'BYTES';
      TimeType            : Result := 'TIME';
      DateTimeType            : Result := 'DATETIME';
      UINT16Type          : Result := 'UINT16';
...
//      FMTBCD            : Result := 'FMTBCD';
      ...
      VariantType         : Result := 'Variant';
      TimeStampOffsetType  : Result := 'TIMESTAMPOFFSET';
      JsonValueType       : Result := 'JSON';
      else
...
begin
  inherited Create;
  FDriverLoaders    := TStringList.Create;
  FDriverClasses    := TStringList.Create;
...
begin
  ...
  FreeAndNil(FDriverClasses);
//  List := FDrivers.LockList;
//  for I := 0 to List.Count - 1 do
//  begin
//    TDBXDriver(List.Items[I]).Free;
//    List.Delete(I);
//  end;
//  FDrivers.UnlockList;
  FreeAndNil(FDrivers);
...
function TDBXDriverRegistry.FindDriver(List: TList;
  const DriverName: UnicodeString): Integer;
var
  Index: TInt32;
  Driver: TDBXDriver;
begin
...
procedure TDBXDriverRegistry.DriverLoadError(DriverDef: TDBXDriverDef; PackageName: UnicodeString);
var
  DBXContext: TDBXContext;
begin
...
procedure SplitTypeIntoClassAndPackage(var ClassName: UnicodeString; var PackageName: UnicodeString);
var
  Pos: Integer;
begin
...
function RegisterClassLoader(DriverProperties: TDBXProperties; ClassNameProp: UnicodeString; ClassNameDefault: UnicodeString; PackageNameProp: UnicodeString; PackageDefault: UnicodeString; out ResultPackageName: UnicodeString): UnicodeString;
var
  ClassRegistry: TClassRegistry;
...
var
  MetaDataClassName: UnicodeString;
  MetaDataPackageName: UnicodeString;
  DriverProperties: TDBXProperties;
begin
...
begin
  if DBXDriverRegistry.FDriverClasses.IndexOf(DriverName) < 0 then
    DBXDriverRegistry.FDriverClasses.AddObject(DriverName, TObject(DriverClass));
end;
...
begin
  ...
  begin
    Index := DBXDriverRegistry.FDriverClasses.IndexOf(DriverName);
    if Index >= 0 then
...
begin
  ...
  try
    ...
    if Index < 0 then
    begin
      Index := FDriverClasses.IndexOf(DriverDef.FDriverName);
      if Index > -1 then
      begin
        DriverClass := TDBXDriverClass(FDriverClasses.Objects[Index]);
...
var
  Index: Integer;
begin
  for Index := 0 to FDriverClasses.Count - 1 do
  begin
    DriverClassNameList.Add(FDriverClasses[Index]);
  end;
end;
...
begin
  for Index := 0 to FDriverLoaders.Count - 1 do
  begin
    DriverLoaderNameList.Add(FDriverLoaders[Index]);
  end;
end;
...
//procedure TDBXDriverRegistry.InternalRegisterLoaderClass(LoaderName: UnicodeString;
...
procedure TDBXDriverRegistry.InternalRegisterLoader(const LoaderClassName: UnicodeString; Loader: TDBXDriverLoader);
var
  Index: Integer;
begin
  inc(FCounter);
...
//class procedure TDBXDriverRegistry.RegisterLoaderClass(LoaderClassName: UnicodeString; LoaderClass: TDBXDriverLoaderClass);
//begin
//  if DBXDriverRegistry = nil then
...
begin
  while FCommands.Count > 0 do
    TDBXCommand(FCommands[0]).ConnectionClosing;
end;
...
procedure TDBXConnection.GetCommands(const CommandType: UnicodeString;
  List: TStrings);
begin
...
function TDBXConnection.GetProductVersion: UnicodeString;
var
  ProductVersionProperty: UnicodeString;
begin
...
function TDBXConnection.GetProductName: UnicodeString;
begin
...
function TDBXConnection.GetConnectionProperty(const Name: UnicodeString): UnicodeString;
begin
  Result := FConnectionProperties[Name];
end;

function TDBXConnection.GetVendorProperty(const Name: UnicodeString): UnicodeString;
begin
  Result := '';
end;
...
begin
  ...
  try
    GetCommands(CommandType, Strings);
...
begin
  Close;
  FreeAndNil(FFreeOnCloseList);
  if FConnection <> nil then
    FConnection.RemoveCommand(Self);
  inherited;
end;

procedure TDBXCommand.SetCommandType(const CommandType: UnicodeString);
begin
...
begin
  ...
  begin
    FFreeOnCloseList := TObjectList.Create;
    FFreeOnCloseList.OwnsObjects := true;
  end;
...
function TDBXCommand.GetCommandType: UnicodeString;
begin
  Result := FCommandType;
end;
...
function TDBXCommand.GetText: UnicodeString;
begin
  Result := FText;
end;
...
procedure TDBXCommand.SetText(const Value: UnicodeString);
begin
...
begin
  ...
  begin
    FCommand.FFreeOnCloseList := TObjectList.Create;
    FCommand.FFreeOnCloseList.OwnsObjects := true;
  end;
...
procedure TDBXMorphicCommand.SetCommandType(const Value: UnicodeString);
begin
...
procedure TDBXMorphicCommand.SetText(const Value: UnicodeString);
begin
...
procedure TDBXWritableValue.SetAsString(const Value: UnicodeString);
begin
  SetString(Value);
end;
...
procedure TDBXWritableValue.SetWideString(const Value: UnicodeString);
begin
...
function TDBXValue.GetAsString: UnicodeString;
begin
...
function TDBXValue.GetWideString(defaultValue: UnicodeString): UnicodeString;
begin
  if IsNull then
    Result := defaultValue
  else
...
function TDBXValue.GetWideString: UnicodeString;
begin
  TDBXValueType.InvalidTypeAccess(ValueType.DataType, TDBXDataTypes.WideStringType);
  Result := '';
end;
...
//
procedure TDBXValueList.InvalidName(const Name: UnicodeString; const Ordinal: TInt32);
begin
...
function TDBXValueList.GetValueByName(const Name: UnicodeString): TDBXValue;
begin
...
//function TDBXReader.GetValueTypeByName(const Name: UnicodeString): TDBXValueType;
//begin
//  Result := GetValueType(GetOrdinal(Name));
//end;

function TDBXReader.GetObjectTypeName(Ordinal: TInt32): UnicodeString;
begin
...
function TDBXValueList.GetOrdinal(const Name: UnicodeString): TInt32;
begin
...
function TDBXValueList.FindOrdinal(const Name: UnicodeString; const StartOrdinal,
...
begin
  ...
  begin
    if Assigned(FValues[Ordinal]) and (CompareText(FValues[Ordinal].ValueType.Name, Name) = 0) then
    begin
...
function TDBXValueTypeList.FindOrdinal(const Name: UnicodeString; StartOrdinal,
  EndOrdinal: TInt32): TInt32;
var
  Ordinal:      Integer;
  CurrentName:  UnicodeString;
begin
  for Ordinal := StartOrdinal to EndOrdinal - 1 do
  begin
    CurrentName := Values[Ordinal].Name;
    if CompareText(CurrentName, Name) = 0 then
    begin
      FLastOrdinal := Ordinal;
      Result := Ordinal;
      exit;
...
function TDBXValueTypeList.GetOrdinal(const Name: UnicodeString): TInt32;
begin
  // Simple optimization that always starts scanning from the Ordinal
  // position of the last found name.
  //
...
begin
  ...
  try
    ...
    end else if Self Is TDBXDataBaseMetadata then
...
function TDBXParameterList.GetOrdinal(const Name: UnicodeString): Integer;
begin
  Result := FValueTypes.GetOrdinal(Name);
end;

function TDBXParameterList.GetParameterByName(
  const Name: UnicodeString): TDBXParameter;
begin
...
procedure TDBXContext.Error(ErrorCode: TDBXErrorCode;
  ErrorMessage: UnicodeString; InnerException: Exception);
begin
...
function TDBXContext.IsTracingCategory(Category: UnicodeString): Boolean;
begin
  Result := true;
end;
...
function TDBXContext.Trace(TraceLevel: TDBXTraceLevel; TraceFlag: TDBXTraceFlag;
  CustomCategory, TraceMessage: UnicodeString): CBRType;
var
...
function TDBXContext.Trace(TraceLevel: TDBXTraceLevel; TraceFlag: TDBXTraceFlag;
  TraceMessage: UnicodeString): CBRType;
begin
...
function TDBXDelegateDriver.GetDriverName: UnicodeString;
begin
  if FDriver = nil then
    Result := ''
  else
...
function TDBXDelegateDriver.GetDriverVersion: UnicodeString;
begin
  Result := FDriver.GetDriverVersion;
end;

procedure TDBXDelegateDriver.SetDriverName(const DriverName: UnicodeString);
begin
...
begin
  if IsNull then
    ...
    Row.SetString(Self, GetAnsiString);
end;
...
begin
  ...
  SetAnsiString(AnsiString(TDBXDefaultFormatter.GetDefaultDBXFormatter.BcdToString(BcdValue)));
  FreeAndNil(BcdValue);
end;

procedure TDBXAnsiStringValue.SetAsBoolean(const Value: Boolean);
begin
  SetAnsiString(AnsiString(BoolToStr(Value, True)));
end;
...
begin
  ...
  SetAnsiString(AnsiString(TDBXDefaultFormatter.GetDefaultDBXFormatter.DateToString(DateValue)));
  FreeAndNil(DateValue);
end;

procedure TDBXAnsiStringValue.SetAsDouble(const Value: Double);
begin
  SetAnsiString(AnsiString(FloatToStr(Value)));
end;

procedure TDBXAnsiStringValue.SetAsInt16(const Value: SmallInt);
begin
  SetAnsiString(AnsiString(IntToStr(Value)));
end;
...
procedure TDBXAnsiStringValue.SetAsString(const Value: UnicodeString);
begin
...
begin
  ...
  SetAnsiString(AnsiString(TDBXDefaultFormatter.GetDefaultDBXFormatter.TimeToString(TimeValue)));
  FreeAndNil(TimeValue);
end;
...
begin
  ...
  SetAnsiString(AnsiString(TDBXDefaultFormatter.GetDefaultDBXFormatter.TimestampToString(TimestampValue)));
  FreeAndNil(TimestampValue);
end;
...
begin
  BcdValue := TDBXBcdValue.Create(nil);
  TDBXDefaultFormatter.GetDefaultDBXFormatter.StringToBcd(String(GetAnsiString), BcdValue);
...
begin
  DateValue := TDBXDateValue.Create(nil);
  TDBXDefaultFormatter.GetDefaultDBXFormatter.StringToDate(String(GetAnsiString), DateValue);
...
begin
  Result := StrToFloatDef(String(GetAnsiString), 0);
end;

function TDBXAnsiStringValue.GetAsInt16: SmallInt;
begin
  Result := StrToIntDef(String(GetAnsiString), 0);
end;
...
begin
  Result := StrToInt64Def(String(GetAnsiString), 0);
end;
...
function TDBXAnsiStringValue.GetAsString: UnicodeString;
begin
...
begin
  TimeValue := TDBXTimeValue.Create(nil);
  TDBXDefaultFormatter.GetDefaultDBXFormatter.StringToTime(String(GetAnsiString), TimeValue);
...
begin
  TimestampValue := TDBXTimestampValue.Create(nil);
  TDBXDefaultFormatter.GetDefaultDBXFormatter.StringToTimestamp(String(GetAnsiString), TimestampValue);
...
begin
  SetDynamicBytes(0, TDBXPlatform.AnsiStrToBytes(Value), 0, Length(Value));
end;
...
begin
  ...
  begin
    Row.SetAnsiMemo(Self, GetAnsiString);
  end;
end;
...
//  Result := string(FBytes);
  Result := Data.DBXPlatform.TDBXPlatform.BytesToAnsiStr(FBytes);
end;

function TDBXAnsiMemoValue.GetAsString: UnicodeString;
begin
  Result := String(GetAnsiString);
end;

procedure TDBXAnsiMemoValue.SetAsString(const Value: UnicodeString);
begin
  SetAnsiString(AnsiString(Value));
end;
...
function TDBXDateValue.GetAsString: UnicodeString;
begin
...
procedure TDBXDateValue.SetAsString(const Value: UnicodeString);
begin
...
function TDBXBooleanValue.GetAsString: UnicodeString;
begin
...
function TDBXTimeValue.GetAsString: UnicodeString;
begin
...
procedure TDBXTimeValue.SetAsString(const Value: UnicodeString);
begin
...
procedure TDBXWideStringValue.SetAsString(const Value: UnicodeString);
begin
  SetWideString(Value);
end;
...
function TDBXWideStringValue.GetAsString: UnicodeString;
begin
  Result := GetWideString;
end;
...
function TDBXWideStringValue.GetWideString: UnicodeString;
begin
  Result := '';
end;
...
procedure TDBXWideMemoValue.SetAsString(const Value: UnicodeString);
begin
  SetWideString(Value);
end;
...
procedure TDBXWideMemoValue.SetWideString(const Value: UnicodeString);
begin
...
function TDBXWideMemoValue.GetWideString: UnicodeString;
begin
  GetFBytes;
//    Result := UnicodeString(Buffer);
  Result := UnicodeString(TDBXPlatform.BytesToWideStr(FBytes));
end;
...
function TDBXWideMemoValue.GetAsString: UnicodeString;
begin
  Result := GetWideString;
end;
...
function TDBXStringValue.GetWideString: UnicodeString;
begin
  if (FDbxRow <> nil) and (FGeneration <> FDbxRow.Generation) then
  begin
...
procedure TDBXStringValue.SetWideString(const Value: UnicodeString);
begin
  FIsNull := false;
  FWideString := Value;
  FSetPending := true;
...
procedure TDBXWideStringBuilderValue.SetWideString(const Value: UnicodeString);
begin
//  ValueType.FailIfReadOnly;
  FIsNull := false;
  FWideString := Value;
...
function TDBXWideStringBuilderValue.GetWideString: UnicodeString;
begin
  if (FDbxRow <> nil) and (FGeneration <> FDbxRow.Generation) then
  begin
    FDbxRow.GetWideString(Self, FWideStringBuilder, FIsNull);
...
procedure TDBXInt16Value.SetAsString(const Value: UnicodeString);
var
  IntValue: Integer;
begin
...
function TDBXInt16Value.GetAsString: UnicodeString;
begin
...
procedure TDBXInt32Value.SetAsString(const Value: UnicodeString);
begin
...
function TDBXInt32Value.GetAsString: UnicodeString;
begin
...
procedure TDBXInt64Value.SetAsString(const Value: UnicodeString);
begin
...
function TDBXInt64Value.GetAsString: UnicodeString;
begin
...
procedure TDBXSingleValue.SetAsString(const Value: UnicodeString);
begin
...
function TDBXSingleValue.GetAsString: UnicodeString;
begin
...
procedure TDBXDoubleValue.SetAsString(const Value: UnicodeString);
begin
...
function TDBXDoubleValue.GetAsString: UnicodeString;
begin
...
procedure TDBXByteArrayValue.SetOverflowBytes(
  const OverFlowBytes: TDBXStreamReader);
begin
  FreeAndNil(FOverFlowBytes);
...
function TDBXTimeStampValue.GetAsString: UnicodeString;
begin
...
procedure TDBXTimeStampValue.SetAsString(const Value: UnicodeString);
begin
...
procedure TDBXBcdValue.SetAsString(const Value: UnicodeString);
begin
...
function TDBXBcdValue.GetAsString: UnicodeString;
begin
...
procedure TDBXClosedByteReader.GetInt8(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
begin
  InvalidOperation;
end;

procedure TDBXClosedByteReader.GetSingle(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
begin
  InvalidOperation;
end;
...
procedure TDBXClosedByteReader.GetUInt16(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
begin
  InvalidOperation;
end;

procedure TDBXClosedByteReader.GetUInt8(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
begin
  InvalidOperation;
end;
...
function TDBXRow.GetObjectTypeName(Ordinal: TInt32): UnicodeString;
begin
  NotImplemented;
end;
...
function TDBXConnectionBuilder.GetDelegationSignature: UnicodeString;
var
  DelegateItem: TDBXDelegateItem;
begin
...
procedure TDBXReaderByteReader.GetInt8(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
var
  ValueObject: TDBXValue;
begin
...
procedure TDBXReaderByteReader.GetSingle(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
var
  ValueObject: TDBXValue;
begin
...
procedure TDBXReaderByteReader.GetUInt16(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
var
  ValueObject: TDBXValue;
begin
...
procedure TDBXReaderByteReader.GetUInt8(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
var
  ValueObject: TDBXValue;
begin
...
procedure TDBXWideCharsValue.SetWideString(const Value: UnicodeString);
begin
//  ValueType.FailIfReadOnly;
  FIsNull := false;
...
function TDBXWideCharsValue.GetWideString: UnicodeString;
begin
  if (FDbxRow <> nil) and (FGeneration <> FDbxRow.Generation) then
  begin
...
function TDBXWideCharsValue.GetBytes(Offset: Int64; const Value: TBytes;
  BufferOffset, Length: Int64): Int64;
var
  Chars: TDBXWideChars;
  Count:  Integer;
...
procedure TDBXWideStringValue.SetOverflowBytes(
...
begin
  inherited Create(ValueType);
  FCount := 0;
  SetLength(FAnsiChars, 0);
  UpdateType;
end;

destructor TDBXAnsiCharsValue.Destroy;
begin
  SetLength(FAnsiChars, 0);
  FString := '';
  inherited Destroy;
...
begin
  ...
  begin
    // resize current content
    SetLength(FAnsiChars, Length);
  end;

  // copy the bytes as chars
  TDBXPlatform.CopyBytesToAnsiChars(Buffer, BufferOffset, FAnsiChars, 0, Length);
  FCount := Length;
  ...
  FString := TDBXPlatform.CreateAnsiString(FAnsiChars, FCount);
end;
...
begin
  if (FDbxRow <> nil) and (FGeneration <> FDbxRow.Generation) then
  begin
    FDbxRow.GetAnsiChars(Self, FAnsiChars, FCount, FIsNull);
    FGeneration := FDbxRow.Generation;
    if FIsNull then
      FString := ''
    else
...
begin
  if IsNull then
    ...
    Row.SetAnsiChars(Self, GetAnsiString)
end;

procedure TDBXAnsiCharsValue.SetRowValue;
begin
  FDbxRow.SetAnsiChars(Self, FString)
end;
...
function TDBXAnsiCharsValue.GetBytes(Offset: Int64; const Value: TBytes;
  BufferOffset, Length: Int64): Int64;
var
  Chars: TDBXAnsiChars;
  Count:  Integer;
...
begin
    Chars := AnsiChars;
    Count := AnsiCharsCount;
    Index := Offset;
    while Count > 0 do
    begin
      Ch := AnsiChar(Chars[Index]);
      Value[Index] := Byte(Ch);
      inc(Index);
      dec(Count);
    end;
    Result := AnsiCharsCount;
end;
...
begin
  ...
  begin
    Result := nil;
    FDbxRow.GetStream(Self, Result, FIsNull);
  end else if FSetPending and not FIsNull and (FStreamStreamReader <> nil) then
...
function TDBXLookAheadStreamReader.Read(const Buffer: TBytes; const Offset,
...
procedure TDBXByteReader.GetBoolean(Ordinal: TInt32; const Value: TBytes;
  Offset: TInt32; var IsNull: LongBool);
begin
...
function TDBXByteStreamReader.Read(const Buffer: TBytes; const Offset,
  Count: Integer): Integer;
var
  Available : Integer;
begin
...
procedure TDBXStateItemList.AddStateItem(Name: UnicodeString; Item: TDBXStateItem);
begin
...
function TDBXStateItemList.GetStateItem(Name: UnicodeString): TDBXStateItem;
begin
  Result := nil;
end;

procedure TDBXStateItemList.RemoveAndFreeStateItem(Name: UnicodeString);
begin
...
function TDBXDefaultFormatter.BcdToString(
  DBXBcdValue: TDBXBcdValue): UnicodeString;
begin
  Result := BcdToStr(DBXBcdValue.GetBcd);
end;

procedure TDBXDefaultFormatter.StringToBcd(StringValue: UnicodeString;
...
function TDBXDefaultFormatter.DateToString(
  DBXDateValue: TDBXDateValue): UnicodeString;
var
  Date: TDateTime;
  Time: TTimeStamp;
begin
...
procedure TDBXDefaultFormatter.StringToDate(StringValue: UnicodeString;
...
procedure TDBXDefaultFormatter.StringToTime(StringValue: UnicodeString;
...
function TDBXDefaultFormatter.TimeToString(
  DBXTimeValue: TDBXTimeValue): UnicodeString;
var
  Date: TDateTime;
  Time: TTimeStamp;
begin
...
procedure TDBXDefaultFormatter.StringToTimestamp(StringValue: UnicodeString;
...
function TDBXStreamReaderStream.ReadBytes(const Buffer: TBytes; Offset, Count: Longint): Longint;
begin
...
constructor TDBXBytesStream.Create(Bytes: TBytes; Size: Int64);
begin
  inherited Create;
  FBuffer := Bytes;
  FSize   := Size;
...
destructor TDBXBytesStream.Destroy;
begin
  SetLength(FBuffer, 0);
  inherited;
end;
...
function TDBXBytesStream.ReadBytes(const Buffer: TBytes; Offset, Count: Longint): Longint;
begin
  Result := Read(Buffer[Offset], Count);
end;
...
//function TDBXWritableValueList.GetWritableValueByName(
//  const Name: UnicodeString): TDBXWritableValue;
//begin
//
//end;
...
//end;
//
function TDBXTimeStampOffsetValue.GetAsString: UnicodeString;
begin
...
//end;
//
procedure TDBXTimeStampOffsetValue.SetAsString(const Value: UnicodeString);
begin
...
function TDBXInt8Value.GetAsString: UnicodeString;
begin
...
procedure TDBXInt8Value.SetAsString(const Value: UnicodeString);
var
  IntValue: Integer;
begin
  IntValue := StrToInt(Value);
...
function TDBXUInt8Value.GetAsString: UnicodeString;
begin
...
procedure TDBXUInt8Value.SetAsString(const Value: UnicodeString);
var
  IntValue: Integer;
begin
  IntValue := StrToInt(Value);
...
function TDBXJSONValue.ToBytes(const Data: TBytes; const Offset: Integer): Integer;
begin
  if FJsonValue <> nil then
  begin
...
function TDBXJSONValue.GetWideString: UnicodeString;
var
  Val: TJSONValue;
begin
  Val := GetJSONValue;
...
function TDBXJSONValue.CreateJSONValue(const Data: TBytes; const Off: Integer; const Count: Integer): TJSONValue;
begin
  if FInstanceOwner then
    FJsonValue.Free;
...
begin
  ...
  FEvents := TList<TDBXSchedulerRec>.Create;
end;
...
function TDBXUInt16Value.GetAsString: UnicodeString;
begin
...
procedure TDBXUInt16Value.SetAsString(const Value: UnicodeString);
var
  IntValue: LongInt;
begin
  IntValue := StrToInt(Value);
