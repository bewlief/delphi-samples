...
{$HPPEMIT '#pragma link "Data.DBXTrace"'}    {Do not Localize}
unit Data.DBXTrace;
...
type
  ...
  private
    ...
    function GetProperty(ResultName, InstanceName, PropertyName: String)
      : String; virtual; abstract;
    function SetProperty(InstanceName, PropertyName: String;
      Value: UnicodeString): String; virtual; abstract;
    ...
    function CallOpenFunction(ResultName, InstanceName, MethodName: String)
      : String; virtual; abstract;
    ...
    function ParamWideString(Param: UnicodeString; Separator: String): String; virtual; abstract;
  ...
  private
    ...
    function GetProperty(ResultName, InstanceName, PropertyName: String)
      : String; override;
    function SetProperty(InstanceName, PropertyName: String;
      Value: UnicodeString): String; override;
    ...
    function ParamWideString(Param: UnicodeString; Separator: String): String; override;
  ...
  private
    ...
    procedure WriteTraceln(Line: UnicodeString); virtual; abstract;
  ...
  private
    ...
    procedure WriteTraceln(Line: UnicodeString); override;
  public
    destructor Destroy; override;
  end;
  ...
  private
    ...
    FTraceOutputList: TStrings;
    function GetTraceOutput(Name: UnicodeString): TDBXTraceOutput;
  ...
  public
    ...
    function CreateConnection(ConnectionBuilder: TDBXConnectionBuilder)
      : TDBXConnection; override;
  ...
  private
    ...
    procedure Trace(TraceFlags: TDBXTraceFlag; Message: UnicodeString);


  protected

    function CreateAndBeginTransaction(const Isolation: TDBXIsolation)
      : TDBXTransaction; override;
    ...
    function GetConnectionProperty(const Name: UnicodeString): UnicodeString; override;
...
//TDBXTraceParameterRow = class;
  ...
  protected
    ...
    function GetCommandType: UnicodeString; override;
  ...
  private
    ...
    FValueDisplayName: UnicodeString;
    FLastOrdinal: TInt32;

    function GetValueDisplayName: UnicodeString;

  protected
    // constructor Create(DBXContext: TDBXContext; ValueType: TDBXValueType; Value: TDBXValue; Formatter: TDBXTraceFormatter; ValueName: UnicodeString); overload;
    constructor Create(DBXContext: TDBXContext; ValueType: TDBXValueType;
      Value: TDBXWritableValue; Formatter: TDBXTraceFormatter;
      ValueName: UnicodeString); overload;
  ...
  public
    ...
    function GetWideString: UnicodeString; overload; override;
    ...
    function GetBytes(Offset: Int64; const Buffer: TBytes;
    ...
    function GetWideString(defaultValue: UnicodeString): UnicodeString; overload; override;
    ...
    procedure SetDynamicBytes(Offset: Int64; const Buffer: TBytes;
      BufferOffset: Int64; Length: Int64); override;
  ...
  public
    constructor Create(DBXContext: TDBXContext; Parameter: TDBXParameter;
      Formatter: TDBXTraceFormatter; ValueName: UnicodeString);
    destructor Destroy(); override;
...
procedure TDBXTraceConnection.DerivedGetCommands(const CommandType: UnicodeString;
  const List: TStrings);
begin
  inherited;
  if FDBXContext.IsTracing(TDBXTraceFlags.Command) then
...
function TDBXTraceConnection.GetProductName: UnicodeString;
begin
...
function TDBXTraceConnection.GetProductVersion: UnicodeString;
begin
...
function TDBXTraceCommand.GetText: UnicodeString;
begin
...
function TDBXTraceCommand.GetCommandType: UnicodeString;
begin
...
procedure TDBXTraceCommand.SetCommandType(const Value: UnicodeString);
begin
  if FDBXContext.IsTracing(TDBXTraceFlags.Command) then
    Trace(TDBXTraceFlags.Command,
...
procedure TDBXTraceCommand.SetText(const Value: UnicodeString);
begin
  if FDBXContext.IsTracing(TDBXTraceFlags.Command) then
    Trace(TDBXTraceFlags.Command,
...
begin
  ...
  FTraceOutputList := TStringList.Create;
end;
...
function TDBXTraceDriver.GetDriverName: UnicodeString;
begin
  Result := 'DBXTrace'; {Do not localize}
end;


function TDBXTraceDriver.GetDriverVersion: UnicodeString;
begin
...
function TDBXTraceDriver.GetTraceOutput(Name: UnicodeString): TDBXTraceOutput;
var
  Index: Integer;
begin
...
begin
  ...
  begin
    ...
    HexIndex := Ch shr 4;
    if HexIndex = 0 then
      Buffer[BufIndex] := WideChar(Hex[(Ch shr 4)+1]);
    Buffer[BufIndex] := WideChar(Hex[(Ch shr 4)+1]);
    Inc(BufIndex);
    Buffer[BufIndex] := WideChar(Hex[(Ch and $F)+1]);
    Inc(BufIndex);
    Buffer[BufIndex] := ',';
    Inc(BufIndex);
  end;
...
function TDBXTracePascalFormatter.ParamWideString(Param: UnicodeString;
  Separator: String): String;
begin
  Result := QuoteString(Param) + Separator;
end;
...
function TDBXTracePascalFormatter.SetProperty(InstanceName,
  PropertyName: String; Value: UnicodeString): String;
begin
...
function TDBXTraceParameterList.GetOrdinal(const Name: UnicodeString): Integer;
begin
...
//{ TDBXTraceRegistry }
//
//procedure TDBXTraceRegistry.AddTraceWriter(Name: UnicodeString;
...
//  FSingletons    := TStringList.Create;
//end;
//
...
//end;
//
//function TDBXTraceRegistry.GetInstance(Name: UnicodeString;
...
constructor TDBXTraceWritableValue.Create(DBXContext: TDBXContext; ValueType: TDBXValueType; Value: TDBXWritableValue;  Formatter: TDBXTraceFormatter;ValueName: UnicodeString);
begin
...
//constructor TDBXTraceWritableValue.Create(DBXContext: TDBXContext; ValueType: TDBXValueType; Value: TDBXValue;  Formatter: TDBXTraceFormatter; ValueName: UnicodeString);
//begin
//  inherited Create(ValueType, Value);
//  FFormatter      := Formatter;
//  FValueName      := ValueName;
...
function TDBXTraceWritableValue.GetAsString: UnicodeString;
begin
  if DBXContext.IsTracing(TDBXTraceFlags.Parameter) then
    DBXContext.Trace(TDBXTraceFlags.Parameter,
          FFormatter.GetProperty('ResultString',
...
function TDBXTraceWritableValue.GetValueDisplayName: UnicodeString;
begin
...
function TDBXTraceWritableValue.GetWideString(
  defaultValue: UnicodeString): UnicodeString;
begin
  if DBXContext.IsTracing(TDBXTraceFlags.Parameter) then
    DBXContext.Trace(TDBXTraceFlags.Parameter,
...
function TDBXTraceWritableValue.GetWideString: UnicodeString;
begin
  if DBXContext.IsTracing(TDBXTraceFlags.Parameter) then
    DBXContext.Trace(TDBXTraceFlags.Parameter,
          FFormatter.GetProperty('ResultWideString',
...
procedure TDBXTraceWritableValue.SetAsString(const Value: UnicodeString);
begin
  if DBXContext.IsTracing(TDBXTraceFlags.Parameter) then
    DBXContext.Trace(TDBXTraceFlags.Parameter,
          FFormatter.CallOpenProcedure(GetValueDisplayName,
...
procedure TDBXTraceWritableValue.SetWideString(const Value: UnicodeString);
begin
  if DBXContext.IsTracing(TDBXTraceFlags.Parameter) then
    DBXContext.Trace(TDBXTraceFlags.Parameter,
          FFormatter.CallOpenProcedure(GetValueDisplayName,
...
begin
    AssignFile(FTraceFile, UnicodeString(Name));
...
procedure TDBXFileTraceOutput.WriteTraceln(Line: UnicodeString);
begin
...
procedure TDBXConsoleTraceOutput.WriteTraceln(Line: UnicodeString);
begin
    Writeln(Line);
end;
