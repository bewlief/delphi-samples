...
{$HPPEMIT '#pragma link "Data.DbxDb2"'}    {Do not Localize}
unit Data.DbxDb2;
...
begin
  ...
  Values[TDBXPropertyNames.DriverPackageLoader] := 'TDBXDynalinkDriverLoader,DBXDb2Driver160.bpl';
  ...
  Values[TDBXPropertyNames.MetaDataPackageLoader] := 'TDBXDb2MetaDataCommandFactory,DBXDb2Driver160.bpl';
  Values[TDBXPropertyNames.MetaDataAssemblyLoader] := 'Borland.Data.TDBXDb2MetaDataCommandFactory,Borland.Data.DbxDb2Driver,Version=16.0.0.0,Culture=neutral,PublicKeyToken=' + TDBXPlatform.GetPublicKeyToken;
