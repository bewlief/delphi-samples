...
type
  ...
  public
    ...
    private
      FVendorLibPath: UnicodeString;
      FSupportsNLSDataType: Boolean;
      FIsServerCharsetUTF8: Boolean;
      FIsCharUnicode: Boolean;
    public
      property VendorLibPath : UnicodeString read FVendorLibPath;
...
function TDBXSybaseASAMetaDataReader.GetProductName: UnicodeString;
begin
  Result := 'Adaptive Server Anywhere';
end;

function TDBXSybaseASAMetaDataReader.GetTableType: UnicodeString;
begin
  Result := 'BASE';
end;

function TDBXSybaseASAMetaDataReader.GetViewType: UnicodeString;
begin
  Result := 'VIEW';
end;

function TDBXSybaseASAMetaDataReader.GetSystemTableType: UnicodeString;
begin
  Result := 'BASE';
end;

function TDBXSybaseASAMetaDataReader.GetSystemViewType: UnicodeString;
begin
  Result := 'VIEW';
end;
...
function TDBXSybaseASAMetaDataReader.GetSqlForSchemas: UnicodeString;
begin
  Result := 'SELECT DB_NAME(), NAME FROM SYS.SYSUSERLIST WHERE RESOURCEAUTH=''Y'' ORDER BY 1, 2';
end;

function TDBXSybaseASAMetaDataReader.GetSqlForTables: UnicodeString;
begin
...
function TDBXSybaseASAMetaDataReader.GetSqlForViews: UnicodeString;
begin
...
function TDBXSybaseASAMetaDataReader.GetSqlForColumns: UnicodeString;
begin
...
function TDBXSybaseASAMetaDataReader.FetchColumnConstraints(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const TableName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASAMetaDataReader.GetSqlForIndexes: UnicodeString;
var
...
function TDBXSybaseASAMetaDataReader.GetSqlForIndexColumns: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXSybaseASAMetaDataReader.GetSqlForForeignKeys: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXSybaseASAMetaDataReader.GetSqlForForeignKeyColumns: UnicodeString;
var
  CurrentVersion: UnicodeString;
begin
  CurrentVersion := Version;
...
function TDBXSybaseASAMetaDataReader.FetchSynonyms(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const SynonymName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASAMetaDataReader.GetSqlForProcedures: UnicodeString;
begin
...
function TDBXSybaseASAMetaDataReader.GetSqlForProcedureSources: UnicodeString;
begin
...
function TDBXSybaseASAMetaDataReader.GetSqlForProcedureParameters: UnicodeString;
begin
...
function TDBXSybaseASAMetaDataReader.FetchPackages(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASAMetaDataReader.FetchPackageProcedures(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ProcedureType: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASAMetaDataReader.FetchPackageProcedureParameters(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString; const ProcedureName: UnicodeString; const ParameterName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASAMetaDataReader.FetchPackageSources(const CatalogName: UnicodeString; const SchemaName: UnicodeString; const PackageName: UnicodeString): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXSybaseASAMetaDataReader.GetSqlForUsers: UnicodeString;
begin
  Result := 'SELECT NAME FROM SYS.SYSUSERLIST WHERE USER_GROUP=''N'' ORDER BY 1';
end;

function TDBXSybaseASAMetaDataReader.GetSqlForRoles: UnicodeString;
begin
