...
type
  ...
  published
    ...
    /// </remarks>
    property ConsistentRead: Boolean read FConsistentRead write FConsistentRead;
  ...
  public
    ...
    /// <param name="ResponseInfo">The optional class for storing response info into</param>
    /// <returns>True if the request was successful, false otherwise.</returns>
    function UploadObject(const BucketName, ObjectName: String; Content: TBytes; ReducedRedundancy: Boolean = false;
    ...
    /// <param name="ResponseInfo">The optional class for storing response info into</param>
    /// <returns>True if successful, false otherwise.</returns>
    function UploadPart(const BucketName, ObjectName, UploadId: String; PartNumber: Integer; Content: TBytes;
...
function TAmazonBasicService.IssueRequest(URL: String; QueryParams: TStringList; ResponseInfo: TCloudResponseInfo;
                                          RequestStream: TStream = nil): TCloudHTTP;
var
  OutStr: String;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      QueryString := Copy(BuildQueryParameterString(EmptyStr, QueryParameters, False, True), 2);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          CurrentHeaderName := Copy(CurrentHeaderName, 12);
...
function TAmazonStorageService.UploadObject(const BucketName, ObjectName: String; Content: TBytes;
...
function TAmazonStorageService.UploadPart(const BucketName, ObjectName, UploadId: String; PartNumber: Integer;
                                          Content: TBytes; out Part: TAmazonMultipartPart;
                                          const ContentMD5: String;
                                          ResponseInfo: TCloudResponseInfo): boolean;
var
  url: String;
