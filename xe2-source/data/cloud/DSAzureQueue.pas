...
type
  ...
  ///<summary>
  ///  Component for managing Queues and their messages on Windows Azure.
  ///</summary>
  ///<remarks>
  ///  A tree component for viewing all of the queues stored for the given Windows Azure connection.
...
uses
  ...
  Vcl.Graphics, System.SysUtils, Winapi.Windows, Xml.XMLDoc, Xml.XMLIntf, System.StrUtils;
