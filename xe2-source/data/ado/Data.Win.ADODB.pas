...
uses
  Winapi.Windows, System.Variants, Winapi.ActiveX, System.SysUtils, System.Classes, System.TypInfo, Data.DB, Winapi.OleDB, Winapi.ADOInt, System.WideStrings;
...
{ TCustomADODataSet }
  ...
  protected
    ...
    procedure UpdateRecordSetPosition(Buffer: TRecordBuffer);
...
uses Data.DBCommon, Winapi.Mtx, Data.DBConsts, System.Win.ComObj, Data.Win.ADOConst, System.WideStrUtils, Data.FMTBcd, System.VarUtils;
...
procedure TCustomADODataSet.ClearCalcFields(Buffer: TRecordBuffer);
var
  I: Integer;
begin
...
function TCustomADODataSet.GetActiveRecBuf(var RecBuf: TRecordBuffer): Boolean;
begin
  case State of
    dsBlockRead,
    dsBrowse:
...
procedure TCustomADODataSet.UpdateRecordSetPosition(Buffer: TRecordBuffer);
begin
  ...
  begin
    ...
    begin
      ...
      if (DataType in [ftMemo, ftWideMemo, ftBlob]) and (Size = 0) then
        Size := High(Integer);
      Recordset.Fields._Append(Name, FieldTypeToADOType(DataType), Size, Options);
    end;
  end;
