...
uses
  Data.DBConsts, Vcl.VDBConsts, Vcl.Themes, Vcl.GraphUtil;
    ...
    begin
      ...
      try
        ...
        begin
          ...
          begin
            FCanvas.Brush.Color := StyleServices.GetSystemColor(clBtnFace);
            FCanvas.Font.Color := StyleServices.GetSystemColor(clBtnText);
...
begin
  ...
  begin
    ...
    begin
      if TStyleManager.IsCustomStyleActive then
        FPanel.Color := StyleServices.GetStyleColor(scPanel)
      else
        FPanel.Color := Color;
    end;
  ...
  begin
    ...
    begin
      ...
      try
        ...
        begin
          Pen.Color := TopColor;
          MoveTo(LRect.Right - 1, LRect.Top);
...
begin
  ...
  begin
    ...
    begin
      if TStyleManager.IsCustomStyleActive then
        Brush := CreateSolidBrush(ColorToRGB(StyleServices.GetStyleColor(scPanel)))
      else
