...
uses Winapi.Windows, System.Classes, Vcl.StdCtrls, Data.DB, Vcl.Controls, Winapi.Messages, System.SysUtils,
  Vcl.Forms, Vcl.Graphics, Vcl.Menus, Vcl.Buttons, Vcl.DBGrids, Bde.DBTables, Vcl.Grids, Vcl.DBCtrls;
...
uses Data.DBConsts, Bde.Bdeconst;
...
begin
  ...
  if (Key >= #32) and (FFieldLink.Field <> nil) and
