...
type
  ...
  private
    ...
    FWriter: string;
    FMetaDataProvider: TDSCustomMetaDataProvider;
...
uses Data.DBXCommon, Data.DBXPlatform, Datasnap.DSClientResStrs, Datasnap.DSCommonServer, Datasnap.DSProxyRest;
...
begin
  ...
  LWriter := LInstance.GetWriter(FWriter);
  try
