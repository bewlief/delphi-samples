...
{$HPPEMIT '#pragma link "Datasnap.DSProxyJavaAndroid"'}    { Do not Localize }
...
type
  ...
  protected
    ...
    procedure WriteJavaLine(const Line: UnicodeString); overload; virtual;
...
procedure TDSJavaAndroidProxyWriter.DerivedWrite(const Line: UnicodeString);
begin
