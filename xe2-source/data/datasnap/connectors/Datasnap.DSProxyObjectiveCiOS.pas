...
type
  ...
  protected
    ...
    procedure WriteObjectiveCLine(const Line: UnicodeString); overload; virtual;
...
const
  sObjectiveCiOS_RESTProxyWriter = 'Objective-C iOS 4.2 REST';
...
const
  sDSProxyObjectiveCiOSLanguage = 'objectivec_ios42';
...
begin
  Result.UsesUnits := 'Datasnap.DSProxyObjective_c_ios';
  ...
  Result.Language := sDSProxyObjectiveCiOSLanguage;
...
TDSProxyWriterFactory.RegisterWriter(sObjectiveCiOS_RESTProxyWriter,
  TDSClientProxyWriterObjectiveCiOS);

finalization

TDSProxyWriterFactory.UnregisterWriter(sObjectiveCiOS_RESTProxyWriter);
