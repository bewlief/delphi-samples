...
type
  ...
  protected
    ...
    function GetParameterTypeName: UnicodeString;
    procedure SetParameterTypeName(const DataTypeName: UnicodeString);
    function GetParameterTypeUnit: UnicodeString;
    procedure SetParameterTypeUnit(const DataTypeUnit: UnicodeString);
  ...
  public
    ...
    property ParameterTypeName: UnicodeString read GetParameterTypeName write SetParameterTypeName;
    property ParameterTypeUnit: UnicodeString read GetParameterTypeUnit write SetParameterTypeUnit;
  ...
  private
    FProxyClassName: UnicodeString;
    FFirstMethod: TDSProxyMethod;
    FLastMethod: TDSProxyMethod;
    FNext: TDSProxyClass;
  public
    property ProxyClassName: UnicodeString read FProxyClassName write FProxyClassName;
  ...
  IDSProxyWriter = interface
    ...
    procedure Write(const Line: UnicodeString);
    procedure WriteLine;
  end;
  ...
  private
    ...
    FProxyMethodName: UnicodeString;
  ...
  public
    property ProxyMethodName: UnicodeString read FProxyMethodName write FProxyMethodName;
    ...
    property MethodAlias: UnicodeString read FMethodAlias write FMethodAlias;
  ...
  TDSProxyParameter = class
  protected
    procedure SetTypeUnit(const TypeUnit: UnicodeString); virtual;
    function GetTypeUnit: UnicodeString; virtual;
  ...
  private
    ...
    FTypeUnit: UnicodeString;
  public
    property TypeName: UnicodeString read FTypeName write FTypeName;
    ...
    property ParameterName: UnicodeString read FParameterName write FParameterName;
    property TypeUnit: UnicodeString read GetTypeUnit write SetTypeUnit;
...
procedure TDSMethodParametersEntity.SetParameterTypeUnit(const DataTypeUnit: UnicodeString);
begin
...
procedure TDSProxyParameter.SetTypeUnit(const TypeUnit: UnicodeString);
begin
  self.FTypeUnit := TypeUnit;
end;

function TDSProxyParameter.GetTypeUnit: UnicodeString;
begin
  Result := FTypeUnit;
end;
...
begin
  if not StringIsNil(FTypeName) then
  begin
    if CompareText(Copy(FTypeName,0+1,5-(0)), 'TJSON') = 0 then
      Exit(True);
  end;
  Result := False;
end;
...
procedure TDSProxyStreamWriter.Write(const Line: UnicodeString);
begin
