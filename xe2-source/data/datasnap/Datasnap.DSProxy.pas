...
uses Data.DBXCommon, Data.DBXJSON, Data.DBXJSONReflect, Data.DbxCompressionFilter;
...
type
  ...
  public
    ...
    function NotifyCallback(ChannelName: string; ClientId: string; CallbackId: string; Msg: TJSONValue; out Response: TJSONValue): Boolean; overload;
    /// <summary> Deprecated: Use NotifyObject which takes no ChannelName, instead.</summary>
    function NotifyObject(ChannelName: string; ClientId: string; CallbackId: string; Msg: TObject; out Response: TObject): Boolean; overload;
