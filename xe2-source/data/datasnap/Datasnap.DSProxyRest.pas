...
uses Data.DBXCommon, Data.DBXJSON, Data.DBXJSONReflect, Datasnap.DSClientRest, Datasnap.DSCommonProxy;
...
type
  ...
  ///<summary>
  ///  Proxy for executing DSAdmin functions. This is meant to be subclassed by generated
  ///  proxies so that they get the important DSAdmin functions for free.
  ///</summary>
...
const
  ...
  (* DSAdmin_CreateServerClasses: array [0..0] of TDSRestParameterMetaData =
  (
    (Name: 'ClassReader'; Direction: 1; DBXType: 23; TypeName: 'TDBXReader')
  );

  DSAdmin_DropServerClasses: array [0..0] of TDSRestParameterMetaData =
  (
    (Name: 'ClassReader'; Direction: 1; DBXType: 23; TypeName: 'TDBXReader')
  );

  DSAdmin_CreateServerMethods: array [0..0] of TDSRestParameterMetaData =
  (
    (Name: 'MethodReader'; Direction: 1; DBXType: 23; TypeName: 'TDBXReader')
  );

  DSAdmin_DropServerMethods: array [0..0] of TDSRestParameterMetaData =
  (
    (Name: 'MethodReader'; Direction: 1; DBXType: 23; TypeName: 'TDBXReader')
  );

  DSAdmin_GetServerClasses: array [0..0] of TDSRestParameterMetaData =
  (
    (Name: ''; Direction: 4; DBXType: 23; TypeName: 'TDBXReader')
  );
  *)
...
//  DSAdmin_ConsumeClientChannel: array [0..4] of TDSRestParameterMetaData =
//  (
...
//  DSAdmin_ConsumeClientChannelTimeout: array [0..5] of TDSRestParameterMetaData =
//  (
//    (Name: 'ChannelName'; Direction: 1; DBXType: 26; TypeName: 'string'),
//    (Name: 'ClientManagerId'; Direction: 1; DBXType: 26; TypeName: 'string'),
//    (Name: 'CallbackId'; Direction: 1; DBXType: 26; TypeName: 'string'),
...
//  DSAdmin_RegisterClientCallbackServer: array [0..3] of TDSRestParameterMetaData =
//  (
//    (Name: 'ChannelName'; Direction: 1; DBXType: 26; TypeName: 'string'),
//    (Name: 'ChannelId'; Direction: 1; DBXType: 26; TypeName: 'string'),
//    (Name: 'CallbackId'; Direction: 1; DBXType: 26; TypeName: 'string'),
...
(*
  ...
  DSMetadata_GetProcedures: array [0..2] of TDSRestParameterMetaData =
  (
    (Name: 'ProcedureNamePattern'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: 'ProcedureType'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: ''; Direction: 4; DBXType: 23; TypeName: 'TDBXReader')
  );

  DSMetadata_GetProcedureParameters: array [0..1] of TDSRestParameterMetaData =
  (
    (Name: 'ProcedureNamePattern'; Direction: 1; DBXType: 26; TypeName: 'string'),
    (Name: ''; Direction: 4; DBXType: 23; TypeName: 'TDBXReader')
  );

  DSMetadata_GetDatabase: array [0..0] of TDSRestParameterMetaData =
  (
    (Name: ''; Direction: 4; DBXType: 23; TypeName: 'TDBXReader')
  );

  DSMetadata_GetDSServerName: array [0..0] of TDSRestParameterMetaData =
  (
    (Name: ''; Direction: 4; DBXType: 26; TypeName: 'string')
  );
*)
