...
{$HPPEMIT '#pragma link "Datasnap.DSProxyDelphi"'}    {Do not Localize}
unit Datasnap.DSProxyDelphi;

interface

uses System.Classes, Datasnap.DSCommonProxy, Datasnap.DSProxyWriter;
...
uses Data.DBXCommon, Data.DBXPlatform, System.SysUtils;
...
var
  ...
  Line: UnicodeString;
begin
  Line := 'uses Data.DBXCommon, Data.DBXClient, Data.DBXDataSnap, Data.DBXJSON, Datasnap.DSProxy, System.Classes, System.SysUtils, Data.DB, Data.SqlExpr, Data.DBXDBReaders,';
...
procedure TDSCustomDelphiProxyWriter.WriteOutgoingParameter(const Lhs: UnicodeString; const InRhs: UnicodeString; const Param: TDSProxyParameter; const CommandName: UnicodeString; const ParamName: UnicodeString);
var
  Rhs: UnicodeString;
begin
  Rhs := InRhs;
...
function TDSCustomDelphiProxyWriter.GetAssignmentString: UnicodeString;
begin
  Result := ':=';
end;


function TDSCustomDelphiProxyWriter.GetCreateDataSetReader(const Param: TDSProxyParameter): UnicodeString;
begin
  Result := '(TDBXDataSetReader.Create(' + Param.ParameterName + ', FInstanceOwner), True)';
end;

function TDSCustomDelphiProxyWriter.GetCreateParamsReader(const Param: TDSProxyParameter): UnicodeString;
begin
...
procedure TDSDelphiProxyWriter.DerivedWrite(const Line: UnicodeString);
begin
...
initialization
  TDSProxyWriterFactory.RegisterWriter(sDelphiDBXProxyWriter, TDSClientProxyWriterDelphi);
finalization
