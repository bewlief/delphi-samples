...
type
  ...
  private
    ...
    FRoleName: UnicodeString;
    FLifeCycle: UnicodeString;
    FDsClass: TDSClass;
    FAdminClass: Boolean;
    FServerClass: TDSCustomServerClass;
  public
    property DSClassName: UnicodeString read FClassName write FClassName;
    property DSClass: TDSClass read FDsClass write FDsClass;
    property LifeCycle: UnicodeString read FLifeCycle write FLifeCycle;
    property PackageName: UnicodeString read FPackageName write FPackageName;
    property RoleName: UnicodeString read FRoleName write FRoleName;
    ...
    property DSUnitName: UnicodeString read FUnitName write FUnitName;
  end;
  ...
  public
    ...
    function GetDSServerName: UnicodeString; override;
  protected
  ...
  public
    ...
    destructor Destroy; override;
  protected
    procedure SetMethodAlias(const MethodAlias: UnicodeString);
    function GetDSMethod: TDSMethod;
  private
    FMethodAlias: UnicodeString;
    FClassInfo: TDSClassInfo;
    FDsMethod: TDSMethod;
    FRoleName: UnicodeString;
    FMethodName: UnicodeString;
    FSearchName: UnicodeString;
  ...
  public
    ...
    property MethodAlias: UnicodeString read FMethodAlias write SetMethodAlias;
    property SearchName: UnicodeString read FSearchName;
    property DSMethodName: UnicodeString read FMethodName write FMethodName;
    property RoleName: UnicodeString read FRoleName write FRoleName;
  ...
  /// <summary>
  ///  Administrative built-in server methods.
  /// </summary>
  /// <remarks>  There are String constants in the <see cref="TDSAdminMethods"/>
  ///  class for each of these methods that can be used to specify which method to
  ///  invoke.
  /// 
  /// </remarks>
  ...
  public
    ...
    /// </summary>
    function GetPlatformName: UnicodeString;
    ...
    function DescribeClass(const ClassName: UnicodeString): TJSONObject;
    ...
    function ListMethods(const ClassName: UnicodeString): TJSONArray;
    ...
    function DescribeMethod(const ServerMethodName: UnicodeString): TJSONObject;
  ...
  public
    ...
    /// </summary>
    procedure GetServerMethods(const ClassName: UnicodeString; const Container: TJSONArray); overload;
    
    /// <summary> Delegate for TDSServerMethodProvider#getServerMethod(String, String, JSONObject)
    /// </summary>
    procedure GetServerMethod(const ServerMethodName: UnicodeString; const Container: TJSONObject);
  ...
  protected
    class function FindCustomServer(const Name: UnicodeString): TDSCustomServer; static;
    function GetClassTable: TDBXTable;
    procedure SetClassTable(const Classes: TDBXTable);
    function GetMethodTable: TDBXTable;
    procedure SetMethodTable(const Methods: TDBXTable);
  ...
  /// <summary> 
  ///  Event object provided to an event handler that destroys an instance for a server class.
  /// </summary>
  /// <remarks>
  /// </remarks>
  ...
  /// <summary> 
  ///  Event object provided to an event handler that creates an instance for a server class.
  /// </summary>
  /// <remarks>
  /// </remarks>
  ...
  /// <summary>
  ///  DataSnap implementation of a subset of <c>TDBXMetaDataCommands</c>
  /// 
  /// </summary>
  ...
  public
    ...
    /// <summary>
  ///  Event object provided to a server method event.
  /// </summary>
  /// <remarks>
  /// </remarks>
  ...
  public
    constructor Create(const Builder: TDBXConnectionBuilder);
    destructor Destroy; override;
  ...
  public
    ...
    procedure PrepareServerMethod(const MethodAlias: UnicodeString; const ServerMethod: TDSServerMethod;
  ...
  private
    ...
    function IsCall(const CommandText: UnicodeString): Integer;
    function FirstToken(const CommandText: UnicodeString): UnicodeString;
    function ScanMetaDataParameter(const InCommandText: UnicodeString): UnicodeString;
  ...
  private
    ...
    procedure InitServerMethodEventObject(
      ...
      const MethodAlias: UnicodeString; const ServerMethod: TDSServerMethod;
      const UserName: string; const UserRoles, AuthorizedRoles, DeniedRoles: TStrings);
  public
  ...
  public
    constructor Create;
    destructor Destroy; override;
    function GetClassInfo(const ClassName: UnicodeString): TDSClassInfo;
    procedure GetServerClasses(const ServerCon: TDSServerConnectionHandler; const Classes: TDSClassEntity); overload;
    ...
    procedure DropServerClass(const ServerClassName: UnicodeString);
    ...
    procedure DropSeverMethod(const MethodAlias: UnicodeString);
    procedure GetServerMethods(const ServerCon: TDSServerConnectionHandler; const Methods: TDSMethodEntity); overload;
    ...
    procedure GetServerMethodParameters(const SearchName: UnicodeString; const Container: TJSONObject); overload;
    procedure GetProcedures(const ServerCon: TDSServerConnectionHandler; const ProcedureNamePattern: UnicodeString; const ProcedureTypePattern: UnicodeString; const Procedures: TDSProcedureEntity);
    procedure GetProcedureParameters(const ServerCon: TDSServerConnectionHandler; const SchemaPattern: UnicodeString; const MethodPattern: UnicodeString; const ProcedureParameters: TDSProcedureParametersEntity);
    ...
    function HasServerMethod(const MethodName: UnicodeString): Boolean;
  ...
  private
    ...
    function CreateMethodAlias(const MethodClass: TDSMethod): UnicodeString;
    procedure AddAllMethods(ARTTICtx: TRTTIContext; const ClassInfo: TDSClassInfo);
    function AddBuiltinMethods(ARTTICtx: TRTTIContext; const PackageName: UnicodeString; const UnitName: UnicodeString; const ClassName: UnicodeString; const AdminClass: Boolean): TDSClassInfo;
    ...
    function GetParameterMode(const ParameterClass: TDSClass): UnicodeString;
    procedure AddParameter(const ServerCon: TDSServerConnectionHandler; const Parameter: TDSClass; const ParameterName: UnicodeString; const SchemaName: UnicodeString; const ProcedureName: UnicodeString; const ParamIndex: Integer; const ProcedureParameters: TDSProcedureParametersEntity);
    procedure CheckConfiguration(const Config: TDSConfiguration);
    procedure ProcessConfiguration(const Config: TDSConfiguration);
    procedure UnknownLifeCycle(const LifeCycle: UnicodeString);
  ...
  public
    constructor Create(const AClassName: UnicodeString; const ADestroyEventObject: TDSDestroyInstanceEventObject; const AServerClass: TDSCustomServerClass; const AInstance: TObject);
    procedure DestroyInstance;
  public
    FNext: TInstanceProviderItem;
  private
    FServerClassNotifier: TServerClassNotifier;
    FInstanceClassName: UnicodeString;
    FDestroyEventObject: TDSDestroyInstanceEventObject;
    FServerClass: TDSCustomServerClass;
    FInstance: TObject;
  public
    property Instance: TObject read FInstance;
    property InstanceClassName: UnicodeString read FInstanceClassName;
  end;
...
function TDSCustomAdmin.GetDSServerName: UnicodeString;
begin
...
function DSAdmin.GetPlatformName: UnicodeString;
begin
...
function DSAdmin.FindClasses(const PackageName: UnicodeString; const ClassPattern: UnicodeString): TDBXReader;
var
  Table: TDBXTable;
...
begin
  ...
  try
    ...
    DsPackage := TDSPackage.Create;
    List := DsPackage.GetDSClasses(C_Conditional(StringIsNil(ClassPattern), '', ClassPattern));
...
function DSAdmin.FindMethods(const PackageName: UnicodeString; const ClassPattern: UnicodeString; const MethodPattern: UnicodeString): TDBXReader;
var
  Table: TDBXTable;
  ...
  LowerCaseMethodPattern: UnicodeString;
  MethodName: UnicodeString;
  ShortClassName: UnicodeString;
...
begin
  ...
  DsClass := nil;
  DsMethods := nil;
  if not StringIsNil(MethodPattern) then
    LowerCaseMethodPattern := LowerCase(MethodPattern)
  else 
  ...
  try
    ...
    begin
      ...
      if StringIsNil(DsClass.ClassLoadError) then
      begin
        DsMethods := DsClass.Methods;
        ClassName := List[ClassIndex];
        LastDot := StringLastIndexOf(ClassName,'.');
        if StringIndexOf(ClassName,'.') > -1 then
          ShortClassName := Copy(ClassName,LastDot + 1+1,Length(ClassName)-(LastDot + 1))
        else 
          ShortClassName := ClassName;
        for methodIndex := 0 to Length(DsMethods) - 1 do
        begin
          MethodName := DsMethods[MethodIndex].DSMethodName;
          if (StringIsNil(MethodPattern)) or (Length(MethodPattern) < 1) or (StringIndexOf(LowerCase(MethodName),LowerCaseMethodPattern) > -1) then
          begin
...
function DSAdmin.DescribeClass(const ClassName: UnicodeString): TJSONObject;
var
...
function DSAdmin.ListMethods(const ClassName: UnicodeString): TJSONArray;
var
  Container: TJSONArray;
begin
  Container := TJSONArray.Create;
...
function DSAdmin.DescribeMethod(const ServerMethodName: UnicodeString): TJSONObject;
var
  Container: TJSONObject;
begin
  Container := TJSONObject.Create;
...
function DSAdmin.GetConnection(const NewConName: UnicodeString): TDBXConnection;
var
  NewCon: TDBXConnection;
begin
  if (StringIsNil(FConName)) or not (FConName = NewConName) then
  begin
...
class function TDSCustomServer.FindCustomServer(const Name: UnicodeString): TDSCustomServer;
begin
...
procedure TDSCustomServer.GetServerClass(const ClassName: UnicodeString; const Container: TJSONObject);
begin
  FServerMethodProvider.GetServerClass(ClassName, Container);
end;

procedure TDSCustomServer.GetServerMethods(const ClassName: UnicodeString; const Container: TJSONArray);
begin
  FServerMethodProvider.GetServerMethods(ClassName, Container);
end;

procedure TDSCustomServer.GetServerMethod(const ServerMethodName: UnicodeString; const Container: TJSONObject);
begin
...
begin
  if CompareText(Message.Command, TDBXMetaDataCommands.GetDatabase) = 0 then
  begin
...
function TDSDefaultDatabaseConnectionHandler.GetProductName: UnicodeString;
begin
  Result := 'DataSnap';
end;
...
begin
  inherited Create;
  FInstanceTable := TDBXObjectStore.Create;
...
function DSMetadata.GetProcedures(const ProcedureNamePattern: UnicodeString; const ProcedureType: UnicodeString): TDBXReader;
var
  ...
  try
    ...
    begin
      ...
      try
        ...
        if Length(ProcedureType) > 0 then
...
function DSMetadata.GetProcedureParameters(const ProcedureNamePattern: UnicodeString): TDBXReader;
var
...
procedure TDSMethodInfo.SetMethodAlias(const MethodAlias: UnicodeString);
begin
...
function TDSServerMethodUserEventObject.GetUserName: string;
begin
  if FUserName <> '' then
    Result := FUserName
  else
...
begin
  ...
  begin
    ...
    begin
      ...
      if Session <> nil then
        try
          Channel := TDBXLocalChannel.Create(Session.GetData('RemoteIP'));
          ChannelInfo := Channel.ChannelInfo;

          with ClientInfo do
          begin
            IpAddress := Channel.ChannelInfo.Info;
      ...
      FConHandler := TDSServerConnectionHandler.Create(FDbxContext, FNextHandler, Channel);
...
procedure TDSServerConnection.DerivedGetCommands(const CommandType: UnicodeString; const List: TStrings);
begin
end;
...
procedure TDSServerConnectionHandler.InitServerMethodEventObject(EventObject: TDSServerMethodUserEventObject; const MethodAlias: UnicodeString; const ServerMethod: TDSServerMethod;
  const UserName: string; const UserRoles, AuthorizedRoles, DeniedRoles: TStrings);
var
  ServerClass: TDSCustomServerClass;
begin
...
procedure TDSServerConnectionHandler.PrepareServerMethod(const MethodAlias: UnicodeString; const ServerMethod: TDSServerMethod;
  const UserName: string; const UserRoles, AuthorizedRoles, DeniedRoles: TStrings);
begin
...
function TDSServerConnectionHandler.GetProductName: UnicodeString;
begin
...
function TDSServerConnectionHandler.IsCall(const CommandText: UnicodeString): Integer;
var
  Count: Integer;
  Ch: Char;
  Index: Integer;
begin
  Count := Length(CommandText);
  for Index := 0 to Count - 1 do
    case CommandText[1+Index] of
      ' ',
      #$9,
      #$d,
      #$a:;
      ...
      'c':
        begin
          ...
          begin
            Ch := CommandText[1+Index + 1];
            if (Ch = 'A') or (Ch = 'a') then
            begin
              Ch := CommandText[1+Index + 2];
              if (Ch = 'L') or (Ch = 'l') then
              begin
                Ch := CommandText[1+Index + 3];
                if (Ch = 'L') or (Ch = 'l') then
                  case CommandText[1+Index + 4] of
                    ' ',
                    #$9,
                    #$d,
                    #$a:
...
function TDSServerConnectionHandler.FirstToken(const CommandText: UnicodeString): UnicodeString;
var
  Count: Integer;
  StartIndex: Integer;
  Index: Integer;
begin
        ...
        begin
          ...
          begin
            case CommandText[1+Index] of
              ...
              '"',
              '(':
                Exit(Copy(CommandText,StartIndex+1,Index-(StartIndex)));
            end;
            Index := Index + 1;
          end;
        end;
  ...
  Result := Copy(CommandText,StartIndex+1,Index-(StartIndex));
end;

function TDSServerConnectionHandler.ScanMetaDataParameter(const InCommandText: UnicodeString): UnicodeString;
var
  CommandText: UnicodeString;
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      with DbxConnection.DatabaseMetaData do
        Scanner := TDBXSqlScanner.Create(QuoteChar, QuotePrefix, QuoteSuffix);
    ...
    try
      ...
      begin
        if CompareText(Scanner.Id, TDBXMetaDataCommands.GetProcedures) = 0 then
        begin
        ...
        else if CompareText(Scanner.Id, TDBXMetaDataCommands.GetProcedureParameters) = 0 then
        begin
...
var
  NextCommandHandler: TDBXCommandHandler;
  CommandType: UnicodeString;
  CommandText: UnicodeString;
  ServerMethodText: UnicodeString;
  CallIndex: Integer;
  ConvertToServerMethod: Boolean;
  ServerHandler: TDSServerMethodCommandHandler;
  DatabaseHandler: TDBXCommandHandler;
begin
  ...
  if CallIndex > -1 then
  begin
    ServerMethodText := Copy(CommandText,CallIndex + 5+1,Length(CommandText)-(CallIndex + 5));
    if (CompareText(CommandType, TDBXCommandTypes.DsServerMethod) = 0) then
  ...
  else if CompareText(CommandType, TDBXCommandTypes.DbxStoredProcedure) = 0 then
  begin
  ...
  else if (CompareText(CommandText, TDBXMetaDataCommands.GetDatabase) = 0) and (Message.CommandType = TDBXCommandTypes.DbxMetadata) then
  begin
    Message.Command := TDSMetadataMethods.GetDatabase;
    Message.CommandType := TDBXCommandTypes.DsServerMethod;
    Exit(AcquireCommandHandler(Message));
...
var
  ServerConnectionName: UnicodeString;
  Command: TDBXCommand;
...
begin
  ...
  if StringIsNil(ServerConnectionName) then
    DbxConnection := nil
  else 
  begin
...
begin
  ...
  begin
    if FAdapterInstance Is TDSProviderDataModuleAdapter then
      TDSProviderDataModuleAdapter(FAdapterInstance).ProviderDataModule := nil;
...
begin
  ...
  begin
    ...
    begin
      ...
      if FServerMethod.AdapterInstance is TDSProviderDataModuleAdapter then
      begin
        Adapter := TDSProviderDataModuleAdapter(FServerMethod.AdapterInstance);
        if Adapter.ProviderDataModule = FServerMethod.MethodInstance then
          Adapter.ProviderDataModule := nil;
      end;
...
var
  LifeCycle: UnicodeString;
begin
  LifeCycle := FServerMethod.MethodInfo.DSClassInfo.LifeCycle;
  if (not StringIsNil(LifeCycle)) and (LifeCycle = TDSLifeCycle.Invocation) then
...
function TDSServerMethodProvider.GetClassInfo(const ClassName: UnicodeString): TDSClassInfo;
var
  &Object: TObject;
begin
  &Object := FClassTable[ClassName];
  if &Object = nil then
    Exit(nil);
  Result := TDSClassInfo(&Object);
end;
...
begin
  ...
  for Index := 0 to Count - 1 do
  begin
    ClassInfo := TDSClassInfo(FClassTable[UnicodeString(FClassList[Index])]);
...
procedure TDSServerMethodProvider.GetServerClass(const ClassName: UnicodeString; const Container: TJSONObject);
var
  ClassInfo: TDSClassInfo;
...
begin
  ...
  begin
    ...
    begin
      ...
      if not StringIsNil(DsClass.ClassLoadError) then
...
procedure TDSServerMethodProvider.DropServerClass(const ServerClassName: UnicodeString);
var
...
begin
  ...
  begin
    MethodInfo := TDSMethodInfo(FMethodTable[(UnicodeString(FMethodSearchNameList[MethodIndex]))]);
  ...
  begin
    if ((UnicodeString(FClassList[ClassIndex])) = ServerClassName) then
    begin
  ...
  FClassTable.Delete(FClassTable.IndexOf(ServerClassName));
end;
...
function TDSServerMethodProvider.CreateMethodAlias(const MethodClass: TDSMethod): UnicodeString;
var
  Alias: UnicodeString;
  DsClass: TDSClass;
  ServerMethodClassName: UnicodeString;
  LastDot: Integer;
begin
  ...
  LastDot := StringLastIndexOf(ServerMethodClassName,'.');
  if LastDot < 0 then
    Alias := ServerMethodClassName
  else 
    Alias := Copy(ServerMethodClassName,LastDot + 1+1,Length(ServerMethodClassName)-(LastDot + 1));
...
function TDSServerMethodProvider.AddBuiltinMethods(ARTTICtx: TRTTIContext; const PackageName: UnicodeString; const UnitName: UnicodeString; const ClassName: UnicodeString; const AdminClass: Boolean): TDSClassInfo;
var
  ClassInfo: TDSClassInfo;
begin
  ClassInfo := TDSClassInfo.Create;
...
begin
  ...
  FMethodTable.Delete(FMethodTable.IndexOf(MethodInfo.SearchName));
  MethodInfo.Free;
end;

procedure TDSServerMethodProvider.DropSeverMethod(const MethodAlias: UnicodeString);
var
  MethodInfo: TDSMethodInfo;
  Count: Integer;
  Index: Integer;
begin
  ...
  for Index := 0 to Count - 1 do
  begin
    if CompareText((UnicodeString(FMethodSearchNameList[Index])), MethodAlias) = 0 then
    begin
...
begin
  ...
  for Index := 0 to Count - 1 do
  begin
    MethodInfo := (TDSMethodInfo(FMethodTable[UnicodeString(FMethodSearchNameList[Index])]));
    Methods.Table.Insert;
...
procedure TDSServerMethodProvider.GetServerMethods(const ClassName: UnicodeString; const Container: TJSONArray);
var
  MethodInfo: TDSMethodInfo;
...
begin
  Prefix := NullString;
  if not StringIsNil(ClassName) then
  begin
    Prefix := UpperCase(ClassName);
    Prefix := Prefix + '.';
  end;
  Count := FMethodSearchNameList.Count;
  for Index := 0 to Count - 1 do
  begin
    MethodInfo := (TDSMethodInfo(FMethodTable[UnicodeString(FMethodSearchNameList[Index])]));
    if (StringIsNil(Prefix)) or StringStartsWith(MethodInfo.SearchName,Prefix) then
      Container.AddElement(TJSONString.Create(MethodInfo.MethodAlias));
  end;
end;

procedure TDSServerMethodProvider.GetServerMethod(const ServerMethodName: UnicodeString; const Container: TJSONObject);
var
  MethodInfo: TDSMethodInfo;
...
procedure TDSServerMethodProvider.GetServerMethodParameters(const SearchName: UnicodeString; const Container: TJSONObject);
var
  MethodInfo: TDSMethodInfo;
  DsMethod: TDSMethod;
  ParameterClass: TDSClass;
...
begin
  MethodInfo := TDSMethodInfo(FMethodTable[UpperCase(SearchName)]);
  if MethodInfo <> nil then
  begin
    DsMethod := MethodInfo.DSMethod;
    ParamTypes := DsMethod.ParameterTypes;
...
procedure TDSServerMethodProvider.GetProcedures(const ServerCon: TDSServerConnectionHandler; const ProcedureNamePattern: UnicodeString; const ProcedureTypePattern: UnicodeString; const Procedures: TDSProcedureEntity);
var
  Count: Integer;
  MethodInfo: TDSMethodInfo;
...
begin
  ...
  begin
    MethodInfo := (TDSMethodInfo(FMethodTable[UnicodeString(FMethodSearchNameList[Index])]));
    if (Length(ProcedureNamePattern) < 1) or (ProcedureNamePattern = '%') or (StringIndexOf(MethodInfo.MethodAlias,ProcedureNamePattern) >= 0) then
    begin
...
function TDSServerMethodProvider.GetParameterMode(const ParameterClass: TDSClass): UnicodeString;
begin
...
procedure TDSServerMethodProvider.AddParameter(const ServerCon: TDSServerConnectionHandler; const Parameter: TDSClass; const ParameterName: UnicodeString; const SchemaName: UnicodeString; const ProcedureName: UnicodeString; const ParamIndex: Integer; const ProcedureParameters: TDSProcedureParametersEntity);
var
...
procedure TDSServerMethodProvider.GetProcedureParameters(const ServerCon: TDSServerConnectionHandler; const SchemaPattern: UnicodeString; const MethodPattern: UnicodeString; const ProcedureParameters: TDSProcedureParametersEntity);
var
  Count: Integer;
...
begin
  ...
  begin
    MethodInfo := (TDSMethodInfo(FMethodTable[UnicodeString(FMethodSearchNameList[Index])]));
    if ((Length(MethodPattern) < 1) or (StringIndexOf(MethodInfo.MethodAlias,MethodPattern) >= 0)) and ((Length(SchemaPattern) < 1) or (StringIndexOf(MethodInfo.RoleName,SchemaPattern) >= 0)) then
    begin
...
procedure TDSServerMethodProvider.UnknownLifeCycle(const LifeCycle: UnicodeString);
begin
...
begin
  ...
  ReturnInstance := nil;
  if (StringIsNil(LifeCycle)) or (Length(LifeCycle) < 1) or (LifeCycle = TDSLifeCycle.Server) then
...
function TDSServerMethodProvider.HasServerMethod(const MethodName: UnicodeString): Boolean;
begin
...
begin
  ...
  if not FOpen then
  begin
    FPackageTable := TDBXObjectStore.Create;
    FClassTable := TDBXObjectStore.Create;
    FClassList := TDBXStringList.Create;
    FMethodTable := TDBXObjectStore.Create;
...
var
  ...
  Index: Integer;
  NewCons: TDBXConnectionHandlerArray;
  Index2: Integer;
begin
  ...
  for Index2 := 0 to Length(Cons) - 1 do
    NewCons[Index2] := Cons[Index2];
...
function TDSVoidConnectionHandler.GetProductName: UnicodeString;
begin
  Result := NullString;
end;
...
constructor TInstanceProviderItem.Create(const AClassName: UnicodeString; const ADestroyEventObject: TDSDestroyInstanceEventObject; const AServerClass: TDSCustomServerClass; const AInstance: TObject);
begin
  inherited Create;
