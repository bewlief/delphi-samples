...
type
  ...
  protected
    ...
    function GetDSServerName: UnicodeString; virtual; abstract;
  public
  ...
  TDSPlatform = class
  public
//    class function CreateDatabaseConnectionHandler(con: TDSServerConnection): TDBXConnectionHandler; static;
    class function DefaultPackageName: WideString; static;
    class function DataSnapAdminClassName: WideString; static;
    class function DataSnapAdminUnitName: String; static;
    class function MetadataClassName: WideString; static;
    class function MetadataUnitName: String; static;
    class function PlatformName: WideString; static;
...
//class function TDSPlatform.CreateDatabaseConnectionHandler(
//  con: TDSServerConnection): TDBXConnectionHandler;
//begin
...
class function TDSPlatform.DefaultPackageName: WideString;
begin
  Result := '';
end;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        try
          Connections.DriverProperties := Factory.GetDriverProperties(DriverName).Properties.DelimitedText;
...
class function TDSPlatform.DataSnapAdminClassName: WideString;
begin
  Result := 'DSAdmin';
end;

class function TDSPlatform.PlatformName: WideString;
begin
  Result := 'win32';
end;

class function TDSPlatform.MetadataClassName: WideString;
begin
  Result := 'DSMetadata';
end;
