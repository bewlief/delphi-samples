...
unit Xml.XMLSchema99;

interface

uses System.SysUtils, Xml.XMLSchema, Xml.Xmldom, Xml.XMLDoc, Xml.XMLIntf;
...
{ TXMLSchema1999TranslatorFactory }
  ...
  protected
    function CanImportFile(const FileName: DOMString): Boolean; override;
  end;
...
function TXMLSchema1999TranslatorFactory.CanImportFile(
  const FileName: DOMString): Boolean;
var
  Doc: IXMLDocument;
begin
...
procedure TXMLSchema1999Translator.Translate(const FileName: DOMString;
...
initialization
  TranslatorFactory := TXMLSchema1999TranslatorFactory.Create(
    TXMLSchema1999Translator, nil, SXMLSchemaExt, S99TransDesc);
