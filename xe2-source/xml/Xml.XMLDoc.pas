...
{$ENDIF}
  System.SyncObjs, System.Types, System.Variants, System.SysUtils, System.Classes, Xml.Xmldom, Xml.XMLIntf;
...
begin
  ...
  begin
    ...
    while (ItemPos < LineLen) and not IsQuoteChar(AttrLine[ItemPos]) do
      Inc(ItemPos);
    if ItemPos < LineLen then
    begin
      ItemEnd := ItemPos + 1;
      while (ItemEnd < LineLen) and not IsQuoteChar(AttrLine[ItemEnd]) do
        Inc(ItemEnd);
  ...
  begin
    ...
    try
      ...
      begin
        ...
        MemoryStream.Read(XML[1], MemoryStream.Size);
      end
      else
