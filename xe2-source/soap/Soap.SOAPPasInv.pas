...
uses
  Soap.Invoker, System.TypInfo, System.Classes, Soap.OPConvert, Soap.OPToSOAPDomConv, Soap.SOAPAttachIntf,
  Soap.WSDLIntf, System.Contnrs, Soap.InvokeRegistry;
...
uses
  Soap.SOAPConst, System.SysUtils, Soap.WebServExp, Soap.InvConst, Soap.IntfInfo{$IFDEF MSWINDOWS}, Winapi.ActiveX{$ENDIF}, Soap.OpConvertOptions;
