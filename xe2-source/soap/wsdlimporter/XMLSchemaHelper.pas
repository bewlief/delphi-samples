...
{$ENDIF}
  ...
  ['{BA640BF8-8364-49FF-829E-81B74A3394F9}']
    ...
    function Visit(const Item: IXMLElementDef; const ElementType: TElementType;
...
type
  ...
  public
    ...
    procedure Show(Items: IXMLElementGroups; Context: XMLVisitorContext); overload;
    ...
    procedure Show(Items: IXMLElementDefs; ElementType: TElementType; CompositorId: Integer;
    ...
    function Show(Item: IXMLElementGroup; Context: XMLVisitorContext): XMLVisitorContext; overload;
    ...
    function Show(Item: IXMLElementDef; ElementType: TElementType; CompositorId: Integer; Context: XMLVisitorContext): XMLVisitorContext; overload;
...
//      Show(SchemaDef.ElementGroups, Context);
...
begin
  ...
  begin
    Item := Items[I];
    Show(Item, ElementType, CompositorId, Context);
  end;
end;
...
var
  ...
  Node: IXMLNode;
begin
  if Item.Compositors.Count < 1 then
    Show(Item.ElementDefs, ElementTypeFromCompositorType(Item.CompositorType), CompositorId, Context)
  else
  begin
    ...
    begin
      ...
      begin
        Show(Nodes[I] as IXMLElementDef, ElementTypeFromCompositorType(Item.CompositorType),
             CompositorId, Context);
        Processed[I] := True;
      end
      else
        Processed[I] := False;
...
function TXMLSchemaGuide.Show(Item: IXMLElementGroup; Context: XMLVisitorContext): XMLVisitorContext;
begin
  Result := FXMLVisitor.Visit(Item, Context);
  Show(Item.ElementDefs, etElementGroup, 0, Result);
end;
...
function TXMLSchemaGuide.Show(Item: IXMLElementDef; ElementType: TElementType;
                              CompositorId: Integer; Context: XMLVisitorContext): XMLVisitorContext;
begin
  Result := FXMLVisitor.Visit(Item, ElementType, CompositorId, Context);
