...
uses
  System.Classes, Web.HTTPApp, System.Math, Web.AutoDisp, System.Masks, Soap.WebNode, Soap.SOAPHTTPDisp, Soap.SOAPAttachIntf;
...
uses
  System.SysUtils, Soap.InvokeRegistry, Soap.SOAPConst, Soap.SOAPPasInv, Soap.OPConvert,
  Soap.OpConvertOptions, Soap.SOAPAttach, Soap.OPToSOAPDomConv, Soap.WSDLIntf;
...
var
  ...
  begin
    ...
    if Len > MAX_COMP_LEN then
      Len := MAX_COMP_LEN;
    Result := AnsiStrLIComp(PAnsiChar(ContentType),
