...
uses
  System.SysUtils, System.Classes, {Variants, ActiveX,} Soap.IntfInfo, System.TypInfo, Xml.XMLIntf, Xml.XMLDoc, Xml.Xmldom, Xml.XmlSchema,
  Soap.WSDLIntf, Soap.WSDLBind, Xml.XMLSchemaTags, Soap.InvokeRegistry;
...
uses Soap.SOAPConst, Soap.XSBuiltIns;
...
{$ENDIF}
      ...
      begin
{$IF FALSE} // The .NET importer does not like the name attribute
