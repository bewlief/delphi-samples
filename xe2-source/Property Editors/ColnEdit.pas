...
uses
  ...
  DesignWindows, Vcl.StdCtrls, Vcl.Menus, Vcl.ExtCtrls, DesignIntf, Vcl.ComCtrls, Vcl.ImgList,
  Vcl.ActnList, Vcl.ToolWin, ToolWnds, DesignEditors, Vcl.ActnPopup;
      ...
      for I := ListView1.Items.Count - 1 downto 0 do
        ...
        begin
          ...
          if (not Found) and (csAncestor in Component.ComponentState) then
            raise Exception.Create(DesignConst.SCantDeleteAncestor)
          else
