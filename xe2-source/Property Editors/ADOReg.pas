...
{ TProviderProperty }
  ...
  TProviderProperty = class(TDBWideStringProperty)
  public
...
{ TConnectionStringProperty }
  ...
  TConnectionStringProperty = class(TWideStringProperty)
  public
...
{ TCommandTextProperty }
  ...
  TCommandTextProperty = class(TDBWideStringProperty)
  private
...
uses TypInfo, Data.Win.AdoConEd, Consts, WideSqlEdit, Dialogs, DBCommon;
...
procedure TProviderProperty.GetValueList(List: TWideStrings);
begin
...
procedure TCommandTextProperty.GetValueList(List: TWideStrings);
var
  Connection: TADOConnection;
begin
  Connection := GetConnection(True);
