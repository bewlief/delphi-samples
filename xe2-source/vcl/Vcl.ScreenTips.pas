...
uses
  ...
  WinUtils,
  {$ENDIF CLR}
  System.Classes, Vcl.ActnMan, Vcl.ActnList, Winapi.Windows, Vcl.Graphics, Vcl.ExtCtrls, Vcl.AppEvnts, Vcl.Forms,
...
uses
  Vcl.Menus, Vcl.Dialogs, System.Math, Vcl.RibbonConsts, Vcl.GraphUtil, Vcl.ImgList{$IFDEF USE_ZLIB}, System.ZLib{$ENDIF};
...
begin
  ...
  try
    ...
    if not PtInRect(LRect, LPt) then
    begin
