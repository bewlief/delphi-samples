...
uses
  System.Variants, Winapi.Windows, Winapi.Messages, Winapi.ActiveX, System.SysUtils, {$IFDEF LINUX} WinUtils, {$ENDIF}
  ...
  begin
    ...
    if FilterMessage then
      if FSimpleFrameSite.PreMessageFilter(Handle, Msg, WParam, LParam,
        IntPtr(Result), Cookie) = S_FALSE then Exit;
    case Msg of
...
type
  TPWideCharArray = array[0..MaxListSize] of PWideChar;
var
  Size, I: Integer;
  S: WideString;
begin
