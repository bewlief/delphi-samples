...
{ GradientFillCanvas draws a gradient on ACanvas using AStartColor and AEndColor
  in the given Direction. GradientFillCanvas requires Windows 98, 2000 or better.
  On OS' that do not support the Microsoft GradientFill API this function returns without
  changing the canvas. }
...
{$IFDEF USE_ZLIB}
  System.ZLib,
{$ENDIF USE_ZLIB}
  System.UITypes, System.SysUtils, System.Math, Vcl.Consts;
