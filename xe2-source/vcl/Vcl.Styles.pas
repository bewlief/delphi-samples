...
{$HPPEMIT '#pragma link "Vcl.Styles.obj"'}
{$WARN UNSUPPORTED_CONSTRUCT OFF}

uses
  Winapi.Windows, Winapi.Messages, System.Classes, Winapi.CommCtrl,
  System.Generics.Collections, System.ZLib, Vcl.Graphics, Vcl.Controls,
...
uses
  System.UITypes, System.SysUtils, Winapi.UxTheme, Vcl.StdCtrls, Vcl.ComCtrls,
      ...
      case Element of
        ...
        teComboBox:
          begin
            ...
            else if Part = THEME_EP_EDITTEXT then
              EditDraw(kescEdit, LCanvas, EditInfo(R, TSeEditDrawState(State)))
            else
              Result := False;
          end;
