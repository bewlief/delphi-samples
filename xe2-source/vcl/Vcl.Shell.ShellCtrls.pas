...
{                                                       }
{                  Copyright (c) 1995,                  }
{          2001-2011 Embarcadero Technologies Inc.      }
{                                                       }
{*******************************************************}
...
uses
  ...
  Vcl.ComCtrls, Winapi.CommCtrl, Winapi.ShlObj, Winapi.ActiveX, Vcl.StdCtrls, Vcl.ImgList;
...
uses Vcl.Shell.ShellConsts, Winapi.ShellAPI, System.Win.ComObj, System.TypInfo, Vcl.Menus, Vcl.Consts, System.Math;
...
begin
  ...
  begin
    ...
    CopyMemory(Pointer(Integer(Result) + cb1), IDList2, cb2);
  end;
end;
