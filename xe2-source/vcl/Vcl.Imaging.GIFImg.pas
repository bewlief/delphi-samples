...
{$HPPEMIT '#pragma link "Vcl.Imaging.GIFImg.obj"'}
{$HPPEMIT ''}
...
function GDICheck(Value: Integer): Integer; overload;
begin
  if Value = 0 then GDIError;
  Result := Value;
end;

function GDICheck(Value: Cardinal): Cardinal; overload; inline;
begin
  Result := GDICheck(Integer(Value));
end;
