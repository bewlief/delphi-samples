...
//---------------------------------------------------------------------------
{
  ...
  1. Sign up for a free trial account in the AppAnalytics web interface
     (http://appanalytics.embarcadero.com)
  2. Get a new App ID from the AppAnalytics web interface
  3. Copy your App ID into the ApplicationID property of TAppAnalytics1
  4. Build and run the application. Once you activate AppAnalytics,
     your usage will begin to appear in the AppAnalytics web interface
