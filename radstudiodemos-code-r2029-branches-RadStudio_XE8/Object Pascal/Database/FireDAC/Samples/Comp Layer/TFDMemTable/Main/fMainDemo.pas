...
begin
  ...
  OpenDialog1.InitialDir := 'C:\Users\Public\Documents\Embarcadero\Studio\16.0\Samples\Data';
  OpenDialog1.FilterIndex := 2;

  SaveDialog1.DefaultExt := S_FD_RegBinDefExt;
  SaveDialog1.Filter := S_FD_RegFDSFilter;
  SaveDialog1.InitialDir := 'C:\Users\Public\Documents\Embarcadero\Studio\16.0\Samples\Data';
  SaveDialog1.FilterIndex := 2;

  btnGetCustomersClick(nil);
end;
