  ...
  begin
    ...
    begin
      try
        ...
        if (not Terminated) and (Resp <> TetheringEmpty) then
...
function TTetheringBluetoothAdapter.DoCreateCommunicationThread(const AnAdapter: TTetheringAdapter; const ABindToAddress: string): TTetheringManagerCommunicationThread;
begin
  inherited;
