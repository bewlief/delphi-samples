...
uses
  DsnConst, System.Win.Registry, BrandingAPI, IDETheme.Utils;
...
procedure TBindMethodsForm.FormCreate(Sender: TObject);
begin
  if TIDEThemeMetrics.Font.Enabled then
    Font.Assign(TIDEThemeMetrics.Font.GetFont());
  if Themeproperties <> nil then
  begin
    IDEThemeManager.RegisterFormClass(TBindMethodsForm);
