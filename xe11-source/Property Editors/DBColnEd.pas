...
uses
  ...
  Vcl.PlatformDefaultStyleActnCtrls, Vcl.ActnPopup, System.Actions, System.ImageList,
...
{$IFDEF MSWINDOWS}
uses TypInfo, DBGrids, DsnDBCst, Winapi.CommCtrl;
{$ENDIF}
...
procedure TDBGridColumnsEditor.FormAfterMonitorDpiChanged(Sender: TObject;
...
procedure TDBGridColumnsEditor.FormBeforeMonitorDpiChanged(Sender: TObject;
  OldDPI, NewDPI: Integer);
begin
  if ListView1.Columns.Count > 0 then
  begin
