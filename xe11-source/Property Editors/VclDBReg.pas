...
{ TDBGridSelectionEditor }

type
  TCustomDBGridSelectionEditor = class(TSelectionEditor)
  public
    procedure RequiresUnits(Proc: TGetStrProc); override;
  end;

procedure TCustomDBGridSelectionEditor.RequiresUnits(Proc: TGetStrProc);
begin
  Proc('Data.DB');
end;
...
begin
  ...
  RegisterNonActiveX([TDataSource, TCustomDBGrid, TDBNavigator, TDBText,
    ...
    TDBLookupControl, TDBLabeledEdit], axrIncludeDescendants);
  ...
  RegisterSelectionEditor(TCustomDBGrid, TCustomDBGridSelectionEditor);
end;
