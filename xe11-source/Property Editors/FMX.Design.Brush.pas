...
begin
  if not FEditorIsFilling then
  begin
    FEditorIsFilling := True;
    try
      FillGradientTab;
      FillSolidTab;
      FillBitmapTab;
      ...
      FEditorIsFilling := False;
    end;
  end;
end;

procedure TBrushDesigner.Modify;
begin
  if not FEditorIsFilling and (FDesigner <> nil) then
    FDesigner.Modified;
end;
