...
{$IFDEF MSWINDOWS}
  ...
  TClientDataSetPropertyFilter = class(TSelectionEditor, ISelectionPropertyFilter)
  protected
...
{ TClientDataSetPropertyFilter }

procedure TClientDataSetPropertyFilter.FilterProperties(
  const ASelection: IDesignerSelections;
  const ASelectionProperties: IInterfaceList);
const
  sPersistDataPacket = 'PersistDataPacket';
var
  I, J: Integer;
  LProperty: IProperty;
begin
...
{$ENDIF}
  ...
  RegisterSelectionEditor(TCustomClientDataSet, TClientDataSetPropertyFilter);
{$IFDEF MSWINDOWS}
