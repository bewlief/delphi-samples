...
begin
  StoredWidth := ConvertToDefaultPPI(Self, Width);
  StoredHeight := ConvertToDefaultPPI(Self, Height);
  StoredLeft := ConvertToDefaultPPI(Self, Left);
  StoredTop := ConvertToDefaultPPI(Self, Top);
end;
