...
uses
  Registry, LibHelp, DsnConst, ToolsAPI, BrandingAPI;
...
begin
  ...
  begin
    ...
    ExtTextOut(Handle, R.Left + ScaleValue(TIDEThemeMetrics.AlignFactor), R.Top + ScaleValue(1), ETO_CLIPPED or ETO_OPAQUE, @R,
...
begin
  ...
  begin
    IDEThemeManager.RegisterFormClass(TMaskForm);
    ...
    ListBox1.ItemHeight := ScaleValue(TIDEThemeMetrics.VirtualTree.NodeHeight);
  end;
end;
