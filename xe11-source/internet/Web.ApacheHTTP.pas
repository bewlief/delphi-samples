...
function TApacheRequest.GetIntegerVariable(Index: Integer): Int64;
var
  Value: string;
begin
  Value := GetStringVariable(Index);
...
function TApacheResponse.GetIntegerVariable(Index: Integer): Int64;
begin
...
procedure TApacheResponse.SetIntegerVariable(Index: Integer; Value: Int64);
begin
  if (Index >= Low(FIntegerVariables)) and (Index <= High(FIntegerVariables)) then
