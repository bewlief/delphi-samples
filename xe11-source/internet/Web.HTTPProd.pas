...
begin
  if FHTMLFile <> '' then
  begin
    Result := TFileStream.Create(GetProducerTemplateFileName {Qualified name}, fmOpenRead or fmShareDenyWrite);
    AOwned := True;
  end
  else
  begin
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            ParamStr := Trim(Encoding.GetString(BytesOf(SkipToToken('>'))));                  
