...
uses System.Types, System.UITypes, Vcl.Forms, Vcl.Menus, System.Variants, System.Win.ComObj,
  ExDispID, Vcl.Dialogs, Winapi.ShlObj, WBComp, IEConst;
...
begin
  ...
  begin
    ...
    begin
      ...
      SetWindowLongW(FShellDocObjViewHandle, GWL_WNDPROC, NativeInt(FShellDocObjInstance));
    end
    else
    begin
      FDefShellObjViewProc := Pointer(GetWindowLong(FShellDocObjViewHandle, GWL_WNDPROC));
      SetWindowLong(FShellDocObjViewHandle, GWL_WNDPROC, NativeInt(FShellDocObjInstance));
    end;
    ...
    begin
      ...
      SetWindowLongW(FInetExplorerServerHandle, GWL_WNDPROC, NativeInt(FInetExplorerServerInstance));
    end
    else
    begin
      FDefInetExplorerServerProc := Pointer(GetWindowLong(FInetExplorerServerHandle, GWL_WNDPROC));
      SetWindowLong(FInetExplorerServerHandle, GWL_WNDPROC, NativeInt(FInetExplorerServerInstance));
    end;
  end;
end;
