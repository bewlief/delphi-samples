...
type
  ...
  public
    ...
    class procedure add_headers_out(const ARequestRec: PHTTPDRequest; const Key, Value: UTF8String);
...
class procedure THTTPDMethods.add_headers_out(const ARequestRec: PHTTPDRequest;
  const Key, Value: UTF8String);
begin
  CheckRegister;
  GHTTPDImpl.add_headers_out(ARequestRec, Key, Value);
end;
