...
{ TCustomDisplayServices }
  ...
  private
    ...
    function GetLineInfo: ILineInfo;
  ...
  public
    ...
    property LineInfo: ILineInfo read GetLineInfo;
...
uses System.UITypes, Mshtmdid, Vcl.Forms, Vcl.Dialogs, System.Types, System.StrUtils, Vcl.GraphUtil,
  Winapi.Messages, IEConst;
...
function TCustomDisplayServices.GetLineInfo: ILineInfo;
var
  Ptr: IDisplayPointer;
begin
  Result := nil;
