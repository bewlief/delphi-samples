...
var
  ...
  VarR4FromStr: function(const strIn: _POleStr; LCID: Integer; dwFlags: Integer;
    out fltOut: Single): HRESULT; stdcall;
  VarR8FromStr: function(const strIn: _POleStr; LCID: Integer; dwFlags: Integer;
  ...
  VarBstrFromDate: function(dateIn: TDateTime; LCID: Integer; dwFlags: Integer;
    out bstrOut: WideString): HRESULT; stdcall;
...
function SafeArrayGetElemSize(VarArray: PVarArray): Cardinal; stdcall;
    ...
    begin
      ...
      if (V.VType and varByRef) = 0 then
        case V.VType of
          ...
          varWord, varUInt32, varInt64, varUInt64:;
      ...
      begin
        if (Source.VType and varByRef) <> 0 then // var is byref
          ...
          case (Source.VType and varTypeMask) of // strip off modifier flags
            ...
            varError, varBoolean, varShortInt, varByte, varWord, varUInt32, varInt64, varUInt64:
...
begin
  ...
  case (LSource.VType and varTypeMask) of // strip off modifier flags
    ...
    varUInt32:
      Dest.VUInt32 := PCardinal(LSource.VPointer)^;
    varInt64:
      ...
      case LSource.VType of
        ...
        varSmallint:
          case VarType of
            ...
            varUInt32:
              Dest.VUInt32 := LSource.VSmallInt;
            varInt64:
        ...
        varSingle:
          case VarType of
            ...
            varUInt32:
              Dest.VUInt32 := Round(LSource.VSingle);
            varInt64:
        ...
        varDouble:
          case VarType of
            ...
            varUInt32:
              Dest.VUInt32 := Round(LSource.VDouble);
            varInt64:
        ...
        varCurrency:
          case VarType of
            ...
            varUInt32:
              Dest.VUInt32 := Round(LSource.VCurrency);
            varInt64:
        ...
        varDate:
          case VarType of
            ...
            varOleStr:
                VarOleStrFromStr(Dest, DateTimeToOleAutoString(LSource.VDate));
            varBoolean:
            ...
            varUInt32:
              Dest.VUInt32 := Round(LSource.VDate);
            varInt64:
        ...
        varOleStr:
          case VarType of
            ...
            varUInt32:
              Dest.VUInt32 := StrToInt64(string(LSource.VOleStr));
            varInt64:
        ...
        varBoolean:
          case VarType of
            ...
            varUInt32:
              Dest.VUInt32 := Cardinal(LSource.VBoolean);
            varInt64:
        ...
        varVariant:
          case VarType of
            ...
            varUInt32:
              Dest.VUInt32 := PVariant(LSource.VPointer)^;
            varInt64:
        ...
        varUInt32:
          case VarType of
            varEmpty, varNull:;
            varSmallInt:
              Dest.VSmallInt := LSource.VUInt32;
            varInteger:
              Dest.VInteger := LSource.VUInt32;
            varSingle:
              Dest.VSingle := LSource.VUInt32;
            varDouble:
              Dest.VDouble := LSource.VUInt32;
            varCurrency:
              Dest.VCurrency := LSource.VUInt32;
            varDate:
              Dest.VDate := LSource.VUInt32;
            varOleStr:
                                              
              //WideString(Pointer(Dest.VOleStr)) := IntToStr(LSource.VUInt32);
              VarOleStrFromStr(Dest, UIntToStr(LSource.VUInt32));
            varBoolean:
              Dest.VBoolean := LSource.VUInt32 <> 0;
            varShortInt:
              Dest.VShortInt := LSource.VUInt32;
            varByte:
              Dest.VByte := LSource.VUInt32;
            varWord:
              Dest.VWord := LSource.VUInt32;
            varUInt32:
              Dest.VUInt32 := LSource.VUInt32;
            varInt64:
              Dest.VInt64 := LSource.VUInt32;
            varUInt64:
              Dest.VUInt64 := LSource.VUInt32;
          else
            Result := VAR_TYPEMISMATCH;
          end;
        varInt64:
...
function CmpUnimplemented(const Left, Right: TVarData; LCID: Integer; Flags: Cardinal): HRESULT; stdcall;
begin
  Result := VAR_NOTIMPL;
end;
...
function BackupVarI4FromStr(const strIn: _POleStr; LCID: Integer; dwFlags: Integer;
  out iOut: Integer): HRESULT; stdcall;
begin
  if LCID <> VAR_LOCALE_USER_DEFAULT then
    Result := VAR_NOTIMPL
  else
    Result := CResult[TryStrToInt(strIn, iOut)];
end;

function BackupVarR4FromStr(const strIn: _POleStr; LCID: Integer; dwFlags: Integer;
  out fltOut: Single): HRESULT; stdcall;
begin
  if LCID <> VAR_LOCALE_USER_DEFAULT then
    Result := VAR_NOTIMPL
...
function BackupVarR8FromStr(const strIn: _POleStr; LCID: Integer; dwFlags: Integer;
  out dblOut: Double): HRESULT; stdcall;
begin
  if LCID <> VAR_LOCALE_USER_DEFAULT then
    Result := VAR_NOTIMPL
...
function BackupVarDateFromStr(const strIn: _POleStr; LCID: DWORD; dwFlags: Integer;
  out dateOut: TDateTime): HRESULT; stdcall;
begin
  if LCID <> VAR_LOCALE_USER_DEFAULT then
    Result := VAR_NOTIMPL
...
function BackupVarCyFromStr(const strIn: _POleStr; LCID: DWORD; dwFlags: Integer;
  out cyOut: Currency): HRESULT; stdcall;
begin
  if LCID <> VAR_LOCALE_USER_DEFAULT then
    Result := VAR_NOTIMPL
...
function BackupVarBoolFromStr(const strIn: _POleStr; LCID: Integer; dwFlags: Integer;
  out boolOut: WordBool): HRESULT; stdcall;
var
  LBoolean: Boolean;
begin
...
function BackupVarBStrFromCy(cyIn: Currency; LCID: Integer; dwFlags: Integer;
  out bstrOut: WideString): HRESULT; stdcall;
begin
  if LCID <> VAR_LOCALE_USER_DEFAULT then
    Result := VAR_NOTIMPL
...
function BackupVarBStrFromDate(dateIn: TDateTime; LCID: Integer; dwFlags: Integer;
  out bstrOut: WideString): HRESULT; stdcall;
begin
  if LCID <> VAR_LOCALE_USER_DEFAULT then
    Result := VAR_NOTIMPL
  ...
  begin
    bstrOut := DateTimeToOleAutoString(dateIn);
    Result := VAR_OK;
  end;
end;

function BackupVarBStrFromBool(boolIn: WordBool; LCID: Integer; dwFlags: Integer;
  out bstrOut: WideString): HRESULT; stdcall;
begin
  if LCID <> VAR_LOCALE_USER_DEFAULT then
    Result := VAR_NOTIMPL
...
function SafeArrayAllocMem(const Size: Cardinal): Pointer;
begin
...
procedure SafeArrayReallocMem(var Address: Pointer; const OldSize, NewSize: Cardinal);
var
  Temp: Pointer;
  Amount: Cardinal;
begin
  ...
  try //and
    try // again
      ...
      case SafeArrayElementStyle(VarArray) of
        ...
        esOleStr:
          _OleStr(PPointer(Data)^) := PWideString(LAddress)^;
        esVariant:
  ...
  try // and
    try // again
      ...
      case SafeArrayElementStyle(VarArray) of
        ...
        esOleStr:
          _OleStr(PPointer(LAddress)^) := WideString(Data);
        esVariant:
...
function SafeArrayGetElemSize(VarArray: PVarArray): Cardinal;
begin
  Result := 0;
  if SafeArrayValidate(VarArray) = VAR_OK then
