...
{ Access / Audit structures }
  ...
  ACTRL_ACCESS_ENTRY_LISTA = record
    cEntries: ULONG;
  ...
  ACTRL_ACCESS_ENTRY_LISTW = record
    cEntries: ULONG;
...
type
  ...
  _ACTRL_OVERLAPPED = record
    case Integer of
      ...
      1: (Reserved1: ULONG;{$IFDEF WIN64} Padding: ULONG;{$ENDIF} Reserved2: ULONG; hEvent: THandle);
  end;
