...
type
  ...
  _D3DCOLORVALUE = Winapi.DXTypes._D3DCOLORVALUE;
  {$EXTERNALSYM _D3DCOLORVALUE}
  D3DCOLORVALUE = Winapi.DXTypes.D3DCOLORVALUE;
  {$EXTERNALSYM D3DCOLORVALUE}
  TD3DColorValue = Winapi.DXTypes.TD3DColorValue;
  PD3DColorValue = Winapi.DXTypes.PD3DColorValue;

  _D3DRECT = Winapi.DXTypes._D3DRECT;
  {$EXTERNALSYM _D3DRECT}
  D3DRECT = Winapi.DXTypes.D3DRECT;
  {$EXTERNALSYM D3DRECT}
  TD3DRect = Winapi.DXTypes.TD3DRect;
  PD3DRect = Winapi.DXTypes.PD3DRect;

  _D3DMATRIX = Winapi.DXTypes._D3DMATRIX;
  {$EXTERNALSYM _D3DMATRIX}
  D3DMATRIX = Winapi.DXTypes.D3DMATRIX;
  {$EXTERNALSYM D3DMATRIX}
  TD3DMatrix = Winapi.DXTypes.TD3DMatrix;
  PD3DMatrix = Winapi.DXTypes.PD3DMatrix;

  PD3DViewport8 = ^TD3DViewport8;
  _D3DVIEWPORT8 = record
    X: DWord;
...
{$ENDIF}
  ...
  _D3DADAPTER_IDENTIFIER8 = record
