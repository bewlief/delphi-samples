...
uses Winapi.Windows, Winapi.ActiveX, Winapi.DirectShow9;
...
type
  ...
  _DRM_LICENSE_STATE_DATA = record
...
type
  ...
  _WMStreamPrioritizationRecord = record
    wStreamNumber: Word;
    fMandatory   : BOOL;
  end;
...
//
  ...
  _WMT_FILESINK_DATA_UNIT = record
  ...
  _WMT_WEBSTREAM_SAMPLE_HEADER = record
...
type
  ...
  __WMT_VIDEOIMAGE_SAMPLE = record
    dwMagic        : LongWord;
...
type
  ...
  _WMT_TIMECODE_EXTENSION_DATA = record
    wRange     : Word;
    dwTimecode : LongWord;
    dwUserbits : LongWord;
    dwAmFlags  : LongWord;
...
// The reader can be QI'd for this interface for advanced functionality.
  ...
  IWMIndexer2 = interface(IWMIndexer)
    ...
    (*** IWMIndexer2 methods ***)
    function Configure(wStreamNum: Word; nIndexerType: TWMTIndexerType;
