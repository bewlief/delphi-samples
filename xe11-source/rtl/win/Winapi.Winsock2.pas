...
type
{$POINTERMATH ON}
  MarshaledAStringList = ^MarshaledAString; // This type is needed to provide array indexing.
{$POINTERMATH OFF}

  hostent = record
    h_name: MarshaledAString;              // official name of host
    h_aliases: MarshaledAStringList;          // alias list
    h_addrtype: Smallint;           // host address type
    h_length: Smallint;             // length of address
    case Integer of
      0: (h_addr_list: MarshaledAStringList); // list of addresses
      1: (h_addr: MarshaledAStringList);      // address, for backward compat
  end;
  {$EXTERNALSYM hostent}
  THostEnt = hostent;
  PHostEnt = ^hostent;
...
type
  netent = record
    n_name: MarshaledAString;           // official name of net
    n_aliases: MarshaledAStringList;  // alias list
  ...
  servent = record
    s_name: MarshaledAString;           // official service name
    s_aliases: MarshaledAStringList;  // alias list
{$IFDEF WIn64}
    s_proto: MarshaledAString;          // protocol to use
...
{$ENDIF}
  ...
  protoent = record
    p_name: MarshaledAString;           // official protocol name
    p_aliases: MarshaledAStringList;  // alias list
...
{$IFDEF WIN64}
    iMaxSockets: Word;
    iMaxUdpDg: Word;
    lpVendorInfo: MarshaledAString;
    szDescription: array [0..WSADESCRIPTION_LEN] of a_char;
    szSystemStatus: array [0..WSASYS_STATUS_LEN] of a_char;
{$ELSE}
    szDescription: array [0..WSADESCRIPTION_LEN] of a_char;
    szSystemStatus: array [0..WSASYS_STATUS_LEN] of a_char;
    iMaxSockets: Word;
...
type
  _WSABUF = record
    ...
    buf: MarshaledAString;      // the pointer to the buffer
  end;
  {$EXTERNALSYM _WSABUF}
  WSABUF = _WSABUF;
  {$EXTERNALSYM WSABUF}
...
type
  _WSAPROTOCOL_INFOA = record
    ...
    szProtocol: array [0..WSAPROTOCOL_LEN] of a_char;
  end;
...
function inet_pton(af: Integer; src: MarshaledAString; dst: Pointer): Integer; stdcall;
{$EXTERNALSYM inet_pton}
function inet_ntop(af: Integer; src: Pointer; dst: MarshaledAString; size: size_t): MarshaledAString; stdcall;
...
function gethostbyaddr(addr: MarshaledAString; len, type_: Integer): PHostEnt; overload; stdcall;
function gethostbyaddr(var addr; len, type_: Integer): PHostEnt; overload; stdcall;
{$EXTERNALSYM gethostbyaddr}
function gethostbyname(name: MarshaledAString): PHostEnt; stdcall;
{$EXTERNALSYM gethostbyname}
function gethostname(name: MarshaledAString; namelen: Integer): Integer; stdcall;
{$EXTERNALSYM gethostname}
function getservbyport(port: Integer; proto: MarshaledAString): PServEnt; stdcall;
{$EXTERNALSYM getservbyport}
function getservbyname(name, proto: MarshaledAString): PServEnt; stdcall;
{$EXTERNALSYM getservbyname}
function getprotobynumber(number: Integer): PProtoEnt; stdcall;
{$EXTERNALSYM getprotobynumber}
function getprotobyname(name: MarshaledAString): PProtoEnt; stdcall;
...
function WSAAsyncGetServByName(hWnd: HWND; wMsg: u_int; name, proto, buf: MarshaledAString;
...
function WSAAsyncGetServByPort(hWnd: HWND; wMsg: u_int; port: Integer;
  proto, buf: MarshaledAString; buflen: Integer): THandle; stdcall;
{$EXTERNALSYM WSAAsyncGetServByPort}
function WSAAsyncGetProtoByName(hWnd: HWND; wMsg: u_int; name, buf: MarshaledAString;
  buflen: Integer): THandle; stdcall;
{$EXTERNALSYM WSAAsyncGetProtoByName}
function WSAAsyncGetProtoByNumber(hWnd: HWND; wMsg: u_int; number: Integer;
  buf: MarshaledAString; buflen: Integer): THandle; stdcall;
{$EXTERNALSYM WSAAsyncGetProtoByNumber}
function WSAAsyncGetHostByName(hWnd: HWND; wMsg: u_int; name, buf: MarshaledAString;
  buflen: Integer): THandle; stdcall;
{$EXTERNALSYM WSAAsyncGetHostByName}
function WSAAsyncGetHostByAddr(hWnd: HWND; wMsg: u_int; addr: MarshaledAString;
  len, type_: Integer; buf: MarshaledAString; buflen: Integer): THandle; stdcall;
...
function inet_pton; external ws2_32 name 'inet_pton' delayed;
function inet_ntop; external ws2_32 name 'inet_ntop' delayed;
...
function gethostbyaddr(addr: MarshaledAString; len, type_: Integer): PHostEnt; external ws2_32 name 'gethostbyaddr';
function gethostbyaddr(var addr; len, type_: Integer): PHostEnt; external ws2_32 name 'gethostbyaddr';
...
function GetAddrInfoW; external ws2_32 name 'GetAddrInfoW';
procedure FreeAddrInfoW; external ws2_32 name 'FreeAddrInfoW';
