...
const
  ...
  {$EXTERNALSYM DISPID_LOCATIONOBJECT}
  DISPID_LOCATIONOBJECT = -5506;
  {$EXTERNALSYM DISPID_HISTORYOBJECT}
  DISPID_HISTORYOBJECT = -5507;
  {$EXTERNALSYM DISPID_NAVIGATOROBJECT}
  DISPID_NAVIGATOROBJECT = -5508;
  {$EXTERNALSYM DISPID_SECURITYCTX}
  DISPID_SECURITYCTX = -5511;
  {$EXTERNALSYM DISPID_AMBIENT_DLCONTROL}
  DISPID_AMBIENT_DLCONTROL = -5512;
  {$EXTERNALSYM DISPID_AMBIENT_USERAGENT}
  DISPID_AMBIENT_USERAGENT = -5513;
  {$EXTERNALSYM DISPID_SECURITYDOMAIN}
...
{ DllRegisterServer/DllUnregisterServer status codes }
  ...
  SELFREG_E_LAST  = HRESULT($8004020F);
...
{$IFDEF MSWINDOWS}
  ...
  PPOleStr = ^POleStr;
{$ELSE}
  TOleChar = System.Types.TOleChar;
  POleStr = System.Types.POleStr;
  PPOleStr = System.Types.PPOleStr;
{$ENDIF}
...
{$IFDEF MSWINDOWS}
  LargeInt = Int64;
{$ELSE}
  LargeInt = System.Types.LargeInt;
{$ENDIF}
...
{$IFDEF MSWINDOWS}
  LargeUInt = UInt64;
{$ELSE}
  LargeUInt = System.Types.LargeUInt;
{$ENDIF}
...
{$IFDEF MSWINDOWS}
  ...
  TCLSID = TGUID;
{$ELSE}
  PCLSID = System.Types.PCLSID;
  TCLSID = System.Types.TCLSID;
{$ENDIF}
...
{ Registration function types }
  ...
  {$NODEFINE TPointF}
  {$NODEFINE PPointF}
  tagPointF = System.Types.tagPointF;
  {$NODEFINE tagPointF}
...
{$ELSE}
  PStatStg = System.Types.PStatStg;
  TStatStg = System.Types.TStatStg;
  ISequentialStream = System.Types.ISequentialStream;
  IStream = System.Types.IStream;
{$ENDIF}
...
{ IPropertyStorage / IPropertySetStorage }
  ...
  tagPROPVARIANT = record
    ...
    case Integer of
      ...
      VT_STREAM: (pStream: Pointer{IStream});
      VT_VERSIONED_STREAM: (pVersionedStream: Pointer{LPVERSIONEDSTREAM});
      VT_STORAGE: (pStorage: Pointer{IStorage});
      VT_BSTR: (bstrVal: TBStr);
      VT_LPSTR: (pszVal: PAnsiChar);
      VT_LPWSTR: (pwszVal: PWideChar);
      VT_SAFEARRAY: (parray: PSAFEARRAY);
      VT_VECTOR or VT_UI1: (caub: TCAUB);
      VT_VECTOR or VT_I1: (cai: TCAI);
      VT_VECTOR or VT_UI2: (caui: TCAUI);
      VT_VECTOR or VT_BOOL: (cabool: TCABOOL);
      VT_VECTOR or VT_I4: (cal: TCAL);
      VT_VECTOR or VT_UI4: (caul: TCAUL);
      VT_VECTOR or VT_R4: (caflt: TCAFLT);
      VT_VECTOR or VT_ERROR: (cascode: TCASCODE);
      VT_VECTOR or VT_I8: (cah: TCAH);
      VT_VECTOR or VT_UI8: (cauh: TCAUH);
      VT_VECTOR or VT_R8: (cadbl: TCADBL);
      VT_VECTOR or VT_CY: (cacy: TCACY);
      VT_VECTOR or VT_DATE: (cadate: TCADATE);
      VT_VECTOR or VT_FILETIME: (cafiletime: TCAFILETIME);
      VT_VECTOR or VT_CLSID: (cauuid: TCACLSID);
      VT_VECTOR or VT_CF: (caclipdata: TCACLIPDATA);
      VT_VECTOR or VT_BSTR: (cabstr: TCABSTR);
      VT_VECTOR or VT_LPSTR: (calpstr: TCALPSTR);
      VT_VECTOR or VT_LPWSTR: (calpwstr: TCALPWSTR );
      VT_VECTOR or VT_VARIANT: (capropvar: TCAPROPVARIANT);
...
{ The following ActiveDoc interfaces come from DocObj.idl }
  ...
  {$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IOleDocumentView)' }
  ...
  {$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IEnumOleDocumentViews)' }
  ...
  {$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IOleDocument)' }
  ...
  {$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IOleDocumentSite)' }
  ...
  {$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IContinueCallback)' }
...
type
  ...
  {$EXTERNALSYM IPrint}
  {$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IPrint)' }
...
type
  {$NODEFINE IEnumGUID}
  IEnumGUID = interface;
  {$NODEFINE IEnumCATEGORYINFO}
  IEnumCATEGORYINFO = interface;
  {$NODEFINE ICatRegister}
  ICatRegister = interface;
  {$NODEFINE ICatInformation}
  ICatInformation = interface;
  {$NODEFINE PCATEGORYINFO}
...
type
  ...
  {$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IObjectSafety)' }
...
type
  ...
  {$HPPEMIT 'DECLARE_DINTERFACE_TYPE(IDispatchEx)' }
...
const
  ...
  {$EXTERNALSYM fdexPropCanGet}
  fdexPropCanGet              = $1;
  {$EXTERNALSYM fdexPropCannotGet}
  fdexPropCannotGet           = $2;
  {$EXTERNALSYM fdexPropCanPut}
  fdexPropCanPut              = $4;
  {$EXTERNALSYM fdexPropCannotPut}
  fdexPropCannotPut           = $8;
  {$EXTERNALSYM fdexPropCanPutRef}
  fdexPropCanPutRef           = $10;
  {$EXTERNALSYM fdexPropCannotPutRef}
  fdexPropCannotPutRef        = $20;
  {$EXTERNALSYM fdexPropNoSideEffects}
  fdexPropNoSideEffects       = $40;
  {$EXTERNALSYM fdexPropDynamicType}
  fdexPropDynamicType         = $80;
  {$EXTERNALSYM fdexPropCanCall}
  fdexPropCanCall             = $100;
  {$EXTERNALSYM fdexPropCannotCall}
  fdexPropCannotCall          = $200;
  {$EXTERNALSYM fdexPropCanConstruct}
  fdexPropCanConstruct        = $400;
  {$EXTERNALSYM fdexPropCannotConstruct}
  fdexPropCannotConstruct     = $800;
  {$EXTERNALSYM fdexPropCanSourceEvents}
  fdexPropCanSourceEvents     = $1000;
  {$EXTERNALSYM fdexPropCannotSourceEvents}
  fdexPropCannotSourceEvents  = $2000;

  {$EXTERNALSYM fdexPropCanAll}
...
procedure CoFreeUnusedLibrariesEx(dwUnloadDelay, dwReserved: DWORD); stdcall;

{ Call Security. }

{$EXTERNALSYM CoInitializeSecurity}
function CoInitializeSecurity(pSecDesc: Pointer; cAuthSvc: LONG;
  asAuthSvc: PSOleAuthenticationService; pReserved1: Pointer;
  dwAuthnLevel, dImpLevel: DWORD; pAuthList: Pointer; dwCapabilities: DWORD;
...
function CoFileTimeToDosDateTime(const filetime: TFileTime; out dosDate: Word;
  out dosTime: Word): BOOL; inline; overload;
function CoFileTimeToDosDateTime(filetime: PFileTime; out dosDate: Word;
  out dosTime: Word): BOOL; overload; stdcall;
...
{$EXTERNALSYM SafeArrayCreateVectorEx}
function SafeArrayCreateVectorEx(vt: TVarType; LBound, cElements: Longint; pvExta: pointer): PSafeArray; stdcall;
{$EXTERNALSYM SafeArrayCreateEx}
function SafeArrayCreateEx(vt: TVarType; cDims: Integer; rgsabound: PSafeArrayBound; pvExtra: pointer): PSafeArray; stdcall;
...
function DispCallFunc(pvInstance: Pointer; oVft: IntPtr; cc: TCallConv;
...
function PropVariantCopy(out pvarDest: PROPVARIANT; const pvarSrc: PROPVARIANT): HRESULT; stdcall;
function PropVariantClear(var pvar: PROPVARIANT): HRESULT; stdcall;
function FreePropVariantArray(cVariants: ULONG; rgvars: PPROPVARIANT): HRESULT; stdcall;
...
function InitPropVariantFromResource(hinst: HINST; id: UINT; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromResource}
function InitPropVariantFromBuffer(pv: Pointer; cb: UINT; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromBuffer}
function InitPropVariantFromCLSID(const clsid: TCLSID; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromCLSID}
function InitPropVariantFromGUIDAsString(const guid: TGuid; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromGUIDAsString}
function InitPropVariantFromFileTime(pftIn: PFILETIME; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromFileTime}
function InitPropVariantFromPropVariantVectorElem(const propvarIn: PROPVARIANT; iElem: Cardinal; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromPropVariantVectorElem}
function InitPropVariantVectorFromPropVariant(const propvarSingle: PROPVARIANT; out ppropvarVector: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantVectorFromPropVariant}
function InitPropVariantFromStrRet(var pstrret; const pidl; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromStrRet}
function InitPropVariantFromBooleanVector(prgf: PBool; cElems: Cardinal; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromBooleanVector}
function InitPropVariantFromInt16Vector(prgn: PSHORT; cElems: Cardinal; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromInt16Vector}
function InitPropVariantFromUInt16Vector(prgn: PWord; cElems: Cardinal; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromUInt16Vector}
function InitPropVariantFromInt32Vector(prgn: PInteger; cElems: Cardinal; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromInt32Vector}
function InitPropVariantFromUInt32Vector(prgn: PCardinal; cElems: Cardinal; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromUInt32Vector}
function InitPropVariantFromInt64Vector(prgn: PInt64; cElems: Cardinal; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromInt64Vector}
function InitPropVariantFromUInt64Vector(prgn: PULONGLONG; cElems: Cardinal; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromUInt64Vector}
function InitPropVariantFromDoubleVector(prgn: PDouble; cElems: Cardinal; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromDoubleVector}
function InitPropVariantFromFileTimeVector(prgft: PFILETIME; cElems: Cardinal; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromFileTimeVector}
function InitPropVariantFromStringVector(prgsz: PLPWSTR; cElems: Cardinal; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromStringVector}
function InitPropVariantFromStringAsVector(psz: LPCWSTR; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM InitPropVariantFromStringAsVector}

{ Extract data from a propvariant }
function PropVariantToBooleanWithDefault(const propvarIn: PROPVARIANT; fDefault: BOOL): BOOL; stdcall;
{$EXTERNALSYM PropVariantToBooleanWithDefault}
function PropVariantToInt16WithDefault(const propvarIn: PROPVARIANT; iDefault: Smallint): SHORT; stdcall;
{$EXTERNALSYM PropVariantToInt16WithDefault}
function PropVariantToUInt16WithDefault(const propvarIn: PROPVARIANT; uiDefault: USHORT): USHORT; stdcall;
{$EXTERNALSYM PropVariantToUInt16WithDefault}
function PropVariantToInt32WithDefault(const propvarIn: PROPVARIANT; lDefault: Integer): LONG; stdcall;
{$EXTERNALSYM PropVariantToInt32WithDefault}
function PropVariantToUInt32WithDefault(const propvarIn: PROPVARIANT; ulDefault: Cardinal): ULONG; stdcall;
{$EXTERNALSYM PropVariantToUInt32WithDefault}
function PropVariantToInt64WithDefault(const propvarIn: PROPVARIANT; llDefault: LONGLONG): LONGLONG; stdcall;
{$EXTERNALSYM PropVariantToInt64WithDefault}
function PropVariantToUInt64WithDefault(const propvarIn: PROPVARIANT; ullDefault: ULONGLONG): ULONGLONG; stdcall;
{$EXTERNALSYM PropVariantToUInt64WithDefault}
function PropVariantToDoubleWithDefault(const propvarIn: PROPVARIANT; dblDefault: Double): DOUBLE; stdcall;
{$EXTERNALSYM PropVariantToDoubleWithDefault}
function PropVariantToStringWithDefault(const propvarIn: PROPVARIANT; pszDefault: LPCWSTR): LPCWSTR; stdcall;
{$EXTERNALSYM PropVariantToStringWithDefault}

function PropVariantToBoolean(const propvarIn: PROPVARIANT; out pfRet: Bool): HResult; stdcall;
{$EXTERNALSYM PropVariantToBoolean}
function PropVariantToInt16(const propvarIn: PROPVARIANT; out piRet: Short): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt16}
function PropVariantToUInt16(const propvarIn: PROPVARIANT; out puiRet: Word): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt16}
function PropVariantToInt32(const propvarIn: PROPVARIANT; out plRet: LONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt32}
function PropVariantToUInt32(const propvarIn: PROPVARIANT; out pulRet: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt32}
function PropVariantToInt64(const propvarIn: PROPVARIANT; out pllRet: LONGLONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt64}
function PropVariantToUInt64(const propvarIn: PROPVARIANT; out pullRet: ULONGLONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt64}
function PropVariantToDouble(const propvarIn: PROPVARIANT; out pdblRet: Double): HResult; stdcall;
{$EXTERNALSYM PropVariantToDouble}
function PropVariantToBuffer(const propvar: PROPVARIANT; var Buffer; cb: UINT): HResult; stdcall;
{$EXTERNALSYM PropVariantToBuffer}
function PropVariantToString(const propvar: PROPVARIANT; psz: LPWSTR; cch: UINT): HResult; stdcall;
{$EXTERNALSYM PropVariantToString}
function PropVariantToGUID(const propvar: PROPVARIANT; out pguid: TGUID): HResult; stdcall;
{$EXTERNALSYM PropVariantToGUID}
function PropVariantToStringAlloc(const propvar: PROPVARIANT; ppszOut: PLPWSTR): HResult; stdcall;
{$EXTERNALSYM PropVariantToStringAlloc}
function PropVariantToBSTR(const propvar: PROPVARIANT; out pbstrOut: WideString): HResult; stdcall;
{$EXTERNALSYM PropVariantToBSTR}
function PropVariantToStrRet(const propvar: PROPVARIANT; var pstrret): HResult; stdcall;
{$EXTERNALSYM PropVariantToStrRet}
function PropVariantToFileTime(const propvar: PROPVARIANT; pstfOut: PSTIME_FLAGS; out pftOut: FILETIME): HResult; stdcall;
{$EXTERNALSYM PropVariantToFileTime}

{ Returns element count of a VT_VECTOR or VT_ARRAY value; or 1 otherwise }
function PropVariantGetElementCount(const propvar: PROPVARIANT): ULONG; stdcall;
{$EXTERNALSYM PropVariantGetElementCount}

{ Extract data from a propvariant into a vector }
function PropVariantToBooleanVector(const propvar: PROPVARIANT; prgf: PBool; crgf: Cardinal; pcElem: PCardinal): HResult; stdcall;
{$EXTERNALSYM PropVariantToBooleanVector}
function PropVariantToInt16Vector(const propvar: PROPVARIANT; prgn: PSHORT; crgn: Cardinal; pcElem: PCardinal): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt16Vector}
function PropVariantToUInt16Vector(const propvar: PROPVARIANT; prgn: PWord; crgn: Cardinal; pcElem: PCardinal): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt16Vector}
function PropVariantToInt32Vector(const propvar: PROPVARIANT; prgn: PInteger; crgn: Cardinal; pcElem: PCardinal): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt32Vector}
function PropVariantToUInt32Vector(const propvar: PROPVARIANT; prgn: PCardinal; crgn: Cardinal; pcElem: PCardinal): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt32Vector}
function PropVariantToInt64Vector(const propvar: PROPVARIANT; prgn: PInt64; crgn: Cardinal; pcElem: PCardinal): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt64Vector}
function PropVariantToUInt64Vector(const propvar: PROPVARIANT; prgn: PULONGLONG; crgn: Cardinal; pcElem: PCardinal): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt64Vector}
function PropVariantToDoubleVector(const propvar: PROPVARIANT; prgn: PDouble; crgn: Cardinal; pcElem: PCardinal): HResult; stdcall;
{$EXTERNALSYM PropVariantToDoubleVector}
function PropVariantToFileTimeVector(const propvar: PROPVARIANT; prgft: PFILETIME; crgft: Cardinal; pcElem: PCardinal): HResult; stdcall;
{$EXTERNALSYM PropVariantToFileTimeVector}
function PropVariantToStringVector(const propvar: PROPVARIANT; prgsz: PLPWSTR; crgsz: Cardinal; pcElem: PCardinal): HResult; stdcall;
...
function PropVariantToBooleanVectorAlloc(const propvar: PROPVARIANT; out pprgf: PBOOL; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToBooleanVectorAlloc}
function PropVariantToInt16VectorAlloc(const propvar: PROPVARIANT; out pprgn: PSHORT; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt16VectorAlloc}
function PropVariantToUInt16VectorAlloc(const propvar: PROPVARIANT; out pprgn: PWord; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt16VectorAlloc}
function PropVariantToInt32VectorAlloc(const propvar: PROPVARIANT; out pprgn: PInteger; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt32VectorAlloc}
function PropVariantToUInt32VectorAlloc(const propvar: PROPVARIANT; out pprgn: PDWORD; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt32VectorAlloc}
function PropVariantToInt64VectorAlloc(const propvar: PROPVARIANT; out pprgn: PInt64; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToInt64VectorAlloc}
function PropVariantToUInt64VectorAlloc(const propvar: PROPVARIANT; out pprgn: PULONGLONG; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToUInt64VectorAlloc}
function PropVariantToDoubleVectorAlloc(const propvar: PROPVARIANT; out pprgn: PDouble; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToDoubleVectorAlloc}
function PropVariantToFileTimeVectorAlloc(const propvar: PROPVARIANT; out pprgn: PFILETIME; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM PropVariantToFileTimeVectorAlloc}
function PropVariantToStringVectorAlloc(const propvar: PROPVARIANT; out pprgn: PPChar; out pcElem: ULONG): HResult; stdcall;
...
function PropVariantGetBooleanElem(const propvar: PROPVARIANT; iElem: Cardinal; out pfVal: Bool): HResult; stdcall;
{$EXTERNALSYM PropVariantGetBooleanElem}
function PropVariantGetInt16Elem(const propvar: PROPVARIANT; iElem: Cardinal; out pnVal: SHORT): HResult; stdcall;
{$EXTERNALSYM PropVariantGetInt16Elem}
function PropVariantGetUInt16Elem(const propvar: PROPVARIANT; iElem: Cardinal; out pnVal: Word): HResult; stdcall;
{$EXTERNALSYM PropVariantGetUInt16Elem}
function PropVariantGetInt32Elem(const propvar: PROPVARIANT; iElem: Cardinal; out pnVal: Integer): HResult; stdcall;
{$EXTERNALSYM PropVariantGetInt32Elem}
function PropVariantGetUInt32Elem(const propvar: PROPVARIANT; iElem: Cardinal; out pnVal: Cardinal): HResult; stdcall;
{$EXTERNALSYM PropVariantGetUInt32Elem}
function PropVariantGetInt64Elem(const propvar: PROPVARIANT; iElem: Cardinal; out pnVal: LONGLONG): HResult; stdcall;
{$EXTERNALSYM PropVariantGetInt64Elem}
function PropVariantGetUInt64Elem(const propvar: PROPVARIANT; iElem: Cardinal; out pnVal: ULONGLONG): HResult; stdcall;
{$EXTERNALSYM PropVariantGetUInt64Elem}
function PropVariantGetDoubleElem(const propvar: PROPVARIANT; iElem: Cardinal; out pnVal: Double): HResult; stdcall;
{$EXTERNALSYM PropVariantGetDoubleElem}
function PropVariantGetFileTimeElem(const propvar: PROPVARIANT; iElem: Cardinal; out pftVal: FILETIME): HResult; stdcall;
{$EXTERNALSYM PropVariantGetFileTimeElem}
function PropVariantGetStringElem(const propvar: PROPVARIANT; iElem: Cardinal; out ppszVal: LPWSTR): HResult; stdcall;
{$EXTERNALSYM PropVariantGetStringElem}

{ Helpers }
procedure ClearPropVariantArray(var rgPropVar: PROPVARIANT; cVars: UINT); stdcall;
{$EXTERNALSYM ClearPropVariantArray}

type
  PROPVAR_COMPARE_UNIT = type Integer;
  {$EXTERNALSYM PROPVAR_COMPARE_UNIT}
const
  PVCU_DEFAULT = 0;
  {$EXTERNALSYM PVCU_DEFAULT}
  PVCU_SECOND  = 1;
...
{ Comparisons }
function PropVariantCompareEx(const propvar1: PROPVARIANT; const propvar2: PROPVARIANT; _unit: PROPVAR_COMPARE_UNIT; flags: PROPVAR_COMPARE_FLAGS): Integer; stdcall;
...
function InitVariantFromResource(hinst: HINST; id: UINT; out pvar: OleVariant): HResult; stdcall;
...
function InitVariantFromGUIDAsString(const guid: TGuid; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromGUIDAsString}
function InitVariantFromFileTime(pft: PFILETIME; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromFileTime}
function InitVariantFromFileTimeArray(prgft: PFILETIME; cElems: Cardinal; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromFileTimeArray}
function InitVariantFromStrRet(const pstrret; const pidl; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromStrRet}
function InitVariantFromVariantArrayElem(const varIn: OleVariant; iElem: Cardinal; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromVariantArrayElem}
function InitVariantFromBooleanArray(prgf: PBool; cElems: Cardinal; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromBooleanArray}
function InitVariantFromInt16Array(prgn: PSHORT; cElems: Cardinal; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromInt16Array}
function InitVariantFromUInt16Array(prgn: PWord; cElems: Cardinal; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromUInt16Array}
function InitVariantFromInt32Array(prgn: PInteger; cElems: Cardinal; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromInt32Array}
function InitVariantFromUInt32Array(prgn: PCardinal; cElems: Cardinal; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromUInt32Array}
function InitVariantFromInt64Array(prgn: PInt64; cElems: Cardinal; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromInt64Array}
function InitVariantFromUInt64Array(prgn: PULONGLONG; cElems: Cardinal; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromUInt64Array}
function InitVariantFromDoubleArray(prgn: PDouble; cElems: Cardinal; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromDoubleArray}
function InitVariantFromStringArray(prgsz: PLPWSTR; cElems: Cardinal; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM InitVariantFromStringArray}

{ Extract data from a VARIANT }
function VariantToBooleanWithDefault(const varIn: OleVariant; fDefault: BOOL): BOOL; stdcall;
{$EXTERNALSYM VariantToBooleanWithDefault}
function VariantToInt16WithDefault(const varIn: OleVariant; iDefault: Shortint): SHORT; stdcall;
{$EXTERNALSYM VariantToInt16WithDefault}
function VariantToUInt16WithDefault(const varIn: OleVariant; uiDefault: USHORT): USHORT; stdcall;
{$EXTERNALSYM VariantToUInt16WithDefault}
function VariantToInt32WithDefault(const varIn: OleVariant; lDefault: Integer): LONG; stdcall;
{$EXTERNALSYM VariantToInt32WithDefault}
function VariantToUInt32WithDefault(const varIn: OleVariant; ulDefault: Cardinal): ULONG; stdcall;
{$EXTERNALSYM VariantToUInt32WithDefault}
function VariantToInt64WithDefault(const varIn: OleVariant; llDefault: LONGLONG): LONGLONG; stdcall;
{$EXTERNALSYM VariantToInt64WithDefault}
function VariantToUInt64WithDefault(const varIn: OleVariant; ullDefault: ULONGLONG): ULONGLONG; stdcall;
{$EXTERNALSYM VariantToUInt64WithDefault}
function VariantToDoubleWithDefault(const varIn: OleVariant; dblDefault: Double): DOUBLE; stdcall;
{$EXTERNALSYM VariantToDoubleWithDefault}
function VariantToStringWithDefault(const varIn: OleVariant; pszDefault: LPCWSTR): LPCWSTR; stdcall;
{$EXTERNALSYM VariantToStringWithDefault}

function VariantToBoolean(const varIn: OleVariant; out pfRet: Bool): HResult; stdcall;
{$EXTERNALSYM VariantToBoolean}
function VariantToInt16(const varIn: OleVariant; out piRet: Shortint): HResult; stdcall;
{$EXTERNALSYM VariantToInt16}
function VariantToUInt16(const varIn: OleVariant; out puiRet: USHORT): HResult; stdcall;
{$EXTERNALSYM VariantToUInt16}
function VariantToInt32(const varIn: OleVariant; out plRet: Integer): HResult; stdcall;
{$EXTERNALSYM VariantToInt32}
function VariantToUInt32(const varIn: OleVariant; out pulRet: Cardinal): HResult; stdcall;
{$EXTERNALSYM VariantToUInt32}
function VariantToInt64(const varIn: OleVariant; out pllRet: LONGLONG): HResult; stdcall;
{$EXTERNALSYM VariantToInt64}
function VariantToUInt64(const varIn: OleVariant; out pullRet: ULONGLONG): HResult; stdcall;
{$EXTERNALSYM VariantToUInt64}
function VariantToDouble(const varIn: OleVariant; out pdblRet: Double): HResult; stdcall;
{$EXTERNALSYM VariantToDouble}
function VariantToBuffer(const varIn: OleVariant; var Buffer; out cb: UINT): HResult; stdcall;
{$EXTERNALSYM VariantToBuffer}
function VariantToGUID(const varIn: OleVariant; out pguid: TGUID): HResult; stdcall;
{$EXTERNALSYM VariantToGUID}
function VariantToString(const varIn: OleVariant; pszBuf: LPWSTR; cchBuf: UINT): HResult; stdcall;
{$EXTERNALSYM VariantToString}
function VariantToStringAlloc(const varIn: OleVariant; out ppszBuf: LPWSTR): HResult; stdcall;
{$EXTERNALSYM VariantToStringAlloc}
function VariantToDosDateTime(const varIn: OleVariant; out pwDate: Word; out pwTime: Word): HResult; stdcall;
{$EXTERNALSYM VariantToDosDateTime}
function VariantToStrRet(const varIn: OleVariant; var pstrret): HResult; stdcall;
{$EXTERNALSYM VariantToStrRet}
function VariantToFileTime(const varIn: OleVariant; stfOut: PSTIME_FLAGS; out pftOut: FILETIME): HResult; stdcall;
...
function VariantGetElementCount(const varIn: OleVariant): ULONG; stdcall;
{$EXTERNALSYM VariantGetElementCount}

{ Extract data from a VARIANT into a vector }
function VariantToBooleanArray(const _var: OleVariant; prgf: PBool; crgn: Cardinal; out pcElem: Cardinal): HResult; stdcall;
{$EXTERNALSYM VariantToBooleanArray}
function VariantToInt16Array(const _var: OleVariant; prgn: PSHORT; crgn: Cardinal; out pcElem: Cardinal): HResult; stdcall;
{$EXTERNALSYM VariantToInt16Array}
function VariantToUInt16Array(const _var: OleVariant; prgn: PWord; crgn: Cardinal; out pcElem: Cardinal): HResult; stdcall;
{$EXTERNALSYM VariantToUInt16Array}
function VariantToInt32Array(const _var: OleVariant; prgn: PInteger; crgn: Cardinal; out pcElem: Cardinal): HResult; stdcall;
{$EXTERNALSYM VariantToInt32Array}
function VariantToUInt32Array(const _var: OleVariant; prgn: PCardinal; crgn: Cardinal; out pcElem: Cardinal): HResult; stdcall;
{$EXTERNALSYM VariantToUInt32Array}
function VariantToInt64Array(const _var: OleVariant; prgn: PInt64; crgn: Cardinal; out pcElem: Cardinal): HResult; stdcall;
{$EXTERNALSYM VariantToInt64Array}
function VariantToUInt64Array(const _var: OleVariant; prgn: PULONGLONG; crgn: Cardinal; out pcElem: Cardinal): HResult; stdcall;
{$EXTERNALSYM VariantToUInt64Array}
function VariantToDoubleArray(const _var: OleVariant; prgn: PDouble; crgn: Cardinal; out pcElem: Cardinal): HResult; stdcall;
{$EXTERNALSYM VariantToDoubleArray}
function VariantToStringArray(const _var: OleVariant; prgsz: PLPWSTR; crgsz: Cardinal; out pcElem: Cardinal): HResult; stdcall;
{$EXTERNALSYM VariantToStringArray}

{ Extract data from a VARIANT into a newly allocated vector (free with CoTaskMemFree) }
function VariantToBooleanArrayAlloc(const _var: OleVariant; out pprgf: PBOOL; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM VariantToBooleanArrayAlloc}
function VariantToInt16ArrayAlloc(const _var: OleVariant; out pprgn: PSHORT; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM VariantToInt16ArrayAlloc}
function VariantToUInt16ArrayAlloc(const _var: OleVariant; out pprgn: PWord; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM VariantToUInt16ArrayAlloc}
function VariantToInt32ArrayAlloc(const _var: OleVariant; out pprgn: PInteger; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM VariantToInt32ArrayAlloc}
function VariantToUInt32ArrayAlloc(const _var: OleVariant; out pprgn: PDWORD; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM VariantToUInt32ArrayAlloc}
function VariantToInt64ArrayAlloc(const _var: OleVariant; out pprgn: PInt64; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM VariantToInt64ArrayAlloc}
function VariantToUInt64ArrayAlloc(const _var: OleVariant; out pprgn: PULONGLONG; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM VariantToUInt64ArrayAlloc}
function VariantToDoubleArrayAlloc(const _var: OleVariant; out pprgn: PDouble; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM VariantToDoubleArrayAlloc}
function VariantToStringArrayAlloc(const _var: OleVariant; out pprgn: PPChar; out pcElem: ULONG): HResult; stdcall;
{$EXTERNALSYM VariantToStringArrayAlloc}
...
function VariantGetBooleanElem(const _var: OleVariant; iElem: Cardinal; out pfVal: Bool): HResult; stdcall;
{$EXTERNALSYM VariantGetBooleanElem}
function VariantGetInt16Elem(const _var: OleVariant; iElem: Cardinal; out pnVal: Shortint): HResult; stdcall;
{$EXTERNALSYM VariantGetInt16Elem}
function VariantGetUInt16Elem(const _var: OleVariant; iElem: Cardinal; out pnVal: USHORT): HResult; stdcall;
{$EXTERNALSYM VariantGetUInt16Elem}
function VariantGetInt32Elem(const _var: OleVariant; iElem: Cardinal; out pnVal: Integer): HResult; stdcall;
{$EXTERNALSYM VariantGetInt32Elem}
function VariantGetUInt32Elem(const _var: OleVariant; iElem: Cardinal; out pnVal: Cardinal): HResult; stdcall;
{$EXTERNALSYM VariantGetUInt32Elem}
function VariantGetInt64Elem(const _var: OleVariant; iElem: Cardinal; out pnVal: LONGLONG): HResult; stdcall;
{$EXTERNALSYM VariantGetInt64Elem}
function VariantGetUInt64Elem(const _var: OleVariant; iElem: Cardinal; out pnVal: ULONGLONG): HResult; stdcall;
{$EXTERNALSYM VariantGetUInt64Elem}
function VariantGetDoubleElem(const _var: OleVariant; iElem: Cardinal; out pnVal: Double): HResult; stdcall;
{$EXTERNALSYM VariantGetDoubleElem}
function VariantGetStringElem(const _var: OleVariant; iElem: Cardinal; out ppszVal: LPWSTR): HResult; stdcall;
{$EXTERNALSYM VariantGetStringElem}

{ Helpers }
procedure ClearVariantArray(var pvars: OleVariant; cvars: UINT); stdcall;
{$EXTERNALSYM ClearVariantArray}
function VariantCompare(const var1: OleVariant; const var2: OleVariant): Integer; stdcall;
...
type
  ...
  {$EXTERNALSYM PROPVAR_CHANGE_FLAGS}

{ Coersions }
function PropVariantChangeType(var ppropvarDest: PROPVARIANT; const propvarSrc: PROPVARIANT; flags: PROPVAR_CHANGE_FLAGS; vt: TVARTYPE): HResult; stdcall;
{$EXTERNALSYM PropVariantChangeType}

{ Conversions }
function PropVariantToVariant(const ppropvar: PROPVARIANT; out pvar: OleVariant): HResult; stdcall;
{$EXTERNALSYM PropVariantToVariant}
function VariantToPropVariant(const pvar: OleVariant; out ppropvar: PROPVARIANT): HResult; stdcall;
{$EXTERNALSYM VariantToPropVariant}

type
  PSERIALIZEDPROPERTYVALUE = ^tagSERIALIZEDPROPERTYVALUE;
  {$EXTERNALSYM PSERIALIZEDPROPERTYVALUE}
...
{ Stg functions }
function StgSerializePropVariant(const ppropvar : PROPVARIANT; out ppProp: PSERIALIZEDPROPERTYVALUE; out pcb : ULONG): HResult; stdcall;
{$EXTERNALSYM StgSerializePropVariant}

function StgDeserializePropVariant(var pprop : SERIALIZEDPROPERTYVALUE; cbMax : Cardinal; out ppropvar : PROPVARIANT): HResult; stdcall;
...
function InitPropVariantFromBoolean(fVal: BOOL; out ppropvar: PROPVARIANT): HRESULT; inline;
function InitPropVariantFromInt16(nVal: SHORT; out ppropvar: PROPVARIANT): HRESULT; inline;
function InitPropVariantFromUInt16(uiVal: USHORT; out ppropvar: PROPVARIANT): HRESULT; inline;
function InitPropVariantFromInt32(lVal: Integer; out ppropvar: PROPVARIANT): HRESULT; inline;
function InitPropVariantFromUInt32(ulVal: Cardinal; out ppropvar: PROPVARIANT): HRESULT; inline;
function InitPropVariantFromInt64(llVal: LONGLONG; out ppropvar: PROPVARIANT): HRESULT; inline;
function InitPropVariantFromUInt64(ullVal: ULONGLONG; out ppropvar: PROPVARIANT): HRESULT; inline;
function InitPropVariantFromDouble(dblVal: Double; out ppropvar: PROPVARIANT): HRESULT; inline;
{ Creates a VT_LPWSTR propvariant. }
function InitPropVariantFromString(psz: LPCWSTR; out ppropvar: PROPVARIANT): HRESULT; inline;
{ Creates a VT_VECTOR | VT_UI1 propvariant. }
function InitPropVariantFromGUIDAsBuffer(const guid: TGuid; out ppropvar: PROPVARIANT): HRESULT; inline;
function IsPropVariantVector(const propvar: PROPVARIANT): BOOL;
{ If TRUE, propvar contains a unicode string.  Use PropVariantToStringWithDefault(propvar, NULL) to retrieve it. }
function IsPropVariantString(const propvar: PROPVARIANT): BOOL;
function PropVariantToCLSID(const propvarIn: PROPVARIANT; out pclsid: TCLSID): HRESULT; inline;
function PropVariantCompare(const propvar1: PROPVARIANT; const propvar2: PROPVARIANT): Integer;
function PropVariantGetElem(const propvarIn: PROPVARIANT; iElem: Cardinal; out ppropvar: PROPVARIANT): HRESULT; inline;
function InitVariantFromBoolean(fVal: BOOL; out pvar: OleVariant): HRESULT; inline;
function InitVariantFromInt16(iVal: Smallint; out pvar: OleVariant): HRESULT; inline;
function InitVariantFromUInt16(uiVal: USHORT; out pvar: OleVariant): HRESULT; inline;
function InitVariantFromInt32(lVal: Integer; out pvar: OleVariant): HRESULT; inline;
function InitVariantFromUInt32(ulVal: Cardinal; out pvar: OleVariant): HRESULT; inline;
function InitVariantFromInt64(llVal: LONGLONG; out pvar: OleVariant): HRESULT; inline;
function InitVariantFromUInt64(ullVal: ULONGLONG; out pvar: OleVariant): HRESULT; inline;
function InitVariantFromDouble(dblVal: Double; out pvar: OleVariant): HRESULT; inline;
function InitVariantFromString(psz: LPCWSTR; out pvar: OleVariant): HRESULT; inline;
function InitVariantFromDispatch(const pdisp: IDispatch; out pvar: OleVariant): HRESULT; inline;
{ Creates a VT_DATE variant }
function InitVariantFromDosDateTime(wDate: Word; wTime: Word; out pvar: OleVariant): HRESULT; inline;
function IsVarTypeFloat(vt: TVARTYPE): Boolean; inline;
function IsVariantArray(const _var: OleVariant): Boolean;
{ if TRUE, you can use VariantToStringCast to obtain the string pointer }
function IsVariantString(const _var: OleVariant): Boolean; inline;
function IsVarTypeNumber(vt: TVARTYPE): Boolean; inline;
function IsVarTypeSignedInteger(vt: TVARTYPE): Boolean; inline;
function IsVarTypeUnsignedInteger(vt: TVARTYPE): Boolean; inline;
function IsVarTypeInteger(vt: TVARTYPE): Boolean; inline;
{ Creates a VT_ARRAY | VT_UI1 variant. }
function InitVariantFromGUIDAsBuffer(const guid: TGuid; out pvar: OleVariant): HRESULT; inline;
function VariantGetElem(const varIn: OleVariant; iElem: Cardinal; out pvar: OleVariant): HRESULT; inline;
// declare here to allow inlining of InitPropVariantFromString from above
function _SHStrDupW(psz: PWideChar; out ppwsz: PWideChar): HRESULT; stdcall;
...
procedure CoFreeUnusedLibrariesEx;      external ole32 name 'CoFreeUnusedLibrariesEx';
...
function CoFileTimeToDosDateTime(filetime: PFileTime; out dosDate: Word;
  out dosTime: Word): BOOL;             external ole32 name 'CoFileTimeToDosDateTime';
function CoFileTimeToDosDateTime(const filetime: TFileTime; out dosDate: Word;
  out dosTime: Word): BOOL;
begin
  Result := CoFileTimeToDosDateTime(@filetime, dosDate, dosTime);
end;
...
function OleLoadPicturePath;            external oleaut32 name 'OleLoadPicturePath';
function OleLoadPictureFile;            external oleaut32 name 'OleLoadPictureFile';
function OleSavePictureFile;            external oleaut32 name 'OleSavePictureFile';

{ Externals from olepro32.dll  - also exported by oleaut32.dll}

{$IFDEF WIN64}
function OleCreatePropertyFrame;        external oleaut32 name 'OleCreatePropertyFrame';
function OleCreatePropertyFrameIndirect; external oleaut32 name 'OleCreatePropertyFrameIndirect';
function OleTranslateColor;             external oleaut32 name 'OleTranslateColor';
function OleCreateFontIndirect;         external oleaut32 name 'OleCreateFontIndirect';
function OleCreatePictureIndirect;      external oleaut32 name 'OleCreatePictureIndirect';
function OleLoadPicture;                external oleaut32 name 'OleLoadPicture';
function OleIconToCursor;               external oleaut32 name 'OleIconToCursor';
{$ELSE}
...
class operator _tagpropertykey.Equal(const Left, Right: _tagpropertykey): Boolean;
begin
  Result := IsEqualPropertyKey(Left, Right);
end;

class operator _tagpropertykey.NotEqual(const Left, Right: _tagpropertykey): Boolean;
begin
  Result := not (Left = Right);
end;

function PropVariantCopy; external ole32 name 'PropVariantCopy' delayed;
{$EXTERNALSYM PropVariantCopy}
function PropVariantClear; external ole32 name 'PropVariantClear' delayed;
{$EXTERNALSYM PropVariantClear}
function FreePropVariantArray; external ole32 name 'FreePropVariantArray' delayed;
...
procedure ClearPropVariantArray; external propsys name 'ClearPropVariantArray' delayed;
procedure ClearVariantArray; external propsys name 'ClearVariantArray' delayed;
function InitPropVariantFromBooleanVector; external propsys name 'InitPropVariantFromBooleanVector' delayed;
function InitPropVariantFromBuffer; external propsys name 'InitPropVariantFromBuffer' delayed;
function InitPropVariantFromCLSID; external propsys name 'InitPropVariantFromCLSID' delayed;
function InitPropVariantFromDoubleVector; external propsys name 'InitPropVariantFromDoubleVector' delayed;
function InitPropVariantFromFileTime; external propsys name 'InitPropVariantFromFileTime' delayed;
function InitPropVariantFromFileTimeVector; external propsys name 'InitPropVariantFromFileTimeVector' delayed;
function InitPropVariantFromGUIDAsString; external propsys name 'InitPropVariantFromGUIDAsString' delayed;
function InitPropVariantFromInt16Vector; external propsys name 'InitPropVariantFromInt16Vector' delayed;
function InitPropVariantFromInt32Vector; external propsys name 'InitPropVariantFromInt32Vector' delayed;
function InitPropVariantFromInt64Vector; external propsys name 'InitPropVariantFromInt64Vector' delayed;
function InitPropVariantFromPropVariantVectorElem; external propsys name 'InitPropVariantFromPropVariantVectorElem' delayed;
function InitPropVariantFromResource; external propsys name 'InitPropVariantFromResource' delayed;
function InitPropVariantFromStringAsVector; external propsys name 'InitPropVariantFromStringAsVector' delayed;
function InitPropVariantFromStringVector; external propsys name 'InitPropVariantFromStringVector' delayed;
function InitPropVariantFromStrRet; external propsys name 'InitPropVariantFromStrRet' delayed;
function InitPropVariantFromUInt16Vector; external propsys name 'InitPropVariantFromUInt16Vector' delayed;
function InitPropVariantFromUInt32Vector; external propsys name 'InitPropVariantFromUInt32Vector' delayed;
function InitPropVariantFromUInt64Vector; external propsys name 'InitPropVariantFromUInt64Vector' delayed;
function InitPropVariantVectorFromPropVariant; external propsys name 'InitPropVariantVectorFromPropVariant' delayed;
function InitVariantFromBooleanArray; external propsys name 'InitVariantFromBooleanArray' delayed;
function InitVariantFromBuffer; external propsys name 'InitVariantFromBuffer' delayed;
function InitVariantFromDoubleArray; external propsys name 'InitVariantFromDoubleArray' delayed;
function InitVariantFromFileTime; external propsys name 'InitVariantFromFileTime' delayed;
function InitVariantFromFileTimeArray; external propsys name 'InitVariantFromFileTimeArray' delayed;
function InitVariantFromGUIDAsString; external propsys name 'InitVariantFromGUIDAsString' delayed;
function InitVariantFromInt16Array; external propsys name 'InitVariantFromInt16Array' delayed;
function InitVariantFromInt32Array; external propsys name 'InitVariantFromInt32Array' delayed;
function InitVariantFromInt64Array; external propsys name 'InitVariantFromInt64Array' delayed;
function InitVariantFromResource; external propsys name 'InitVariantFromResource' delayed;
function InitVariantFromStringArray; external propsys name 'InitVariantFromStringArray' delayed;
function InitVariantFromStrRet; external propsys name 'InitVariantFromStrRet' delayed;
function InitVariantFromUInt16Array; external propsys name 'InitVariantFromUInt16Array' delayed;
function InitVariantFromUInt32Array; external propsys name 'InitVariantFromUInt32Array' delayed;
function InitVariantFromUInt64Array; external propsys name 'InitVariantFromUInt64Array' delayed;
function InitVariantFromVariantArrayElem; external propsys name 'InitVariantFromVariantArrayElem' delayed;
function PropVariantChangeType; external propsys name 'PropVariantChangeType' delayed;
function PropVariantCompareEx; external propsys name 'PropVariantCompareEx' delayed;
function PropVariantGetBooleanElem; external propsys name 'PropVariantGetBooleanElem' delayed;
function PropVariantGetDoubleElem; external propsys name 'PropVariantGetDoubleElem' delayed;
function PropVariantGetElementCount; external propsys name 'PropVariantGetElementCount' delayed;
function PropVariantGetFileTimeElem; external propsys name 'PropVariantGetFileTimeElem' delayed;
function PropVariantGetInt16Elem; external propsys name 'PropVariantGetInt16Elem' delayed;
function PropVariantGetInt32Elem; external propsys name 'PropVariantGetInt32Elem' delayed;
function PropVariantGetInt64Elem; external propsys name 'PropVariantGetInt64Elem' delayed;
function PropVariantGetStringElem; external propsys name 'PropVariantGetStringElem' delayed;
function PropVariantGetUInt16Elem; external propsys name 'PropVariantGetUInt16Elem' delayed;
function PropVariantGetUInt32Elem; external propsys name 'PropVariantGetUInt32Elem' delayed;
function PropVariantGetUInt64Elem; external propsys name 'PropVariantGetUInt64Elem' delayed;
function PropVariantToBoolean; external propsys name 'PropVariantToBoolean' delayed;
function PropVariantToBooleanVector; external propsys name 'PropVariantToBooleanVector' delayed;
function PropVariantToBooleanVectorAlloc; external propsys name 'PropVariantToBooleanVectorAlloc' delayed;
function PropVariantToBooleanWithDefault; external propsys name 'PropVariantToBooleanWithDefault' delayed;
function PropVariantToBSTR; external propsys name 'PropVariantToBSTR' delayed;
function PropVariantToBuffer; external propsys name 'PropVariantToBuffer' delayed;
function PropVariantToDouble; external propsys name 'PropVariantToDouble' delayed;
function PropVariantToDoubleVector; external propsys name 'PropVariantToDoubleVector' delayed;
function PropVariantToDoubleVectorAlloc; external propsys name 'PropVariantToDoubleVectorAlloc' delayed;
function PropVariantToDoubleWithDefault; external propsys name 'PropVariantToDoubleWithDefault' delayed;
function PropVariantToFileTime; external propsys name 'PropVariantToFileTime' delayed;
function PropVariantToFileTimeVector; external propsys name 'PropVariantToFileTimeVector' delayed;
function PropVariantToFileTimeVectorAlloc; external propsys name 'PropVariantToFileTimeVectorAlloc' delayed;
function PropVariantToGUID; external propsys name 'PropVariantToGUID' delayed;
function PropVariantToInt16; external propsys name 'PropVariantToInt16' delayed;
function PropVariantToInt16Vector; external propsys name 'PropVariantToInt16Vector' delayed;
function PropVariantToInt16VectorAlloc; external propsys name 'PropVariantToInt16VectorAlloc' delayed;
function PropVariantToInt16WithDefault; external propsys name 'PropVariantToInt16WithDefault' delayed;
function PropVariantToInt32; external propsys name 'PropVariantToInt32' delayed;
function PropVariantToInt32Vector; external propsys name 'PropVariantToInt32Vector' delayed;
function PropVariantToInt32VectorAlloc; external propsys name 'PropVariantToInt32VectorAlloc' delayed;
function PropVariantToInt32WithDefault; external propsys name 'PropVariantToInt32WithDefault' delayed;
function PropVariantToInt64; external propsys name 'PropVariantToInt64' delayed;
function PropVariantToInt64Vector; external propsys name 'PropVariantToInt64Vector' delayed;
function PropVariantToInt64VectorAlloc; external propsys name 'PropVariantToInt64VectorAlloc' delayed;
function PropVariantToInt64WithDefault; external propsys name 'PropVariantToInt64WithDefault' delayed;
function PropVariantToString; external propsys name 'PropVariantToString' delayed;
function PropVariantToStringAlloc; external propsys name 'PropVariantToStringAlloc' delayed;
function PropVariantToStringVector; external propsys name 'PropVariantToStringVector' delayed;
function PropVariantToStringVectorAlloc; external propsys name 'PropVariantToStringVectorAlloc' delayed;
function PropVariantToStringWithDefault; external propsys name 'PropVariantToStringWithDefault' delayed;
function PropVariantToStrRet; external propsys name 'PropVariantToStrRet' delayed;
function PropVariantToUInt16; external propsys name 'PropVariantToUInt16' delayed;
function PropVariantToUInt16Vector; external propsys name 'PropVariantToUInt16Vector' delayed;
function PropVariantToUInt16VectorAlloc; external propsys name 'PropVariantToUInt16VectorAlloc' delayed;
function PropVariantToUInt16WithDefault; external propsys name 'PropVariantToUInt16WithDefault' delayed;
function PropVariantToUInt32; external propsys name 'PropVariantToUInt32' delayed;
function PropVariantToUInt32Vector; external propsys name 'PropVariantToUInt32Vector' delayed;
function PropVariantToUInt32VectorAlloc; external propsys name 'PropVariantToUInt32VectorAlloc' delayed;
function PropVariantToUInt32WithDefault; external propsys name 'PropVariantToUInt32WithDefault' delayed;
function PropVariantToUInt64; external propsys name 'PropVariantToUInt64' delayed;
function PropVariantToUInt64Vector; external propsys name 'PropVariantToUInt64Vector' delayed;
function PropVariantToUInt64VectorAlloc; external propsys name 'PropVariantToUInt64VectorAlloc' delayed;
function PropVariantToUInt64WithDefault; external propsys name 'PropVariantToUInt64WithDefault' delayed;
function PropVariantToVariant; external propsys name 'PropVariantToVariant' delayed;
function StgDeserializePropVariant; external propsys name 'StgDeserializePropVariant' delayed;
function StgSerializePropVariant; external propsys name 'StgSerializePropVariant' delayed;
function VariantCompare; external propsys name 'VariantCompare' delayed;
function VariantGetBooleanElem; external propsys name 'VariantGetBooleanElem' delayed;
function VariantGetDoubleElem; external propsys name 'VariantGetDoubleElem' delayed;
function VariantGetElementCount; external propsys name 'VariantGetElementCount' delayed;
function VariantGetInt16Elem; external propsys name 'VariantGetInt16Elem' delayed;
function VariantGetInt32Elem; external propsys name 'VariantGetInt32Elem' delayed;
function VariantGetInt64Elem; external propsys name 'VariantGetInt64Elem' delayed;
function VariantGetStringElem; external propsys name 'VariantGetStringElem' delayed;
function VariantGetUInt16Elem; external propsys name 'VariantGetUInt16Elem' delayed;
function VariantGetUInt32Elem; external propsys name 'VariantGetUInt32Elem' delayed;
function VariantGetUInt64Elem; external propsys name 'VariantGetUInt64Elem' delayed;
function VariantToBoolean; external propsys name 'VariantToBoolean' delayed;
function VariantToBooleanArray; external propsys name 'VariantToBooleanArray' delayed;
function VariantToBooleanArrayAlloc; external propsys name 'VariantToBooleanArrayAlloc' delayed;
function VariantToBooleanWithDefault; external propsys name 'VariantToBooleanWithDefault' delayed;
function VariantToBuffer; external propsys name 'VariantToBuffer' delayed;
function VariantToDosDateTime; external propsys name 'VariantToDosDateTime' delayed;
function VariantToDouble; external propsys name 'VariantToDouble' delayed;
function VariantToDoubleArray; external propsys name 'VariantToDoubleArray' delayed;
function VariantToDoubleArrayAlloc; external propsys name 'VariantToDoubleArrayAlloc' delayed;
function VariantToDoubleWithDefault; external propsys name 'VariantToDoubleWithDefault' delayed;
function VariantToFileTime; external propsys name 'VariantToFileTime' delayed;
function VariantToGUID; external propsys name 'VariantToGUID' delayed;
function VariantToInt16; external propsys name 'VariantToInt16' delayed;
function VariantToInt16Array; external propsys name 'VariantToInt16Array' delayed;
function VariantToInt16ArrayAlloc; external propsys name 'VariantToInt16ArrayAlloc' delayed;
function VariantToInt16WithDefault; external propsys name 'VariantToInt16WithDefault' delayed;
function VariantToInt32; external propsys name 'VariantToInt32' delayed;
function VariantToInt32Array; external propsys name 'VariantToInt32Array' delayed;
function VariantToInt32ArrayAlloc; external propsys name 'VariantToInt32ArrayAlloc' delayed;
function VariantToInt32WithDefault; external propsys name 'VariantToInt32WithDefault' delayed;
function VariantToInt64; external propsys name 'VariantToInt64' delayed;
function VariantToInt64Array; external propsys name 'VariantToInt64Array' delayed;
function VariantToInt64ArrayAlloc; external propsys name 'VariantToInt64ArrayAlloc' delayed;
function VariantToInt64WithDefault; external propsys name 'VariantToInt64WithDefault' delayed;
function VariantToPropVariant; external propsys name 'VariantToPropVariant' delayed;
function VariantToString; external propsys name 'VariantToString' delayed;
function VariantToStringAlloc; external propsys name 'VariantToStringAlloc' delayed;
function VariantToStringArray; external propsys name 'VariantToStringArray' delayed;
function VariantToStringArrayAlloc; external propsys name 'VariantToStringArrayAlloc' delayed;
function VariantToStringWithDefault; external propsys name 'VariantToStringWithDefault' delayed;
function VariantToStrRet; external propsys name 'VariantToStrRet' delayed;
function VariantToUInt16; external propsys name 'VariantToUInt16' delayed;
function VariantToUInt16Array; external propsys name 'VariantToUInt16Array' delayed;
function VariantToUInt16ArrayAlloc; external propsys name 'VariantToUInt16ArrayAlloc' delayed;
function VariantToUInt16WithDefault; external propsys name 'VariantToUInt16WithDefault' delayed;
function VariantToUInt32; external propsys name 'VariantToUInt32' delayed;
function VariantToUInt32Array; external propsys name 'VariantToUInt32Array' delayed;
function VariantToUInt32ArrayAlloc; external propsys name 'VariantToUInt32ArrayAlloc' delayed;
function VariantToUInt32WithDefault; external propsys name 'VariantToUInt32WithDefault' delayed;
function VariantToUInt64; external propsys name 'VariantToUInt64' delayed;
function VariantToUInt64Array; external propsys name 'VariantToUInt64Array' delayed;
function VariantToUInt64ArrayAlloc; external propsys name 'VariantToUInt64ArrayAlloc' delayed;
function VariantToUInt64WithDefault; external propsys name 'VariantToUInt64WithDefault' delayed;

function InitPropVariantFromBoolean(fVal: BOOL; out ppropvar: PROPVARIANT): HRESULT;
begin
  ppropvar.vt := VT_BOOL;
...
function InitPropVariantFromInt16(nVal: SHORT; out ppropvar: PROPVARIANT): HRESULT;
begin
  ppropvar.vt := VT_I2;
  ppropvar.iVal := nVal;
  Result := S_OK;
...
function InitPropVariantFromUInt16(uiVal: USHORT; out ppropvar: PROPVARIANT): HRESULT;
begin
  ppropvar.vt := VT_UI2;
...
function InitPropVariantFromInt32(lVal: Integer; out ppropvar: PROPVARIANT): HRESULT;
begin
  ppropvar.vt := VT_I4;
  ppropvar.lVal := lVal;
  Result := S_OK;
...
function InitPropVariantFromUInt32(ulVal: Cardinal; out ppropvar: PROPVARIANT): HRESULT;
begin
  ppropvar.vt := VT_UI4;
...
function InitPropVariantFromInt64(llVal: LONGLONG; out ppropvar: PROPVARIANT): HRESULT;
begin
  ppropvar.vt := VT_I8;
...
function InitPropVariantFromUInt64(ullVal: ULONGLONG; out ppropvar: PROPVARIANT): HRESULT;
begin
  ppropvar.vt := VT_UI8;
...
function InitPropVariantFromDouble(dblVal: Double; out ppropvar: PROPVARIANT): HRESULT;
begin
  ppropvar.vt := VT_R8;
...
function _SHStrDupW; external 'shlwapi.dll' name 'SHStrDupW';

{ Creates a VT_LPWSTR propvariant. }
function InitPropVariantFromString(psz: LPCWSTR; out ppropvar: PROPVARIANT): HRESULT;
begin
...
{ Creates a VT_VECTOR | VT_UI1 propvariant. }
function InitPropVariantFromGUIDAsBuffer(const guid: TGuid; out ppropvar: PROPVARIANT): HRESULT;
begin
...
function PropVariantToCLSID(const propvarIn: PROPVARIANT; out pclsid: TCLSID): HRESULT;
begin
...
function PropVariantCompare(const propvar1: PROPVARIANT; const propvar2: PROPVARIANT): Integer;
begin
  Result := PropVariantCompareEx(propvar1, propvar2, PVCU_DEFAULT, PVCF_DEFAULT);
end;

function PropVariantGetElem(const propvarIn: PROPVARIANT; iElem: Cardinal; out ppropvar: PROPVARIANT): HRESULT;
begin
  Result := InitPropVariantFromPropVariantVectorElem(propvarIn, iElem, ppropvar);
end;

function InitVariantFromBoolean(fVal: BOOL; out pvar: OleVariant): HRESULT;
begin
  TVariantArg(pvar).vt := VT_BOOL;
  TVariantArg(pvar).vbool := fVal;
  Result := S_OK;
end;

function InitVariantFromInt16(iVal: Smallint; out pvar: OleVariant): HRESULT;
begin
  TVariantArg(pvar).vt := VT_I2;
  TVariantArg(pvar).iVal := iVal;
  Result := S_OK;
end;

function InitVariantFromUInt16(uiVal: USHORT; out pvar: OleVariant): HRESULT;
begin
  TVariantArg(pvar).vt := VT_UI2;
  TVariantArg(pvar).uiVal := uiVal;
  Result := S_OK;
end;

function InitVariantFromInt32(lVal: Integer; out pvar: OleVariant): HRESULT;
begin
  TVariantArg(pvar).vt := VT_I4;
  TVariantArg(pvar).lVal := lVal;
  Result := S_OK;
end;

function InitVariantFromUInt32(ulVal: Cardinal; out pvar: OleVariant): HRESULT;
begin
  TVariantArg(pvar).vt := VT_UI4;
  TVariantArg(pvar).ulVal := ulVal;
  Result := S_OK;
end;

function InitVariantFromInt64(llVal: LONGLONG; out pvar: OleVariant): HRESULT;
begin
  TVariantArg(pvar).vt := VT_I8;
  TVariantArg(pvar).llVal := llVal;
  Result := S_OK;
end;

function InitVariantFromUInt64(ullVal: ULONGLONG; out pvar: OleVariant): HRESULT;
begin
  TVariantArg(pvar).vt := VT_UI8;
  TVariantArg(pvar).ullVal := ullVal;
  Result := S_OK;
end;

function InitVariantFromDouble(dblVal: Double; out pvar: OleVariant): HRESULT;
begin
  TVariantArg(pvar).vt := VT_R8;
  TVariantArg(pvar).dblVal := dblVal;
  Result := S_OK;
end;

function InitVariantFromString(psz: LPCWSTR; out pvar: OleVariant): HRESULT;
begin
  TVariantArg(pvar).vt := VT_BSTR;
  TVariantArg(pvar).bstrVal := SysAllocString(psz);
  if TVariantArg(pvar).bstrVal <> nil then
    Result := S_OK
  else if psz <> nil then
...
function InitVariantFromDispatch(const pdisp: IDispatch; out pvar: OleVariant): HRESULT;
begin
  TVariantArg(pvar).vt := VT_DISPATCH;
  IDispatch(TVariantArg(pvar).dispVal) := pdisp;
  Result := S_OK;
end;

{ Creates a VT_DATE variant }
function InitVariantFromDosDateTime(wDate: Word; wTime: Word; out pvar: OleVariant): HRESULT;
begin
  TVariantArg(pvar).vt := VT_DATE;
  if DosDateTimeToVariantTime(wDate, wTime, TVariantArg(pvar).date) <> 0 then Result := S_OK else Result := S_FALSE;
end;

function IsVarTypeFloat(vt: TVARTYPE): Boolean;
begin
  Result := (vt = VT_R4) or (vt = VT_R8);
end;

function IsVariantArray(const _var: OleVariant): Boolean;
begin
  Result := (TVariantArg(_var).vt and VT_ARRAY) <> 0;
end;

{ if TRUE, you can use VariantToStringCast to obtain the string pointer }
function IsVariantString(const _var: OleVariant): Boolean;
begin
  Result := VariantToStringWithDefault(_var, nil) <> nil;
end;

function IsVarTypeSignedInteger(vt: TVARTYPE): Boolean;
begin
  case vt of
    VT_I1,
    VT_I2,
...
function IsVarTypeUnsignedInteger(vt: TVARTYPE): Boolean;
begin
  case vt of
    VT_UI1,
    VT_UI2,
...
function IsVarTypeInteger(vt: TVARTYPE): Boolean;
begin
  Result := IsVarTypeSignedInteger(vt) or IsVarTypeUnsignedInteger(vt);
end;

function IsVarTypeNumber(vt: TVARTYPE): Boolean;
begin
  Result := IsVarTypeInteger(vt) or IsVarTypeFloat(vt);
end;

{ Creates a VT_ARRAY | VT_UI1 variant. }
function InitVariantFromGUIDAsBuffer(const guid: TGuid; out pvar: OleVariant): HRESULT;
begin
  Result := InitVariantFromBuffer(@guid, sizeof(guid), pvar);
end;

function VariantGetElem(const varIn: OleVariant; iElem: Cardinal; out pvar: OleVariant): HRESULT;
begin
  Result := InitVariantFromVariantArrayElem(varIn, iElem, pvar);
end;
