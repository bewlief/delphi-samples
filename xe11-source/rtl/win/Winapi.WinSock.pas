...
{  All Rights Reserved.                                 }
{ This file includes parts which are Copyright (c)      }
{ 1982-1986 Regents of the University of California.    }
...
{$POINTERMATH OFF}
  ...
  hostent = record
    ...
    h_aliases: MarshaledAStringList;
    h_addrtype: Smallint;
    h_length: Smallint;
    case Byte of
      0: (h_addr_list: MarshaledAStringList);
      1: (h_addr: PMarshaledAString); // should be a macro for h_add_list[0], but we can't use that here
  end;
  THostEnt = hostent;
  ...
  netent = record
    ...
    n_aliases: MarshaledAStringList;
    n_addrtype: Smallint;
    n_net: u_long;
  end;
  TNetEnt = netent;
  ...
  servent = record
    ...
    s_aliases: MarshaledAStringList;
{$IFDEF WIN64}
...
{$ENDIF}
  ...
  protoent = record
    ...
    p_aliases: MarshaledAStringList;
    p_proto: Smallint;
  end;
  TProtoEnt = protoent;
...
{$IFDEF WIN64}
    ...
    szDescription: array[0..WSADESCRIPTION_LEN] of u_char;
    szSystemStatus: array[0..WSASYS_STATUS_LEN] of u_char;
{$ELSE}
    szDescription: array[0..WSADESCRIPTION_LEN] of u_char;
    szSystemStatus: array[0..WSASYS_STATUS_LEN] of u_char;
    iMaxSockets: Word;
...
function inet_ntoa(inaddr: TInAddr): MarshaledAString; stdcall;
{$EXTERNALSYM listen}
...
function setsockopt(s: TSocket; level, optname: Integer; optval: MarshaledAString;
...
function WSAAsyncGetServByName(HWindow: HWND; wMsg: u_int;
  name, proto, buf: MarshaledAString; buflen: Integer): THandle; stdcall;
...
function WSAAsyncGetProtoByName(HWindow: HWND; wMsg: u_int;
  name, buf: MarshaledAString; buflen: Integer): THandle; stdcall;
...
function WSAAsyncGetHostByAddr(HWindow: HWND; wMsg: u_int; addr: MarshaledAString;
  len, Struct: Integer; buf: MarshaledAString; buflen: Integer): THandle; stdcall;
