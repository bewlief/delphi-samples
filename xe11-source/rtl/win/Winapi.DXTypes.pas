...
{$HPPEMIT '#define DIRECT3D_VERSION 0x0900'}
...
type
  ...
  {$EXTERNALSYM LPD3DCOLORVALUE}
  TD3DColorValue = D3DCOLORVALUE;
  PD3DColorValue = LPD3DCOLORVALUE;
  ...
  {$EXTERNALSYM LPD3DMATRIX}
  TD3DMatrix = D3DMATRIX;
  PD3DMatrix = LPD3DMATRIX;
