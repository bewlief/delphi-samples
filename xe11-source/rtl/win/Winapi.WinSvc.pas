...
//
  ...
  {$EXTERNALSYM SERVICE_CONTROL_LOWRESOURCES}
  SERVICE_CONTROL_LOWRESOURCES           = $00000060;
  {$EXTERNALSYM SERVICE_CONTROL_SYSTEMLOWRESOURCES}
...
//
  ...
  {$EXTERNALSYM SERVICE_ACCEPT_USER_LOGOFF}
  SERVICE_ACCEPT_USER_LOGOFF             = $00000800;
  {$EXTERNALSYM SERVICE_ACCEPT_LOWRESOURCES}
  SERVICE_ACCEPT_LOWRESOURCES            = $00002000;
  {$EXTERNALSYM SERVICE_ACCEPT_SYSTEMLOWRESOURCES}
...
//
  ...
  {$EXTERNALSYM SERVICE_CONFIG_LAUNCH_PROTECTED}
...
//
  ...
  {$EXTERNALSYM SERVICE_STOP_REASON_MINOR_MEMOTYLIMIT}
  SERVICE_STOP_REASON_MINOR_MEMOTYLIMIT                   = $00000018;
  {$EXTERNALSYM SERVICE_STOP_REASON_MINOR_MAX}
  SERVICE_STOP_REASON_MINOR_MAX                           = $00000019;
...
//
  ...
  {$EXTERNALSYM SERVICE_TRIGGER_DATA_TYPE_LEVEL}
  SERVICE_TRIGGER_DATA_TYPE_LEVEL                             = 3;
  {$EXTERNALSYM SERVICE_TRIGGER_DATA_TYPE_KEYWORD_ANY}
  SERVICE_TRIGGER_DATA_TYPE_KEYWORD_ANY                       = 4;
  {$EXTERNALSYM SERVICE_TRIGGER_DATA_TYPE_KEYWORD_ALL}
  SERVICE_TRIGGER_DATA_TYPE_KEYWORD_ALL                       = 5;

//
//  Service start reason
//
  {$EXTERNALSYM SERVICE_START_REASON_DEMAND}
  SERVICE_START_REASON_DEMAND                                 = $00000001;
  {$EXTERNALSYM SERVICE_START_REASON_AUTO}
  SERVICE_START_REASON_AUTO                                   = $00000002;
  {$EXTERNALSYM SERVICE_START_REASON_TRIGGER}
  SERVICE_START_REASON_TRIGGER                                = $00000004;
  {$EXTERNALSYM SERVICE_START_REASON_RESTART_ON_FAILURE}
  SERVICE_START_REASON_RESTART_ON_FAILURE                     = $00000008;
  {$EXTERNALSYM SERVICE_START_REASON_DELAYEDAUTO}
  SERVICE_START_REASON_DELAYEDAUTO                            = $00000010;

//
//  Service dynamic information levels
//
  {$EXTERNALSYM SERVICE_DYNAMIC_INFORMATION_LEVEL_START_REASON}
  SERVICE_DYNAMIC_INFORMATION_LEVEL_START_REASON              = 1;

//
// Service LaunchProtected types supported
//
  {$EXTERNALSYM SERVICE_LAUNCH_PROTECTED_NONE}
  SERVICE_LAUNCH_PROTECTED_NONE                               = 0;
  {$EXTERNALSYM SERVICE_LAUNCH_PROTECTED_WINDOWS}
  SERVICE_LAUNCH_PROTECTED_WINDOWS                            = 1;
  {$EXTERNALSYM SERVICE_LAUNCH_PROTECTED_WINDOWS_LIGHT}
  SERVICE_LAUNCH_PROTECTED_WINDOWS_LIGHT                      = 2;
  {$EXTERNALSYM SERVICE_LAUNCH_PROTECTED_ANTIMALWARE_LIGHT}
...
// used with SERVICE_TRIGGER_TYPE_NETWORK_ENDPOINT trigger.
  ...
  {$EXTERNALSYM RPC_INTERFACE_EVENT_GUID}
  RPC_INTERFACE_EVENT_GUID: TGUID = '{BC90D167-9470-4139-A9BA-BE0BBBF5B74D}';

  {$EXTERNALSYM NAMED_PIPE_EVENT_GUID}
...
//
  {$EXTERNALSYM CUSTOM_SYSTEM_STATE_CHANGE_EVENT_GUID}
  CUSTOM_SYSTEM_STATE_CHANGE_EVENT_GUID: TGUID = '{2D7A2816-0C5E-45FC-9CE7-570E5ECDE9C9}';

//
// Service notification trigger identifier
//
type
  {$EXTERNALSYM SERVICE_TRIGGER_CUSTOM_STATE_ID}
  SERVICE_TRIGGER_CUSTOM_STATE_ID = record
    Data: array[0..1] of DWORD;
  end;

  {$EXTERNALSYM LPSERVICE_CUSTOM_SYSTEM_STATE_CHANGE_DATA_ITEM}
  LPSERVICE_CUSTOM_SYSTEM_STATE_CHANGE_DATA_ITEM = ^SERVICE_CUSTOM_SYSTEM_STATE_CHANGE_DATA_ITEM;
  {$EXTERNALSYM SERVICE_CUSTOM_SYSTEM_STATE_CHANGE_DATA_ITEM}
  SERVICE_CUSTOM_SYSTEM_STATE_CHANGE_DATA_ITEM = record
    case Integer of
...
//
  ...
  public
    _DelayedAutostart: DWORD;
    property fDelayedAutostart: Boolean read GetValue write SetValue;      // Delayed autostart flag
  end;
...
const
  {$EXTERNALSYM SC_AGGREGATE_STORAGE_KEY}
...
//
  {$EXTERNALSYM PSERVICE_LAUNCH_PROTECTED_INFO}
  PSERVICE_LAUNCH_PROTECTED_INFO = ^SERVICE_LAUNCH_PROTECTED_INFO;
  {$EXTERNALSYM SERVICE_LAUNCH_PROTECTED_INFO}
  SERVICE_LAUNCH_PROTECTED_INFO = record
    dwLaunchProtected: DWORD;  // Service launch protected
  end;
...
//  {$EXTERNALSYM HANDLER_FUNCTION}
//  HANDLER_FUNCTION = procedure(dwControl: DWORD); stdcall;

//  {$EXTERNALSYM HANDLER_FUNCTION_EX}
//  HANDLER_FUNCTION_EX = function(dwControl: DWORD; dwEventType: DWORD;
...
//  Service start reason
//
  {$EXTERNALSYM PSERVICE_START_REASON}
  PSERVICE_START_REASON = ^SERVICE_START_REASON;

  {$EXTERNALSYM SERVICE_START_REASON}
  SERVICE_START_REASON = record
    dwReason: DWORD;
  end;
...
{$EXTERNALSYM QueryServiceDynamicInformation}
function QueryServiceDynamicInformation(hServiceStatus: SERVICE_STATUS_HANDLE;
  dwInfoLevel: DWORD; ppDynamicInfo: PPointer) : BOOL; stdcall;

//
// Service status change notification API
//
type
  {$EXTERNALSYM PSC_EVENT_TYPE}
  PSC_EVENT_TYPE = ^SC_EVENT_TYPE;
  {$EXTERNALSYM SC_EVENT_TYPE}
  SC_EVENT_TYPE = (SC_EVENT_DATABASE_CHANGE, SC_EVENT_PROPERTY_CHANGE, SC_EVENT_STATUS_CHANGE);

  {$EXTERNALSYM PSC_NOTIFICATION_CALLBACK}
  PSC_NOTIFICATION_CALLBACK = ^SC_NOTIFICATION_CALLBACK;
  {$EXTERNALSYM SC_NOTIFICATION_CALLBACK}
  SC_NOTIFICATION_CALLBACK = procedure(dwNotify: DWORD; pCallbackContext: Pointer); stdcall;

  {$EXTERNALSYM PSC_NOTIFICATION_REGISTRATION}
  PSC_NOTIFICATION_REGISTRATION = ^_SC_NOTIFICATION_REGISTRATION;
  {$EXTERNALSYM _SC_NOTIFICATION_REGISTRATION}
  _SC_NOTIFICATION_REGISTRATION = record
  end;

{$EXTERNALSYM SubscribeServiceChangeNotifications}
function SubscribeServiceChangeNotifications(
    ...
    var pSubscription: PSC_NOTIFICATION_REGISTRATION
  ): DWORD; stdcall;

  {$EXTERNALSYM UnsubscribeServiceChangeNotifications}
  procedure UnsubscribeServiceChangeNotifications(pSubscription: PSC_NOTIFICATION_REGISTRATION); stdcall;

{$EXTERNALSYM WaitServiceState}
function WaitServiceState(
    hService: SC_HANDLE;
    dwNotify, dwTimeout: DWORD;
...
//
type
  {$EXTERNALSYM SERVICE_REGISTRY_STATE_TYPE}
...
function QueryServiceDynamicInformation; external advapi32 name 'QueryServiceDynamicInformation' delayed;
function SubscribeServiceChangeNotifications; external SecHost name 'SubscribeServiceChangeNotifications' delayed;
procedure UnsubscribeServiceChangeNotifications; external SecHost name 'UnsubscribeServiceChangeNotifications' delayed;
function WaitServiceState; external SecHost name 'WaitServiceState' delayed;
function GetServiceRegistryStateKey; external SecHost name 'GetServiceRegistryStateKey' delayed;
function GetServiceDirectory; external SecHost name 'GetServiceDirectory' delayed;
function GetSharedServiceRegistryStateKey; external SecHost name 'GetSharedServiceRegistryStateKey' delayed;
function GetSharedServiceDirectory; external SecHost name 'GetSharedServiceDirectory' delayed;

procedure SERVICE_DELAYED_AUTO_START_INFO.SetValue(Value: Boolean);
begin
  _DelayedAutostart := Ord(Value);  // 0 or 1
end;

function SERVICE_DELAYED_AUTO_START_INFO.GetValue: Boolean;
begin
  Result := _DelayedAutostart <> 0;
end;
