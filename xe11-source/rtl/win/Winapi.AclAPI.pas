...
function GetNamedSecurityInfo(pObjectName: LPWSTR; ObjectType: SE_OBJECT_TYPE;
         ...
         ppSecurityDescriptor: PPSECURITY_DESCRIPTOR): DWORD; stdcall; {use localfree to release ppSecurityDescriptor}
...
procedure BuildImpersonateExplicitAccessWithName(pExplicitAccess: PEXPLICIT_ACCESS_;
          pTrusteeName: LPWSTR; pTrustee: PTRUSTEE_; AccessPermissions: DWORD;
...
procedure BuildTrusteeWithName(pTrustee: PTRUSTEE_; pName: LPWSTR); stdcall;
...
function GetTrusteeName(var pTrustee: TRUSTEE_): LPWSTR; stdcall;
function GetTrusteeNameA(var pTrustee: TRUSTEE_A): LPSTR; stdcall;
function GetTrusteeNameW(var pTrustee: TRUSTEE_W): LPWSTR; stdcall;
