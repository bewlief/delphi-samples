...
{$HPPEMIT '// The "BlueTooth Low Energy" interface requires that you install the Windows 8 SDK'}
{$HPPEMIT '#include <no_sal2.h>         // Header available from the "Windows SDK for Windows 8"'}
{$HPPEMIT '#include <bthledef.h>        // Header available from the "Windows SDK for Windows 8"'}
{$HPPEMIT '#include <bluetoothleapis.h> // Header available from the "Windows SDK for Windows 8"'}
