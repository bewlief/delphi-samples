...
const
  ...
  {$EXTERNALSYM FR_RAW}
  FR_RAW           = $00020000;
  {$EXTERNALSYM FR_SHOWWRAPAROUND}
  FR_SHOWWRAPAROUND = $00040000;
  {$EXTERNALSYM FR_NOWRAPAROUND}
  FR_NOWRAPAROUND   = $00080000;
  {$EXTERNALSYM FR_WRAPAROUND}
  FR_WRAPAROUND     = $00100000;
...
const
  {$EXTERNALSYM FRM_FIRST}
  FRM_FIRST = WM_USER + 100;
  {$EXTERNALSYM FRM_LAST}
  FRM_LAST = WM_USER + 200;

  {$EXTERNALSYM FRM_SETOPERATIONRESULT}
  FRM_SETOPERATIONRESULT     = FRM_FIRST + $0000;
  {$EXTERNALSYM FRM_SETOPERATIONRESULTTEXT}
  FRM_SETOPERATIONRESULTTEXT = FRM_FIRST + $0001;
...
{$EXTERNALSYM CommDlg_FindReplace_SendResult}
procedure CommDlg_FindReplace_SendResult(_hdlg: HWND; _flags: WPARAM; var _fr: TFindReplace); inline;

// lParam = pointer to a string to be used to communicate the result of an operation to a user
// wParam = not used
// return = not used

{$EXTERNALSYM CommDlg_FindReplace_SendCustomResult}
procedure CommDlg_FindReplace_SendCustomResult(_hdlg: HWND; _psz: LPSTR); inline;
...
procedure CommDlg_FindReplace_SendResult(_hdlg: HWND; _flags: WPARAM; var _fr: TFindReplace);
begin
  SendMessage(_hdlg, FRM_SETOPERATIONRESULT, _flags, LPARAM(@_fr));
end;

procedure CommDlg_FindReplace_SendCustomResult(_hdlg: HWND; _psz: LPSTR);
begin
  SendMessage(_hdlg, FRM_SETOPERATIONRESULTTEXT, 0, LPARAM(_psz));
end;
