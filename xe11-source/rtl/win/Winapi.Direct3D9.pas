...
uses Winapi.Windows, Winapi.DXTypes;
...
type
  _D3DVECTOR = Winapi.DXTypes._D3DVECTOR;
  {$EXTERNALSYM _D3DVECTOR}
  D3DVECTOR = Winapi.DXTypes.D3DVECTOR;
  {$EXTERNALSYM D3DVECTOR}
  TD3DVector = Winapi.DXTypes.TD3DVector;
  {$EXTERNALSYM TD3DVector}
  PD3DVector = Winapi.DXTypes.PD3DVector;
  {$EXTERNALSYM PD3DVector}

  PD3DViewport9 = ^TD3DViewport9;
  {$EXTERNALSYM PD3DViewport9}
...
type
  ...
  {$EXTERNALSYM TD3DClipStatus9}

  PD3DMaterial9 = ^TD3DMaterial9;
  {$EXTERNALSYM PD3DMaterial9}
  ...
  {$EXTERNALSYM TD3DLightType}

  PD3DLight9 = ^TD3DLight9;
  {$EXTERNALSYM PD3DLight9}
  _D3DLIGHT9 = record
...
type
  ...
  {$EXTERNALSYM TD3DTextureAddress}
...
{$ENDIF}
  ...
  {$EXTERNALSYM TD3DTransformStateType}
...
type
  ...
  {$EXTERNALSYM TD3DRenderStateType}
...
type
  ...
  {$EXTERNALSYM TD3DMaterialSource}
...
type
  ...
  {$EXTERNALSYM TD3DTextureStageStateType}
 ...
 *)
  ...
  {$EXTERNALSYM TD3DSamplerStateType}
...
type
  ...
  {$EXTERNALSYM TD3DTextureFilterType}
...
type
  ...
  {$EXTERNALSYM PD3DVertexElement9}
  ...
  {$EXTERNALSYM TD3DVertexElement9}
...
type 
  ...
  {$EXTERNALSYM TD3DShaderInstructionOpcodeType}
...
type
  ...
  {$EXTERNALSYM TD3DShaderComparison}
...
type
  ...
  {$EXTERNALSYM TD3DSamplerTextureType}
...
{$ENDIF}
  ...
  {$EXTERNALSYM TD3DShaderParamRegisterType}
  ...
  {$EXTERNALSYM TD3DShaderMiscTypeOffsets}
  {$MINENUMSIZE 4} // Restores enums to be 4 byte in size
  ...
  {$EXTERNALSYM TD3DVSRastoutOffsets}
...
type
  ...
  {$EXTERNALSYM TD3DVSAddressModeType}
...
type
  ...
  {$EXTERNALSYM TD3DShaderAddressModeType}
...
type
  ...
  {$EXTERNALSYM TD3DShaderParamSRCModType}
...
type
  ...
  {$EXTERNALSYM TD3DPatchEdgeStyle}
  ...
  {$EXTERNALSYM TD3DStateBlockType}
...
type
  ...
  {$EXTERNALSYM TD3DVertexBlendFlags}
...
type
  ...
  {$EXTERNALSYM TD3DTextureTransformFlags}
...
{$IFDEF DIRECT3D_VERSION_9_VISTA}
  ...
  IDirect3DDevice9Ex = interface(IDirect3DDevice9)
    ...
    function ResetEx(const pPresentationParameters: TD3DPresentParameters; pFullscreenDisplayMode: PD3DDisplayModeEx): HResult; stdcall;
...
{$IFDEF DIRECT3D_VERSION_9_VISTA}
function Direct3DCreate9Ex(SDKVersion: LongWord; out d3d9ex: IDirect3D9Ex): HRESULT; stdcall; external Direct3D9dll delayed;
{$ENDIF}
{$ENDIF}
