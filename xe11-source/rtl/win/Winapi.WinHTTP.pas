...
const
  ...
  {$EXTERNALSYM WINHTTP_OPTION_ENABLE_HTTP_PROTOCOL}
  WINHTTP_OPTION_HTTP_PROTOCOL_USED = 134;
  {$EXTERNALSYM WINHTTP_OPTION_HTTP_PROTOCOL_USED}

  WINHTTP_OPTION_SECURITY_INFO = 151;
  {$EXTERNALSYM WINHTTP_OPTION_SECURITY_INFO}
...
{ Secure connection error status flags }
  ...
  {$EXTERNALSYM WINHTTP_PROTOCOL_FLAG_HTTP2}
  WINHTTP_PROTOCOL_MASK = WINHTTP_PROTOCOL_FLAG_HTTP2;
  {$EXTERNALSYM WINHTTP_PROTOCOL_MASK}
