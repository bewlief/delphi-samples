...
{$HPPEMIT '#include <udpmib.h>'}
{$HPPEMIT '#include <tcpmib.h>'}
{$HPPEMIT ''}
{$HPPEMIT LEGACYHPP}
...
type
  ...
  _MIBICMPSTATS_EX_XPSP1 = record
    dwMsgs: DWORD;
    dwErrors: DWORD;
    rgdwTypeCount: array [0..255] of DWORD;
  end;
  {$EXTERNALSYM _MIBICMPSTATS_EX_XPSP1}
  MIBICMPSTATS_EX = _MIBICMPSTATS_EX_XPSP1;
  ...
  _MIB_ICMP_EX_XPSP1 = record
    icmpInStats: MIBICMPSTATS_EX;
    icmpOutStats: MIBICMPSTATS_EX;
  end;
  {$EXTERNALSYM _MIB_ICMP_EX_XPSP1}
  MIB_ICMP_EX = _MIB_ICMP_EX_XPSP1;
...
// #define SIZEOF_UDPTABLE(X) (FIELD_OFFSET(MIB_UDPTABLE, table[0]) + ((X) * sizeof(MIB_UDPROW)) + ALIGN_SIZE)
  ...
  {$EXTERNALSYM _MIB_TCPSTATS_LH}
  MIB_TCPSTATS = _MIB_TCPSTATS_LH;
...
type
  ...
  {$EXTERNALSYM _MIB_IPSTATS_W2K}
  MIB_IPSTATS = _MIB_IPSTATS_W2K;
...
type
  ...
  {$EXTERNALSYM _MIB_IPNETROW_W2K}
  MIB_IPNETROW = _MIB_IPNETROW_W2K;
...
type
  ...
  _MIB_IPMCAST_OIF_XP = record
    dwOutIfIndex: DWORD;
    dwNextHopAddr: DWORD;
    dwReserved: DWORD;
    dwReserved1: DWORD;
  end;
  {$EXTERNALSYM _MIB_IPMCAST_OIF_XP}
  MIB_IPMCAST_OIF = _MIB_IPMCAST_OIF_XP;
...
type
  ...
  _MIB_IPMCAST_OIF_STATS_LH = record
    dwOutIfIndex: DWORD;
    dwNextHopAddr: DWORD;
    dwDialContext: DWORD;
    ulTtlTooLow: ULONG;
  ...
  {$EXTERNALSYM _MIB_IPMCAST_OIF_STATS_LH}
  MIB_IPMCAST_OIF_STATS = _MIB_IPMCAST_OIF_STATS_LH;
...
type
  _MIB_IPMCAST_MFE_STATS_EX_XP = record
    dwGroup: DWORD;
    dwSource: DWORD;
    dwSrcMask: DWORD;
    dwUpStrmNgbr: DWORD;
  ...
  {$EXTERNALSYM _MIB_IPMCAST_MFE_STATS_EX_XP}
  MIB_IPMCAST_MFE_STATS_EX = _MIB_IPMCAST_MFE_STATS_EX_XP;
  ...
  TArrayMibIpMCastMfeStatsEx = array [0..ANY_SIZE - 1] of MIB_IPMCAST_MFE_STATS_EX;
  PArrayMibIpMCastMfeStatsEx = ^TArrayMibIpMCastMfeStatsEx;

  _MIB_MFE_STATS_TABLE_EX_XP = record
    dwNumEntries: DWORD;
    table: PArrayMibIpMCastMfeStatsEx;
  end;
  {$EXTERNALSYM _MIB_MFE_STATS_TABLE_EX_XP}
  MIB_MFE_STATS_TABLE_EX = _MIB_MFE_STATS_TABLE_EX_XP;
