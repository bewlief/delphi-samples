...
type
  ...
  D3D10_SHADER_MACRO = record
    Name: LPCSTR;
    Definition: LPCSTR;
  end;
  {$EXTERNALSYM D3D10_SHADER_MACRO}
  TD3D10_ShaderMacro = D3D10_SHADER_MACRO;
...
//----------------------------------------------------------------------------
  ...
  TD3D10_ShaderVariableClass = D3D10_SHADER_VARIABLE_CLASS;
  ...
  TD3D10_ShaderVariableFlags = D3D10_SHADER_VARIABLE_FLAGS;
...
//----------------------------------------------------------------------------
  ...
  TD3D10_ShaderVariableType = D3D10_SHADER_VARIABLE_TYPE;
  ...
  TD3D10_ShaderInputFlags = D3D10_SHADER_INPUT_FLAGS;
...
type
  ...
  TD3D10_ShaderInputType = D3D10_SHADER_INPUT_TYPE;
  ...
  TD3D10_ShaderCBufferFlags = D3D10_SHADER_CBUFFER_FLAGS;
  ...
  TD3D10_CBufferType = D3D10_CBUFFER_TYPE;
...
//----------------------------------------------------------------------------
  ...
  TD3D10IncludeType = D3D10_INCLUDE_TYPE;
