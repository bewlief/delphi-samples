...
type
  ...
  Collation_ICharacterGroupingsFactory = interface;
  PCollation_ICharacterGroupingsFactory = ^Collation_ICharacterGroupingsFactory;
  ...
  ICalendarIdentifiersStatics3 = interface;
  PICalendarIdentifiersStatics3 = ^ICalendarIdentifiersStatics3;
  ...
  ICurrencyIdentifiersStatics2 = interface;
  PICurrencyIdentifiersStatics2 = ^ICurrencyIdentifiersStatics2;

  // Windows.Globalization.ICurrencyIdentifiersStatics3
  ICurrencyIdentifiersStatics3 = interface;
  PICurrencyIdentifiersStatics3 = ^ICurrencyIdentifiersStatics3;
  ...
  PILanguageStatics3 = ^ILanguageStatics3;
  ...
  PLanguageLayoutDirection = ^LanguageLayoutDirection;
  ...
  // UsedAPI Interface
  // Windows.Globalization.ILanguage
  [WinRTClassNameAttribute(SWindows_Globalization_Language)]
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Globalization.ILanguage>
  IIterator_1__ILanguage_Base = interface(IInspectable)
  ['{30E99AE6-F414-5243-8DB2-AAB38EA3F1F1}']
  ...
  // Windows.Foundation.Collections.IIterator`1<Windows.Globalization.ILanguage>
  IIterator_1__ILanguage = interface(IIterator_1__ILanguage_Base)
  ...
  // Generic Ancestor for:
  // Windows.Foundation.Collections.IIterator`1<Windows.Globalization.Collation.ICharacterGrouping>
  IIterator_1__Collation_ICharacterGrouping_Base = interface(IInspectable)
  ['{57E89BBC-9220-5DF2-844B-DDFE6605DB5F}']
  ...
  // UsedAPI Interface
  // Windows.Foundation.Collections.IIterator`1<Windows.Globalization.Collation.ICharacterGrouping>
  IIterator_1__Collation_ICharacterGrouping = interface(IIterator_1__Collation_ICharacterGrouping_Base)
  ...
  // UsedAPI Interface
  // Windows.Globalization.Collation.ICharacterGroupings
  [WinRTClassNameAttribute(SWindows_Globalization_Collation_CharacterGroupings)]
  ...
  // Windows.Globalization.Collation.ICharacterGroupingsFactory
  [WinRTClassNameAttribute(SWindows_Globalization_Collation_CharacterGroupings)]
  Collation_ICharacterGroupingsFactory = interface(IInspectable)
  ['{99EA9FD9-886D-4401-9F98-69C82D4C2F78}']
    function Create(language: HSTRING): Collation_ICharacterGroupings; safecall;
  end;
  ...
  // UsedAPI Interface
  // Windows.Globalization.DateTimeFormatting.IDateTimeFormatter
  [WinRTClassNameAttribute(SWindows_Globalization_DateTimeFormatting_DateTimeFormatter)]
  ...
  ['{B12E5C3A-B76D-459B-BEEB-901151CD77D1}']
    ...
    property FontStretch_: FontStretch read get_FontStretch;
    property FontStyle_: FontStyle read get_FontStyle;
    property FontWeight_: FontWeight read get_FontWeight;
  ...
  // UsedAPI Interface
  // Windows.Globalization.Fonts.ILanguageFontGroup
  [WinRTClassNameAttribute(SWindows_Globalization_Fonts_LanguageFontGroup)]
  ...
  // UsedAPI Interface
  // Windows.Globalization.ICalendar
  [WinRTClassNameAttribute(SWindows_Globalization_Calendar)]
  ...
  ['{CA30221D-86D9-40FB-A26B-D44EB7CF08EA}']
    ...
    property DayOfWeek_: DayOfWeek read get_DayOfWeek;
  ...
  // UsedAPI Interface
  // Windows.Globalization.ICalendarIdentifiersStatics
  [WinRTClassNameAttribute(SWindows_Globalization_CalendarIdentifiers)]
  ...
  // Windows.Globalization.ICalendarIdentifiersStatics3
  [WinRTClassNameAttribute(SWindows_Globalization_CalendarIdentifiers)]
  ICalendarIdentifiersStatics3 = interface(IInspectable)
  ['{2C225423-1FAD-40C0-9334-A8EB90DB04F5}']
    function get_ChineseLunar: HSTRING; safecall;
    function get_JapaneseLunar: HSTRING; safecall;
    function get_KoreanLunar: HSTRING; safecall;
    function get_TaiwanLunar: HSTRING; safecall;
    function get_VietnameseLunar: HSTRING; safecall;
    property ChineseLunar: HSTRING read get_ChineseLunar;
    property JapaneseLunar: HSTRING read get_JapaneseLunar;
    property KoreanLunar: HSTRING read get_KoreanLunar;
    property TaiwanLunar: HSTRING read get_TaiwanLunar;
    property VietnameseLunar: HSTRING read get_VietnameseLunar;
  end;

  // DualAPI Interface
  // UsedAPI Interface
  // Windows.Globalization.IClockIdentifiersStatics
  [WinRTClassNameAttribute(SWindows_Globalization_ClockIdentifiers)]
  ...
  // UsedAPI Interface
  // Windows.Globalization.ICurrencyIdentifiersStatics
  [WinRTClassNameAttribute(SWindows_Globalization_CurrencyIdentifiers)]
  ...
  // Windows.Globalization.ICurrencyIdentifiersStatics2
  [WinRTClassNameAttribute(SWindows_Globalization_CurrencyIdentifiers)]
  ICurrencyIdentifiersStatics2 = interface(IInspectable)
  ['{1814797F-C3B2-4C33-9591-980011950D37}']
    function get_BYN: HSTRING; safecall;
    property BYN: HSTRING read get_BYN;
  end;
  ...
  // Windows.Globalization.ICurrencyIdentifiersStatics3
  [WinRTClassNameAttribute(SWindows_Globalization_CurrencyIdentifiers)]
  ICurrencyIdentifiersStatics3 = interface(IInspectable)
  ['{4FB23BFA-ED25-4F4D-857F-237F1748C21C}']
    function get_MRU: HSTRING; safecall;
    function get_SSP: HSTRING; safecall;
    function get_STN: HSTRING; safecall;
    function get_VES: HSTRING; safecall;
    property MRU: HSTRING read get_MRU;
    property SSP: HSTRING read get_SSP;
    property STN: HSTRING read get_STN;
    property VES: HSTRING read get_VES;
  end;

  // DualAPI Interface
  // UsedAPI Interface
  // Windows.Globalization.IGeographicRegion
  [WinRTClassNameAttribute(SWindows_Globalization_GeographicRegion)]
  ...
  // UsedAPI Interface
  // Windows.Globalization.ILanguage2
  ILanguage2 = interface(IInspectable)
  ['{6A47E5B5-D94D-4886-A404-A5A5B9D5B494}']
    function get_LayoutDirection: LanguageLayoutDirection; safecall;
    property LayoutDirection: LanguageLayoutDirection read get_LayoutDirection;
  end;

  // DualAPI Interface
  // UsedAPI Interface
  // Windows.Globalization.ILanguage3
  ILanguage3 = interface(IInspectable)
  ['{C6AF3D10-641A-5BA4-BB43-5E12AED75954}']
    function get_AbbreviatedName: HSTRING; safecall;
    property AbbreviatedName: HSTRING read get_AbbreviatedName;
  end;
  ...
  // Windows.Globalization.ILanguageStatics3
  [WinRTClassNameAttribute(SWindows_Globalization_Language)]
  ILanguageStatics3 = interface(IInspectable)
  ['{D15ECB5A-71DE-5752-9542-FAC5B4F27261}']
    function GetMuiCompatibleLanguageListFromLanguageTags(languageTags: IIterable_1__HSTRING): IVector_1__HSTRING; safecall;
  end;

  // DualAPI Interface
  // UsedAPI Interface
  // Windows.Globalization.INumeralSystemIdentifiersStatics
  [WinRTClassNameAttribute(SWindows_Globalization_NumeralSystemIdentifiers)]
  ...
  // UsedAPI Interface
  // Windows.Globalization.NumberFormatting.INumberFormatterOptions
  [WinRTClassNameAttribute(SWindows_Globalization_NumberFormatting_PermilleFormatter)]
  ...
  // UsedAPI Interface
  // Windows.Globalization.NumberFormatting.ICurrencyFormatter
  [WinRTClassNameAttribute(SWindows_Globalization_NumberFormatting_CurrencyFormatter)]
  ...
  // UsedAPI Interface
  // Windows.Globalization.NumberFormatting.IDecimalFormatterFactory
  [WinRTClassNameAttribute(SWindows_Globalization_NumberFormatting_DecimalFormatter)]
  ...
  // UsedAPI Interface
  // Windows.Globalization.NumberFormatting.IIncrementNumberRounder
  [WinRTClassNameAttribute(SWindows_Globalization_NumberFormatting_IncrementNumberRounder)]
  ...
  // UsedAPI Interface
  // Windows.Globalization.NumberFormatting.INumeralSystemTranslator
  [WinRTClassNameAttribute(SWindows_Globalization_NumberFormatting_NumeralSystemTranslator)]
  ...
  // UsedAPI Interface
  // Windows.Globalization.NumberFormatting.IPercentFormatterFactory
  [WinRTClassNameAttribute(SWindows_Globalization_NumberFormatting_PercentFormatter)]
  ...
  // UsedAPI Interface
  // Windows.Globalization.NumberFormatting.ISignificantDigitsNumberRounder
  [WinRTClassNameAttribute(SWindows_Globalization_NumberFormatting_SignificantDigitsNumberRounder)]
  ...
  // DualAPI
  // Implements: Windows.Globalization.ICalendar
  // Implements: Windows.Globalization.ITimeZoneOnCalendar
  // Factory: "Windows.Globalization.ICalendarFactory"
  // Factory: "Windows.Globalization.ICalendarFactory2"
  // Instantiable: "ICalendar"
  ...
  // DualAPI
  // Statics: "Windows.Globalization.ICalendarIdentifiersStatics"
  // Statics: "Windows.Globalization.ICalendarIdentifiersStatics2"
  // Statics: "Windows.Globalization.ICalendarIdentifiersStatics3"
  TCalendarIdentifiers = class(TWinRTGenericImportS3<ICalendarIdentifiersStatics, ICalendarIdentifiersStatics2, ICalendarIdentifiersStatics3>)
  public
    ...
    class function get_ChineseLunar: HSTRING; static; inline;
    class function get_JapaneseLunar: HSTRING; static; inline;
    class function get_KoreanLunar: HSTRING; static; inline;
    class function get_TaiwanLunar: HSTRING; static; inline;
    class function get_VietnameseLunar: HSTRING; static; inline;
    class property ChineseLunar: HSTRING read get_ChineseLunar;
    class property JapaneseLunar: HSTRING read get_JapaneseLunar;
    class property KoreanLunar: HSTRING read get_KoreanLunar;
    class property TaiwanLunar: HSTRING read get_TaiwanLunar;
    class property VietnameseLunar: HSTRING read get_VietnameseLunar;
  end;

  // Windows.Globalization.ClockIdentifiers
  // DualAPI
  // Statics: "Windows.Globalization.IClockIdentifiersStatics"
  ...
  // DualAPI
  // Implements: Windows.Globalization.Collation.ICharacterGroupings
  // Implements: Windows.Foundation.Collections.IVectorView`1<Windows.Globalization.Collation.ICharacterGrouping>
  // Implements: Windows.Foundation.Collections.IIterable`1<Windows.Globalization.Collation.ICharacterGrouping>
  // Factory: "Windows.Globalization.Collation.ICharacterGroupingsFactory"
  // Instantiable: "Collation_ICharacterGroupings"
  TCollation_CharacterGroupings = class(TWinRTGenericImportFI<Collation_ICharacterGroupingsFactory, Collation_ICharacterGroupings>)
  public
    // -> Collation_ICharacterGroupingsFactory
    class function Create(language: HSTRING): Collation_ICharacterGroupings; overload; static; inline;
  end;

  // Windows.Globalization.CurrencyIdentifiers
  // DualAPI
  // Statics: "Windows.Globalization.ICurrencyIdentifiersStatics"
  // Statics: "Windows.Globalization.ICurrencyIdentifiersStatics2"
  // Statics: "Windows.Globalization.ICurrencyIdentifiersStatics3"
  TCurrencyIdentifiers = class(TWinRTGenericImportS3<ICurrencyIdentifiersStatics, ICurrencyIdentifiersStatics2, ICurrencyIdentifiersStatics3>)
  public
    ...
    class function get_BYN: HSTRING; static; inline;
    class property BYN: HSTRING read get_BYN;

    // -> ICurrencyIdentifiersStatics3
    class function get_MRU: HSTRING; static; inline;
    class function get_SSP: HSTRING; static; inline;
    class function get_STN: HSTRING; static; inline;
    class function get_VES: HSTRING; static; inline;
    class property MRU: HSTRING read get_MRU;
    class property SSP: HSTRING read get_SSP;
    class property STN: HSTRING read get_STN;
    class property VES: HSTRING read get_VES;
  end;

  // Windows.Globalization.DateTimeFormatting.DateTimeFormatter
  // DualAPI
  // Implements: Windows.Globalization.DateTimeFormatting.IDateTimeFormatter
  // Implements: Windows.Globalization.DateTimeFormatting.IDateTimeFormatter2
  // Statics: "Windows.Globalization.DateTimeFormatting.IDateTimeFormatterStatics"
  ...
  // Statics: "Windows.Globalization.IGeographicRegionStatics"
  // Factory: "Windows.Globalization.IGeographicRegionFactory"
  // Instantiable: "IGeographicRegion"
  ...
  // DualAPI
  // Implements: Windows.Globalization.ILanguage
  // Implements: Windows.Globalization.ILanguageExtensionSubtags
  // Implements: Windows.Globalization.ILanguage2
  // Implements: Windows.Globalization.ILanguage3
  // Statics: "Windows.Globalization.ILanguageStatics"
  // Statics: "Windows.Globalization.ILanguageStatics2"
  // Statics: "Windows.Globalization.ILanguageStatics3"
  // Factory: "Windows.Globalization.ILanguageFactory"
  TLanguage = class(TWinRTGenericImportFS3<ILanguageFactory, ILanguageStatics, ILanguageStatics2, ILanguageStatics3>)
  public
    // -> ILanguageStatics
    ...
    // -> ILanguageStatics3
    class function GetMuiCompatibleLanguageListFromLanguageTags(languageTags: IIterable_1__HSTRING): IVector_1__HSTRING; static; inline;
  ...
  // DualAPI
  // Implements: Windows.Globalization.NumberFormatting.ICurrencyFormatter
  // Implements: Windows.Globalization.NumberFormatting.INumberParser
  // Implements: Windows.Globalization.NumberFormatting.INumberFormatter2
  // Implements: Windows.Globalization.NumberFormatting.INumberFormatter
  // Implements: Windows.Globalization.NumberFormatting.INumberFormatterOptions
  // Implements: Windows.Globalization.NumberFormatting.ICurrencyFormatter2
  // Implements: Windows.Globalization.NumberFormatting.ISignificantDigitsOption
  // Implements: Windows.Globalization.NumberFormatting.INumberRounderOption
  // Implements: Windows.Globalization.NumberFormatting.ISignedZeroOption
  ...
  // Instantiable: "NumberFormatting_INumberFormatterOptions"
  ...
  // DualAPI
  // Implements: Windows.Globalization.NumberFormatting.INumberRounder
  // Implements: Windows.Globalization.NumberFormatting.IIncrementNumberRounder
  // Instantiable: "NumberFormatting_IIncrementNumberRounder"
  ...
  // DualAPI
  // Implements: Windows.Globalization.NumberFormatting.INumeralSystemTranslator
  // Factory: "Windows.Globalization.NumberFormatting.INumeralSystemTranslatorFactory"
  // Instantiable: "NumberFormatting_INumeralSystemTranslator"
  ...
  // DualAPI
  // Implements: Windows.Globalization.NumberFormatting.INumberRounder
  // Implements: Windows.Globalization.NumberFormatting.ISignificantDigitsNumberRounder
  // Instantiable: "NumberFormatting_ISignificantDigitsNumberRounder"
  ...
  // DualAPI
  // Statics: "Windows.Globalization.INumeralSystemIdentifiersStatics"
  // Statics: "Windows.Globalization.INumeralSystemIdentifiersStatics2"
...
class function TCalendarIdentifiers.get_ChineseLunar: HSTRING;
begin
  Result := Statics3.get_ChineseLunar;
end;

class function TCalendarIdentifiers.get_JapaneseLunar: HSTRING;
begin
  Result := Statics3.get_JapaneseLunar;
end;

class function TCalendarIdentifiers.get_KoreanLunar: HSTRING;
begin
  Result := Statics3.get_KoreanLunar;
end;

class function TCalendarIdentifiers.get_TaiwanLunar: HSTRING;
begin
  Result := Statics3.get_TaiwanLunar;
end;

class function TCalendarIdentifiers.get_VietnameseLunar: HSTRING;
begin
  Result := Statics3.get_VietnameseLunar;
end;
...
// Factories for : "Collation_CharacterGroupings"
// Factory: "Windows.Globalization.Collation.ICharacterGroupingsFactory"
// -> Collation_ICharacterGroupingsFactory

class function TCollation_CharacterGroupings.Create(language: HSTRING): Collation_ICharacterGroupings;
begin
  Result := Factory.Create(language);
end;
...
class function TCurrencyIdentifiers.get_BYN: HSTRING;
begin
  Result := Statics2.get_BYN;
end;


class function TCurrencyIdentifiers.get_MRU: HSTRING;
begin
  Result := Statics3.get_MRU;
end;

class function TCurrencyIdentifiers.get_SSP: HSTRING;
begin
  Result := Statics3.get_SSP;
end;

class function TCurrencyIdentifiers.get_STN: HSTRING;
begin
  Result := Statics3.get_STN;
end;

class function TCurrencyIdentifiers.get_VES: HSTRING;
begin
  Result := Statics3.get_VES;
end;
...
class function TLanguage.GetMuiCompatibleLanguageListFromLanguageTags(languageTags: IIterable_1__HSTRING): IVector_1__HSTRING;
begin
  Result := Statics3.GetMuiCompatibleLanguageListFromLanguageTags(languageTags);
end;
