...
//
  ...
  FIXED_INFO = record
    HostName: array [0..MAX_HOSTNAME_LEN + 3] of u_char;
    DomainName: array[0..MAX_DOMAIN_NAME_LEN + 3] of u_char;
    CurrentDnsServer: PIP_ADDR_STRING;
    DnsServerList: IP_ADDR_STRING;
    NodeType: UINT;
    ScopeId: array [0..MAX_SCOPE_ID_LEN + 3] of u_char;
    EnableRouting: UINT;
    EnableProxy: UINT;
    EnableDns: UINT;
  end;
