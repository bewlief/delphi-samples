...
function GetGPOList(hToken: THandle; lpName, lpHostName, lpComputerName: LPWSTR;
    dwFlags: DWORD; out pGPOList: PGroupPolicyObject): BOOL; stdcall;
{$EXTERNALSYM GetGPOList}
function GetGPOListA(hToken: THandle; lpName, lpHostName, lpComputerName: LPSTR;
    dwFlags: DWORD; out pGPOList: PGroupPolicyObjectA): BOOL; stdcall;
{$EXTERNALSYM GetGPOListA}
function GetGPOListW(hToken: THandle; lpName, lpHostName, lpComputerName: LPWSTR;
    dwFlags: DWORD; out pGPOList: PGroupPolicyObjectW): BOOL; stdcall;
{$EXTERNALSYM GetGPOListW}

function FreeGPOList(pGPOList: PGroupPolicyObject): BOOL; stdcall;
{$EXTERNALSYM FreeGPOList}
function FreeGPOListA(pGPOList: PGroupPolicyObjectA): BOOL; stdcall;
{$EXTERNALSYM FreeGPOListA}
function FreeGPOListW(pGPOList: PGroupPolicyObjectW): BOOL; stdcall;
{$EXTERNALSYM FreeGPOListW}

function GetAppliedGPOList(dwFlags: DWORD; pMachineName: LPWSTR; pSidUser: PSID;
    const pGuidExtension: TGUID; out ppGPOList: PGroupPolicyObject): DWORD; stdcall;
{$EXTERNALSYM GetAppliedGPOList}
function GetAppliedGPOListA(dwFlags: DWORD; pMachineName: LPSTR; pSidUser: PSID;
    const pGuidExtension: TGUID; out ppGPOList: PGroupPolicyObjectA): DWORD; stdcall;
{$EXTERNALSYM GetAppliedGPOListA}
function GetAppliedGPOListW(dwFlags: DWORD; pMachineName: LPWSTR; pSidUser: PSID;
    const pGuidExtension: TGUID; out ppGPOList: PGroupPolicyObjectW): DWORD; stdcall;
...
function RsopSetPolicySettingStatus(dwFlags: DWORD; const pServices: IWbemServices;
    const pSettingInstance: IWbemClassObject; nInfo: DWORD; const pStatus: TPolicySettingStatusInfo): HRESULT; stdcall;
{$EXTERNALSYM RsopSetPolicySettingStatus}

function RsopResetPolicySettingStatus(dwFlags: DWORD; const pServices: IWbemServices;
    const pSettingInstance: IWbemClassObject): HRESULT; stdcall;
...
function GetGPOList(hToken: THandle; lpName, lpHostName, lpComputerName: LPWSTR;
    dwFlags: DWORD; out pGPOList:PGroupPolicyObject): BOOL; external userenv name 'GetGPOListW';
function GetGPOListA(hToken: THandle; lpName, lpHostName, lpComputerName: LPSTR;
    dwFlags: DWORD; out pGPOList:PGroupPolicyObjectA): BOOL; external userenv name 'GetGPOListA';
function GetGPOListW(hToken: THandle; lpName, lpHostName, lpComputerName: LPWSTR;
    dwFlags: DWORD; out pGPOList:PGroupPolicyObjectW): BOOL; external userenv name 'GetGPOListW';

function FreeGPOList(pGPOList: PGroupPolicyObject): BOOL; external userenv name 'FreeGPOListW';
function FreeGPOListA(pGPOList: PGroupPolicyObjectA): BOOL; external userenv name 'FreeGPOListA';
function FreeGPOListW(pGPOList: PGroupPolicyObjectW): BOOL; external userenv name 'FreeGPOListW';
