...
type
  ...
  HSE_VERSION_INFO = record
    ...
    lpszExtensionDesc: array [0..HSE_MAX_EXT_DLL_NAME_LEN-1] of UTF8Char;
  end;
...
type
  ...
  TEXTENSION_CONTROL_BLOCK = record
    ...
    lpszLogData: array [0..HSE_LOG_BUFFER_LEN-1] of UTF8Char;
    lpszMethod: PUTF8Char;                // REQUEST_METHOD
    lpszQueryString: PUTF8Char;           // QUERY_STRING
    lpszPathInfo: PUTF8Char;              // PATH_INFO
    lpszPathTranslated: PUTF8Char;        // PATH_TRANSLATED
    ...
    lpszContentType: PUTF8Char;           // Content type of client data
...
//
  ...
  THSE_TF_INFO = record
    ...
    pszStatusCode: PUTF8Char; // HTTP Status Code  eg: "200 OK"
...
type
  ...
  TFilterGetServerVariableProc = function (var pfc{: THTTP_FILTER_CONTEXT};
    VariableName: PUTF8Char; Buffer: Pointer; var Size: DWORD ): BOOL; stdcall;

  TFilterAddResponseHeadersProc = function (var pfc{: THTTP_FILTER_CONTEXT};
    lpszHeaders: PUTF8Char; dwReserved: DWORD): BOOL; stdcall;
...
type
  ...
  HTTP_FILTER_ACCESS_DENIED = record
    pszURL: PUTF8Char;            // Requesting URL
    pszPhysicalPath: PUTF8Char;   // Physical path of resource
  ...
  HTTP_FILTER_LOG = record
    pszClientHostName: PUTF8Char;
    pszClientUserName: PUTF8Char;
    pszServerName: PUTF8Char;
    pszOperation: PUTF8Char;
    pszTarget: PUTF8Char;
    pszParameters: PUTF8Char;
    dwHttpStatus: DWORD;
    dwWin32Status: DWORD;
...
type
  ...
  HTTP_FILTER_VERSION = record
    ...
    lpszFilterDesc: array[0..SF_MAX_FILTER_DESC_LEN - 1] of UTF8Char;
    dwFlags: DWORD;
  end;
