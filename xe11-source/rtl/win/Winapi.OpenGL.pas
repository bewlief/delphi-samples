...
{  Extensions }
  ...
  GL_EXT_bgra = 1; 
  {$EXTERNALSYM GL_EXT_bgra}
  GL_EXT_paletted_texture = 1; 
  {$EXTERNALSYM GL_EXT_paletted_texture}
  GL_WIN_swap_hint = 1; 
  {$EXTERNALSYM GL_WIN_swap_hint}
  GL_WIN_draw_range_elements = 1; 
  {$EXTERNALSYM GL_WIN_draw_range_elements}
...
{  WIN_draw_range_elements }
  ...
  {$EXTERNALSYM GL_MAX_ELEMENTS_VERTICES_WIN}
  GL_MAX_ELEMENTS_INDICES_WIN = $80E9;
  {$EXTERNALSYM GL_MAX_ELEMENTS_INDICES_WIN}
...
procedure glCopyTexImage1D (target: GLenum; level: GLint; internalFormat: GLenum; x: GLint; y: GLint;
...
procedure glCopyTexSubImage1D (target: GLenum; level: GLint; xoffset: GLint; x: GLint; y: GLint;
...
procedure glDrawElements (mode: GLenum; count: GLsizei; atype: GLenum; indices: Pointer); stdcall;
...
procedure glEdgeFlagPointer (stride: GLsizei; pointer: Pointer); stdcall;
...
procedure glIndexPointer (type_: GLenum; stride: GLsizei; pointer: Pointer); stdcall;
  {$EXTERNALSYM glIndexPointer}
procedure glInitNames; stdcall;
  {$EXTERNALSYM glInitNames}
procedure glInterleavedArrays (format: GLenum; stride: GLsizei; pointer: Pointer); stdcall;
...
procedure glGetPointerv (pname: GLenum; params: Pointer); stdcall;
...
procedure glTexSubImage1D (target: GLenum; level: GLint; xoffset: GLint; width: GLsizei; format: GLenum; atype: GLenum; pixels: Pointer); stdcall;
  {$EXTERNALSYM glTexSubImage1D}
procedure glTexSubImage2D (target: GLenum; level: GLint; xoffset: GLint; yoffset: GLint; width: GLsizei; height: GLsizei; format: GLenum; atype: GLenum; pixels: Pointer); stdcall;
...
function  glAreTexturesResident; external opengl32;
...
procedure glCopyTexSubImage1D; external opengl32;
procedure glCopyTexSubImage2D; external opengl32;
...
procedure glEdgeFlagPointer; external opengl32;
...
procedure glGetPointerv; external opengl32;
...
procedure glIndexPointer; external opengl32;
...
procedure glPopClientAttrib; external opengl32;
procedure glPopMatrix; external opengl32;
procedure glPopName; external opengl32;
procedure glPrioritizeTextures; external opengl32;
...
procedure glTexSubImage1D; external opengl32;
procedure glTexSubImage2D; external opengl32;
