...
type
  ...
  {$EXTERNALSYM TA_PROPERTY_FLAG}

function GetThemeAnimationProperty(hTheme: HTHEME; iStoryboardId: Integer; iTargetId: Integer; eProperty: TA_PROPERTY;
                                   pvProperty: Pointer; cbSize: DWORD; pcbSizeOut: LPDWORD): HRESULT; stdcall;
{$EXTERNALSYM GetThemeAnimationProperty}
...
type
  ...
  {$EXTERNALSYM TA_TRANSFORM_FLAG}

  TA_TRANSFORM_ = record
  var
  ...
  {$EXTERNALSYM TA_TRANSFORM_}
  TA_TRANSFORM = TA_TRANSFORM_;
  {$EXTERNALSYM TA_TRANSFORM}
  PTA_TRANSFORM = ^TA_TRANSFORM_;
  {$EXTERNALSYM PTA_TRANSFORM}

  TA_TRANSFORM_2D_ = record
  var
    header: TA_TRANSFORM;
    rX: Single;
    rY: Single;
  ...
  {$EXTERNALSYM TA_TRANSFORM_2D_}
  TA_TRANSFORM_2D = TA_TRANSFORM_2D_;
  {$EXTERNALSYM TA_TRANSFORM_2D}
  PTA_TRANSFORM_2D = ^TA_TRANSFORM_2D_;
  {$EXTERNALSYM PTA_TRANSFORM_2D}

  TA_TRANSFORM_OPACITY_ = record
  var
    header: TA_TRANSFORM;
    rOpacity: Single;
    rInitialOpacity: Single;
  end;
  {$EXTERNALSYM TA_TRANSFORM_OPACITY_}
  PTA_TRANSFORM_OPACITY = ^TA_TRANSFORM_OPACITY_;
  {$EXTERNALSYM PTA_TRANSFORM_OPACITY}

  TA_TRANSFORM_CLIP_ = record
  var
    header: TA_TRANSFORM;
    rLeft: Single;
    rTop: Single;
  ...
  {$EXTERNALSYM TA_TRANSFORM_CLIP_}
  TA_TRANSFORM_CLIP = TA_TRANSFORM_CLIP_;
  {$EXTERNALSYM TA_TRANSFORM_CLIP}
  PTA_TRANSFORM_CLIP = ^TA_TRANSFORM_CLIP_;
  {$EXTERNALSYM PTA_TRANSFORM_CLIP}

function GetThemeAnimationTransform(hTheme: HTHEME; iStoryboardId: Integer; iTargetId: Integer; dwTransformIndex: DWORD;
                                    pTransform: PTA_TRANSFORM; cbSize: DWORD; pcbSizeOut: LPDWORD): HRESULT; stdcall;
  {$EXTERNALSYM GetThemeAnimationTransform}
...
type
  ...
  {$EXTERNALSYM TA_TIMINGFUNCTION_TYPE}

  TA_TIMINGFUNCTION_ = record
  var
    eTimingFunctionType: TA_TIMINGFUNCTION_TYPE;
  end;
  {$EXTERNALSYM TA_TIMINGFUNCTION_}
  TA_TIMINGFUNCTION = TA_TIMINGFUNCTION_;
  {$EXTERNALSYM TA_TIMINGFUNCTION}
  PTA_TIMINGFUNCTION = ^TA_TIMINGFUNCTION_;
  {$EXTERNALSYM PTA_TIMINGFUNCTION}

  TA_CUBIC_BEZIER_ = record
  var
  ...
  {$EXTERNALSYM TA_CUBIC_BEZIER_}
  TA_CUBIC_BEZIER = TA_CUBIC_BEZIER_;
  {$EXTERNALSYM TA_CUBIC_BEZIER}
  PTA_CUBIC_BEZIER = ^TA_CUBIC_BEZIER_;
  {$EXTERNALSYM PTA_CUBIC_BEZIER}

function GetThemeTimingFunction(hTheme: HTHEME; iTimingFunctionId: Integer; pTimingFunction: PTA_TIMINGFUNCTION;
                                cbSize: DWORD; pcbSizeOut: LPDWORD): HRESULT; stdcall;
  {$EXTERNALSYM GetThemeTimingFunction}
...
const
  ...
  {$EXTERNALSYM MAX_INTLIST_COUNT_600}
...
{$EXTERNALSYM OpenThemeDataForDpi}
...
function GetThemeAnimationProperty; external themelib name 'GetThemeAnimationProperty' delayed;
function GetThemeAnimationTransform; external themelib name 'GetThemeAnimationTransform' delayed;
function GetThemeTimingFunction; external themelib name 'GetThemeTimingFunction' delayed;
