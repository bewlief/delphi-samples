...
const
  ...
  {$EXTERNALSYM DM_POINTERHITTEST}
  WM_POINTERROUTEDTO       = $0251;
  {$EXTERNALSYM WM_POINTERROUTEDTO}
  WM_POINTERROUTEDAWAY     = $0252;
  {$EXTERNALSYM WM_POINTERROUTEDAWAY}
  WM_POINTERROUTEDRELEASED = $0253;
  {$EXTERNALSYM WM_POINTERROUTEDRELEASED}
