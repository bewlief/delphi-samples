...
const
  ...
  {$EXTERNALSYM DBPROPVAL_SQ_TABLE}
...
// *********************************************************************//
  IRowset = interface(IUnknown)
    ...
    function AddRefRows(cRows: ULONG_PTR; rghRows: PULONG_PTRArray; rgRefCounts: PUintArray;
    ...
    function GetNextRows(hReserved: HCHAPTER; lRowsOffset: LONG_PTR; cRows: LONG_PTR;
      out pcRowsObtained: ULONG_PTR; var prghRows: PULONG_PTRArray): HResult; stdcall;
    function ReleaseRows(cRows: ULONG_PTR; rghRows: PULONG_PTRArray; rgRowOptions,
  ...
  IRowsetSC = interface(IUnknown)
    ['{0C733A7C-2A1C-11CE-ADE5-00AA0044773D}']
    procedure AddRefRows(cRows: ULONG_PTR; rghRows: PULONG_PTRArray; rgRefCounts: PUintArray;
    ...
    procedure GetNextRows(hReserved: HCHAPTER; lRowsOffset: LONG_PTR; cRows: LONG_PTR;
      out pcRowsObtained: ULONG_PTR; var prghRows: PULONG_PTRArray); safecall;
    procedure ReleaseRows(cRows: ULONG_PTR; rghRows: PULONG_PTRArray; rgRowOptions,
...
// *********************************************************************//
  IRowsetLocate = interface(IRowset)
    ...
    function GetRowsByBookmark(hReserved: HCHAPTER; cRows: ULONG_PTR; rgcbBookmarks: PULONG_PTRArray;
      rgpBookmarks: PPByteArray; rghRows: PULONG_PTRArray; rgRowStatus: PUintArray): HResult; stdcall;
  ...
  IRowsetLocateSC = interface(IRowsetSC)
    ...
    procedure GetRowsByBookmark(hReserved: HCHAPTER; cRows: ULONG_PTR; rgcbBookmarks: PULONG_PTRArray;
      rgpBookmarks: PPByteArray; rghRows: PULONG_PTRArray; rgRowStatus: PUintArray); safecall;
...
// *********************************************************************//
  IRowsetResynch = interface(IUnknown)
    ...
    function ResynchRows(cRows: ULONG_PTR; rghRows: PULONG_PTRArray; pcRowsResynched: PULONG_PTR;
  ...
  IRowsetResynchSC = interface(IUnknown)
    ...
    procedure ResynchRows(cRows: ULONG_PTR; rghRows: PULONG_PTRArray; pcRowsResynched: PULONG_PTR;
...
// *********************************************************************//
  IRowsetChange = interface(IUnknown)
    ...
    function DeleteRows(hReserved: HCHAPTER; cRows: ULONG_PTR; rghRows: PULONG_PTRArray;
      rgRowStatus: PUintArray): HResult; stdcall;
  ...
  IRowsetChangeSC = interface(IUnknown)
    ['{0C733A05-2A1C-11CE-ADE5-00AA0044773D}']
    procedure DeleteRows(hReserved: HCHAPTER; cRows: ULONG_PTR; rghRows: PULONG_PTRArray;
      rgRowStatus: PUintArray); safecall;
...
// *********************************************************************//
  IRowsetUpdate = interface(IRowsetChange)
    ...
    function GetRowStatus(hReserved: HCHAPTER; cRows: ULONG_PTR; rghRows: PULONG_PTRArray;
      rgPendingStatus: PUintArray): HResult; stdcall;
    function Undo(hReserved: HCHAPTER; cRows: ULONG_PTR; rghRows: PULONG_PTRArray; pcRowsUndone: PULONG_PTR;
      prgRowsUndone: PPHROW; prgRowStatus: PPDBROWSTATUS): HResult; stdcall;
    function Update(hReserved: HCHAPTER; cRows: ULONG_PTR; rghRows: PULONG_PTRArray; pcRows: PULONG_PTR;
  ...
  IRowsetUpdateSC = interface(IRowsetChangeSC)
    ...
    procedure GetRowStatus(hReserved: HCHAPTER; cRows: ULONG_PTR; rghRows: PULONG_PTRArray;
      rgPendingStatus: PUintArray); safecall;
    procedure Undo(hReserved: HCHAPTER; cRows: ULONG_PTR; rghRows: PULONG_PTRArray; pcRowsUndone: PULONG_PTR;
      prgRowsUndone: PPHROW; prgRowStatus: PPDBROWSTATUS); safecall;
    procedure Update(hReserved: HCHAPTER; cRows: ULONG_PTR; rghRows: PULONG_PTRArray; pcRows: PULONG_PTR;
...
// *********************************************************************//
  ...
  { PGUID Version }
  ICommandTextP = interface(ICommand)
    ['{0C733A27-2A1C-11CE-ADE5-00AA0044773D}']
    function GetCommandText(pguidDialect: PGUID;
      out ppwszCommand: PWideChar): HResult; stdcall;
    function SetCommandText(const guidDialect: TGUID;
      pwszCommand: PWideChar): HResult; stdcall;
  end;
  ...
  { Safecall and PGUID Version }
  ICommandTextSCP = interface(ICommandSC)
    ['{0C733A27-2A1C-11CE-ADE5-00AA0044773D}']
    procedure GetCommandText(pguidDialect: PGUID;
      out ppwszCommand: PWideChar); safecall;
    procedure SetCommandText(const guidDialect: TGUID;
      pwszCommand: PWideChar); safecall;
  end;
...
// *********************************************************************//
  ...
  { Safecall Version }
  ITransactionLocalSC = interface(ITransactionSC)
    ['{0C733A5F-2A1C-11CE-ADE5-00AA0044773D}']
    procedure GetOptionsObject(out ppOptions: ITransactionOptions); safecall;
...
// *********************************************************************//
  IRowsetRefresh = interface(IUnknown)
    ...
    function RefreshVisibleData(HCHAPTER: HCHAPTER; cRows: ULONG_PTR; rghRows: PULONG_PTRArray;
  ...
  IRowsetRefreshSC = interface(IUnknown)
    ['{0C733AA9-2A1C-11CE-ADE5-00AA0044773D}']
    procedure RefreshVisibleData(HCHAPTER: HCHAPTER; cRows: ULONG_PTR; rghRows: PULONG_PTRArray;
      fOverWrite: BOOL; pcRowsRefreshed: PULONG_PTR;
