...
unit Winapi.DirectInput;

interface

uses
  Winapi.Windows, Winapi.MMSystem, Winapi.DXTypes;
...
type
  ...
  _DICONFIGUREDEVICESPARAMSA = record
     dwSize:         DWORD;
     dwcUsers:       DWORD;
     lptszUserNames: LPCSTR;
     dwcFormats:     DWORD;
  ...
  _DICONFIGUREDEVICESPARAMSW = record
     dwSize:         DWORD;
     dwcUsers:       DWORD;
     lptszUserNames: LPCWSTR;
     dwcFormats:     DWORD;
...
type
  ...
  _DIDEVICEIMAGEINFOHEADERA = record
    dwSize:             DWORD;
  ...
  _DIDEVICEIMAGEINFOHEADERW = record
    dwSize:             DWORD;
    dwSizeImageInfo:    DWORD;
    dwcViews:           DWORD;
    dwcButtons:         DWORD;
...
type
  ...
  PDIDeviceObjectInstanceDX3 = PDIDeviceObjectInstanceDX3W;
  DIDEVICEOBJECTINSTANCE_DX3A = record
    dwSize:   DWORD;
    guidType: TGUID;
    dwOfs:    DWORD;
    dwType:   DWORD;
  ...
  DIDEVICEOBJECTINSTANCE_DX3W = record
    dwSize:   DWORD;
    guidType: TGUID;
    dwOfs:    DWORD;
    dwType:   DWORD;
  ...
  TDIDeviceObjectInstanceDX3 = TDIDeviceObjectInstanceDX3W;
...
type
  ...
  TDIEnumDeviceObjectsCallback = TDIEnumDeviceObjectsCallbackW;
...
type
  ...
  PDIDeviceInstanceDX3 = PDIDeviceInstanceDX3W;
  DIDEVICEINSTANCE_DX3A = record
    dwSize: DWORD;
    guidInstance: TGUID;
    guidProduct: TGUID;
    dwDevType: DWORD;
  ...
  TDIDeviceInstanceDX3 = TDIDeviceInstanceDX3W;
 (* DIRECTINPUT_VERSION >= 0x0500 *)
...
type
  ...
  TDIEnumEffectsCallback = TDIEnumEffectsCallbackW;
...
type
  ...
  IDirectInputDevice7A = interface(IDirectInputDevice2A)
    ...
    function EnumEffectsInFile(lpszFileName: LPCSTR; pec: TDIEnumEffectsInFileCallback; pvRef: Pointer; dwFlags: DWORD): HResult; stdcall;
    function WriteEffectToFile(lpszFileName: LPCSTR; dwEntries: DWORD; rgDiFileEft: PDIFileEffect; dwFlags: DWORD): HResult; stdcall;
  end;
  ...
  IDirectInputDevice7W = interface(IDirectInputDevice2W)
    ...
    function EnumEffectsInFile(lpszFileName: LPCWSTR; pec: TDIEnumEffectsInFileCallback; pvRef: Pointer; dwFlags: DWORD): HResult; stdcall;
    function WriteEffectToFile(lpszFileName: LPCWSTR; dwEntries: DWORD; rgDiFileEft: PDIFileEffect; dwFlags: DWORD): HResult; stdcall;
  end;
...
type
  ...
  IDirectInputDevice8A = interface(IDirectInputDevice7A)
    ...
    function BuildActionMap(out lpdiaf: TDIActionFormatA; lpszUserName: LPCSTR; dwFlags: DWORD): HResult; stdcall;
    function SetActionMap(var lpdiActionFormat: TDIActionFormatA; lptszUserName: LPCSTR; dwFlags: DWORD): HResult; stdcall;
  ...
  IDirectInputDevice8W = interface(IDirectInputDevice7W)
    ...
    function BuildActionMap(out lpdiaf: TDIActionFormatW; lpszUserName: LPCWSTR; dwFlags: DWORD): HResult; stdcall;
    function SetActionMap(var lpdiActionFormat: TDIActionFormatW; lptszUserName: LPCWSTR; dwFlags: DWORD): HResult; stdcall;
...
type
  ...
  TDIEnumDevicesCallback = TDIEnumDevicesCallbackW;
...
type
  ...
  IDirectInput2A = interface(IDirectInputA)
    ...
    function FindDevice(const rguidClass: TGUID; ptszName: LPCSTR; out pguidInstance: TGUID): HResult; stdcall;
  end;
  ...
  IDirectInput2W = interface(IDirectInputW)
    ...
    function FindDevice(const rguidClass: TGUID; ptszName: LPCWSTR; out pguidInstance: TGUID): HResult; stdcall;
  end;
...
type
  ...
  IDirectInput8A = interface(IUnknown)
    ...
    function Initialize(hinst: THandle; dwVersion: DWORD): HResult; stdcall;
    function FindDevice(const rguidClass: TGUID; ptszName: LPCSTR; out pguidInstance: TGUID): HResult; stdcall;
    function EnumDevicesBySemantics(ptszUserName: LPCSTR; const lpdiActionFormat: TDIActionFormatA; lpCallback: TDIEnumDevicesBySemanticsCallbackA; pvRef: Pointer; dwFlags: DWORD): HResult; stdcall;
  ...
  IDirectInput8W = interface(IUnknown)
    ...
    function Initialize(hinst: THandle; dwVersion: DWORD): HResult; stdcall;
    function FindDevice(const rguidClass: TGUID; ptszName: LPCWSTR; out pguidInstance: TGUID): HResult; stdcall;
    function EnumDevicesBySemantics(ptszUserName: LPCWSTR; const lpdiActionFormat: TDIActionFormatW; lpCallback: TDIEnumDevicesBySemanticsCallbackW; pvRef: Pointer; dwFlags: DWORD): HResult; stdcall;
