...
function WindowFromAccessibleObject(Accessible: IAccessible; var phwnd: THandle): HRESULT; stdcall;
...
function WindowFromAccessibleObject; external 'oleacc.dll' name 'WindowFromAccessibleObject';
function AccessibleObjectFromWindow; external 'oleacc.dll' name 'AccessibleObjectFromWindow';
function AccessibleObjectFromEvent; external 'oleacc.dll' name 'AccessibleObjectFromEvent';
function AccessibleObjectFromPoint; external 'oleacc.dll' name 'AccessibleObjectFromPoint';
function AccessibleChildren; external 'oleacc.dll' name 'AccessibleChildren';
