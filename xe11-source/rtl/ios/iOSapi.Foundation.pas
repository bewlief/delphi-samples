...
function NSDecimalIsNotANumber(dcm: PNSDecimal): Boolean; cdecl; inline;
...
// ===== Interface declarations =====
  ...
  NSObject = interface(IObjectiveCInstance)
    ...
    procedure removeObserver(observer: NSObject; forKeyPath: NSString); overload; cdecl;
    [MethodName('removeObserver:forKeyPath:context:')]
    procedure removeObserver(observer: NSObject; forKeyPath: NSString; context: Pointer); overload; cdecl;
...
//    function initWithCString(bytes: MarshaledAString; length: NSUInteger): Pointer; cdecl; overload;
  ...
  NSJSONSerializationClass = interface(NSObjectClass)
    ...
    {class} function JSONObjectWithData(data: NSData; options: NSJSONReadingOptions; error: PPointer = nil): Pointer; cdecl;
    {class} function JSONObjectWithStream(stream: NSInputStream; options: NSJSONReadingOptions; error: PPointer = nil): Pointer; cdecl;
    {class} function dataWithJSONObject(obj: Pointer; options: NSJSONWritingOptions; error: PPointer = nil): NSData; cdecl;
    {class} function isValidJSONObject(obj: Pointer): Boolean; cdecl;
    {class} function writeJSONObject(obj: Pointer; toStream: NSOutputStream; options: NSJSONWritingOptions; error: PPointer = nil): NSInteger; cdecl;
  end;
  ...
  NSRegularExpressionClass = interface(NSObjectClass)
    ...
    {class} function regularExpressionWithPattern(pattern: NSString; options: NSRegularExpressionOptions; error: PPointer = nil): Pointer; cdecl;
  end;
  NSRegularExpression = interface(NSObject)
    ...
    function initWithPattern(pattern: NSString; options: NSRegularExpressionOptions; error: PPointer = nil): Pointer; cdecl;
...
(*  Use hand-coded NSObject instead of this.
  ...
  NSObject = interface(IObjectiveCInstance)
    ...
    function validateValue(ioValue: Pointer; forKey: NSString; error: PPointer = nil): Boolean; cdecl; overload;
    function validateValue(ioValue: Pointer; forKeyPath: NSString; error: PPointer = nil): Boolean; cdecl; overload;
    function valueForKey(key: NSString): Pointer; cdecl;
    function valueForKeyPath(keyPath: NSString): Pointer; cdecl;
...
//    function completionBlock: void (^)(void); cdecl;
  ...
  NSFileVersionClass = interface(NSObjectClass)
    ...
    {class} function addVersionOfItemAtURL(url: NSURL; withContentsOfURL: NSURL; options: NSFileVersionAddingOptions; error: PPointer = nil): Pointer; cdecl;
...
//    function writeabilityHandler: void (^)(NSFileHandle ; cdecl;
  ...
  NSFileManager = interface(NSObject)
    ...
    function createDirectoryAtURL(url: NSURL; withIntermediateDirectories: Boolean; attributes: NSDictionary; error: PPointer = nil): Boolean; cdecl;
  ...
  NSDataDetectorClass = interface(NSRegularExpressionClass)
    ...
    {class} function dataDetectorWithTypes(checkingTypes: NSTextCheckingTypes; error: PPointer = nil): Pointer; cdecl;
  end;
  NSDataDetector = interface(NSRegularExpression)
    ...
    function initWithTypes(checkingTypes: NSTextCheckingTypes; error: PPointer = nil): Pointer; cdecl;
  end;
...
begin
  Result := (dcm._length = 0) and (dcm._isNegative <> 0);
end;
