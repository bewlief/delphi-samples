...
uses Posix.StdDef, Macapi.CoreFoundation, iOSapi.Foundation, iOSapi.CoreGraphics, iOSapi.OpenGLES;
...
function CVOpenGLESTextureCacheCreateTextureFromImage(allocator: CFAllocatorRef; textureCache: CVOpenGLESTextureCacheRef; sourceImage: CVImageBufferRef; textureAttributes: CFDictionaryRef; target: GLenum; internalFormat: GLint; width: GLsizei; height: GLsizei; format: GLenum; type_: GLenum; planeIndex: size_t; textureOut: PCVOpenGLESTextureRef): CVReturn; cdecl; external libCoreVideo name _PU + 'CVOpenGLESTextureCacheCreateTextureFromImage';
