...
uses
  Macapi.ObjectiveC, iOSapi.CocoaTypes, iOSapi.Foundation, iOSapi.CoreGraphics;
...
// ===== Interface declarations =====
  ...
  ALAssetRepresentation = interface(NSObject)
    ...
    function getBytes(buffer: PByte; fromOffset: Int64; length: NSUInteger; error: PPointer = nil): NSUInteger; cdecl;
