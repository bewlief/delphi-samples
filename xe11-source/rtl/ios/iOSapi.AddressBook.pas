...
function ABAddressBookErrorDomain:  CFStringRef;
function kABSourceNameProperty: ABPropertyID;
function kABSourceTypeProperty: ABPropertyID;
function kABWorkLabel: NSString;
function kABHomeLabel: NSString;
function kABOtherLabel: NSString;
function kABPersonFirstNameProperty: ABPropertyID;
function kABPersonLastNameProperty: ABPropertyID;
function kABPersonMiddleNameProperty: ABPropertyID;
function kABPersonPrefixProperty: ABPropertyID;
function kABPersonSuffixProperty: ABPropertyID;
function kABPersonNicknameProperty: ABPropertyID;
function kABPersonFirstNamePhoneticProperty: ABPropertyID;
function kABPersonLastNamePhoneticProperty: ABPropertyID;
function kABPersonMiddleNamePhoneticProperty: ABPropertyID;
function kABPersonOrganizationProperty: ABPropertyID;
function kABPersonJobTitleProperty: ABPropertyID;
function kABPersonDepartmentProperty: ABPropertyID;
function kABPersonEmailProperty: ABPropertyID;
function kABPersonBirthdayProperty: ABPropertyID;
function kABPersonNoteProperty: ABPropertyID;
function kABPersonCreationDateProperty: ABPropertyID;
function kABPersonModificationDateProperty: ABPropertyID;
function kABPersonAddressProperty: ABPropertyID;
...
function kABPersonDateProperty: ABPropertyID;
function kABPersonAnniversaryLabel: NSString;
function kABPersonKindProperty: ABPropertyID;
function kABPersonKindPerson: CFNumberRef;
function kABPersonKindOrganization: CFNumberRef;
function kABPersonPhoneProperty: ABPropertyID;
...
function kABPersonInstantMessageProperty: ABPropertyID;
...
function kABPersonURLProperty: ABPropertyID;
function kABPersonHomePageLabel: NSString;
function kABPersonRelatedNamesProperty: ABPropertyID;
...
function kABPersonSocialProfileProperty: ABPropertyID;
...
function kABPersonAlternateBirthdayProperty: ABPropertyID;
...
function kABGroupNameProperty: ABPropertyID;
...
function ABAddressBookErrorDomain: CFStringRef;
begin
  Result := CocoaObjectIdConst(libAddressBook, 'ABAddressBookErrorDomain');
end;
...
function kABPersonKindPerson: CFNumberRef;
begin
  Result := CocoaObjectIdConst(libAddressBook, 'kABPersonKindPerson');
end;

function kABPersonKindOrganization: CFNumberRef;
begin
  Result := CocoaObjectIdConst(libAddressBook, 'kABPersonKindOrganization');
end;
