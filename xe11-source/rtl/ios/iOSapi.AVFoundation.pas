...
type
  ...
  TAVFoundationCompletionHandler3 = procedure(granted: Boolean) of object;
...
//    {class} function mediaSelectionOptionsFromArray(array_: NSArray; withoutMediaCharacteristics: NSArray): NSArray; cdecl; overload;
  ...
  AVCaptureDeviceClass = interface(NSObjectClass)
    ...
    {class} procedure requestAccessForMediaType(mediaType: AVMediaType; handler: TAVFoundationCompletionHandler3); cdecl;
  end;
  ...
  AVAssetImageGenerator = interface(NSObject)
    ...
    function copyCGImageAtTime(requestedTime: CMTime; actualTime: CMTime; error: PPointer = nil): CGImageRef; cdecl;
    function initWithAsset(asset: AVAsset): Pointer; cdecl;
  ...
  AVAudioSession = interface(NSObject)
    ...
    function setActive(beActive: Boolean; error: PPointer = nil): Boolean; cdecl; overload;
    function setActive(beActive: Boolean; withFlags: NSInteger; error: PPointer = nil): Boolean; cdecl; overload;
    function setCategory(theCategory: NSString; error: PPointer = nil): Boolean; cdecl;
    procedure setDelegate(delegate: Pointer); cdecl;
    function setMode(theMode: NSString; error: PPointer = nil): Boolean; cdecl;
    function setPreferredHardwareSampleRate(sampleRate: double; error: PPointer = nil): Boolean; cdecl;
    function setPreferredIOBufferDuration(duration: NSTimeInterval; error: PPointer = nil): Boolean; cdecl;
  end;
  ...
  AVAudioRecorder = interface(NSObject)
    ...
    function initWithURL(url: NSURL; settings: NSDictionary; error: PPointer = nil): Pointer; cdecl;
  ...
  AVAudioPlayer = interface(NSObject)
    ...
    function initWithData(data: NSData; error: PPointer = nil): Pointer; cdecl;
    function isMeteringEnabled: Boolean; cdecl;
...
//    procedure captureOutput(captureOutput: AVCaptureFileOutput; didStartRecordingToOutputFileAtURL: NSURL; fromConnections: NSArray); cdecl; overload;
  ...
  AVMutableCompositionTrack = interface(AVCompositionTrack)
    ...
    function insertTimeRanges(timeRanges: NSArray; ofTracks: NSArray; atTime: CMTime; error: PPointer = nil): Boolean; cdecl;
    function languageCode: NSString; cdecl;
    function naturalTimeScale: CMTimeScale; cdecl;
    function preferredTransform: CGAffineTransform; cdecl;
    function preferredVolume: Single; cdecl;
