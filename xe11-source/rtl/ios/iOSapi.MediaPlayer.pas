...
uses
  Macapi.ObjectiveC, Macapi.ObjCRuntime, iOSapi.CocoaTypes, iOSapi.Foundation, iOSapi.UIKit, iOSapi.CoreGraphics;
...
{$M+}
  ...
  TMediaPlayerHandler = procedure(status: MPMediaLibraryAuthorizationStatus) of object;
...
//    procedure setMovieControlMode(movieControlMode: MPMovieControlMode); cdecl; // deprecated
  ...
  MPMediaLibraryClass = interface(NSObjectClass)
    ...
    {class} function authorizationStatus: MPMediaLibraryAuthorizationStatus; cdecl;
    {class} function defaultMediaLibrary: Pointer; cdecl;
    {class} procedure requestAuthorization(handler: TMediaPlayerHandler); cdecl;
  end;
