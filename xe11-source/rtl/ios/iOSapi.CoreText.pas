...
uses Posix.StdDef, Macapi.CoreFoundation, iOSapi.CocoaTypes, iOSapi.CoreGraphics;
...
procedure CTFontDrawGlyphs(font: CTFontRef; glyphs: PCGGlyph; positions: PCGPoint; count: size_t; context: CGContextRef); cdecl; external libCoreText name _PU + 'CTFontDrawGlyphs';
...
function CTFontGetLigatureCaretPositions(font: CTFontRef; glyph: CGGlyph; positions: PCGFloat; maxPositions: CFIndex): CFIndex; cdecl; external libCoreText name _PU + 'CTFontGetLigatureCaretPositions';
...
function CTGetCoreTextVersion: UInt32; cdecl; external libCoreText name _PU + 'CTGetCoreTextVersion';
