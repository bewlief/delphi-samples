...
{$EXTERNALSYM pthread_mach_thread_np}
{$ENDIF MACOS}

{ Declare GetCurrentThreadID as a forwarding call to pthread_self for portability. }
function GetCurrentThreadID: TThreadID;

{$IF defined(MACOS) or defined(ANDROID)}
function pthread_mutex_timedlock(var Mutex: pthread_mutex_t; const [ref] AbsTime: timespec): Integer;
