...
{$ENDIF}
{$IFDEF ANDROID}
  sqlite3dll = 'libsqlite.so';
  _PU = '';
{$ENDIF}
{$IFDEF LINUX}
  sqlite3dll = 'libsqlite3.so';
  _PU = '';
{$ENDIF LINUX}
{$IFDEF MACOS}
...
type
  sqlite3_mutex_methods = record
    ...
    xMutexEnter: procedure(Mutex: Pointer); cdecl;
  ...
  {$EXTERNALSYM sqlite3_mutex_methods}
...
const
  ...
  {$EXTERNALSYM SQLITE_STATUS_PAGECACHE_SIZE}
