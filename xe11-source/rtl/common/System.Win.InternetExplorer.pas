...
unit System.Win.InternetExplorer;
{New name for SHDocVw.pas}
...
uses
  Winapi.Windows, System.Classes, System.Variants, System.Win.StdVCL, System.Win.OleControls, System.Win.OleServers, Winapi.ActiveX;
...
// *********************************************************************//
  IWebBrowserApp = interface(IWebBrowser)
    ...
    function Get_HWND_: HWND; safecall;
    ...
    property HWND_: HWND read Get_HWND_;
...
// *********************************************************************//
  IWebBrowserAppDisp = dispinterface
    ...
    property HWND_: HWND readonly dispid -515;
...
// *********************************************************************//
  ...
  TOleWebBrowser = class(TDelegatedOleControl)
  private
    FLastUrl: WideString;
...
//    property Visible: WordBool index 402 read GetWordBoolProp write SetWordBoolProp stored False;
    property Visible: WordBool read GetVisible write SetVisible stored False;
...
procedure TOleWebBrowser.InitControlData;
const
...
procedure TOleWebBrowser.CreateControl;
...
procedure TOleWebBrowser.CreateWnd;
begin
  inherited;
  Self.Navigate(FLastUrl);
end;

procedure TOleWebBrowser.DestroyWnd;
begin
  FLastUrl := Self.DefaultInterface.LocationURL ;
  inherited;
end;

function TOleWebBrowser.GetControlInterface: IWebBrowser2;
begin
  CreateControl;
  Result := FIntf;
end;

function TOleWebBrowser.Get_Application: IDispatch;
begin
  Result := DefaultInterface.Application;
end;

function TOleWebBrowser.Get_Parent: IDispatch;
begin
  Result := DefaultInterface.Parent;
end;

function TOleWebBrowser.Get_Container: IDispatch;
begin
  Result := DefaultInterface.Container;
end;

function TOleWebBrowser.Get_Document: IDispatch;
begin
  Result := DefaultInterface.Document;
end;

function TOleWebBrowser.Get_HWND_: HWND;
begin
  Result := DefaultInterface.HWND_;
end;

procedure TOleWebBrowser.GoBack;
begin
  DefaultInterface.GoBack;
end;

procedure TOleWebBrowser.GoForward;
begin
  DefaultInterface.GoForward;
end;

procedure TOleWebBrowser.GoHome;
begin
  DefaultInterface.GoHome;
end;

procedure TOleWebBrowser.GoSearch;
begin
  DefaultInterface.GoSearch;
end;

procedure TOleWebBrowser.Navigate(const URL: WideString);
var
...
procedure TOleWebBrowser.Navigate(const URL: WideString; const Flags: OleVariant);
var
  EmptyParam: OleVariant;
begin
  EmptyParam := System.Variants.EmptyParam;
...
procedure TOleWebBrowser.Refresh;
begin
  DefaultInterface.Refresh;
end;

procedure TOleWebBrowser.Refresh2;
var
  EmptyParam: OleVariant;
begin
  EmptyParam := System.Variants.EmptyParam;
...
procedure TOleWebBrowser.Refresh2(const Level: OleVariant);
begin
  DefaultInterface.Refresh2(Level);
end;

procedure TOleWebBrowser.Stop;
begin
  DefaultInterface.Stop;
end;

procedure TOleWebBrowser.Quit;
begin
  DefaultInterface.Quit;
end;

procedure TOleWebBrowser.ClientToWindow(var pcx: SYSINT; var pcy: SYSINT);
begin
  DefaultInterface.ClientToWindow(pcx, pcy);
end;

procedure TOleWebBrowser.PutProperty(const Property_: WideString; vtValue: OleVariant);
begin
  DefaultInterface.PutProperty(Property_, vtValue);
end;

function TOleWebBrowser.GetProperty(const Property_: WideString): OleVariant;
begin
  Result := DefaultInterface.GetProperty(Property_);
end;

function TOleWebBrowser.GetVisible: WordBool;
begin
  Result := DefaultInterface.Visible;
end;

procedure TOleWebBrowser.Navigate2(const URL: OleVariant);
var
  EmptyParam: OleVariant;
begin
  EmptyParam := System.Variants.EmptyParam;
...
procedure TOleWebBrowser.Navigate2(const URL: OleVariant; const Flags: OleVariant);
var
  EmptyParam: OleVariant;
begin
  EmptyParam := System.Variants.EmptyParam;
...
function TOleWebBrowser.QueryStatusWB(cmdID: OLECMDID): OLECMDF;
begin
  Result := DefaultInterface.QueryStatusWB(cmdID);
end;

procedure TOleWebBrowser.ExecWB(cmdID: OLECMDID; cmdexecopt: OLECMDEXECOPT);
var
  EmptyParam: OleVariant;
begin
  EmptyParam := System.Variants.EmptyParam;
...
procedure TOleWebBrowser.ExecWB(cmdID: OLECMDID; cmdexecopt: OLECMDEXECOPT; const pvaIn: OleVariant);
var
  EmptyParam: OleVariant;
begin
  EmptyParam := System.Variants.EmptyParam;
...
procedure TOleWebBrowser.ShowBrowserBar(const pvaClsid: OleVariant);
var
  EmptyParam: OleVariant;
begin
  EmptyParam := System.Variants.EmptyParam;
...
procedure TOleWebBrowser.ShowBrowserBar(const pvaClsid: OleVariant; const pvarShow: OleVariant);
var
  EmptyParam: OleVariant;
begin
  EmptyParam := System.Variants.EmptyParam;
...
procedure TOleWebBrowser.SetVisible(const Value: WordBool);
begin
...
function TInternetExplorer.Get_HWND_: HWND;
begin
  Result := DefaultInterface.HWND_;
end;
...
function TInternetExplorerMedium.Get_HWND_: HWND;
begin
  Result := DefaultInterface.HWND_;
end;
