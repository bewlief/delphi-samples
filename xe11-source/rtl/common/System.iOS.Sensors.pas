...
uses
  System.SysUtils, System.Math, System.Generics.Collections, System.RTLConsts, System.Classes, System.TypInfo, iOSapi.Foundation, Macapi.ObjectiveC,
  iOSapi.CocoaTypes, iOSapi.CoreLocation, iOSapi.CoreMotion, Macapi.Helpers, Macapi.Consts, iOSapi.UIKit, iOSapi.Helpers;
...
begin
  if Assigned(FLocation) then
    Result := NSDateToDateTime(FLocation.timestamp)
  else
    Result := 0;
end;
...
begin
  ...
  TiOSHelper.DefaultNotificationCenter.addObserver(GetObjectID, sel_getUid('willEnterForeground:'), NSObjectToID(UIApplicationWillEnterForegroundNotification), nil);
  TiOSHelper.DefaultNotificationCenter.addObserver(GetObjectID, sel_getUid('didEnterBackground:'), NSObjectToID(UIApplicationDidEnterBackgroundNotification), nil);
end;
