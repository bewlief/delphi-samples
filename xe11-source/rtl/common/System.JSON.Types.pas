...
type
  ...
  public
    ...
    class function IsEndToken(Token: TJsonToken): Boolean; static;
    /// <summary> Checks whether the token is an start token </summary>
    class function IsStartToken(Token: TJsonToken): Boolean; static;
    /// <summary> Checks whether the token is an primitive token </summary>
    class function IsPrimitiveToken(Token: TJsonToken): Boolean; static;
...
var
  ...
  /// Affects TList&lt;T&gt; / TListHelper, TJSONString, TDate serialization. </summary>
