...
function SQLAllocConnect; external odbcdll name _PU + 'SQLAllocConnect';
function SQLAllocEnv; external odbcdll name _PU + 'SQLAllocEnv';
function SQLAllocHandle; external odbcdll name _PU + 'SQLAllocHandle';
function SQLAllocStmt; external odbcdll name _PU + 'SQLAllocStmt';
function SQLBindCol; external odbcdll name _PU + 'SQLBindCol';
function SQLBindParam; external odbcdll name _PU + 'SQLBindParam';
function SQLCancel; external odbcdll name _PU + 'SQLCancel';
function SQLCancelHandle; external odbcdll name _PU + 'SQLCancelHandle';
function SQLCloseCursor; external odbcdll name _PU + 'SQLCloseCursor';
function SQLColAttribute; external odbcdll name _PU + 'SQLColAttributeW';
function SQLColAttributeA; external odbcdll name _PU + 'SQLColAttributeA';
function SQLColAttributeW; external odbcdll name _PU + 'SQLColAttributeW';
function SQLColumns; external odbcdll name _PU + 'SQLColumnsW';
function SQLColumnsA; external odbcdll name _PU + 'SQLColumnsA';
function SQLColumnsW; external odbcdll name _PU + 'SQLColumnsW';
function SQLConnect; external odbcdll name _PU + 'SQLConnectW';
function SQLConnectA; external odbcdll name _PU + 'SQLConnectA';
function SQLConnectW; external odbcdll name _PU + 'SQLConnectW';
function SQLCopyDesc; external odbcdll name _PU + 'SQLCopyDesc';
function SQLDataSources; external odbcdll name _PU + 'SQLDataSourcesW';
function SQLDataSourcesA; external odbcdll name _PU + 'SQLDataSourcesA';
function SQLDataSourcesW; external odbcdll name _PU + 'SQLDataSourcesW';
function SQLDescribeCol; external odbcdll name _PU + 'SQLDescribeColW';
function SQLDescribeColA; external odbcdll name _PU + 'SQLDescribeColA';
function SQLDescribeColW; external odbcdll name _PU + 'SQLDescribeColW';
function SQLDisconnect; external odbcdll name _PU + 'SQLDisconnect';
function SQLEndTran; external odbcdll name _PU + 'SQLEndTran';
function SQLError; external odbcdll name _PU + 'SQLErrorW';
function SQLErrorA; external odbcdll name _PU + 'SQLErrorA';
function SQLErrorW; external odbcdll name _PU + 'SQLErrorW';
function SQLExecDirect; external odbcdll name _PU + 'SQLExecDirectW';
function SQLExecDirectA; external odbcdll name _PU + 'SQLExecDirectA';
function SQLExecDirectW; external odbcdll name _PU + 'SQLExecDirectW';
function SQLExecute; external odbcdll name _PU + 'SQLExecute';
function SQLFetch; external odbcdll name _PU + 'SQLFetch';
function SQLFetchScroll; external odbcdll name _PU + 'SQLFetchScroll';
function SQLFreeConnect; external odbcdll name _PU + 'SQLFreeConnect';
function SQLFreeEnv; external odbcdll name _PU + 'SQLFreeEnv';
function SQLFreeHandle; external odbcdll name _PU + 'SQLFreeHandle';
function SQLFreeStmt; external odbcdll name _PU + 'SQLFreeStmt';
function SQLGetConnectAttr; external odbcdll name _PU + 'SQLGetConnectAttrW';
function SQLGetConnectAttrA; external odbcdll name _PU + 'SQLGetConnectAttrA';
function SQLGetConnectAttrW; external odbcdll name _PU + 'SQLGetConnectAttrW';
function SQLGetConnectOption; external odbcdll name _PU + 'SQLGetConnectOptionW';
function SQLGetConnectOptionA; external odbcdll name _PU + 'SQLGetConnectOptionA';
function SQLGetConnectOptionW; external odbcdll name _PU + 'SQLGetConnectOptionW';
function SQLGetCursorName; external odbcdll name _PU + 'SQLGetCursorNameW';
function SQLGetCursorNameA; external odbcdll name _PU + 'SQLGetCursorNameA';
function SQLGetCursorNameW; external odbcdll name _PU + 'SQLGetCursorNameW';
function SQLGetData; external odbcdll name _PU + 'SQLGetData';
function SQLGetDescField; external odbcdll name _PU + 'SQLGetDescFieldW';
function SQLGetDescFieldA; external odbcdll name _PU + 'SQLGetDescFieldA';
function SQLGetDescFieldW; external odbcdll name _PU + 'SQLGetDescFieldW';
function SQLGetDescRec; external odbcdll name _PU + 'SQLGetDescRecW';
function SQLGetDescRecA; external odbcdll name _PU + 'SQLGetDescRecA';
function SQLGetDescRecW; external odbcdll name _PU + 'SQLGetDescRecW';
function SQLGetDiagField; external odbcdll name _PU + 'SQLGetDiagFieldW';
function SQLGetDiagFieldA; external odbcdll name _PU + 'SQLGetDiagFieldA';
function SQLGetDiagFieldW; external odbcdll name _PU + 'SQLGetDiagFieldW';
function SQLGetDiagRec; external odbcdll name _PU + 'SQLGetDiagRecW';
function SQLGetDiagRecA; external odbcdll name _PU + 'SQLGetDiagRecA';
function SQLGetDiagRecW; external odbcdll name _PU + 'SQLGetDiagRecW';
function SQLGetEnvAttr; external odbcdll name _PU + 'SQLGetEnvAttr';
function SQLGetFunctions; external odbcdll name _PU + 'SQLGetFunctions';
function SQLGetInfo; external odbcdll name _PU + 'SQLGetInfoW';
function SQLGetInfoA; external odbcdll name _PU + 'SQLGetInfoA';
function SQLGetInfoW; external odbcdll name _PU + 'SQLGetInfoW';
function SQLGetStmtAttr; external odbcdll name _PU + 'SQLGetStmtAttrW';
function SQLGetStmtAttrA; external odbcdll name _PU + 'SQLGetStmtAttrA';
function SQLGetStmtAttrW; external odbcdll name _PU + 'SQLGetStmtAttrW';
function SQLGetStmtOption; external odbcdll name _PU + 'SQLGetStmtOption';
function SQLGetTypeInfo; external odbcdll name _PU + 'SQLGetTypeInfoW';
function SQLGetTypeInfoA; external odbcdll name _PU + 'SQLGetTypeInfoA';
function SQLGetTypeInfoW; external odbcdll name _PU + 'SQLGetTypeInfoW';
function SQLNumResultCols; external odbcdll name _PU + 'SQLNumResultCols';
function SQLParamData; external odbcdll name _PU + 'SQLParamData';
function SQLPrepare; external odbcdll name _PU + 'SQLPrepareW';
function SQLPrepareA; external odbcdll name _PU + 'SQLPrepareA';
function SQLPrepareW; external odbcdll name _PU + 'SQLPrepareW';
function SQLPutData; external odbcdll name _PU + 'SQLPutData';
function SQLRowCount; external odbcdll name _PU + 'SQLRowCount';
function SQLSetConnectAttr; external odbcdll name _PU + 'SQLSetConnectAttrW';
function SQLSetConnectAttrA; external odbcdll name _PU + 'SQLSetConnectAttrA';
function SQLSetConnectAttrW; external odbcdll name _PU + 'SQLSetConnectAttrW';
function SQLSetConnectOption; external odbcdll name _PU + 'SQLSetConnectOptionW';
function SQLSetConnectOptionA; external odbcdll name _PU + 'SQLSetConnectOptionA';
function SQLSetConnectOptionW; external odbcdll name _PU + 'SQLSetConnectOptionW';
function SQLSetCursorName; external odbcdll name _PU + 'SQLSetCursorNameW';
function SQLSetCursorNameA; external odbcdll name _PU + 'SQLSetCursorNameA';
function SQLSetCursorNameW; external odbcdll name _PU + 'SQLSetCursorNameW';
function SQLSetDescField; external odbcdll name _PU + 'SQLSetDescFieldW';
function SQLSetDescRec; external odbcdll name _PU + 'SQLSetDescRec';
function SQLSetEnvAttr; external odbcdll name _PU + 'SQLSetEnvAttr';
function SQLSetParam; external odbcdll name _PU + 'SQLSetParam';
function SQLSetStmtAttr; external odbcdll name _PU + 'SQLSetStmtAttrW';
function SQLSetStmtOption; external odbcdll name _PU + 'SQLSetStmtOption';
function SQLSpecialColumns; external odbcdll name _PU + 'SQLSpecialColumnsW';
function SQLSpecialColumnsA; external odbcdll name _PU + 'SQLSpecialColumnsA';
function SQLSpecialColumnsW; external odbcdll name _PU + 'SQLSpecialColumnsW';
function SQLStatistics; external odbcdll name _PU + 'SQLStatisticsW';
function SQLStatisticsA; external odbcdll name _PU + 'SQLStatisticsA';
function SQLStatisticsW; external odbcdll name _PU + 'SQLStatisticsW';
function SQLTables; external odbcdll name _PU + 'SQLTablesW';
function SQLTablesA; external odbcdll name _PU + 'SQLTablesA';
function SQLTablesW; external odbcdll name _PU + 'SQLTablesW';
function SQLTransact; external odbcdll name _PU + 'SQLTransact';

function SQLDriverConnect; external odbcdll name _PU + 'SQLDriverConnectW';
function SQLDriverConnectA; external odbcdll name _PU + 'SQLDriverConnectA';
function SQLDriverConnectW; external odbcdll name _PU + 'SQLDriverConnectW';
function SQLBrowseConnect; external odbcdll name _PU + 'SQLBrowseConnectW';
function SQLBrowseConnectA; external odbcdll name _PU + 'SQLBrowseConnectA';
function SQLBrowseConnectW; external odbcdll name _PU + 'SQLBrowseConnectW';
function SQLBulkOperations; external odbcdll name _PU + 'SQLBulkOperations';
function SQLColumnPrivileges; external odbcdll name _PU + 'SQLColumnPrivilegesW';
function SQLColumnPrivilegesA; external odbcdll name _PU + 'SQLColumnPrivilegesA';
function SQLColumnPrivilegesW; external odbcdll name _PU + 'SQLColumnPrivilegesW';
function SQLDescribeParam; external odbcdll name _PU + 'SQLDescribeParam';
function SQLForeignKeys; external odbcdll name _PU + 'SQLForeignKeysW';
function SQLForeignKeysA; external odbcdll name _PU + 'SQLForeignKeysA';
function SQLForeignKeysW; external odbcdll name _PU + 'SQLForeignKeysW';
function SQLMoreResults; external odbcdll name _PU + 'SQLMoreResults';
function SQLNativeSql; external odbcdll name _PU + 'SQLNativeSqlW';
function SQLNativeSqlA; external odbcdll name _PU + 'SQLNativeSqlA';
function SQLNativeSqlW; external odbcdll name _PU + 'SQLNativeSqlW';
function SQLNumParams; external odbcdll name _PU + 'SQLNumParams';
function SQLPrimaryKeys; external odbcdll name _PU + 'SQLPrimaryKeysW';
function SQLPrimaryKeysA; external odbcdll name _PU + 'SQLPrimaryKeysA';
function SQLPrimaryKeysW; external odbcdll name _PU + 'SQLPrimaryKeysW';
function SQLProcedureColumns; external odbcdll name _PU + 'SQLProcedureColumnsW';
function SQLProcedureColumnsA; external odbcdll name _PU + 'SQLProcedureColumnsA';
function SQLProcedureColumnsW; external odbcdll name _PU + 'SQLProcedureColumnsW';
function SQLProcedures; external odbcdll name _PU + 'SQLProceduresW';
function SQLProceduresA; external odbcdll name _PU + 'SQLProceduresA';
function SQLProceduresW; external odbcdll name _PU + 'SQLProceduresW';
{$IFDEF MSWINDOWS}
function SQLSetPos; external odbcdll name _PU + 'SQLSetPos';
{$ENDIF}
function SQLTablePrivileges; external odbcdll name _PU + 'SQLTablePrivilegesW';
function SQLTablePrivilegesA; external odbcdll name _PU + 'SQLTablePrivilegesA';
function SQLTablePrivilegesW; external odbcdll name _PU + 'SQLTablePrivilegesW';
function SQLDrivers; external odbcdll name _PU + 'SQLDriversW';
function SQLDriversA; external odbcdll name _PU + 'SQLDriversA';
function SQLDriversW; external odbcdll name _PU + 'SQLDriversW';
function SQLBindParameter; external odbcdll name _PU + 'SQLBindParameter';

{$IFDEF MSWINDOWS}
function SQLAllocHandleStd; external odbcdll name _PU + 'SQLAllocHandleStd';
{$ENDIF}

function TraceOpenLogFile; external odbcdll name _PU + 'TraceOpenLogFile';
function TraceCloseLogFile; external odbcdll name _PU + 'TraceCloseLogFile';
procedure TraceReturn; external odbcdll name _PU + 'TraceReturn';
function TraceVersion; external odbcdll name _PU + 'TraceVersion';

function TraceVSControl; external odbcdll name _PU + 'TraceVSControl';

{$IFDEF MSWINDOWS}
function ODBCSetTryWaitValue; external odbcdll name _PU + 'ODBCSetTryWaitValue';
{$ELSE}
function ODBCSetTryWaitValue; external odbcdll name _PU + 'ODBCSetTryWaitValue';
{$ENDIF}
function ODBCGetTryWaitValue; external odbcdll name _PU + 'ODBCGetTryWaitValue';

function SQLColAttributes; external odbcdll name _PU + 'SQLColAttributesW';
function SQLColAttributesA; external odbcdll name _PU + 'SQLColAttributesA';
function SQLColAttributesW; external odbcdll name _PU + 'SQLColAttributesW';
function SQLSetDescFieldW; external odbcdll name _PU + 'SQLSetDescFieldW';
function SQLSetStmtAttrW; external odbcdll name _PU + 'SQLSetStmtAttrW';

function SQLGetStmtOptionA; external odbcdll name _PU + 'SQLGetStmtOptionA';
function SQLSetStmtOptionA; external odbcdll name _PU + 'SQLSetStmtOptionA';
function SQLDescribeParamA; external odbcdll name _PU + 'SQLDescribeParamA';
