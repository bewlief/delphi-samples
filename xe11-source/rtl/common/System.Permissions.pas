...
begin
  ...
  AOnRequestPermissionsResult(Self, TClassicStringDynArray(APermissions),
    TClassicPermissionStatusDynArray(GrantResults))
end;
...
begin
  ...
  for I := Low(GrantResults) to High(GrantResults) do
    GrantResults[I] := TPermissionStatus.Granted;
  AOnRequestPermissionsResult(TClassicStringDynArray(APermissions),
    TClassicPermissionStatusDynArray(GrantResults))
end;
