...
function TMacLocationSensor.GetActivityType: TLocationActivityType;
begin
...
function TMacLocationSensor.GetUsageAuthorization: TLocationUsageAuthorization;
begin
...
procedure TMacLocationSensor.SetActivityType(const Value: TLocationActivityType);
begin
  FActivityType := Value;
end;
...
procedure TMacLocationSensor.SetUsageAuthorization(const Value: TLocationUsageAuthorization);
begin
