...
function CMAudioFormatDescriptionCreateSummary(allocator: CFAllocatorRef; formatDescriptionArray: CFArrayRef; flags: UInt32; summaryFormatDescriptionOut: PCMAudioFormatDescriptionRef): OSStatus; cdecl; external libCoreMedia name _PU + 'CMAudioFormatDescriptionCreateSummary';
...
function CMAudioFormatDescriptionGetChannelLayout(desc: CMAudioFormatDescriptionRef; layoutSize: Psize_t): PAudioChannelLayout; cdecl; external libCoreMedia name _PU + 'CMAudioFormatDescriptionGetChannelLayout';
function CMAudioFormatDescriptionGetFormatList(desc: CMAudioFormatDescriptionRef; formatListSize: Psize_t): PAudioFormatListItem; cdecl; external libCoreMedia name _PU + 'CMAudioFormatDescriptionGetFormatList';
function CMAudioFormatDescriptionGetMagicCookie(desc: CMAudioFormatDescriptionRef; cookieSizeOut: Psize_t): Pointer; cdecl; external libCoreMedia name _PU + 'CMAudioFormatDescriptionGetMagicCookie';
...
function CMBlockBufferAccessDataBytes(theBuffer: CMBlockBufferRef; offset: size_t; length: size_t; temporaryBlock: Pointer; returnedPointer: Pchar): OSStatus; cdecl; external libCoreMedia name _PU + 'CMBlockBufferAccessDataBytes';
function CMBlockBufferAppendBufferReference(theBuffer: CMBlockBufferRef; targetBBuf: CMBlockBufferRef; offsetToData: size_t; dataLength: size_t; flags: CMBlockBufferFlags): OSStatus; cdecl; external libCoreMedia name _PU + 'CMBlockBufferAppendBufferReference';
...
function CMBlockBufferCopyDataBytes(theSourceBuffer: CMBlockBufferRef; offsetToData: size_t; dataLength: size_t; destination: Pointer): OSStatus; cdecl; external libCoreMedia name _PU + 'CMBlockBufferCopyDataBytes';
function CMBlockBufferCreateContiguous(structureAllocator: CFAllocatorRef; sourceBuffer: CMBlockBufferRef; blockAllocator: CFAllocatorRef; customBlockSource: PCMBlockBufferCustomBlockSource; offsetToData: size_t; dataLength: size_t; flags: CMBlockBufferFlags; newBBufOut: PCMBlockBufferRef): OSStatus; cdecl; external libCoreMedia name _PU + 'CMBlockBufferCreateContiguous';
function CMBlockBufferCreateEmpty(structureAllocator: CFAllocatorRef; subBlockCapacity: UInt32; flags: CMBlockBufferFlags; newBBufOut: PCMBlockBufferRef): OSStatus; cdecl; external libCoreMedia name _PU + 'CMBlockBufferCreateEmpty';
function CMBlockBufferCreateWithBufferReference(structureAllocator: CFAllocatorRef; targetBuffer: CMBlockBufferRef; offsetToData: size_t; dataLength: size_t; flags: CMBlockBufferFlags; newBBufOut: PCMBlockBufferRef): OSStatus; cdecl; external libCoreMedia name _PU + 'CMBlockBufferCreateWithBufferReference';
...
function CMBlockBufferFillDataBytes(fillByte: char; destinationBuffer: CMBlockBufferRef; offsetIntoDestination: size_t; dataLength: size_t): OSStatus; cdecl; external libCoreMedia name _PU + 'CMBlockBufferFillDataBytes';
function CMBlockBufferGetDataLength(theBuffer: CMBlockBufferRef): size_t; cdecl; external libCoreMedia name _PU + 'CMBlockBufferGetDataLength';
function CMBlockBufferGetDataPointer(theBuffer: CMBlockBufferRef; offset: size_t; lengthAtOffset: Psize_t; totalLength: Psize_t; dataPointer: Pchar): OSStatus; cdecl; external libCoreMedia name _PU + 'CMBlockBufferGetDataPointer';
...
function CMBlockBufferIsRangeContiguous(theBuffer: CMBlockBufferRef; offset: size_t; length: size_t): Boolean; cdecl; external libCoreMedia name _PU + 'CMBlockBufferIsRangeContiguous';
function CMBlockBufferReplaceDataBytes(sourceBytes: Pointer; destinationBuffer: CMBlockBufferRef; offsetIntoDestination: size_t; dataLength: size_t): OSStatus; cdecl; external libCoreMedia name _PU + 'CMBlockBufferReplaceDataBytes';
...
function CMSampleBufferGetAudioStreamPacketDescriptions(sbuf: CMSampleBufferRef; packetDescriptionsSize: size_t; packetDescriptionsOut: PAudioStreamPacketDescription; packetDescriptionsSizeNeededOut: Psize_t): OSStatus; cdecl; external libCoreMedia name _PU + 'CMSampleBufferGetAudioStreamPacketDescriptions';
function CMSampleBufferGetAudioStreamPacketDescriptionsPtr(sbuf: CMSampleBufferRef; packetDescriptionsPtrOut: PAudioStreamPacketDescription; packetDescriptionsSizeOut: Psize_t): OSStatus; cdecl; external libCoreMedia name _PU + 'CMSampleBufferGetAudioStreamPacketDescriptionsPtr';
...
function CMSampleBufferGetSampleSize(sbuf: CMSampleBufferRef; sampleIndex: CMItemIndex): size_t; cdecl; external libCoreMedia name _PU + 'CMSampleBufferGetSampleSize';
function CMSampleBufferGetSampleSizeArray(sbuf: CMSampleBufferRef; sizeArrayEntries: CMItemCount; sizeArrayOut: Psize_t; sizeArrayEntriesNeededOut: PCMItemCount): OSStatus; cdecl; external libCoreMedia name _PU + 'CMSampleBufferGetSampleSizeArray';
...
function CMSampleBufferGetTotalSampleSize(sbuf: CMSampleBufferRef): size_t; cdecl; external libCoreMedia name _PU + 'CMSampleBufferGetTotalSampleSize';
...
function CMSampleBufferSetDataBufferFromAudioBufferList(sbuf: CMSampleBufferRef; bbufStructAllocator: CFAllocatorRef; bbufMemoryAllocator: CFAllocatorRef; flags: UInt32; bufferList: PAudioBufferList): OSStatus; cdecl; external libCoreMedia name _PU + 'CMSampleBufferSetDataBufferFromAudioBufferList';
...
function CMSimpleQueueCreate(allocator: CFAllocatorRef; capacity: Int32; queueOut: PCMSimpleQueueRef): OSStatus; cdecl; external libCoreMedia name _PU + 'CMSimpleQueueCreate';
...
function CMSimpleQueueGetCapacity(queue: CMSimpleQueueRef): Int32; cdecl; external libCoreMedia name _PU + 'CMSimpleQueueGetCapacity';
function CMSimpleQueueGetCount(queue: CMSimpleQueueRef): Int32; cdecl; external libCoreMedia name _PU + 'CMSimpleQueueGetCount';
...
function CMTextFormatDescriptionGetDefaultStyle(desc: CMFormatDescriptionRef; outLocalFontID: PUInt16; outBold: PBoolean; outItalic: PBoolean; outUnderline: PBoolean; outFontSize: PCGFloat; outColorComponents: PCGFloat): OSStatus; cdecl; external libCoreMedia name _PU + 'CMTextFormatDescriptionGetDefaultStyle';
function CMTextFormatDescriptionGetDefaultTextBox(desc: CMFormatDescriptionRef; originIsAtTopLeft: Boolean; heightOfTextTrack: CGFloat; outDefaultTextBox: PCGRect): OSStatus; cdecl; external libCoreMedia name _PU + 'CMTextFormatDescriptionGetDefaultTextBox';
...
function CMTextFormatDescriptionGetFontName(desc: CMFormatDescriptionRef; localFontID: UInt16; outFontName: PCFStringRef): OSStatus; cdecl; external libCoreMedia name _PU + 'CMTextFormatDescriptionGetFontName';
...
function CMTimeCodeFormatDescriptionGetFrameQuanta(timeCodeFormatDescription: CMTimeCodeFormatDescriptionRef): UInt32; cdecl; external libCoreMedia name _PU + 'CMTimeCodeFormatDescriptionGetFrameQuanta';
function CMTimeCodeFormatDescriptionGetTimeCodeFlags(desc: CMTimeCodeFormatDescriptionRef): UInt32; cdecl; external libCoreMedia name _PU + 'CMTimeCodeFormatDescriptionGetTimeCodeFlags';
function CMTimeCompare(time1: CMTime; time2: CMTime): Int32; cdecl; external libCoreMedia name _PU + 'CMTimeCompare';
function CMTimeConvertScale(time: CMTime; newTimescale: Int32; method: CMTimeRoundingMethod): CMTime; cdecl; external libCoreMedia name _PU + 'CMTimeConvertScale';
...
function CMTimeMake(value: Int64; timescale: Int32): CMTime; cdecl; external libCoreMedia name _PU + 'CMTimeMake';
...
function CMTimeMakeWithEpoch(value: Int64; timescale: Int32; epoch: Int64): CMTime; cdecl; external libCoreMedia name _PU + 'CMTimeMakeWithEpoch';
function CMTimeMakeWithSeconds(seconds: Float64; preferredTimeScale: Int32): CMTime; cdecl; external libCoreMedia name _PU + 'CMTimeMakeWithSeconds';
...
function CMTimeMultiply(time: CMTime; multiplier: Int32): CMTime; cdecl; external libCoreMedia name _PU + 'CMTimeMultiply';
...
function CMVideoFormatDescriptionCreate(allocator: CFAllocatorRef; codecType: CMVideoCodecType; width: Int32; height: Int32; extensions: CFDictionaryRef; outDesc: PCMVideoFormatDescriptionRef): OSStatus; cdecl; external libCoreMedia name _PU + 'CMVideoFormatDescriptionCreate';
