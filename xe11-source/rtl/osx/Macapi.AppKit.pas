...
// ==== Protocols ====
  ...
  NSDatePickerCellDelegate = interface(IObjectiveC)
    ...
    procedure datePickerCell(aDatePickerCell: NSDatePickerCell; validateProposedDateValue: NSDate; timeInterval: NSTimeInterval); cdecl;
  end;
  ...
  NSMenuDelegate = interface(IObjectiveC)
    ...
    function menu(menu: NSMenu; updateItem: NSMenuItem; atIndex: NSInteger; shouldCancel: Boolean): Boolean; cdecl; overload;
    procedure menu(menu: NSMenu; willHighlightItem: NSMenuItem); cdecl; overload;
  ...
  NSOpenSavePanelDelegate = interface(IObjectiveC)
    ...
    function panelShouldEnableURL(sender: Pointer; shouldEnableURL: NSURL): Boolean; cdecl;
    [MethodName('panel:validateURL:error:')]
    function panelValidateURLError(sender: Pointer; validateURL: NSURL; error: NSError): Boolean; cdecl;
    [MethodName('panel:didChangeToDirectoryURL:')]
    procedure panelDidChangeToDirectoryURL(sender: Pointer; didChangeToDirectoryURL: NSURL); cdecl;
    [MethodName('panel:userEnteredFilename:confirmed:')]
    function panelUserEnteredFilenameConfirmed(sender: Pointer; userEnteredFilename: NSString; confirmed: Boolean): NSString; cdecl;
    [MethodName('panel:willExpand:')]
    procedure panelWillExpand(sender: Pointer; willExpand: Boolean); cdecl;
...
// ===== Interface declarations =====
  ...
  NSTextContainer = interface(NSObject)
    ...
    procedure setLineFragmentPadding(pad: CGFloat); cdecl;
  ...
  NSTextInputContext = interface(NSObject)
    ...
    function selectedKeyboardInputSource: NSString; cdecl;
  end;
  ...
  NSOpenGLLayer = interface(CAOpenGLLayer)
    ...
    function openGLPixelFormatForDisplayMask(mask: UInt32): NSOpenGLPixelFormat; cdecl;
  end;
  ...
  NSLayoutManager = interface(NSObject)
    ...
    function characterIndexForPoint(point: NSPoint; inTextContainer: NSTextContainer; fractionOfDistanceBetweenInsertionPoints: PCGFloat): NSUInteger; cdecl;
    ...
    function defaultBaselineOffsetForFont(theFont: NSFont): CGFloat; cdecl;
    function defaultLineHeightForFont(theFont: NSFont): CGFloat; cdecl;
    ...
    procedure drawStrikethroughForGlyphRange(glyphRange: NSRange; strikethroughType: NSInteger; baselineOffset: CGFloat; lineFragmentRect: NSRect; lineFragmentGlyphRange: NSRange; containerOrigin: NSPoint); cdecl;
    procedure drawUnderlineForGlyphRange(glyphRange: NSRange; underlineType: NSInteger; baselineOffset: CGFloat; lineFragmentRect: NSRect; lineFragmentGlyphRange: NSRange; containerOrigin: NSPoint); cdecl;
    ...
    function fractionOfDistanceThroughGlyphForPoint(point: NSPoint; inTextContainer: NSTextContainer): CGFloat; cdecl;
    ...
    function getGlyphsInRange(glyphRange: NSRange; glyphs: PNSGlyph; characterIndexes: PNSUInteger; glyphInscriptions: PNSGlyphInscription; elasticBits: PBoolean): NSUInteger; cdecl; overload;
    function getGlyphsInRange(glyphRange: NSRange; glyphs: PNSGlyph; characterIndexes: PNSUInteger; glyphInscriptions: PNSGlyphInscription; elasticBits: PBoolean; bidiLevels: PByte): NSUInteger; cdecl; overload;
    function getLineFragmentInsertionPointsForCharacterAtIndex(charIndex: NSUInteger; alternatePositions: Boolean; inDisplayOrder: Boolean; positions: PCGFloat; characterIndexes: PNSUInteger): NSUInteger; cdecl;
    ...
    function glyphIndexForPoint(point: NSPoint; inTextContainer: NSTextContainer; fractionOfDistanceThroughGlyph: PCGFloat): NSUInteger; cdecl; overload;
    ...
    function rectArrayForCharacterRange(charRange: NSRange; withinSelectedCharacterRange: NSRange; inTextContainer: NSTextContainer; rectCount: PNSUInteger): NSRectArray; cdecl;
    function rectArrayForGlyphRange(glyphRange: NSRange; withinSelectedGlyphRange: NSRange; inTextContainer: NSTextContainer; rectCount: PNSUInteger): NSRectArray; cdecl;
    ...
    procedure setLocations(locations: NSPointArray; startingGlyphIndexes: PNSUInteger; count: NSUInteger; forGlyphRange: NSRange); cdecl;
  ...
  NSGlyphGenerator = interface(NSObject)
    ...
    procedure generateGlyphsForGlyphStorage(glyphStorage: NSGlyphStorage; desiredNumberOfCharacters: NSUInteger; glyphIndex: PNSUInteger; characterIndex: PNSUInteger); cdecl;
  end;
  ...
  NSGradient = interface(NSObject)
    ...
    procedure drawInBezierPath(path: NSBezierPath; angle: CGFloat); cdecl; overload;
    procedure drawInBezierPath(path: NSBezierPath; relativeCenterPosition: NSPoint); cdecl; overload;
    procedure drawInRect(rect: NSRect; angle: CGFloat); cdecl; overload;
    procedure drawInRect(rect: NSRect; relativeCenterPosition: NSPoint); cdecl; overload;
    procedure getColor(color: NSColor; location: PCGFloat; atIndex: NSInteger); cdecl;
    function initWithColors(colorArray: NSArray): Pointer; cdecl; overload;
    function initWithColors(colorArray: NSArray; atLocations: PCGFloat; colorSpace: NSColorSpace): Pointer; cdecl; overload;
    ...
    function interpolatedColorAtLocation(location: CGFloat): NSColor; cdecl;
  ...
  NSFontDescriptorClass = interface(NSObjectClass)
    ...
    {class} function fontDescriptorWithName(fontName: NSString; size: CGFloat): Pointer; cdecl; overload;
  end;
  NSFontDescriptor = interface(NSObject)
    ...
    function fontDescriptorWithSize(newPointSize: CGFloat): NSFontDescriptor; cdecl;
...
//    function convertFont(fontObj: NSFont; toNotHaveTrait: NSFontTraitMask): NSFont; cdecl; overload;
    function convertFont(fontObj: NSFont; toSize: CGFloat): NSFont; cdecl; overload;
    ...
    function fontWithFamily(family: NSString; traits: NSFontTraitMask; weight: NSInteger; size: CGFloat): NSFont; cdecl;
    function isEnabled: Boolean; cdecl;
  ...
  NSTextTab = interface(NSObject)
    ...
    function initWithType(type_: NSTextTabType; location: CGFloat): Pointer; cdecl;
  ...
  NSImageRep = interface(NSObject)
    ...
    function drawInRect(dstSpacePortionRect: NSRect; fromRect: NSRect; operation: NSCompositingOperation; fraction: CGFloat; respectFlipped: Boolean; hints: NSDictionary): Boolean; cdecl; overload;
  ...
  NSImage = interface(NSObject)
    ...
    procedure compositeToPoint(point: NSPoint; fromRect: NSRect; operation: NSCompositingOperation; fraction: CGFloat); cdecl; overload;
    procedure compositeToPoint(point: NSPoint; operation: NSCompositingOperation); cdecl; overload;
    procedure compositeToPoint(point: NSPoint; operation: NSCompositingOperation; fraction: CGFloat); cdecl; overload;
    function delegate: NSImageDelegate; cdecl;
    procedure dissolveToPoint(point: NSPoint; fraction: CGFloat); cdecl; overload;
    procedure dissolveToPoint(point: NSPoint; fromRect: NSRect; fraction: CGFloat); cdecl; overload;
    procedure drawAtPoint(point: NSPoint; fromRect: NSRect; operation: NSCompositingOperation; fraction: CGFloat); cdecl;
    procedure drawInRect(rect: NSRect; fromRect: NSRect; operation: NSCompositingOperation; fraction: CGFloat); cdecl; overload;
    procedure drawInRect(dstSpacePortionRect: NSRect; fromRect: NSRect; operation: NSCompositingOperation; fraction: CGFloat; respectFlipped: Boolean; hints: NSDictionary); cdecl; overload;
  ...
  NSRulerMarker = interface(NSObject)
    ...
    function initWithRulerView(ruler: NSRulerView; markerLocation: CGFloat; image: NSImage; imageOrigin: NSPoint): Pointer; cdecl;
    function isDragging: Boolean; cdecl;
    function isMovable: Boolean; cdecl;
    function isRemovable: Boolean; cdecl;
    function markerLocation: CGFloat; cdecl;
    ...
    procedure setMarkerLocation(location: CGFloat); cdecl;
    ...
    function thicknessRequiredInRuler: CGFloat; cdecl;
  ...
  NSSpellChecker = interface(NSObject)
    ...
    function checkSpellingOfString(stringToCheck: NSString; startingAt: NSInteger; language: NSString; wrap: Boolean; inSpellDocumentWithTag: NSInteger; wordCount: PNSInteger): NSRange; cdecl; overload;
    function checkString(stringToCheck: NSString; range: NSRange; types: NSTextCheckingTypes; options: NSDictionary; inSpellDocumentWithTag: NSInteger; orthography: NSOrthography; wordCount: PNSInteger): NSArray; cdecl;
  ...
  NSShadow = interface(NSObject)
    ...
    function init: Pointer; cdecl;
    procedure setShadowBlurRadius(val: CGFloat); cdecl;
  ...
  NSSpeechSynthesizer = interface(NSObject)
    ...
    function objectForProperty(property_: NSString; error: PPointer = nil): Pointer; cdecl;
    ...
    function setObject(object_: Pointer; forProperty: NSString; error: PPointer = nil): Boolean; cdecl;
  ...
  NSScreen = interface(NSObject)
    ...
    function userSpaceScaleFactor: CGFloat; cdecl;
    function visibleFrame: NSRect; cdecl;
    function backingScaleFactor: CGFloat; cdecl; // OS X 10.7+
    function convertRectFromBacking(rect: NSRect): NSRect; cdecl; // OS X 10.7+
    function convertRectToBacking(rect: NSRect): NSRect; cdecl; // OS X 10.7+
  end;
  ...
  NSTextBlock = interface(NSObject)
    ...
    function valueForDimension(dimension: NSTextBlockDimension): CGFloat; cdecl;
    ...
    function widthForLayer(layer: NSTextBlockLayer; edge: NSRectEdge): CGFloat; cdecl;
...
//    {class} function templatesWithAttributeKeyPaths(keyPaths: NSArray; inEntityDescription: NSEntityDescription): NSArray; cdecl;
  ...
  NSPrintInfo = interface(NSObject)
    ...
    function leftMargin: CGFloat; cdecl;
    ...
    function rightMargin: CGFloat; cdecl;
    function scalingFactor: CGFloat; cdecl;
    procedure setBottomMargin(margin: CGFloat); cdecl;
    ...
    procedure setLeftMargin(margin: CGFloat); cdecl;
    ...
    procedure setRightMargin(margin: CGFloat); cdecl;
    procedure setScalingFactor(scalingFactor: CGFloat); cdecl;
    procedure setSelectionOnly(selectionOnly: Boolean); cdecl;
    procedure setTopMargin(margin: CGFloat); cdecl;
  ...
  NSTableColumn = interface(NSObject)
    ...
    function maxWidth: CGFloat; cdecl;
    function minWidth: CGFloat; cdecl;
    ...
    procedure setMaxWidth(maxWidth: CGFloat); cdecl;
    procedure setMinWidth(minWidth: CGFloat); cdecl;
  ...
  NSWorkspace = interface(NSObject)
    ...
    function launchApplicationAtURL(url: NSURL; options: NSWorkspaceLaunchOptions; configuration: NSDictionary; error: PPointer = nil): NSRunningApplication; cdecl;
    ...
    function performFileOperation(operation: NSString; source: NSString; destination: NSString; files: NSArray; tag: PNSInteger): Boolean; cdecl;
    ...
    function setDesktopImageURL(url: NSURL; forScreen: NSScreen; options: NSDictionary; error: PPointer = nil): Boolean; cdecl;
    ...
    function typeOfFile(absoluteFilePath: NSString; error: PPointer = nil): NSString; cdecl;
    function unmountAndEjectDeviceAtPath(path: NSString): Boolean; cdecl;
    function unmountAndEjectDeviceAtURL(url: NSURL; error: PPointer = nil): Boolean; cdecl;
  ...
  NSColorClass = interface(NSObjectClass)
    ...
    {class} function alternateSelectedControlColor: Pointer; cdecl; // API_DEPRECATED_WITH_REPLACEMENT("selectedContentBackgroundColor", macos(10.2,API_TO_BE_DEPRECATED))
    {class} function alternateSelectedControlTextColor: Pointer; cdecl;
    {class} function alternatingContentBackgroundColors: NSArray; cdecl;
    ...
    {class} function colorForControlTint(controlTint: NSControlTint): Pointer; cdecl; // API_DEPRECATED("NSControlTint does not describe the full range of available control accent colors. Use +[NSColor controlAccentColor] instead.", macos(10.0,API_TO_BE_DEPRECATED))
    {class} function colorFromPasteboard(pasteBoard: NSPasteboard): Pointer; cdecl;
    {class} function colorNamed(name: NSColorName): Pointer; overload; cdecl;
    [MethodName('colorNamed:bundle:')]
    {class} function colorNamed(name: NSColorName; bundle: NSBundle): Pointer; overload; cdecl;
    [MethodName('colorWithCalibratedHue:saturation:brightness:alpha:')]
    {class} function colorWithCalibratedHue(hue: CGFloat; saturation: CGFloat; brightness: CGFloat; alpha: CGFloat): Pointer; cdecl;
    [MethodName('colorWithCalibratedRed:green:blue:alpha:')]
    {class} function colorWithCalibratedRed(red: CGFloat; green: CGFloat; blue: CGFloat; alpha: CGFloat): Pointer; cdecl;
    [MethodName('colorWithCalibratedWhite:alpha:')]
    {class} function colorWithCalibratedWhite(white: CGFloat; alpha: CGFloat): Pointer; cdecl;
    ...
    [MethodName('colorWithColorSpace:hue:saturation:brightness:alpha:')]
    {class} function colorWithColorSpace(space: NSColorSpace; hue: CGFloat; saturation: CGFloat; brightness: CGFloat; alpha: CGFloat): Pointer; overload; cdecl;
    [MethodName('colorWithColorSpace:components:count:')]
    {class} function colorWithColorSpace(space: NSColorSpace; components: PCGFloat; numberOfComponents: Pointer): Pointer; overload; cdecl;
    [MethodName('colorWithDeviceCyan:magenta:yellow:black:alpha:')]
    {class} function colorWithDeviceCyan(cyan: CGFloat; magenta: CGFloat; yellow: CGFloat; black: CGFloat; alpha: CGFloat): Pointer; cdecl;
    [MethodName('colorWithDeviceHue:saturation:brightness:alpha:')]
    {class} function colorWithDeviceHue(hue: CGFloat; saturation: CGFloat; brightness: CGFloat; alpha: CGFloat): Pointer; cdecl;
    [MethodName('colorWithDeviceRed:green:blue:alpha:')]
    {class} function colorWithDeviceRed(red: CGFloat; green: CGFloat; blue: CGFloat; alpha: CGFloat): Pointer; cdecl;
    [MethodName('colorWithDeviceWhite:alpha:')]
    {class} function colorWithDeviceWhite(white: CGFloat; alpha: CGFloat): Pointer; cdecl;
    [MethodName('colorWithDisplayP3Red:green:blue:alpha:')]
    {class} function colorWithDisplayP3Red(red: CGFloat; green: CGFloat; blue: CGFloat; alpha: CGFloat): Pointer; cdecl;
    [MethodName('colorWithGenericGamma22White:alpha:')]
    {class} function colorWithGenericGamma22White(white: CGFloat; alpha: CGFloat): Pointer; cdecl;
    [MethodName('colorWithHue:saturation:brightness:alpha:')]
    ...
    [MethodName('colorWithSRGBRed:green:blue:alpha:')]
    {class} function colorWithSRGBRed(red: CGFloat; green: CGFloat; blue: CGFloat; alpha: CGFloat): Pointer; cdecl;
    [MethodName('colorWithWhite:alpha:')]
    {class} function colorWithWhite(white: CGFloat; alpha: CGFloat): Pointer; cdecl;
    {class} function controlAccentColor: Pointer; cdecl;
    {class} function controlAlternatingRowBackgroundColors: NSArray; cdecl; // API_DEPRECATED_WITH_REPLACEMENT("alternatingContentBackgroundColors", macos(10.3,API_TO_BE_DEPRECATED))
    {class} function controlBackgroundColor: Pointer; cdecl;
    {class} function controlColor: Pointer; cdecl;
    {class} function controlDarkShadowColor: Pointer; cdecl; // API_DEPRECATED("Use a color that matches the semantics being used, such as `separatorColor`", macos(10.0,API_TO_BE_DEPRECATED))
    {class} function controlHighlightColor: Pointer; cdecl; // API_DEPRECATED("Use a color that matches the semantics being used, such as `separatorColor`", macos(10.0,API_TO_BE_DEPRECATED))
    {class} function controlLightHighlightColor: Pointer; cdecl; // API_DEPRECATED("Use a color that matches the semantics being used, such as `separatorColor`", macos(10.0,API_TO_BE_DEPRECATED))
    {class} function controlShadowColor: Pointer; cdecl; // API_DEPRECATED("Use a color that matches the semantics being used, such as `separatorColor`", macos(10.0,API_TO_BE_DEPRECATED))
    ...
    {class} function findHighlightColor: Pointer; cdecl;
    {class} function grayColor: Pointer; cdecl;
    {class} function greenColor: Pointer; cdecl;
    {class} function gridColor: Pointer; cdecl;
    {class} function headerColor: Pointer; cdecl; // API_DEPRECATED("Use NSVisualEffectMaterialHeaderView", macos(10.0,API_TO_BE_DEPRECATED))
    {class} function headerTextColor: Pointer; cdecl;
    {class} function highlightColor: Pointer; cdecl;
    {class} function ignoresAlpha: Integer; cdecl;
    {class} function keyboardFocusIndicatorColor: Pointer; cdecl;
    {class} function knobColor: Pointer; cdecl; // API_DEPRECATED("Use NSScroller instead", macos(10.0,API_TO_BE_DEPRECATED))
    {class} function labelColor: Pointer; cdecl;
    {class} function lightGrayColor: Pointer; cdecl;
    {class} function linkColor: Pointer; cdecl;
    {class} function magentaColor: Pointer; cdecl;
    {class} function orangeColor: Pointer; cdecl;
    {class} function placeholderTextColor: Pointer; cdecl;
    {class} function purpleColor: Pointer; cdecl;
    {class} function quaternaryLabelColor: Pointer; cdecl;
    {class} function redColor: Pointer; cdecl;
    {class} function scrollBarColor: Pointer; cdecl; // API_DEPRECATED("Use NSScroller instead", macos(10.0,API_TO_BE_DEPRECATED))
    {class} function scrubberTexturedBackgroundColor: Pointer; cdecl;
    {class} function secondaryLabelColor: Pointer; cdecl;
    {class} function secondarySelectedControlColor: Pointer; cdecl; // API_DEPRECATED_WITH_REPLACEMENT("unemphasizedSelectedContentBackgroundColor", macos(10.1,API_TO_BE_DEPRECATED))
    {class} function selectedContentBackgroundColor: Pointer; cdecl;
    {class} function selectedControlColor: Pointer; cdecl;
    {class} function selectedControlTextColor: Pointer; cdecl;
    {class} function selectedKnobColor: Pointer; cdecl; // API_DEPRECATED("Use NSScroller instead", macos(10.0,API_TO_BE_DEPRECATED))
    {class} function selectedMenuItemColor: Pointer; cdecl; // API_DEPRECATED("Use NSVisualEffectMaterialSelection", macos(10.0,API_TO_BE_DEPRECATED))
    ...
    {class} function separatorColor: Pointer; cdecl;
    {class} procedure setIgnoresAlpha(ignoresAlpha: Integer); cdecl;
    {class} function shadowColor: Pointer; cdecl;
    {class} function systemBlueColor: Pointer; cdecl;
    {class} function systemBrownColor: Pointer; cdecl;
    {class} function systemGrayColor: Pointer; cdecl;
    {class} function systemGreenColor: Pointer; cdecl;
    {class} function systemIndigoColor: Pointer; cdecl;
    {class} function systemOrangeColor: Pointer; cdecl;
    {class} function systemPinkColor: Pointer; cdecl;
    {class} function systemPurpleColor: Pointer; cdecl;
    {class} function systemRedColor: Pointer; cdecl;
    {class} function systemTealColor: Pointer; cdecl;
    {class} function systemYellowColor: Pointer; cdecl;
    {class} function tertiaryLabelColor: Pointer; cdecl;
    ...
    {class} function unemphasizedSelectedContentBackgroundColor: Pointer; cdecl;
    {class} function unemphasizedSelectedTextBackgroundColor: Pointer; cdecl;
    {class} function unemphasizedSelectedTextColor: Pointer; cdecl;
    {class} function whiteColor: Pointer; cdecl;
    {class} function windowBackgroundColor: Pointer; cdecl;
    {class} function windowFrameColor: Pointer; cdecl; // API_DEPRECATED("Use NSVisualEffectMaterialTitlebar", macos(10.0,API_TO_BE_DEPRECATED))
  ...
  NSColor = interface(NSObject)
    ...
    function alphaComponent: CGFloat; cdecl;
    function blackComponent: CGFloat; cdecl;
    function blendedColorWithFraction(fraction: CGFloat; ofColor: NSColor): NSColor; cdecl;
    function blueComponent: CGFloat; cdecl;
    function brightnessComponent: CGFloat; cdecl;
    ...
    function colorWithAlphaComponent(alpha: CGFloat): NSColor; cdecl;
    function cyanComponent: CGFloat; cdecl;
    procedure drawSwatchInRect(rect: NSRect); cdecl;
    procedure getComponents(components: PCGFloat); cdecl;
    procedure getCyan(cyan: PCGFloat; magenta: PCGFloat; yellow: PCGFloat; black: PCGFloat; alpha: PCGFloat); cdecl;
    procedure getHue(hue: PCGFloat; saturation: PCGFloat; brightness: PCGFloat; alpha: PCGFloat); cdecl;
    procedure getRed(red: PCGFloat; green: PCGFloat; blue: PCGFloat; alpha: PCGFloat); cdecl;
    procedure getWhite(white: PCGFloat; alpha: PCGFloat); cdecl;
    function greenComponent: CGFloat; cdecl;
    function highlightWithLevel(val: CGFloat): NSColor; cdecl;
    function hueComponent: CGFloat; cdecl;
    function localizedCatalogNameComponent: NSString; cdecl;
    function localizedColorNameComponent: NSString; cdecl;
    function magentaComponent: CGFloat; cdecl;
    function numberOfComponents: NSInteger; cdecl;
    function patternImage: NSImage; cdecl;
    function redComponent: CGFloat; cdecl;
    function saturationComponent: CGFloat; cdecl;
    procedure setFill; cdecl;
    procedure setStroke; cdecl;
    function shadowWithLevel(val: CGFloat): NSColor; cdecl;
    function whiteComponent: CGFloat; cdecl;
    procedure writeToPasteboard(pasteBoard: NSPasteboard); cdecl;
    function yellowComponent: CGFloat; cdecl;
  end;
  ...
  NSTypesetter = interface(NSObject)
    ...
    function baselineOffsetInLayoutManager(layoutMgr: NSLayoutManager; glyphIndex: NSUInteger): CGFloat; cdecl;
    ...
    function getGlyphsInRange(glyphsRange: NSRange; glyphs: PNSGlyph; characterIndexes: PNSUInteger; glyphInscriptions: PNSGlyphInscription; elasticBits: PBoolean; bidiLevels: PByte): NSUInteger; cdecl;
    ...
    procedure getLineFragmentRect(lineFragmentRect: NSRectPointer; usedRect: NSRectPointer; remainingRect: NSRectPointer; forStartingGlyphAtIndex: NSUInteger; proposedRect: NSRect; lineSpacing: CGFloat; paragraphSpacingBefore: CGFloat; paragraphSpacingAfter: CGFloat); cdecl; overload;
    function glyphRangeForCharacterRange(charRange: NSRange; actualCharacterRange: PNSRange): NSRange; cdecl;
    ...
    procedure layoutGlyphsInLayoutManager(layoutManager: NSLayoutManager; startingAtGlyphIndex: NSUInteger; maxNumberOfLineFragments: NSUInteger; nextGlyphIndex: PNSUInteger); cdecl;
    function layoutManager: NSLayoutManager; cdecl;
    function layoutParagraphAtPoint(lineFragmentOrigin: NSPointPointer): NSUInteger; cdecl;
    function lineFragmentPadding: CGFloat; cdecl;
    function lineSpacingAfterGlyphAtIndex(glyphIndex: NSUInteger; withProposedLineFragmentRect: NSRect): CGFloat; cdecl;
    ...
    function paragraphSpacingAfterGlyphAtIndex(glyphIndex: NSUInteger; withProposedLineFragmentRect: NSRect): CGFloat; cdecl;
    function paragraphSpacingBeforeGlyphAtIndex(glyphIndex: NSUInteger; withProposedLineFragmentRect: NSRect): CGFloat; cdecl;
    procedure setAttachmentSize(attachmentSize: NSSize; forGlyphRange: NSRange); cdecl;
    ...
    procedure setHyphenationFactor(factor: Single); cdecl;
    procedure setLineFragmentPadding(padding: CGFloat); cdecl;
    procedure setLineFragmentRect(fragmentRect: NSRect; forGlyphRange: NSRange; usedRect: NSRect; baselineOffset: CGFloat); cdecl;
    procedure setLocation(location: NSPoint; withAdvancements: PCGFloat; forStartOfGlyphRange: NSRange); cdecl;
    ...
    function textContainers: NSArray; cdecl;
    function textTabForGlyphLocation(glyphLocation: CGFloat; writingDirection: NSWritingDirection; maxLocation: CGFloat): NSTextTab; cdecl;
    function typesetterBehavior: NSTypesetterBehavior; cdecl;
    function usesFontLeading: Boolean; cdecl;
    procedure willSetLineFragmentRect(lineRect: NSRectPointer; forGlyphRange: NSRange; usedRect: NSRectPointer; baselineOffset: PCGFloat); cdecl;
  end;
  ...
  NSBezierPathClass = interface(NSObjectClass)
    ...
    {class} function bezierPathWithRoundedRect(rect: NSRect; xRadius: CGFloat; yRadius: CGFloat): Pointer; cdecl;
    {class} procedure clipRect(rect: NSRect); cdecl;
    {class} function defaultFlatness: CGFloat; cdecl;
    {class} function defaultLineCapStyle: NSLineCapStyle; cdecl;
    {class} function defaultLineJoinStyle: NSLineJoinStyle; cdecl;
    {class} function defaultLineWidth: CGFloat; cdecl;
    {class} function defaultMiterLimit: CGFloat; cdecl;
    ...
    {class} procedure setDefaultFlatness(flatness: CGFloat); cdecl;
    ...
    {class} procedure setDefaultLineWidth(lineWidth: CGFloat); cdecl;
    {class} procedure setDefaultMiterLimit(limit: CGFloat); cdecl;
  ...
  NSBezierPath = interface(NSObject)
    ...
    procedure appendBezierPathWithArcFromPoint(point1: NSPoint; toPoint: NSPoint; radius: CGFloat); cdecl;
    procedure appendBezierPathWithArcWithCenter(center: NSPoint; radius: CGFloat; startAngle: CGFloat; endAngle: CGFloat); cdecl; overload;
    procedure appendBezierPathWithArcWithCenter(center: NSPoint; radius: CGFloat; startAngle: CGFloat; endAngle: CGFloat; clockwise: Boolean); cdecl; overload;
    ...
    procedure appendBezierPathWithRoundedRect(rect: NSRect; xRadius: CGFloat; yRadius: CGFloat); cdecl;
  ...
  NSDocumentController = interface(NSObject)
    ...
    function init: Pointer; cdecl;
    function makeDocumentForURL(absoluteDocumentURL: NSURL; withContentsOfURL: NSURL; ofType: NSString; error: PPointer = nil): Pointer; cdecl;
    ...
    function makeDocumentWithContentsOfURL(absoluteURL: NSURL; ofType: NSString; error: PPointer = nil): Pointer; cdecl; overload;
    function makeUntitledDocumentOfType(type_: NSString): Pointer; cdecl; overload;
    function makeUntitledDocumentOfType(typeName: NSString; error: PPointer = nil): Pointer; cdecl; overload;
    ...
    function openDocumentWithContentsOfURL(absoluteURL: NSURL; display: Boolean; error: PPointer = nil): Pointer; cdecl; overload;
    function openUntitledDocumentAndDisplay(displayDocument: Boolean; error: PPointer = nil): Pointer; cdecl;
    ...
    function reopenDocumentForURL(absoluteDocumentURL: NSURL; withContentsOfURL: NSURL; error: PPointer = nil): Boolean; cdecl;
    ...
    function typeForContentsOfURL(inAbsoluteURL: NSURL; error: PPointer = nil): NSString; cdecl;
  ...
  NSDocument = interface(NSObject)
    ...
    function dataOfType(typeName: NSString; error: PPointer = nil): NSData; cdecl;
    ...
    function fileAttributesToWriteToURL(absoluteURL: NSURL; ofType: NSString; forSaveOperation: NSSaveOperationType; originalContentsURL: NSURL; error: PPointer = nil): NSDictionary; cdecl;
    ...
    function fileWrapperOfType(typeName: NSString; error: PPointer = nil): NSFileWrapper; cdecl;
    ...
    function init: Pointer; cdecl;
    function initForURL(absoluteDocumentURL: NSURL; withContentsOfURL: NSURL; ofType: NSString; error: PPointer = nil): Pointer; cdecl;
    ...
    function initWithContentsOfURL(absoluteURL: NSURL; ofType: NSString; error: PPointer = nil): Pointer; cdecl; overload;
    function initWithType(typeName: NSString; error: PPointer = nil): Pointer; cdecl;
    ...
    function printInfo: NSPrintInfo; cdecl;
    function printOperationWithSettings(printSettings: NSDictionary; error: PPointer = nil): NSPrintOperation; cdecl;
    procedure printShowingPrintPanel(flag: Boolean); cdecl;
    function readFromData(data: NSData; ofType: NSString; error: PPointer = nil): Boolean; cdecl;
    function readFromFile(fileName: NSString; ofType: NSString): Boolean; cdecl;
    function readFromFileWrapper(fileWrapper: NSFileWrapper; ofType: NSString; error: PPointer = nil): Boolean; cdecl;
    function readFromURL(url: NSURL; ofType: NSString): Boolean; cdecl; overload;
    function readFromURL(absoluteURL: NSURL; ofType: NSString; error: PPointer = nil): Boolean; cdecl; overload;
    ...
    function revertToContentsOfURL(absoluteURL: NSURL; ofType: NSString; error: PPointer = nil): Boolean; cdecl;
    ...
    function saveToURL(absoluteURL: NSURL; ofType: NSString; forSaveOperation: NSSaveOperationType; error: PPointer = nil): Boolean; cdecl; overload;
    ...
    function writeSafelyToURL(absoluteURL: NSURL; ofType: NSString; forSaveOperation: NSSaveOperationType; error: PPointer = nil): Boolean; cdecl;
    ...
    function writeToURL(absoluteURL: NSURL; ofType: NSString; error: PPointer = nil): Boolean; cdecl; overload;
    function writeToURL(absoluteURL: NSURL; ofType: NSString; forSaveOperation: NSSaveOperationType; originalContentsURL: NSURL; error: PPointer = nil): Boolean; cdecl; overload;
  ...
  NSFontClass = interface(NSObjectClass)
    ...
    {class} function controlContentFontOfSize(fontSize: CGFloat): Pointer; cdecl;
    {class} function fontWithDescriptor(fontDescriptor: NSFontDescriptor; size: CGFloat): Pointer; cdecl; overload;
    {class} function fontWithDescriptor(fontDescriptor: NSFontDescriptor; textTransform: NSAffineTransform): Pointer; cdecl; overload;
    {class} function fontWithName(fontName: NSString; matrix: PCGFloat): Pointer; cdecl; overload;
    {class} function fontWithName(fontName: NSString; size: CGFloat): Pointer; cdecl; overload;
    {class} function labelFontOfSize(fontSize: CGFloat): Pointer; cdecl;
    {class} function labelFontSize: CGFloat; cdecl;
    {class} function menuBarFontOfSize(fontSize: CGFloat): Pointer; cdecl;
    {class} function menuFontOfSize(fontSize: CGFloat): Pointer; cdecl;
    {class} function messageFontOfSize(fontSize: CGFloat): Pointer; cdecl;
    {class} function paletteFontOfSize(fontSize: CGFloat): Pointer; cdecl;
    ...
    {class} function systemFontSizeForControlSize(controlSize: NSControlSize): CGFloat; cdecl;
    {class} function titleBarFontOfSize(fontSize: CGFloat): Pointer; cdecl;
    {class} function toolTipsFontOfSize(fontSize: CGFloat): Pointer; cdecl;
    {class} function userFixedPitchFontOfSize(fontSize: CGFloat): Pointer; cdecl;
    {class} function userFontOfSize(fontSize: CGFloat): Pointer; cdecl;
  end;
  NSFont = interface(NSObject)
    ...
    function italicAngle: CGFloat; cdecl;
    function leading: CGFloat; cdecl;
    function matrix: PCGFloat; cdecl;
    ...
    function underlinePosition: CGFloat; cdecl;
    function underlineThickness: CGFloat; cdecl;
  ...
  NSFileWrapper = interface(NSObject)
    ...
    function initWithURL(url: NSURL; options: NSFileWrapperReadingOptions; error: PPointer = nil): Pointer; cdecl;
    ...
    function readFromURL(url: NSURL; options: NSFileWrapperReadingOptions; error: PPointer = nil): Boolean; cdecl;
    ...
    function writeToURL(url: NSURL; options: NSFileWrapperWritingOptions; originalContentsURL: NSURL; error: PPointer = nil): Boolean; cdecl;
  end;
  ...
  NSPersistentDocument = interface(NSDocument)
    ...
    function configurePersistentStoreCoordinatorForURL(url: NSURL; ofType: NSString; error: PPointer = nil): Boolean; cdecl; overload;
    function configurePersistentStoreCoordinatorForURL(url: NSURL; ofType: NSString; modelConfiguration: NSString; storeOptions: NSDictionary; error: PPointer = nil): Boolean; cdecl; overload;
//    function managedObjectContext: NSManagedObjectContext; cdecl;
    ...
    function readFromURL(absoluteURL: NSURL; ofType: NSString; error: PPointer = nil): Boolean; cdecl;
    function revertToContentsOfURL(inAbsoluteURL: NSURL; ofType: NSString; error: PPointer = nil): Boolean; cdecl;
//    procedure setManagedObjectContext(managedObjectContext: NSManagedObjectContext); cdecl;
    function writeToURL(absoluteURL: NSURL; ofType: NSString; forSaveOperation: NSSaveOperationType; originalContentsURL: NSURL; error: PPointer = nil): Boolean; cdecl;
  end;
  ...
  NSAppearanceClass = interface(NSObjectClass)
    {class} function appearanceNamed(name: NSAppearanceName): NSAppearance; cdecl;
    {class} function currentAppearance: NSAppearance; cdecl;
    {class} procedure setCurrentAppearance(currentAppearance: NSAppearance); cdecl;
  end;

  NSAppearance = interface(NSObject)
    function allowsVibrancy: Integer; cdecl;
    function bestMatchFromAppearancesWithNames(appearances: NSArray): NSAppearanceName; cdecl;
    [MethodName('initWithAppearanceNamed:bundle:')]
    function initWithAppearanceNamed(name: NSAppearanceName; bundle: NSBundle): Pointer; cdecl;
    function initWithCoder(coder: NSCoder): Pointer; cdecl;
    function name: NSAppearanceName; cdecl;
  end;
  TNSAppearance = class(TOCGenericImport<NSAppearanceClass, NSAppearance>) end;
  ...
  NSApplication = interface(NSResponder)
    ...
    function appearance: NSAppearance; cdecl;
    ...
    function effectiveAppearance: NSAppearance; cdecl;
    ...
    function nextEventMatchingMask(mask: NSUInteger; untilDate: NSDate; inMode: NSString; dequeue: Boolean): NSEvent; cdecl;
    ...
    procedure setAppearance(appearance: NSAppearance); cdecl;
  ...
  NSWindowClass = interface(NSResponderClass)
    ...
    {class} function minFrameWidthWithTitle(aTitle: NSString; styleMask: NSUInteger): CGFloat; cdecl;
  ...
  NSWindow = interface(NSResponder)
    ...
    function alphaValue: CGFloat; cdecl;
    ...
    function contentBorderThicknessForEdge(edge: NSRectEdge): CGFloat; cdecl;
    ...
    function convertRectFromScreen(frameRect: NSRect): NSRect; cdecl;
    ...
    procedure setAlphaValue(windowAlpha: CGFloat); cdecl;
    ...
    procedure setContentBorderThickness(thickness: CGFloat; forEdge: NSRectEdge); cdecl;
  ...
  NSBitmapImageRepClass = interface(NSImageRepClass)
    ...
    {class} procedure getTIFFCompressionTypes(list: PNSTIFFCompression; count: PNSInteger); cdecl;
  ...
  NSBitmapImageRep = interface(NSImageRep)
    ...
    function colorSpace: NSColorSpace; cdecl;
    procedure colorizeByMappingGray(midPoint: CGFloat; toColor: NSColor; blackMapping: NSColor; whiteMapping: NSColor); cdecl;
    ...
    procedure getPixel(p: PNSUInteger; atX: NSInteger; y: NSInteger); cdecl;
    ...
    procedure setPixel(p: PNSUInteger; atX: NSInteger; y: NSInteger); cdecl;
  ...
  NSMutableParagraphStyle = interface(NSParagraphStyle)
    ...
    procedure setBaseWritingDirection(writingDirection: NSWritingDirection); cdecl;
    procedure setDefaultTabInterval(aFloat: CGFloat); cdecl;
    procedure setFirstLineHeadIndent(aFloat: CGFloat); cdecl;
    procedure setHeadIndent(aFloat: CGFloat); cdecl;
    procedure setHeaderLevel(level: NSInteger); cdecl;
    procedure setHyphenationFactor(aFactor: Single); cdecl;
    procedure setLineBreakMode(mode: NSLineBreakMode); cdecl;
    procedure setLineHeightMultiple(aFloat: CGFloat); cdecl;
    procedure setLineSpacing(aFloat: CGFloat); cdecl;
    procedure setMaximumLineHeight(aFloat: CGFloat); cdecl;
    procedure setMinimumLineHeight(aFloat: CGFloat); cdecl;
    procedure setParagraphSpacing(aFloat: CGFloat); cdecl;
    procedure setParagraphSpacingBefore(aFloat: CGFloat); cdecl;
    procedure setParagraphStyle(obj: NSParagraphStyle); cdecl;
    procedure setTabStops(array_: NSArray); cdecl;
    procedure setTailIndent(aFloat: CGFloat); cdecl;
  ...
  NSDrawer = interface(NSResponder)
    ...
    function leadingOffset: CGFloat; cdecl;
    ...
    procedure setLeadingOffset(offset: CGFloat); cdecl;
    ...
    procedure setTrailingOffset(offset: CGFloat); cdecl;
    function state: NSInteger; cdecl;
    procedure toggle(sender: Pointer); cdecl;
    function trailingOffset: CGFloat; cdecl;
  end;
  ...
  NSView = interface(NSResponder)
    ...
    procedure adjustPageHeightNew(newBottom: PCGFloat; top: CGFloat; bottom: CGFloat; limit: CGFloat); cdecl;
    procedure adjustPageWidthNew(newRight: PCGFloat; left: CGFloat; right: CGFloat; limit: CGFloat); cdecl;
    ...
    function bounds: NSRect; cdecl;
    function boundsRotation: CGFloat; cdecl;
...
//    function convertRect(aRect: NSRect; toView: NSView): NSRect; cdecl; overload;
    ...
    function convertRectToBacking(aRect: NSRect): NSRect; cdecl;
...
//    function convertSize(aSize: NSSize; toView: NSView): NSSize; cdecl; overload;
    ...
    function focusRingType: NSFocusRingType; cdecl;
    function frame: NSRect; cdecl;
    function frameCenterRotation: CGFloat; cdecl;
    function frameRotation: CGFloat; cdecl;
    function fittingSize: NSSize; cdecl;
    function gState: NSInteger; cdecl;
    procedure getRectsBeingDrawn(rects: Pointer; count: PNSInteger); cdecl;
    procedure getRectsExposedDuringLiveResize(exposedRects: PNSRect; count: PNSInteger); cdecl;
    function heightAdjustLimit: CGFloat; cdecl;
    ...
    function intrinsicContentSize: NSSize; cdecl;
    ...
    procedure rotateByAngle(angle: CGFloat); cdecl;
...
//    function rulerView(ruler: NSRulerView; shouldRemoveMarker: NSRulerMarker): Boolean; cdecl; overload;
    function rulerView(ruler: NSRulerView; willAddMarker: NSRulerMarker; atLocation: CGFloat): CGFloat; cdecl; overload;
//    function rulerView(ruler: NSRulerView; willMoveMarker: NSRulerMarker; toLocation: CGFloat): CGFloat; cdecl; overload;
    ...
    procedure setAlphaValue(viewAlpha: CGFloat); cdecl;
    ...
    procedure setBoundsRotation(angle: CGFloat); cdecl;
    ...
    procedure setFrameCenterRotation(angle: CGFloat); cdecl;
    procedure setFrameOrigin(newOrigin: NSPoint); cdecl;
    procedure setFrameRotation(angle: CGFloat); cdecl;
    ...
    function widthAdjustLimit: CGFloat; cdecl;
...
//    function fetchWithRequest(fetchRequest: NSFetchRequest; merge: Boolean; error: PPointer = nil): Boolean; cdecl;
...
//    procedure setManagedObjectContext(managedObjectContext: NSManagedObjectContext); cdecl;
  ...
  NSSegmentedCell = interface(NSActionCell)
    ...
    procedure setWidth(width: CGFloat; forSegment: NSInteger); cdecl;
    ...
    function widthForSegment(segment: NSInteger): CGFloat; cdecl;
  end;
  ...
  NSSliderCell = interface(NSActionCell)
    ...
    function knobThickness: CGFloat; cdecl;
    ...
    procedure setKnobThickness(aFloat: CGFloat); cdecl;
  ...
  NSTableHeaderView = interface(NSView)
    ...
    function draggedDistance: CGFloat; cdecl;
...
//    procedure replaceCharactersInRange(range: NSRange; withRTFD: NSData); cdecl; overload;
  ...
  NSSplitView = interface(NSView)
    ...
    function dividerThickness: CGFloat; cdecl;
    ...
    function isVertical: Boolean; cdecl;
    function maxPossiblePositionOfDividerAtIndex(dividerIndex: NSInteger): CGFloat; cdecl;
    function minPossiblePositionOfDividerAtIndex(dividerIndex: NSInteger): CGFloat; cdecl;
    ...
    procedure setPosition(position: CGFloat; ofDividerAtIndex: NSInteger); cdecl;
  ...
  NSFormCell = interface(NSActionCell)
    ...
    procedure setTitleFont(fontObj: NSFont); cdecl;
    procedure setTitleWidth(width: CGFloat); cdecl;
    procedure setTitleWithMnemonic(stringWithAmpersand: NSString); cdecl;
    function title: NSString; cdecl;
    function titleAlignment: NSTextAlignment; cdecl;
    function titleBaseWritingDirection: NSWritingDirection; cdecl;
    function titleFont: NSFont; cdecl;
    function titleWidth: CGFloat; cdecl; overload;
    function titleWidth(aSize: NSSize): CGFloat; cdecl; overload;
  end;
  ...
  NSRulerViewClass = interface(NSViewClass)
    ...
    {class} procedure registerUnitWithName(unitName: NSString; abbreviation: NSString; unitToPointsConversionFactor: CGFloat; stepUpCycle: NSArray; stepDownCycle: NSArray); cdecl;
  end;
  NSRulerView = interface(NSView)
    ['{FF4F8936-4DC3-4FE9-80B5-F90E46B61069}']
    function accessoryView: NSView; cdecl;
    procedure addMarker(marker: NSRulerMarker); cdecl;
    function baselineLocation: CGFloat; cdecl;
    ...
    procedure moveRulerlineFromLocation(oldLocation: CGFloat; toLocation: CGFloat); cdecl;
    function orientation: NSRulerOrientation; cdecl;
    function originOffset: CGFloat; cdecl;
    procedure removeMarker(marker: NSRulerMarker); cdecl;
    function requiredThickness: CGFloat; cdecl;
    function reservedThicknessForAccessoryView: CGFloat; cdecl;
    function reservedThicknessForMarkers: CGFloat; cdecl;
    function ruleThickness: CGFloat; cdecl;
    ...
    procedure setOriginOffset(offset: CGFloat); cdecl;
    procedure setReservedThicknessForAccessoryView(thickness: CGFloat); cdecl;
    procedure setReservedThicknessForMarkers(thickness: CGFloat); cdecl;
    procedure setRuleThickness(thickness: CGFloat); cdecl;
  ...
  NSButtonCell = interface(NSActionCell)
    ...
    procedure setKeyEquivalentFont(fontName: NSString; size: CGFloat); cdecl; overload;
    procedure setKeyEquivalentModifierMask(mask: NSUInteger); cdecl;
  ...
  NSScrollView = interface(NSView)
    ...
    function horizontalLineScroll: CGFloat; cdecl;
    function horizontalPageScroll: CGFloat; cdecl;
    function horizontalRulerView: NSRulerView; cdecl;
    function horizontalScroller: NSScroller; cdecl;
    function lineScroll: CGFloat; cdecl;
    function pageScroll: CGFloat; cdecl;
    ...
    procedure setHorizontalLineScroll(value: CGFloat); cdecl;
    procedure setHorizontalPageScroll(value: CGFloat); cdecl;
    procedure setHorizontalRulerView(ruler: NSRulerView); cdecl;
    procedure setHorizontalScroller(anObject: NSScroller); cdecl;
    procedure setLineScroll(value: CGFloat); cdecl;
    procedure setPageScroll(value: CGFloat); cdecl;
    procedure setRulersVisible(flag: Boolean); cdecl;
    procedure setScrollsDynamically(flag: Boolean); cdecl;
    procedure setVerticalLineScroll(value: CGFloat); cdecl;
    procedure setVerticalPageScroll(value: CGFloat); cdecl;
    ...
    function verticalLineScroll: CGFloat; cdecl;
    function verticalPageScroll: CGFloat; cdecl;
  ...
  NSTextView = interface(NSText)
    ...
    procedure complete(sender: Pointer); cdecl;
    function completionsForPartialWordRange(charRange: NSRange; indexOfSelectedItem: PNSInteger): NSArray; cdecl;
...
//    function rulerView(ruler: NSRulerView; willMoveMarker: NSRulerMarker; toLocation: CGFloat): CGFloat; cdecl; overload;
  ...
  NSBrowser = interface(NSControl)
    ...
    function columnContentWidthForColumnWidth(columnWidth: CGFloat): CGFloat; cdecl;
    function columnOfMatrix(matrix: NSMatrix): NSInteger; cdecl;
    function columnResizingType: NSBrowserColumnResizingType; cdecl;
    function columnWidthForColumnContentWidth(columnContentWidth: CGFloat): CGFloat; cdecl;
    function columnsAutosaveName: NSString; cdecl;
    function defaultColumnWidth: CGFloat; cdecl;
    ...
    function getRow(row: PNSInteger; column: PNSInteger; forPoint: NSPoint): Boolean; cdecl;
    function hasHorizontalScroller: Boolean; cdecl;
    ...
    function minColumnWidth: CGFloat; cdecl;
    ...
    procedure setDefaultColumnWidth(columnWidth: CGFloat); cdecl;
    ...
    procedure setMinColumnWidth(columnWidth: CGFloat); cdecl;
    ...
    procedure setRowHeight(height: CGFloat); cdecl;
    ...
    function widthOfColumn(column: NSInteger): CGFloat; cdecl;
  end;
  ...
  NSComboBoxCell = interface(NSTextFieldCell)
    ...
    function itemHeight: CGFloat; cdecl;
    ...
    procedure setItemHeight(itemHeight: CGFloat); cdecl;
  ...
  NSScrollerClass = interface(NSControlClass)
    ...
    {class} function scrollerWidth: CGFloat; cdecl;
    {class} function scrollerWidthForControlSize(controlSize: NSControlSize): CGFloat; cdecl;
  end;
  NSScroller = interface(NSControl)
    ...
    function knobProportion: CGFloat; cdecl;
    function rectForPart(partCode: NSScrollerPart): NSRect; cdecl;
    procedure setArrowsPosition(where: NSScrollArrowPosition); cdecl;
    procedure setControlSize(controlSize: NSControlSize); cdecl;
    procedure setControlTint(controlTint: NSControlTint); cdecl;
    procedure setFloatValue(aFloat: Single; knobProportion: CGFloat); cdecl;
    procedure setKnobProportion(proportion: CGFloat); cdecl;
  ...
  NSMenuItemCell = interface(NSButtonCell)
    ...
    function imageWidth: CGFloat; cdecl;
    function keyEquivalentRectForBounds(cellFrame: NSRect): NSRect; cdecl;
    function keyEquivalentWidth: CGFloat; cdecl;
    ...
    function stateImageWidth: CGFloat; cdecl;
    function tag: NSInteger; cdecl;
    function titleRectForBounds(cellFrame: NSRect): NSRect; cdecl;
    function titleWidth: CGFloat; cdecl;
  end;
  ...
  NSTextField = interface(NSControl)
    ...
    procedure setEditable(flag: Boolean); cdecl;
    procedure setImportsGraphics(flag: Boolean); cdecl;
    procedure setPlaceholderString(placeholderString: NSString); cdecl;
    procedure setSelectable(flag: Boolean); cdecl;
    procedure setTextColor(color: NSColor); cdecl;
    procedure setTitleWithMnemonic(stringWithAmpersand: NSString); cdecl;
    function textColor: NSColor; cdecl;
  ...
  NSSecureTextFieldClass = interface(NSTextFieldClass)
    ['{4AA49977-FB57-4CA4-A423-F99F4FABB671}']
  end;
  NSSecureTextField = interface(NSTextField)
    ['{E70825A5-96A7-4E2B-8751-F40425C26850}']
  end;
  TNSSecureTextField = class(TOCGenericImport<NSSecureTextFieldClass, NSSecureTextField>)
  end;
  ...
  NSMatrix = interface(NSControl)
    ...
    procedure getNumberOfRows(rowCount: PNSInteger; columns: PNSInteger); cdecl;
    function getRow(row: PNSInteger; column: PNSInteger; forPoint: NSPoint): Boolean; cdecl; overload;
    function getRow(row: PNSInteger; column: PNSInteger; ofCell: NSCell): Boolean; cdecl; overload;
  ...
  NSOutlineView = interface(NSTableView)
    ...
    function indentationPerLevel: CGFloat; cdecl;
    ...
    procedure setIndentationPerLevel(indentationPerLevel: CGFloat); cdecl;
  ...
  NSForm = interface(NSMatrix)
    ...
    procedure setBezeled(flag: Boolean); cdecl;
    procedure setBordered(flag: Boolean); cdecl;
    procedure setEntryWidth(width: CGFloat); cdecl;
    procedure setFrameSize(newSize: NSSize); cdecl;
    procedure setInterlineSpacing(spacing: CGFloat); cdecl;
  ...
  function NSViewGlobalFrameDidChangeNotification: NSString;
  function NSAppKitVersionNumber: Double;

  function NSAppearanceNameAqua: NSAppearanceName;
  function NSAppearanceNameDarkAqua: NSAppearanceName;
  function NSAppearanceNameLightContent: NSAppearanceName;
  function NSAppearanceNameVibrantDark: NSAppearanceName;
  function NSAppearanceNameVibrantLight: NSAppearanceName;
  function NSAppearanceNameAccessibilityHighContrastAqua: NSAppearanceName;
  function NSAppearanceNameAccessibilityHighContrastDarkAqua: NSAppearanceName;
  function NSAppearanceNameAccessibilityHighContrastVibrantLight: NSAppearanceName;
  function NSAppearanceNameAccessibilityHighContrastVibrantDark: NSAppearanceName;
...
function NSViewGlobalFrameDidChangeNotification: NSString;
begin
  Result := CocoaNSStringConst(AppKitFwk, 'NSViewGlobalFrameDidChangeNotification');
end;

function NSAppearanceNameAqua: NSAppearanceName;
begin
  Result := CocoaNSStringConst(AppKitFwk, 'NSAppearanceNameAqua');
end;

function NSAppearanceNameDarkAqua: NSAppearanceName;
begin
  Result := CocoaNSStringConst(AppKitFwk, 'NSAppearanceNameDarkAqua');
end;

function NSAppearanceNameLightContent: NSAppearanceName;
begin
  Result := CocoaNSStringConst(AppKitFwk, 'NSAppearanceNameLightContent');
end;

function NSAppearanceNameVibrantDark: NSAppearanceName;
begin
  Result := CocoaNSStringConst(AppKitFwk, 'NSAppearanceNameVibrantDark');
end;

function NSAppearanceNameVibrantLight: NSAppearanceName;
begin
  Result := CocoaNSStringConst(AppKitFwk, 'NSAppearanceNameVibrantLight');
end;

function NSAppearanceNameAccessibilityHighContrastAqua: NSAppearanceName;
begin
  Result := CocoaNSStringConst(AppKitFwk, 'NSAppearanceNameAccessibilityHighContrastAqua');
end;

function NSAppearanceNameAccessibilityHighContrastDarkAqua: NSAppearanceName;
begin
  Result := CocoaNSStringConst(AppKitFwk, 'NSAppearanceNameAccessibilityHighContrastDarkAqua');
end;

function NSAppearanceNameAccessibilityHighContrastVibrantLight: NSAppearanceName;
begin
  Result := CocoaNSStringConst(AppKitFwk, 'NSAppearanceNameAccessibilityHighContrastVibrantLight');
end;

function NSAppearanceNameAccessibilityHighContrastVibrantDark: NSAppearanceName;
begin
  Result := CocoaNSStringConst(AppKitFwk, 'NSAppearanceNameAccessibilityHighContrastVibrantDark');
end;

initialization
  AppKitModule := LoadLibrary(PWideChar(AppKitFwk));

finalization
  if AppKitModule <> 0 then
