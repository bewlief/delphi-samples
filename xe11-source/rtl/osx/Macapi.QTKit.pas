...
unit Macapi.QTKit deprecated 'QTKit was retired';
...
const
  ...
  {$EXTERNALSYM MAC_OS_X_VERSION_10_4}
  MAC_OS_X_VERSION_10_5 = 1050;
  {$EXTERNALSYM MAC_OS_X_VERSION_10_5}
  MAC_OS_X_VERSION_10_6 = 1060;
  {$EXTERNALSYM MAC_OS_X_VERSION_10_6}
  MAC_OS_X_VERSION_10_7 = 1070;
  {$EXTERNALSYM MAC_OS_X_VERSION_10_7}
  QTCaptureDeviceAVCTransportControlsFastForwardSpeed = 13000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsFastForwardSpeed}
  QTCaptureDeviceAVCTransportControlsFastReverseSpeed = -13000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsFastReverseSpeed}
  QTCaptureDeviceAVCTransportControlsFastestForwardSpeed = 19000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsFastestForwardSpeed}
  QTCaptureDeviceAVCTransportControlsFastestReverseSpeed = -19000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsFastestReverseSpeed}
  QTCaptureDeviceAVCTransportControlsNormalForwardSpeed = 10000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsNormalForwardSpeed}
  QTCaptureDeviceAVCTransportControlsNormalReverseSpeed = -10000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsNormalReverseSpeed}
  QTCaptureDeviceAVCTransportControlsNotPlayingMode = 0;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsNotPlayingMode}
  QTCaptureDeviceAVCTransportControlsPlayingMode = 1;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsPlayingMode}
  QTCaptureDeviceAVCTransportControlsSlowForwardSpeed = 7000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsSlowForwardSpeed}
  QTCaptureDeviceAVCTransportControlsSlowReverseSpeed = -7000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsSlowReverseSpeed}
  QTCaptureDeviceAVCTransportControlsSlowestForwardSpeed = 1000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsSlowestForwardSpeed}
  QTCaptureDeviceAVCTransportControlsSlowestReverseSpeed = -1000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsSlowestReverseSpeed}
  QTCaptureDeviceAVCTransportControlsStoppedSpeed = 0;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsStoppedSpeed}
  QTCaptureDeviceAVCTransportControlsVeryFastForwardSpeed = 16000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsVeryFastForwardSpeed}
  QTCaptureDeviceAVCTransportControlsVeryFastReverseSpeed = -16000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsVeryFastReverseSpeed}
  QTCaptureDeviceAVCTransportControlsVerySlowForwardSpeed = 4000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsVerySlowForwardSpeed}
  QTCaptureDeviceAVCTransportControlsVerySlowReverseSpeed = -4000;
  {$EXTERNALSYM QTCaptureDeviceAVCTransportControlsVerySlowReverseSpeed}
  QTCaptureFileOutputBufferDestinationNewFile = 1;
  {$EXTERNALSYM QTCaptureFileOutputBufferDestinationNewFile}
  QTCaptureFileOutputBufferDestinationOldFile = 2;
  {$EXTERNALSYM QTCaptureFileOutputBufferDestinationOldFile}
  QTErrorDeviceAlreadyUsedbyAnotherSession = 1101;
  {$EXTERNALSYM QTErrorDeviceAlreadyUsedbyAnotherSession}
  QTErrorDeviceExcludedByAnotherDevice = 1302;
  {$EXTERNALSYM QTErrorDeviceExcludedByAnotherDevice}
  QTErrorDeviceInUseByAnotherApplication = 1301;
  {$EXTERNALSYM QTErrorDeviceInUseByAnotherApplication}
  QTErrorDeviceNotConnected = 1300;
  {$EXTERNALSYM QTErrorDeviceNotConnected}
  QTErrorDeviceWasDisconnected = 1203;
  {$EXTERNALSYM QTErrorDeviceWasDisconnected}
  QTErrorDiskFull = 1202;
  {$EXTERNALSYM QTErrorDiskFull}
  QTErrorExportExecutionFailed = 1503;
  {$EXTERNALSYM QTErrorExportExecutionFailed}
  QTErrorExportIOError = 1506;
  {$EXTERNALSYM QTErrorExportIOError}
  QTErrorExportInsufficientSpaceOnDevice = 1504;
  {$EXTERNALSYM QTErrorExportInsufficientSpaceOnDevice}
  QTErrorExportNoSuchDirectoryOrFile = 1505;
  {$EXTERNALSYM QTErrorExportNoSuchDirectoryOrFile}
  QTErrorIncompatibleInput = 1002;
  {$EXTERNALSYM QTErrorIncompatibleInput}
  QTErrorIncompatibleOutput = 1003;
  {$EXTERNALSYM QTErrorIncompatibleOutput}
  QTErrorInvalidDestinationFileTypeForExport = 1501;
  {$EXTERNALSYM QTErrorInvalidDestinationFileTypeForExport}
  QTErrorInvalidInputsOrOutputs = 1100;
  {$EXTERNALSYM QTErrorInvalidInputsOrOutputs}
  QTErrorInvalidSourceFileTypeForExport = 1502;
  {$EXTERNALSYM QTErrorInvalidSourceFileTypeForExport}
  QTErrorMaximumDurationReached = 1205;
  {$EXTERNALSYM QTErrorMaximumDurationReached}
  QTErrorMaximumFileSizeReached = 1206;
  {$EXTERNALSYM QTErrorMaximumFileSizeReached}
  QTErrorMaximumNumberOfSamplesForFileFormatReached = 1208;
  {$EXTERNALSYM QTErrorMaximumNumberOfSamplesForFileFormatReached}
  QTErrorMediaChanged = 1204;
  {$EXTERNALSYM QTErrorMediaChanged}
  QTErrorMediaDiscontinuity = 1207;
  {$EXTERNALSYM QTErrorMediaDiscontinuity}
  QTErrorNoDataCaptured = 1200;
  {$EXTERNALSYM QTErrorNoDataCaptured}
  QTErrorSessionConfigurationChanged = 1201;
  {$EXTERNALSYM QTErrorSessionConfigurationChanged}
  QTErrorUnknown = -1;
  {$EXTERNALSYM QTErrorUnknown}
  QTIncludeAggressiveTypes = 4;
  {$EXTERNALSYM QTIncludeAggressiveTypes}
  QTIncludeAllTypes = 65535;
  {$EXTERNALSYM QTIncludeAllTypes}
  QTIncludeCommonTypes = 0;
  {$EXTERNALSYM QTIncludeCommonTypes}
  QTIncludeDynamicTypes = 8;
  {$EXTERNALSYM QTIncludeDynamicTypes}
  QTIncludeStillImageTypes = 1;
  {$EXTERNALSYM QTIncludeStillImageTypes}
  QTIncludeTranslatableTypes = 2;
  {$EXTERNALSYM QTIncludeTranslatableTypes}
  QTKIT_VERSION_7_0 = 70000;
  {$EXTERNALSYM QTKIT_VERSION_7_0}
  QTKIT_VERSION_7_2 = 70200;
  {$EXTERNALSYM QTKIT_VERSION_7_2}
  QTKIT_VERSION_7_6_3 = 70603;
  {$EXTERNALSYM QTKIT_VERSION_7_6_3}
  QTKIT_VERSION_7_6_6 = 70606;
  {$EXTERNALSYM QTKIT_VERSION_7_6_6}
  QTKIT_VERSION_7_7 = 70700;
  {$EXTERNALSYM QTKIT_VERSION_7_7}
  QTKIT_VERSION_MAX_ALLOWED = 70700;
  {$EXTERNALSYM QTKIT_VERSION_MAX_ALLOWED}
  QTKIT_VERSION_MIN_REQUIRED = 70700;
  {$EXTERNALSYM QTKIT_VERSION_MIN_REQUIRED}
  QTMovieLoadStateComplete = 100000;
  {$EXTERNALSYM QTMovieLoadStateComplete}
  QTMovieLoadStateError = -1;
  {$EXTERNALSYM QTMovieLoadStateError}
  QTMovieLoadStateLoaded = 2000;
  {$EXTERNALSYM QTMovieLoadStateLoaded}
  QTMovieLoadStateLoading = 1000;
  {$EXTERNALSYM QTMovieLoadStateLoading}
  QTMovieLoadStatePlayable = 10000;
  {$EXTERNALSYM QTMovieLoadStatePlayable}
  QTMovieLoadStatePlaythroughOK = 20000;
  {$EXTERNALSYM QTMovieLoadStatePlaythroughOK}
  QTMovieOperationBeginPhase = 0;
  {$EXTERNALSYM QTMovieOperationBeginPhase}
  QTMovieOperationEndPhase = 2;
  {$EXTERNALSYM QTMovieOperationEndPhase}
  QTMovieOperationUpdatePercentPhase = 1;
  {$EXTERNALSYM QTMovieOperationUpdatePercentPhase}
  QTSampleBufferAudioBufferListOptionAssure16ByteAlignment = 1;
  {$EXTERNALSYM QTSampleBufferAudioBufferListOptionAssure16ByteAlignment}
  codecHighQuality = $00000300;
  {$EXTERNALSYM codecHighQuality}
  codecLosslessQuality = $00000400;
  {$EXTERNALSYM codecLosslessQuality}
  codecLowQuality = $00000100;
  {$EXTERNALSYM codecLowQuality}
  codecMaxQuality = $000003FF;
  {$EXTERNALSYM codecMaxQuality}
  codecMinQuality = $00000000;
  {$EXTERNALSYM codecMinQuality}
  codecNormalQuality = $00000200;
  {$EXTERNALSYM codecNormalQuality}
  graphicsModeComposition = 259;
  {$EXTERNALSYM graphicsModeComposition}
  graphicsModePerComponentAlpha = 272;
  {$EXTERNALSYM graphicsModePerComponentAlpha}
  graphicsModePreBlackAlpha = 258;
  {$EXTERNALSYM graphicsModePreBlackAlpha}
  graphicsModePreMulColorAlpha = 261;
  {$EXTERNALSYM graphicsModePreMulColorAlpha}
  graphicsModePreWhiteAlpha = 257;
  {$EXTERNALSYM graphicsModePreWhiteAlpha}
  graphicsModeStraightAlpha = 256;
  {$EXTERNALSYM graphicsModeStraightAlpha}
  graphicsModeStraightAlphaBlend = 260;
  {$EXTERNALSYM graphicsModeStraightAlphaBlend}
  kQTFileType3DMF = '3DMF';
  {$EXTERNALSYM kQTFileType3DMF}
  kQTFileType3GP2 = '3gp2';
  {$EXTERNALSYM kQTFileType3GP2}
  kQTFileType3GPP = '3gpp';
  {$EXTERNALSYM kQTFileType3GPP}
  kQTFileTypeAIFC = 'AIFC';
  {$EXTERNALSYM kQTFileTypeAIFC}
  kQTFileTypeAIFF = 'AIFF';
  {$EXTERNALSYM kQTFileTypeAIFF}
  kQTFileTypeAMC = 'amc ';
  {$EXTERNALSYM kQTFileTypeAMC}
  kQTFileTypeAMR = 'amr ';
  {$EXTERNALSYM kQTFileTypeAMR}
  kQTFileTypeAVI = 'VfW ';
  {$EXTERNALSYM kQTFileTypeAVI}
  kQTFileTypeAudioCDTrack = 'trak';
  {$EXTERNALSYM kQTFileTypeAudioCDTrack}
  kQTFileTypeBMP = 'BMPf';
  {$EXTERNALSYM kQTFileTypeBMP}
  kQTFileTypeDVC = 'dvc!';
  {$EXTERNALSYM kQTFileTypeDVC}
  kQTFileTypeFLC = 'FLC ';
  {$EXTERNALSYM kQTFileTypeFLC}
  kQTFileTypeFlash = 'SWFL';
  {$EXTERNALSYM kQTFileTypeFlash}
  kQTFileTypeFlashPix = 'FPix';
  {$EXTERNALSYM kQTFileTypeFlashPix}
  kQTFileTypeGIF = 'GIFf';
  {$EXTERNALSYM kQTFileTypeGIF}
  kQTFileTypeJFIF = 'JPEG';
  {$EXTERNALSYM kQTFileTypeJFIF}
  kQTFileTypeJPEG = 'JPEG';
  {$EXTERNALSYM kQTFileTypeJPEG}
  kQTFileTypeJPEG2000 = 'jp2 ';
  {$EXTERNALSYM kQTFileTypeJPEG2000}
  kQTFileTypeMIDI = 'Midi';
  {$EXTERNALSYM kQTFileTypeMIDI}
  kQTFileTypeMP4 = 'mpg4';
  {$EXTERNALSYM kQTFileTypeMP4}
  kQTFileTypeMacPaint = 'PNTG';
  {$EXTERNALSYM kQTFileTypeMacPaint}
  kQTFileTypeMovie = 'MooV';
  {$EXTERNALSYM kQTFileTypeMovie}
  kQTFileTypeMuLaw = 'ULAW';
  {$EXTERNALSYM kQTFileTypeMuLaw}
  kQTFileTypePDF = 'PDF ';
  {$EXTERNALSYM kQTFileTypePDF}
  kQTFileTypePICS = 'PICS';
  {$EXTERNALSYM kQTFileTypePICS}
  kQTFileTypePNG = 'PNGf';
  {$EXTERNALSYM kQTFileTypePNG}
  kQTFileTypePhotoShop = '8BPS';
  {$EXTERNALSYM kQTFileTypePhotoShop}
  kQTFileTypePicture = 'PICT';
  {$EXTERNALSYM kQTFileTypePicture}
  kQTFileTypeQuickDrawGXPicture = 'qdgx';
  {$EXTERNALSYM kQTFileTypeQuickDrawGXPicture}
  kQTFileTypeQuickTimeImage = 'qtif';
  {$EXTERNALSYM kQTFileTypeQuickTimeImage}
  kQTFileTypeSDV = 'sdv ';
  {$EXTERNALSYM kQTFileTypeSDV}
  kQTFileTypeSGIImage = '.SGI';
  {$EXTERNALSYM kQTFileTypeSGIImage}
  kQTFileTypeSoundDesignerII = 'Sd2f';
  {$EXTERNALSYM kQTFileTypeSoundDesignerII}
  kQTFileTypeSystemSevenSound = 'sfil';
  {$EXTERNALSYM kQTFileTypeSystemSevenSound}
  kQTFileTypeTIFF = 'TIFF';
  {$EXTERNALSYM kQTFileTypeTIFF}
  kQTFileTypeTargaImage = 'TPIC';
  {$EXTERNALSYM kQTFileTypeTargaImage}
  kQTFileTypeText = 'TEXT';
  {$EXTERNALSYM kQTFileTypeText}
  kQTFileTypeWave = 'WAVE';
  {$EXTERNALSYM kQTFileTypeWave}
  kQTTimeIsIndefinite = 1;
  {$EXTERNALSYM kQTTimeIsIndefinite}
...
// ===== Protocol declarations =====
  ...
  QTCaptureVideoPreviewOutput_Delegate = interface(IObjectiveC)
    ['{55CCDEA8-16A7-45FD-8399-D1099601E5CD}']
    procedure captureOutput(captureOutput: QTCaptureOutput; didOutputVideoFrame: CVImageBufferRef;
      withSampleBuffer: QTSampleBuffer; fromConnection: QTCaptureConnection); cdecl;
  end;
