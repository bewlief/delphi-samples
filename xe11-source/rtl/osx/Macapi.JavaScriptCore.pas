...
function JSCheckScriptSyntax(ctx: JSContextRef; script: JSStringRef; sourceURL: JSStringRef;
  startingLineNumber: Integer; exception: JSValueRef): Boolean; cdecl;
...
function JSValueIsUndefined(ctx: JSContextRef; value: JSValueRef): Boolean; cdecl;
  external libJavaScriptCore name _PU + 'JSValueIsUndefined';
function JSValueIsNull(ctx: JSContextRef; value: JSValueRef): Boolean; cdecl;
  external libJavaScriptCore name _PU + 'JSValueIsNull';
function JSValueIsBoolean(ctx: JSContextRef; value: JSValueRef): Boolean; cdecl;
  external libJavaScriptCore name _PU + 'JSValueIsBoolean';
function JSValueIsNumber(ctx: JSContextRef; value: JSValueRef): Boolean; cdecl;
  external libJavaScriptCore name _PU + 'JSValueIsNumber';
function JSValueIsString(ctx: JSContextRef; value: JSValueRef): Boolean; cdecl;
  external libJavaScriptCore name _PU + 'JSValueIsString';
function JSValueIsObject(ctx: JSContextRef; value: JSValueRef): Boolean; cdecl;
  external libJavaScriptCore name _PU + 'JSValueIsObject';
function JSValueIsObjectOfClass(ctx: JSContextRef; value: JSValueRef; jsClass: JSClassRef): Boolean; cdecl;
  external libJavaScriptCore name _PU + 'JSValueIsObjectOfClass';
function JSValueIsEqual(ctx: JSContextRef; a: JSValueRef; b: JSValueRef; exception: JSValueRef): Boolean; cdecl;
  external libJavaScriptCore name _PU + 'JSValueIsEqual';
function JSValueIsStrictEqual(ctx: JSContextRef; a: JSValueRef; b: JSValueRef): Boolean; cdecl;
...
function JSValueIsInstanceOfConstructor(ctx: JSContextRef; value: JSValueRef; &constructor: JSObjectRef;
  exception: JSValueRef): Boolean; cdecl; external libJavaScriptCore name _PU + 'JSValueIsInstanceOfConstructor';
...
function JSValueToBoolean(ctx: JSContextRef; value: JSValueRef): Boolean; cdecl;
...
function JSObjectHasProperty(ctx: JSContextRef; &object: JSObjectRef; propertyName: JSStringRef): Boolean; cdecl;
...
function JSObjectDeleteProperty(ctx: JSContextRef; &object: JSObjectRef; propertyName: JSStringRef;
  exception: JSValueRef): Boolean; cdecl; external libJavaScriptCore name _PU + 'JSObjectDeleteProperty';
...
function JSObjectSetPrivate(&object: JSObjectRef; data: Pointer): Boolean; cdecl;
  external libJavaScriptCore name _PU + 'JSObjectSetPrivate';
function JSObjectIsFunction(ctx: JSContextRef; &object: JSObjectRef): Boolean; cdecl;
...
function JSObjectIsConstructor(ctx: JSContextRef; &object: JSObjectRef): Boolean; cdecl;
...
function JSStringGetUTF8CString(&string: JSStringRef; buffer: PAnsiChar; bufferSize: size_t): size_t; cdecl;
  external libJavaScriptCore name _PU + 'JSStringGetUTF8CString';
function JSStringIsEqual(a: JSStringRef; b: JSStringRef): Boolean; cdecl;
  external libJavaScriptCore name _PU + 'JSStringIsEqual';
function JSStringIsEqualToUTF8CString(a: JSStringRef; b: PAnsiChar): Boolean; cdecl;
