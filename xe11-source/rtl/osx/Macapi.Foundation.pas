...
// ===== Interface declarations =====
  ...
  NSObjectClass = interface(IObjectiveCClass)
    ...
    {class} procedure cancelPreviousPerformRequestsWithTarget(target: Pointer); overload; cdecl;
    [MethodName('cancelPreviousPerformRequestsWithTarget:selector:object:')]
    {class} procedure cancelPreviousPerformRequestsWithTarget(target: Pointer; selector: SEL; &object: Pointer); overload; cdecl;
    {class} function conformsToProtocol(protocol: Pointer): Boolean; cdecl;
    {class} function debugDescription: NSString; cdecl;
    {class} function description: NSString; cdecl;
    {class} function isSubclassOfClass(aClass: Pointer): Boolean; cdecl;
    {class} function superclass: Pointer; cdecl;
  end;
  NSObject = interface(IObjectiveCInstance)
    ...
    procedure addObserver(observer: NSObject; keyPath: NSString; options: NSKeyValueObservingOptions; context: Pointer); overload; cdecl;
    ...
    procedure performSelector(aSelector: SEL; withObject: Pointer; afterDelay: NSTimeInterval; inModes: NSArray); overload; cdecl;
    [MethodName('performSelector:onThread:withObject:waitUntilDone:modes:')]
    procedure performSelector(aSelector: SEL; onThread: NSThread; withObject: Pointer; waitUntilDone: Boolean; modes: NSArray); overload; cdecl;
    [MethodName('performSelector:onThread:withObject:waitUntilDone:')]
    procedure performSelector(aSelector: SEL; onThread: NSThread; withObject: Pointer; waitUntilDone: Boolean); overload; cdecl;
    [MethodName('performSelector:withObject:afterDelay:')]
    procedure performSelector(aSelector: SEL; withObject: Pointer; afterDelay: NSTimeInterval); overload; cdecl;
    [MethodName('performSelectorInBackground:withObject:')]
    ...
    procedure performSelectorOnMainThread(aSelector: SEL; withObject: Pointer; waitUntilDone: Boolean); overload; cdecl;
    [MethodName('performSelectorOnMainThread:withObject:waitUntilDone:modes:')]
    procedure performSelectorOnMainThread(aSelector: SEL; withObject: Pointer; waitUntilDone: Boolean; modes: NSArray); overload; cdecl;
    procedure release; cdecl;
    [MethodName('removeObserver:forKeyPath:')]
    procedure removeObserver(observer: NSObject; keyPath: NSString); overload; cdecl;
    [MethodName('removeObserver:forKeyPath:context:')]
    procedure removeObserver(observer: NSObject; keyPath: NSString; context: Pointer); overload; cdecl;
  ...
  NSNotificationClass = interface(NSObjectClass)
    ['{C7E40944-6407-499D-947C-87A9BE26002F}']
     ...
     {class} function notificationWithName(aName: NSNotificationName; anObject: Pointer): Pointer; overload; cdecl;
     [MethodName('notificationWithName:object:userInfo:')]
     {class} function notificationWithName(aName: NSNotificationName; anObject: Pointer; aUserInfo: NSDictionary): Pointer; overload; cdecl;
  end;
  NSNotification = interface(NSObject)
    ['{04030ADE-507A-4E0A-A372-219771AA64AE}']
     function initWithCoder(coder: NSCoder): Pointer; cdecl;
     function initWithName(name: NSNotificationName; &object: Pointer; userInfo: NSDictionary): Pointer; cdecl;
     function name: NSString; cdecl;
...
//    {class} function stringWithCString(bytes: MarshaledAString; length: NSUInteger): Pointer; cdecl; overload;
    ...
    {class} function stringWithContentsOfFile(path: NSString; encoding: NSStringEncoding; error: PPointer = nil): Pointer; cdecl; overload;
    {class} function stringWithContentsOfFile(path: NSString; usedEncoding: PNSStringEncoding; error: PPointer = nil): Pointer; cdecl; overload;
    {class} function stringWithContentsOfURL(url: NSURL): Pointer; cdecl; overload;
    {class} function stringWithContentsOfURL(url: NSURL; encoding: NSStringEncoding; error: PPointer = nil): Pointer; cdecl; overload;
    {class} function stringWithContentsOfURL(url: NSURL; usedEncoding: PNSStringEncoding; error: PPointer = nil): Pointer; cdecl; overload;
...
//    function initWithCString(bytes: PAnsiChar; length: NSUInteger): Pointer; cdecl; overload;
    ...
    function initWithContentsOfFile(path: NSString; encoding: NSStringEncoding; error: PPointer = nil): Pointer; cdecl; overload;
    function initWithContentsOfFile(path: NSString; usedEncoding: PNSStringEncoding; error: PPointer = nil): Pointer; cdecl; overload;
    function initWithContentsOfURL(url: NSURL): Pointer; cdecl; overload;
    function initWithContentsOfURL(url: NSURL; encoding: NSStringEncoding; error: PPointer = nil): Pointer; cdecl; overload;
    function initWithContentsOfURL(url: NSURL; usedEncoding: PNSStringEncoding; error: PPointer = nil): Pointer; cdecl; overload;
    ...
    function writeToFile(path: NSString; atomically: Boolean; encoding: NSStringEncoding; error: PPointer = nil): Boolean; cdecl; overload;
    function writeToURL(url: NSURL; atomically: Boolean): Boolean; cdecl; overload;
    function writeToURL(url: NSURL; atomically: Boolean; encoding: NSStringEncoding; error: PPointer = nil): Boolean; cdecl; overload;
  end;
  ...
  NSURLConnectionClass = interface(NSObjectClass)
    ...
    {class} function sendSynchronousRequest(request: NSURLRequest; returningResponse: PPointer; error: PPointer = nil): NSData; cdecl;
  ...
  NSURLClass = interface(NSObjectClass)
    ...
    {class} function URLByResolvingBookmarkData(bookmarkData: NSData; options: NSURLBookmarkResolutionOptions; relativeToURL: NSURL; bookmarkDataIsStale: PBoolean; error: PPointer = nil): Pointer; cdecl;
    ...
    {class} function bookmarkDataWithContentsOfURL(bookmarkFileURL: NSURL; error: PPointer = nil): NSData; cdecl;
    ...
    {class} function writeBookmarkData(bookmarkData: NSData; toURL: NSURL; options: NSURLBookmarkFileCreationOptions; error: PPointer = nil): Boolean; cdecl;
  end;
  NSURL = interface(NSObject)
    ...
    function bookmarkDataWithOptions(options: NSURLBookmarkCreationOptions; includingResourceValuesForKeys: NSArray; relativeToURL: NSURL; error: PPointer = nil): NSData; cdecl;
    function checkResourceIsReachableAndReturnError(error: PPointer = nil): Boolean; cdecl;
    function filePathURL: NSURL; cdecl;
    function fileReferenceURL: NSURL; cdecl;
    function fragment: NSString; cdecl;
    function getResourceValue(value: Pointer; forKey: NSString; error: PPointer = nil): Boolean; cdecl;
    function host: NSString; cdecl;
    function initByResolvingBookmarkData(bookmarkData: NSData; options: NSURLBookmarkResolutionOptions; relativeToURL: NSURL; bookmarkDataIsStale: PBoolean; error: PPointer = nil): Pointer; cdecl;
    ...
    function resourceValuesForKeys(keys: NSArray; error: PPointer = nil): NSDictionary; cdecl; overload;
    function scheme: NSString; cdecl;
    function setProperty(property_: Pointer; forKey: NSString): Boolean; cdecl;
    function setResourceData(data: NSData): Boolean; cdecl;
    function setResourceValue(value: Pointer; forKey: NSString; error: PPointer = nil): Boolean; cdecl;
    function setResourceValues(keyedValues: NSDictionary; error: PPointer = nil): Boolean; cdecl;
  ...
  NSPropertyListSerializationClass = interface(NSObjectClass)
    ...
    {class} function dataWithPropertyList(plist: Pointer; format: NSPropertyListFormat; options: NSPropertyListWriteOptions; error: PPointer = nil): NSData; cdecl;
    ...
    {class} function propertyListWithData(data: NSData; options: NSPropertyListReadOptions; format: PNSPropertyListFormat; error: PPointer = nil): Pointer; cdecl;
    {class} function propertyListWithStream(stream: NSInputStream; options: NSPropertyListReadOptions; format: PNSPropertyListFormat; error: PPointer = nil): Pointer; cdecl;
    {class} function writePropertyList(plist: Pointer; toStream: NSOutputStream; format: NSPropertyListFormat; options: NSPropertyListWriteOptions; error: PPointer = nil): NSInteger; cdecl;
  end;
  ...
  NSNotificationCenter = interface(NSObject)
    ...
    procedure postNotificationName(aName: NSNotificationName; anObject: Pointer; aUserInfo: NSDictionary); overload; cdecl;
    procedure postNotificationName(aName: NSNotificationName; anObject: Pointer); overload; cdecl;
  ...
  NSDateComponents = interface(NSObject)
    ...
    procedure setNanosecond(v: NSInteger); cdecl;
    ...
    [MethodName('setValue:forComponent:')]
    procedure setValue(value: NSInteger; &unit: NSCalendarUnit); cdecl;
  ...
  NSDataClass = interface(NSObjectClass)
    ...
    {class} function dataWithContentsOfFile(path: NSString; options: NSDataReadingOptions; error: PPointer = nil): Pointer; cdecl; overload;
    ...
    {class} function dataWithContentsOfURL(url: NSURL; options: NSDataReadingOptions; error: PPointer = nil): Pointer; cdecl; overload;
  ...
  NSData = interface(NSObject)
    ...
    function initWithContentsOfFile(path: NSString): Pointer; cdecl; overload;
    function initWithContentsOfFile(path: NSString; options: NSDataReadingOptions; error: PPointer = nil): Pointer; cdecl; overload;
    function initWithContentsOfMappedFile(path: NSString): Pointer; cdecl;
    function initWithContentsOfURL(url: NSURL): Pointer; cdecl; overload;
    function initWithContentsOfURL(url: NSURL; options: NSDataReadingOptions; error: PPointer = nil): Pointer; cdecl; overload;
    ...
    function writeToFile(path: NSString; atomically: Boolean): Boolean; cdecl; overload;
    function writeToFile(path: NSString; options: NSDataWritingOptions; error: PPointer = nil): Boolean; cdecl; overload;
    function writeToURL(url: NSURL; atomically: Boolean): Boolean; cdecl; overload;
    function writeToURL(url: NSURL; options: NSDataWritingOptions; error: PPointer = nil): Boolean; cdecl; overload;
  end;
  ...
  NSAppleScript = interface(NSObject)
    ...
    function compileAndReturnError(errorInfo: PPointer = nil): Boolean; cdecl;
    function executeAndReturnError(errorInfo: PPointer = nil): NSAppleEventDescriptor; cdecl;
    function executeAppleEvent(event: NSAppleEventDescriptor; error: PPointer = nil): NSAppleEventDescriptor; cdecl;
    function initWithContentsOfURL(url: NSURL; error: PPointer = nil): Pointer; cdecl;
  ...
  NSBundle = interface(NSObject)
    ...
    function loadAndReturnError(error: PPointer = nil): Boolean; cdecl;
    ...
    function preflightAndReturnError(error: PPointer = nil): Boolean; cdecl;
...
//    {class} function elementWithName(name: NSString; stringValue: NSString): Pointer; cdecl; overload;
  ...
  NSXMLNode = interface(NSObject)
    ...
    function nodesForXPath(xpath: NSString; error: PPointer = nil): NSArray; cdecl;
    function objectValue: Pointer; cdecl;
    function objectsForXQuery(xquery: NSString; constants: NSDictionary; error: PPointer = nil): NSArray; cdecl; overload;
    function objectsForXQuery(xquery: NSString; error: PPointer = nil): NSArray; cdecl; overload;
  ...
  NSFormatter = interface(NSObject)
    ...
    function getObjectValue(obj: Pointer; forString: NSString; errorDescription: PPointer = nil): Boolean; cdecl;
  ...
  NSURLRequest = interface(NSObject)
    ...
    function mutableCopy: NSMutableURLRequest; cdecl;
  end;
  ...
  NSFileHandleClass = interface(NSObjectClass)
    ...
    {class} function fileHandleForReadingFromURL(url: NSURL; error: PPointer = nil): Pointer; cdecl;
    {class} function fileHandleForUpdatingAtPath(path: NSString): Pointer; cdecl;
    {class} function fileHandleForUpdatingURL(url: NSURL; error: PPointer = nil): Pointer; cdecl;
    {class} function fileHandleForWritingAtPath(path: NSString): Pointer; cdecl;
    {class} function fileHandleForWritingToURL(url: NSURL; error: PPointer = nil): Pointer; cdecl;
  ...
  NSFileManager = interface(NSObject)
    ...
    function URLForDirectory(directory: NSSearchPathDirectory; inDomain: NSSearchPathDomainMask; appropriateForURL: NSURL; create: Boolean; error: PPointer = nil): NSURL; cdecl;
    function URLsForDirectory(directory: NSSearchPathDirectory; inDomains: NSSearchPathDomainMask): NSArray; cdecl;
    function attributesOfFileSystemForPath(path: NSString; error: PPointer = nil): NSDictionary; cdecl;
    function attributesOfItemAtPath(path: NSString; error: PPointer = nil): NSDictionary; cdecl;
    ...
    function contentsOfDirectoryAtPath(path: NSString; error: PPointer = nil): NSArray; cdecl;
    function contentsOfDirectoryAtURL(url: NSURL; includingPropertiesForKeys: NSArray; options: NSDirectoryEnumerationOptions; error: PPointer = nil): NSArray; cdecl;
    function copyItemAtPath(srcPath: NSString; toPath: NSString; error: PPointer = nil): Boolean; cdecl;
    function copyItemAtURL(srcURL: NSURL; toURL: NSURL; error: PPointer = nil): Boolean; cdecl;
    ...
    function createDirectoryAtPath(path: NSString; withIntermediateDirectories: Boolean; attributes: NSDictionary; error: PPointer = nil): Boolean; cdecl; overload;
    ...
    function createSymbolicLinkAtPath(path: NSString; withDestinationPath: NSString; error: PPointer = nil): Boolean; cdecl; overload;
    function currentDirectoryPath: NSString; cdecl;
    function delegate: Pointer; cdecl;
    function destinationOfSymbolicLinkAtPath(path: NSString; error: PPointer = nil): NSString; cdecl;
    ...
    function linkItemAtPath(srcPath: NSString; toPath: NSString; error: PPointer = nil): Boolean; cdecl;
    function linkItemAtURL(srcURL: NSURL; toURL: NSURL; error: PPointer = nil): Boolean; cdecl;
    ...
    function moveItemAtPath(srcPath: NSString; toPath: NSString; error: PPointer = nil): Boolean; cdecl;
    function moveItemAtURL(srcURL: NSURL; toURL: NSURL; error: PPointer = nil): Boolean; cdecl;
    ...
    function removeItemAtPath(path: NSString; error: PPointer = nil): Boolean; cdecl;
    function removeItemAtURL(URL: NSURL; error: PPointer = nil): Boolean; cdecl;
    function replaceItemAtURL(originalItemURL: NSURL; withItemAtURL: NSURL; backupItemName: NSString; options: NSFileManagerItemReplacementOptions; resultingItemURL: NSURL; error: PPointer = nil): Boolean; cdecl;
    function setAttributes(attributes: NSDictionary; ofItemAtPath: NSString; error: PPointer = nil): Boolean; cdecl;
    ...
    function subpathsOfDirectoryAtPath(path: NSString; error: PPointer = nil): NSArray; cdecl;
    ...
    function createSymbolicLinkAtURL(url: NSURL; withDestinationURL: NSURL; error: PPointer = nil): Boolean; cdecl;
    ...
    function setUbiquitous(flag: Boolean; itemAtURL: NSURL; destinationURL: NSURL; error: PPointer = nil): Boolean; cdecl;
    function isUbiquitousItemAtURL(url: NSURL): Boolean; cdecl;
    function startDownloadingUbiquitousItemAtURL(url: NSURL; error: PPointer = nil): Boolean; cdecl;
    function evictUbiquitousItemAtURL(url: NSURL; error: PPointer = nil): Boolean; cdecl;
    function URLForUbiquityContainerIdentifier(containerIdentifier: NSString): NSURL; cdecl;
    function URLForPublishingUbiquitousItemAtURL(url: NSURL; expirationDate: NSDate; error: PPointer = nil): NSURL; cdecl;
  ...
  NSXMLDocument = interface(NSXMLNode)
    ...
    function initWithContentsOfURL(url: NSURL; options: NSUInteger; error: PPointer = nil): Pointer; cdecl;
    function initWithData(data: NSData; options: NSUInteger; error: PPointer = nil): Pointer; cdecl;
    function initWithRootElement(element: NSXMLElement): Pointer; cdecl;
    function initWithXMLString(string_: NSString; options: NSUInteger; error: PPointer = nil): Pointer; cdecl;
    ...
    function objectByApplyingXSLT(xslt: NSData; arguments: NSDictionary; error: PPointer = nil): Pointer; cdecl;
    function objectByApplyingXSLTAtURL(xsltURL: NSURL; arguments: NSDictionary; error: PPointer = nil): Pointer; cdecl;
    function objectByApplyingXSLTString(xslt: NSString; arguments: NSDictionary; error: PPointer = nil): Pointer; cdecl;
    ...
    function validateAndReturnError(error: PPointer = nil): Boolean; cdecl;
...
//    function initWithName(name: NSString; stringValue: NSString): Pointer; cdecl; overload;
    function initWithXMLString(string_: NSString; error: PPointer = nil): Pointer; cdecl;
    procedure insertChild(child: NSXMLNode; atIndex: NSUInteger); cdecl;
    procedure insertChildren(children: NSArray; atIndex: NSUInteger); cdecl;
  ...
  NSDateFormatter = interface(NSFormatter)
    ...
    function getObjectValue(out obj: Pointer; forString: NSString; var range: NSRange; error: PPointer = nil): Boolean; cdecl;
...
//    function userNotificationCenter(center: NSUserNotificationCenter; shouldPresentNotification: NSUserNotification): Boolean; overload; cdecl;
  ...
  NSFileVersionClass = interface(NSObjectClass)
    ...
    {class} function removeOtherVersionsOfItemAtURL(url: NSURL; error: PPointer = nil): Boolean; cdecl;
  end;
  NSFileVersion = interface(NSObject)
    ...
    function replaceItemAtURL(url: NSURL; options: NSFileVersionReplacingOptions; error: PPointer = nil): NSURL; cdecl;
    function removeAndReturnError(outError: PPointer = nil): Boolean; cdecl;
  end;
  ...
  NSFileWrapper = interface(NSObject)
    ...
    function initWithURL(url: NSURL; options: NSFileWrapperReadingOptions; error: PPointer = nil)
      : Pointer {instancetype}; cdecl;
    ...
    function writeToURL(url: NSURL; options: NSFileWrapperWritingOptions; originalContentsURL: NSURL; error: PPointer = nil)
      : Boolean; cdecl;
...
// Utility method for loading a single constant from a framework
function CocoaSingleConst(const Fwk: string; const ConstStr: string): Single;

// Utility method for loading a double constant from a framework
...
// Utility method for loading an boolean constant from a framework
function CocoaBooleanConst(const Fwk: string; const ConstStr: string): Boolean;
...
// Utility method for loading an object id constant from a framework
function CocoaObjectIdConst(const Fwk: string; const ConstStr: string): ID;
...
function NSMakeRange(loc: NSUInteger; len: NSUInteger): NSRange; cdecl; inline;
function NSMaxRange(range: NSRange): NSUInteger; cdecl; inline;
function NSLocationInRange(loc: NSUInteger; range: NSRange): Boolean; cdecl; inline;
function NSEqualRanges(range1: NSRange; range2: NSRange): Boolean; cdecl; inline;
...
function NSHostByteOrder: LongInt; cdecl; inline;
function NSSwapShort(inv: Word): Word; cdecl; inline;
function NSSwapInt(inv: Cardinal): Cardinal; cdecl; inline;
function NSSwapLong(inv: LongWord): LongWord; cdecl; inline;
function NSSwapLongLong(inv: UInt64): UInt64; cdecl; inline;
function NSSwapBigShortToHost(X: Word): Word; cdecl; inline;
function NSSwapBigIntToHost(X: Cardinal): Cardinal; cdecl; inline;
function NSSwapBigLongToHost(X: LongWord): LongWord; cdecl; inline;
function NSSwapBigLongLongToHost(X: UInt64): UInt64; cdecl; inline;
function NSSwapHostShortToBig(X: Word): Word; cdecl; inline;
function NSSwapHostIntToBig(X: Cardinal): Cardinal; cdecl; inline;
function NSSwapHostLongToBig(X: LongWord): LongWord; cdecl; inline;
function NSSwapHostLongLongToBig(X: UInt64): UInt64; cdecl; inline;
function NSSwapLittleShortToHost(X: Word): Word; cdecl; inline;
function NSSwapLittleIntToHost(X: Cardinal): Cardinal; cdecl; inline;
function NSSwapLittleLongToHost(X: LongWord): LongWord; cdecl; inline;
function NSSwapLittleLongLongToHost(X: UInt64): UInt64; cdecl; inline;
function NSSwapHostShortToLittle(X: Word): Word; cdecl; inline;
function NSSwapHostIntToLittle(X: Cardinal): Cardinal; cdecl; inline;
function NSSwapHostLongToLittle(X: LongWord): LongWord; cdecl; inline;
function NSSwapHostLongLongToLittle(X: UInt64): UInt64; cdecl; inline;
function NSConvertHostFloatToSwapped(X: Single): NSSwappedFloat; cdecl; inline;
function NSConvertSwappedFloatToHost(X: NSSwappedFloat): Single; cdecl; inline;
function NSConvertHostDoubleToSwapped(X: Double): NSSwappedDouble; cdecl; inline;
function NSConvertSwappedDoubleToHost(X: NSSwappedDouble): Double; cdecl; inline;
function NSSwapFloat(X: NSSwappedFloat): NSSwappedFloat; cdecl; inline;
function NSSwapDouble(X: NSSwappedDouble): NSSwappedDouble; cdecl; inline;
function NSSwapBigDoubleToHost(X: NSSwappedDouble): Double; cdecl; inline;
function NSSwapBigFloatToHost(X: NSSwappedFloat): Single; cdecl; inline;
function NSSwapHostDoubleToBig(X: Double): NSSwappedDouble; cdecl; inline;
function NSSwapHostFloatToBig(X: Single): NSSwappedFloat; cdecl; inline;
function NSSwapLittleDoubleToHost(X: NSSwappedDouble): Double; cdecl; inline;
function NSSwapLittleFloatToHost(X: NSSwappedFloat): Single; cdecl; inline;
function NSSwapHostDoubleToLittle(X: Double): NSSwappedDouble; cdecl; inline;
function NSSwapHostFloatToLittle(X: Single): NSSwappedFloat; cdecl; inline;
...
function NSDecimalIsNotANumber(dcm: Pointer): Boolean; cdecl; inline;
...
function NSMakePoint(X: CGFloat; y: CGFloat): NSPoint; cdecl; inline;
function NSMakeSize(w: CGFloat; h: CGFloat): NSSize; cdecl; inline;
function NSMakeRect(X: CGFloat; y: CGFloat; w: CGFloat; h: CGFloat): NSRect; cdecl; inline;
function NSMaxX(aRect: NSRect): CGFloat; cdecl; inline;
function NSMaxY(aRect: NSRect): CGFloat; cdecl; inline;
function NSMidX(aRect: NSRect): CGFloat; cdecl; inline;
function NSMidY(aRect: NSRect): CGFloat; cdecl; inline;
function NSMinX(aRect: NSRect): CGFloat; cdecl; inline;
function NSMinY(aRect: NSRect): CGFloat; cdecl; inline;
function NSWidth(aRect: NSRect): CGFloat; cdecl; inline;
function NSHeight(aRect: NSRect): CGFloat; cdecl; inline;
function NSRectFromCGRect(CGRect: CGRect): NSRect; cdecl; inline;
function NSRectToCGRect(NSRect: NSRect): CGRect; cdecl; inline;
function NSPointFromCGPoint(CGPoint: CGPoint): NSPoint; cdecl; inline;
function NSPointToCGPoint(NSPoint: NSPoint): CGPoint; cdecl; inline;
function NSSizeFromCGSize(CGSize: CGSize): NSSize; cdecl; inline;
function NSSizeToCGSize(NSSize: NSSize): CGSize; cdecl; inline;
function NSEdgeInsetsMake(top: CGFloat; left: CGFloat; bottom: CGFloat; right: CGFloat): NSEdgeInsets; cdecl; inline;
...
function CocoaPointerConst(const Fwk: string; const ConstStr: string): Pointer;
var
  FrameworkHandle: THandle;
  FrameworkNamePtr: PChar;
  Dic: TDictionary<string, THandle>;
begin
  if FrameworkDic = nil then
  begin
    Dic := TDictionary<string, THandle>.Create;
    if AtomicCmpExchange(Pointer(FrameworkDic), Pointer(Dic), nil) <> nil then
      Dic.Free
{$IFDEF AUTOREFCOUNT}
    else
...
{$ENDIF AUTOREFCOUNT};
  ...
  try
    if not FrameworkDic.TryGetValue(Fwk, FrameworkHandle) then
    begin
      if Fwk = '' then
        FrameworkNamePtr := nil
      else
        FrameworkNamePtr := PChar(Fwk);

      FrameworkHandle := LoadLibrary(FrameworkNamePtr);
      FrameworkDic.Add(Fwk, FrameworkHandle);
    end;
  finally
    TMonitor.Exit(FrameworkDic);
  end;

  if FrameworkHandle <> 0 then
    Result := GetProcAddress(FrameworkHandle, PChar(ConstStr));
end;
...
function CocoaObjectIdConst(const Fwk: string; const ConstStr: string): Pointer;
var
  Obj: Pointer;
begin
  Obj := CocoaPointerConst(Fwk, ConstStr);
...
begin
  Obj := CocoaPointerConst(Fwk, ConstStr);
  if Obj <> nil then
    Result := TNSString.Wrap(Pointer(Obj^))
  else
    Result := nil;
end;
...
// NSByteOrder.h
function NSHostByteOrder: LongInt;
begin
  Result := CFByteOrderGetCurrent;
end;

function NSSwapShort(inv: Word): Word;
begin
  Result := CFSwapInt16(inv);
end;

function NSSwapInt(inv: Cardinal): Cardinal;
begin
    Result := CFSwapInt32(inv);
end;

function NSSwapLong(inv: LongWord): LongWord;
begin
  Result :=  CFSwapInt64(inv);
end;

function NSSwapLongLong(inv: UInt64): UInt64;
begin
  Result := CFSwapInt64(inv);
end;

function NSSwapBigShortToHost(X: Word): Word;
begin
  Result := CFSwapInt16BigToHost(X);
end;

function NSSwapBigIntToHost(X: Cardinal): Cardinal;
begin
  Result := CFSwapInt32BigToHost(X);
end;

function NSSwapBigLongToHost(X: LongWord): LongWord;
begin
{$IFDEF OSX64}
  Result := CFSwapInt64BigToHost(X);
{$ELSE !OSX64}
  Result := CFSwapInt32BigToHost(X);
{$ENDIF OSX64}
end;

function NSSwapBigLongLongToHost(X: UInt64): UInt64;
begin
  Result := CFSwapInt64BigToHost(X);
end;

function NSSwapHostShortToBig(X: Word): Word;
begin
  Result := CFSwapInt16HostToBig(X);
end;

function NSSwapHostIntToBig(X: Cardinal): Cardinal;
begin
  Result := CFSwapInt32HostToBig(X);
end;

function NSSwapHostLongToBig(X: LongWord): LongWord;
begin
{$IFDEF OSX64}
  Result := CFSwapInt64HostToBig(X);
{$ELSE !OSX64}
  Result := CFSwapInt32HostToBig(X);
{$ENDIF OSX64}
end;

function NSSwapHostLongLongToBig(X: UInt64): UInt64;
begin
  Result := CFSwapInt64HostToBig(X);
end;

function NSSwapLittleShortToHost(X: Word): Word;
begin
  Result := CFSwapInt16LittleToHost(X);
end;

function NSSwapLittleIntToHost(X: Cardinal): Cardinal;
begin
  Result := CFSwapInt32LittleToHost(X);
end;

function NSSwapLittleLongToHost(X: LongWord): LongWord;
begin
{$IFDEF OSX64}
  Result := CFSwapInt64LittleToHost(X);
{$ELSE !OSX64}
  Result := CFSwapInt32LittleToHost(X);
{$ENDIF OSX64}
end;

function NSSwapLittleLongLongToHost(X: UInt64): UInt64;
begin
  Result := CFSwapInt64LittleToHost(X);
end;

function NSSwapHostShortToLittle(X: Word): Word;
begin
  Result := CFSwapInt16HostToLittle(X);
end;

function NSSwapHostIntToLittle(X: Cardinal): Cardinal;
begin
  Result := CFSwapInt32HostToLittle(X);
end;

function NSSwapHostLongToLittle(X: LongWord): LongWord;
begin
{$IFDEF OSX64}
  Result := CFSwapInt64HostToLittle(X);
{$ELSE !OSX64}
  Result := CFSwapInt32HostToLittle(X);
{$ENDIF OSX64}
end;

function NSSwapHostLongLongToLittle(X: UInt64): UInt64;
begin
  Result := CFSwapInt64HostToLittle(X);
end;

function NSConvertHostFloatToSwapped(X: Single): NSSwappedFloat;
var
  u: NSSwappedFloat absolute X;
begin
  Result := u;
end;

function NSConvertSwappedFloatToHost(X: NSSwappedFloat): Single;
var
  s: Single absolute X;
begin
  Result := s;
...
function NSConvertHostDoubleToSwapped(X: Double): NSSwappedDouble;
var
  u: UInt64 absolute X;
begin
  Result.v := u;
...
function NSConvertSwappedDoubleToHost(X: NSSwappedDouble): Double;
var
  D: Double absolute X;
begin
  Result := D;
...
function NSSwapFloat(X: NSSwappedFloat): NSSwappedFloat;
begin
  Result.v := NSSwapInt(X.v);
end;

function NSSwapDouble(X: NSSwappedDouble): NSSwappedDouble;
begin
  Result.v := NSSwapLongLong(X.v);
end;

function NSSwapBigDoubleToHost(X: NSSwappedDouble): Double;
begin
  Result := NSConvertSwappedDoubleToHost(NSSwapDouble(X));
end;

function NSSwapBigFloatToHost(X: NSSwappedFloat): Single;
begin
  Result := NSConvertSwappedFloatToHost(NSSwapFloat(X));
end;

function NSSwapHostDoubleToBig(X: Double): NSSwappedDouble;
begin
  Result := NSSwapDouble(NSConvertHostDoubleToSwapped(X));
end;

function NSSwapHostFloatToBig(X: Single): NSSwappedFloat;
begin
  Result := NSSwapFloat(NSConvertHostFloatToSwapped(X));
end;

function NSSwapLittleDoubleToHost(X: NSSwappedDouble): Double;
begin
  Result := NSConvertSwappedDoubleToHost(X);
end;

function NSSwapLittleFloatToHost(X: NSSwappedFloat): Single;
begin
  Result := NSConvertSwappedFloatToHost(X);
end;

function NSSwapHostDoubleToLittle(X: Double): NSSwappedDouble;
begin
  Result := NSConvertHostDoubleToSwapped(X);
end;

function NSSwapHostFloatToLittle(X: Single): NSSwappedFloat;
begin
  Result := NSConvertHostFloatToSwapped(X);
end;

// NSDecimal.h
function NSDecimalIsNotANumber(dcm: Pointer): Boolean; cdecl;
begin
  Result := (PNSDecimal(dcm)._length = 0) and (PNSDecimal(dcm)._isNegative <> 0);
end;
...
function NSMakeRect(X: CGFloat; y: CGFloat; w: CGFloat; h: CGFloat): NSRect;
begin
  Result.origin.x := x;
  Result.origin.y := y;
  Result.size.width := w;
...
begin
  Result := aRect.origin.x + aRect.size.width * CGFloat(0.5);
end;

function NSMidY(aRect: NSRect): CGFloat;
begin
  Result := aRect.origin.y + aRect.size.height * CGFloat(0.5);
end;
...
function NSRectFromCGRect(CGRect: CGRect): NSRect;
begin
  Result := CGRect;
end;

function NSRectToCGRect(NSRect: NSRect): CGRect;
begin
  Result := NSRect;
end;

function NSPointFromCGPoint(CGPoint: CGPoint): NSPoint;
begin
  Result := CGPoint;
end;

function NSPointToCGPoint(NSPoint: NSPoint): CGPoint;
begin
  Result := NSPoint;
end;

function NSSizeFromCGSize(CGSize: CGSize): NSSize;
begin
  Result := CGSize;
end;

function NSSizeToCGSize(NSSize: NSSize): CGSize;
begin
  Result := NSSize;
end;

function NSEdgeInsetsMake(top: CGFloat; left: CGFloat; bottom: CGFloat; right: CGFloat): NSEdgeInsets;
begin
  Result.top := top;
  Result.left := left;
...
begin
  Result := (loc >= range.location) and ((loc - range.location) < range.length);
end;
