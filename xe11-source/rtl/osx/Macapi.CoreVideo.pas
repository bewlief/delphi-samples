...
function CVGetHostClockMinimumTimeDelta: UInt32; cdecl; external libCoreVideo name _PU + 'CVGetHostClockMinimumTimeDelta';
...
function CVOpenGLBufferCreate(allocator: CFAllocatorRef; width: size_t; height: size_t; attributes: CFDictionaryRef; bufferOut: PCVOpenGLBufferRef): CVReturn; cdecl; external libCoreVideo name _PU + 'CVOpenGLBufferCreate';
...
function CVPixelBufferCreate(allocator: CFAllocatorRef; width: size_t; height: size_t; pixelFormatType: OSType; pixelBufferAttributes: CFDictionaryRef; pixelBufferOut: PCVPixelBufferRef): CVReturn; cdecl; external libCoreVideo name _PU + 'CVPixelBufferCreate';
...
function CVPixelBufferGetBaseAddressOfPlane(pixelBuffer: CVPixelBufferRef; planeIndex: size_t): Pointer; cdecl; external libCoreVideo name _PU + 'CVPixelBufferGetBaseAddressOfPlane';
function CVPixelBufferGetBytesPerRow(pixelBuffer: CVPixelBufferRef): size_t; cdecl; external libCoreVideo name _PU + 'CVPixelBufferGetBytesPerRow';
function CVPixelBufferGetBytesPerRowOfPlane(pixelBuffer: CVPixelBufferRef; planeIndex: size_t): size_t; cdecl; external libCoreVideo name _PU + 'CVPixelBufferGetBytesPerRowOfPlane';
function CVPixelBufferGetDataSize(pixelBuffer: CVPixelBufferRef): size_t; cdecl; external libCoreVideo name _PU + 'CVPixelBufferGetDataSize';
procedure CVPixelBufferGetExtendedPixels(pixelBuffer: CVPixelBufferRef; extraColumnsOnLeft: Psize_t; extraColumnsOnRight: Psize_t; extraRowsOnTop: Psize_t; extraRowsOnBottom: Psize_t); cdecl; external libCoreVideo name _PU + 'CVPixelBufferGetExtendedPixels';
function CVPixelBufferGetHeight(pixelBuffer: CVPixelBufferRef): size_t; cdecl; external libCoreVideo name _PU + 'CVPixelBufferGetHeight';
function CVPixelBufferGetHeightOfPlane(pixelBuffer: CVPixelBufferRef; planeIndex: size_t): size_t; cdecl; external libCoreVideo name _PU + 'CVPixelBufferGetHeightOfPlane';
...
function CVPixelBufferGetPlaneCount(pixelBuffer: CVPixelBufferRef): size_t; cdecl; external libCoreVideo name _PU + 'CVPixelBufferGetPlaneCount';
function CVPixelBufferGetTypeID: CFTypeID; cdecl; external libCoreVideo name _PU + 'CVPixelBufferGetTypeID';
function CVPixelBufferGetWidth(pixelBuffer: CVPixelBufferRef): size_t; cdecl; external libCoreVideo name _PU + 'CVPixelBufferGetWidth';
function CVPixelBufferGetWidthOfPlane(pixelBuffer: CVPixelBufferRef; planeIndex: size_t): size_t; cdecl; external libCoreVideo name _PU + 'CVPixelBufferGetWidthOfPlane';
...
function kCVPixelBufferMemoryAllocatorKey: CFStringRef;
function kCVPixelBufferWidthKey: CFStringRef;
function kCVPixelBufferHeightKey: CFStringRef;
function kCVPixelBufferExtendedPixelsLeftKey: CFStringRef;
function kCVPixelBufferExtendedPixelsTopKey: CFStringRef;
function kCVPixelBufferExtendedPixelsRightKey: CFStringRef;
function kCVPixelBufferExtendedPixelsBottomKey: CFStringRef;
function kCVPixelBufferBytesPerRowAlignmentKey: CFStringRef;
...
function kCVPixelBufferOpenGLCompatibilityKey: CFStringRef;
function kCVPixelBufferPlaneAlignmentKey: CFStringRef;
function kCVPixelBufferIOSurfacePropertiesKey: CFStringRef;
function kCVPixelBufferIOSurfaceOpenGLTextureCompatibilityKey: CFStringRef;
function kCVPixelBufferIOSurfaceOpenGLFBOCompatibilityKey: CFStringRef;
function kCVPixelBufferIOSurfaceCoreAnimationCompatibilityKey: CFStringRef;
...
function kCVPixelBufferPixelFormatTypeKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferPixelFormatTypeKey');
end;

function kCVPixelBufferMemoryAllocatorKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferMemoryAllocatorKey');
end;

function kCVPixelBufferWidthKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferWidthKey');
end;

function kCVPixelBufferHeightKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferHeightKey');
end;

function kCVPixelBufferExtendedPixelsLeftKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferExtendedPixelsLeftKey');
end;

function kCVPixelBufferExtendedPixelsTopKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferExtendedPixelsTopKey');
end;

function kCVPixelBufferExtendedPixelsRightKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferExtendedPixelsRightKey');
end;

function kCVPixelBufferExtendedPixelsBottomKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferExtendedPixelsBottomKey');
end;

function kCVPixelBufferBytesPerRowAlignmentKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferBytesPerRowAlignmentKey');
end;

function kCVPixelBufferCGBitmapContextCompatibilityKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferCGBitmapContextCompatibilityKey');
end;

function kCVPixelBufferCGImageCompatibilityKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferCGImageCompatibilityKey');
end;

function kCVPixelBufferOpenGLCompatibilityKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferOpenGLCompatibilityKey');
end;

function kCVPixelBufferPlaneAlignmentKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferPlaneAlignmentKey');
end;

function kCVPixelBufferIOSurfacePropertiesKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferIOSurfacePropertiesKey');
end;

function kCVPixelBufferIOSurfaceOpenGLTextureCompatibilityKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferIOSurfaceOpenGLTextureCompatibilityKey');
end;

function kCVPixelBufferIOSurfaceOpenGLFBOCompatibilityKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferIOSurfaceOpenGLFBOCompatibilityKey');
end;

function kCVPixelBufferIOSurfaceCoreAnimationCompatibilityKey: CFStringRef;
begin
  Result := CocoaObjectIdConst(libCoreVideo, 'kCVPixelBufferIOSurfaceCoreAnimationCompatibilityKey');
end;
