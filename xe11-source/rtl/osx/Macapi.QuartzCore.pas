...
// ===== Interface declarations =====
  ...
  CIImageClass = interface(NSObjectClass)
    ...
    {class} function imageWithTexture(name: Cardinal; size: CGSize; flipped: Boolean; colorSpace: CGColorSpaceRef): Pointer; cdecl;
  end;
  CIImage = interface(NSObject)
    ...
    function initWithTexture(name: Cardinal; size: CGSize; flipped: Boolean; colorSpace: CGColorSpaceRef): Pointer; cdecl;
  ...
  CAConstraintClass = interface(NSObjectClass)
    ...
    {class} function constraintWithAttribute(attr: CAConstraintAttribute; relativeTo: NSString; attribute: CAConstraintAttribute; offset: CGFloat): Pointer; cdecl; overload;
    {class} function constraintWithAttribute(attr: CAConstraintAttribute; relativeTo: NSString; attribute: CAConstraintAttribute; scale: CGFloat; offset: CGFloat): Pointer; cdecl; overload;
  end;
  ...
  CALayer = interface(NSObject)
    ['{A77EA401-8593-4430-8242-939C029EAE61}']
    ...
    procedure insertSublayer(layer: CALayer; atIndex: UInt32); cdecl; overload;
    [MethodName('insertSublayer:below:')]
    procedure InsertSublayerBelow(layer: CALayer; sibling: CALayer); cdecl;
    [MethodName('insertSublayer:above:')]
    procedure InsertSublayerAbove(layer: CALayer; sibling: CALayer); cdecl;
    procedure replaceSublayer(layer: CALayer; layer2: CALayer); cdecl;
    ...
    function ConvertPointFromLayer(p: CGPoint; l: CALayer): CGPoint; cdecl;
    [MethodName('convertPoint:toLayer:')]
    function ConvertPointToLayer(p: CGPoint; l: CALayer): CGPoint; cdecl;
    [MethodName('convertRect:fromLayer:')]
    function ConvertRectFromLayer(r: CGRect; l: CALayer): CGRect; cdecl;
    [MethodName('convertRect:toLayer:')]
    function ConvertRectToLayer(r: CGRect; l: CALayer): CGRect; cdecl;
    [MethodName('convertTime:fromLayer:')]
    function ConvertTimeFromLayer(t: CFTimeInterval; l: CALayer): CFTimeInterval; cdecl;
    [MethodName('convertTime:toLayer:')]
    function ConvertTimeToLayer(t: CFTimeInterval; l: CALayer): CFTimeInterval; cdecl;
    ...
    procedure setEdgeAntialiasingMask(edgeAntialiasingMask: UInt32); cdecl;
    function edgeAntialiasingMask: UInt32; cdecl;
    ...
    procedure setAutoresizingMask(autoresizingMask: UInt32); cdecl;
    function autoresizingMask: UInt32; cdecl;
