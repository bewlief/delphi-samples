...
const
{$IFDEF MACOS64}
  libCoreGraphics = '/System/Library/Frameworks/ApplicationServices.framework/ApplicationServices';
{$ELSE !MACOS64}
...
function CGDisplayBeamPosition(display: CGDirectDisplayID): UInt32; cdecl; external libCoreGraphics name _PU + 'CGDisplayBeamPosition';
{$EXTERNALSYM CGDisplayBeamPosition}
function CGDisplayBestModeForParameters(display: CGDirectDisplayID; bitsPerPixel: size_t; width: size_t; height: size_t; exactMatch: PInteger): CFDictionaryRef; cdecl; external libCoreGraphics name _PU + 'CGDisplayBestModeForParameters';
{$EXTERNALSYM CGDisplayBestModeForParameters}
function CGDisplayBestModeForParametersAndRefreshRate(display: CGDirectDisplayID; bitsPerPixel: size_t; width: size_t; height: size_t; refreshRate: CGRefreshRate; exactMatch: PInteger): CFDictionaryRef; cdecl; external libCoreGraphics name _PU + 'CGDisplayBestModeForParametersAndRefreshRate';
{$EXTERNALSYM CGDisplayBestModeForParametersAndRefreshRate}
function CGDisplayBestModeForParametersAndRefreshRateWithProperty(display: CGDirectDisplayID; bitsPerPixel: size_t; width: size_t; height: size_t; refreshRate: CGRefreshRate; property_: CFStringRef; exactMatch: PInteger): CFDictionaryRef; cdecl; external libCoreGraphics name _PU + 'CGDisplayBestModeForParametersAndRefreshRateWithProperty';
{$EXTERNALSYM CGDisplayBestModeForParametersAndRefreshRateWithProperty}
function CGDisplayBitsPerPixel(display: CGDirectDisplayID): size_t; cdecl; external libCoreGraphics name _PU + 'CGDisplayBitsPerPixel';
{$EXTERNALSYM CGDisplayBitsPerPixel}
function CGDisplayBitsPerSample(display: CGDirectDisplayID): size_t; cdecl; external libCoreGraphics name _PU + 'CGDisplayBitsPerSample';
...
function CGDisplayBytesPerRow(display: CGDirectDisplayID): size_t; cdecl; external libCoreGraphics name _PU + 'CGDisplayBytesPerRow';
...
function CGDisplayGammaTableCapacity(display: CGDirectDisplayID): UInt32; cdecl; external libCoreGraphics name _PU + 'CGDisplayGammaTableCapacity';
...
function CGDisplayModeGetHeight(mode: CGDisplayModeRef): size_t; cdecl; external libCoreGraphics name _PU + 'CGDisplayModeGetHeight';
{$EXTERNALSYM CGDisplayModeGetHeight}
function CGDisplayModeGetIODisplayModeID(mode: CGDisplayModeRef): Int32; cdecl; external libCoreGraphics name _PU + 'CGDisplayModeGetIODisplayModeID';
{$EXTERNALSYM CGDisplayModeGetIODisplayModeID}
function CGDisplayModeGetIOFlags(mode: CGDisplayModeRef): UInt32; cdecl; external libCoreGraphics name _PU + 'CGDisplayModeGetIOFlags';
...
function CGDisplayModeGetWidth(mode: CGDisplayModeRef): size_t; cdecl; external libCoreGraphics name _PU + 'CGDisplayModeGetWidth';
{$EXTERNALSYM CGDisplayModeGetWidth}
function CGDisplayModeIsUsableForDesktopGUI(mode: CGDisplayModeRef): Boolean; cdecl; external libCoreGraphics name _PU + 'CGDisplayModeIsUsableForDesktopGUI';
...
function CGDisplayModelNumber(display: CGDirectDisplayID): UInt32; cdecl; external libCoreGraphics name _PU + 'CGDisplayModelNumber';
...
function CGDisplayPixelsHigh(display: CGDirectDisplayID): size_t; cdecl; external libCoreGraphics name _PU + 'CGDisplayPixelsHigh';
{$EXTERNALSYM CGDisplayPixelsHigh}
function CGDisplayPixelsWide(display: CGDirectDisplayID): size_t; cdecl; external libCoreGraphics name _PU + 'CGDisplayPixelsWide';
...
function CGDisplaySamplesPerPixel(display: CGDirectDisplayID): size_t; cdecl; external libCoreGraphics name _PU + 'CGDisplaySamplesPerPixel';
...
function CGDisplaySerialNumber(display: CGDirectDisplayID): UInt32; cdecl; external libCoreGraphics name _PU + 'CGDisplaySerialNumber';
...
function CGDisplayUnitNumber(display: CGDirectDisplayID): UInt32; cdecl; external libCoreGraphics name _PU + 'CGDisplayUnitNumber';
...
function CGDisplayVendorNumber(display: CGDirectDisplayID): UInt32; cdecl; external libCoreGraphics name _PU + 'CGDisplayVendorNumber';
{$EXTERNALSYM CGDisplayVendorNumber}
function CGDisplayWaitForBeamPositionOutsideLines(display: CGDirectDisplayID; upperScanLine: UInt32; lowerScanLine: UInt32): CGError; cdecl; external libCoreGraphics name _PU + 'CGDisplayWaitForBeamPositionOutsideLines';
...
function CGEventCreateKeyboardEvent(source: CGEventSourceRef; virtualKey: CGKeyCode; keyDown: Boolean): CGEventRef; cdecl; external libCoreGraphics name _PU + 'CGEventCreateKeyboardEvent';
...
function CGEventCreateScrollWheelEvent(source: CGEventSourceRef; units: CGScrollEventUnit; wheelCount: UInt32; wheel1: Int32): CGEventRef; cdecl; varargs; external libCoreGraphics name _PU + 'CGEventCreateScrollWheelEvent';
...
function CGEventSourceButtonState(stateID: CGEventSourceStateID; button: CGMouseButton): Boolean; cdecl; external libCoreGraphics name _PU + 'CGEventSourceButtonState';
{$EXTERNALSYM CGEventSourceButtonState}
function CGEventSourceCounterForEventType(stateID: CGEventSourceStateID; eventType: CGEventType): UInt32; cdecl; external libCoreGraphics name _PU + 'CGEventSourceCounterForEventType';
...
function CGEventSourceKeyState(stateID: CGEventSourceStateID; key: CGKeyCode): Boolean; cdecl; external libCoreGraphics name _PU + 'CGEventSourceKeyState';
...
procedure CGEventTapEnable(tap: CFMachPortRef; enable: Boolean); cdecl; external libCoreGraphics name _PU + 'CGEventTapEnable';
{$EXTERNALSYM CGEventTapEnable}
function CGEventTapIsEnabled(tap: CFMachPortRef): Boolean; cdecl; external libCoreGraphics name _PU + 'CGEventTapIsEnabled';
...
function CGGetActiveDisplayList(maxDisplays: UInt32; activeDisplays: PCGDirectDisplayID; displayCount: PUInt32): CGError; cdecl; external libCoreGraphics name _PU + 'CGGetActiveDisplayList';
...
function CGGetDisplayTransferByTable(display: CGDirectDisplayID; capacity: UInt32; redTable: PCGGammaValue; greenTable: PCGGammaValue; blueTable: PCGGammaValue; sampleCount: PUInt32): CGError; cdecl; external libCoreGraphics name _PU + 'CGGetDisplayTransferByTable';
{$EXTERNALSYM CGGetDisplayTransferByTable}
function CGGetDisplaysWithOpenGLDisplayMask(mask: CGOpenGLDisplayMask; maxDisplays: UInt32; displays: PCGDirectDisplayID; matchingDisplayCount: PUInt32): CGError; cdecl; external libCoreGraphics name _PU + 'CGGetDisplaysWithOpenGLDisplayMask';
{$EXTERNALSYM CGGetDisplaysWithOpenGLDisplayMask}
function CGGetDisplaysWithPoint(point: CGPoint; maxDisplays: UInt32; displays: PCGDirectDisplayID; matchingDisplayCount: PUInt32): CGError; cdecl; external libCoreGraphics name _PU + 'CGGetDisplaysWithPoint';
{$EXTERNALSYM CGGetDisplaysWithPoint}
function CGGetDisplaysWithRect(rect: CGRect; maxDisplays: UInt32; displays: PCGDirectDisplayID; matchingDisplayCount: PUInt32): CGError; cdecl; external libCoreGraphics name _PU + 'CGGetDisplaysWithRect';
{$EXTERNALSYM CGGetDisplaysWithRect}
function CGGetEventTapList(maxNumberOfTaps: UInt32; tapList: PCGEventTapInformation; eventTapCount: PUInt32): CGError; cdecl; external libCoreGraphics name _PU + 'CGGetEventTapList';
...
function CGGetOnlineDisplayList(maxDisplays: UInt32; onlineDisplays: PCGDirectDisplayID; displayCount: PUInt32): CGError; cdecl; external libCoreGraphics name _PU + 'CGGetOnlineDisplayList';
...
function CGPSConverterAbort(converter: CGPSConverterRef): Boolean; cdecl; external libCoreGraphics name _PU + 'CGPSConverterAbort';
{$EXTERNALSYM CGPSConverterAbort}
function CGPSConverterConvert(converter: CGPSConverterRef; provider: CGDataProviderRef; consumer: CGDataConsumerRef; options: CFDictionaryRef): Boolean; cdecl; external libCoreGraphics name _PU + 'CGPSConverterConvert';
...
function CGPSConverterIsConverting(converter: CGPSConverterRef): Boolean; cdecl; external libCoreGraphics name _PU + 'CGPSConverterIsConverting';
...
function CGPaletteCreateWithByteSamples(samples: PCGDeviceByteColor; count: UInt32): CGDirectPaletteRef; cdecl; external libCoreGraphics name _PU + 'CGPaletteCreateWithByteSamples';
{$EXTERNALSYM CGPaletteCreateWithByteSamples}
function CGPaletteCreateWithCapacity(capacity: UInt32): CGDirectPaletteRef; cdecl; external libCoreGraphics name _PU + 'CGPaletteCreateWithCapacity';
...
function CGPaletteCreateWithSamples(samples: PCGDeviceColor; count: UInt32): CGDirectPaletteRef; cdecl; external libCoreGraphics name _PU + 'CGPaletteCreateWithSamples';
{$EXTERNALSYM CGPaletteCreateWithSamples}
function CGPaletteGetColorAtIndex(palette: CGDirectPaletteRef; index: UInt32): CGDeviceColor; cdecl; external libCoreGraphics name _PU + 'CGPaletteGetColorAtIndex';
{$EXTERNALSYM CGPaletteGetColorAtIndex}
function CGPaletteGetIndexForColor(palette: CGDirectPaletteRef; color: CGDeviceColor): UInt32; cdecl; external libCoreGraphics name _PU + 'CGPaletteGetIndexForColor';
{$EXTERNALSYM CGPaletteGetIndexForColor}
function CGPaletteGetNumberOfSamples(palette: CGDirectPaletteRef): UInt32; cdecl; external libCoreGraphics name _PU + 'CGPaletteGetNumberOfSamples';
...
procedure CGPaletteSetColorAtIndex(palette: CGDirectPaletteRef; color: CGDeviceColor; index: UInt32); cdecl; external libCoreGraphics name _PU + 'CGPaletteSetColorAtIndex';
...
function CGPathContainsPoint(path: CGPathRef; m: PCGAffineTransform; point: CGPoint; eoFill: Boolean): Boolean; cdecl; external libCoreGraphics name _PU + 'CGPathContainsPoint';
...
function CGPostScrollWheelEvent(wheelCount: CGWheelCount; wheel1: Int32): CGError; cdecl; varargs; external libCoreGraphics name _PU + 'CGPostScrollWheelEvent';
...
function CGSetDisplayTransferByByteTable(display: CGDirectDisplayID; tableSize: UInt32; redTable: PByte; greenTable: PByte; blueTable: PByte): CGError; cdecl; external libCoreGraphics name _PU + 'CGSetDisplayTransferByByteTable';
...
function CGSetDisplayTransferByTable(display: CGDirectDisplayID; tableSize: UInt32; redTable: PCGGammaValue; greenTable: PCGGammaValue; blueTable: PCGGammaValue): CGError; cdecl; external libCoreGraphics name _PU + 'CGSetDisplayTransferByTable';
...
function CGShieldingWindowID(display: CGDirectDisplayID): UInt32; cdecl; external libCoreGraphics name _PU + 'CGShieldingWindowID';
{$EXTERNALSYM CGShieldingWindowID}
function CGShieldingWindowLevel: Int32; cdecl; external libCoreGraphics name _PU + 'CGShieldingWindowLevel';
...
function CGWaitForScreenRefreshRects(rects: PCGRect; count: PUInt32): CGError; cdecl; external libCoreGraphics name _PU + 'CGWaitForScreenRefreshRects';
{$EXTERNALSYM CGWaitForScreenRefreshRects}
function CGWaitForScreenUpdateRects(requestedOperations: CGScreenUpdateOperation; currentOperation: PCGScreenUpdateOperation; rects: PCGRect; rectCount: Psize_t; delta: PCGScreenUpdateMoveDelta): CGError; cdecl; external libCoreGraphics name _PU + 'CGWaitForScreenUpdateRects';
