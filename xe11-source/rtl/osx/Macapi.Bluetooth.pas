...
{$If defined(MACOS) and NOT defined(IOS)}
  ...
  TBluetoothDeviceAddressData = array[0..5] of Byte;
  BluetoothDeviceAddress = record
    data: TBluetoothDeviceAddressData;
  end;
  PBluetoothDeviceAddress = ^BluetoothDeviceAddress;

  TBluetoothPINCodeData = array[0..15] of Byte;
  BluetoothPINCode = record
    data: TBluetoothPINCodeData;
  end;
...
{$ENDIF defined(MACOS) and NOT defined(IOS)}
  ...
  CBManagerState = (CBManagerStateUnknown = 0, CBManagerStateResetting, CBManagerStateUnsupported,
