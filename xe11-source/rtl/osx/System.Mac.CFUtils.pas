    ...
    case ATypeInfo.Kind of
      ...
      tkInteger:
        case GetTypeData(ATypeInfo).OrdType of
          ...
          otSLong, otULong: LResult := CFNumberGetValue(Value, kCFNumberSInt32Type, ABuffer);
        end;
      tkFloat:
  ...
  case Info.Kind of
    ...
    tkInteger:
      case GetTypeData(Info).OrdType of
        ...
        otSLong, otULong: Result.Value := CFNumberCreate(kCFAllocatorDefault, kCFNumberSInt32Type, @LValue);
      end;
    tkFloat:
...
begin
  ...
  case CFNumberGetType(Value) of
    ...
    kCFNumberSInt32Type,
    kCFNumberIntType: Result := TypeInfo(Integer);
    kCFNumberLongType: Result := TypeInfo(LongInt);
    kCFNumberSInt64Type,
    ...
    kCFNumberCGFloatType: Result := TypeInfo(CGFloat);
