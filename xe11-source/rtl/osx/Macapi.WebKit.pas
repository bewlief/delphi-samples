...
type
  ...
  WebHistory = interface(NSObject)
    ...
    function loadFromURL(URL: NSURL; error: PPointer = nil): Boolean; cdecl;
    function saveToURL(URL: NSURL; error: PPointer = nil): Boolean; cdecl;
  ...
  WKSnapshotConfigurationClass = interface(NSObjectClass)
    ['{39A3B04A-1330-40CD-99B9-A6FF463F3321}']
  end;

  WKSnapshotConfiguration = interface(NSObject)
    ['{9CBCE5B3-B7AB-400A-BF4F-F22C9F276225}']
  ...
  WKWebView = interface(NSView)
    ...
    procedure takeSnapshotWithConfiguration(snapshotConfiguration: WKSnapshotConfiguration; completionHandler: TWKWebViewBlockMethod1); cdecl;
  end;
