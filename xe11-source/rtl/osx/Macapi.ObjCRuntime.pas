...
{$IFDEF CPUX64}
function objc_msgSend_fpret(theReceiver: Pointer; theSelector: Pointer): Extended; cdecl; overload;
  external libobjc name _PU + 'objc_msgSend_fpret';
function objc_msgSendP_fpret(theReceiver: Pointer; theSelector: Pointer; P1: Pointer): Extended; cdecl; overload;
  external libobjc name _PU + 'objc_msgSend_fpret';
function objc_msgSendP2_fpret(theReceiver: Pointer; theSelector: Pointer; P1,P2: Pointer): Extended; cdecl; overload;
  external libobjc name _PU + 'objc_msgSend_fpret';
