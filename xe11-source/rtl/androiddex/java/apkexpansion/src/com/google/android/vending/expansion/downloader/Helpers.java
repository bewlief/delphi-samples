...
public class Helpers {
     ...
     */
    static public String getDownloaderStringResourceIDFromState(int state) {
        switch (state) {
            case IDownloaderClient.STATE_IDLE:
                return NotificationLabels.state_idle;
            case IDownloaderClient.STATE_FETCHING_URL:
                return NotificationLabels.state_fetching_url;
            case IDownloaderClient.STATE_CONNECTING:
                return NotificationLabels.state_connecting;
            case IDownloaderClient.STATE_DOWNLOADING:
                return NotificationLabels.state_downloading;
            case IDownloaderClient.STATE_COMPLETED:
                return NotificationLabels.state_completed;
            case IDownloaderClient.STATE_PAUSED_NETWORK_UNAVAILABLE:
                return NotificationLabels.state_paused_network_unavailable;
            case IDownloaderClient.STATE_PAUSED_BY_REQUEST:
                return NotificationLabels.state_paused_by_request;
            case IDownloaderClient.STATE_PAUSED_WIFI_DISABLED_NEED_CELLULAR_PERMISSION:
                return NotificationLabels.state_paused_wifi_disabled;
            case IDownloaderClient.STATE_PAUSED_NEED_CELLULAR_PERMISSION:
                return NotificationLabels.state_paused_wifi_unavailable;
            case IDownloaderClient.STATE_PAUSED_WIFI_DISABLED:
                return NotificationLabels.state_paused_wifi_disabled;
            case IDownloaderClient.STATE_PAUSED_NEED_WIFI:
                return NotificationLabels.state_paused_wifi_unavailable;
            case IDownloaderClient.STATE_PAUSED_ROAMING:
                return NotificationLabels.state_paused_roaming;
            case IDownloaderClient.STATE_PAUSED_NETWORK_SETUP_FAILURE:
                return NotificationLabels.state_paused_network_setup_failure;
            case IDownloaderClient.STATE_PAUSED_SDCARD_UNAVAILABLE:
                return NotificationLabels.state_paused_sdcard_unavailable;
            case IDownloaderClient.STATE_FAILED_UNLICENSED:
                return NotificationLabels.state_failed_unlicensed;
            case IDownloaderClient.STATE_FAILED_FETCHING_URL:
                return NotificationLabels.state_failed_fetching_url;
            case IDownloaderClient.STATE_FAILED_SDCARD_FULL:
                return NotificationLabels.state_failed_sdcard_full;
            case IDownloaderClient.STATE_FAILED_CANCELED:
                return NotificationLabels.state_failed_cancelled;
            default:
                return NotificationLabels.state_unknown;
        }
    }
