...
// ===== Forward declarations =====
  ...
  JCustomPhoneStateListener = interface;//com.embarcadero.firemonkey.telephony.CustomPhoneStateListener
  JICustomPhoneStateListener = interface;//com.embarcadero.firemonkey.telephony.ICustomPhoneStateListener
...
// ===== Interface declarations =====
  ...
  JTelephonyManager = interface(JObject)
    ...
    function getServiceState: JServiceState; cdecl;
    ...
    procedure setDataEnabled(enable: Boolean); cdecl;
    ...
    //procedure setVoicemailRingtoneUri(phoneAccountHandle: JPhoneAccountHandle; uri: Jnet_Uri); cdecl;
    //procedure setVoicemailVibrationEnabled(phoneAccountHandle: JPhoneAccountHandle; enabled: Boolean); cdecl;
  end;
