...
// ===== Forward declarations =====
  ...
  JRTLBluetoothGattCallback = interface;//com.embarcadero.rtl.bluetooth.RTLBluetoothGattCallback
  JRTLBluetoothGattListener = interface;//com.embarcadero.rtl.bluetooth.RTLBluetoothGattListener
  JRTLBluetoothGattServerCallback = interface;//com.embarcadero.rtl.bluetooth.RTLBluetoothGattServerCallback
  JRTLBluetoothGattServerListener = interface;//com.embarcadero.rtl.bluetooth.RTLBluetoothGattServerListener
  ...
  JRTLAdvertiseCallback = interface;//com.embarcadero.rtl.bluetooth.le.RTLAdvertiseCallback
  JRTLAdvertiseListener = interface;//com.embarcadero.rtl.bluetooth.le.RTLAdvertiseListener
  JScanCallback = interface;//android.bluetooth.le.ScanCallback
  JRTLScanCallback = interface;//com.embarcadero.rtl.bluetooth.le.RTLScanCallback
  JRTLScanListener = interface;//com.embarcadero.rtl.bluetooth.le.RTLScanListener
...
// ===== Interface declarations =====
  ...
  JRTLAdvertiseCallback = interface(JAdvertiseCallback)
    ...
    procedure onStartFailure(errorCode: Integer); cdecl;
    procedure onStartSuccess(settingsInEffect: JAdvertiseSettings); cdecl;
    procedure setListener(listener: JRTLAdvertiseListener); cdecl;
  end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Bluetooth.JRTLScanListener', TypeInfo(Androidapi.JNI.Bluetooth.JRTLScanListener));
