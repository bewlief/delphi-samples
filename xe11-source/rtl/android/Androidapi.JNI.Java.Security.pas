...
unit Androidapi.JNI.Java.Security;
...
// ===== Forward declarations =====
  ...
  JAccessControlContext = interface;//java.security.AccessControlContext
  JAlgorithmConstraints = interface;//java.security.AlgorithmConstraints
  ...
  JDomainCombiner = interface;//java.security.DomainCombiner
  ...
  JDestroyable = interface;//javax.security.auth.Destroyable
  JPrivateKey = interface;//java.security.PrivateKey
  JPrivilegedAction = interface;//java.security.PrivilegedAction
  JPrivilegedExceptionAction = interface;//java.security.PrivilegedExceptionAction
  ...
  JSubject = interface;//javax.security.auth.Subject
...
// ===== Interface declarations =====
  ...
  JAccessControlContextClass = interface(JObjectClass)
    ['{A228C257-AADF-4F8D-8679-E389AA6D7648}']
    {class} function init(context: TJavaObjectArray<JProtectionDomain>): JAccessControlContext; cdecl; overload;
    {class} function init(acc: JAccessControlContext; combiner: JDomainCombiner): JAccessControlContext; cdecl; overload;
  end;

  [JavaSignature('java/security/AccessControlContext')]
  JAccessControlContext = interface(JObject)
    ['{9117C5C3-A57A-478B-82B4-CBEFDC15A3DD}']
    procedure checkPermission(perm: JPermission); cdecl;
    function getDomainCombiner: JDomainCombiner; cdecl;
  end;
  TJAccessControlContext = class(TJavaGenericImport<JAccessControlContextClass, JAccessControlContext>) end;

  JAlgorithmConstraintsClass = interface(IJavaClass)
    ['{D2B254B9-6912-4C5A-B0E9-9BAFB98B047D}']
  end;

  [JavaSignature('java/security/AlgorithmConstraints')]
  JAlgorithmConstraints = interface(IJavaInstance)
    ['{66E09CF2-E2E1-4C22-B977-B727D163F965}']
    function permits(primitives: JSet; algorithm: JString; parameters: JAlgorithmParameters): Boolean; cdecl; overload;
    function permits(primitives: JSet; key: JKey): Boolean; cdecl; overload;
    function permits(primitives: JSet; algorithm: JString; key: JKey; parameters: JAlgorithmParameters): Boolean; cdecl; overload;
  end;
  TJAlgorithmConstraints = class(TJavaGenericImport<JAlgorithmConstraintsClass, JAlgorithmConstraints>) end;
  ...
  JCodeSourceClass = interface(JObjectClass)
    ...
    {class} //function init(url: JURL; certs: TJavaObjectArray<JCertificate>): JCodeSource; cdecl; overload;
    {class} //function init(url: JURL; signers: TJavaObjectArray<JCodeSigner>): JCodeSource; cdecl; overload;
  end;
  ...
  JCodeSource = interface(JObject)
    ...
    function implies(codesource: JCodeSource): Boolean; cdecl;
  end;
  TJCodeSource = class(TJavaGenericImport<JCodeSourceClass, JCodeSource>) end;

  JDomainCombinerClass = interface(IJavaClass)
    ['{A1C314B0-0047-4407-B0B5-0544A4F58531}']
  end;

  [JavaSignature('java/security/DomainCombiner')]
  JDomainCombiner = interface(IJavaInstance)
    ['{E4316842-A5FE-476D-8194-4334B2C8B2D2}']
    function combine(currentDomains: TJavaObjectArray<JProtectionDomain>; assignedDomains: TJavaObjectArray<JProtectionDomain>): TJavaObjectArray<JProtectionDomain>; cdecl;
  end;
  TJDomainCombiner = class(TJavaGenericImport<JDomainCombinerClass, JDomainCombiner>) end;
  ...
  JKeyStore = interface(JObject)
    ...
    function getEntry(alias: JString; protParam: JKeyStore_ProtectionParameter): JKeyStore_Entry; cdecl;
    ...
    procedure setEntry(alias: JString; entry: JKeyStore_Entry; protParam: JKeyStore_ProtectionParameter); cdecl;
  ...
  JKeyStore_Entry = interface(IJavaInstance)
    ...
    function getAttributes: JSet; cdecl;
  end;
  ...
  JPermission = interface(JObject)
    ...
    procedure checkGuard(object_: JObject); cdecl;
  ...
  JPrincipal = interface(IJavaInstance)
    ...
    function getName: JString; cdecl;
    function hashCode: Integer; cdecl;
    function implies(subject: JSubject): Boolean; cdecl;
    function toString: JString; cdecl;
  end;
  TJPrincipal = class(TJavaGenericImport<JPrincipalClass, JPrincipal>) end;

  JDestroyableClass = interface(IJavaClass)
    ['{BCA6BFF6-A936-406D-A2D3-E43A6943E498}']
  end;

  [JavaSignature('javax/security/auth/Destroyable')]
  JDestroyable = interface(IJavaInstance)
    ['{D3A05C24-0930-49F6-85C9-5745C07C189B}']
    procedure destroy; cdecl;
    function isDestroyed: Boolean; cdecl;
  end;
  TJDestroyable = class(TJavaGenericImport<JDestroyableClass, JDestroyable>) end;

  JPrivateKeyClass = interface(JDestroyableClass)
  ...
  JPrivateKey = interface(JDestroyable)
    ['{81138458-5C17-498A-966F-8EAADC2639AF}']
  end;
  TJPrivateKey = class(TJavaGenericImport<JPrivateKeyClass, JPrivateKey>) end;

  JPrivilegedActionClass = interface(IJavaClass)
    ['{385E305D-E354-479B-B64A-5968FDD354E3}']
  end;

  [JavaSignature('java/security/PrivilegedAction')]
  JPrivilegedAction = interface(IJavaInstance)
    ['{7B275AAF-91BC-4027-B86E-ADDC97FFF128}']
    function run: JObject; cdecl;
  end;
  TJPrivilegedAction = class(TJavaGenericImport<JPrivilegedActionClass, JPrivilegedAction>) end;

  JPrivilegedExceptionActionClass = interface(IJavaClass)
    ['{9667A793-B3E5-4A69-A7C3-7DA0F1962422}']
  end;

  [JavaSignature('java/security/PrivilegedExceptionAction')]
  JPrivilegedExceptionAction = interface(IJavaInstance)
    ['{660B89C4-CC24-432E-90C3-B6A93CC3A0C2}']
    function run: JObject; cdecl;
  end;
  TJPrivilegedExceptionAction = class(TJavaGenericImport<JPrivilegedExceptionActionClass, JPrivilegedExceptionAction>) end;

  JProtectionDomainClass = interface(JObjectClass)
    ['{762DD343-844A-4634-8E15-19EF5AA75337}']
    {class} function init(codesource: JCodeSource; permissions: JPermissionCollection): JProtectionDomain; cdecl; overload;
    {class} function init(codesource: JCodeSource; permissions: JPermissionCollection; classloader: JClassLoader; principals: TJavaObjectArray<JPrincipal>): JProtectionDomain; cdecl; overload;
  end;
  ...
  JSecureRandomClass = interface(JRandomClass)
    ...
    {class} function getInstanceStrong: JSecureRandom; cdecl;
  ...
  JCertificate = interface(JObject)
    ...
    procedure verify(key: JPublicKey; sigProvider: JProvider); cdecl; overload;
  end;
  ...
  JX509Certificate = interface(JCertificate)
    ...
    procedure verify(key: JPublicKey; sigProvider: JProvider); cdecl;
  end;
  ...
  JSubjectClass = interface(JObjectClass)
    ['{B6CA0075-0706-4466-88EC-102A4CDD7500}']
    {class} function init: JSubject; cdecl; overload;
    {class} function init(readOnly: Boolean; principals: JSet; pubCredentials: JSet; privCredentials: JSet): JSubject; cdecl; overload;
    {class} function doAs(subject: JSubject; action: JPrivilegedAction): JObject; cdecl; overload;
    {class} function doAs(subject: JSubject; action: JPrivilegedExceptionAction): JObject; cdecl; overload;
    {class} function doAsPrivileged(subject: JSubject; action: JPrivilegedAction; acc: JAccessControlContext): JObject; cdecl; overload;
    {class} function doAsPrivileged(subject: JSubject; action: JPrivilegedExceptionAction; acc: JAccessControlContext): JObject; cdecl; overload;
    {class} function getSubject(acc: JAccessControlContext): JSubject; cdecl;
  end;

  [JavaSignature('javax/security/auth/Subject')]
  JSubject = interface(JObject)
    ['{AE212E01-2105-4FE0-A94F-78D670A6E273}']
    function equals(o: JObject): Boolean; cdecl;
    function getPrincipals: JSet; cdecl; overload;
    function getPrincipals(c: Jlang_Class): JSet; cdecl; overload;
    function getPrivateCredentials: JSet; cdecl; overload;
    function getPrivateCredentials(c: Jlang_Class): JSet; cdecl; overload;
    function getPublicCredentials: JSet; cdecl; overload;
    function getPublicCredentials(c: Jlang_Class): JSet; cdecl; overload;
    function hashCode: Integer; cdecl;
    function isReadOnly: Boolean; cdecl;
    procedure setReadOnly; cdecl;
    function toString: JString; cdecl;
  end;
  TJSubject = class(TJavaGenericImport<JSubjectClass, JSubject>) end;
  ...
  JX500PrincipalClass = interface(JObjectClass)
    ...
    {class} function init(is_: JInputStream): JX500Principal; cdecl; overload;
...
begin
  TRegTypes.RegisterType('Androidapi.JNI.Java.Security.JAccessControlContext', TypeInfo(Androidapi.JNI.Java.Security.JAccessControlContext));
  TRegTypes.RegisterType('Androidapi.JNI.Java.Security.JAlgorithmConstraints', TypeInfo(Androidapi.JNI.Java.Security.JAlgorithmConstraints));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Java.Security.JDomainCombiner', TypeInfo(Androidapi.JNI.Java.Security.JDomainCombiner));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Java.Security.JDestroyable', TypeInfo(Androidapi.JNI.Java.Security.JDestroyable));
  TRegTypes.RegisterType('Androidapi.JNI.Java.Security.JPrivateKey', TypeInfo(Androidapi.JNI.Java.Security.JPrivateKey));
  TRegTypes.RegisterType('Androidapi.JNI.Java.Security.JPrivilegedAction', TypeInfo(Androidapi.JNI.Java.Security.JPrivilegedAction));
  TRegTypes.RegisterType('Androidapi.JNI.Java.Security.JPrivilegedExceptionAction', TypeInfo(Androidapi.JNI.Java.Security.JPrivilegedExceptionAction));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Java.Security.JSubject', TypeInfo(Androidapi.JNI.Java.Security.JSubject));
