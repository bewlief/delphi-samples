...
// ===== Interface declarations =====
  ...
  JDrmInitData = interface(JObject)
    ...
    function &get(schemeUuid: JUUID): JDrmInitData_SchemeInitData; cdecl;
  end;
  ...
  JMediaCasClass = interface(JObjectClass)
    ...
    {class} function init(CA_system_id: Integer): JMediaCas; cdecl;
  ...
  JMediaCas = interface(JObject)
    ...
    procedure close; cdecl;
    function openSession: JMediaCas_Session; cdecl;
  ...
  JMediaDrm = interface(JObject)
    ...
    function getSecureStops: JList; cdecl;
  ...
  JMediaExtractor = interface(JObject)
    ...
    procedure setMediaCas(mediaCas: JMediaCas); cdecl;
  ...
  JMediaPlayer_DrmInfo = interface(JObject)
    ...
    function getPssh: TJavaObjectArray<JMap>; cdecl;
  ...
  JTvInputManager = interface(JObject)
    ...
    function acquireTvInputHardware(deviceId: Integer; callback: JObject; info: JTvInputInfo): JObject; cdecl;
  ...
  JTvInputService = interface(JService)
    ...
    function onBind(intent: JIntent): JIBinder; cdecl;
    function onCreateRecordingSession(inputId: JString): JTvInputService_RecordingSession; cdecl;
  ...
  JTvInputService_RecordingSession = interface(JObject)
    ...
    procedure onAppPrivateCommand(action: JString; data: JBundle); cdecl;
    procedure onRelease; cdecl;
    procedure onStartRecording(programUri: Jnet_Uri); cdecl;
  ...
  JTvRecordingClient = interface(JObject)
    ...
    procedure startRecording(programUri: Jnet_Uri); cdecl;
