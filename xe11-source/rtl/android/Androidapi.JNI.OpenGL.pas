...
// ===== Forward declarations =====
  ...
  JGLES32 = interface;//android.opengl.GLES32
  JGLES32_DebugProc = interface;//android.opengl.GLES32$DebugProc
...
// ===== Interface declarations =====
  ...
  JEGL14Class = interface(JObjectClass)
    ...
    {class} function eglCreatePixmapSurface(dpy: Jopengl_EGLDisplay; config: Jopengl_EGLConfig; pixmap: Integer; attrib_list: TJavaArray<Integer>; offset: Integer): Jopengl_EGLSurface; cdecl;//Deprecated
  ...
  JEGLExtClass = interface(JObjectClass)
    ...
    {class} function _GetEGL_RECORDABLE_ANDROID: Integer; cdecl;
    ...
    {class} property EGL_RECORDABLE_ANDROID: Integer read _GetEGL_RECORDABLE_ANDROID;
  end;
  ...
  JGLES30Class = interface(JGLES20Class)
    ...
    {class} procedure glGetTransformFeedbackVarying(program_: Integer; index: Integer; bufsize: Integer; length: JIntBuffer; size: JIntBuffer; type_: JIntBuffer; name: Byte); cdecl; overload;//Deprecated
    {class} procedure glGetTransformFeedbackVarying(program_: Integer; index: Integer; bufsize: Integer; length: JIntBuffer; size: JIntBuffer; type_: JIntBuffer; name: JByteBuffer); cdecl; overload;
    ...
    {class} procedure glReadPixels(x: Integer; y: Integer; width: Integer; height: Integer; format: Integer; type_: Integer; offset: Integer); cdecl;
  ...
  JGLES31Class = interface(JGLES30Class)
    ...
    {class} function _GetGL_ALL_BARRIER_BITS: Integer; cdecl;
    ...
    {class} function _GetGL_ELEMENT_ARRAY_BARRIER_BIT: Integer; cdecl;
    ...
    {class} function _GetGL_SHADER_IMAGE_ACCESS_BARRIER_BIT: Integer; cdecl;
    ...
    {class} function _GetGL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT: Integer; cdecl;
    ...
    {class} property GL_ALL_BARRIER_BITS: Integer read _GetGL_ALL_BARRIER_BITS;
    ...
    {class} property GL_ELEMENT_ARRAY_BARRIER_BIT: Integer read _GetGL_ELEMENT_ARRAY_BARRIER_BIT;
    ...
    {class} property GL_SHADER_IMAGE_ACCESS_BARRIER_BIT: Integer read _GetGL_SHADER_IMAGE_ACCESS_BARRIER_BIT;
    ...
    {class} property GL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT: Integer read _GetGL_VERTEX_ATTRIB_ARRAY_BARRIER_BIT;
  ...
  JGLES32Class = interface(JGLES31Class)
    ['{C83CC8F0-59E2-43B4-B4E6-99C53E4943D7}']
    {class} function _GetGL_BUFFER: Integer; cdecl;
    {class} function _GetGL_CLAMP_TO_BORDER: Integer; cdecl;
    {class} function _GetGL_COLORBURN: Integer; cdecl;
    {class} function _GetGL_COLORDODGE: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_10x10: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_10x5: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_10x6: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_10x8: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_12x10: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_12x12: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_4x4: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_5x4: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_5x5: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_6x5: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_6x6: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_8x5: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_8x6: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_RGBA_ASTC_8x8: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6: Integer; cdecl;
    {class} function _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8: Integer; cdecl;
    {class} function _GetGL_CONTEXT_FLAGS: Integer; cdecl;
    {class} function _GetGL_CONTEXT_FLAG_DEBUG_BIT: Integer; cdecl;
    {class} function _GetGL_CONTEXT_FLAG_ROBUST_ACCESS_BIT: Integer; cdecl;
    {class} function _GetGL_CONTEXT_LOST: Integer; cdecl;
    {class} function _GetGL_DARKEN: Integer; cdecl;
    {class} function _GetGL_DEBUG_CALLBACK_FUNCTION: Integer; cdecl;
    {class} function _GetGL_DEBUG_CALLBACK_USER_PARAM: Integer; cdecl;
    {class} function _GetGL_DEBUG_GROUP_STACK_DEPTH: Integer; cdecl;
    {class} function _GetGL_DEBUG_LOGGED_MESSAGES: Integer; cdecl;
    {class} function _GetGL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH: Integer; cdecl;
    {class} function _GetGL_DEBUG_OUTPUT: Integer; cdecl;
    {class} function _GetGL_DEBUG_OUTPUT_SYNCHRONOUS: Integer; cdecl;
    {class} function _GetGL_DEBUG_SEVERITY_HIGH: Integer; cdecl;
    {class} function _GetGL_DEBUG_SEVERITY_LOW: Integer; cdecl;
    {class} function _GetGL_DEBUG_SEVERITY_MEDIUM: Integer; cdecl;
    {class} function _GetGL_DEBUG_SEVERITY_NOTIFICATION: Integer; cdecl;
    {class} function _GetGL_DEBUG_SOURCE_API: Integer; cdecl;
    {class} function _GetGL_DEBUG_SOURCE_APPLICATION: Integer; cdecl;
    {class} function _GetGL_DEBUG_SOURCE_OTHER: Integer; cdecl;
    {class} function _GetGL_DEBUG_SOURCE_SHADER_COMPILER: Integer; cdecl;
    {class} function _GetGL_DEBUG_SOURCE_THIRD_PARTY: Integer; cdecl;
    {class} function _GetGL_DEBUG_SOURCE_WINDOW_SYSTEM: Integer; cdecl;
    {class} function _GetGL_DEBUG_TYPE_DEPRECATED_BEHAVIOR: Integer; cdecl;
    {class} function _GetGL_DEBUG_TYPE_ERROR: Integer; cdecl;
    {class} function _GetGL_DEBUG_TYPE_MARKER: Integer; cdecl;
    {class} function _GetGL_DEBUG_TYPE_OTHER: Integer; cdecl;
    {class} function _GetGL_DEBUG_TYPE_PERFORMANCE: Integer; cdecl;
    {class} function _GetGL_DEBUG_TYPE_POP_GROUP: Integer; cdecl;
    {class} function _GetGL_DEBUG_TYPE_PORTABILITY: Integer; cdecl;
    {class} function _GetGL_DEBUG_TYPE_PUSH_GROUP: Integer; cdecl;
    {class} function _GetGL_DEBUG_TYPE_UNDEFINED_BEHAVIOR: Integer; cdecl;
    {class} function _GetGL_DIFFERENCE: Integer; cdecl;
    {class} function _GetGL_EXCLUSION: Integer; cdecl;
    {class} function _GetGL_FIRST_VERTEX_CONVENTION: Integer; cdecl;
    {class} function _GetGL_FRACTIONAL_EVEN: Integer; cdecl;
    {class} function _GetGL_FRACTIONAL_ODD: Integer; cdecl;
    {class} function _GetGL_FRAGMENT_INTERPOLATION_OFFSET_BITS: Integer; cdecl;
    {class} function _GetGL_FRAMEBUFFER_ATTACHMENT_LAYERED: Integer; cdecl;
    {class} function _GetGL_FRAMEBUFFER_DEFAULT_LAYERS: Integer; cdecl;
    {class} function _GetGL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS: Integer; cdecl;
    {class} function _GetGL_GEOMETRY_INPUT_TYPE: Integer; cdecl;
    {class} function _GetGL_GEOMETRY_OUTPUT_TYPE: Integer; cdecl;
    {class} function _GetGL_GEOMETRY_SHADER: Integer; cdecl;
    {class} function _GetGL_GEOMETRY_SHADER_BIT: Integer; cdecl;
    {class} function _GetGL_GEOMETRY_SHADER_INVOCATIONS: Integer; cdecl;
    {class} function _GetGL_GEOMETRY_VERTICES_OUT: Integer; cdecl;
    {class} function _GetGL_GUILTY_CONTEXT_RESET: Integer; cdecl;
    {class} function _GetGL_HARDLIGHT: Integer; cdecl;
    {class} function _GetGL_HSL_COLOR: Integer; cdecl;
    {class} function _GetGL_HSL_HUE: Integer; cdecl;
    {class} function _GetGL_HSL_LUMINOSITY: Integer; cdecl;
    {class} function _GetGL_HSL_SATURATION: Integer; cdecl;
    {class} function _GetGL_IMAGE_BUFFER: Integer; cdecl;
    {class} function _GetGL_IMAGE_CUBE_MAP_ARRAY: Integer; cdecl;
    {class} function _GetGL_INNOCENT_CONTEXT_RESET: Integer; cdecl;
    {class} function _GetGL_INT_IMAGE_BUFFER: Integer; cdecl;
    {class} function _GetGL_INT_IMAGE_CUBE_MAP_ARRAY: Integer; cdecl;
    {class} function _GetGL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY: Integer; cdecl;
    {class} function _GetGL_INT_SAMPLER_BUFFER: Integer; cdecl;
    {class} function _GetGL_INT_SAMPLER_CUBE_MAP_ARRAY: Integer; cdecl;
    {class} function _GetGL_ISOLINES: Integer; cdecl;
    {class} function _GetGL_IS_PER_PATCH: Integer; cdecl;
    {class} function _GetGL_LAST_VERTEX_CONVENTION: Integer; cdecl;
    {class} function _GetGL_LAYER_PROVOKING_VERTEX: Integer; cdecl;
    {class} function _GetGL_LIGHTEN: Integer; cdecl;
    {class} function _GetGL_LINES_ADJACENCY: Integer; cdecl;
    {class} function _GetGL_LINE_STRIP_ADJACENCY: Integer; cdecl;
    {class} function _GetGL_LOSE_CONTEXT_ON_RESET: Integer; cdecl;
    {class} function _GetGL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_DEBUG_GROUP_STACK_DEPTH: Integer; cdecl;
    {class} function _GetGL_MAX_DEBUG_LOGGED_MESSAGES: Integer; cdecl;
    {class} function _GetGL_MAX_DEBUG_MESSAGE_LENGTH: Integer; cdecl;
    {class} function _GetGL_MAX_FRAGMENT_INTERPOLATION_OFFSET: Integer; cdecl;
    {class} function _GetGL_MAX_FRAMEBUFFER_LAYERS: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_ATOMIC_COUNTERS: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_IMAGE_UNIFORMS: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_INPUT_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_OUTPUT_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_OUTPUT_VERTICES: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_SHADER_INVOCATIONS: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_UNIFORM_BLOCKS: Integer; cdecl;
    {class} function _GetGL_MAX_GEOMETRY_UNIFORM_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_LABEL_LENGTH: Integer; cdecl;
    {class} function _GetGL_MAX_PATCH_VERTICES: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_CONTROL_ATOMIC_COUNTERS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_CONTROL_IMAGE_UNIFORMS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_CONTROL_INPUT_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_CONTROL_UNIFORM_BLOCKS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_EVALUATION_INPUT_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_GEN_LEVEL: Integer; cdecl;
    {class} function _GetGL_MAX_TESS_PATCH_COMPONENTS: Integer; cdecl;
    {class} function _GetGL_MAX_TEXTURE_BUFFER_SIZE: Integer; cdecl;
    {class} function _GetGL_MIN_FRAGMENT_INTERPOLATION_OFFSET: Integer; cdecl;
    {class} function _GetGL_MIN_SAMPLE_SHADING_VALUE: Integer; cdecl;
    {class} function _GetGL_MULTIPLY: Integer; cdecl;
    {class} function _GetGL_MULTISAMPLE_LINE_WIDTH_GRANULARITY: Integer; cdecl;
    {class} function _GetGL_MULTISAMPLE_LINE_WIDTH_RANGE: Integer; cdecl;
    {class} function _GetGL_NO_RESET_NOTIFICATION: Integer; cdecl;
    {class} function _GetGL_OVERLAY: Integer; cdecl;
    {class} function _GetGL_PATCHES: Integer; cdecl;
    {class} function _GetGL_PATCH_VERTICES: Integer; cdecl;
    {class} function _GetGL_PRIMITIVES_GENERATED: Integer; cdecl;
    {class} function _GetGL_PRIMITIVE_BOUNDING_BOX: Integer; cdecl;
    {class} function _GetGL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED: Integer; cdecl;
    {class} function _GetGL_PROGRAM: Integer; cdecl;
    {class} function _GetGL_PROGRAM_PIPELINE: Integer; cdecl;
    {class} function _GetGL_QUADS: Integer; cdecl;
    {class} function _GetGL_QUERY: Integer; cdecl;
    {class} function _GetGL_REFERENCED_BY_GEOMETRY_SHADER: Integer; cdecl;
    {class} function _GetGL_REFERENCED_BY_TESS_CONTROL_SHADER: Integer; cdecl;
    {class} function _GetGL_REFERENCED_BY_TESS_EVALUATION_SHADER: Integer; cdecl;
    {class} function _GetGL_RESET_NOTIFICATION_STRATEGY: Integer; cdecl;
    {class} function _GetGL_SAMPLER: Integer; cdecl;
    {class} function _GetGL_SAMPLER_2D_MULTISAMPLE_ARRAY: Integer; cdecl;
    {class} function _GetGL_SAMPLER_BUFFER: Integer; cdecl;
    {class} function _GetGL_SAMPLER_CUBE_MAP_ARRAY: Integer; cdecl;
    {class} function _GetGL_SAMPLER_CUBE_MAP_ARRAY_SHADOW: Integer; cdecl;
    {class} function _GetGL_SAMPLE_SHADING: Integer; cdecl;
    {class} function _GetGL_SCREEN: Integer; cdecl;
    {class} function _GetGL_SHADER: Integer; cdecl;
    {class} function _GetGL_SOFTLIGHT: Integer; cdecl;
    {class} function _GetGL_STACK_OVERFLOW: Integer; cdecl;
    {class} function _GetGL_STACK_UNDERFLOW: Integer; cdecl;
    {class} function _GetGL_TESS_CONTROL_OUTPUT_VERTICES: Integer; cdecl;
    {class} function _GetGL_TESS_CONTROL_SHADER: Integer; cdecl;
    {class} function _GetGL_TESS_CONTROL_SHADER_BIT: Integer; cdecl;
    {class} function _GetGL_TESS_EVALUATION_SHADER: Integer; cdecl;
    {class} function _GetGL_TESS_EVALUATION_SHADER_BIT: Integer; cdecl;
    {class} function _GetGL_TESS_GEN_MODE: Integer; cdecl;
    {class} function _GetGL_TESS_GEN_POINT_MODE: Integer; cdecl;
    {class} function _GetGL_TESS_GEN_SPACING: Integer; cdecl;
    {class} function _GetGL_TESS_GEN_VERTEX_ORDER: Integer; cdecl;
    {class} function _GetGL_TEXTURE_2D_MULTISAMPLE_ARRAY: Integer; cdecl;
    {class} function _GetGL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY: Integer; cdecl;
    {class} function _GetGL_TEXTURE_BINDING_BUFFER: Integer; cdecl;
    {class} function _GetGL_TEXTURE_BINDING_CUBE_MAP_ARRAY: Integer; cdecl;
    {class} function _GetGL_TEXTURE_BORDER_COLOR: Integer; cdecl;
    {class} function _GetGL_TEXTURE_BUFFER: Integer; cdecl;
    {class} function _GetGL_TEXTURE_BUFFER_BINDING: Integer; cdecl;
    {class} function _GetGL_TEXTURE_BUFFER_DATA_STORE_BINDING: Integer; cdecl;
    {class} function _GetGL_TEXTURE_BUFFER_OFFSET: Integer; cdecl;
    {class} function _GetGL_TEXTURE_BUFFER_OFFSET_ALIGNMENT: Integer; cdecl;
    {class} function _GetGL_TEXTURE_BUFFER_SIZE: Integer; cdecl;
    {class} function _GetGL_TEXTURE_CUBE_MAP_ARRAY: Integer; cdecl;
    {class} function _GetGL_TRIANGLES_ADJACENCY: Integer; cdecl;
    {class} function _GetGL_TRIANGLE_STRIP_ADJACENCY: Integer; cdecl;
    {class} function _GetGL_UNDEFINED_VERTEX: Integer; cdecl;
    {class} function _GetGL_UNKNOWN_CONTEXT_RESET: Integer; cdecl;
    {class} function _GetGL_UNSIGNED_INT_IMAGE_BUFFER: Integer; cdecl;
    {class} function _GetGL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY: Integer; cdecl;
    {class} function _GetGL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY: Integer; cdecl;
    {class} function _GetGL_UNSIGNED_INT_SAMPLER_BUFFER: Integer; cdecl;
    {class} function _GetGL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY: Integer; cdecl;
    {class} function _GetGL_VERTEX_ARRAY: Integer; cdecl;
    {class} procedure glBlendBarrier; cdecl;
    {class} procedure glBlendEquationSeparatei(buf: Integer; modeRGB: Integer; modeAlpha: Integer); cdecl;
    {class} procedure glBlendEquationi(buf: Integer; mode: Integer); cdecl;
    {class} procedure glBlendFuncSeparatei(buf: Integer; srcRGB: Integer; dstRGB: Integer; srcAlpha: Integer; dstAlpha: Integer); cdecl;
    {class} procedure glBlendFunci(buf: Integer; src: Integer; dst: Integer); cdecl;
    {class} procedure glColorMaski(index: Integer; r: Boolean; g: Boolean; b: Boolean; a: Boolean); cdecl;
    {class} procedure glCopyImageSubData(srcName: Integer; srcTarget: Integer; srcLevel: Integer; srcX: Integer; srcY: Integer; srcZ: Integer; dstName: Integer; dstTarget: Integer; dstLevel: Integer; dstX: Integer; dstY: Integer; dstZ: Integer; srcWidth: Integer; srcHeight: Integer; srcDepth: Integer); cdecl;
    {class} procedure glDebugMessageCallback(callback: JGLES32_DebugProc); cdecl;
    {class} procedure glDebugMessageControl(source: Integer; type_: Integer; severity: Integer; count: Integer; ids: TJavaArray<Integer>; offset: Integer; enabled: Boolean); cdecl; overload;
    {class} procedure glDebugMessageControl(source: Integer; type_: Integer; severity: Integer; count: Integer; ids: JIntBuffer; enabled: Boolean); cdecl; overload;
    {class} procedure glDebugMessageInsert(source: Integer; type_: Integer; id: Integer; severity: Integer; length: Integer; buf: JString); cdecl;
    {class} procedure glDisablei(target: Integer; index: Integer); cdecl;
    {class} procedure glDrawElementsBaseVertex(mode: Integer; count: Integer; type_: Integer; indices: JBuffer; basevertex: Integer); cdecl;
    {class} procedure glDrawElementsInstancedBaseVertex(mode: Integer; count: Integer; type_: Integer; indices: JBuffer; instanceCount: Integer; basevertex: Integer); cdecl; overload;
    {class} procedure glDrawElementsInstancedBaseVertex(mode: Integer; count: Integer; type_: Integer; indicesOffset: Integer; instanceCount: Integer; basevertex: Integer); cdecl; overload;
    {class} procedure glDrawRangeElementsBaseVertex(mode: Integer; start: Integer; end_: Integer; count: Integer; type_: Integer; indices: JBuffer; basevertex: Integer); cdecl;
    {class} procedure glEnablei(target: Integer; index: Integer); cdecl;
    {class} procedure glFramebufferTexture(target: Integer; attachment: Integer; texture: Integer; level: Integer); cdecl;
    {class} function glGetDebugMessageLog(count: Integer; bufSize: Integer; sources: TJavaArray<Integer>; sourcesOffset: Integer; types: TJavaArray<Integer>; typesOffset: Integer; ids: TJavaArray<Integer>; idsOffset: Integer; severities: TJavaArray<Integer>; severitiesOffset: Integer; lengths: TJavaArray<Integer>; lengthsOffset: Integer; messageLog: TJavaArray<Byte>; messageLogOffset: Integer): Integer; cdecl; overload;
    {class} function glGetDebugMessageLog(count: Integer; sources: JIntBuffer; types: JIntBuffer; ids: JIntBuffer; severities: JIntBuffer; lengths: JIntBuffer; messageLog: JByteBuffer): Integer; cdecl; overload;
    {class} function glGetDebugMessageLog(count: Integer; sources: TJavaArray<Integer>; sourcesOffset: Integer; types: TJavaArray<Integer>; typesOffset: Integer; ids: TJavaArray<Integer>; idsOffset: Integer; severities: TJavaArray<Integer>; severitiesOffset: Integer): TJavaObjectArray<JString>; cdecl; overload;
    {class} function glGetDebugMessageLog(count: Integer; sources: JIntBuffer; types: JIntBuffer; ids: JIntBuffer; severities: JIntBuffer): TJavaObjectArray<JString>; cdecl; overload;
    {class} function glGetGraphicsResetStatus: Integer; cdecl;
    {class} function glGetObjectLabel(identifier: Integer; name: Integer): JString; cdecl;
    {class} function glGetObjectPtrLabel(ptr: Int64): JString; cdecl;
    {class} function glGetPointerv(pname: Integer): Int64; cdecl;
    {class} procedure glGetSamplerParameterIiv(sampler: Integer; pname: Integer; params: TJavaArray<Integer>; offset: Integer); cdecl; overload;
    {class} procedure glGetSamplerParameterIiv(sampler: Integer; pname: Integer; params: JIntBuffer); cdecl; overload;
    {class} procedure glGetSamplerParameterIuiv(sampler: Integer; pname: Integer; params: TJavaArray<Integer>; offset: Integer); cdecl; overload;
    {class} procedure glGetSamplerParameterIuiv(sampler: Integer; pname: Integer; params: JIntBuffer); cdecl; overload;
    {class} procedure glGetTexParameterIiv(target: Integer; pname: Integer; params: TJavaArray<Integer>; offset: Integer); cdecl; overload;
    {class} procedure glGetTexParameterIiv(target: Integer; pname: Integer; params: JIntBuffer); cdecl; overload;
    {class} procedure glGetTexParameterIuiv(target: Integer; pname: Integer; params: TJavaArray<Integer>; offset: Integer); cdecl; overload;
    {class} procedure glGetTexParameterIuiv(target: Integer; pname: Integer; params: JIntBuffer); cdecl; overload;
    {class} procedure glGetnUniformfv(program_: Integer; location: Integer; bufSize: Integer; params: TJavaArray<Single>; offset: Integer); cdecl; overload;
    {class} procedure glGetnUniformfv(program_: Integer; location: Integer; bufSize: Integer; params: JFloatBuffer); cdecl; overload;
    {class} procedure glGetnUniformiv(program_: Integer; location: Integer; bufSize: Integer; params: TJavaArray<Integer>; offset: Integer); cdecl; overload;
    {class} procedure glGetnUniformiv(program_: Integer; location: Integer; bufSize: Integer; params: JIntBuffer); cdecl; overload;
    {class} procedure glGetnUniformuiv(program_: Integer; location: Integer; bufSize: Integer; params: TJavaArray<Integer>; offset: Integer); cdecl; overload;
    {class} procedure glGetnUniformuiv(program_: Integer; location: Integer; bufSize: Integer; params: JIntBuffer); cdecl; overload;
    {class} function glIsEnabledi(target: Integer; index: Integer): Boolean; cdecl;
    {class} procedure glMinSampleShading(value: Single); cdecl;
    {class} procedure glObjectLabel(identifier: Integer; name: Integer; length: Integer; label_: JString); cdecl;
    {class} procedure glObjectPtrLabel(ptr: Int64; label_: JString); cdecl;
    {class} procedure glPatchParameteri(pname: Integer; value: Integer); cdecl;
    {class} procedure glPopDebugGroup; cdecl;
    {class} procedure glPrimitiveBoundingBox(minX: Single; minY: Single; minZ: Single; minW: Single; maxX: Single; maxY: Single; maxZ: Single; maxW: Single); cdecl;
    {class} procedure glPushDebugGroup(source: Integer; id: Integer; length: Integer; message: JString); cdecl;
    {class} procedure glReadnPixels(x: Integer; y: Integer; width: Integer; height: Integer; format: Integer; type_: Integer; bufSize: Integer; data: JBuffer); cdecl;
    {class} procedure glSamplerParameterIiv(sampler: Integer; pname: Integer; param: TJavaArray<Integer>; offset: Integer); cdecl; overload;
    {class} procedure glSamplerParameterIiv(sampler: Integer; pname: Integer; param: JIntBuffer); cdecl; overload;
    {class} procedure glSamplerParameterIuiv(sampler: Integer; pname: Integer; param: TJavaArray<Integer>; offset: Integer); cdecl; overload;
    {class} procedure glSamplerParameterIuiv(sampler: Integer; pname: Integer; param: JIntBuffer); cdecl; overload;
    {class} procedure glTexBuffer(target: Integer; internalformat: Integer; buffer: Integer); cdecl;
    {class} procedure glTexBufferRange(target: Integer; internalformat: Integer; buffer: Integer; offset: Integer; size: Integer); cdecl;
    {class} procedure glTexParameterIiv(target: Integer; pname: Integer; params: TJavaArray<Integer>; offset: Integer); cdecl; overload;
    {class} procedure glTexParameterIiv(target: Integer; pname: Integer; params: JIntBuffer); cdecl; overload;
    {class} procedure glTexParameterIuiv(target: Integer; pname: Integer; params: TJavaArray<Integer>; offset: Integer); cdecl; overload;
    {class} procedure glTexParameterIuiv(target: Integer; pname: Integer; params: JIntBuffer); cdecl; overload;
    {class} procedure glTexStorage3DMultisample(target: Integer; samples: Integer; internalformat: Integer; width: Integer; height: Integer; depth: Integer; fixedsamplelocations: Boolean); cdecl;
    {class} property GL_BUFFER: Integer read _GetGL_BUFFER;
    {class} property GL_CLAMP_TO_BORDER: Integer read _GetGL_CLAMP_TO_BORDER;
    {class} property GL_COLORBURN: Integer read _GetGL_COLORBURN;
    {class} property GL_COLORDODGE: Integer read _GetGL_COLORDODGE;
    {class} property GL_COMPRESSED_RGBA_ASTC_10x10: Integer read _GetGL_COMPRESSED_RGBA_ASTC_10x10;
    {class} property GL_COMPRESSED_RGBA_ASTC_10x5: Integer read _GetGL_COMPRESSED_RGBA_ASTC_10x5;
    {class} property GL_COMPRESSED_RGBA_ASTC_10x6: Integer read _GetGL_COMPRESSED_RGBA_ASTC_10x6;
    {class} property GL_COMPRESSED_RGBA_ASTC_10x8: Integer read _GetGL_COMPRESSED_RGBA_ASTC_10x8;
    {class} property GL_COMPRESSED_RGBA_ASTC_12x10: Integer read _GetGL_COMPRESSED_RGBA_ASTC_12x10;
    {class} property GL_COMPRESSED_RGBA_ASTC_12x12: Integer read _GetGL_COMPRESSED_RGBA_ASTC_12x12;
    {class} property GL_COMPRESSED_RGBA_ASTC_4x4: Integer read _GetGL_COMPRESSED_RGBA_ASTC_4x4;
    {class} property GL_COMPRESSED_RGBA_ASTC_5x4: Integer read _GetGL_COMPRESSED_RGBA_ASTC_5x4;
    {class} property GL_COMPRESSED_RGBA_ASTC_5x5: Integer read _GetGL_COMPRESSED_RGBA_ASTC_5x5;
    {class} property GL_COMPRESSED_RGBA_ASTC_6x5: Integer read _GetGL_COMPRESSED_RGBA_ASTC_6x5;
    {class} property GL_COMPRESSED_RGBA_ASTC_6x6: Integer read _GetGL_COMPRESSED_RGBA_ASTC_6x6;
    {class} property GL_COMPRESSED_RGBA_ASTC_8x5: Integer read _GetGL_COMPRESSED_RGBA_ASTC_8x5;
    {class} property GL_COMPRESSED_RGBA_ASTC_8x6: Integer read _GetGL_COMPRESSED_RGBA_ASTC_8x6;
    {class} property GL_COMPRESSED_RGBA_ASTC_8x8: Integer read _GetGL_COMPRESSED_RGBA_ASTC_8x8;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x10;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x5;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x6;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_10x8;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x10;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_12x12;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_4x4;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x4;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_5x5;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x5;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_6x6;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x5;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x6;
    {class} property GL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8: Integer read _GetGL_COMPRESSED_SRGB8_ALPHA8_ASTC_8x8;
    {class} property GL_CONTEXT_FLAGS: Integer read _GetGL_CONTEXT_FLAGS;
    {class} property GL_CONTEXT_FLAG_DEBUG_BIT: Integer read _GetGL_CONTEXT_FLAG_DEBUG_BIT;
    {class} property GL_CONTEXT_FLAG_ROBUST_ACCESS_BIT: Integer read _GetGL_CONTEXT_FLAG_ROBUST_ACCESS_BIT;
    {class} property GL_CONTEXT_LOST: Integer read _GetGL_CONTEXT_LOST;
    {class} property GL_DARKEN: Integer read _GetGL_DARKEN;
    {class} property GL_DEBUG_CALLBACK_FUNCTION: Integer read _GetGL_DEBUG_CALLBACK_FUNCTION;
    {class} property GL_DEBUG_CALLBACK_USER_PARAM: Integer read _GetGL_DEBUG_CALLBACK_USER_PARAM;
    {class} property GL_DEBUG_GROUP_STACK_DEPTH: Integer read _GetGL_DEBUG_GROUP_STACK_DEPTH;
    {class} property GL_DEBUG_LOGGED_MESSAGES: Integer read _GetGL_DEBUG_LOGGED_MESSAGES;
    {class} property GL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH: Integer read _GetGL_DEBUG_NEXT_LOGGED_MESSAGE_LENGTH;
    {class} property GL_DEBUG_OUTPUT: Integer read _GetGL_DEBUG_OUTPUT;
    {class} property GL_DEBUG_OUTPUT_SYNCHRONOUS: Integer read _GetGL_DEBUG_OUTPUT_SYNCHRONOUS;
    {class} property GL_DEBUG_SEVERITY_HIGH: Integer read _GetGL_DEBUG_SEVERITY_HIGH;
    {class} property GL_DEBUG_SEVERITY_LOW: Integer read _GetGL_DEBUG_SEVERITY_LOW;
    {class} property GL_DEBUG_SEVERITY_MEDIUM: Integer read _GetGL_DEBUG_SEVERITY_MEDIUM;
    {class} property GL_DEBUG_SEVERITY_NOTIFICATION: Integer read _GetGL_DEBUG_SEVERITY_NOTIFICATION;
    {class} property GL_DEBUG_SOURCE_API: Integer read _GetGL_DEBUG_SOURCE_API;
    {class} property GL_DEBUG_SOURCE_APPLICATION: Integer read _GetGL_DEBUG_SOURCE_APPLICATION;
    {class} property GL_DEBUG_SOURCE_OTHER: Integer read _GetGL_DEBUG_SOURCE_OTHER;
    {class} property GL_DEBUG_SOURCE_SHADER_COMPILER: Integer read _GetGL_DEBUG_SOURCE_SHADER_COMPILER;
    {class} property GL_DEBUG_SOURCE_THIRD_PARTY: Integer read _GetGL_DEBUG_SOURCE_THIRD_PARTY;
    {class} property GL_DEBUG_SOURCE_WINDOW_SYSTEM: Integer read _GetGL_DEBUG_SOURCE_WINDOW_SYSTEM;
    {class} property GL_DEBUG_TYPE_DEPRECATED_BEHAVIOR: Integer read _GetGL_DEBUG_TYPE_DEPRECATED_BEHAVIOR;
    {class} property GL_DEBUG_TYPE_ERROR: Integer read _GetGL_DEBUG_TYPE_ERROR;
    {class} property GL_DEBUG_TYPE_MARKER: Integer read _GetGL_DEBUG_TYPE_MARKER;
    {class} property GL_DEBUG_TYPE_OTHER: Integer read _GetGL_DEBUG_TYPE_OTHER;
    {class} property GL_DEBUG_TYPE_PERFORMANCE: Integer read _GetGL_DEBUG_TYPE_PERFORMANCE;
    {class} property GL_DEBUG_TYPE_POP_GROUP: Integer read _GetGL_DEBUG_TYPE_POP_GROUP;
    {class} property GL_DEBUG_TYPE_PORTABILITY: Integer read _GetGL_DEBUG_TYPE_PORTABILITY;
    {class} property GL_DEBUG_TYPE_PUSH_GROUP: Integer read _GetGL_DEBUG_TYPE_PUSH_GROUP;
    {class} property GL_DEBUG_TYPE_UNDEFINED_BEHAVIOR: Integer read _GetGL_DEBUG_TYPE_UNDEFINED_BEHAVIOR;
    {class} property GL_DIFFERENCE: Integer read _GetGL_DIFFERENCE;
    {class} property GL_EXCLUSION: Integer read _GetGL_EXCLUSION;
    {class} property GL_FIRST_VERTEX_CONVENTION: Integer read _GetGL_FIRST_VERTEX_CONVENTION;
    {class} property GL_FRACTIONAL_EVEN: Integer read _GetGL_FRACTIONAL_EVEN;
    {class} property GL_FRACTIONAL_ODD: Integer read _GetGL_FRACTIONAL_ODD;
    {class} property GL_FRAGMENT_INTERPOLATION_OFFSET_BITS: Integer read _GetGL_FRAGMENT_INTERPOLATION_OFFSET_BITS;
    {class} property GL_FRAMEBUFFER_ATTACHMENT_LAYERED: Integer read _GetGL_FRAMEBUFFER_ATTACHMENT_LAYERED;
    {class} property GL_FRAMEBUFFER_DEFAULT_LAYERS: Integer read _GetGL_FRAMEBUFFER_DEFAULT_LAYERS;
    {class} property GL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS: Integer read _GetGL_FRAMEBUFFER_INCOMPLETE_LAYER_TARGETS;
    {class} property GL_GEOMETRY_INPUT_TYPE: Integer read _GetGL_GEOMETRY_INPUT_TYPE;
    {class} property GL_GEOMETRY_OUTPUT_TYPE: Integer read _GetGL_GEOMETRY_OUTPUT_TYPE;
    {class} property GL_GEOMETRY_SHADER: Integer read _GetGL_GEOMETRY_SHADER;
    {class} property GL_GEOMETRY_SHADER_BIT: Integer read _GetGL_GEOMETRY_SHADER_BIT;
    {class} property GL_GEOMETRY_SHADER_INVOCATIONS: Integer read _GetGL_GEOMETRY_SHADER_INVOCATIONS;
    {class} property GL_GEOMETRY_VERTICES_OUT: Integer read _GetGL_GEOMETRY_VERTICES_OUT;
    {class} property GL_GUILTY_CONTEXT_RESET: Integer read _GetGL_GUILTY_CONTEXT_RESET;
    {class} property GL_HARDLIGHT: Integer read _GetGL_HARDLIGHT;
    {class} property GL_HSL_COLOR: Integer read _GetGL_HSL_COLOR;
    {class} property GL_HSL_HUE: Integer read _GetGL_HSL_HUE;
    {class} property GL_HSL_LUMINOSITY: Integer read _GetGL_HSL_LUMINOSITY;
    {class} property GL_HSL_SATURATION: Integer read _GetGL_HSL_SATURATION;
    {class} property GL_IMAGE_BUFFER: Integer read _GetGL_IMAGE_BUFFER;
    {class} property GL_IMAGE_CUBE_MAP_ARRAY: Integer read _GetGL_IMAGE_CUBE_MAP_ARRAY;
    {class} property GL_INNOCENT_CONTEXT_RESET: Integer read _GetGL_INNOCENT_CONTEXT_RESET;
    {class} property GL_INT_IMAGE_BUFFER: Integer read _GetGL_INT_IMAGE_BUFFER;
    {class} property GL_INT_IMAGE_CUBE_MAP_ARRAY: Integer read _GetGL_INT_IMAGE_CUBE_MAP_ARRAY;
    {class} property GL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY: Integer read _GetGL_INT_SAMPLER_2D_MULTISAMPLE_ARRAY;
    {class} property GL_INT_SAMPLER_BUFFER: Integer read _GetGL_INT_SAMPLER_BUFFER;
    {class} property GL_INT_SAMPLER_CUBE_MAP_ARRAY: Integer read _GetGL_INT_SAMPLER_CUBE_MAP_ARRAY;
    {class} property GL_ISOLINES: Integer read _GetGL_ISOLINES;
    {class} property GL_IS_PER_PATCH: Integer read _GetGL_IS_PER_PATCH;
    {class} property GL_LAST_VERTEX_CONVENTION: Integer read _GetGL_LAST_VERTEX_CONVENTION;
    {class} property GL_LAYER_PROVOKING_VERTEX: Integer read _GetGL_LAYER_PROVOKING_VERTEX;
    {class} property GL_LIGHTEN: Integer read _GetGL_LIGHTEN;
    {class} property GL_LINES_ADJACENCY: Integer read _GetGL_LINES_ADJACENCY;
    {class} property GL_LINE_STRIP_ADJACENCY: Integer read _GetGL_LINE_STRIP_ADJACENCY;
    {class} property GL_LOSE_CONTEXT_ON_RESET: Integer read _GetGL_LOSE_CONTEXT_ON_RESET;
    {class} property GL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS: Integer read _GetGL_MAX_COMBINED_GEOMETRY_UNIFORM_COMPONENTS;
    {class} property GL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS: Integer read _GetGL_MAX_COMBINED_TESS_CONTROL_UNIFORM_COMPONENTS;
    {class} property GL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS: Integer read _GetGL_MAX_COMBINED_TESS_EVALUATION_UNIFORM_COMPONENTS;
    {class} property GL_MAX_DEBUG_GROUP_STACK_DEPTH: Integer read _GetGL_MAX_DEBUG_GROUP_STACK_DEPTH;
    {class} property GL_MAX_DEBUG_LOGGED_MESSAGES: Integer read _GetGL_MAX_DEBUG_LOGGED_MESSAGES;
    {class} property GL_MAX_DEBUG_MESSAGE_LENGTH: Integer read _GetGL_MAX_DEBUG_MESSAGE_LENGTH;
    {class} property GL_MAX_FRAGMENT_INTERPOLATION_OFFSET: Integer read _GetGL_MAX_FRAGMENT_INTERPOLATION_OFFSET;
    {class} property GL_MAX_FRAMEBUFFER_LAYERS: Integer read _GetGL_MAX_FRAMEBUFFER_LAYERS;
    {class} property GL_MAX_GEOMETRY_ATOMIC_COUNTERS: Integer read _GetGL_MAX_GEOMETRY_ATOMIC_COUNTERS;
    {class} property GL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS: Integer read _GetGL_MAX_GEOMETRY_ATOMIC_COUNTER_BUFFERS;
    {class} property GL_MAX_GEOMETRY_IMAGE_UNIFORMS: Integer read _GetGL_MAX_GEOMETRY_IMAGE_UNIFORMS;
    {class} property GL_MAX_GEOMETRY_INPUT_COMPONENTS: Integer read _GetGL_MAX_GEOMETRY_INPUT_COMPONENTS;
    {class} property GL_MAX_GEOMETRY_OUTPUT_COMPONENTS: Integer read _GetGL_MAX_GEOMETRY_OUTPUT_COMPONENTS;
    {class} property GL_MAX_GEOMETRY_OUTPUT_VERTICES: Integer read _GetGL_MAX_GEOMETRY_OUTPUT_VERTICES;
    {class} property GL_MAX_GEOMETRY_SHADER_INVOCATIONS: Integer read _GetGL_MAX_GEOMETRY_SHADER_INVOCATIONS;
    {class} property GL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS: Integer read _GetGL_MAX_GEOMETRY_SHADER_STORAGE_BLOCKS;
    {class} property GL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS: Integer read _GetGL_MAX_GEOMETRY_TEXTURE_IMAGE_UNITS;
    {class} property GL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS: Integer read _GetGL_MAX_GEOMETRY_TOTAL_OUTPUT_COMPONENTS;
    {class} property GL_MAX_GEOMETRY_UNIFORM_BLOCKS: Integer read _GetGL_MAX_GEOMETRY_UNIFORM_BLOCKS;
    {class} property GL_MAX_GEOMETRY_UNIFORM_COMPONENTS: Integer read _GetGL_MAX_GEOMETRY_UNIFORM_COMPONENTS;
    {class} property GL_MAX_LABEL_LENGTH: Integer read _GetGL_MAX_LABEL_LENGTH;
    {class} property GL_MAX_PATCH_VERTICES: Integer read _GetGL_MAX_PATCH_VERTICES;
    {class} property GL_MAX_TESS_CONTROL_ATOMIC_COUNTERS: Integer read _GetGL_MAX_TESS_CONTROL_ATOMIC_COUNTERS;
    {class} property GL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS: Integer read _GetGL_MAX_TESS_CONTROL_ATOMIC_COUNTER_BUFFERS;
    {class} property GL_MAX_TESS_CONTROL_IMAGE_UNIFORMS: Integer read _GetGL_MAX_TESS_CONTROL_IMAGE_UNIFORMS;
    {class} property GL_MAX_TESS_CONTROL_INPUT_COMPONENTS: Integer read _GetGL_MAX_TESS_CONTROL_INPUT_COMPONENTS;
    {class} property GL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS: Integer read _GetGL_MAX_TESS_CONTROL_OUTPUT_COMPONENTS;
    {class} property GL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS: Integer read _GetGL_MAX_TESS_CONTROL_SHADER_STORAGE_BLOCKS;
    {class} property GL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS: Integer read _GetGL_MAX_TESS_CONTROL_TEXTURE_IMAGE_UNITS;
    {class} property GL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS: Integer read _GetGL_MAX_TESS_CONTROL_TOTAL_OUTPUT_COMPONENTS;
    {class} property GL_MAX_TESS_CONTROL_UNIFORM_BLOCKS: Integer read _GetGL_MAX_TESS_CONTROL_UNIFORM_BLOCKS;
    {class} property GL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS: Integer read _GetGL_MAX_TESS_CONTROL_UNIFORM_COMPONENTS;
    {class} property GL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS: Integer read _GetGL_MAX_TESS_EVALUATION_ATOMIC_COUNTERS;
    {class} property GL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS: Integer read _GetGL_MAX_TESS_EVALUATION_ATOMIC_COUNTER_BUFFERS;
    {class} property GL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS: Integer read _GetGL_MAX_TESS_EVALUATION_IMAGE_UNIFORMS;
    {class} property GL_MAX_TESS_EVALUATION_INPUT_COMPONENTS: Integer read _GetGL_MAX_TESS_EVALUATION_INPUT_COMPONENTS;
    {class} property GL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS: Integer read _GetGL_MAX_TESS_EVALUATION_OUTPUT_COMPONENTS;
    {class} property GL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS: Integer read _GetGL_MAX_TESS_EVALUATION_SHADER_STORAGE_BLOCKS;
    {class} property GL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS: Integer read _GetGL_MAX_TESS_EVALUATION_TEXTURE_IMAGE_UNITS;
    {class} property GL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS: Integer read _GetGL_MAX_TESS_EVALUATION_UNIFORM_BLOCKS;
    {class} property GL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS: Integer read _GetGL_MAX_TESS_EVALUATION_UNIFORM_COMPONENTS;
    {class} property GL_MAX_TESS_GEN_LEVEL: Integer read _GetGL_MAX_TESS_GEN_LEVEL;
    {class} property GL_MAX_TESS_PATCH_COMPONENTS: Integer read _GetGL_MAX_TESS_PATCH_COMPONENTS;
    {class} property GL_MAX_TEXTURE_BUFFER_SIZE: Integer read _GetGL_MAX_TEXTURE_BUFFER_SIZE;
    {class} property GL_MIN_FRAGMENT_INTERPOLATION_OFFSET: Integer read _GetGL_MIN_FRAGMENT_INTERPOLATION_OFFSET;
    {class} property GL_MIN_SAMPLE_SHADING_VALUE: Integer read _GetGL_MIN_SAMPLE_SHADING_VALUE;
    {class} property GL_MULTIPLY: Integer read _GetGL_MULTIPLY;
    {class} property GL_MULTISAMPLE_LINE_WIDTH_GRANULARITY: Integer read _GetGL_MULTISAMPLE_LINE_WIDTH_GRANULARITY;
    {class} property GL_MULTISAMPLE_LINE_WIDTH_RANGE: Integer read _GetGL_MULTISAMPLE_LINE_WIDTH_RANGE;
    {class} property GL_NO_RESET_NOTIFICATION: Integer read _GetGL_NO_RESET_NOTIFICATION;
    {class} property GL_OVERLAY: Integer read _GetGL_OVERLAY;
    {class} property GL_PATCHES: Integer read _GetGL_PATCHES;
    {class} property GL_PATCH_VERTICES: Integer read _GetGL_PATCH_VERTICES;
    {class} property GL_PRIMITIVES_GENERATED: Integer read _GetGL_PRIMITIVES_GENERATED;
    {class} property GL_PRIMITIVE_BOUNDING_BOX: Integer read _GetGL_PRIMITIVE_BOUNDING_BOX;
    {class} property GL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED: Integer read _GetGL_PRIMITIVE_RESTART_FOR_PATCHES_SUPPORTED;
    {class} property GL_PROGRAM: Integer read _GetGL_PROGRAM;
    {class} property GL_PROGRAM_PIPELINE: Integer read _GetGL_PROGRAM_PIPELINE;
    {class} property GL_QUADS: Integer read _GetGL_QUADS;
    {class} property GL_QUERY: Integer read _GetGL_QUERY;
    {class} property GL_REFERENCED_BY_GEOMETRY_SHADER: Integer read _GetGL_REFERENCED_BY_GEOMETRY_SHADER;
    {class} property GL_REFERENCED_BY_TESS_CONTROL_SHADER: Integer read _GetGL_REFERENCED_BY_TESS_CONTROL_SHADER;
    {class} property GL_REFERENCED_BY_TESS_EVALUATION_SHADER: Integer read _GetGL_REFERENCED_BY_TESS_EVALUATION_SHADER;
    {class} property GL_RESET_NOTIFICATION_STRATEGY: Integer read _GetGL_RESET_NOTIFICATION_STRATEGY;
    {class} property GL_SAMPLER: Integer read _GetGL_SAMPLER;
    {class} property GL_SAMPLER_2D_MULTISAMPLE_ARRAY: Integer read _GetGL_SAMPLER_2D_MULTISAMPLE_ARRAY;
    {class} property GL_SAMPLER_BUFFER: Integer read _GetGL_SAMPLER_BUFFER;
    {class} property GL_SAMPLER_CUBE_MAP_ARRAY: Integer read _GetGL_SAMPLER_CUBE_MAP_ARRAY;
    {class} property GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW: Integer read _GetGL_SAMPLER_CUBE_MAP_ARRAY_SHADOW;
    {class} property GL_SAMPLE_SHADING: Integer read _GetGL_SAMPLE_SHADING;
    {class} property GL_SCREEN: Integer read _GetGL_SCREEN;
    {class} property GL_SHADER: Integer read _GetGL_SHADER;
    {class} property GL_SOFTLIGHT: Integer read _GetGL_SOFTLIGHT;
    {class} property GL_STACK_OVERFLOW: Integer read _GetGL_STACK_OVERFLOW;
    {class} property GL_STACK_UNDERFLOW: Integer read _GetGL_STACK_UNDERFLOW;
    {class} property GL_TESS_CONTROL_OUTPUT_VERTICES: Integer read _GetGL_TESS_CONTROL_OUTPUT_VERTICES;
    {class} property GL_TESS_CONTROL_SHADER: Integer read _GetGL_TESS_CONTROL_SHADER;
    {class} property GL_TESS_CONTROL_SHADER_BIT: Integer read _GetGL_TESS_CONTROL_SHADER_BIT;
    {class} property GL_TESS_EVALUATION_SHADER: Integer read _GetGL_TESS_EVALUATION_SHADER;
    {class} property GL_TESS_EVALUATION_SHADER_BIT: Integer read _GetGL_TESS_EVALUATION_SHADER_BIT;
    {class} property GL_TESS_GEN_MODE: Integer read _GetGL_TESS_GEN_MODE;
    {class} property GL_TESS_GEN_POINT_MODE: Integer read _GetGL_TESS_GEN_POINT_MODE;
    {class} property GL_TESS_GEN_SPACING: Integer read _GetGL_TESS_GEN_SPACING;
    {class} property GL_TESS_GEN_VERTEX_ORDER: Integer read _GetGL_TESS_GEN_VERTEX_ORDER;
    {class} property GL_TEXTURE_2D_MULTISAMPLE_ARRAY: Integer read _GetGL_TEXTURE_2D_MULTISAMPLE_ARRAY;
    {class} property GL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY: Integer read _GetGL_TEXTURE_BINDING_2D_MULTISAMPLE_ARRAY;
    {class} property GL_TEXTURE_BINDING_BUFFER: Integer read _GetGL_TEXTURE_BINDING_BUFFER;
    {class} property GL_TEXTURE_BINDING_CUBE_MAP_ARRAY: Integer read _GetGL_TEXTURE_BINDING_CUBE_MAP_ARRAY;
    {class} property GL_TEXTURE_BORDER_COLOR: Integer read _GetGL_TEXTURE_BORDER_COLOR;
    {class} property GL_TEXTURE_BUFFER: Integer read _GetGL_TEXTURE_BUFFER;
    {class} property GL_TEXTURE_BUFFER_BINDING: Integer read _GetGL_TEXTURE_BUFFER_BINDING;
    {class} property GL_TEXTURE_BUFFER_DATA_STORE_BINDING: Integer read _GetGL_TEXTURE_BUFFER_DATA_STORE_BINDING;
    {class} property GL_TEXTURE_BUFFER_OFFSET: Integer read _GetGL_TEXTURE_BUFFER_OFFSET;
    {class} property GL_TEXTURE_BUFFER_OFFSET_ALIGNMENT: Integer read _GetGL_TEXTURE_BUFFER_OFFSET_ALIGNMENT;
    {class} property GL_TEXTURE_BUFFER_SIZE: Integer read _GetGL_TEXTURE_BUFFER_SIZE;
    {class} property GL_TEXTURE_CUBE_MAP_ARRAY: Integer read _GetGL_TEXTURE_CUBE_MAP_ARRAY;
    {class} property GL_TRIANGLES_ADJACENCY: Integer read _GetGL_TRIANGLES_ADJACENCY;
    {class} property GL_TRIANGLE_STRIP_ADJACENCY: Integer read _GetGL_TRIANGLE_STRIP_ADJACENCY;
    {class} property GL_UNDEFINED_VERTEX: Integer read _GetGL_UNDEFINED_VERTEX;
    {class} property GL_UNKNOWN_CONTEXT_RESET: Integer read _GetGL_UNKNOWN_CONTEXT_RESET;
    {class} property GL_UNSIGNED_INT_IMAGE_BUFFER: Integer read _GetGL_UNSIGNED_INT_IMAGE_BUFFER;
    {class} property GL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY: Integer read _GetGL_UNSIGNED_INT_IMAGE_CUBE_MAP_ARRAY;
    {class} property GL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY: Integer read _GetGL_UNSIGNED_INT_SAMPLER_2D_MULTISAMPLE_ARRAY;
    {class} property GL_UNSIGNED_INT_SAMPLER_BUFFER: Integer read _GetGL_UNSIGNED_INT_SAMPLER_BUFFER;
    {class} property GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY: Integer read _GetGL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY;
    {class} property GL_VERTEX_ARRAY: Integer read _GetGL_VERTEX_ARRAY;
  end;

  [JavaSignature('android/opengl/GLES32')]
  JGLES32 = interface(JGLES31)
    ['{70302388-B672-4207-9E51-D665FF0EE4AC}']
  end;
  TJGLES32 = class(TJavaGenericImport<JGLES32Class, JGLES32>) end;

  JGLES32_DebugProcClass = interface(IJavaClass)
    ['{3C18DB55-0FBE-4D04-AF8E-E7AA9EF267CE}']
  end;

  [JavaSignature('android/opengl/GLES32$DebugProc')]
  JGLES32_DebugProc = interface(IJavaInstance)
    ['{88B37159-E2F0-48BD-AB4D-4747F75FD63A}']
    procedure onMessage(source: Integer; type_: Integer; id: Integer; severity: Integer; message: JString); cdecl;
  end;
  TJGLES32_DebugProc = class(TJavaGenericImport<JGLES32_DebugProcClass, JGLES32_DebugProc>) end;
  ...
  JGLSurfaceView = interface(JSurfaceView)
    ...
    procedure surfaceRedrawNeeded(holder: JSurfaceHolder); cdecl;//Deprecated
    procedure surfaceRedrawNeededAsync(holder: JSurfaceHolder; finishDrawing: JRunnable); cdecl;
  end;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.OpenGL.JGLES32', TypeInfo(Androidapi.JNI.OpenGL.JGLES32));
  TRegTypes.RegisterType('Androidapi.JNI.OpenGL.JGLES32_DebugProc', TypeInfo(Androidapi.JNI.OpenGL.JGLES32_DebugProc));
