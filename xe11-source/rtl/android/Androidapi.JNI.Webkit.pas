...
// ===== Forward declarations =====
  ...
  JRenderProcessGoneDetail = interface;//android.webkit.RenderProcessGoneDetail
  JServiceWorkerClient = interface;//android.webkit.ServiceWorkerClient
  JServiceWorkerController = interface;//android.webkit.ServiceWorkerController
  JServiceWorkerWebSettings = interface;//android.webkit.ServiceWorkerWebSettings
...
// ===== Interface declarations =====
  ...
  JRenderProcessGoneDetailClass = interface(JObjectClass)
    ['{AD82E7AF-70FB-419E-9A3C-49E0E0D76303}']
    {class} function init: JRenderProcessGoneDetail; cdecl;
  end;

  [JavaSignature('android/webkit/RenderProcessGoneDetail')]
  JRenderProcessGoneDetail = interface(JObject)
    ['{7E085013-B1F9-432D-976D-E028A4941AA0}']
    function didCrash: Boolean; cdecl;
    function rendererPriorityAtExit: Integer; cdecl;
  end;
  TJRenderProcessGoneDetail = class(TJavaGenericImport<JRenderProcessGoneDetailClass, JRenderProcessGoneDetail>) end;

  JServiceWorkerClientClass = interface(JObjectClass)
    ['{3CD102BA-6EE3-4495-A3B4-BF779AD47B44}']
    {class} function init: JServiceWorkerClient; cdecl;
  end;

  [JavaSignature('android/webkit/ServiceWorkerClient')]
  JServiceWorkerClient = interface(JObject)
    ['{7D0D0BCD-CDAC-4D10-B5F3-B8F689611753}']
    function shouldInterceptRequest(request: JWebResourceRequest): JWebResourceResponse; cdecl;
  end;
  TJServiceWorkerClient = class(TJavaGenericImport<JServiceWorkerClientClass, JServiceWorkerClient>) end;

  JServiceWorkerControllerClass = interface(JObjectClass)
    ['{4CA0F16A-85E7-4211-9861-4D8B7CF4CD88}']
    {class} function init: JServiceWorkerController; cdecl;
    {class} function getInstance: JServiceWorkerController; cdecl;
  end;

  [JavaSignature('android/webkit/ServiceWorkerController')]
  JServiceWorkerController = interface(JObject)
    ['{E462448D-9665-481D-8E58-B8EB3A4C0B8D}']
    function getServiceWorkerWebSettings: JServiceWorkerWebSettings; cdecl;
    procedure setServiceWorkerClient(client: JServiceWorkerClient); cdecl;
  end;
  TJServiceWorkerController = class(TJavaGenericImport<JServiceWorkerControllerClass, JServiceWorkerController>) end;

  JServiceWorkerWebSettingsClass = interface(JObjectClass)
    ['{175D6281-AE76-4F25-9C91-8913A9570B39}']
    {class} function init: JServiceWorkerWebSettings; cdecl;
  end;

  [JavaSignature('android/webkit/ServiceWorkerWebSettings')]
  JServiceWorkerWebSettings = interface(JObject)
    ['{87A253E0-8EBE-4F48-88C1-B72620311EFB}']
  ...
  TJServiceWorkerWebSettings = class(TJavaGenericImport<JServiceWorkerWebSettingsClass, JServiceWorkerWebSettings>) end;
  ...
  JWebSettingsClass = interface(JObjectClass)
    ...
    {class} function _GetMENU_ITEM_NONE: Integer; cdecl;
    {class} function _GetMENU_ITEM_PROCESS_TEXT: Integer; cdecl;
    {class} function _GetMENU_ITEM_SHARE: Integer; cdecl;
    {class} function _GetMENU_ITEM_WEB_SEARCH: Integer; cdecl;
    ...
    {class} property MENU_ITEM_NONE: Integer read _GetMENU_ITEM_NONE;
    {class} property MENU_ITEM_PROCESS_TEXT: Integer read _GetMENU_ITEM_PROCESS_TEXT;
    {class} property MENU_ITEM_SHARE: Integer read _GetMENU_ITEM_SHARE;
    {class} property MENU_ITEM_WEB_SEARCH: Integer read _GetMENU_ITEM_WEB_SEARCH;
  ...
  JWebSettings = interface(JObject)
    ...
    function getSaveFormData: Boolean; cdecl;//Deprecated
    ...
    procedure setDisabledActionModeMenuItems(menuItems: Integer); cdecl;
    ...
    procedure setGeolocationDatabasePath(databasePath: JString); cdecl;//Deprecated
    ...
    procedure setSafeBrowsingEnabled(enabled: Boolean); cdecl;
    procedure setSansSerifFontFamily(font: JString); cdecl;
    procedure setSaveFormData(save: Boolean); cdecl;//Deprecated
  ...
  JWebViewClass = interface(JAbsoluteLayoutClass)
    ...
    {class} property RENDERER_PRIORITY_BOUND: Integer read _GetRENDERER_PRIORITY_BOUND;
    {class} property RENDERER_PRIORITY_IMPORTANT: Integer read _GetRENDERER_PRIORITY_IMPORTANT;
    {class} property RENDERER_PRIORITY_WAIVED: Integer read _GetRENDERER_PRIORITY_WAIVED;
  ...
  JWebView = interface(JAbsoluteLayout)
    ...
    procedure autofill(values: JSparseArray); cdecl;
    ...
    function getHttpAuthUsernamePassword(host: JString; realm: JString): TJavaObjectArray<JString>; cdecl;//Deprecated
    function getOriginalUrl: JString; cdecl;
    function getProgress: Integer; cdecl;
    function getRendererPriorityWaivedWhenNotVisible: Boolean; cdecl;
    function getRendererRequestedPriority: Integer; cdecl;
    ...
    procedure onProvideAutofillVirtualStructure(structure: JViewStructure; flags: Integer); cdecl;
    ...
    procedure setHttpAuthUsernamePassword(host: JString; realm: JString; username: JString; password: JString); cdecl;//Deprecated
    ...
    procedure setRendererPriorityPolicy(rendererRequestedPriority: Integer; waivedWhenNotVisible: Boolean); cdecl;
  ...
  JWebViewClientClass = interface(JObjectClass)
    ...
    {class} function _GetERROR_UNSAFE_RESOURCE: Integer; cdecl;
    ...
    {class} property ERROR_UNSAFE_RESOURCE: Integer read _GetERROR_UNSAFE_RESOURCE;
  ...
  JWebViewClient = interface(JObject)
    ...
    function onRenderProcessGone(view: JWebView; detail: JRenderProcessGoneDetail): Boolean; cdecl;
    ...
    function shouldOverrideUrlLoading(view: JWebView; url: JString): Boolean; cdecl; overload;//Deprecated
    function shouldOverrideUrlLoading(view: JWebView; request: JWebResourceRequest): Boolean; cdecl; overload;
  end;
  ...
  JWebViewDatabase = interface(JObject)
    ...
    procedure clearFormData; cdecl;//Deprecated
    ...
    function hasFormData: Boolean; cdecl;//Deprecated
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Webkit.JRenderProcessGoneDetail', TypeInfo(Androidapi.JNI.Webkit.JRenderProcessGoneDetail));
  TRegTypes.RegisterType('Androidapi.JNI.Webkit.JServiceWorkerClient', TypeInfo(Androidapi.JNI.Webkit.JServiceWorkerClient));
  TRegTypes.RegisterType('Androidapi.JNI.Webkit.JServiceWorkerController', TypeInfo(Androidapi.JNI.Webkit.JServiceWorkerController));
  TRegTypes.RegisterType('Androidapi.JNI.Webkit.JServiceWorkerWebSettings', TypeInfo(Androidapi.JNI.Webkit.JServiceWorkerWebSettings));
