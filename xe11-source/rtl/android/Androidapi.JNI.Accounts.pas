...
// ===== Interface declarations =====
  ...
  JAccountManagerClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_ACCOUNT_REMOVED: JString; cdecl;
    ...
    {class} function _GetKEY_ACCOUNT_SESSION_BUNDLE: JString; cdecl;
    {class} function _GetKEY_ACCOUNT_STATUS_TOKEN: JString; cdecl;
    ...
    {class} function _GetPACKAGE_NAME_KEY_LEGACY_NOT_VISIBLE: JString; cdecl;
    {class} function _GetPACKAGE_NAME_KEY_LEGACY_VISIBLE: JString; cdecl;
    {class} function _GetVISIBILITY_NOT_VISIBLE: Integer; cdecl;
    {class} function _GetVISIBILITY_UNDEFINED: Integer; cdecl;
    {class} function _GetVISIBILITY_USER_MANAGED_NOT_VISIBLE: Integer; cdecl;
    {class} function _GetVISIBILITY_USER_MANAGED_VISIBLE: Integer; cdecl;
    ...
    {class} property ACTION_ACCOUNT_REMOVED: JString read _GetACTION_ACCOUNT_REMOVED;
    ...
    {class} property KEY_ACCOUNT_SESSION_BUNDLE: JString read _GetKEY_ACCOUNT_SESSION_BUNDLE;
    {class} property KEY_ACCOUNT_STATUS_TOKEN: JString read _GetKEY_ACCOUNT_STATUS_TOKEN;
    ...
    {class} property PACKAGE_NAME_KEY_LEGACY_NOT_VISIBLE: JString read _GetPACKAGE_NAME_KEY_LEGACY_NOT_VISIBLE;
    {class} property PACKAGE_NAME_KEY_LEGACY_VISIBLE: JString read _GetPACKAGE_NAME_KEY_LEGACY_VISIBLE;
    {class} property VISIBILITY_NOT_VISIBLE: Integer read _GetVISIBILITY_NOT_VISIBLE;
    {class} property VISIBILITY_UNDEFINED: Integer read _GetVISIBILITY_UNDEFINED;
    {class} property VISIBILITY_USER_MANAGED_NOT_VISIBLE: Integer read _GetVISIBILITY_USER_MANAGED_NOT_VISIBLE;
    {class} property VISIBILITY_USER_MANAGED_VISIBLE: Integer read _GetVISIBILITY_USER_MANAGED_VISIBLE;
  ...
  JAccountManager = interface(JObject)
    ...
    function addAccountExplicitly(account: JAccount; password: JString; userdata: JBundle): Boolean; cdecl; overload;
    function addAccountExplicitly(account: JAccount; password: JString; extras: JBundle; visibility: JMap): Boolean; cdecl; overload;
    procedure addOnAccountsUpdatedListener(listener: JOnAccountsUpdateListener; handler: JHandler; updateImmediately: Boolean); cdecl; overload;
    procedure addOnAccountsUpdatedListener(listener: JOnAccountsUpdateListener; handler: JHandler; updateImmediately: Boolean; accountTypes: TJavaObjectArray<JString>); cdecl; overload;
    ...
    function finishSession(sessionBundle: JBundle; activity: JActivity; callback: JAccountManagerCallback; handler: JHandler): JAccountManagerFuture; cdecl;
    function getAccountVisibility(account: JAccount; packageName: JString): Integer; cdecl;
    function getAccounts: TJavaObjectArray<JAccount>; cdecl;
    function getAccountsAndVisibilityForPackage(packageName: JString; accountType: JString): JMap; cdecl;
    ...
    function getPackagesAndVisibilityForAccount(account: JAccount): JMap; cdecl;
    ...
    function isCredentialsUpdateSuggested(account: JAccount; statusToken: JString; callback: JAccountManagerCallback; handler: JHandler): JAccountManagerFuture; cdecl;
    ...
    function setAccountVisibility(account: JAccount; packageName: JString; visibility: Integer): Boolean; cdecl;
    ...
    function startAddAccountSession(accountType: JString; authTokenType: JString; requiredFeatures: TJavaObjectArray<JString>; options: JBundle; activity: JActivity; callback: JAccountManagerCallback; handler: JHandler): JAccountManagerFuture; cdecl;
    function startUpdateCredentialsSession(account: JAccount; authTokenType: JString; options: JBundle; activity: JActivity; callback: JAccountManagerCallback; handler: JHandler): JAccountManagerFuture; cdecl;
