...
// ===== Interface declarations =====
  ...
  JWifiManager = interface(JObject)
    ...
    function enableNetwork(netId: Integer; attemptConnect: Boolean): Boolean; cdecl;
    function getConfiguredNetworks: JList; cdecl;
    function getConnectionInfo: JWifiInfo; cdecl;
    function getDhcpInfo: JDhcpInfo; cdecl;
    function getPasspointConfigurations: JList; cdecl;
    ...
    procedure removePasspointConfiguration(fqdn: JString); cdecl;
  ...
  JDiscoverySession = interface(JObject)
    ...
    procedure close; cdecl;
    function createNetworkSpecifierOpen(peerHandle: JPeerHandle): JNetworkSpecifier; cdecl;
    function createNetworkSpecifierPassphrase(peerHandle: JPeerHandle; passphrase: JString): JNetworkSpecifier; cdecl;
  ...
  JDiscoverySessionCallback = interface(JObject)
    ...
    procedure onServiceDiscovered(peerHandle: JPeerHandle; serviceSpecificInfo: TJavaArray<Byte>; matchFilter: JList); cdecl;
  ...
  JWifiAwareSession = interface(JObject)
    ...
    procedure close; cdecl;
    function createNetworkSpecifierOpen(role: Integer; peer: TJavaArray<Byte>): JNetworkSpecifier; cdecl;
    function createNetworkSpecifierPassphrase(role: Integer; peer: TJavaArray<Byte>; passphrase: JString): JNetworkSpecifier; cdecl;
