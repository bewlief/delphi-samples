...
// ===== Forward declarations =====
  ...
  JCompoundButton = interface;//android.widget.CompoundButton
  JCompoundButton_OnCheckedChangeListener = interface;//android.widget.CompoundButton$OnCheckedChangeListener
  ...
  JSwitch = interface;//android.widget.Switch
...
// ===== Interface declarations =====
  ...
  JAdapterView = interface(JViewGroup)
    ...
    procedure onProvideAutofillStructure(structure: JViewStructure; flags: Integer); cdecl;
    ...
    procedure setFocusable(focusable: Integer); cdecl;
  ...
  JAbsListView = interface(JAdapterView)
    ...
    function onResolvePointerIcon(event: JMotionEvent; pointerIndex: Integer): JPointerIcon; cdecl;
    ...
    function showContextMenu: Boolean; cdecl; overload;
    function showContextMenu(x: Single; y: Single): Boolean; cdecl; overload;
    function showContextMenuForChild(originalView: JView): Boolean; cdecl; overload;
    function showContextMenuForChild(originalView: JView; x: Single; y: Single): Boolean; cdecl; overload;
  ...
  JTextViewClass = interface(JViewClass)
    ...
    {class} function _GetAUTO_SIZE_TEXT_TYPE_NONE: Integer; cdecl;
    {class} function _GetAUTO_SIZE_TEXT_TYPE_UNIFORM: Integer; cdecl;
    ...
    {class} property AUTO_SIZE_TEXT_TYPE_NONE: Integer read _GetAUTO_SIZE_TEXT_TYPE_NONE;
    {class} property AUTO_SIZE_TEXT_TYPE_UNIFORM: Integer read _GetAUTO_SIZE_TEXT_TYPE_UNIFORM;
  end;

  [JavaSignature('android/widget/TextView')]
  JTextView = interface(JView)
    ['{45436351-10E4-41C0-ADB2-099CB38BA534}']
    procedure addExtraDataToAccessibilityNodeInfo(info: JAccessibilityNodeInfo; extraDataKey: JString; arguments: JBundle); cdecl;
    ...
    procedure autofill(value: JAutofillValue); cdecl;
    ...
    function getAutoSizeMaxTextSize: Integer; cdecl;
    function getAutoSizeMinTextSize: Integer; cdecl;
    function getAutoSizeStepGranularity: Integer; cdecl;
    function getAutoSizeTextAvailableSizes: TJavaArray<Integer>; cdecl;
    function getAutoSizeTextType: Integer; cdecl;
    function getAutofillType: Integer; cdecl;
    function getAutofillValue: JAutofillValue; cdecl;
    ...
    function getFontVariationSettings: JString; cdecl;
    ...
    function getImeHintLocales: JLocaleList; cdecl;
    ...
    function getJustificationMode: Integer; cdecl;
    ...
    function getTextClassifier: JTextClassifier; cdecl;
    function getTextColors: JColorStateList; cdecl; overload;
    function getTextLocale: JLocale; cdecl;
    function getTextLocales: JLocaleList; cdecl;
    ...
    procedure setAutoSizeTextTypeUniformWithConfiguration(autoSizeMinTextSize: Integer; autoSizeMaxTextSize: Integer; autoSizeStepGranularity: Integer; unit_: Integer); cdecl;
    procedure setAutoSizeTextTypeUniformWithPresetSizes(presetSizes: TJavaArray<Integer>; unit_: Integer); cdecl;
    procedure setAutoSizeTextTypeWithDefaults(autoSizeTextType: Integer); cdecl;
    ...
    function setFontVariationSettings(fontVariationSettings: JString): Boolean; cdecl;
    ...
    procedure setImeHintLocales(hintLocales: JLocaleList); cdecl;
    ...
    procedure setJustificationMode(justificationMode: Integer); cdecl;
    ...
    procedure setMaxHeight(maxPixels: Integer); cdecl;
    ...
    procedure setMinHeight(minPixels: Integer); cdecl;
    ...
    procedure setTextClassifier(textClassifier: JTextClassifier); cdecl;
    ...
    procedure setTextLocales(locales: JLocaleList); cdecl;
  ...
  JCalendarView = interface(JFrameLayout)
    ...
    function getShowWeekNumber: Boolean; cdecl;//Deprecated
    ...
    procedure setShowWeekNumber(showWeekNumber: Boolean); cdecl;//Deprecated
  ...
  JCompoundButtonClass = interface(JButtonClass)
    ['{A00ADD78-B9E3-4FE6-8480-89B52EEA6942}']
    {class} function init(context: JContext): JCompoundButton; cdecl; overload;
    {class} function init(context: JContext; attrs: JAttributeSet): JCompoundButton; cdecl; overload;
    {class} function init(context: JContext; attrs: JAttributeSet; defStyleAttr: Integer): JCompoundButton; cdecl; overload;
    {class} function init(context: JContext; attrs: JAttributeSet; defStyleAttr: Integer; defStyleRes: Integer): JCompoundButton; cdecl; overload;
  end;

  [JavaSignature('android/widget/CompoundButton')]
  JCompoundButton = interface(JButton)
    ['{365F9429-E6D3-4BE4-B7A5-F5B27AB3861F}']
    procedure drawableHotspotChanged(x: Single; y: Single); cdecl;
    function getAccessibilityClassName: JCharSequence; cdecl;
    function getButtonDrawable: JDrawable; cdecl;
    function getButtonTintList: JColorStateList; cdecl;
    function getButtonTintMode: JPorterDuff_Mode; cdecl;
    function getCompoundPaddingLeft: Integer; cdecl;
    function getCompoundPaddingRight: Integer; cdecl;
    ...
    procedure setButtonDrawable(drawable: JDrawable); cdecl; overload;
    procedure setButtonTintList(tint: JColorStateList); cdecl;
    procedure setButtonTintMode(tintMode: JPorterDuff_Mode); cdecl;
  ...
  TJCompoundButton = class(TJavaGenericImport<JCompoundButtonClass, JCompoundButton>) end;

  JCompoundButton_OnCheckedChangeListenerClass = interface(IJavaClass)
    ['{06626864-A73D-44E0-B6FA-FFD166116BC0}']
  end;
  ...
  TJCompoundButton_OnCheckedChangeListener = class(TJavaGenericImport<JCompoundButton_OnCheckedChangeListenerClass, JCompoundButton_OnCheckedChangeListener>) end;
  ...
  JDatePicker = interface(JFrameLayout)
    ...
    procedure autofill(value: JAutofillValue); cdecl;
    procedure dispatchProvideAutofillStructure(structure: JViewStructure; flags: Integer); cdecl;
    function getAccessibilityClassName: JCharSequence; cdecl;
    function getAutofillType: Integer; cdecl;
    function getAutofillValue: JAutofillValue; cdecl;
    function getCalendarView: JCalendarView; cdecl;//Deprecated
    function getCalendarViewShown: Boolean; cdecl;//Deprecated
    function getDayOfMonth: Integer; cdecl;
    function getFirstDayOfWeek: Integer; cdecl;
    function getMaxDate: Int64; cdecl;
    function getMinDate: Int64; cdecl;
    function getMonth: Integer; cdecl;
    function getSpinnersShown: Boolean; cdecl;//Deprecated
    ...
    procedure setCalendarViewShown(shown: Boolean); cdecl;//Deprecated
    procedure setEnabled(enabled: Boolean); cdecl;
    procedure setFirstDayOfWeek(firstDayOfWeek: Integer); cdecl;
    procedure setMaxDate(maxDate: Int64); cdecl;
    procedure setMinDate(minDate: Int64); cdecl;
    procedure setOnDateChangedListener(onDateChangedListener: JDatePicker_OnDateChangedListener); cdecl;
    procedure setSpinnersShown(shown: Boolean); cdecl;//Deprecated
  ...
  JFrameLayout_LayoutParamsClass = interface(JViewGroup_MarginLayoutParamsClass)
    ...
    {class} function _GetUNSPECIFIED_GRAVITY: Integer; cdecl;
    ...
    {class} property UNSPECIFIED_GRAVITY: Integer read _GetUNSPECIFIED_GRAVITY;
  end;
  ...
  JPopupWindow = interface(JObject)
    ...
    function getMaxAvailableHeight(anchor: JView; yOffset: Integer; ignoreBottomDecorations: Boolean): Integer; cdecl; overload;
  ...
  JRelativeLayout_LayoutParams = interface(JViewGroup_MarginLayoutParams)
    ...
    procedure addRule(verb: Integer; subject: Integer); cdecl; overload;
    function debug(output: JString): JString; cdecl;
  ...
  JRemoteViews = interface(JObject)
    ...
    procedure setChronometerCountDown(viewId: Integer; isCountDown: Boolean); cdecl;
  ...
  JSwitchClass = interface(JCompoundButtonClass)
    ['{C0D46D4E-5384-466B-94CC-0E3D668331F8}']
    {class} function init(context: JContext): JSwitch; cdecl; overload;
    {class} function init(context: JContext; attrs: JAttributeSet): JSwitch; cdecl; overload;
    {class} function init(context: JContext; attrs: JAttributeSet; defStyleAttr: Integer): JSwitch; cdecl; overload;
    {class} function init(context: JContext; attrs: JAttributeSet; defStyleAttr: Integer; defStyleRes: Integer): JSwitch; cdecl; overload;
  end;

  [JavaSignature('android/widget/Switch')]
  JSwitch = interface(JCompoundButton)
    ['{0BF56A5E-7BE7-42C3-BA4E-4A22C96F42C6}']
    procedure draw(c: JCanvas); cdecl;
    procedure drawableHotspotChanged(x: Single; y: Single); cdecl;
    function getAccessibilityClassName: JCharSequence; cdecl;
    function getCompoundPaddingLeft: Integer; cdecl;
    function getCompoundPaddingRight: Integer; cdecl;
    function getShowText: Boolean; cdecl;
    function getSplitTrack: Boolean; cdecl;
    function getSwitchMinWidth: Integer; cdecl;
    function getSwitchPadding: Integer; cdecl;
    function getTextOff: JCharSequence; cdecl;
    function getTextOn: JCharSequence; cdecl;
    function getThumbDrawable: JDrawable; cdecl;
    function getThumbTextPadding: Integer; cdecl;
    function getThumbTintList: JColorStateList; cdecl;
    function getThumbTintMode: JPorterDuff_Mode; cdecl;
    function getTrackDrawable: JDrawable; cdecl;
    function getTrackTintList: JColorStateList; cdecl;
    function getTrackTintMode: JPorterDuff_Mode; cdecl;
    procedure jumpDrawablesToCurrentState; cdecl;
    procedure onMeasure(widthMeasureSpec: Integer; heightMeasureSpec: Integer); cdecl;
    procedure onProvideStructure(structure: JViewStructure); cdecl;
    function onTouchEvent(ev: JMotionEvent): Boolean; cdecl;
    procedure setChecked(checked: Boolean); cdecl;
    procedure setShowText(showText: Boolean); cdecl;
    procedure setSplitTrack(splitTrack: Boolean); cdecl;
    procedure setSwitchMinWidth(pixels: Integer); cdecl;
    procedure setSwitchPadding(pixels: Integer); cdecl;
    procedure setSwitchTextAppearance(context: JContext; resid: Integer); cdecl;
    procedure setSwitchTypeface(tf: JTypeface; style: Integer); cdecl; overload;
    procedure setSwitchTypeface(tf: JTypeface); cdecl; overload;
    procedure setTextOff(textOff: JCharSequence); cdecl;
    procedure setTextOn(textOn: JCharSequence); cdecl;
    procedure setThumbDrawable(thumb: JDrawable); cdecl;
    procedure setThumbResource(resId: Integer); cdecl;
    procedure setThumbTextPadding(pixels: Integer); cdecl;
    procedure setThumbTintList(tint: JColorStateList); cdecl;
    procedure setThumbTintMode(tintMode: JPorterDuff_Mode); cdecl;
    procedure setTrackDrawable(track: JDrawable); cdecl;
    procedure setTrackResource(resId: Integer); cdecl;
    procedure setTrackTintList(tint: JColorStateList); cdecl;
    procedure setTrackTintMode(tintMode: JPorterDuff_Mode); cdecl;
    procedure toggle; cdecl;
  end;
  TJSwitch = class(TJavaGenericImport<JSwitchClass, JSwitch>) end;
  ...
  JTimePicker = interface(JFrameLayout)
    ...
    function validateInput: Boolean; cdecl;
  end;
  ...
  JToolbar = interface(JViewGroup)
    ...
    function getContentInsetEndWithActions: Integer; cdecl;
    ...
    function getContentInsetStartWithNavigation: Integer; cdecl;
    function getCurrentContentInsetEnd: Integer; cdecl;
    function getCurrentContentInsetLeft: Integer; cdecl;
    function getCurrentContentInsetRight: Integer; cdecl;
    function getCurrentContentInsetStart: Integer; cdecl;
    ...
    function getTitleMarginBottom: Integer; cdecl;
    function getTitleMarginEnd: Integer; cdecl;
    function getTitleMarginStart: Integer; cdecl;
    function getTitleMarginTop: Integer; cdecl;
    ...
    procedure onRtlPropertiesChanged(layoutDirection: Integer); cdecl;
    function onTouchEvent(ev: JMotionEvent): Boolean; cdecl;
    procedure setContentInsetEndWithActions(insetEndWithActions: Integer); cdecl;
    procedure setContentInsetStartWithNavigation(insetStartWithNavigation: Integer); cdecl;
    ...
    procedure setTitleMargin(start: Integer; top: Integer; end_: Integer; bottom: Integer); cdecl;
    procedure setTitleMarginBottom(margin: Integer); cdecl;
    procedure setTitleMarginEnd(margin: Integer); cdecl;
    procedure setTitleMarginStart(margin: Integer); cdecl;
    procedure setTitleMarginTop(margin: Integer); cdecl;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Widget.JCompoundButton', TypeInfo(Androidapi.JNI.Widget.JCompoundButton));
  TRegTypes.RegisterType('Androidapi.JNI.Widget.JCompoundButton_OnCheckedChangeListener', TypeInfo(Androidapi.JNI.Widget.JCompoundButton_OnCheckedChangeListener));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Widget.JSwitch', TypeInfo(Androidapi.JNI.Widget.JSwitch));
