...
// ===== Forward declarations =====
  ...
  JProtocolFamily = interface;//java.net.ProtocolFamily
  ...
  JSocketOption = interface;//java.net.SocketOption
...
// ===== Interface declarations =====
  ...
  Jnet_ContentHandler = interface(JObject)
    ...
    function getContent(urlc: JURLConnection): JObject; cdecl; overload;
    function getContent(urlc: JURLConnection; classes: TJavaObjectArray<Jlang_Class>): JObject; cdecl; overload;
  end;
  ...
  JContentHandlerFactory = interface(IJavaInstance)
    ...
    function createContentHandler(mimetype: JString): Jnet_ContentHandler; cdecl;
  end;
  ...
  JDatagramPacketClass = interface(JObjectClass)
    ...
    {class} function init(buf: TJavaArray<Byte>; offset: Integer; length: Integer): JDatagramPacket; cdecl; overload;
    {class} function init(buf: TJavaArray<Byte>; length: Integer): JDatagramPacket; cdecl; overload;
    {class} function init(buf: TJavaArray<Byte>; offset: Integer; length: Integer; address: JInetAddress; port: Integer): JDatagramPacket; cdecl; overload;
    {class} function init(buf: TJavaArray<Byte>; offset: Integer; length: Integer; address: JSocketAddress): JDatagramPacket; cdecl; overload;
    {class} function init(buf: TJavaArray<Byte>; length: Integer; address: JInetAddress; port: Integer): JDatagramPacket; cdecl; overload;
    {class} function init(buf: TJavaArray<Byte>; length: Integer; address: JSocketAddress): JDatagramPacket; cdecl; overload;
  end;
  ...
  JDatagramPacket = interface(JObject)
    ...
    procedure setAddress(iaddr: JInetAddress); cdecl;
    procedure setData(buf: TJavaArray<Byte>; offset: Integer; length: Integer); cdecl; overload;
    procedure setData(buf: TJavaArray<Byte>); cdecl; overload;
    procedure setLength(length: Integer); cdecl;
    procedure setPort(iport: Integer); cdecl;
    procedure setSocketAddress(address: JSocketAddress); cdecl;
  end;
  ...
  JDatagramSocketClass = interface(JObjectClass)
    ...
    {class} function init(bindaddr: JSocketAddress): JDatagramSocket; cdecl; overload;
    {class} function init(port: Integer): JDatagramSocket; cdecl; overload;
    {class} function init(port: Integer; laddr: JInetAddress): JDatagramSocket; cdecl; overload;
  ...
  JDatagramSocket = interface(JObject)
    ...
    procedure bind(addr: JSocketAddress); cdecl;
    procedure close; cdecl;
    procedure connect(address: JInetAddress; port: Integer); cdecl; overload;
    procedure connect(addr: JSocketAddress); cdecl; overload;
    ...
    procedure receive(p: JDatagramPacket); cdecl;
    procedure send(p: JDatagramPacket); cdecl;
    procedure setBroadcast(on: Boolean); cdecl;
    procedure setReceiveBufferSize(size: Integer); cdecl;
    procedure setReuseAddress(on: Boolean); cdecl;
    procedure setSendBufferSize(size: Integer); cdecl;
    procedure setSoTimeout(timeout: Integer); cdecl;
    procedure setTrafficClass(tc: Integer); cdecl;
  end;
  ...
  JURLConnectionClass = interface(JObjectClass)
    ...
    {class} function getDefaultRequestProperty(key: JString): JString; cdecl;//Deprecated
    {class} function getFileNameMap: JFileNameMap; cdecl;
    {class} function guessContentTypeFromName(fname: JString): JString; cdecl;
    {class} function guessContentTypeFromStream(is_: JInputStream): JString; cdecl;
    {class} procedure setContentHandlerFactory(fac: JContentHandlerFactory); cdecl;
    {class} procedure setDefaultAllowUserInteraction(defaultallowuserinteraction: Boolean); cdecl;
    {class} procedure setDefaultRequestProperty(key: JString; value: JString); cdecl;//Deprecated
  ...
  JURLConnection = interface(JObject)
    ...
    procedure addRequestProperty(key: JString; value: JString); cdecl;
    ...
    function getContent(classes: TJavaObjectArray<Jlang_Class>): JObject; cdecl; overload;
    function getContentEncoding: JString; cdecl;
    function getContentLength: Integer; cdecl;
    function getContentLengthLong: Int64; cdecl;
    ...
    function getHeaderFieldDate(name: JString; Default: Int64): Int64; cdecl;
    function getHeaderFieldInt(name: JString; Default: Integer): Integer; cdecl;
    function getHeaderFieldKey(n: Integer): JString; cdecl;
    function getHeaderFieldLong(name: JString; Default: Int64): Int64; cdecl;
    ...
    function getRequestProperty(key: JString): JString; cdecl;
    function getURL: JURL; cdecl;
    function getUseCaches: Boolean; cdecl;
    procedure setAllowUserInteraction(allowuserinteraction: Boolean); cdecl;
    procedure setConnectTimeout(timeout: Integer); cdecl;
    procedure setDefaultUseCaches(defaultusecaches: Boolean); cdecl;
    procedure setDoInput(doinput: Boolean); cdecl;
    procedure setDoOutput(dooutput: Boolean); cdecl;
    procedure setIfModifiedSince(ifmodifiedsince: Int64); cdecl;
    procedure setReadTimeout(timeout: Integer); cdecl;
    procedure setRequestProperty(key: JString; value: JString); cdecl;
    procedure setUseCaches(usecaches: Boolean); cdecl;
  ...
  JHttpURLConnectionClass = interface(JURLConnectionClass)
    ...
    {class} procedure setFollowRedirects(set_: Boolean); cdecl;
  ...
  JHttpURLConnection = interface(JURLConnection)
    ...
    function getHeaderField(n: Integer): JString; cdecl;
    function getHeaderFieldDate(name: JString; Default: Int64): Int64; cdecl;
    function getHeaderFieldKey(n: Integer): JString; cdecl;
    ...
    procedure setChunkedStreamingMode(chunklen: Integer); cdecl;
  ...
  JInetAddressClass = interface(JObjectClass)
    ...
    {class} function getByAddress(host: JString; addr: TJavaArray<Byte>): JInetAddress; cdecl; overload;
    {class} function getByAddress(addr: TJavaArray<Byte>): JInetAddress; cdecl; overload;
  ...
  JInetAddress = interface(JObject)
    ...
    function isReachable(netif: JNetworkInterface; ttl: Integer; timeout: Integer): Boolean; cdecl; overload;
  ...
  JInetSocketAddressClass = interface(JSocketAddressClass)
    ...
    {class} function init(addr: JInetAddress; port: Integer): JInetSocketAddress; cdecl; overload;
    {class} function init(hostname: JString; port: Integer): JInetSocketAddress; cdecl; overload;
  ...
  JNetworkInterfaceClass = interface(JObjectClass)
    ...
    {class} function getByInetAddress(addr: JInetAddress): JNetworkInterface; cdecl;
    {class} function getByName(name: JString): JNetworkInterface; cdecl;
  ...
  JProtocolFamilyClass = interface(IJavaClass)
    ['{61151ABC-4E86-426D-AD5A-7DFC5A53E4F1}']
  end;

  [JavaSignature('java/net/ProtocolFamily')]
  JProtocolFamily = interface(IJavaInstance)
    ['{72D117D9-5582-4BE3-9037-2C5E6ED99D16}']
    function name: JString; cdecl;
  end;
  TJProtocolFamily = class(TJavaGenericImport<JProtocolFamilyClass, JProtocolFamily>) end;
  ...
  JResponseCache = interface(JObject)
    ...
    function &get(uri: JURI; rqstMethod: JString; rqstHeaders: JMap): JCacheResponse; cdecl;
    function put(uri: JURI; conn: JURLConnection): JCacheRequest; cdecl;
  end;
  ...
  JServerSocketClass = interface(JObjectClass)
    ...
    {class} function init(port: Integer; backlog: Integer; bindAddr: JInetAddress): JServerSocket; cdecl; overload;
    {class} procedure setSocketFactory(fac: JSocketImplFactory); cdecl;
  end;
  ...
  JServerSocket = interface(JObject)
    ...
    procedure bind(endpoint: JSocketAddress); cdecl; overload;
    procedure bind(endpoint: JSocketAddress; backlog: Integer); cdecl; overload;
    procedure close; cdecl;
  ...
  JSocketClass = interface(JObjectClass)
    ...
    {class} function init(host: JString; port: Integer): JSocket; cdecl; overload;
    {class} function init(address: JInetAddress; port: Integer): JSocket; cdecl; overload;
    {class} function init(host: JString; port: Integer; localAddr: JInetAddress; localPort: Integer): JSocket; cdecl; overload;
    {class} function init(address: JInetAddress; port: Integer; localAddr: JInetAddress; localPort: Integer): JSocket; cdecl; overload;
    {class} function init(host: JString; port: Integer; stream: Boolean): JSocket; cdecl; overload;//Deprecated
    {class} function init(host: JInetAddress; port: Integer; stream: Boolean): JSocket; cdecl; overload;//Deprecated
  ...
  JSocket = interface(JObject)
    ...
    procedure bind(bindpoint: JSocketAddress); cdecl;
    procedure close; cdecl;
    procedure connect(endpoint: JSocketAddress); cdecl; overload;
    procedure connect(endpoint: JSocketAddress; timeout: Integer); cdecl; overload;
    ...
    procedure sendUrgentData(data: Integer); cdecl;
    procedure setKeepAlive(on: Boolean); cdecl;
    procedure setOOBInline(on: Boolean); cdecl;
    procedure setPerformancePreferences(connectionTime: Integer; latency: Integer; bandwidth: Integer); cdecl;
    procedure setReceiveBufferSize(size: Integer); cdecl;
    procedure setReuseAddress(on: Boolean); cdecl;
    procedure setSendBufferSize(size: Integer); cdecl;
    procedure setSoLinger(on: Boolean; linger: Integer); cdecl;
    procedure setSoTimeout(timeout: Integer); cdecl;
  ...
  JSocketOptionClass = interface(IJavaClass)
    ['{D35E9729-9405-4625-ADDD-FEDA4FA0466C}']
  end;

  [JavaSignature('java/net/SocketOption')]
  JSocketOption = interface(IJavaInstance)
    ['{AF34E663-DA85-4DDA-902C-AD6EF5DAE75D}']
    function name: JString; cdecl;
    function &type: Jlang_Class; cdecl;
  end;
  TJSocketOption = class(TJavaGenericImport<JSocketOptionClass, JSocketOption>) end;

  JURIClass = interface(JObjectClass)
    ['{248E7A13-8C00-4246-B62A-26973AF67439}']
    {class} function init(str: JString): JURI; cdecl; overload;
    ...
    {class} function init(scheme: JString; ssp: JString; fragment: JString): JURI; cdecl; overload;
    {class} function create(str: JString): JURI; cdecl;
  end;

  [JavaSignature('java/net/URI')]
  JURI = interface(JObject)
    ['{621C74EA-9C1E-4279-9DFF-253F28359DB1}']
    function compareTo(that: JURI): Integer; cdecl;
    ...
    function relativize(uri: JURI): JURI; cdecl;
    function resolve(uri: JURI): JURI; cdecl; overload;
    function resolve(str: JString): JURI; cdecl; overload;
  ...
  JURLClass = interface(JObjectClass)
    ...
    {class} procedure setURLStreamHandlerFactory(fac: JURLStreamHandlerFactory); cdecl;
  end;
  ...
  JURL = interface(JObject)
    ...
    function sameFile(other: JURL): Boolean; cdecl;
  ...
  JServerSocketFactory = interface(JObject)
    ...
    function createServerSocket(port: Integer; backlog: Integer; ifAddress: JInetAddress): JServerSocket; cdecl; overload;
  end;
  ...
  JSSLContextClass = interface(JObjectClass)
    ...
    {class} procedure setDefault(context: JSSLContext); cdecl;
  end;
  ...
  JSSLContext = interface(JObject)
    ...
    procedure init(km: TJavaObjectArray<JKeyManager>; tm: TJavaObjectArray<JTrustManager>; random: JSecureRandom); cdecl;
  end;
  ...
  JSSLEngine = interface(JObject)
    ...
    function getHandshakeSession: JSSLSession; cdecl;
    ...
    procedure setSSLParameters(params: JSSLParameters); cdecl;
  ...
  JSSLParameters = interface(JObject)
    ...
    function getAlgorithmConstraints: JAlgorithmConstraints; cdecl;
    function getCipherSuites: TJavaObjectArray<JString>; cdecl;
    function getEndpointIdentificationAlgorithm: JString; cdecl;
    function getNeedClientAuth: Boolean; cdecl;
    function getProtocols: TJavaObjectArray<JString>; cdecl;
    function getSNIMatchers: JCollection; cdecl;
    function getServerNames: JList; cdecl;
    function getUseCipherSuitesOrder: Boolean; cdecl;
    function getWantClientAuth: Boolean; cdecl;
    procedure setAlgorithmConstraints(constraints: JAlgorithmConstraints); cdecl;
    procedure setCipherSuites(cipherSuites: TJavaObjectArray<JString>); cdecl;
    procedure setEndpointIdentificationAlgorithm(algorithm: JString); cdecl;
    procedure setNeedClientAuth(needClientAuth: Boolean); cdecl;
    procedure setProtocols(protocols: TJavaObjectArray<JString>); cdecl;
    procedure setSNIMatchers(matchers: JCollection); cdecl;
    procedure setServerNames(serverNames: JList); cdecl;
    procedure setUseCipherSuitesOrder(honorOrder: Boolean); cdecl;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Java.Net.JProtocolFamily', TypeInfo(Androidapi.JNI.Java.Net.JProtocolFamily));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Java.Net.JSocketOption', TypeInfo(Androidapi.JNI.Java.Net.JSocketOption));
