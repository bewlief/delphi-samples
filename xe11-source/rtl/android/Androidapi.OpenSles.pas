...
(*$HPPEMIT '#include <SLES/OpenSLES_Platform.h>' *)
(*$HPPEMIT '#include <SLES/OpenSLES_AndroidConfiguration.h>' *)
...
type
  ...
  /// <summary>Interface ID defined as a UUID</summary>
...
type
  ...
  /// <summary>URI-based data locator definition where locatorType must be
  /// SL_DATALOCATOR_URI</summary>
  ...
  /// <summary>Address-based data locator definition where locatorType must be
  /// SL_DATALOCATOR_ADDRESS</summary>
...
type
  /// <summary>IODevice-based data locator definition where locatorType must be
  /// SL_DATALOCATOR_IODEVICE</summary>
  ...
  /// <summary>OutputMix-based data locator definition where locatorType must be
  /// SL_DATALOCATOR_OUTPUTMIX</summary>
  ...
  /// <summary>BufferQueue-based data locator definition where locatorType must
  /// be SL_DATALOCATOR_BUFFERQUEUE</summary>
  ...
  /// <summary>MidiBufferQueue-based data locator definition where locatorType
  /// must be SL_DATALOCATOR_MIDIBUFFERQUEUE</summary>
...
type
  /// <summary>MIME-type-based data format definition where formatType must be
  /// SL_DATAFORMAT_MIME</summary>
...
type
  /// <summary>PCM-type-based data format definition where formatType must be
  /// SL_DATAFORMAT_PCM</summary>
...
const
  ...
  SL_DEVLOCATION_RESLTE: SLuint16 = $0005 deprecated 'Use SL_DEVLOCATION_REMOTE';
...
const
  ...
  SL_RECORDEVENT_BUFFER_INSUFFICIENT: SLuint32 = $00000020 deprecated 'Use use SL_RECORDEVENT_BUFFER_FULL';
...
type
  ...
  SL3DLocationItf_ = record
    SetLocationCartesian: function(self: SL3DLocationItf; pLocation: PSLVec3D): SLresult;
