...
// ===== Interface declarations =====
  ...
  // com.google.android.vending.expansion.downloader.impl.AndroidHttpClient
  ...
  JDownloadThread = interface(JObject)
    ...
    function getPreferredHttpHost(context: JContext; url: JString): JObject; cdecl;
    procedure run; cdecl;
  end;
...
begin
  ...
  //TRegTypes.RegisterType('Androidapi.JNI.ApkExpansion.Jimpl_AndroidHttpClient', TypeInfo(Androidapi.JNI.ApkExpansion.Jimpl_AndroidHttpClient));
