...
// ===== Interface declarations =====
  ...
  JBaseDexClassLoaderClass = interface(JClassLoaderClass)
    ...
    {class} function init(dexPath: JString; optimizedDirectory: JFile; librarySearchPath: JString; parent: JClassLoader): JBaseDexClassLoader; cdecl;
  end;
  ...
  JDexClassLoaderClass = interface(JBaseDexClassLoaderClass)
    ...
    {class} function init(dexPath: JString; optimizedDirectory: JString; librarySearchPath: JString; parent: JClassLoader): JDexClassLoader; cdecl;
  end;
