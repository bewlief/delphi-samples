...
// ===== Interface declarations =====
  ...
  JSynthesisCallback = interface(IJavaInstance)
    ...
    procedure rangeStart(markerInFrames: Integer; start: Integer; end_: Integer); cdecl;
  ...
  JUtteranceProgressListener = interface(JObject)
    ...
    procedure onAudioAvailable(utteranceId: JString; audio: TJavaArray<Byte>); cdecl;
    procedure onBeginSynthesis(utteranceId: JString; sampleRateInHz: Integer; audioFormat: Integer; channelCount: Integer); cdecl;
    ...
    procedure onRangeStart(utteranceId: JString; start: Integer; end_: Integer; frame: Integer); cdecl;
    procedure onStart(utteranceId: JString); cdecl;
    procedure onStop(utteranceId: JString; interrupted: Boolean); cdecl;
    procedure onUtteranceRangeStart(utteranceId: JString; start: Integer; end_: Integer); cdecl;//Deprecated
  end;
