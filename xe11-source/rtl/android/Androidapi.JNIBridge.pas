...
{$M-}
  ...
  private
    ...
    class function GetProxyInterfaceNameFromContext(AContext: JNIObject): string; static;
  protected
    function GetObjectID: Pointer;
  public
    constructor Create;
  ...
  TVTableCache = class
  strict private
    class var VTables: TObjectDictionary<PTypeInfo, TJavaVTable>;
  ...
  protected
    ...
    class function GetVTable(P: PTypeInfo; ClsID: Pointer; IsClassTable: Boolean): TJavaVTable;
    class procedure DeleteVTable(P: PTypeInfo; const J: TJavaVTable);
  end;
  ...
  private
    ...
    class function GetBasicTypeMethodID(const ClassSig, ClassGetMethod, ClassGetMethodSig: string): JNIMethodID; static;
    class function InternalGetJavaClassID(const AClass: string): JNIClass; static;
    class procedure AddReturnValue(Obj: Pointer; const AValue: TValue); overload; static;
  ...
  public
    ...
    class function GetJavaMethodID(AClass: JNIClass; const AMethod, AMethodSig: string; IsClassTable: Boolean = True): JNIMethodID; static;
    class function GetJavaStaticMethodID(AClass: JNIClass; const AMethod, AMethodSig: string): JNIMethodID; static; inline;
    class function GetJavaStaticFieldID(AClass: JNIClass; const AField, AFieldSig: string): JNIFieldID; static; inline;
    class function GetJavaFieldID(AClass: JNIClass; const AField, AFieldSig: string): JNIFieldID; static; inline;
    ...
    class function GetObjectRefType(AObject: JNIObject): JNIObjectRefType; static; inline;
    class function NewObject(AClass: JNIClass): JNIObject; static; inline;
    class function NewGlobalRef(AJNIObject: JNIObject): JNIObject; static; inline;
    class function GetObjectArrayElement(AArray: JNIObjectArray; Index: JNISize): JNIObject; static; inline;
    class procedure SetObjectArrayElement(AArray: JNIObjectArray; Index: JNISize; const Val); static;
    class procedure SetRawObjectArrayElement(AArray: JNIObjectArray; Index: JNISize; const Val); static; inline;
    class function GetRawValueFromJInteger(AJInteger: JNIObject): Integer; static; inline;
    class function GetRawValueFromJBoolean(AJBoolean: JNIObject): Boolean; static; inline;
    class function GetRawValueFromJCharacter(AJCharacter: JNIObject): Char; static; inline;
    class function GetRawValueFromJLong(AJLong: JNIObject): Int64; static; inline;
    class function GetRawValueFromJShort(AJShort: JNIObject): SmallInt; static; inline;
    class function GetRawValueFromJByte(AJByte: JNIObject): ShortInt; static; inline;
    class function GetRawValueFromJDouble(AJDouble: JNIObject): Double; static; inline;
    class function GetRawValueFromJFloat(AJFloat: JNIObject): Single; static; inline;
    ...
    class function JavaInstanceToID(const AJavaInstance: IJavaInstance): Pointer; static; inline;
    /// <summary>Tests whether Java object is a instance of specified java class.</summary>
    class function IsInstanceOf(const AJavaInstance: IJavaInstance; const AClass: JNIClass): Boolean; static; inline;
    /// <summary>Tests whether two references refer to the same Java object</summary>
    class function IsSameObject(const AObject1, AObject2: IJavaInstance): Boolean; static; inline;
    class constructor Create;
    class destructor Destroy;
  end;
  ...
  private
    Handle: JNIArray;
    procedure ProcessArray(CreateArray: Boolean; Len: Integer; AHandle: Pointer); virtual; abstract;
  ...
  type
    ...
    TJavaArrayElementsGetter = function(Env: PJNIEnv; AArray: JNIArray; IsCopy: PJNIBoolean): Pointer; cdecl;
  private
  ...
  public
    ...
    class function Wrap(const AnArray: TJavaBasicArray): TJavaArray<T>; static; inline;
  ...
  public
    ...
    class function Wrap(const AnArray: TJavaBasicArray): TJavaObjectArray<T>; static; inline;
  end;
...
function dispatchToNative(Env: PJNIEnv; This: JNIObject; Method: JNIString; Args: JNIObjectArray; DelphiObject: Int64): JNIObject; cdecl;
function dispatchToNative2(Env: PJNIEnv; This: JNIObject; MethodName: JNIString; MethodSig: JNIString; Args: JNIObjectArray; DelphiObject: Int64): JNIObject; cdecl;
procedure cleanNative(Env: PJNIEnv; This: JNIObject; DelphiObject: Int64); cdecl;
...
type
  ...
  private
    ...
    class destructor Destroy;
    //TJavaGenericImport
    class function GetInstanceVTable(var AVTable: TJavaVtable; ATypeInfo: PTypeInfo;ClsID: Pointer):TJavaVTable; static; inline;
    class procedure GetJavaClass(CTypeInfo, ITypeInfo: PTypeInfo; var AJavaClass: IJavaClass; var AClsID: Pointer; var AClassVTable: TJavaVTable); static;
    class procedure Wrap(P: Pointer; ITypeInfo: PTypeInfo; var JNIClassID: Pointer; var ATable: TJavaVTable; var Resp: IInterface);
    class procedure WrapInstance(const I: IJavaInstance; ITypeInfo: PTypeInfo; var JNIClassID: Pointer; var ATable: TJavaVTable; var Resp: IInterface);
    class procedure Alloc(var ClsID: Pointer; ITypeInfo: PTypeInfo; var AVTable: TJavaVtable; var Resp); static;
    class function GetClsID(var AClsID: Pointer; ATypeInfo: PTypeInfo): Pointer; static;

    //TJavaArray
    class procedure ProcessArray(LInfo: PTypeInfo; const Context: TRttiContext;var FArrayReleaser: Pointer;
      var FArrayGetter: Pointer; var FBaseType: TRttiType; var Handle: JNIArray; var FClassID: JNIClass;
      CreateArray: Boolean; Len: Integer; AHandle: Pointer); static;
  end;

procedure ReleaseAndNil(var Obj); Inline;
...
{$IFDEF ANDROID64}
procedure DispatchToImport; cdecl; external 'librtlhelper.a' name '_DispatchToImport';
{$ELSE !ANDROID64}
procedure DispatchToImport; cdecl; varargs; external 'librtlhelper.a' name 'DispatchToImport';
{$ENDIF ANDROID64}

function GetClassSignature(const ClassType: TRttiType; RaiseIfNotFound: Boolean = False): Pointer;
var
...
begin
  ...
  begin
    ...
    if RaiseIfNotFound and (Result = nil) then
      raise EJNIFatal.CreateResFmt(@SJNIClassNotFound, [Sig.Signature]);
  end
  else
    Result := nil;
end;

function FindMethod(const MethodName: string; const ClassType: TRttiType): TRttiMethod;
var
...
function GetParamFromJSource(const APar: TRttiType; AJParameter: JNIObject): TValue;
begin
    ...
    begin
      ...
      begin
        case APar.AsOrdinal.OrdType of
          otSByte, otUByte:
            Result := TValue.From<ShortInt>(TJNIResolver.GetRawValueFromJByte(AJParameter));
          otSWord, otUWord:
            Result := TValue.From<SmallInt>(TJNIResolver.GetRawValueFromJShort(AJParameter));
          otSLong, otULong:
...
function GetJReturnFromValue(const RetValue: TValue; Method: TRttiMethod; DelphiObject: Pointer): JNIObject;
var
  AClass: JNIClass;
  ConstructorID: JNIMethodID;
  LJNIEnvRes: PJNIEnv;

  function DoubleArgToJNIValues(Arg: Double): TJNIValueArray;
  begin
    SetLength(Result, 1);
    Result[0].d := Arg;
  end;
...
begin
  ...
  case RetValue.Kind of
    tkInteger:
    begin
      case RetValue.TypeData^.OrdType of
        otSByte, otUByte:
        begin
          AClass := TJNIResolver.InternalGetJavaClassID(JByteSig);
          if AClass = nil then
            raise EJNIFatal.CreateResFmt(@SJNIClassNotFound, [JByteSig]);

          ConstructorID := TJNIResolver.GetJavaMethodID(AClass, DefaultJConstructor, '(B)V');
          Result := LJNIEnvRes^.NewObjectA(LJNIEnvRes, AClass, ConstructorID, PJNIValue(ArgsToJNIValues(
            [RetValue.AsType<ShortInt>])));
        end;
        otSWord, otUWord:
        begin
          AClass := TJNIResolver.InternalGetJavaClassID(JShortSig);
          if AClass = nil then
            raise EJNIFatal.CreateResFmt(@SJNIClassNotFound, [JShortSig]);

          ConstructorID := TJNIResolver.GetJavaMethodID(AClass, DefaultJConstructor, '(S)V');
          Result := LJNIEnvRes^.NewObjectA(LJNIEnvRes, AClass, ConstructorID, PJNIValue(ArgsToJNIValues(
            [RetValue.AsType<SmallInt>])));
        end;
        otSLong, otULong:
        begin
          ...
          ConstructorID := TJNIResolver.GetJavaMethodID(AClass, DefaultJConstructor, '(I)V');
          Result := LJNIEnvRes^.NewObjectA(LJNIEnvRes, AClass, ConstructorID, PJNIValue(ArgsToJNIValues(
            [RetValue.AsInteger])));
        end;
        else
    ...
    tkInt64:
    begin
      AClass := TJNIResolver.InternalGetJavaClassID(JLongSig);
      if AClass = nil then
        raise EJNIFatal.CreateResFmt(@SJNIClassNotFound, [JLongSig]);

      ConstructorID := TJNIResolver.GetJavaMethodID(AClass, DefaultJConstructor, '(J)V');
      Result := LJNIEnvRes^.NewObjectA(LJNIEnvRes, AClass, ConstructorID, PJNIValue(ArgsToJNIValues(
        [RetValue.AsInt64])));
    end;
    ...
    tkFloat:
    begin
      case RetValue.TypeData^.FloatType of
        ftSingle:
        begin
          AClass := TJNIResolver.InternalGetJavaClassID(JFloatSig);
          if AClass = nil then
            raise EJNIFatal.CreateResFmt(@SJNIClassNotFound, [JFloatSig]);

          ConstructorID := TJNIResolver.GetJavaMethodID(AClass, DefaultJConstructor, '(F)V');
          Result := LJNIEnvRes^.NewObjectA(LJNIEnvRes, AClass, ConstructorID, PJNIValue(ArgsToJNIValues(
            [RetValue.AsType<Single>])));
        end;
        ftDouble:
        begin
          AClass := TJNIResolver.InternalGetJavaClassID(JDoubleSig);
          if AClass = nil then
            raise EJNIFatal.CreateResFmt(@SJNIClassNotFound, [JDoubleSig]);

          ConstructorID := TJNIResolver.GetJavaMethodID(AClass, DefaultJConstructor, '(D)V');
          Result := LJNIEnvRes^.NewObjectA(LJNIEnvRes, AClass, ConstructorID, PJNIValue(DoubleArgToJNIValues(
            RetValue.AsType<Double>)));
        end;
        else
          Result := nil;
      end;
    ...
    begin
      ...
      ConstructorID := TJNIResolver.GetJavaMethodID(AClass, DefaultJConstructor, '(Z)V');
      Result := LJNIEnvRes^.NewObjectA(LJNIEnvRes, AClass, ConstructorID, PJNIValue(ArgsToJNIValues(
        [RetValue.AsBoolean])));
    end;
...
procedure ReleaseJNIArrayArguments(const Args: TArray<TValue>);
var
  I: Integer;
  Arg: TValue;
begin
  ...
  begin
    Arg := Args[I];
    if (Arg.Kind = tkClass) and Arg.IsObject then
      Arg.AsObject.Free;
  end;
end;
    ...
    begin
      ...
      begin
        ...
        try
          ...
          ReleaseJNIArrayArguments(NewArgs);
        end;
        if LMethod.ReturnType <> nil then
           Result := GetJReturnFromValue(RetValue, LMethod, Pointer(DelphiObject));
      end
      else
...
function GetMethodSignature(const Method: TRttiMethod): string; forward;

function dispatchToNative2(Env: PJNIEnv; This: JNIObject; MethodName: JNIString; MethodSig: JNIString; Args: JNIObjectArray; DelphiObject: Int64): JNIObject; cdecl;
var
  LDelphiObject: TJavaLocal;
  AContext: TRttiContext;
  LJavaMethodName: string;
  LJavaMethodSig: string;
  AType: TRttiType;
  LDelphiMethod: TRttiMethod;
  NewArgs: TArray<TValue>;
  I: Integer;
  APar: TRttiParameter;
  Params: TArray<TRttiParameter>;
  ...
  procedure ThrowJavaException(const ExceptionMsg: string);
  var
    JavaClazz: JNIClass;
  begin
    JavaClazz := Env^.FindClass(Env, 'com/embarcadero/rtl/NativeDispatchException');

    Env^.ThrowNew(Env, JavaClazz, PUTF8Char(UTF8String(ExceptionMsg)));
    Env^.DeleteLocalRef(Env, JavaClazz);
  end;

  function FindDelphiMethod: TRttiMethod;
  var
    LType: TRttiType;
  ...
  begin
    ...
    while (LType <> nil) and TRttiInstanceType(LType).MetaclassType.InheritsFrom(TJavaLocal) do
    begin
      LMethods := LType.GetDeclaredMethods;

      for J := 0 to High(LMethods) do
      begin
        LMethod := LMethods[J];

        if LMethod.HasName(LJavaMethodName) then
        begin
          LMethodSig := GetMethodSignature(LMethod);

          if (LMethodSig = LJavaMethodSig) or (LMethod.HasName('equals') and (LMethodSig = '(?)Z') and (LJavaMethodSig = '(Ljava/lang/Object;)Z'))
                                           or (LMethod.HasName('toString') and (LMethodSig = '()?') and (LJavaMethodSig = '()Ljava/lang/String;')) then
            Exit(LMethod);
        end;
      end;
...
begin
  Result := nil;
  LDelphiObject := TJavaLocal(Pointer(DelphiObject));
  LJavaMethodName := JNIStringToString(Env, MethodName);
  LJavaMethodSig := JNIStringToString(Env, MethodSig);

  AContext := TRttiContext.Create;

  try
    AType := AContext.GetType(LDelphiObject.ClassInfo);

    if AType <> nil then
    begin
      try
        LDelphiMethod := FindDelphiMethod;
      except
        on E: EJNIFatal do
        begin
          ThrowJavaException(E.Message);
          Exit;
        end;
      end;

      if LDelphiMethod <> nil then
      begin
        Params := LDelphiMethod.GetParameters;
        SetLength(NewArgs, Length(Params));

        for I := 0 to Length(Params) - 1 do
        begin
          APar := Params[I];
          SourcePar := Env^.GetObjectArrayElement(Env, Args, I);
        ...
        try
          RetValue := LDelphiMethod.Invoke(LDelphiObject, NewArgs);
        finally
          ReleaseJNIArrayArguments(NewArgs);
        end;

        if LDelphiMethod.ReturnType <> nil then
          Result := GetJReturnFromValue(RetValue, LDelphiMethod, Pointer(DelphiObject));
      end
      else
        ThrowJavaException(string.Format(SJNIMethodNotFound, [LJavaMethodName + LJavaMethodSig]));
    end
    else
      ThrowJavaException(string.Format(SJNIRTTINotAvailable, [LJavaMethodName]));
  finally
    AContext.Free;
  end;
end;
...
begin
  ...
  DclLoadclassID := LJNIEnvRes^.GetMethodID(LJNIEnvRes, ContextClass, GetClassLoaderMethod, GetClassLoaderSig);
  if DclLoadClassID = nil then
    raise EJNIFatal.CreateResFmt(@SJNIMethodNotFound, [GetClassLoaderMethod]);
  Result := LJNIEnvRes^.CallObjectMethod(LJNIEnvRes,  AJavaContext, DclLoadclassID);
...
begin
  ...
  LoadClassID := LJNIEnvRes^.GetMethodID(LJNIEnvRes, clClass, ActClassLoader, ActClassLoaderSig);
...
begin
  ...
  FCharMethodID := GetBasicTypeMethodID(JCharSig, JCharGetMethod, JCharGetMethodSig);
  FBooleanMethodID := GetBasicTypeMethodID(JBooleanSig, JBooleanGetMethod, JBooleanGetMethodSig);
  FIntMethodID := GetBasicTypeMethodID(JIntegerSig, JIntegerGetMethod, JIntegerGetMethodSig);
  FIntMethodID := GetBasicTypeMethodID(JIntegerSig, JIntegerGetMethod, JIntegerGetMethodSig);
  FLongMethodID := GetBasicTypeMethodID(JLongSig, JLongGetMethod, JLongGetMethodSig);
  FShortMethodID := GetBasicTypeMethodID(JShortSig, JShortGetMethod, JShortGetMethodSig);
  FByteMethodID := GetBasicTypeMethodID(JByteSig, JByteGetMethod, JByteGetMethodSig);
  FFloatMethodID := GetBasicTypeMethodID(JFloatSig, JFloatGetMethod, JFloatGetMethodSig);
  FDoubleMethodID := GetBasicTypeMethodID(JDoubleSig, JDoubleGetMethod, JDoubleGetMethodSig);
end;
...
class function TJNIResolver.GetObjectRefType(AObject: JNIObject): JNIObjectRefType;
var
  LJNIEnvRes: PJNIEnv;
begin
  LJNIEnvRes :=  TJNIResolver.GetJNIEnv;
...
begin
  LJNIEnvRes :=  TJNIResolver.GetJNIEnv;
  Result := LJNIEnvRes^.CallBooleanMethod(LJNIEnvRes, AJBoolean, FBooleanMethodID).ToBoolean;
end;
...
class function TJNIResolver.InternalGetJavaClassID(const AClass: string): JNIClass;
var
  LocalRef: JNIObject;
begin
...
class function TJNIResolver.JavaInstanceToID(const AJavaInstance: IJavaInstance): Pointer;
var
  LocalObject: ILocalObject;
begin
...
begin
  LJNIEnvRes :=  TJNIResolver.GetJNIEnv;
  ConstructorID := LJNIEnvRes^.GetMethodID(LJNIEnvRes, AClass, DefaultJConstructor, DefaultJConstructorSig);  // default constructor name & signature
...
class function TJNIResolver.IsInstanceOf(const AJavaInstance: IJavaInstance; const AClass: JNIClass): Boolean;
var
  LJNIEnvRes: PJNIEnv;
  ID: JNIObject;
begin
...
class function TJNIResolver.IsSameObject(const AObject1, AObject2: IJavaInstance): Boolean;
var
  LJNIEnvRes: PJNIEnv;
  ID1, ID2: Pointer;
begin
...
class function TJNIResolver.GetBasicTypeMethodID(const ClassSig, ClassGetMethod, ClassGetMethodSig: string): JNIMethodID;
var
  AClass: JNIClass;
begin
  ...
  Result := TJNIResolver.GetJavaMethodID(AClass, ClassGetMethod, ClassGetMethodSig);
  if Result = nil then
...
class function TJNIResolver.GetJavaMethodID(AClass: JNIClass; const AMethod, AMethodSig: string; IsClassTable: Boolean): JNIMethodID;
var
...
begin
  ...
  Result := LJNIEnvRes^.GetMethodID(LJNIEnvRes, AClass, MarshaledAString(LUTF8StrMethod), MarshaledAString(LUTF8StrSig));
  if Result = nil then
    ExceptionCheck;
end;

class function TJNIResolver.GetJavaStaticMethodID(AClass: JNIClass; const AMethod, AMethodSig: string): JNIMethodID;
var
  LUTF8StrSig: UTF8String;
  LUTF8StrMethod: UTF8String;
  LJNIEnvRes: PJNIEnv;
begin
  ...
  LUTF8StrSig := UTF8String(AMethodSig);
  LUTF8StrMethod := UTF8String(AMethod);
  Result := LJNIEnvRes^.GetStaticMethodID(LJNIEnvRes, AClass, MarshaledAString(LUTF8StrMethod), MarshaledAString(LUTF8StrSig));
  if Result = nil then
    ExceptionCheck;
end;

class function TJNIResolver.GetJavaStaticFieldID(AClass: JNIClass; const AField, AFieldSig: string): JNIFieldID;
var
  LUTF8StrSig: UTF8String;
...
begin
  ...
  Result := LJNIEnvRes^.GetStaticFieldID(LJNIEnvRes, AClass, MarshaledAString(LUTF8StrField), MarshaledAString(LUTF8StrSig));
  if Result = nil then
    ExceptionCheck;
end;

class function TJNIResolver.GetJavaFieldID(AClass: JNIClass; const AField, AFieldSig: string): JNIFieldID;
var
  LUTF8StrSig: UTF8String;
  LUTF8StrField: UTF8String;
  LJNIEnvRes: PJNIEnv;
begin
  ...
  LUTF8StrSig := UTF8String(AFieldSig);
  LUTF8StrField := UTF8String(AField);
  Result := LJNIEnvRes^.GetFieldID(LJNIEnvRes, AClass, MarshaledAString(LUTF8StrField), MarshaledAString(LUTF8StrSig));
  if Result = nil then
   ExceptionCheck;
end;
...
{$IFDEF ANDROID64}
      tkFloat:
        begin
          // copy floating point value from FP registers to jvalue parameter of Call<type>MethodA
            Ops[Cnt].Size := 8;
            Ops[Cnt].Kind := moCopyFloat;
          Size := Size + Ops[Cnt].Size;
          Inc(Cnt);
        end;
{$ENDIF ANDROID64}
...
begin
  case AType.TypeKind of
    ...
    begin
      if TRttiInstanceType(AType).MetaclassType.InheritsFrom(TJavaBasicArray) then
        Result := MangleGenericType(AType)
      else
        raise EJNIFatal.CreateResFmt(@SJNIMangleErrorInvalidClassType, [AType.Name]);
    end;
    ...
    begin
      ...
      begin
        ...
        raise EJNIFatal.CreateResFmt(@SJNIMangleErrorInvalidInterfaceType, [AType.Name]);
    end;
    ...
    begin
      case TRttiFloatType(AType).FloatType of
        ...
        ftDouble: Result := 'D';
          ...
          raise EJNIFatal.CreateResFmt(@SJNIMangleErrorInvalidFloatingPointType, [AType.Name]);
      end;
    end;

    tkPointer:
      Result := '?'; // Used only for internal purposes.

    else
      raise EJNIFatal.CreateResFmt(@SJNIMangleErrorInvalidJavaType, [AType.Name]);
  end;
end;
...
begin
  ...
  if (Method.ReturnType <> nil) and (Method.Name <> DefaultJConstructorName) then
...
begin
  ...
  if IsClassTable and (Method.Name <> DefaultJConstructorName) then
    ...
    Result := TJNIResolver.GetJavaMethodID(ClsID, Method.Name, MethodSig, IsClassTable);
end;
...
function FindStaticFieldID(const Method: TRttiMethod; const PropType: TRttiType; var ClsID: Pointer): Pointer;
const
...
begin
  ...
  begin
    ...
    try
      AType := LContext.FindType(LParent.QualifiedName.SubString(0, LParent.QualifiedName.Length - ClassSufixLength));
      if AType <> nil then
      begin
...
function MethodIDForProperty(const Method: TRttiMethod; var ClsID: Pointer; IsClassTable: Boolean; var MethodKind: TMethodKind; var RetKind: TRetKind; var JavaType: PTypeInfo; var RetClsID: Pointer): Pointer;
var
  Params: TArray<TRttiParameter>;
  PropType: TRttiType;
begin
...
class procedure TBridgeHelper.GetJavaClass(CTypeInfo, ITypeInfo: PTypeInfo; var AJavaClass: IJavaClass; var AClsID: Pointer; var AClassVTable: TJavaVTable);
var
...
begin
  ...
  begin
    TMonitor.Enter(FGetClassLock);  // weird case when 2 threads try to access to the java class at the same time and the class is not initializated
    try
      if AJavaClass = nil then
        begin
        ...
        try
          ...
          begin
            ...
            if AClsID = nil then
              raise EJNI.CreateResFmt(@SJNIClassNotFound, [ITypeInfo^.NameFld.ToString]);
            AClassVTable := TVTableCache.GetVTable(CTypeInfo, AClsID, True);
            ClassImport := TJavaImport.Create(AClsID, AClassVTable);
            if ClassImport.QueryInterface(GetTypeData(CTypeInfo)^.Guid, AJavaClass) <> 0 then
              raise EJNI.CreateResFmt(@SInternalBindingError, [ITypeInfo^.NameFld.ToString]);
          end;
        finally
          Context.Free;
        end;
...
class destructor TJavaGenericImport<C,T>.Destroy;
begin
  TVTableCache.DeleteVTable(TypeInfo(T), FInstanceVTable);
  FInstanceVTable := nil;
  TVTableCache.DeleteVTable(TypeInfo(C), FClassVTable);
  FClassVTable := nil;
  inherited;
end;
...
begin
  TBridgeHelper.GetJavaClass(TypeInfo(C), TypeInfo(T), IJavaClass(FJavaClass), FJNIClassID, FClassVTable);
  Result := FJavaClass;
end;
...
class function TBridgeHelper.GetClsID(var AClsID: Pointer; ATypeInfo: PTypeInfo): Pointer;
var
  Context: TRttiContext;
  ClassType: TRttiType;
  Attrs: TArray<TCustomAttribute>;
...
begin
  ...
  begin
    Context := TRttiContext.Create;
    try
      ClassType := Context.GetType(ATypeInfo);
      ...
      begin
        ...
        AClsID := TJNIResolver.InternalGetJavaClassID(SigAttr.Signature);
        if AClsID = nil then
          raise EJNIFatal.CreateResFmt(@SJNIClassNotFound, [SigAttr.Signature]);
      end;
    finally
      Context.Free;
    end;
...
class function TBridgeHelper.GetInstanceVTable(var AVTable: TJavaVtable; ATypeInfo: PTypeInfo; ClsID: Pointer):TJavaVTable;
begin
  if AVTable = nil then
...
class procedure TBridgeHelper.Alloc(var ClsID: Pointer; ITypeInfo: PTypeInfo; var AVTable: TJavaVtable; var Resp);
var
  Obj: TJavaImport;
  LJNIObj: Pointer;
begin
...
class procedure TBridgeHelper.Wrap(P: Pointer; ITypeInfo: PTypeInfo; var JNIClassID: Pointer; var ATable: TJavaVTable; var Resp: IInterface);
var
  Obj: TJavaImport;
begin
  if P = nil then
  ...
  begin
    ...
    GetInstanceVTable(ATable, ITypeInfo, JNIClassID); // Update AVTable if it's nil
...
begin
  Result := nil;
  TBridgeHelper.Wrap(AJNIObjectID, TypeInfo(T), FJNIClassID, FInstanceVTable, IInterface(Result));
end;

class procedure TBridgeHelper.WrapInstance(const I: IJavaInstance; ITypeInfo: PTypeInfo; var JNIClassID: Pointer; var ATable: TJavaVTable; var Resp: IInterface);
begin
...
begin
  Result := nil;
  TBridgeHelper.WrapInstance(AInstance, TypeInfo(T), FJNIClassID, FInstanceVTable, IInterface(Result));
end;
...
begin
  VTables := TObjectDictionary<PTypeInfo, TJavaVTable>.Create([doOwnsValues]);
end;
...
class function TVTableCache.GetVTable(P: PTypeInfo; ClsID: Pointer; IsClassTable: Boolean): TJavaVTable;
begin
...
class procedure TVTableCache.DeleteVTable(P: PTypeInfo; const J: TJavaVTable);
begin
  TMonitor.Enter(VTables);
  try
    if VTables.ContainsKey(P) then
      VTables.Remove(P);
  finally
    TMonitor.Exit(VTables);
  end;
...
class procedure TBridgeHelper.ProcessArray(LInfo: PTypeInfo; const Context: TRttiContext;var FArrayReleaser: Pointer;
  var FArrayGetter: Pointer; var FBaseType: TRttiType; var Handle: JNIArray; var FClassID: JNIClass;
  CreateArray: Boolean; Len: Integer; AHandle: Pointer);
var
  AType: TRttiType;
  JNIEnv: PJNIEnv;
  LocalRef: JNIArray;
...
begin
  FArrayElem := nil;
  TBridgeHelper.ProcessArray(TypeInfo(T), Context, @FArrayReleaser, @FArrayGetter, FBaseType, Handle, FClassID,
    CreateArray, Len, AHandle);
end;
...
class function TJavaArray<T>.Wrap(const AnArray: TJavaBasicArray): TJavaArray<T>;
begin
  Result := TJavaArray<T>(WrapJNIArray(AnArray.ToPointer, TypeInfo(TJavaArray<T>)));
end;
...
class function TJavaObjectArray<T>.Wrap(const AnArray: TJavaBasicArray): TJavaObjectArray<T>;
begin
  Result := TJavaObjectArray<T>(WrapJNIArray(AnArray.ToPointer, TypeInfo(TJavaObjectArray<T>)));
end;
...
begin
  LJNIEnvRes :=  TJNIResolver.GetJNIEnv;
  Exp.Name := 'dispatchToNative2';
  Exp.Signature := '(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;J)Ljava/lang/Object;';
  Exp.FnPtr := @Androidapi.JNIBridge.dispatchToNative2;
...
procedure ReleaseAndNil(var Obj); Inline;
var
  Temp: TJInterfacedObject;
begin
  if TJInterfacedObject(Obj) <> nil then
  begin
    Temp := TJInterfacedObject(Obj);
    Pointer(Obj) := nil;
    Temp._Release;
  end;
end;
...
begin
  ...
  try
    ...
    begin
      ...
      ClsID := GetClassSignature(AInterface, True);
      ...
      ProxyConstructor := TJNIResolver.GetJavaMethodID(ProxyClass, DefaultJConstructor, DefaultJConstructorSig);
      ...
      try
        ...
        FLocalRefObjectID := AJNIEnv^.CallObjectMethodA(AJNIEnv, AJNIObject, CreateProxyClass, PJNIValue(ArgsToJNIValues([ClsID, Int64(Self)])));
        HandleJNIException(AJNIEnv);
...
begin
  ...
  if ProxyConstructor = nil then
    ProxyConstructor := TJNIResolver.GetJavaMethodID(ProxyClass, DefaultJConstructor, DefaultJConstructorSig, False);
  if ProxyConstructor = nil then
    raise EJNIFatal.CreateResFmt(@SJNIMethodNotFound, [FProxyInterfaceName+'.'+DefaultJConstructor]);
...
class function TJavaLocal.GetProxyInterfaceNameFromContext(AContext: JNIObject): string;
var
  Env: PJNIEnv;
  Clazz: JNIClass;
  JavaClazz: JNIClass;
...
begin
  ...
  MethodID := Env^.GetMethodID(Env, JavaClazz, 'getName', '()Ljava/lang/String;');
  JNIClassName := Env^.CallObjectMethod(Env, Clazz, MethodID);

  Result := JNIStringToString(Env, JNIClassName).Replace('.', '/') + 'ProxyInterface';
...
begin
  ...
  TRegTypes.RegisterType('System.UnicodeString', TypeInfo(System.UnicodeString));
end;
