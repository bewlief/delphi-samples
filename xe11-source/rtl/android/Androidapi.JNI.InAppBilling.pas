...
type
  ...
  JPurchasesResponseListener = interface;
  ...
  JBillingClient = interface(JObject)
    ...
    procedure queryPurchaseHistoryAsync(skuType: JString; purchaseHistoryResponseListener: JPurchaseHistoryResponseListener); cdecl;
    function queryPurchases(skuType: JString): JPurchase_PurchasesResult; cdecl;
    procedure queryPurchasesAsync(skuType: JString; listener: JPurchasesResponseListener); cdecl;
  ...
  JBillingFlowParams_Builder = interface(JObject)
    ...
    function setObfuscatedProfileId(obfuscatedAProfileid: JString): JBillingFlowParams_Builder; cdecl;
    function setOldSku(oldSku: JString): JBillingFlowParams_Builder; cdecl;
  ...
  JPurchaseHistoryRecordClass = interface(JObjectClass)
    ...
    {class} function init(jsonPurchaseInfo: JString; signature: JString): JPurchaseHistoryRecord; cdecl;
  end;
  ...
  JSkuDetailsParams_Builder = interface(JObject)
    ...
    function setType(skuType: JString): JSkuDetailsParams_Builder; cdecl;
  end;
