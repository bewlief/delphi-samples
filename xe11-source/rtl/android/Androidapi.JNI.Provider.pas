...
// ===== Forward declarations =====
  ...
  JBlockedNumberContract = interface;//android.provider.BlockedNumberContract
  JBlockedNumberContract_BlockedNumbers = interface;//android.provider.BlockedNumberContract$BlockedNumbers
  ...
  JDocumentsContract_Path = interface;//android.provider.DocumentsContract$Path
  ...
  JFontRequest = interface;//android.provider.FontRequest
  JFontsContract = interface;//android.provider.FontsContract
  JFontsContract_Columns = interface;//android.provider.FontsContract$Columns
  JFontsContract_FontFamilyResult = interface;//android.provider.FontsContract$FontFamilyResult
  JFontsContract_FontInfo = interface;//android.provider.FontsContract$FontInfo
  JFontsContract_FontRequestCallback = interface;//android.provider.FontsContract$FontRequestCallback
  ...
  JTelephony_ServiceStateTable = interface;//android.provider.Telephony$ServiceStateTable
...
// ===== Interface declarations =====
  ...
  JAlarmClockClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_SHOW_TIMERS: JString; cdecl;
    ...
    {class} property ACTION_SHOW_TIMERS: JString read _GetACTION_SHOW_TIMERS;
  ...
  JBlockedNumberContractClass = interface(JObjectClass)
    ['{2C52C19A-D7E3-4648-AF85-37D2B00A4C40}']
    {class} function _GetAUTHORITY: JString; cdecl;
    {class} function _GetAUTHORITY_URI: Jnet_Uri; cdecl;
    {class} function canCurrentUserBlockNumbers(context: JContext): Boolean; cdecl;
    {class} function isBlocked(context: JContext; phoneNumber: JString): Boolean; cdecl;
    {class} function unblock(context: JContext; phoneNumber: JString): Integer; cdecl;
    {class} property AUTHORITY: JString read _GetAUTHORITY;
    {class} property AUTHORITY_URI: Jnet_Uri read _GetAUTHORITY_URI;
  end;

  [JavaSignature('android/provider/BlockedNumberContract')]
  JBlockedNumberContract = interface(JObject)
    ['{EE0AB57C-C886-4139-B835-D62593CAF8A3}']
  end;
  TJBlockedNumberContract = class(TJavaGenericImport<JBlockedNumberContractClass, JBlockedNumberContract>) end;

  JBlockedNumberContract_BlockedNumbersClass = interface(JObjectClass)
    ['{380AA368-3961-4565-94E3-E8B09990AFE4}']
    {class} function _GetCOLUMN_E164_NUMBER: JString; cdecl;
    {class} function _GetCOLUMN_ID: JString; cdecl;
    {class} function _GetCOLUMN_ORIGINAL_NUMBER: JString; cdecl;
    ...
    {class} property COLUMN_E164_NUMBER: JString read _GetCOLUMN_E164_NUMBER;
    {class} property COLUMN_ID: JString read _GetCOLUMN_ID;
    {class} property COLUMN_ORIGINAL_NUMBER: JString read _GetCOLUMN_ORIGINAL_NUMBER;
  ...
  JBlockedNumberContract_BlockedNumbers = interface(JObject)
    ['{A90D31E6-43CC-49EE-AA1A-44D98987D220}']
  end;
  TJBlockedNumberContract_BlockedNumbers = class(TJavaGenericImport<JBlockedNumberContract_BlockedNumbersClass, JBlockedNumberContract_BlockedNumbers>) end;
  ...
  JCallLog_CallsClass = interface(JObjectClass)
    ...
    {class} function _GetANSWERED_EXTERNALLY_TYPE: Integer; cdecl;
    {class} function _GetBLOCKED_TYPE: Integer; cdecl;
    ...
    {class} function _GetFEATURES_HD_CALL: Integer; cdecl;
    {class} function _GetFEATURES_PULLED_EXTERNALLY: Integer; cdecl;
    {class} function _GetFEATURES_VIDEO: Integer; cdecl;
    {class} function _GetFEATURES_WIFI: Integer; cdecl;
    ...
    {class} function _GetPOST_DIAL_DIGITS: JString; cdecl;
    ...
    {class} function _GetREJECTED_TYPE: Integer; cdecl;
    {class} function _GetTRANSCRIPTION: JString; cdecl;
    {class} function _GetTYPE: JString; cdecl;
    {class} function _GetVIA_NUMBER: JString; cdecl;
    ...
    {class} property ANSWERED_EXTERNALLY_TYPE: Integer read _GetANSWERED_EXTERNALLY_TYPE;
    {class} property BLOCKED_TYPE: Integer read _GetBLOCKED_TYPE;
    ...
    {class} property FEATURES_HD_CALL: Integer read _GetFEATURES_HD_CALL;
    {class} property FEATURES_PULLED_EXTERNALLY: Integer read _GetFEATURES_PULLED_EXTERNALLY;
    {class} property FEATURES_VIDEO: Integer read _GetFEATURES_VIDEO;
    {class} property FEATURES_WIFI: Integer read _GetFEATURES_WIFI;
    ...
    {class} property POST_DIAL_DIGITS: JString read _GetPOST_DIAL_DIGITS;
    ...
    {class} property REJECTED_TYPE: Integer read _GetREJECTED_TYPE;
    {class} property TRANSCRIPTION: JString read _GetTRANSCRIPTION;
    {class} property &TYPE: JString read _GetTYPE;
    {class} property VIA_NUMBER: JString read _GetVIA_NUMBER;
  ...
  JCommonDataKinds_OrganizationClass = interface(JObjectClass)
    ...
    {class} function _GetPHONETIC_NAME: JString; cdecl;
    {class} function _GetPHONETIC_NAME_STYLE: JString; cdecl;
    ...
    {class} property PHONETIC_NAME: JString read _GetPHONETIC_NAME;
    {class} property PHONETIC_NAME_STYLE: JString read _GetPHONETIC_NAME_STYLE;
  ...
  JContactsContract_DirectoryClass = interface(JObjectClass)
    ...
    {class} function _GetCALLER_PACKAGE_PARAM_KEY: JString; cdecl;
    {class} function _GetCONTENT_ITEM_TYPE: JString; cdecl;
    {class} function _GetCONTENT_TYPE: JString; cdecl;
    {class} function _GetCONTENT_URI: Jnet_Uri; cdecl;
    ...
    {class} function _GetDISPLAY_NAME: JString; cdecl;
    {class} function _GetENTERPRISE_CONTENT_URI: Jnet_Uri; cdecl;
    {class} function _GetENTERPRISE_DEFAULT: Int64; cdecl;
    {class} function _GetENTERPRISE_LOCAL_INVISIBLE: Int64; cdecl;
    ...
    {class} function isEnterpriseDirectoryId(directoryId: Int64): Boolean; cdecl;
    {class} function isRemoteDirectoryId(directoryId: Int64): Boolean; cdecl;
    ...
    {class} property CALLER_PACKAGE_PARAM_KEY: JString read _GetCALLER_PACKAGE_PARAM_KEY;
    {class} property CONTENT_ITEM_TYPE: JString read _GetCONTENT_ITEM_TYPE;
    {class} property CONTENT_TYPE: JString read _GetCONTENT_TYPE;
    {class} property CONTENT_URI: Jnet_Uri read _GetCONTENT_URI;
    ...
    {class} property DISPLAY_NAME: JString read _GetDISPLAY_NAME;
    {class} property ENTERPRISE_CONTENT_URI: Jnet_Uri read _GetENTERPRISE_CONTENT_URI;
    {class} property ENTERPRISE_DEFAULT: Int64 read _GetENTERPRISE_DEFAULT;
    {class} property ENTERPRISE_LOCAL_INVISIBLE: Int64 read _GetENTERPRISE_LOCAL_INVISIBLE;
  ...
  JContactsContract_IntentsClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_VOICE_SEND_MESSAGE_TO_CONTACTS: JString; cdecl;
    {class} function _GetATTACH_IMAGE: JString; cdecl;
    {class} function _GetCONTACTS_DATABASE_CREATED: JString; cdecl;
    {class} function _GetEXTRA_CREATE_DESCRIPTION: JString; cdecl;
    {class} function _GetEXTRA_FORCE_CREATE: JString; cdecl;
    {class} function _GetEXTRA_RECIPIENT_CONTACT_CHAT_ID: JString; cdecl;
    {class} function _GetEXTRA_RECIPIENT_CONTACT_NAME: JString; cdecl;
    {class} function _GetEXTRA_RECIPIENT_CONTACT_URI: JString; cdecl;
    {class} function _GetINVITE_CONTACT: JString; cdecl;
    {class} function _GetMETADATA_ACCOUNT_TYPE: JString; cdecl;
    {class} function _GetMETADATA_MIMETYPE: JString; cdecl;
    {class} function _GetSEARCH_SUGGESTION_CLICKED: JString; cdecl;
    {class} function _GetSEARCH_SUGGESTION_CREATE_CONTACT_CLICKED: JString; cdecl;
    {class} function _GetSEARCH_SUGGESTION_DIAL_NUMBER_CLICKED: JString; cdecl;
    {class} function _GetSHOW_OR_CREATE_CONTACT: JString; cdecl;
    {class} function init: JContactsContract_Intents; cdecl;
    {class} property ACTION_VOICE_SEND_MESSAGE_TO_CONTACTS: JString read _GetACTION_VOICE_SEND_MESSAGE_TO_CONTACTS;
    {class} property ATTACH_IMAGE: JString read _GetATTACH_IMAGE;
    {class} property CONTACTS_DATABASE_CREATED: JString read _GetCONTACTS_DATABASE_CREATED;
    {class} property EXTRA_CREATE_DESCRIPTION: JString read _GetEXTRA_CREATE_DESCRIPTION;
    {class} property EXTRA_FORCE_CREATE: JString read _GetEXTRA_FORCE_CREATE;
    {class} property EXTRA_RECIPIENT_CONTACT_CHAT_ID: JString read _GetEXTRA_RECIPIENT_CONTACT_CHAT_ID;
    {class} property EXTRA_RECIPIENT_CONTACT_NAME: JString read _GetEXTRA_RECIPIENT_CONTACT_NAME;
    {class} property EXTRA_RECIPIENT_CONTACT_URI: JString read _GetEXTRA_RECIPIENT_CONTACT_URI;
    {class} property INVITE_CONTACT: JString read _GetINVITE_CONTACT;
    {class} property METADATA_ACCOUNT_TYPE: JString read _GetMETADATA_ACCOUNT_TYPE;
    {class} property METADATA_MIMETYPE: JString read _GetMETADATA_MIMETYPE;
    {class} property SEARCH_SUGGESTION_CLICKED: JString read _GetSEARCH_SUGGESTION_CLICKED;
    {class} property SEARCH_SUGGESTION_CREATE_CONTACT_CLICKED: JString read _GetSEARCH_SUGGESTION_CREATE_CONTACT_CLICKED;
    {class} property SEARCH_SUGGESTION_DIAL_NUMBER_CLICKED: JString read _GetSEARCH_SUGGESTION_DIAL_NUMBER_CLICKED;
    {class} property SHOW_OR_CREATE_CONTACT: JString read _GetSHOW_OR_CREATE_CONTACT;
  ...
  JContactsContract_ProviderStatusClass = interface(JObjectClass)
    ...
    {class} function _GetCONTENT_TYPE: JString; cdecl;
    {class} function _GetCONTENT_URI: Jnet_Uri; cdecl;
    {class} function _GetDATABASE_CREATION_TIMESTAMP: JString; cdecl;
    ...
    {class} property CONTENT_TYPE: JString read _GetCONTENT_TYPE;
    {class} property CONTENT_URI: Jnet_Uri read _GetCONTENT_URI;
    {class} property DATABASE_CREATION_TIMESTAMP: JString read _GetDATABASE_CREATION_TIMESTAMP;
  ...
  JDocumentsContractClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_DOCUMENT_SETTINGS: JString; cdecl;
    ...
    {class} function _GetEXTRA_INITIAL_URI: JString; cdecl;
    {class} function _GetEXTRA_LOADING: JString; cdecl;
    {class} function _GetEXTRA_ORIENTATION: JString; cdecl;
    ...
    {class} function copyDocument(resolver: JContentResolver; sourceDocumentUri: Jnet_Uri; targetParentDocumentUri: Jnet_Uri): Jnet_Uri; cdecl;
    ...
    {class} function createWebLinkIntent(resolver: JContentResolver; uri: Jnet_Uri; options: JBundle): JIntentSender; cdecl;
    {class} function deleteDocument(resolver: JContentResolver; documentUri: Jnet_Uri): Boolean; cdecl;
    {class} procedure ejectRoot(resolver: JContentResolver; rootUri: Jnet_Uri); cdecl;
    {class} function findDocumentPath(resolver: JContentResolver; treeUri: Jnet_Uri): JDocumentsContract_Path; cdecl;
    ...
    {class} function isTreeUri(uri: Jnet_Uri): Boolean; cdecl;
    {class} function moveDocument(resolver: JContentResolver; sourceDocumentUri: Jnet_Uri; sourceParentDocumentUri: Jnet_Uri; targetParentDocumentUri: Jnet_Uri): Jnet_Uri; cdecl;
    {class} function removeDocument(resolver: JContentResolver; documentUri: Jnet_Uri; parentDocumentUri: Jnet_Uri): Boolean; cdecl;
    {class} function renameDocument(resolver: JContentResolver; documentUri: Jnet_Uri; displayName: JString): Jnet_Uri; cdecl;
    {class} property ACTION_DOCUMENT_SETTINGS: JString read _GetACTION_DOCUMENT_SETTINGS;
    ...
    {class} property EXTRA_INITIAL_URI: JString read _GetEXTRA_INITIAL_URI;
    {class} property EXTRA_LOADING: JString read _GetEXTRA_LOADING;
    {class} property EXTRA_ORIENTATION: JString read _GetEXTRA_ORIENTATION;
  ...
  JDocumentsContract_DocumentClass = interface(JObjectClass)
    ...
    {class} function _GetFLAG_SUPPORTS_COPY: Integer; cdecl;
    {class} function _GetFLAG_SUPPORTS_DELETE: Integer; cdecl;
    {class} function _GetFLAG_SUPPORTS_MOVE: Integer; cdecl;
    {class} function _GetFLAG_SUPPORTS_REMOVE: Integer; cdecl;
    {class} function _GetFLAG_SUPPORTS_RENAME: Integer; cdecl;
    {class} function _GetFLAG_SUPPORTS_SETTINGS: Integer; cdecl;
    {class} function _GetFLAG_SUPPORTS_THUMBNAIL: Integer; cdecl;
    {class} function _GetFLAG_SUPPORTS_WRITE: Integer; cdecl;
    {class} function _GetFLAG_VIRTUAL_DOCUMENT: Integer; cdecl;
    {class} function _GetFLAG_WEB_LINKABLE: Integer; cdecl;
    ...
    {class} property FLAG_SUPPORTS_COPY: Integer read _GetFLAG_SUPPORTS_COPY;
    {class} property FLAG_SUPPORTS_DELETE: Integer read _GetFLAG_SUPPORTS_DELETE;
    {class} property FLAG_SUPPORTS_MOVE: Integer read _GetFLAG_SUPPORTS_MOVE;
    {class} property FLAG_SUPPORTS_REMOVE: Integer read _GetFLAG_SUPPORTS_REMOVE;
    {class} property FLAG_SUPPORTS_RENAME: Integer read _GetFLAG_SUPPORTS_RENAME;
    {class} property FLAG_SUPPORTS_SETTINGS: Integer read _GetFLAG_SUPPORTS_SETTINGS;
    ...
    {class} property FLAG_VIRTUAL_DOCUMENT: Integer read _GetFLAG_VIRTUAL_DOCUMENT;
    {class} property FLAG_WEB_LINKABLE: Integer read _GetFLAG_WEB_LINKABLE;
  ...
  JDocumentsContract_PathClass = interface(JObjectClass)
    ['{C44C0438-A83D-48EE-B816-9DD5749D7363}']
    {class} function _GetCREATOR: JParcelable_Creator; cdecl;
    {class} function init(rootId: JString; path: JList): JDocumentsContract_Path; cdecl;
    {class} property CREATOR: JParcelable_Creator read _GetCREATOR;
  end;

  [JavaSignature('android/provider/DocumentsContract$Path')]
  JDocumentsContract_Path = interface(JObject)
    ['{68285AB9-0CE0-4C2D-AFF2-0DC63F16EA3F}']
    function describeContents: Integer; cdecl;
    function equals(o: JObject): Boolean; cdecl;
    function getPath: JList; cdecl;
    function getRootId: JString; cdecl;
    function hashCode: Integer; cdecl;
    function toString: JString; cdecl;
    procedure writeToParcel(dest: JParcel; flags: Integer); cdecl;
  end;
  TJDocumentsContract_Path = class(TJavaGenericImport<JDocumentsContract_PathClass, JDocumentsContract_Path>) end;
  ...
  JDocumentsContract_RootClass = interface(JObjectClass)
    ...
    {class} function _GetCOLUMN_CAPACITY_BYTES: JString; cdecl;
    {class} function _GetCOLUMN_DOCUMENT_ID: JString; cdecl;
    {class} function _GetCOLUMN_FLAGS: JString; cdecl;
    {class} function _GetCOLUMN_ICON: JString; cdecl;
    ...
    {class} function _GetFLAG_SUPPORTS_EJECT: Integer; cdecl;
    ...
    {class} function _GetMIME_TYPE_ITEM: JString; cdecl;
    {class} property COLUMN_AVAILABLE_BYTES: JString read _GetCOLUMN_AVAILABLE_BYTES;
    {class} property COLUMN_CAPACITY_BYTES: JString read _GetCOLUMN_CAPACITY_BYTES;
    {class} property COLUMN_DOCUMENT_ID: JString read _GetCOLUMN_DOCUMENT_ID;
    {class} property COLUMN_FLAGS: JString read _GetCOLUMN_FLAGS;
    {class} property COLUMN_ICON: JString read _GetCOLUMN_ICON;
    ...
    {class} property FLAG_SUPPORTS_EJECT: Integer read _GetFLAG_SUPPORTS_EJECT;
    ...
    {class} property MIME_TYPE_ITEM: JString read _GetMIME_TYPE_ITEM;
  end;
  ...
  JDocumentsProvider = interface(JContentProvider)
    ...
    function copyDocument(sourceDocumentId: JString; targetParentDocumentId: JString): JString; cdecl;
    function createDocument(parentDocumentId: JString; mimeType: JString; displayName: JString): JString; cdecl;
    function createWebLinkIntent(documentId: JString; options: JBundle): JIntentSender; cdecl;
    ...
    procedure ejectRoot(rootId: JString); cdecl;
    function findDocumentPath(parentDocumentId: JString; childDocumentId: JString): JDocumentsContract_Path; cdecl;
    function getDocumentStreamTypes(documentId: JString; mimeTypeFilter: JString): TJavaObjectArray<JString>; cdecl;
    ...
    function moveDocument(sourceDocumentId: JString; sourceParentDocumentId: JString; targetParentDocumentId: JString): JString; cdecl;
    ...
    function openTypedDocument(documentId: JString; mimeTypeFilter: JString; opts: JBundle; signal: JCancellationSignal): JAssetFileDescriptor; cdecl;
    ...
    function queryChildDocuments(parentDocumentId: JString; projection: TJavaObjectArray<JString>; sortOrder: JString): JCursor; cdecl; overload;
    function queryChildDocuments(parentDocumentId: JString; projection: TJavaObjectArray<JString>; queryArgs: JBundle): JCursor; cdecl; overload;
    ...
    procedure removeDocument(documentId: JString; parentDocumentId: JString); cdecl;
  ...
  JFontRequestClass = interface(JObjectClass)
    ['{A8749F37-222C-4CD8-9319-134770CA10CF}']
    {class} function init(providerAuthority: JString; providerPackage: JString; query: JString): JFontRequest; cdecl; overload;
    {class} function init(providerAuthority: JString; providerPackage: JString; query: JString; certificates: JList): JFontRequest; cdecl; overload;
  end;

  [JavaSignature('android/provider/FontRequest')]
  JFontRequest = interface(JObject)
    ['{9F5102E4-89D6-4F06-8339-1EEB590388B6}']
    function getCertificates: JList; cdecl;
    function getProviderAuthority: JString; cdecl;
    function getProviderPackage: JString; cdecl;
    function getQuery: JString; cdecl;
    function toString: JString; cdecl;
  end;
  TJFontRequest = class(TJavaGenericImport<JFontRequestClass, JFontRequest>) end;

  JFontsContractClass = interface(JObjectClass)
    ['{D6F05951-4EB7-401A-9393-C40190DE140C}']
    {class} function buildTypeface(context: JContext; cancellationSignal: JCancellationSignal; fonts: TJavaObjectArray<JFontsContract_FontInfo>): JTypeface; cdecl;
    {class} function fetchFonts(context: JContext; cancellationSignal: JCancellationSignal; request: JFontRequest): JFontsContract_FontFamilyResult; cdecl;
    {class} procedure requestFonts(context: JContext; request: JFontRequest; handler: JHandler; cancellationSignal: JCancellationSignal; callback: JFontsContract_FontRequestCallback); cdecl;
  end;

  [JavaSignature('android/provider/FontsContract')]
  JFontsContract = interface(JObject)
    ['{8DAA7A6F-D6A2-4AD2-80BE-027658AF3EDF}']
  end;
  TJFontsContract = class(TJavaGenericImport<JFontsContractClass, JFontsContract>) end;

  JFontsContract_ColumnsClass = interface(JObjectClass)
    ['{B4B4C4DF-B245-48F2-BAA7-6E2EF9000C9F}']
    {class} function _GetFILE_ID: JString; cdecl;
    {class} function _GetITALIC: JString; cdecl;
    {class} function _GetRESULT_CODE: JString; cdecl;
    {class} function _GetRESULT_CODE_FONT_NOT_FOUND: Integer; cdecl;
    {class} function _GetRESULT_CODE_FONT_UNAVAILABLE: Integer; cdecl;
    {class} function _GetRESULT_CODE_MALFORMED_QUERY: Integer; cdecl;
    {class} function _GetRESULT_CODE_OK: Integer; cdecl;
    {class} function _GetTTC_INDEX: JString; cdecl;
    {class} function _GetVARIATION_SETTINGS: JString; cdecl;
    {class} function _GetWEIGHT: JString; cdecl;
    {class} property FILE_ID: JString read _GetFILE_ID;
    {class} property ITALIC: JString read _GetITALIC;
    {class} property RESULT_CODE: JString read _GetRESULT_CODE;
    {class} property RESULT_CODE_FONT_NOT_FOUND: Integer read _GetRESULT_CODE_FONT_NOT_FOUND;
    {class} property RESULT_CODE_FONT_UNAVAILABLE: Integer read _GetRESULT_CODE_FONT_UNAVAILABLE;
    {class} property RESULT_CODE_MALFORMED_QUERY: Integer read _GetRESULT_CODE_MALFORMED_QUERY;
    {class} property RESULT_CODE_OK: Integer read _GetRESULT_CODE_OK;
    {class} property TTC_INDEX: JString read _GetTTC_INDEX;
    {class} property VARIATION_SETTINGS: JString read _GetVARIATION_SETTINGS;
    {class} property WEIGHT: JString read _GetWEIGHT;
  end;

  [JavaSignature('android/provider/FontsContract$Columns')]
  JFontsContract_Columns = interface(JObject)
    ['{F64BD17B-BCB8-470F-A0E0-71D07CF4015E}']
  end;
  TJFontsContract_Columns = class(TJavaGenericImport<JFontsContract_ColumnsClass, JFontsContract_Columns>) end;

  JFontsContract_FontFamilyResultClass = interface(JObjectClass)
    ['{657967E8-6EBD-468F-8F26-F0561D639BF4}']
    {class} function _GetSTATUS_OK: Integer; cdecl;
    {class} function _GetSTATUS_REJECTED: Integer; cdecl;
    {class} function _GetSTATUS_UNEXPECTED_DATA_PROVIDED: Integer; cdecl;
    {class} function _GetSTATUS_WRONG_CERTIFICATES: Integer; cdecl;
    {class} property STATUS_OK: Integer read _GetSTATUS_OK;
    {class} property STATUS_REJECTED: Integer read _GetSTATUS_REJECTED;
    {class} property STATUS_UNEXPECTED_DATA_PROVIDED: Integer read _GetSTATUS_UNEXPECTED_DATA_PROVIDED;
    {class} property STATUS_WRONG_CERTIFICATES: Integer read _GetSTATUS_WRONG_CERTIFICATES;
  end;

  [JavaSignature('android/provider/FontsContract$FontFamilyResult')]
  JFontsContract_FontFamilyResult = interface(JObject)
    ['{4C39E077-FBD0-4131-B31E-D11395BA7413}']
    function getFonts: TJavaObjectArray<JFontsContract_FontInfo>; cdecl;
    function getStatusCode: Integer; cdecl;
  end;
  TJFontsContract_FontFamilyResult = class(TJavaGenericImport<JFontsContract_FontFamilyResultClass, JFontsContract_FontFamilyResult>) end;

  JFontsContract_FontInfoClass = interface(JObjectClass)
    ['{0FC8C115-56DD-4C43-AB00-656122E65267}']
  end;

  [JavaSignature('android/provider/FontsContract$FontInfo')]
  JFontsContract_FontInfo = interface(JObject)
    ['{34261282-A0FC-4126-8B64-D77B9C4ADA1F}']
    function getAxes: TJavaObjectArray<JFontVariationAxis>; cdecl;
    function getResultCode: Integer; cdecl;
    function getTtcIndex: Integer; cdecl;
    function getUri: Jnet_Uri; cdecl;
    function getWeight: Integer; cdecl;
    function isItalic: Boolean; cdecl;
  end;
  TJFontsContract_FontInfo = class(TJavaGenericImport<JFontsContract_FontInfoClass, JFontsContract_FontInfo>) end;

  JFontsContract_FontRequestCallbackClass = interface(JObjectClass)
    ['{E11CD666-FA2A-441F-8AB2-186E20CDD239}']
    {class} function _GetFAIL_REASON_FONT_LOAD_ERROR: Integer; cdecl;
    {class} function _GetFAIL_REASON_FONT_NOT_FOUND: Integer; cdecl;
    {class} function _GetFAIL_REASON_FONT_UNAVAILABLE: Integer; cdecl;
    {class} function _GetFAIL_REASON_MALFORMED_QUERY: Integer; cdecl;
    {class} function _GetFAIL_REASON_PROVIDER_NOT_FOUND: Integer; cdecl;
    {class} function _GetFAIL_REASON_WRONG_CERTIFICATES: Integer; cdecl;
    {class} function init: JFontsContract_FontRequestCallback; cdecl;
    {class} property FAIL_REASON_FONT_LOAD_ERROR: Integer read _GetFAIL_REASON_FONT_LOAD_ERROR;
    {class} property FAIL_REASON_FONT_NOT_FOUND: Integer read _GetFAIL_REASON_FONT_NOT_FOUND;
    {class} property FAIL_REASON_FONT_UNAVAILABLE: Integer read _GetFAIL_REASON_FONT_UNAVAILABLE;
    {class} property FAIL_REASON_MALFORMED_QUERY: Integer read _GetFAIL_REASON_MALFORMED_QUERY;
    {class} property FAIL_REASON_PROVIDER_NOT_FOUND: Integer read _GetFAIL_REASON_PROVIDER_NOT_FOUND;
    {class} property FAIL_REASON_WRONG_CERTIFICATES: Integer read _GetFAIL_REASON_WRONG_CERTIFICATES;
  end;

  [JavaSignature('android/provider/FontsContract$FontRequestCallback')]
  JFontsContract_FontRequestCallback = interface(JObject)
    ['{ACBFEB73-23BB-4931-AADF-E524F053EBE4}']
    procedure onTypefaceRequestFailed(reason: Integer); cdecl;
    procedure onTypefaceRetrieved(typeface: JTypeface); cdecl;
  end;
  TJFontsContract_FontRequestCallback = class(TJavaGenericImport<JFontsContract_FontRequestCallbackClass, JFontsContract_FontRequestCallback>) end;
  ...
  JMediaStoreClass = interface(JObjectClass)
    ...
    {class} function getDocumentUri(context: JContext; mediaUri: Jnet_Uri): Jnet_Uri; cdecl;
  ...
  JSettingsClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_APP_NOTIFICATION_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_CHANNEL_NOTIFICATION_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_HARD_KEYBOARD_SETTINGS: JString; cdecl;
    {class} function _GetACTION_HOME_SETTINGS: JString; cdecl;
    {class} function _GetACTION_IGNORE_BACKGROUND_DATA_RESTRICTIONS_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_NIGHT_DISPLAY_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_REQUEST_SET_AUTOFILL_SERVICE: JString; cdecl;
    ...
    {class} function _GetACTION_VPN_SETTINGS: JString; cdecl;
    {class} function _GetACTION_VR_LISTENER_SETTINGS: JString; cdecl;
    {class} function _GetACTION_WEBVIEW_SETTINGS: JString; cdecl;
    ...
    {class} function _GetACTION_ZEN_MODE_PRIORITY_SETTINGS: JString; cdecl;
    {class} function _GetAUTHORITY: JString; cdecl;
    {class} function _GetEXTRA_ACCOUNT_TYPES: JString; cdecl;
    {class} function _GetEXTRA_AIRPLANE_MODE_ENABLED: JString; cdecl;
    {class} function _GetEXTRA_APP_PACKAGE: JString; cdecl;
    ...
    {class} property ACTION_APP_NOTIFICATION_SETTINGS: JString read _GetACTION_APP_NOTIFICATION_SETTINGS;
    ...
    {class} property ACTION_CHANNEL_NOTIFICATION_SETTINGS: JString read _GetACTION_CHANNEL_NOTIFICATION_SETTINGS;
    ...
    {class} property ACTION_HARD_KEYBOARD_SETTINGS: JString read _GetACTION_HARD_KEYBOARD_SETTINGS;
    {class} property ACTION_HOME_SETTINGS: JString read _GetACTION_HOME_SETTINGS;
    {class} property ACTION_IGNORE_BACKGROUND_DATA_RESTRICTIONS_SETTINGS: JString read _GetACTION_IGNORE_BACKGROUND_DATA_RESTRICTIONS_SETTINGS;
    ...
    {class} property ACTION_NIGHT_DISPLAY_SETTINGS: JString read _GetACTION_NIGHT_DISPLAY_SETTINGS;
    ...
    {class} property ACTION_REQUEST_SET_AUTOFILL_SERVICE: JString read _GetACTION_REQUEST_SET_AUTOFILL_SERVICE;
    ...
    {class} property ACTION_VPN_SETTINGS: JString read _GetACTION_VPN_SETTINGS;
    {class} property ACTION_VR_LISTENER_SETTINGS: JString read _GetACTION_VR_LISTENER_SETTINGS;
    {class} property ACTION_WEBVIEW_SETTINGS: JString read _GetACTION_WEBVIEW_SETTINGS;
    ...
    {class} property ACTION_ZEN_MODE_PRIORITY_SETTINGS: JString read _GetACTION_ZEN_MODE_PRIORITY_SETTINGS;
    {class} property AUTHORITY: JString read _GetAUTHORITY;
    ...
    {class} property EXTRA_APP_PACKAGE: JString read _GetEXTRA_APP_PACKAGE;
  ...
  JSettings_GlobalClass = interface(JSettings_NameValueTableClass)
    ...
    {class} function _GetBOOT_COUNT: JString; cdecl;
    {class} function _GetCONTACT_METADATA_SYNC: JString; cdecl;
    {class} function _GetCONTACT_METADATA_SYNC_ENABLED: JString; cdecl;
    {class} function _GetCONTENT_URI: Jnet_Uri; cdecl;
    ...
    {class} function _GetDEVICE_NAME: JString; cdecl;
    ...
    {class} property BOOT_COUNT: JString read _GetBOOT_COUNT;
    {class} property CONTACT_METADATA_SYNC: JString read _GetCONTACT_METADATA_SYNC;
    {class} property CONTACT_METADATA_SYNC_ENABLED: JString read _GetCONTACT_METADATA_SYNC_ENABLED;
    {class} property CONTENT_URI: Jnet_Uri read _GetCONTENT_URI;
    ...
    {class} property DEVICE_NAME: JString read _GetDEVICE_NAME;
  ...
  JTelephony_ServiceStateTableClass = interface(JObjectClass)
    ['{80CD94B9-4C07-4E5D-996D-96F26A3E6D0B}']
    {class} function _GetAUTHORITY: JString; cdecl;
    {class} function _GetCONTENT_URI: Jnet_Uri; cdecl;
    {class} function _GetIS_MANUAL_NETWORK_SELECTION: JString; cdecl;
    {class} function _GetVOICE_OPERATOR_NUMERIC: JString; cdecl;
    {class} function _GetVOICE_REG_STATE: JString; cdecl;
    {class} function getUriForSubscriptionId(subscriptionId: Integer): Jnet_Uri; cdecl;
    {class} function getUriForSubscriptionIdAndField(subscriptionId: Integer; field: JString): Jnet_Uri; cdecl;
    {class} property AUTHORITY: JString read _GetAUTHORITY;
    {class} property CONTENT_URI: Jnet_Uri read _GetCONTENT_URI;
    {class} property IS_MANUAL_NETWORK_SELECTION: JString read _GetIS_MANUAL_NETWORK_SELECTION;
    {class} property VOICE_OPERATOR_NUMERIC: JString read _GetVOICE_OPERATOR_NUMERIC;
    {class} property VOICE_REG_STATE: JString read _GetVOICE_REG_STATE;
  end;

  [JavaSignature('android/provider/Telephony$ServiceStateTable')]
  JTelephony_ServiceStateTable = interface(JObject)
    ['{3D951E0C-6DE1-438C-9A06-577197398865}']
  end;
  TJTelephony_ServiceStateTable = class(TJavaGenericImport<JTelephony_ServiceStateTableClass, JTelephony_ServiceStateTable>) end;
  ...
  JSms_IntentsClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_DEFAULT_SMS_PACKAGE_CHANGED: JString; cdecl;
    {class} function _GetACTION_EXTERNAL_PROVIDER_CHANGE: JString; cdecl;
    {class} function _GetDATA_SMS_RECEIVED_ACTION: JString; cdecl;
    {class} function _GetEXTRA_IS_DEFAULT_SMS_APP: JString; cdecl;
    ...
    {class} property ACTION_DEFAULT_SMS_PACKAGE_CHANGED: JString read _GetACTION_DEFAULT_SMS_PACKAGE_CHANGED;
    {class} property ACTION_EXTERNAL_PROVIDER_CHANGE: JString read _GetACTION_EXTERNAL_PROVIDER_CHANGE;
    {class} property DATA_SMS_RECEIVED_ACTION: JString read _GetDATA_SMS_RECEIVED_ACTION;
    {class} property EXTRA_IS_DEFAULT_SMS_APP: JString read _GetEXTRA_IS_DEFAULT_SMS_APP;
  ...
  JVoicemailContractClass = interface(JObjectClass)
    ...
    {class} function _GetACTION_SYNC_VOICEMAIL: JString; cdecl;
    {class} function _GetAUTHORITY: JString; cdecl;
    ...
    {class} property ACTION_SYNC_VOICEMAIL: JString read _GetACTION_SYNC_VOICEMAIL;
    {class} property AUTHORITY: JString read _GetAUTHORITY;
  ...
  JVoicemailContract_StatusClass = interface(JObjectClass)
    ...
    {class} function _GetCONFIGURATION_STATE_CONFIGURING: Integer; cdecl;
    {class} function _GetCONFIGURATION_STATE_DISABLED: Integer; cdecl;
    {class} function _GetCONFIGURATION_STATE_FAILED: Integer; cdecl;
    ...
    {class} function _GetDATA_CHANNEL_STATE_BAD_CONFIGURATION: Integer; cdecl;
    {class} function _GetDATA_CHANNEL_STATE_COMMUNICATION_ERROR: Integer; cdecl;
    {class} function _GetDATA_CHANNEL_STATE_NO_CONNECTION: Integer; cdecl;
    {class} function _GetDATA_CHANNEL_STATE_NO_CONNECTION_CELLULAR_REQUIRED: Integer; cdecl;
    {class} function _GetDATA_CHANNEL_STATE_OK: Integer; cdecl;
    {class} function _GetDATA_CHANNEL_STATE_SERVER_CONNECTION_ERROR: Integer; cdecl;
    {class} function _GetDATA_CHANNEL_STATE_SERVER_ERROR: Integer; cdecl;
    ...
    {class} function _GetPHONE_ACCOUNT_COMPONENT_NAME: JString; cdecl;
    {class} function _GetPHONE_ACCOUNT_ID: JString; cdecl;
    {class} function _GetQUOTA_OCCUPIED: JString; cdecl;
    {class} function _GetQUOTA_TOTAL: JString; cdecl;
    {class} function _GetQUOTA_UNAVAILABLE: Integer; cdecl;
    {class} function _GetSETTINGS_URI: JString; cdecl;
    {class} function _GetSOURCE_PACKAGE: JString; cdecl;
    {class} function _GetSOURCE_TYPE: JString; cdecl;
    ...
    {class} property CONFIGURATION_STATE_CONFIGURING: Integer read _GetCONFIGURATION_STATE_CONFIGURING;
    {class} property CONFIGURATION_STATE_DISABLED: Integer read _GetCONFIGURATION_STATE_DISABLED;
    {class} property CONFIGURATION_STATE_FAILED: Integer read _GetCONFIGURATION_STATE_FAILED;
    ...
    {class} property DATA_CHANNEL_STATE_BAD_CONFIGURATION: Integer read _GetDATA_CHANNEL_STATE_BAD_CONFIGURATION;
    {class} property DATA_CHANNEL_STATE_COMMUNICATION_ERROR: Integer read _GetDATA_CHANNEL_STATE_COMMUNICATION_ERROR;
    {class} property DATA_CHANNEL_STATE_NO_CONNECTION: Integer read _GetDATA_CHANNEL_STATE_NO_CONNECTION;
    {class} property DATA_CHANNEL_STATE_NO_CONNECTION_CELLULAR_REQUIRED: Integer read _GetDATA_CHANNEL_STATE_NO_CONNECTION_CELLULAR_REQUIRED;
    {class} property DATA_CHANNEL_STATE_OK: Integer read _GetDATA_CHANNEL_STATE_OK;
    {class} property DATA_CHANNEL_STATE_SERVER_CONNECTION_ERROR: Integer read _GetDATA_CHANNEL_STATE_SERVER_CONNECTION_ERROR;
    {class} property DATA_CHANNEL_STATE_SERVER_ERROR: Integer read _GetDATA_CHANNEL_STATE_SERVER_ERROR;
    ...
    {class} property PHONE_ACCOUNT_COMPONENT_NAME: JString read _GetPHONE_ACCOUNT_COMPONENT_NAME;
    {class} property PHONE_ACCOUNT_ID: JString read _GetPHONE_ACCOUNT_ID;
    {class} property QUOTA_OCCUPIED: JString read _GetQUOTA_OCCUPIED;
    {class} property QUOTA_TOTAL: JString read _GetQUOTA_TOTAL;
    {class} property QUOTA_UNAVAILABLE: Integer read _GetQUOTA_UNAVAILABLE;
    {class} property SETTINGS_URI: JString read _GetSETTINGS_URI;
    {class} property SOURCE_PACKAGE: JString read _GetSOURCE_PACKAGE;
    {class} property SOURCE_TYPE: JString read _GetSOURCE_TYPE;
  ...
  JVoicemailContract_VoicemailsClass = interface(JObjectClass)
    ...
    {class} function _GetARCHIVED: JString; cdecl;
    {class} function _GetBACKED_UP: JString; cdecl;
    {class} function _GetCONTENT_URI: Jnet_Uri; cdecl;
    {class} function _GetDATE: JString; cdecl;
    ...
    {class} function _GetIS_OMTP_VOICEMAIL: JString; cdecl;
    {class} function _GetIS_READ: JString; cdecl;
    {class} function _GetITEM_TYPE: JString; cdecl;
    {class} function _GetLAST_MODIFIED: JString; cdecl;
    {class} function _GetMIME_TYPE: JString; cdecl;
    ...
    {class} function _GetPHONE_ACCOUNT_COMPONENT_NAME: JString; cdecl;
    {class} function _GetPHONE_ACCOUNT_ID: JString; cdecl;
    {class} function _GetRESTORED: JString; cdecl;
    {class} function _GetSOURCE_DATA: JString; cdecl;
    {class} function _GetSOURCE_PACKAGE: JString; cdecl;
    {class} function _GetTRANSCRIPTION: JString; cdecl;
    {class} function buildSourceUri(packageName: JString): Jnet_Uri; cdecl;
    {class} property ARCHIVED: JString read _GetARCHIVED;
    {class} property BACKED_UP: JString read _GetBACKED_UP;
    {class} property CONTENT_URI: Jnet_Uri read _GetCONTENT_URI;
    {class} property DATE: JString read _GetDATE;
    ...
    {class} property IS_OMTP_VOICEMAIL: JString read _GetIS_OMTP_VOICEMAIL;
    {class} property IS_READ: JString read _GetIS_READ;
    {class} property ITEM_TYPE: JString read _GetITEM_TYPE;
    {class} property LAST_MODIFIED: JString read _GetLAST_MODIFIED;
    {class} property MIME_TYPE: JString read _GetMIME_TYPE;
    ...
    {class} property PHONE_ACCOUNT_COMPONENT_NAME: JString read _GetPHONE_ACCOUNT_COMPONENT_NAME;
    {class} property PHONE_ACCOUNT_ID: JString read _GetPHONE_ACCOUNT_ID;
    {class} property RESTORED: JString read _GetRESTORED;
...
begin
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JBlockedNumberContract', TypeInfo(Androidapi.JNI.Provider.JBlockedNumberContract));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JBlockedNumberContract_BlockedNumbers', TypeInfo(Androidapi.JNI.Provider.JBlockedNumberContract_BlockedNumbers));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JDocumentsContract_Path', TypeInfo(Androidapi.JNI.Provider.JDocumentsContract_Path));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JFontRequest', TypeInfo(Androidapi.JNI.Provider.JFontRequest));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JFontsContract', TypeInfo(Androidapi.JNI.Provider.JFontsContract));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JFontsContract_Columns', TypeInfo(Androidapi.JNI.Provider.JFontsContract_Columns));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JFontsContract_FontFamilyResult', TypeInfo(Androidapi.JNI.Provider.JFontsContract_FontFamilyResult));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JFontsContract_FontInfo', TypeInfo(Androidapi.JNI.Provider.JFontsContract_FontInfo));
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JFontsContract_FontRequestCallback', TypeInfo(Androidapi.JNI.Provider.JFontsContract_FontRequestCallback));
  ...
  TRegTypes.RegisterType('Androidapi.JNI.Provider.JTelephony_ServiceStateTable', TypeInfo(Androidapi.JNI.Provider.JTelephony_ServiceStateTable));
