...
resourcestring
  ...
  SJNIClassNotFound = 'Java type %s could not be found';
  ...
  SJNIMangleErrorInvalidClassType = 'Mangle error: the type ''%s'' is invalid for describing a Java array type. The former must be a class derived from TJavaBasicArray';
  SJNIMangleErrorInvalidInterfaceType = 'Mangle error: the type ''%s'' is invalid for describing a Java class type. The former must be an interface annotated with the JavaSignature attribute';
  SJNIMangleErrorInvalidFloatingPointType = 'Mangle error: the type ''%s'' is invalid for describing a Java float-pointing type. Single and Double are the only supported floating-point types';
  SJNIMangleErrorInvalidJavaType = 'Mangle error: the type ''%s'' is invalid for describing a Java type';
  ...
  SIABFeatureNotSupported = 'Billing service feature is not supported';
  SIABServiceDisconnected = 'Billing service disconnected';
  SIABServiceTimeout = 'Billing service connection timeout';
  SIABServiceUnavailable = 'Billing service unavailable';
