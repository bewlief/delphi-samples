...
resourcestring
  ...
  SNetUriInvalidRelPath = 'Invalid relative URL path: "%s"';
  ...
  SNetHttpClientLibCurlNotFound = 'Error loading %s';
  ...
  SNetHttpCertFileOpenError = 'Error opening certificate file: (%d) %s';
  SNetHttpCertNotFoundError = 'Certificate is not found in file: (%d) %s';
  ...
  sSocketFailure = 'Network socket error on API ''%s''';
  ...
  sReceiveTimeout = 'Timeout to receive data from socket';
