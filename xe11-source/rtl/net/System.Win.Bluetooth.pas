...
begin
  ...
  begin
    ...
    LSearchParams.fReturnConnected := True;
  ...
  begin
    ...
    LSearchParams.cTimeoutMultiplier := Round((Timeout / 1000) / 1.28);
    if LSearchParams.cTimeoutMultiplier > 48 then
      LSearchParams.cTimeoutMultiplier := 48; //The maximum value for this member is 48
  end;
