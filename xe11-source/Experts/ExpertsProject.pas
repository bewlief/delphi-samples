...
type
  ...
  private
    ...
    FProjectPlatformTypes: TOSFamilySet;
  ...
  public
    ...
    property ProjectPlatformTypes: TOSFamilySet read FProjectPlatformTypes write FProjectPlatformTypes;
  end;
...
type
  TExpertsProjectAccessor = class(TInterfacedObject, IExpertsProjectAccessor, IExpertsProjectAccessor190)
  private
    FPersonality: string;
...
function TExpertsProjectAccessor.GetProjectPlatformTypes: TOSFamilySet;
begin
  Result := FExpertsProject.ProjectPlatformTypes;
end;
