...
resourcestring
  ...
  sInvalidDirectorName = 'Last folder name in project location must be a valid Delphi identifier.'#13#10 +
    'The name will be used as a project name.';
  ...
  sDataSnapServerCategory = 'DataSnap';  
...
const
  sCategoryDelphiDataSnap = 'Borland.Delphi.DataSnap'; { do not localize }
  sCategoryCBuilderDataSnap = 'Borland.CBuilder.DataSnap'; { do not localize }
