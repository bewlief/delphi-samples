...
begin
  if not (osfLinux in DSStandAloneProject.PlatformTypes) then
    Exit;
  LProject := GetActiveProject;
  if LProject <> nil then
  begin
    if not (osfLinux in DSStandAloneProject.ProjectPlatformTypes) then
      Exit;
...
begin
  ...
  case FProjectType of
    ...
    begin
      ...
      DSStandAloneProject.ProjectPlatformTypes := DSStandAloneProject.PlatformTypes + [osfLinux];
    end;
    ptService:
    begin
