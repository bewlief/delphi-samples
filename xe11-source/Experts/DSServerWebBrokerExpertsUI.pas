...
begin
  ...
  begin
    ...
    // Setting default project to Linux platform
    if osfLinux in PlatformTypes then
      TWebServerWizardFrame(ApplicationTypeWizardPage1.Frame).CreateNewIndyConsoleApp.Checked := true;
  end;
end;
