...
resourcestring
  ...
  sDuplicatedConverterType2 = 'The converter "%s" duplicates coverter "%s(%s, %s)"';
  ...
  sBoolOpFail = 'Don''t know how to perform boolean operation on "%s" and "%s"';
  sBoolNegateOpFail = 'Don''t know how to perform boolean negation of "%s"';
  ...
  sInvalidOperator = 'Invalid operator in source (%s%s)';
  ...
  sStringToBoolDesc = '';
  sBoolToInteger = 'BoolToInteger';
  sBoolToIntegerDesc = '';
  sIntegerToBool = 'IntegerToBool';
  sIntegerToBoolDesc = '';
  sBoolToFloat = 'BoolToFloat';
  sBoolToFloatDesc = '';
  sFloatToBool = 'FloatToBool';
  sFloatToBoolDesc = '';
