...
type
  ...
  /// <summary>Output conversion routine signature.</summary>
  TConvertProc3 = reference to procedure(var OutValue: TValue);
  ...
  private
    ...
    class var FOutputConverter: IValueRefConverter;
  public
    ...
    class function GetOutputConverter: IValueRefConverter;
  end;
  ...
  public
    ...
    /// <summary>Obtains supplementary information about a given location.</summary>
    /// <param name="Location">The location for which the information is going to be
    /// returned.</param>
    /// <param name="LocationRec">The supplementary information returned for the
    /// given location.</param>
    /// <returns>True if the supplementary location information has been successfully
  ...
  /// <summary>Utilities for assigning/converting one type of value to another type of value</summary>
  TConverterUtils = class
  public
{$IFNDEF NEXTGEN}
    /// <summary>Convert AnsiString to AnsiChar</summary>
    class procedure AnsiStringToAnsiChar(const I: TValue; var O: TValue); static;
    /// <summary>Convert String to AnsiChar</summary>
    class procedure StringToAnsiChar(const I: TValue; var O: TValue); static;
{$ENDIF}
    /// <summary>Convert Boolean to String</summary>
    class procedure BoolToString(const I: TValue; var O: TValue); static;
    /// <summary>Convert Boolean to Variant</summary>
    class procedure BoolToVariant(const I: TValue; var O: TValue); static;
    /// <summary>Convert Boolean to Integer</summary>
    class procedure BoolToInteger(const I: TValue; var O: TValue); static;
    /// <summary>Convert Boolean to Float</summary>
    class procedure BoolToFloat(const I: TValue; var O: TValue); static;
    /// <summary>Convert DateTime to String</summary>
    class procedure DateTimeToString(const I: TValue; var O: TValue); static;
    /// <summary>Convert Float to a type of integer</summary>
    class procedure FloatToInteger(const I: TValue; ATo: PTypeInfo; var O: TValue); static;
    /// <summary>Convert Float to a type of string</summary>
    class procedure FloatToString(const I: TValue; var O: TValue); static;
    /// <summary>Convert Float to a Variant</summary>
    class procedure FloatToVariant(const I: TValue; var O: TValue); static;
    /// <summary>Convert Float to a Boolean</summary>
    class procedure FloatToBool(const I: TValue; var O: TValue); static;
    /// <summary>Convert Integer to a String</summary>
    class procedure IntegerToString(const I: TValue; var O: TValue); static;
    /// <summary>Convert Integer to a Variant</summary>
    class procedure IntToVariant(const I: TValue; var O: TValue); static;
    /// <summary>Convert Integer to a Boolean</summary>
    class procedure IntegerToBool(const I: TValue; var O: TValue); static;
    /// <summary>Set value to False for Nil assignment</summary>
    class procedure NilToBoolean(var O: TValue); static;
    /// <summary>Set value to 0 DateTime  for Nil assignment</summary>
    class procedure NilToDateTime(var O: TValue); static;
    /// <summary>Set a value to 0  for Nil assignment</summary>
    class procedure NilToNumber(var O: TValue); static;
    /// <summary>Set a value to ""  for Nil assignment</summary>
    class procedure NilToString(var O: TValue); static;
    /// <summary>Clear a value containing TStrings for Nil assignment</summary>
    class procedure NilToTStrings(var O: TValue); static;
    /// <summary>Set Variant to '' for Nil assignment</summary>
    class procedure NilToVariant(var O: TValue); static;
    /// <summary>Assign TPersistent to TPersistent</summary>
    class procedure PersistentToPersistent(const I: TValue; var O: TValue); static;
    /// <summary>Assign string literal to represent TPersistent</summary>
    class procedure PersistentToString(const I: TValue; var O: TValue); static;
    /// <summary>Assign TStrings to string</summary>
    class procedure StringsToString(const I: TValue; var O: TValue); static;
    /// <summary>Assign String to Boolean</summary>
    class procedure StringToBool(const I: TValue; var O: TValue); static;
    /// <summary>Assign String to Char</summary>
    class procedure StringToChar(const I: TValue; var O: TValue); static;
    /// <summary>Assign String to Date</summary>
    class procedure StringToDate(const I: TValue; var O: TValue); static;
    /// <summary>Assign String to DateTime</summary>
    class procedure StringToDateTime(const I: TValue; var O: TValue); static;
    /// <summary>Assign String to Float</summary>
    class procedure StringToFloat(const I: TValue; ATo: PTypeInfo; var O: TValue); static;
    /// <summary>Assign String to Integer</summary>
    class procedure StringToInteger(const I: TValue; ATo: PTypeInfo;
      var O: TValue); static;
    /// <summary>Assign String to TStrings</summary>
    class procedure StringToStrings(const I: TValue; var O: TValue); static;
    /// <summary>Assign String to Time</summary>
    class procedure StringToTime(const I: TValue; var O: TValue); static;
    /// <summary>Assign String to Variant</summary>
    class procedure StringToVariant(const I: TValue; var O: TValue); static;
    /// <summary>Assign Variant to Boolean</summary>
    class procedure VariantToBool(const I: TValue; var O: TValue); static;
  end;

var
  GCollectAllDups: Boolean = False;

implementation

uses
  System.DateUtils, System.Bindings.NotifierContracts, System.Bindings.Graph,
...
// returns the manager of the given Owner object; it is used in conjunction with
...
begin
  if ClassType = '' then
    raise EBindOutputCallbackError.CreateRes(@sClassTypeNotFound);
...
begin
  if not TValueRefConverterFactory.HasConverter(ConverterID) then
    raise EBindConverterError.CreateResFmt(@sConverterIDNotRegistered, [ConverterID]);
...
begin
  ...
  try
    ...
    Value := LocationRec.CompiledBinding.Evaluate(LocationRec.Scope, nil, nil, FPreparedWrappers);
    if (not Supports(Value, ILocation, LocationRec.Location)) and
      ((Value.GetType = nil) or (Value.GetType^.Kind <> tkClass)) then
      raise EBindOutputError.CreateRes(@sOutputIsReadOnly);
    ...
    begin
      if Child = nil then
        raise EBindOutputError.CreateRes(@sUnavailNotifier);
...
begin
  ...
  raise EBindConverterError.CreateResFmt(@sConverterNotFound,
    [LName, AToType.Name]);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      raise EBindOutputError.CreateResFmt(@sUpdateOutputLocFailed, [Outpair.Key.ClassName, Outpair.Value]);
    end;
...
var
  LExistingConverter: TConverterDescription;
begin
  // StringToInteger, StringToChar
  if FConversions.TryGetValue(ConvPair, LExistingConverter) then
    if GCollectAllDups then
      FDuplicates.AppendLine(Format(sDuplicatedConverterType2, [AConverter.ID, LExistingConverter.ID, ConvPair.FromType.Name, ConvPair.ToType.Name]))
    else
      raise EBindConverterError.CreateResFmt(@sDuplicatedConverterType, [FConversions.Items[ConvPair].ID, ConvPair.FromType.Name, ConvPair.ToType.Name])
  else
...
begin
  ...
  FConversions.Capacity := 120;
  FDuplicates := TStringBuilder.Create;
end;
...
begin
  ...
  if ((AFrom <> nil) and (AFrom.Kind = tkUString)) or ((ATo <> nil) and (ATo.Kind = tkUString)) then
  begin
    // Support TCaption = type(string), for example
    StringTypeInfo := TypeInfo(string);
    Assert(StringTypeInfo.Kind = tkUString);
    if AFrom = nil then
      ATo := StringTypeInfo
    else if ATo = nil then
      AFrom := StringTypeInfo
    else if AFrom.Kind = ATo.Kind then
    begin
      AFrom := StringTypeInfo;
      ATo := StringTypeInfo;
    end
    else if AFrom.Kind = tkUString then
      AFrom := StringTypeInfo
    else
      ATo := StringTypeInfo;
  end;
...
begin
  ...
  try
    if Length(ConverterIDs) > 0 then
      ...
      begin
        if not FRegisteredConversions.TryGetValue(ConvID, ValuePair) then
          raise EBindConverterError.CreateResFmt(@sConverterIDNotRegistered, [ConvID]);
    ...
    if Result.FDuplicates.Length > 0 then
      raise EBindConverterError.Create(Result.FDuplicates.ToString(True));
  except
    on E: Exception do
    begin
      Result.Free;
...
class function TValueRefConverterFactory.GetOutputConverter: IValueRefConverter;
var
  UseConverters: TList<string>;
  ConvDesc: TConverterDescription;
begin
  if not Assigned(FOutputConverter) then
  begin
    ...
    try
      ...
      FOutputConverter := TValueRefConverterFactory.GetConverter(UseConverters.ToArray);
    finally
      UseConverters.Free;
    end;
  end;
...
begin
  if AID = '' then
    raise EBindConverterError.CreateRes(@sConverterIDNotFound);
...
constructor TConverterDescription.Create3(AConvertProc3: TConvertProc3; const AID,
  ADisplayName, AUnitName: string; ADefaultEnabled: Boolean; const ADescription: string; AFrameworkClass: TPersistentClass);
begin
  if AID = '' then
    raise EBindConverterError.CreateRes(@sConverterIDNotFound);
  FConvertProc3 := AConvertProc3;
  FDisplayName := ADisplayName;
  FUnitName := AUnitName;
  FID := AID;
  FDefaultEnabled := ADefaultEnabled;
...
const
  ...
  sIDPersistentToString = 'PersistentToString';
  sIDBoolToString = 'BoolToString';
  sIDStringToBool = 'StringToBool';
  sIDBoolToInteger = 'BoolToInteger';
  sIDIntegerToBool = 'IntegerToBool';
  sIDBoolToFloat = 'BoolToFloat';
  sIDFloatToBool = 'FloatToBool';
...
var
  ...
  LBooleanPTypeInfos: TArray<PTypeInfo>;
  LPersistentPTypeInfos: TArray<PTypeInfo>;
  LVariantPTypeInfos: TArray<PTypeInfo>;
  LTStringsPTypeInfos: TArray<PTypeInfo>;
begin
...
{$ENDIF}
  LBooleanPTypeInfos := TArray<PTypeInfo>.Create(TypeInfo(Boolean), TypeInfo(ByteBool), TypeInfo(WordBool), TypeInfo(LongBool));
  LPersistentPTypeInfos := TArray<PTypeInfo>.Create(TypeInfo(TPersistent));
  LVariantPTypeInfos := TArray<PTypeInfo>.Create(TypeInfo(Variant));
  LTStringsPTypeInfos := TArray<PTypeInfo>.Create(TypeInfo(TStrings));

  TValueRefConverterFactory.RegisterConversion(nil, TypeInfo(string),
    TConverterDescription.Create3(TConverterUtils.NilToString,
    sIDNilToString,
    sNilToString,
    '', True, sNilToStringDesc, nil)
  );
  TValueRefConverterFactory.RegisterConversion(nil, LBooleanPTypeInfos,
    TConverterDescription.Create3(TConverterUtils.NilToBoolean,
    sIDNilToBoolean,
    sNilToBoolean,
    '', True, sNilToBooleanDesc, nil)
  );
  TValueRefConverterFactory.RegisterConversion(nil, TypeInfo(Variant),
    TConverterDescription.Create3(TConverterUtils.NilToVariant,
    sIDNilToVariant,
    sNilToVariant,
  ...
  TValueRefConverterFactory.RegisterConversion(TArray<PTypeInfo>.Create(nil), LFloatPTypeInfos,
    TConverterDescription.Create3(TConverterUtils.NilToNumber,
    sIDNilToNumber,
    sNilToNumber,
  ...
  TValueRefConverterFactory.RegisterConversion(TArray<PTypeInfo>.Create(nil), LDateTimePTypeInfos,
    TConverterDescription.Create3(TConverterUtils.NilToDateTime,
    sIDNilToTDateTime,
    sNilToTDateTime,
  ...
  TValueRefConverterFactory.RegisterConversion(nil, TypeInfo(TStrings),
    TConverterDescription.Create3(TConverterUtils.NilToTStrings,
    sIDNilToTStrings,
    sNilToTStrings,
    '', True, sNilToTStringsDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LPersistentPTypeInfos, LPersistentPTypeInfos,
    TConverterDescription.Create(TConverterUtils.PersistentToPersistent,
    sIDPersistentToPersistent,
    sPersistentToPersistent,
    '', True, sPersistentToPersistentDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LPersistentPTypeInfos, LStringPTypeInfos,
    TConverterDescription.Create(TConverterUtils.PersistentToString,
    sIDPersistentToString,
    sPersistentToString,
    '', True, sPersistentToStringDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LBooleanPTypeInfos, LStringPTypeInfos,
    TConverterDescription.Create(TConverterUtils.BoolToString,
    sIDBoolToString,
    sBoolToString,
    '', True, sBoolToStringDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LStringPTypeInfos, LBooleanPTypeInfos,
    TConverterDescription.Create(TConverterUtils.StringToBool,
    sIDStringToBool,
    sStringToBool,
    '', True, sStringToBoolDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LBooleanPTypeInfos, LIntegerPTypeInfos,
    TConverterDescription.Create(TConverterUtils.BoolToInteger,
    sIDBoolToInteger,
    sBoolToInteger,
    '', True, sBoolToIntegerDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LIntegerPTypeInfos, LBooleanPTypeInfos,
    TConverterDescription.Create(TConverterUtils.IntegerToBool,
    sIDIntegerToBool,
    sIntegerToBool,
    '', True, sIntegerToBoolDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LBooleanPTypeInfos, LFloatPTypeInfos,
    TConverterDescription.Create(TConverterUtils.BoolToFloat,
    sIDBoolToFloat,
    sBoolToFloat,
    '', True, sBoolToFloatDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LFloatPTypeInfos, LBooleanPTypeInfos,
    TConverterDescription.Create(TConverterUtils.FloatToBool,
    sIDFloatToBool,
    sFloatToBool,
    '', True, sFloatToBoolDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LIntegerPTypeInfos, LStringPTypeInfos,
    TConverterDescription.Create(TConverterUtils.IntegerToString,
    sIDIntegerToString,
    sIntegerToString,
  ...
  TValueRefConverterFactory.RegisterConversion(LStringPTypeInfos, LIntegerPTypeInfos,
    TConverterDescription.Create2(TConverterUtils.StringToInteger,
    sIDStringToInteger,
    sStringToInteger,
  ...
  TValueRefConverterFactory.RegisterConversion(LFloatPTypeInfos, LStringPTypeInfos,
    TConverterDescription.Create(TConverterUtils.FloatToString,
    sIDFloatToString,
    sFloatToString,
  ...
  TValueRefConverterFactory.RegisterConversion(LStringPTypeInfos, LFloatPTypeInfos,
    TConverterDescription.Create2(TConverterUtils.StringToFloat,
    sIDStrToFloat,
    sStrToFloat,
    '', True, sStrToFloatDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LStringPTypeInfos, TArray<PTypeInfo>.Create(TypeInfo(TDateTime)),
    TConverterDescription.Create(TConverterUtils.StringToDateTime,
    sIDStrToTDateTime,
    sStrToTDateTime,
  ...
  TValueRefConverterFactory.RegisterConversion(LDateTimePTypeInfos, LStringPTypeInfos,
    TConverterDescription.Create(TConverterUtils.DateTimeToString,
    sIDTDateTimeToStr,
    sTDateTimeToStr,
    '', True, sTDateTimeToStrDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LStringPTypeInfos, TArray<PTypeInfo>.Create(TypeInfo(TDate)),
    TConverterDescription.Create(TConverterUtils.StringToDate,
    sIDStrToTDate,
    sStrToTDate,
    '', True, sStrToTDateDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LStringPTypeInfos, TArray<PTypeInfo>.Create(TypeInfo(TTime)),
    TConverterDescription.Create(TConverterUtils.StringToTime,
    sIDStrToTTime,
    sStrToTTime,
    '', True, sStrToTTimeDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LStringPTypeInfos, LVariantPTypeInfos,
    TConverterDescription.Create(TConverterUtils.StringToVariant,
    sIDStringToVariant,
    sStringToVariant,
    '', True, sStringToVariantDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LBooleanPTypeInfos, LVariantPTypeInfos,
    TConverterDescription.Create(TConverterUtils.BoolToVariant,
    sIDBoolToVariant,
    sBoolToVariant,
    '', True, sBoolToVariantDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LVariantPTypeInfos, LBooleanPTypeInfos,
    TConverterDescription.Create(TConverterUtils.VariantToBool,
    sIDVariantToBool,
    sVariantToBool,
    '', True, sVariantToBoolDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LFloatPTypeInfos, LVariantPTypeInfos,
    TConverterDescription.Create(TConverterUtils.FloatToVariant,
    sIDFloatToVariant,
    sFloatToVariant,
    '', True, sFloatToVariantDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LIntegerPTypeInfos, LVariantPTypeInfos,
    TConverterDescription.Create(TConverterUtils.IntToVariant,
    sIDIntToVariant,
    sIntToVariant,
  ...
  TValueRefConverterFactory.RegisterConversion(LFloatPTypeInfos, LIntegerPTypeInfos,
    TConverterDescription.Create2(TConverterUtils.FloatToInteger,
    sIDFloatToInteger,
    sFloatToInteger,
    '', True, sFloatToIntegerDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LTStringsPTypeInfos, LStringPTypeInfos,
    TConverterDescription.Create(TConverterUtils.StringsToString,
    sIDTStringsToString,
    sTStringsToString,
    '', True, sTStringToStringDesc, nil)
  );

  TValueRefConverterFactory.RegisterConversion(LStringPTypeInfos, LTStringsPTypeInfos,
    TConverterDescription.Create(TConverterUtils.StringToStrings,
    sIDStringToTStrings,
    sStringToTStrings,
  ...
  TValueRefConverterFactory.RegisterConversion(LStringPTypeInfos, TArray<PTypeInfo>.Create(TypeInfo(char)),
    TConverterDescription.Create(TConverterUtils.StringToChar,
    sIDStringToChar,
    sStringToChar,
...
//    TConverterDescription.Create(TConverterUtils.AnsiStringToAnsiChar,
//    sIDStringToChar,
//    sStringToChar,
//    '', True, sStringToCharDesc, nil)
//  );
...
//    TConverterDescription.Create(TConverterUtils.StringToAnsiChar,
//    sIDStringToChar,
//    sStringToChar,
//    '', True, sStringToCharDesc, nil)
//  );
...
class procedure TConverterUtils.StringToFloat(const I: TValue; ATo: PTypeInfo; var O: TValue);
var
  LCurr: Currency;
  LFloat: Extended;
  LValue: string;
begin
  ...
  if not TryStrToFloat(LValue, LFloat) then
    LFloat := 0.0;
  case GetTypeData(ATo)^.FloatType of
    ftCurr:
      if TryStrToCurr(LValue, LCurr) then
        TValue.Make<Currency>(LCurr, O)
      else
        TValue.Make<Currency>(0.00, O);
  else
    TValue.Make<Extended>(LFloat, O);
  end;
end;

class procedure TConverterUtils.NilToString(var O: TValue);
begin
  O := '';
end;

class procedure TConverterUtils.NilToBoolean(var O: TValue);
begin
  O := False;
end;

class procedure TConverterUtils.NilToVariant(var O: TValue);
begin
  TValue.Make<Variant>('', O);
end;

class procedure TConverterUtils.NilToNumber(var O: TValue);
begin
  O := 0;
end;

class procedure TConverterUtils.NilToDateTime(var O: TValue);
begin
  O := 0;
end;

class procedure TConverterUtils.NilToTStrings(var O: TValue);
var
  items: TStrings;
begin
...
class procedure TConverterUtils.PersistentToPersistent(const I: TValue; var O: TValue);
var
  oIn, oOut: TObject;
begin
  oIn := I.AsObject;
...
class procedure TConverterUtils.PersistentToString(const I: TValue; var O: TValue);
begin
  TValue.Make<string>('(OBJECT)', O);  // Do not localize
end;

class procedure TConverterUtils.BoolToString(const I: TValue; var O: TValue);
begin
  TValue.Make<string>(BoolToStr(I.AsBoolean, True), O);
end;

class procedure TConverterUtils.StringToBool(const I: TValue; var O: TValue);
var
  LBool: Boolean;
begin
  if not TryStrToBool(I.AsString, LBool) then
    LBool := False;
  TValue.Make<Boolean>(LBool, O);
end;

class procedure TConverterUtils.BoolToInteger(const I: TValue; var O: TValue);
begin
  if I.AsBoolean then
    TValue.Make<Integer>(-1, O)
  else
    TValue.Make<Integer>(0, O);
end;

class procedure TConverterUtils.IntegerToBool(const I: TValue; var O: TValue);
begin
  TValue.Make<Boolean>(I.AsInt64 <> 0, O);
end;

class procedure TConverterUtils.BoolToFloat(const I: TValue; var O: TValue);
begin
  if I.AsBoolean then
    TValue.Make<Extended>(-1.0, O)
  else
    TValue.Make<Extended>(0, O);
end;

class procedure TConverterUtils.FloatToBool(const I: TValue; var O: TValue);
begin
  TValue.Make<Boolean>(I.AsExtended <> 0, O);
end;

class procedure TConverterUtils.IntegerToString(const I: TValue; var O: TValue);
begin
  case I.TypeInfo.Kind of
    tkInteger:
      case I.TypeInfo.TypeData.OrdType of
        ...
        otSWord,
        otSLong:
          TValue.Make<string>(IntToStr(I.AsInteger), O);
        otUByte,
        otUWord,
        otULong:
          TValue.Make<string>(UIntToStr(I.AsType<UInt32>), O);
      end;
    tkInt64:
      with I.TypeInfo.TypeData^ do
        if MinInt64Value > MaxInt64Value then
          TValue.Make<string>(UIntToStr(I.AsType<UInt64>), O)
        else
          TValue.Make<string>(IntToStr(I.AsInt64), O);
  else
    Assert(False);
    O := TValue.Empty;
  end;
...
class procedure TConverterUtils.StringToInteger(const I: TValue; ATo: PTypeInfo; var O: TValue);
var
  val: string;
begin
  val := I.AsString;
    ...
    case ATo.Kind of
      tkInteger:
        case ATo.TypeData.OrdType of
          ...
          otSWord,
          otSLong:
            TValue.Make<Integer>(StrToInt(val), O);
          otUByte,
          otUWord,
          otULong:
            TValue.Make<UInt32>(StrToUInt64(val), O)
        end;
      tkInt64:
        with I.TypeInfo.TypeData^ do
          if MinInt64Value > MaxInt64Value then
            TValue.Make<UInt64>(StrToUInt64(val), O)
          else
            TValue.Make<Int64>(StrToInt64(val), O);
    else
      Assert(False);
      O := TValue.Empty;
    end;
...
class procedure TConverterUtils.FloatToString(const I: TValue; var O: TValue);
begin
  // Use System.Rtti conversions
  TValue.Make<string>(I.ToString, O);
end;

class procedure TConverterUtils.StringToDateTime(const I: TValue; var O: TValue);
var
  LDateTime: TDateTime;
begin
  if TryStrToDateTIme(I.AsString, LDateTime) then
    TValue.Make<TDateTime>(LDateTime, O)
  else
    O := TValue.Empty;
end;

class procedure TConverterUtils.DateTimeToString(const I: TValue; var O: TValue);
begin
  // Use System.Rtti conversions
  TValue.Make<string>(I.ToString, O);
end;

class procedure TConverterUtils.StringToDate(const I: TValue; var O: TValue);
var
  LDate: TDateTime;
begin
  if TryStrToDate(I.AsString, LDate) then
    TValue.Make<TDate>(LDate, O)
  else if TryStrToDateTIme(I.AsString, LDate) then
    TValue.Make<TDate>(DateOf(LDate), O)
  else
    O := TValue.Empty;
end;


class procedure TConverterUtils.StringToTime(const I: TValue; var O: TValue);
var
  LTime: TDateTime;
begin
  if TryStrToDate(I.AsString, LTime) then
    TValue.Make<TTime>(LTime, O)
  else if TryStrToDateTIme(I.AsString, LTime) then
    TValue.Make<TTime>(TimeOf(LTime), O)
  else
    O := TValue.Empty;
end;


class procedure TConverterUtils.StringToVariant(const I: TValue; var O: TValue);
begin
  TValue.Make<Variant>(I.AsString, O);
end;

class procedure TConverterUtils.BoolToVariant(const I: TValue; var O: TValue);
var
  LVariant: Variant;
begin
  LVariant := I.AsBoolean;
  TValue.Make<Variant>(LVariant, O);
end;

class procedure TConverterUtils.VariantToBool(const I: TValue; var O: TValue);
var
  LBool: Boolean;
begin
  LBool := I.AsVariant;
...
class procedure TConverterUtils.FloatToVariant(const I: TValue; var O: TValue);
begin
  TValue.Make<Variant>(I.AsExtended, O);
end;

class procedure TConverterUtils.IntToVariant(const I: TValue; var O: TValue);
begin
  TValue.Make<Variant>(I.AsInt64, O);
end;

class procedure TConverterUtils.FloatToInteger(const I: TValue; ATo: PTypeInfo; var O: TValue);
begin
  case ATo.Kind of
    tkInteger:
      case ATo.TypeData.OrdType of
        ...
        otSWord,
        otSLong:
          TValue.Make<Integer>(Round(I.AsExtended), O);
        otUByte,
        otUWord,
        otULong:
          TValue.Make<UInt32>(Round(I.AsExtended), O)
      end;
    tkInt64:
      with I.TypeInfo.TypeData^ do
        if MinInt64Value > MaxInt64Value then
          TValue.Make<UInt64>(Round(I.AsExtended), O)
        else
          TValue.Make<Int64>(Round(I.AsExtended), O);
  else
    Assert(False);
    O := TValue.Empty;
  end;
...
class procedure TConverterUtils.StringsToString(const I: TValue; var O: TValue);
var
  oIn: TStrings;
begin
  if I.IsEmpty then
...
class procedure TConverterUtils.StringToChar(const I: TValue; var O: TValue);
var
  s: Char;
  c: Char;
begin
  ...
  TValue.Make<Char>(c, O);
end;

{$IFNDEF NEXTGEN}
class procedure TConverterUtils.AnsiStringToAnsiChar(const I: TValue; var O: TValue);
var
  s: AnsiChar;
  c: AnsiChar;
begin
  ...
  TValue.Make<AnsiChar>(c, O);
end;

class procedure TConverterUtils.StringToAnsiChar(const I: TValue; var O: TValue);
var
  s: Char;
  c: AnsiChar;
begin
