...
resourcestring
  ...
  sIDAttr = 'ID';
  sStateAttr = 'State';
  sNoDataSet = 'Error in %0:s.  No dataset.';
  ...
  sSelectedValueDesc = 'Bidirectional method to either get the selected value in a control,'#13#10 +
     ...
     'Example usage when binding to a TListBox:'#13#10 +
     '  SelectedLookupValue(Self).AsString';
  sSelectedDateTime = 'SelectedDateTime';
  sSelectedDateTimeDesc = 'Bidirectional method to either get the selected DateTime in a control,'#13#10 +
     'or set the selected DateTime value in a control'#13#10 +
    'Example usage when binding to a TCustomDateTimeEdit:'#13#10 +
    '   SelectedDateTime(Self)';
  sLookup = 'Lookup';
  ...
  sScopeRecordEnumIncompatible = 'Error configuring %s: Object must implement IScopeRecordEnumerable';
