...
uses System.SysUtils, System.Classes, Data.Bind.Components, Data.Bind.DBScope, FMX.Types, FMX.Edit, FMX.Controls,
  System.Bindings.Outputs, Data.Bind.DBLinks, Data.DB, FMX.Grid, System.Generics.Collections;
...
procedure TCustomBindDBGridLink.DefineProperties(Filer: TFiler);
begin
  inherited;
...
procedure TCustomBindDBGridLink.ReadBoolean(Reader: TReader);
begin
  Reader.ReadBoolean;
end;

procedure TCustomBindDBGridLink.ReadInteger(Reader: TReader);
begin
  Reader.ReadInteger;
end;
