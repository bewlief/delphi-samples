...
begin
  begin
    ...
    if (CurProcess <> nil) and (CurProcess.GetProcessType <> optOSX32) and (CurProcess.GetProcessType <> optOSX64) and
      (CurProcess.GetProcessType <> optOSXArm64) then
    begin
      ...
      begin
        ...
        begin
          Done := True;
          EvalRes := CurThread.Evaluate(Expression+'.c_str()', @ResultStr, Length(ResultStr),
