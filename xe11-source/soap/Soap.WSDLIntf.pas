...
uses
  System.Generics.Collections, System.Classes, Xml.xmldom;
...
type
  ...
  ['{395CDFB2-1D10-4A37-AC16-393D569676F0}']
    ...
    function GetTransport: IInterface;

    property Transport: IInterface read GetTransport;
  ...
  IStreamLoaderCustomizer = interface
