...
type
  ...
  private
    FWSDLStreamLoaderCustomizer: IStreamLoaderCustomizer;
  ...
  public
    ...
    property StreamLoaderCustomizer: IStreamLoaderCustomizer read FWSDLStreamLoaderCustomizer write FWSDLStreamLoaderCustomizer;
