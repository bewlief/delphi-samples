...
(*$HPPEMIT '' *)
(*$HPPEMIT '// URLMON.H defines a global IBinding which causes ambiguities' *)
(*$HPPEMIT '#if !defined(_DECLARE_USING_NAMESPACE_WSDLBIND)' *)
(*$HPPEMIT '  #define NO_USING_NAMESPACE_WSDLBIND' *)
(*$HPPEMIT '#endif' *)
(*$HPPEMIT '' *)
{$ENDIF}
...
uses
  Xml.XMLDoc, Xml.XMLIntf, Xml.XMLSchema;
...
{ IParts }
  ...
  IParts = interface(IXMLNodeCollection)
    ...
    { Methods & Properties }
    function Add(const Name, Element: string; const AType: string = ''): IPart;
...
{ IMessages }
  ...
  IMessages = interface(IXMLNodeCollection)
    ...
    { Methods & Properties }
    function Add(const Name: string): IMessage;
...
{ IFault }
  ...
  IFaults = interface(IXMLNodeCollection)
    ...
    { Methods & Properties }
    function Add(const Name, Message: string): IFault;
...
{ IOperations }
  ...
  IOperations = interface(IXMLNodeCollection)
    ...
    { Methods & Properties }
    function Add(const Name: string): IOperation; overload;
    // Review with Ramesh....
    function Add(const Name, InputMessage, InputName, OutputMessage: string): IOperation; overload;
...
{ IPortTypes }
  ...
  IPortTypes = interface(IXMLNodeCollection)
    ...
    { Methods & Properties }
    function Add(const Name: string): IPortType;
...
{ IBindingOperations }
  ...
  IBindingOperations = interface(IXMLNodeCollection)
    ...
    { Methods & Properties }
    function Add(const Name: string): IBindingOperation;
...
{ IBindings }
  ...
  IBindings = interface(IXMLNodeCollection)
    ...
    { Methods & Properties }
    function Add(const Name, AType: string): IBinding;
...
{ IPort }
  ...
  IPort = interface(IDocumented)
    ...
    procedure SetName(Value: string);
    procedure SetBinding(Value: string);
    { Methods & Properties }
    property Name: string read GetName write SetName;
...
{ IPorts }
  ...
  IPorts = interface(IXMLNodeCollection)
    ...
    { Methods & Properties }
    function Add(const Name, ABinding: string): IPort;
...
{ IServices }
  ...
  IServices = interface(IXMLNodeCollection)
    ...
    { Methods & Properties }
    function Add(const Name: string): IService;
...
{ IDefinition }
  ...
  IDefinition = interface(IXMLNode)
    ...
    procedure SetTargetNamespace(Value: string);
    procedure SetName(Value: string);
    { Methods & Properties }
    property Name: string read GetName write SetName;
    property TargetNamespace: string read GetTargetNamespace write SetTargetNamespace;
...
{ TParam }
  ...
  TFault = class(TParam, IParam, IFault, IBindingInput, IBindingOutput)
  end;
...
{ TPortTypes }
  ...
  protected
    { IPortTypes }
    function Add(const Name: string): IPortType; overload;
    function Insert(Index: Integer): IPortType;
    function GetPortType(Index: Integer): IPortType;
  end;
...
{ TPorts }
  ...
  protected
    { IPorts }
    function GetPort(Index: Integer): IPort;
    function Add(const Name, Binding: string): IPort;
    function Insert(Index: Integer): IPort;
  end;
...
function LoadWSDLDoc(const FileName: string): IWSDLDocument;
function NewWSDLDoc: IWSDLDocument;

implementation

uses
  Soap.WSDLIntf, Xml.XMLSchemaTags;
...
function TDocumentationCollection.Add(const Text: string): IDocumentation;
begin
...
function TImport.GetNamespace: string;
begin
  Result := AttributeNodes[SNamespace].Text;
end;

procedure TImport.SetNamespace(Value: string);
begin
  SetAttribute(SNamespace, Value);
end;

function TImport.GetLocation: string;
begin
  Result := AttributeNodes[SLocation].Text;
end;

procedure TImport.SetLocation(Value: string);
begin
...
function TImports.Add(const Namespace, Location: string): IImport;
begin
...
function TXMLSchemaDefs.Add(const NamespaceURI, TargetNamespace: string): IXMLSchemaDef;
var
  ItemNS: string;
begin
...
procedure TPart.SetName(Value: string);
begin
  SetAttribute(SName, Value);
end;

function TPart.GetType_: string;
begin
  Result := AttributeNodes[SType].Text;
end;

procedure TPart.SetType_(Value: string);
begin
  SetAttribute(SType, Value);
end;

function TPart.GetElement: string;
begin
  Result := AttributeNodes[SElement].Text;
end;

procedure TPart.SetElement(Value: string);
begin
...
function TParts.Add(const Name, Element: string; const AType: string = ''): IPart;
begin
...
procedure TMessage.SetName(Value: string);
begin
  SetAttribute(SName, Value);
end;
...
function TMessages.Add(const Name: string): IMessage;
begin
...
procedure TParam.SetName(Value: string);
begin
  SetAttribute(SName, Value);
end;

function TParam.GetMessage: string;
begin
  Result := AttributeNodes[SMessage].Text;
end;

procedure TParam.SetMessage(Value: string);
begin
...
function TFaults.Add(const Name, Message: string): IFault;
begin
...
begin
  RegisterChildNodes([SInput, SOutput, SFault], [TParam, TParam, TFault]);
  FFaults := CreateCollection(TFaults, IFault, SFault) as IFaults;
  inherited;
end;

function TOperation.GetName: string;
begin
  Result := AttributeNodes[SName].Text;
end;

procedure TOperation.SetName(Value: string);
begin
  SetAttribute(SName, Value);
end;
...
function TOperations.Add(const Name: string): IOperation;
begin
...
function TOperations.Add(const Name, InputMessage, InputName,
  OutputMessage: string): IOperation;
begin
  Result := Add(Name);
...
function TPortType.GetName: string;
begin
  Result := AttributeNodes[SName].Text;
end;

procedure TPortType.SetName(Value: string);
begin
  SetAttribute(SName, Value);
end;
...
function TPorTTypes.Add(const Name: string): IPortType;
begin
...
function TBindingOperation.GetName: string;
begin
  Result := AttributeNodes[SName].Text;
end;

procedure TBindingOperation.SetName(Value: string);
begin
  SetAttribute(SName, Value);
end;
...
function TBindingOperations.Add(const Name: string): IBindingOperation;
begin
...
procedure TBinding.SetName(Value: string);
begin
  SetAttribute(SName, Value);
end;

function TBinding.GetType_: string;
begin
  Result := AttributeNodes[SType].Text;
end;

procedure TBinding.SetType_(Value: string);
begin
  SetAttribute(SType, Value);
end;
...
function TBindings.Add(const Name, AType: string): IBinding;
begin
...
function TPort.GetName: string;
begin
  Result := AttributeNodes[SName].Text;
end;

procedure TPort.SetName(Value: string);
begin
  SetAttribute(SName, Value);
end;

function TPort.GetBinding: string;
begin
  Result := AttributeNodes[SBinding].Text;
end;

procedure TPort.SetBinding(Value: string);
begin
...
function TPorts.Add(const Name, Binding: string): IPort;
begin
...
procedure TService.SetName(Value: string);
begin
  SetAttribute(SName, Value);
end;
...
function TServices.Add(const Name: string): IService;
begin
...
function TDefinition.GetTargetNamespace: string;
begin
  Result := AttributeNodes[STargetNamespace].Text;
end;

procedure TDefinition.SetTargetNamespace(Value: string);
begin
...
procedure TDefinition.SetName(Value: string);
begin
  SetAttribute(SName, Value);
end;
