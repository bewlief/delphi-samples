...
uses
  System.Classes, System.SysUtils, System.Masks, Soap.SOAPAttachIntf, Soap.SOAPHTTPDisp,
  Web.AutoDisp, Web.HTTPApp;

type
  TSoapDispatcherException = procedure(Sender: TObject; Request: TWebRequest;
  ...
  private
    ...
    FOnException: TSoapDispatcherException;
  ...
  published
    ...
    property OnException: TSoapDispatcherException read FOnException write FOnException;
  end;
