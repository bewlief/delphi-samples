...
uses
  System.Classes, System.Rtti, Soap.IntfInfo, Soap.OPConvert, System.IOUtils,
...
uses
  ...
  System.SysUtils, {$IFNDEF AUTOREFCOUNT} System.SyncObjs, {$ENDIF !AUTOREFCOUNT}
...
begin
  FTempFile := TPath.Combine(GetTempDir, 'EmbarcaderoSoapMimeCache');
