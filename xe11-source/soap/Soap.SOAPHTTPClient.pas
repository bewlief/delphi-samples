...
begin
  ...
  begin
    if Assigned(FHTTPWebNode) and (FHTTPWebNode.WSDLView = FWSDLView) then
      FHTTPWebNode.WSDLView := nil;
    if Assigned(FDomConverter) and (FDOMConverter.WSDLView = FWSDLView) then
