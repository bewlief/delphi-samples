...
sStandardSourceInclude =
                     '#pragma hdrstop'                         + sLineBreak +
                                                                 sLineBreak +
                     '#include "%0:s.h"'                       + sLineBreak + sLineBreak;
...
sHdrGuardBegin     = '#ifndef   %0:sH'                         + sLineBreak +
                     ...
                     '#include <Soap.InvokeRegistry.hpp>'      + sLineBreak +
                     '#include <Soap.XSBuiltIns.hpp>'          + sLineBreak;

sClientHeaders     = '#include <Soap.SOAPHTTPClient.hpp>'      + sLineBreak + sLineBreak;
...
sImplDecl          = 'class T%0:sImpl : public Soap::Invokeregistry::TInvokableClass, public %0:s'+ sLineBreak +
                     '{'                                                                          + sLineBreak +
...
sRemoteClsDtrImplPas3 = '  for I := 0 to System.Length(%0:s)-1 do'   + sLineBreak +
                        '    System.SysUtils.FreeAndNil(%0:s[I]);'   + sLineBreak +
...
{$ENDIF}
{$IFDEF USE_FREE_AND_NIL}
sRemoteClsDtrImplPas4 = '  System.SysUtils.FreeAndNil(%0:s);'        + sLineBreak;
{$ELSE}
...
sMergeDuplicateTypes = 'Merge duplicate types';
...
sSkipUnusedTypesForCommandLineHelp   = 'Do not emit unused types';
sImportFaultsForCommandLineHelp      = 'Import Fault Types';
sValidateEnumForCommandLineHelp      = 'Validate Enumeration members';
sImportHeadersForCommandLineHelp     = 'Import Header Types';
sGenTrueGUIDForCommandLineHelp       = 'Generate interface GUIDs using COM API';
//sCollapseAliasesForCommandLineHelp   = 'Collapse simple alias types';
sForceSOAP11ForCommandLineHelp       = 'Process only WSDL Binding extensions for the SOAP 1.1 Protocol';
sForceSOAP12ForCommandLineHelp       = 'Process only WSDL Binding extensions for the SOAP 1.2 Protocol';
sOneOutParamIsReturnForCommandLineHelp = 'One out parameter is return value';
sGenServerImplForCommandLineHelp     = 'Generate server implementation instead of client proxies';
sGenerateWarningsForCommandLineHelp  = 'Generate warning comments';
sAmbiguousComplexTypesAsArrayForCommandLineHelp = 'Ambiguous Complex Types are considered arrays';
sAutoDestroyMembersForCommandLineHelp = 'Generate destructors for remotable types';
sMapStringsToWideStringsForCommandLineHelp = 'Map String to WideString';
sOutputLiteralTypesForCommandLineHelp = 'Emit wrapper element Types';
sUnwindLiteralTypesForCommandLineHelp = 'Unwrap wrapper elements (wrapped doc|lit services)';
sIgnoreSchemaErrorsForCommandLineHelp = 'Ignore Schema Errors';

sProcessRefSchemasForCommandLineHelp = 'Process included and imported schemas';
sStrongClassAliasesForCommandLineHelp= 'Generate class aliases as class types';
sAllowOutParametersForCommandLineHelp     = 'Allow out parameters';
sUseSettersAndGettersForCommandLineHelp   = 'Use Setters and Getters for properties';
sProcessNillableOptionalForCommandLineHelp= 'Process nillable and optional elements';
sUseXSTypeForSimpleNillableForCommandLineHelp = 'Use TXSxxxx classes for simple nillable types';
sUseScopedEnumerationsForCommandLineHelp = 'Generate scoped enumerations';
sCreateArrayElemTypeAliasForCommandLineHelp = 'Generate alias for the element of pure collections';
sMergeDuplicateTypesHelp = 'Merge duplicate types';
...
CannotUnwrapStr: array[CannotUnwrap] of String = (
  ...
  MergeDuplicateTypes       = 'MergeDuplicateTypes';   { do not localize }
  ...
  OptStrings: array[WSDLGenFlags] of string  =
                ('',                                { wfDebug }
                 ...
                 MergeDuplicateTypes,               { wfMergeDuplicateTypes }
                 ''                                 { wfLastOption }
                 );
  ...
  OptDescriptions: array[WSDLGenFlags] of string =
                ('',                                { wfDebug }
                 ...
                 sMergeDuplicateTypes,              { wfMergeDuplicateTypes }
                 ''                                 { wfLastOption }
                 );
  ...
  OptDescriptionsForCommandLineHelp: array[WSDLGenFlags] of string =
                ('',                                              { wfDebug }
                 ...
                 sGenServerImplForCommandLineHelp,                { wfServer }
                 '',                                              { wfUseXMLBindingManager }
                 sAmbiguousComplexTypesAsArrayForCommandLineHelp, { wfAmbiguousComplexTypesAsArray }
                 sUnwindLiteralTypesForCommandLineHelp,           { wfUnwindLiteralTypes }
                 sOutputLiteralTypesForCommandLineHelp,           { wfOutputLiterayTypes }
                 sMapStringsToWideStringsForCommandLineHelp,      { wfMapStringsToWideStrings }
                 sIgnoreSchemaErrorsForCommandLineHelp,           { wfIgnoreSchemaErrors }
                 '',                                              { wfAutoInitMembers }
                 sAutoDestroyMembersForCommandLineHelp,           { wfAutoDestroyMembers }
                 '',                                              { wfQuietMode }
                 '',                                              { wfSelectiveCodeGen }
                 sGenerateWarningsForCommandLineHelp,             { wfGenerateWarnings }
                 sMapNamedArraysForCommandLineHelp,               { wfMapArraysToClasses }
                 '',                                              { wfTypesInNamespace }
                 sSkipUnusedTypesForCommandLineHelp,              { wfSkipUnusedTypes }
                 '',                                              { wfUseSerializerClassForAttrs }
                 sValidateEnumForCommandLineHelp,                 { wfValidateEnumMembers }
                 sImportFaultsForCommandLineHelp,                 { wfProcessFaults }
                 sImportHeadersForCommandLineHelp,                { wfProcessHeaders }
                 sGenTrueGUIDForCommandLineHelp,                  { wfGenTrueGUIDs }
                 sProcessRefSchemasForCommandLineHelp,            { wfProcessRefSchemas }
                 sStrongClassAliasesForCommandLineHelp,           { wfStrongClassAliases }
                 sAllowOutParametersForCommandLineHelp,           { wfAllowOutParameters }
                 sUseSettersAndGettersForCommandLineHelp,         { wfUseSettersAndGetters }
                 sProcessNillableOptionalForCommandLineHelp,      { wfProcessNillableOptional }
                 sUseXSTypeForSimpleNillableForCommandLineHelp,   { wfUseXSTypeForSimpleNillable }
                 sUseScopedEnumerationsForCommandLineHelp,        { wfUseScopedEnumerations }
                 sForceSOAP11ForCommandLineHelp,                  { wfForceSOAP11 }
                 sForceSOAP12ForCommandLineHelp,                  { wfForceSOAP12 }
                 sCreateArrayElemTypeAliasForCommandLineHelp,     { wfCreateArrayElemTypeAlias }
                 sMergeDuplicateTypesHelp,                        { wfMergeDuplicateTypes }
                 ''                                               { wfLastOption }
                 );
