...
type
  ...
  IVGModel = Interface(IVGModel210)
    ['{14E1FBF7-442E-4DD7-B3CC-7CFA59B935D6}']
    function IsElementSelected(AElementID: Integer): Boolean;
  End;
  ...
  IVGModule = Interface(IVGModule190)
    ['{829CF722-6B2E-4812-B43D-9269999035D5}']
    function LockDesignerSelection: Boolean;
    procedure UnlockDesignerSelection;
  End;
  ...
  IVGDrawingBase = interface
    ['{F3188CF6-C9C6-4418-9AB6-2BFA344D6D9A}']
  ...
  IVGDrawing280 = interface(IVGDrawingBase)
    ['{7BC31E12-B5E9-4D06-85A8-E2249C7CA837}']
    function AddImage(const AImageName: string; const AImage: TGraphicArray): Integer;
  end;

  IVGDrawing = interface(IVGDrawing280)
