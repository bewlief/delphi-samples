...
uses Winapi.Windows, Winapi.ActiveX, System.SysUtils, System.Classes, Vcl.AxCtrls,
{$IFNDEF PARSER_TEST}
  ToolsAPI
{$ELSE} 
  ToolsAPI4Testing
...
constructor TIMemoryStream.Create(Stream: TMemoryStream; Ownership: TStreamOwnership);
begin
  if Stream = nil then
  begin
    Ownership := soOwned;
