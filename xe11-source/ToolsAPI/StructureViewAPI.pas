...
uses
  Winapi.Windows, Winapi.CommCtrl, System.SysUtils, System.Classes, Vcl.Menus,
  Vcl.Controls, Winapi.ActiveX, ToolsAPI, Vcl.VirtualImageList, VCL.Graphics;
...
type
  ...
  /// <summary>
  ///  This interface provide possibility to add Images from sent TVirtualImageList
  ///  into IDEImageCollection and defined TVirtualImageList.
  /// </summary>
  IOTAStructureView280 = interface(IOTAStructureView110)
    ['{D54B2624-1411-48D1-8FD1-559373FD141E}']
    function AddImage(const AImageName: string; const AImage: TGraphicArray; StateImage: WordBool = False): Integer; safecall;
    function AddVirtualImageList(AVirtualImageList: TVirtualImageList; StateImage: WordBool = False): Integer; safecall;
  end;
