...
type
  ...
  strict private
    ...
    procedure GetSectionValues(const Section: string; const Strings: TStrings);
  public
...
{$IFDEF LONGINT64}
function TXmlIniFile.ReadInteger(const Section, Ident: string; Default: Integer): Integer;
{$ELSE !LONGINT64}
...
{$IFDEF LONGINT64}
procedure TXmlIniFile.WriteInteger(const Section, Ident: string; Value: Integer);
{$ELSE !LONGINT64}
...
procedure TXmlIniFile.GetSectionValues(const Section: string; const Strings: TStrings);
var
  I: Integer;
...
procedure TXmlIniFile.GetStrings(const List: TStrings);
var
  I: Integer;
  Section: string;
  Sections: TStrings;
...
{$IFDEF LONGINT64}
function TXmlMemIniFile.ReadInteger(const Section, Ident: string; Default: Integer): Integer;
{$ELSE !LONGINT64}
