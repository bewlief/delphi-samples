...
resourcestring
  ...
  SInvalidTargetNS = 'Included schema file "%s" has an invalid targetNamespace.' + sLineBreak + sLineBreak +
                     'Expected: %s' + sLineBreak + 'Found: %s';
  ...
  sReason = 'Reason: %s' + sLineBreak;
  sLinePosError = 'Error on line %d, position %d';
  sXMLParseError = 'XML Parse Error:' + sLineBreak;
