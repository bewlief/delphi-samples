...
uses Winapi.Windows, Winapi.Messages, Winapi.ActiveX, System.SysUtils, System.Classes, System.Win.ComObj;
...
begin
  ...
  if (FServer <> nil) and IsEqualIID(IID, FServer.FServerData^.EventIID) then
  begin
