...
unit Vcl.Samples.Calendar;

interface

uses System.Classes, Vcl.Controls, Winapi.Messages, Winapi.Windows, Vcl.Forms, Vcl.Graphics, Vcl.StdCtrls,
...
type
  ...
  protected
    ...
    procedure RecalcColumns(AHeight, AWidth: Integer);
  public
...
procedure TCalendar.ChangeScale(M, D: Integer);
begin
  inherited ChangeScale(M, D);
  RecalcColumns(Height, Width);
end;
...
begin
  RecalcColumns(Message.Height, Message.Width);
end;

procedure TCalendar.RecalcColumns(AHeight, AWidth: Integer);
var
  GridLines: Integer;
begin
