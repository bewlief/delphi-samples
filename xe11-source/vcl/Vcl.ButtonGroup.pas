...
procedure TButtonGroup.ChangeScale(M, D: Integer; isDpiChange: Boolean);
begin
  inherited;
...
procedure TButtonGroup.CheckImageIndexes;
var
  I: Integer;
begin
...
begin
  ...
  try
    ...
    if IsCustomStyleActive and not (seClient in StyleElements) then
    begin
      LColor := Color;
...
procedure TGrpButtonItem.CheckImageIndexAndName;
var
  LImages: TCustomImageList;
begin
  if ButtonGroup <> nil then
    LImages := ButtonGroup.Images
  else
    LImages := nil;
