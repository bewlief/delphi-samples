...
begin
  ...
  begin
    ...
    begin
      ...
      LRGBQuad.rgbRed := LRGBQuad.rgbRed * Alpha div 255;
      LRGBQuad.rgbGreen := LRGBQuad.rgbGreen * Alpha div 255;
      LRGBQuad.rgbBlue := LRGBQuad.rgbBlue * Alpha div 255;
      Inc(LRGBQuad);
    end;
  end;
end;
...
begin
  ...
  { We must work in 24-bit or 32-bit to ensure the pixel layout for
    scanline is correct }
