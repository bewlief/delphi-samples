...
resourcestring
  ...
  EPNGUnknownColorTypeText = 'This "Portable Network Graphics" image uses ' +
    'an unknown color type which could not be decoded.';
  ...
  EPNGInvalidBitDepthText = 'The "Portable Network Graphics" image could not be loaded ' +
    'because it uses an invalid image bit depth.';
