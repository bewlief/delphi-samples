...
{ TWinHelpViewer.
  ...
  private
   ...
   FLastCommand: String;
   FLastContext: THelpContext;
   function IsNewQuery(QueryType: TWHCommandType; Command: String; Context: ThelpContext): Boolean;
...
function TWinHelpViewer.UnderstandsContext(const ContextID: THelpContext;
  const HelpFileName: String): Boolean;
begin
{$IF NOT DEFINED(LINUX)}
  Result := True;
...
procedure TWinHelpViewer.DisplayHelpByContext(const ContextID: THelpContext;
                                              const HelpFileName: String);
var
   FileName: String;
begin
...
function TWinHelpViewer.IsNewQuery(QueryType: TWHCommandType; Command: String; Context: THelpContext): Boolean;
var
