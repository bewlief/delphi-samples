...
type
  ...
  public
    ...
    /// <summary>Property to manage the list of files that is going to be shared</summary>
...
function TCustomSharingContract.GetFileList: TStrings;
begin
  Result := FShareContract.FileList;
end;
...
procedure TCustomSharingContract.SetFileList(const Value: TStrings);
var
  MyElem: String;
begin
  if FShareContract <> nil then
  begin
    FShareContract.FileList.Clear;
    for MyElem in Value do
      FShareContract.FileList.Add(MyElem);
  end;
end;
