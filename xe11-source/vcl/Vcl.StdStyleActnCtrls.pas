...
function TStandardStyleActionBars.GetScrollBtnClass(ActionBar: TCustomActionBar): TCustomToolScrollBtnClass;
begin
  if TStyleManager.IsCustomStyleActive then
    Result := PlatformDefaultStyle.GetScrollBtnClass(ActionBar)
  else
