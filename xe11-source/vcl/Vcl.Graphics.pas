...
begin
  ...
  begin
    ...
    if FImage.FPalette <> 0 then
    begin
      OldPalette := SelectPalette(ACanvas.FHandle, FImage.FPalette, True);
    ...
    DoHalftone := (BPP <= 8) and (BPP < (FImage.FDIB.dsBm.bmBitsPixel * FImage.FDIB.dsBm.bmPlanes));
    if DoHalftone then
    begin
    ...
    try
      ...
      begin
        ...
        try
          ...
          Save := SelectObject(MaskDC, FImage.FMaskHandle);
          TransparentStretchBlt(ACanvas.FHandle, Left, Top, Right - Left,
            Bottom - Top, Canvas.FHandle, 0, 0, FImage.FDIB.dsbm.bmWidth,
            FImage.FDIB.dsbm.bmHeight, MaskDC, 0, 0);
        finally
      ...
      begin
        ...
        Winapi.Windows.AlphaBlend(ACanvas.Handle, Left, Top, Right - Left, Bottom - Top,
          Canvas.FHandle, 0, 0, FImage.FDIB.dsbm.bmWidth, FImage.FDIB.dsbm.bmHeight, BF);
      end
      else
        StretchBlt(ACanvas.FHandle, Left, Top, Right - Left, Bottom - Top,
          Canvas.FHandle, 0, 0, FImage.FDIB.dsbm.bmWidth,
          FImage.FDIB.dsbm.bmHeight, ACanvas.CopyMode);
    finally
...
begin
  ...
  begin
    ...
    try
      ...
      else if FImage.FDIB.dsBmih.biBitCount = 32 then
      begin
