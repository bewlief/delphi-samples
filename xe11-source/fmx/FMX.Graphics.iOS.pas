...
{ TBitmapCodecQuartz }
  ...
  private
    ...
    function ImageToSurface(const Img: CGImageRef; const Bitmap: TBitmapSurface; const MaxSizeLimit: Cardinal): Boolean;
...
uses
  ...
  FMX.Canvas.GPU, FMX.Context.GLES.iOS, FMX.Context.Metal, FMX.Types;
