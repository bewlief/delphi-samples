...
uses
  System.SysUtils, System.DateUtils, FMX.Types, FMX.Platform, FMX.BehaviorManager, FMX.Calendar.Style 
  {$IFDEF IOS}, FMX.Calendar.iOS{$ENDIF}{$IFDEF ANDROID}, FMX.Calendar.Android{$ENDIF};
