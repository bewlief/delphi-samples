...
uses
  System.TypInfo, System.Types, System.Classes, Winapi.Windows, FMX.Types, FMX.Controls.Presentation, FMX.Memo.Types,
  FMX.Memo, FMX.Presentation.Messages, FMX.Presentation.Win, Winapi.Messages, FMX.Controls.Model, FMX.Controls.Win,
  FMX.ScrollBox, FMX.Text;
...
uses
  System.UITypes, System.SysUtils, System.Math, FMX.Consts, FMX.Controls, FMX.Graphics, FMX.Presentation.Factory,
  FMX.Helpers.Win;
...
procedure TWinNativeMemo.RecreateFont;
var
...
procedure TWinNativeMemo.DeleteFont;
begin
...
procedure TWinNativeMemo.DestroyHandle;
begin
  DeleteFont;
  inherited;
end;
...
begin
  ...
  SendMessage(Handle, WM_SETFONT, WPARAM(FFontHandle), 1);
end;
