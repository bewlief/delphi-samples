...
function LocalizedButtonCaption(const AButton: TMsgDlgBtn): string;
begin
  Result := Translate(ButtonCaptions[AButton]);
end;

function LocalizedMessageDialogTitle(const ADialogType: TMsgDlgType): string;
begin
  Result := Translate(MsgTitles[ADialogType]);
end;
...
function MessageDlgPos(const AMessage: string; const ADialogType: TMsgDlgType; const AButtons: TMsgDlgButtons;
  const AHelpContext: THelpContext; const AX, AY: Integer): Integer;
begin
  Result := MessageDlgPosHelp(AMessage, ADialogType, AButtons, AHelpContext, AX, AY, '');
end;

procedure MessageDlgPos(const AMessage: string; const ADialogType: TMsgDlgType; const AButtons: TMsgDlgButtons;
  const AHelpContext: THelpContext; const AX, AY: Integer; const ACloseDialogProc: TInputCloseDialogProc);
begin
...
function MessageDlgPos(const AMessage: string; const ADialogType: TMsgDlgType; const AButtons: TMsgDlgButtons;
  const AHelpContext: THelpContext; const AX, AY: Integer; const ADefaultButton: TMsgDlgBtn): Integer;
begin
...
function MessageDlgPosHelp(const AMessage: string; const ADialogType: TMsgDlgType; const AButtons: TMsgDlgButtons;
  const AHelpContext: THelpContext; const AX, AY: Integer; const AHelpFileName: string): Integer;
begin
