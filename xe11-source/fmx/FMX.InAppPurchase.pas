...
function TCustomInAppPurchase.QueryInterface(const IID: TGUID; out Obj): HResult;
begin
  Result := inherited QueryInterface(IID, Obj);
  if (FInAppPurchaseService <> nil) and (Result <> S_OK) then
    Result := FInAppPurchaseService.QueryInterface(IID, Obj);
end;
