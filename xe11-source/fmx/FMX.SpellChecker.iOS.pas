...
uses
  ...
  FMX.Types, FMX.SpellChecker, FMX.Platform, iOSapi.CocoaTypes;
...
begin
  ...
  Result := nil;
  if FChecker.rangeOfMisspelledWordInString(StrToNSStr(Word), NSMakeRange(0, Word.Length), 0, False, FCurrentLanguage).location <> NSUInteger(NSNotFound) then
  begin
