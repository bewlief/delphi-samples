...
uses
  System.SysUtils, System.Messaging, System.PushNotification, System.JSON, iOSapi.Foundation, iOSapi.UserNotifications,
  iOSapi.CocoaTypes, iOSapi.UIKit, Macapi.Helpers, FMX.Platform, FMX.Platform.iOS, FMX.Helpers.iOS, FMX.Forms;
...
procedure TAPSPushService.RequestAuthorizationHandler(granted: Boolean;
  error: NSError);
begin
  SharedApplication.registerForRemoteNotifications;
end;
