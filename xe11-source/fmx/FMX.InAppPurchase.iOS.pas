...
function TiOSInAppPurchaseService.QueryInterface(const IID: TGUID; out Obj): HResult;
begin
  Result := inherited QueryInterface(IID, Obj);
  if (FProductsRequest <> nil) and (Result <> S_OK) then
    Result := FProductsRequest.QueryInterface(IID, Obj);
end;
