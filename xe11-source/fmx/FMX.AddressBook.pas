...
uses
  System.Generics.Collections, System.Classes, System.Permissions, FMX.AddressBook.Types, FMX.Surfaces;
...
{ Address Book }
  ...
  public
    ...
    /// <exception cref="FMX.AddressBook.Types|EAddressBookWrongArgs">Input parameters is wrong</exception>
    /// <exception cref="FMX.AddressBook.Types|EAddressBookAccess">Application doesn't have access to work with AddressBook</exception>
    /// <exception cref="FMX.AddressBook.Types|EAddressBookExecute">Exceptional situation in the course of execution of request</exception>
...
{ Contact }
  ...
  protected
    ...
    /// <exception cref="FMX.AddressBook.Types|EAddressBookException">Platform doesn't support this field or field is not required type</exception>
    ...
    /// <exception cref="FMX.AddressBook.Types|EAddressBookException">Platform doesn't support this field or field is not bitmap type</exception>
  ...
  public
    ...
    /// <summary>Source of contact</summary>
    property Source: TAddressBookSource read GetSource;
    /// <summary>Returns list of contact's groups</summary>
    /// <exception cref="FMX.AddressBook.Types|EAddressBookWrongArgs">Input parameter is wrong</exception>
    /// <exception cref="FMX.AddressBook.Types|EAddressBookExecute">Exceptional situation in the course of execution of request</exception>
    procedure AllGroups(var AGroups: TAddressBookGroups); virtual; abstract;
