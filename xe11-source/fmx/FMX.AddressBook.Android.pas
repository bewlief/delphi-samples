...
type
  ...
  private
    ...
    procedure OnRequestPermissionsResult(Sender: TObject; const APermissions: TClassicStringDynArray; const AGrantResults: TClassicPermissionStatusDynArray);
  protected
  ...
  protected
    ...
    { Lists }
    function GetDates: TContactDates; reintroduce; overload;
  public
...
procedure TAndroidAddressBook.OnRequestPermissionsResult(Sender: TObject; const APermissions: TClassicStringDynArray; const AGrantResults: TClassicPermissionStatusDynArray);
var
  &Message: string;
