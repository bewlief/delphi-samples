...
type
  ...
  TiOSSaveStateService = class(TInterfacedObject, IFMXSaveStateService)
  private
  ...
  TCocoaTouchSaveStateService = TiOSSaveStateService;
...
{ TiOSSaveStateService }

function TiOSSaveStateService.GetSaveStateFileName(const ABlockName: string): string;
const
  Separator = '_';
var
  S: TStringBuilder;
...
constructor TiOSSaveStateService.Create;
begin
  inherited;
  RegisterService;
end;

destructor TiOSSaveStateService.Destroy;
begin
  UnregisterService;
  inherited;
end;

function TiOSSaveStateService.GetBlock(const ABlockName: string; const ABlockData: TStream): Boolean;
...
function TiOSSaveStateService.SetBlock(const ABlockName: string; const ABlockData: TStream): Boolean;
...
function TiOSSaveStateService.GetStoragePath: string;
begin
  Result := FSaveStateStoragePath;
end;

procedure TiOSSaveStateService.RegisterService;
begin
...
procedure TiOSSaveStateService.SetStoragePath(const ANewPath: string);
begin
