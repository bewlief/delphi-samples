...
begin
  ...
  try
    ...
    types := TNSArray.Wrap(TNSArray.OCClass.arrayWithObject(NSObjectToID(NSPasteboardTypePNG)));
    Pasteboard.declareTypes(types, NSObjectToID(Pasteboard));
...
begin
  ...
  try
    Pasteboard := TNSPasteboard.Wrap(TNSPasteboard.OCClass.generalPasteboard);
    Pasteboard.clearContents;
    types := TNSArray.Wrap(TNSArray.OCClass.arrayWithObject(NSObjectToID(NSPasteboardTypeString)));
    Pasteboard.declareTypes(types, NSObjectToID(Pasteboard));
...
begin
  ...
  try
    Pasteboard := TNSPasteboard.Wrap(TNSPasteboard.OCClass.generalPasteboard);
    Pasteboard.clearContents;
    types := TNSArray.Wrap(TNSArray.OCClass.arrayWithObject(NSObjectToID(FClipboardFormats[AFormatName])));
    Pasteboard.declareTypes(types, NSObjectToID(Pasteboard));
