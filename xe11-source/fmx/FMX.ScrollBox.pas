...
uses
  ...
  FMX.Consts {$IFDEF IOS}, FMX.ScrollBox.iOS{$ENDIF} {$IFDEF ANDROID}, FMX.ScrollBox.Android{$ENDIF}
  {$IFDEF MSWINDOWS}, FMX.ScrollBox.Win{$ENDIF};
...
procedure TCustomScrollBoxModel.SetScrollDirections(const Value: TScrollDirections);
...
procedure TCustomPresentedScrollBox.SetScrollDirections(const Value: TScrollDirections);
begin
