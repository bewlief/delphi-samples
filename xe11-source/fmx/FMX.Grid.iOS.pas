  ...
  begin
    ...
    if TStyledSetting.FontColor in Model.StyledSettings then
      if TOSVersion.Check(13) then
        FontColor := TUIColor.Wrap(TUIColor.OCClass.labelColor)
      else
...
begin
  ...
  Update;
  if TOSVersion.Check(13) then
    View.setBackgroundColor(TUIColor.Wrap(TUIColor.OCClass.separatorColor))
  else
...
begin
  ...
  try
    ...
    if TOSVersion.Check(13) then
      FBkColor := TUIColor.Wrap(TUIColor.OCClass.systemBackgroundColor)
    else
      FBkColor := TmpTable.backgroundColor;
    FBkColor.retain;

    if TOSVersion.Check(13) then
      FOddColor := TUIColor.Wrap(TUIColor.OCClass.systemGroupedBackgroundColor)
    else
