...
uses
  ...
  System.Character, System.TypInfo, System.Math.Vectors, FMX.Presentation.Factory, System.SyncObjs, FMX.Clipboard;
...
procedure TStyledMemo.UpdateSelectionPointPositions;
  ...
  begin
    ...
    Result := Result and Memo.LocalRect.Contains(PointInContent);
  end;
...
procedure TStyledMemo.SelPtMouseUpHandler(Sender: TObject; Button: TMouseButton;
