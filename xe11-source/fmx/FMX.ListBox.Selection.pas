...
type
  ...
  protected
    ...
    procedure CopySelection(const Other: TListBoxSelector); override;
  public
...
procedure TSingleSelectionController.CopySelection(const Other: TListBoxSelector);
begin
  inherited;
  ClearSelection;
  SetSelected(Other.GetCurrentItem, True);
end;
...
procedure TMutiselectSelectionController.CopySelection(const Other: TListBoxSelector);
begin
  inherited;
...
procedure TExtendedSelectionController.CopySelection(const Other: TListBoxSelector);
begin
  inherited;
  SetCurrent(Other.GetCurrent);
end;
