...
begin
  ...
  if CompareText(s, '') = 0 then
    ...
    Result := csUtf8
  else if CompareText(s, 'utf8mb4') = 0 then
    Result := csUtf8mb4
  else
    Result := csNone;
end;
...
const
  C_CharacterSet: array[TFDMySQLCharacterSet] of String = ('', 'big5', 'dec8', 'cp850', 'hp8', 'koi8r', 'latin1', 'latin2', 'swe7', 'ascii', 'ujis', 'sjis', 'cp1251', 'hebrew', 'tis620', 'euckr', 'koi8u', 'gb2312', 'greek', 'cp1250', 'gbk', 'latin5', 'armscii8', 'cp866', 'keybcs2', 'macce', 'macroman', 'cp852', 'latin7', 'cp1256', 'cp1257', 'binary', 'utf8', 'utf8mb4');
begin
