...
{$ENDIF}
  ...
  { IFDGUIxFormsMemo                                                           }
  {----------------------------------------------------------------------------}
  TFDGUIxCreateMemoFunc = function(AOwner: TComponent): TWinControl;
  IFDGUIxFormsMemo = interface
    ['{3E9B315B-F456-4175-A864-B2573C4A2208}']
...
var
  FDGUIxCreateMemoFunc: TFDGUIxCreateMemoFunc;
...
begin
  ...
  FMount.Parent := FTree;
  FMount.Height := FTree.ScaleValue(CMountMinHeight);
  FMount.Align := alTop;
  ...
  FLbl.SetBounds(CHorizSpace0 + CHorizSpace1, CVertSpace0,
    FMount.ClientWidth - (CHorizSpace0 + CHorizSpace1), FTree.ScaleValue(CMountMinHeight));
...
begin
  ...
  oPnl.SetBounds(CHorizSpace0, 2, CHorizSpace1 + CButtonWidth + CHorizSpace1,
   FTree.ScaleValue(CVertSpace0 + CButtonHeight + CVertSpace0));
  ...
  FLbl.SetBounds(CHorizSpace0 + CHorizSpace1 + CButtonWidth + CHorizSpace0 + CHorizSpace1,
    ...
    CHorizSpace0 + CHorizSpace1), FTree.ScaleValue(CMountMinHeight));
