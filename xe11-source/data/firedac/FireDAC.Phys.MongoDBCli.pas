...
type
  ...
  Pmongoc_session_opt_t = Pmongoc_handle_t;
  Pmongoc_transaction_opt_t = Pmongoc_handle_t;
  Pmongoc_client_session_t = Pmongoc_handle_t;
  Pmongoc_cursor_t = Pmongoc_handle_t;
  Pmongoc_database_t = Pmongoc_handle_t;
  Pmongoc_collection_t = Pmongoc_handle_t;
  Pmongoc_read_concern_t = Pmongoc_handle_t;
...
type
  ...
  P_mongoc_collection_t2 = ^_mongoc_collection_t2;
  _mongoc_collection_t2 = record
    client: Pmongoc_client_t;
    ns: PFDAnsiString;
    nslen: Cardinal;
    db: PFDAnsiString;
    collection: PFDAnsiString;
    collectionlen: Cardinal;
    // ....
  end;

  mongoc_transaction_state_t = Cardinal;
const
...
type
  ...
  Tmongoc_get_version = function (): PFDAnsiString; cdecl;

  // mongoc-client-session.h
  Tmongoc_client_start_session = function (client: Pmongoc_client_t;
    opts: Pmongoc_session_opt_t; error: Pbson_error_t): Pmongoc_client_session_t; cdecl;
  Tmongoc_client_session_destroy = procedure (session: Pmongoc_client_session_t); cdecl;
  Tmongoc_client_session_start_transaction = function (session: Pmongoc_client_session_t;
    opts: Pmongoc_transaction_opt_t; error: Pbson_error_t): Boolean; cdecl;
  Tmongoc_client_session_in_transaction = function (session: Pmongoc_client_session_t): Boolean; cdecl;
  Tmongoc_client_session_get_transaction_state = function (session: Pmongoc_client_session_t
   ): mongoc_transaction_state_t; cdecl;
  Tmongoc_client_session_commit_transaction = function (session: Pmongoc_client_session_t;
    reply: Pbson_t; error: Pbson_error_t): Boolean; cdecl;
  Tmongoc_client_session_abort_transaction = function (session: Pmongoc_client_session_t;
    error: Pbson_error_t): Boolean; cdecl;
  Tmongoc_client_session_append = function (client_session: Pmongoc_client_session_t;
    opts: Pbson_t; error: Pbson_error_t): Boolean; cdecl;
  Tmongoc_transaction_opts_new = function (): Pmongoc_transaction_opt_t; cdecl;
  Tmongoc_transaction_opts_clone = function (opts: Pmongoc_transaction_opt_t): Pmongoc_transaction_opt_t; cdecl;
  Tmongoc_transaction_opts_destroy = procedure (opts: Pmongoc_transaction_opt_t); cdecl;
  Tmongoc_transaction_opts_set_max_commit_time_ms = procedure (opts: Pmongoc_transaction_opt_t;
    max_commit_time_ms: Int64); cdecl;
  Tmongoc_transaction_opts_get_max_commit_time_ms = function (opts: Pmongoc_transaction_opt_t): Int64; cdecl;
  Tmongoc_transaction_opts_set_read_concern = procedure (opts: Pmongoc_transaction_opt_t;
    read_concern: Pmongoc_read_concern_t); cdecl;
  Tmongoc_transaction_opts_get_read_concern = function (opts: Pmongoc_transaction_opt_t):
    Pmongoc_read_concern_t; cdecl;
  Tmongoc_transaction_opts_set_write_concern = procedure (opts: Pmongoc_transaction_opt_t;
    write_concern: Pmongoc_write_concern_t); cdecl;
  Tmongoc_transaction_opts_get_write_concern = function (opts: Pmongoc_transaction_opt_t):
    Pmongoc_write_concern_t; cdecl;
  Tmongoc_transaction_opts_set_read_prefs = procedure (opts: Pmongoc_transaction_opt_t;
    read_prefs: Pmongoc_read_prefs_t); cdecl;
  Tmongoc_transaction_opts_get_read_prefs = function (opts: Pmongoc_transaction_opt_t):
    Pmongoc_read_prefs_t; cdecl;

  Tmongoc_session_opts_new = function (): Pmongoc_session_opt_t; cdecl;
  Tmongoc_session_opts_clone = function (opts: Pmongoc_session_opt_t): Pmongoc_session_opt_t; cdecl;
  Tmongoc_session_opts_destroy = procedure (opts: Pmongoc_session_opt_t); cdecl;
  Tmongoc_session_opts_set_causal_consistency = procedure (opts: Pmongoc_session_opt_t;
    causal_consistency: Boolean); cdecl;
  Tmongoc_session_opts_get_causal_consistency = function (opts: Pmongoc_session_opt_t): Boolean; cdecl;
  Tmongoc_session_opts_set_default_transaction_opts = procedure (opts: Pmongoc_session_opt_t;
    txn_opts: Pmongoc_transaction_opt_t); cdecl;
  Tmongoc_session_opts_get_default_transaction_opts = function (opts: Pmongoc_session_opt_t):
    Pmongoc_transaction_opt_t; cdecl;
  Tmongoc_session_opts_get_transaction_opts = function (session: Pmongoc_client_session_t):
    Pmongoc_transaction_opt_t; cdecl;

  // mongoc-error.h
  Tmongoc_error_has_label = function (reply: Pbson_t; _label: PFDAnsiString): Boolean; cdecl;
  ...
  Tmongoc_collection_drop = function (collection: Pmongoc_collection_t;
    error: Pbson_error_t): Boolean; cdecl;
  Tmongoc_collection_drop_with_opts = function (collection: Pmongoc_collection_t;
    opts: Pbson_t; error: Pbson_error_t): Boolean; cdecl;
  ...
  Tmongoc_collection_drop_index_with_opts = function (collection: Pmongoc_collection_t;
    index_name: PFDAnsiString; opts: Pbson_t; error: Pbson_error_t): Boolean; cdecl;
  ...
  Tmongoc_collection_create_index_with_opts = function (collection: Pmongoc_collection_t;
    keys: Pbson_t; opt: Pmongoc_index_opt_t; opts: Pbson_t; reply: Pbson_t;
    error: Pbson_error_t): Boolean; cdecl;
  Tmongoc_collection_find_indexes = function (collection: Pmongoc_collection_t;
    error: Pbson_error_t): Pmongoc_cursor_t; cdecl;
  Tmongoc_collection_find_indexes_with_opts = function (collection: Pmongoc_collection_t;
    keys: Pbson_t): Pmongoc_cursor_t; cdecl;
  ...
  Tmongoc_collection_find_with_opts = function (collection: Pmongoc_collection_t;
    filter: Pbson_t; opts: Pbson_t; read_prefs: Pmongoc_read_prefs_t): Pmongoc_cursor_t; cdecl;
  Tmongoc_collection_insert = function (collection: Pmongoc_collection_t;
    ...
    error: Pbson_error_t): Boolean; cdecl;
  Tmongoc_collection_insert_one = function (collection: Pmongoc_collection_t;
    document: Pbson_t; opts: Pbson_t; reply: Pbson_t; error: Pbson_error_t): Boolean; cdecl;
  ...
  Tmongoc_collection_update_xxx = function (collection: Pmongoc_collection_t;
    selector, update: Pbson_t; opts: Pbson_t; reply: Pbson_t; error: Pbson_error_t): Boolean; cdecl;
  ...
  Tmongoc_collection_remove = function (collection: Pmongoc_collection_t;
    ...
    error: Pbson_error_t): Boolean; cdecl;
  Tmongoc_collection_delete_xxx = function (collection: Pmongoc_collection_t;
    selector: Pbson_t; opts: Pbson_t; reply: Pbson_t; error: Pbson_error_t): Boolean; cdecl;
  Tmongoc_collection_rename = function (collection: Pmongoc_collection_t;
    ...
    error: Pbson_error_t): Boolean; cdecl;
  Tmongoc_collection_rename_with_opts = function (collection: Pmongoc_collection_t;
    new_db, new_name: PFDAnsiString; drop_target_before_rename: Boolean;
    opts: Pbson_t; error: Pbson_error_t): Boolean; cdecl;
  ...
  Tmongoc_collection_create_bulk_operation_with_opts = function (collection: Pmongoc_collection_t;
    opts: Pbson_t): Pmongoc_bulk_operation_t; cdecl;
  ...
  Tmongoc_read_concern_new = function (): Pmongoc_read_concern_t; cdecl;
  Tmongoc_read_concern_destroy = procedure (read_concern: Pmongoc_read_concern_t); cdecl;
  Tmongoc_read_concern_copy = function (read_concern: Pmongoc_read_concern_t): Pmongoc_read_concern_t; cdecl;
  Tmongoc_read_concern_get_level = function (read_concern: Pmongoc_read_concern_t): PFDAnsiString; cdecl;
  Tmongoc_read_concern_set_level = function (read_concern: Pmongoc_read_concern_t; level: PFDAnsiString): Boolean; cdecl;
