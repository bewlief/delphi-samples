...
{$IFDEF FireDAC_PGSQL_STATIC}
  ...
  function PQgetCopyData(conn: PPGconn; var buffer: Pointer; async: Integer): Integer; cdecl; external;
  ...
  function PQencryptPassword(passwd, user: PFDAnsiString): PFDAnsiString; cdecl; external;
  function PQencryptPasswordConn(conn: PPGconn; passwd, user,
    algorithm: PFDAnsiString): PFDAnsiString; cdecl; external;
...
type
  ...
  TPQgetCopyData = function(conn: PPGconn; var buffer: Pointer; async: Integer): Integer; cdecl;
  ...
  TPQexecBulkPrepared = function(conn: PPGconn; stmtName: PFDAnsiString;
    nCols, nRows: Cardinal; paramValues: PPointer; paramLengths: PInteger;
    paramFormats: PInteger): PPGresult; cdecl;

  TPQencryptPassword = function(passwd, user: PFDAnsiString): PFDAnsiString; cdecl;
  TPQencryptPasswordConn = function (conn: PPGconn; passwd, user,
    algorithm: PFDAnsiString): PFDAnsiString; cdecl;
