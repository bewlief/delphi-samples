...
type
  // TFDPhysFBConnectionDefParams
  // Generated for: FireDAC FB driver

  TFDFBCharLenMode = (clmChars, clmBytes);

  /// <summary> TFDPhysFBConnectionDefParams class implements FireDAC FB driver specific connection definition class. </summary>
  TFDPhysFBConnectionDefParams = class(TFDConnectionDefParams)
  private
    ...
    function GetCharLenMode: TFDFBCharLenMode;
    procedure SetCharLenMode(const AValue: TFDFBCharLenMode);
  published
    ...
    property CharLenMode: TFDFBCharLenMode read GetCharLenMode write SetCharLenMode stored False default clmChars;
  end;
...
{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetDriverID: String;
begin
  Result := FDef.AsString[S_FD_ConnParam_Common_DriverID];
end;

{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetDriverID(const AValue: String);
begin
  FDef.AsString[S_FD_ConnParam_Common_DriverID] := AValue;
end;

{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetOSAuthent: Boolean;
begin
  Result := FDef.AsYesNo[S_FD_ConnParam_Common_OSAuthent];
end;

{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetOSAuthent(const AValue: Boolean);
begin
  FDef.AsYesNo[S_FD_ConnParam_Common_OSAuthent] := AValue;
end;

{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetProtocol: TIBProtocol;
var
  s: String;
begin
...
{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetProtocol(const AValue: TIBProtocol);
const
...
{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetServer: String;
begin
  Result := FDef.AsString[S_FD_ConnParam_Common_Server];
end;

{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetServer(const AValue: String);
begin
  FDef.AsString[S_FD_ConnParam_Common_Server] := AValue;
end;

{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetPort: Integer;
begin
  Result := FDef.AsInteger[S_FD_ConnParam_Common_Port];
end;

{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetPort(const AValue: Integer);
begin
  FDef.AsInteger[S_FD_ConnParam_Common_Port] := AValue;
end;

{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetSQLDialect: Integer;
begin
...
{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetSQLDialect(const AValue: Integer);
begin
  FDef.AsInteger[S_FD_ConnParam_IB_SQLDialect] := AValue;
end;

{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetRoleName: String;
begin
  Result := FDef.AsString[S_FD_ConnParam_IB_RoleName];
end;

{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetRoleName(const AValue: String);
begin
  FDef.AsString[S_FD_ConnParam_IB_RoleName] := AValue;
end;

{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetCharacterSet: TIBCharacterSet;
var
  s: String;
begin
...
{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetCharacterSet(const AValue: TIBCharacterSet);
const
...
{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetExtendedMetadata: Boolean;
begin
  Result := FDef.AsBoolean[S_FD_ConnParam_Common_ExtendedMetadata];
end;

{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetExtendedMetadata(const AValue: Boolean);
begin
  FDef.AsBoolean[S_FD_ConnParam_Common_ExtendedMetadata] := AValue;
end;

{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetOpenMode: TIBOpenMode;
var
  s: String;
begin
...
{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetOpenMode(const AValue: TIBOpenMode);
const
...
{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetPageSize: TIBPageSize;
var
  s: String;
begin
  ...
  if CompareText(s, '1024') = 0 then
    ...
    Result := ps16384
  else if CompareText(s, '32768') = 0 then
    Result := ps32768
  else
    Result := ps4096;
end;
...
{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetPageSize(const AValue: TIBPageSize);
const
  C_PageSize: array[{TIBPageSize} 0..5] of String = ('1024', '2048', '4096', '8192', '16384', '32768');
begin
  FDef.AsString[S_FD_ConnParam_IB_PageSize] := C_PageSize[Ord(AValue)];
end;

{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetDropDatabase: Boolean;
begin
  Result := FDef.AsYesNo[S_FD_ConnParam_IB_DropDatabase];
end;

{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetDropDatabase(const AValue: Boolean);
begin
  FDef.AsYesNo[S_FD_ConnParam_IB_DropDatabase] := AValue;
end;

{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetIBAdvanced: String;
begin
  Result := FDef.AsString[S_FD_ConnParam_IB_IBAdvanced];
end;

{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetIBAdvanced(const AValue: String);
begin
  FDef.AsString[S_FD_ConnParam_IB_IBAdvanced] := AValue;
end;

{-------------------------------------------------------------------------------}
function TFDPhysFBConnectionDefParams.GetCharLenMode: TFDFBCharLenMode;
var
  s: String;
begin
  s := FDef.AsString[S_FD_ConnParam_FB_CharLenMode];
  if CompareText(s, 'Chars') = 0 then
    Result := clmChars
  else if CompareText(s, 'Bytes') = 0 then
    Result := clmBytes
  else
    Result := clmChars;
end;
...
{-------------------------------------------------------------------------------}
procedure TFDPhysFBConnectionDefParams.SetCharLenMode(const AValue: TFDFBCharLenMode);
const
  C_CharLenMode: array[TFDFBCharLenMode] of String = ('Chars', 'Bytes');
begin
  FDef.AsString[S_FD_ConnParam_FB_CharLenMode] := C_CharLenMode[AValue];
end;
