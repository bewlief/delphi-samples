...
uses
  System.Types, System.SysUtils, System.Classes, FireDAC.Stan.Intf;
...
{-------------------------------------------------------------------------------}
function TFDPhysPGConnectionDefParams.GetGUIDEndian: TEndian;
var
  s: String;
begin
...
{-------------------------------------------------------------------------------}
procedure TFDPhysPGConnectionDefParams.SetGUIDEndian(const AValue: TEndian);
const
