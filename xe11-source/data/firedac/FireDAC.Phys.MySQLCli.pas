...
{>= 8.0}
  ...
  NOT_SECONDARY_FLAG      = 1 shl 29; // Field will not be loaded in secondary engine
...
type
  ...
  PMYSQL_DATA0800 = ^MYSQL_DATA0800;
  MYSQL_DATA0800 = record
    data:          PMYSQL_ROWS;
    alloc:         MEM_ROOT0600;
    rows:          my_ulonglong;
    fields:        Cardinal;
...
{>= 4.1 end}
{>= 5.0.6 begin}
  MYSQL_REPORT_DATA_TRUNCATION_ = 19;
{>= 5.0.6 end}
{>= 5.1 begin}
  MYSQL_OPT_RECONNECT_ = 20;
...
type
  PMYSQL_OPTIONS0800 = ^MYSQL_OPTIONS0800;
  MYSQL_OPTIONS0800 = record
    connect_timeout,
    read_timeout,
    write_timeout,
    port,
...
{>= 8.0 begin}
type
  enum_resultset_metadata = my_enum;
const
...
{>= 4.1 end}
  ...
  PMYSQL0800 = ^MYSQL0800;
  MYSQL0800 = record
    net:                  NET0800;      // Communication parameters
  ...
  PMYSQL_RES0800 = ^MYSQL_RES0800;
  MYSQL_RES0800 = record
...
const
  ...
  // bigger values.
type
  PMYSQL_TIME0800 = ^MYSQL_TIME0800;
  MYSQL_TIME0800 = record
    year, month, day,
    ...
    time_zone_displacement:Integer;
  end;
