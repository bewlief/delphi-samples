...
const
  C_FD_Version = '28.0.0 (Build 106147)';
  C_FD_Copyright = #$00A9 + ' 2021 Embarcadero Technologies, Inc.';
  C_FD_Product = 'FireDAC';
  C_FD_ProductFull = 'Embarcadero' + #$00AE + ' ' + C_FD_Product;
  C_FD_ToolName = 'RAD Studio 11.0';
...
{$ENDIF}
  ...
  S_FD_ConnParam_MSAcc_StringFormat = 'StringFormat';
    ...
    S_FD_ANSI = 'ANSI';
  S_FD_ConnParam_MSSQL_StringFormat = S_FD_ConnParam_MSAcc_StringFormat;
...
//  S_FD_ConnParam_Oracle_SrvIntName = 'Dist_SrvIntName';
  ...
  // SQLite parameters
  S_FD_ConnParam_SQLite_EngineLinkage = 'EngineLinkage';
  S_FD_ConnParam_SQLite_SEEKey = 'SEEKey';
  ...
  S_FD_ConnParam_Mongo_SSL_PEMFile = 'SSL_PEMFile';
  S_FD_ConnParam_Mongo_SSL_PEMPassword = 'SSL_PEMPassword';
  S_FD_ConnParam_Mongo_SSL_CAFile = 'SSL_CAFile';
  S_FD_ConnParam_Mongo_SSL_WeakValidation = 'SSL_WeakValidation';
  S_FD_ConnParam_Mongo_SSL_AllowInvHost = 'SSL_AllowInvHost';
...
{$ENDIF}
  ...
  cvOracle180000 = 1800000000;
  cvOracle190000 = 1900000000;
  ...
  er_FD_SQLiteLinkageNotSupported = 1606;
