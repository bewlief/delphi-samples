...
{$IFNDEF FireDAC_MOBILE}
  ...
  TFDRDBMSKinds.SQLAnywhere: Result := TFDPhysASAMetadata.Create(Self, False, 0, iClntVer, GetKeywords);
...
initialization
  try
    ...
    FDRegisterDriverClass(TFDPhysTDBXDriver);
  except
    // none
  end;

finalization
  FDUnregisterDriverClass(TFDPhysTDBXDriver);
