...
begin
  ...
  ClientHeight := FAddToOptionsHeight + Length(FDlg.FParams) * Muldiv(26, M.PixelsPerInch, 96);
  ClientWidth := Muldiv(250, M.PixelsPerInch, 96);
...
begin
  ...
  OpenDialog1.InitialDir := FDExpandStr(ExtractFileDir(OpenDialog1.FileName));
