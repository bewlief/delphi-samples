...
const
  ...
  // ---------------------------------------------------------------------------
  // Firebird 4.0 object interfaces (only required part)
  // ---------------------------------------------------------------------------
type
  NativeIntPtr = ^NativeInt;
  CardinalPtr = ^Cardinal;

  FB_DEC16Ptr = PFB_DEC16;
  FB_DEC34Ptr = PFB_DEC34;
  FB_I128Ptr = PFB_I128;
  ISC_TIME_TZPtr = PISC_TIME_TZ;
  ISC_TIMESTAMP_TZPtr = PISC_TIMESTAMP_TZ;
  ISC_TIME_TZ_EXPtr = PISC_TIME_TZ_EX;
  ISC_TIMESTAMP_TZ_EXPtr = PISC_TIMESTAMP_TZ_EX;
  ...
  public
    ...
    function release(): Integer; inline;
  end;
  ...
  protected type
    ...
    StatusVTable = class(DisposableVTable)
      init: Pointer {IStatus_initPtr};
      getState: IStatus_getStatePtr;
      setErrors2: Pointer {IStatus_setErrors2Ptr};
      setWarnings2: Pointer {IStatus_setWarnings2Ptr};
      setErrors: Pointer {IStatus_setErrorsPtr};
      setWarnings: Pointer {IStatus_setWarningsPtr};
      getErrors: IStatus_getErrorsPtr;
      getWarnings: Pointer {IStatus_getWarningsPtr};
      clone: Pointer {IStatus_clonePtr};
    end;
  public
    const VERSION = 3;
  ...
  protected type
    ...
    DecFloat16VTable = class(VersionedVTable)
      toBcd: Pointer {IDecFloat16_toBcdPtr};
      toString: IDecFloat16_toStringPtr;
      fromBcd: Pointer {IDecFloat16_fromBcdPtr};
...
{$WARNINGS OFF}
    procedure toString(status: IStatus; from: FB_DEC16Ptr; bufferLength: Cardinal; buffer: PAnsiChar); inline;
{$WARNINGS ON}
    procedure fromString(status: IStatus; from: PAnsiChar; to_: FB_DEC16Ptr); inline;
  end;
  ...
  protected type
    ...
    DecFloat34VTable = class(VersionedVTable)
      toBcd: Pointer {IDecFloat34_toBcdPtr};
      toString: IDecFloat34_toStringPtr;
      fromBcd: Pointer {IDecFloat34_fromBcdPtr};
...
{$WARNINGS OFF}
    procedure toString(status: IStatus; from: FB_DEC34Ptr; bufferLength: Cardinal; buffer: PAnsiChar); inline;
{$WARNINGS ON}
    procedure fromString(status: IStatus; from: PAnsiChar; to_: FB_DEC34Ptr); inline;
  end;
...
{$WARNINGS OFF}
    procedure toString(status: IStatus; from: FB_I128Ptr; scale: Integer; bufferLength: Cardinal; buffer: PAnsiChar); inline;
{$WARNINGS ON}
    procedure fromString(status: IStatus; scale: Integer; from: PAnsiChar; to_: FB_I128Ptr); inline;
  end;
  ...
  protected type
    ...
    UtilVTable = class(VersionedVTable)
      getFbVersion: Pointer {IUtil_getFbVersionPtr};
      loadBlob: Pointer {IUtil_loadBlobPtr};
      dumpBlob: Pointer {IUtil_dumpBlobPtr};
      getPerfCounters: Pointer {IUtil_getPerfCountersPtr};
      executeCreateDatabase: Pointer {IUtil_executeCreateDatabasePtr};
      decodeDate: Pointer {IUtil_decodeDatePtr};
      decodeTime: Pointer {IUtil_decodeTimePtr};
      encodeDate: Pointer {IUtil_encodeDatePtr};
      encodeTime: Pointer {IUtil_encodeTimePtr};
      formatStatus: Pointer {IUtil_formatStatusPtr};
      getClientVersion: Pointer {IUtil_getClientVersionPtr};
      getXpbBuilder: Pointer {IUtil_getXpbBuilderPtr};
      setOffsets: Pointer {IUtil_setOffsetsPtr};
  ...
  public
    ...
    function getInt128(status: IStatus): IInt128; inline;
    procedure decodeTimeTz(status: IStatus; timeTz: ISC_TIME_TZPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); inline;
    procedure decodeTimeStampTz(status: IStatus; timeStampTz: ISC_TIMESTAMP_TZPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); inline;
    procedure encodeTimeTz(status: IStatus; timeTz: ISC_TIME_TZPtr; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar); inline;
    procedure encodeTimeStampTz(status: IStatus; timeStampTz: ISC_TIMESTAMP_TZPtr; year: Cardinal; month: Cardinal; day: Cardinal; hours: Cardinal; minutes: Cardinal; seconds: Cardinal; fractions: Cardinal; timeZone: PAnsiChar); inline;
    procedure decodeTimeTzEx(status: IStatus; timeTz: ISC_TIME_TZ_EXPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); inline;
    procedure decodeTimeStampTzEx(status: IStatus; timeStampTz: ISC_TIMESTAMP_TZ_EXPtr; year: CardinalPtr; month: CardinalPtr; day: CardinalPtr; hours: CardinalPtr; minutes: CardinalPtr; seconds: CardinalPtr; fractions: CardinalPtr; timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar); inline;
  end;
  ...
  protected type
    ...
    MasterVTable = class(VersionedVTable)
      ...
      getDispatcher: Pointer {IMaster_getDispatcherPtr};
      getPluginManager: Pointer {IMaster_getPluginManagerPtr};
      getTimerControl: Pointer {IMaster_getTimerControlPtr};
      getDtc: Pointer {IMaster_getDtcPtr};
      registerAttachment: Pointer {IMaster_registerAttachmentPtr};
      registerTransaction: Pointer {IMaster_registerTransactionPtr};
      getMetadataBuilder: Pointer {IMaster_getMetadataBuilderPtr};
      serverMode: Pointer {IMaster_serverModePtr};
      getUtilInterface: IMaster_getUtilInterfacePtr;
      getConfigManager: Pointer {IMaster_getConfigManagerPtr};
      getProcessExiting: Pointer {IMaster_getProcessExitingPtr};
    end;
  public
    const VERSION = 2;
    function getStatus(): IStatus; inline;
    function getUtilInterface(): IUtil; inline;
  end;
  ...
  protected type
    ...
    MessageMetadataVTable = class(ReferenceCountedVTable)
      getCount: Pointer {IMessageMetadata_getCountPtr};
      ...
      getType: Pointer {IMessageMetadata_getTypePtr};
      isNullable: Pointer {IMessageMetadata_isNullablePtr};
      getSubType: Pointer {IMessageMetadata_getSubTypePtr};
      getLength: Pointer {IMessageMetadata_getLengthPtr};
      getScale: Pointer {IMessageMetadata_getScalePtr};
      getCharSet: Pointer {IMessageMetadata_getCharSetPtr};
      getOffset: Pointer {IMessageMetadata_getOffsetPtr};
      getNullOffset: Pointer {IMessageMetadata_getNullOffsetPtr};
      getBuilder: Pointer {IMessageMetadata_getBuilderPtr};
      getMessageLength: Pointer {IMessageMetadata_getMessageLengthPtr};
      getAlignment: Pointer {IMessageMetadata_getAlignmentPtr};
      getAlignedLength: Pointer {IMessageMetadata_getAlignedLengthPtr};
    end;
  public
    const VERSION = 4;
    function getField(status: IStatus; index: Cardinal): PAnsiChar; inline;
    function getRelation(status: IStatus; index: Cardinal): PAnsiChar; inline;
    function getOwner(status: IStatus; index: Cardinal): PAnsiChar; inline;
    function getAlias(status: IStatus; index: Cardinal): PAnsiChar; inline;
  end;
  ...
  protected type
    ...
    StatementVTable = class(ReferenceCountedVTable)
      getInfo: Pointer {IStatement_getInfoPtr};
      getType: Pointer {IStatement_getTypePtr};
      getPlan: Pointer {IStatement_getPlanPtr};
      getAffectedRecords: Pointer {IStatement_getAffectedRecordsPtr};
      getInputMetadata: IStatement_getInputMetadataPtr;
      getOutputMetadata: IStatement_getOutputMetadataPtr;
      execute: Pointer {IStatement_executePtr};
      openCursor: Pointer {IStatement_openCursorPtr};
      setCursorName: Pointer {IStatement_setCursorNamePtr};
      free: Pointer {IStatement_freePtr};
      getFlags: Pointer {IStatement_getFlagsPtr};
      getTimeout: Pointer {IStatement_getTimeoutPtr};
      setTimeout: Pointer {IStatement_setTimeoutPtr};
      createBatch: Pointer {IStatement_createBatchPtr};
    end;
  public
    const VERSION = 4;
    function getInputMetadata(status: IStatus): IMessageMetadata; inline;
    function getOutputMetadata(status: IStatus): IMessageMetadata; inline;
  end;
...
{$ENDIF}
  ...
  function isc_attach_database(user_status: PISC_STATUS; file_length: Smallint;
    ...
    {$IF DEFINED(CPUARM)} dependency LibCPP
      {$IF DECLARED(LibCPP_ABI)}, LibCPP_ABI {$ENDIF}
      {$IF DECLARED(C_FD_IBLib_DEP)}, C_FD_IBLib_DEP {$ENDIF}
    {$ENDIF};
...
{$IFDEF FireDAC_IB_STATIC_FBBRAND}
  ...
  function fb_get_transaction_handle(status: PISC_STATUS; tr_handle: Pisc_tr_handle;
    data: Pointer): ISC_STATUS; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF}; external C_FD_IBLib;
  function fb_get_master_interface: IMaster; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF}; external C_FD_IBLib;
  function fb_dsql_set_timeout(status: PISC_STATUS; stmt_handle: Pisc_stmt_handle;
    timeout: ISC_ULONG): ISC_STATUS; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF}; external C_FD_IBLib;
  function fb_get_statement_interface(status: PISC_STATUS; iPtr: Pointer;
    stmt_handle: Pisc_stmt_handle): ISC_STATUS; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF}; external C_FD_IBLib;
{$ENDIF}
{$ENDIF}
...
{$ENDIF}
  ...
  Tfb_get_transaction_handle = function (status: PISC_STATUS; tr_handle: Pisc_tr_handle;
    data: Pointer): ISC_STATUS; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
  Tfb_get_master_interface = function: IMaster; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
  Tfb_dsql_set_timeout = function (status: PISC_STATUS; stmt_handle: Pisc_stmt_handle;
    timeout: ISC_ULONG): ISC_STATUS; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
  Tfb_get_statement_interface = function (status: PISC_STATUS; iPtr: Pointer;
    stmt_handle: Pisc_stmt_handle): ISC_STATUS; {$IFDEF MSWINDOWS} stdcall {$ELSE} cdecl {$ENDIF};
...
{-------------------------------------------------------------------------------}
{ Firebird 4.0 object interfaces                                                }
{-------------------------------------------------------------------------------}
...
{-------------------------------------------------------------------------------}
procedure IDecFloat16.fromString(status: IStatus; from: PAnsiChar;
  to_: FB_DEC16Ptr);
begin
...
{-------------------------------------------------------------------------------}
procedure IDecFloat16.toString(status: IStatus; from: FB_DEC16Ptr;
  bufferLength: Cardinal; buffer: PAnsiChar);
begin
  DecFloat16VTable(vTable).toString(Self, status, from, bufferLength, buffer);
end;

{-------------------------------------------------------------------------------}
procedure IDecFloat34.fromString(status: IStatus; from: PAnsiChar;
  to_: FB_DEC34Ptr);
begin
...
{-------------------------------------------------------------------------------}
procedure IDecFloat34.toString(status: IStatus; from: FB_DEC34Ptr;
  bufferLength: Cardinal; buffer: PAnsiChar);
begin
...
{-------------------------------------------------------------------------------}
procedure IInt128.fromString(status: IStatus; scale: Integer; from: PAnsiChar;
  to_: FB_I128Ptr);
begin
...
{-------------------------------------------------------------------------------}
procedure IInt128.toString(status: IStatus; from: FB_I128Ptr; scale: Integer;
  bufferLength: Cardinal; buffer: PAnsiChar);
begin
...
{-------------------------------------------------------------------------------}
procedure IUtil.decodeTimeTz(status: IStatus; timeTz: ISC_TIME_TZPtr; hours,
  minutes, seconds, fractions: CardinalPtr; timeZoneBufferLength: Cardinal;
  timeZoneBuffer: PAnsiChar);
begin
  UtilVTable(vTable).decodeTimeTz(Self, status, timeTz, hours, minutes, seconds,
    fractions, timeZoneBufferLength, timeZoneBuffer);
end;

{-------------------------------------------------------------------------------}
procedure IUtil.decodeTimeStampTz(status: IStatus; timeStampTz: ISC_TIMESTAMP_TZPtr;
  year, month, day, hours, minutes, seconds, fractions: CardinalPtr;
  timeZoneBufferLength: Cardinal; timeZoneBuffer: PAnsiChar);
begin
  UtilVTable(vTable).decodeTimeStampTz(Self, status, timeStampTz, year, month, day,
    hours, minutes, seconds, fractions, timeZoneBufferLength, timeZoneBuffer);
end;

{-------------------------------------------------------------------------------}
procedure IUtil.encodeTimeTz(status: IStatus; timeTz: ISC_TIME_TZPtr; hours,
  minutes, seconds, fractions: Cardinal; timeZone: PAnsiChar);
begin
  UtilVTable(vTable).encodeTimeTz(Self, status, timeTz, hours, minutes, seconds,
    fractions, timeZone);
end;

{-------------------------------------------------------------------------------}
procedure IUtil.encodeTimeStampTz(status: IStatus; timeStampTz: ISC_TIMESTAMP_TZPtr;
  year, month, day, hours, minutes, seconds, fractions: Cardinal; timeZone: PAnsiChar);
begin
  UtilVTable(vTable).encodeTimeStampTz(Self, status, timeStampTz, year, month, day,
    hours, minutes, seconds, fractions, timeZone);
end;

{-------------------------------------------------------------------------------}
procedure IUtil.decodeTimeTzEx(status: IStatus; timeTz: ISC_TIME_TZ_EXPtr;
  hours, minutes, seconds, fractions: CardinalPtr; timeZoneBufferLength: Cardinal;
  timeZoneBuffer: PAnsiChar);
begin
  UtilVTable(vTable).decodeTimeTzEx(Self, status, timeTz, hours, minutes, seconds,
    fractions, timeZoneBufferLength, timeZoneBuffer);
end;

{-------------------------------------------------------------------------------}
procedure IUtil.decodeTimeStampTzEx(status: IStatus;
  timeStampTz: ISC_TIMESTAMP_TZ_EXPtr; year, month, day, hours, minutes,
  seconds, fractions: CardinalPtr; timeZoneBufferLength: Cardinal;
  timeZoneBuffer: PAnsiChar);
begin
  UtilVTable(vTable).decodeTimeStampTzEx(Self, status, timeStampTz, year, month, day,
    hours, minutes, seconds, fractions, timeZoneBufferLength, timeZoneBuffer);
end;
