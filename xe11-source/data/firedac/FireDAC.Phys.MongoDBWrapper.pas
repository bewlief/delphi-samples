...
uses
  System.TypInfo, System.SysUtils, System.Classes, System.Generics.Collections,
    System.Rtti, System.JSON.Types, System.JSON.Readers, System.JSON.Writers,
...
{$ENDIF}
    ...
    property OwningObj: TObject read FOwningObj;
    /// <summary> Specifies time zone mode. </summary>
  ...
  ///  More: https://docs.mongodb.com/manual/core/read-preference/ </summary>
  TMongoReadPreference = class(TMongoObject)
  public type
    /// <summary> See https://docs.mongodb.com/manual/core/read-preference/#read-preference-modes. </summary>
  ...
  public
    ...
    /// <summary> See https://docs.mongodb.com/manual/core/read-preference-tags/. </summary>
  ...
  ///  More: https://docs.mongodb.com/manual/reference/write-concern/ </summary>
  TMongoWriteConcern = class(TMongoObject)
  public type
    /// <summary> See http://mongoc.org/libmongoc/current/mongoc_write_concern_t.html. </summary>
  ...
  protected type
    ...
    /// <summary> Implements pipeline Sample stage. </summary>
    TSample = class sealed(TOperation)
    protected
      class function GetOperator: String; override;
      /// <summary> Sets the Size attribute of Sample stage. </summary>
      procedure SetValue(const AValue: Integer);
    end;

    /// <summary> Implements pipeline Lookup stage. </summary>
    TLookup = class sealed(TOperation)
    protected
      class function GetOperator: String; override;
      /// <summary> Setups attributes of Lookup stage. </summary>
      procedure Setup(const AFrom, ALocalField, AForeignField, AAs: String);
    end;
    ...
    /// <summary> Implements pipeline IndexStats stage. </summary>
    TIndexStats = class sealed(TOperation)
    protected
      class function GetOperator: String; override;
      /// <summary> Setups IndexStats stage. </summary>
      procedure Setup();
    end;
  ...
  public type
    ...
    /// <summary> Implements pipeline GeoNear stage. </summary>
    TGeoNear = class sealed(TOperation)
    public type
      TQuery = class sealed(TMongoExpression<TGeoNear>)
      public
        /// <summary> Finishes Query part of geoNear stage and returns reference
        ///  to parent geoNear object. </summary>
    ...
    public
      destructor Destroy; override;
      /// <summary> Clears content of geoNear stage. </summary>
      function Clear: TGeoNear; inline;
      /// <summary> Appends JSON construction to geoNear stage. </summary>
      function Append(const AJSON: String): TGeoNear; inline;
      /// <summary> Specifies the point for which to find the closest documents. </summary>
      function &Near(ALatitude, ALongitude: Extended): TGeoNear;
      /// <summary> When true, then MongoDB uses spherical geometry to
      ///  calculate distances in meters. </summary>
      function Spherical(AValue: Boolean): TGeoNear;
      /// <summary> Specifies the maximum number of documents to return. </summary>
      function Limit(AValue: Integer): TGeoNear;
      /// <summary> Specifies the minimum and maximum distances from the
      ///  center point that the documents can be. Specify -1 when one of
      ///  the limits should not be used. </summary>
      function Distance(AMin, AMax: Integer): TGeoNear;
      /// <summary> ADistField specifies the output field that contains the
      ///  calculated distance. ALocsField specifies the output field that
      ///  identifies the location used to calculate the distance. </summary>
      function Output(const ADistField: String; const ALocsField: String = ''): TGeoNear;
      /// <summary> Limits the results to the documents that match the query. </summary>
    ...
    public
      ...
      ///  * https://docs.mongodb.com/manual/reference/method/db.collection.aggregate/#perform-large-sort-operation-with-external-sort
      /// </summary>
  ...
  public
    ...
    /// <summary> Randomly selects the specified number of documents from its input.
    ///  For more details see:
    ...
    /// <summary> Returns reference to $geoNear stage builder, which outputs
    ///  documents in order of nearest to farthest from a specified point.
    ///  Optionally may be specified JSON string representing this stage.
    ///  For more details see:
    ///  * https://docs.mongodb.com/manual/reference/operator/aggregation/geoNear/
    /// </summary>
    function GeoNear(const AJSON: String = ''): TGeoNear;
    /// <summary> Performs a join to a collection to filter in documents from
    ///  the "joined" collection for processing. For more details see:
    ...
    /// <summary> Returns statistics regarding the use of each index for
    ///  the collection. For more details see:
    ///  * https://docs.mongodb.com/manual/reference/operator/aggregation/indexStats/
    /// </summary>
    function IndexStats(): TMongoPipeline;
    /// <summary> Returns reference to a generic stage builder identified by AName.
    ///  Optionally may be specified JSON string representing this stage. For
    ///  more details see:
  ...
  public type
    ...
    public
      ...
      ///  * https://docs.mongodb.com/manual/reference/operator/meta/comment/ </summary>
      ...
      ///  For more details see:
      ///  * https://docs.mongodb.com/manual/reference/operator/meta/hint/ </summary>
      property Hint: String read FHint write FHint;
      /// <summary> Limits the number of documents scanned.
      ///  For more details see:
      ///  * https://docs.mongodb.com/manual/reference/operator/meta/maxScan/ </summary>
      ...
      ///  For more details see:
      ///  * https://docs.mongodb.com/manual/reference/operator/meta/maxTimeMS/ </summary>
      property MaxTimeMS: Integer read FMaxTimeMS write FMaxTimeMS default 0;
      /// <summary> Forces the cursor to only return fields included in the index.
      ///  For more details see:
      ///  * https://docs.mongodb.com/manual/reference/operator/meta/returnKey/ </summary>
      ...
      ///  * https://docs.mongodb.com/manual/reference/method/cursor.batchSize/ </summary>
      property BatchSize: Integer read FBatchSize write FBatchSize default 0;
    end;
  ...
  protected
    ...
    /// </summary>
    constructor Create(AEnv: TMongoEnv; AOwningObj: TObject; const AGetCount: TGetCount); overload;
  ...
  protected
    constructor Create(AEnv: TMongoEnv; AOwningObj: TObject; const ARunUpdate: TRunUpdate); overload;
  ...
  private
    ...
    procedure ResetCounts(const AValue: Int64);
    procedure ProcessWriteResult(AReply: TMongoDocument; ABulk, AFailed: Boolean);
  ...
  TMongoClientLibExt = class(TMongoClientLib)
  protected
    procedure LoadEntries; override;

  public
    // mongoc-client-session.h
    Fmongoc_client_start_session: Tmongoc_client_start_session;
    Fmongoc_client_session_destroy: Tmongoc_client_session_destroy;
    Fmongoc_client_session_start_transaction: Tmongoc_client_session_start_transaction;
    Fmongoc_client_session_in_transaction: Tmongoc_client_session_in_transaction;
    Fmongoc_client_session_get_transaction_state: Tmongoc_client_session_get_transaction_state;
    Fmongoc_client_session_commit_transaction: Tmongoc_client_session_commit_transaction;
    Fmongoc_client_session_abort_transaction: Tmongoc_client_session_abort_transaction;
    Fmongoc_client_session_append: Tmongoc_client_session_append;
    Fmongoc_transaction_opts_new: Tmongoc_transaction_opts_new;
    Fmongoc_transaction_opts_clone: Tmongoc_transaction_opts_clone;
    Fmongoc_transaction_opts_destroy: Tmongoc_transaction_opts_destroy;
    Fmongoc_transaction_opts_set_max_commit_time_ms: Tmongoc_transaction_opts_set_max_commit_time_ms;
    Fmongoc_transaction_opts_get_max_commit_time_ms: Tmongoc_transaction_opts_get_max_commit_time_ms;
    Fmongoc_transaction_opts_set_read_concern: Tmongoc_transaction_opts_set_read_concern;
    Fmongoc_transaction_opts_get_read_concern: Tmongoc_transaction_opts_get_read_concern;
    Fmongoc_transaction_opts_set_write_concern: Tmongoc_transaction_opts_set_write_concern;
    Fmongoc_transaction_opts_get_write_concern: Tmongoc_transaction_opts_get_write_concern;
    Fmongoc_transaction_opts_set_read_prefs: Tmongoc_transaction_opts_set_read_prefs;
    Fmongoc_transaction_opts_get_read_prefs: Tmongoc_transaction_opts_get_read_prefs;

    Fmongoc_session_opts_new: Tmongoc_session_opts_new;
    Fmongoc_session_opts_clone: Tmongoc_session_opts_clone;
    Fmongoc_session_opts_destroy: Tmongoc_session_opts_destroy;
    Fmongoc_session_opts_set_causal_consistency: Tmongoc_session_opts_set_causal_consistency;
    Fmongoc_session_opts_get_causal_consistency: Tmongoc_session_opts_get_causal_consistency;
    Fmongoc_session_opts_set_default_transaction_opts: Tmongoc_session_opts_set_default_transaction_opts;
    Fmongoc_session_opts_get_default_transaction_opts: Tmongoc_session_opts_get_default_transaction_opts;
    Fmongoc_session_opts_get_transaction_opts: Tmongoc_session_opts_get_transaction_opts;

    // mongoc-error.h
    Fmongoc_error_has_label: Tmongoc_error_has_label;

    // mongoc-read-concern.h
    Fmongoc_read_concern_new: Tmongoc_read_concern_new;
    Fmongoc_read_concern_copy: Tmongoc_read_concern_copy;
    Fmongoc_read_concern_destroy: Tmongoc_read_concern_destroy;
    Fmongoc_read_concern_get_level: Tmongoc_read_concern_get_level;
    Fmongoc_read_concern_set_level: Tmongoc_read_concern_set_level;

    // mongoc-collection.h
    Fmongoc_collection_drop_with_opts: Tmongoc_collection_drop_with_opts;
    Fmongoc_collection_rename_with_opts: Tmongoc_collection_rename_with_opts;
    Fmongoc_collection_find_indexes_with_opts: Tmongoc_collection_find_indexes_with_opts;
    Fmongoc_collection_create_index_with_opts: Tmongoc_collection_create_index_with_opts;
    Fmongoc_collection_drop_index_with_opts: Tmongoc_collection_drop_index_with_opts;
    Fmongoc_collection_create_bulk_operation_with_opts: Tmongoc_collection_create_bulk_operation_with_opts;
    Fmongoc_collection_insert_one: Tmongoc_collection_insert_one;
    Fmongoc_collection_delete_one: Tmongoc_collection_delete_xxx;
    Fmongoc_collection_delete_many: Tmongoc_collection_delete_xxx;
    Fmongoc_collection_update_one: Tmongoc_collection_update_xxx;
    Fmongoc_collection_update_many: Tmongoc_collection_update_xxx;
    Fmongoc_collection_find_with_opts: Tmongoc_collection_find_with_opts;
  end;

  TMongoClientLibExt2 = class(TMongoClientLibExt)
  protected
    procedure LoadEntries; override;

  public
    Fmongoc_get_version: Tmongoc_get_version;
  end;

                                                                                             
  /// <summary> Incapsulates MongoDB mongoc_read_concern_t structure, representing
  ///  MongoDB API read concerns. All other MongoDB API wrapping classes provide
  ///  access to objects representing default read concerns.
  ///  More: https://docs.mongodb.com/manual/reference/read-concern/ </summary>
  TMongoReadConcern = class(TMongoObject)
  public type
    /// <summary> See http://api.mongodb.org/c/current/mongoc_read_concern_t.html. </summary>
    TReadLevel = (Default, Available, Local, Majority, Linearizable, Snapshot);
  private
    function GetLevel: TReadLevel;
    procedure SetLevel(const AValue: TReadLevel);
  protected
    /// <summary> Release handle of this read concern object. </summary>
    procedure InternalFreeHandle; override;
  public
    /// <summary> Creates new read concern object. </summary>
    constructor Create(AEnv: TMongoEnv; AOwningObj: TObject;
      AHandle: Pmongoc_read_concern_t = nil);
    /// <summary> Assigns settings of existing read concern object to this object. </summary>
    procedure Assign(ASource: TMongoReadConcern);
    /// <summary> Gets/sets current read concern level of this read concern object. </summary>
    property Level: TReadLevel read GetLevel write SetLevel default TReadLevel.Default;
  end;

                                                                                      
  TMongoQueryHelper = class helper for TMongoQuery
  private
    procedure SaveToOpts(AFlags: TMongoQueryFlags; AWriter: TMongoDocument);
  end;

                                                                                                
  TMongoConnectionHelper = class helper for TMongoConnection
  public
    function NewSession: TMongoSession;
  end;

                                                                                                                 
  /// <summary> Incapsulates MongoDB Pmongoc_transaction_opt_t structure, representing
  ///  MongoDB API transaction options.
  ///  More: https://docs.mongodb.com/manual/core/transactions/#read-concern-write-concern-read-preference </summary>
  TMongoTransactionOptions = class(TMongoObject)
  private
    FCommitTimeout: Cardinal;
    FReadPreference: TMongoReadPreference;
    FWriteConcern: TMongoWriteConcern;
    FReadConcern: TMongoReadConcern;
  protected
    procedure HandleAllocated; override;
    procedure InternalFreeHandle; override;
  public
    ...
    destructor Destroy; override;
    procedure Update;
    property CommitTimeout: Cardinal read FCommitTimeout write FCommitTimeout default 5000;
    property ReadPreference: TMongoReadPreference read FReadPreference;
    property WriteConcern: TMongoWriteConcern read FWriteConcern;
    property ReadConcern: TMongoReadConcern read FReadConcern;
  end;

  /// <summary> Incapsulates MongoDB mongoc_session_t structure. This class
  ///  represents a MongoDB session. A session allows to set the options and
  ///  control MongoDB transactions. A new session may be created by
  ///  TMongoConnection.NewSession method, and associated with a collection
  ///  using TMongoCollection.Session property.
  /// </summary>
  TMongoSession = class(TMongoObject)
  private
    FOptions: TMongoTransactionOptions;
    FCmdOpts: TMongoDocument;
    FClients: TList;
    function GetInTransaction: Boolean;
    function GetTransactionState: Cardinal;
    function GetCmdOptsHandle: Pbson_t;
    procedure Cleanup;
  protected
    constructor CreateUsingHandle(AEnv: TMongoEnv; AOwningObj: TObject; AHandle: Pmongoc_client_session_t);
    procedure HandleAllocated; override;
    procedure InternalFreeHandle; override;
    procedure AddClient(AClient: TMongoObject);
    procedure RemoveClient(AClient: TMongoObject);
  public
    destructor Destroy; override;
    // handle session and transactions
    procedure Append(ADocument: TMongoDocument);
    procedure StartTransaction;
    function CommitTransaction: Boolean;
    procedure AbortTransaction;
    // props
    property InTransaction: Boolean read GetInTransaction;
    property TransactionState: Cardinal read GetTransactionState;
    property Options: TMongoTransactionOptions read FOptions;
    property CmdOptsHandle: Pbson_t read GetCmdOptsHandle;
  end;

                                                                                                
  TMongoCollectionHelper = class helper for TMongoCollection
  private
    function GetSession: TMongoSession;
    procedure SetSession(const AValue: TMongoSession);
  public
    /// <summary> Associates this MongoDB collection with a session.
    /// </summary>
...
uses
  ...
  System.Variants, System.DateUtils, {System.Types,} Data.SqlTimSt, Data.FmtBcd,
  FireDAC.Stan.Consts;
...
const
  ...
  smongoc_get_version: String = 'mongoc_get_version';

  // mongoc-client-session.h
  smongoc_client_start_session: String = 'mongoc_client_start_session';
  smongoc_client_session_destroy: String = 'mongoc_client_session_destroy';
  smongoc_client_session_start_transaction: String = 'mongoc_client_session_start_transaction';
  smongoc_client_session_in_transaction: String = 'mongoc_client_session_in_transaction';
  smongoc_client_session_get_transaction_state: String = 'mongoc_client_session_get_transaction_state';
  smongoc_client_session_commit_transaction: String = 'mongoc_client_session_commit_transaction';
  smongoc_client_session_abort_transaction: String = 'mongoc_client_session_abort_transaction';
  smongoc_client_session_append: String = 'mongoc_client_session_append';
  smongoc_transaction_opts_new: String = 'mongoc_transaction_opts_new';
  smongoc_transaction_opts_clone: String = 'mongoc_transaction_opts_clone';
  smongoc_transaction_opts_destroy: String = 'mongoc_transaction_opts_destroy';
  smongoc_transaction_opts_set_max_commit_time_ms: String = 'mongoc_transaction_opts_set_max_commit_time_ms';
  smongoc_transaction_opts_get_max_commit_time_ms: String = 'mongoc_transaction_opts_get_max_commit_time_ms';
  smongoc_transaction_opts_set_read_concern: String = 'mongoc_transaction_opts_set_read_concern';
  smongoc_transaction_opts_get_read_concern: String = 'mongoc_transaction_opts_get_read_concern';
  smongoc_transaction_opts_set_write_concern: String = 'mongoc_transaction_opts_set_write_concern';
  smongoc_transaction_opts_get_write_concern: String = 'mongoc_transaction_opts_get_write_concern';
  smongoc_transaction_opts_set_read_prefs: String = 'mongoc_transaction_opts_set_read_prefs';
  smongoc_transaction_opts_get_read_prefs: String = 'mongoc_transaction_opts_get_read_prefs';

  smongoc_session_opts_new: String = 'mongoc_session_opts_new';
  smongoc_session_opts_clone: String = 'mongoc_session_opts_clone';
  smongoc_session_opts_destroy: String = 'mongoc_session_opts_destroy';
  smongoc_session_opts_set_causal_consistency: String = 'mongoc_session_opts_set_causal_consistency';
  smongoc_session_opts_get_causal_consistency: String = 'mongoc_session_opts_get_causal_consistency';
  smongoc_session_opts_set_default_transaction_opts: String = 'mongoc_session_opts_set_default_transaction_opts';
  smongoc_session_opts_get_default_transaction_opts: String = 'mongoc_session_opts_get_default_transaction_opts';
  smongoc_session_opts_get_transaction_opts: String = 'mongoc_session_opts_get_transaction_opts';

  // mongoc-error.h
  smongoc_error_has_label: String = 'mongoc_error_has_label';
  ...
  smongoc_collection_drop_with_opts: String = 'mongoc_collection_drop_with_opts';
  smongoc_collection_drop_index: String = 'mongoc_collection_drop_index';
  smongoc_collection_drop_index_with_opts: String = 'mongoc_collection_drop_index_with_opts';
  smongoc_collection_create_index: String = 'mongoc_collection_create_index';
  smongoc_collection_create_index_with_opts: String = 'mongoc_collection_create_index_with_opts';
  smongoc_collection_find_indexes: String = 'mongoc_collection_find_indexes';
  smongoc_collection_find_indexes_with_opts: String = 'mongoc_collection_find_indexes_with_opts';
  smongoc_collection_find: String = 'mongoc_collection_find';
  smongoc_collection_find_with_opts: String = 'mongoc_collection_find_with_opts';
  smongoc_collection_insert: String = 'mongoc_collection_insert';
  smongoc_collection_insert_one: String = 'mongoc_collection_insert_one';
  smongoc_collection_update: String = 'mongoc_collection_update';
  smongoc_collection_update_one: String = 'mongoc_collection_update_one';
  smongoc_collection_update_many: String = 'mongoc_collection_update_many';
  smongoc_collection_save: String = 'mongoc_collection_save';
  smongoc_collection_remove: String = 'mongoc_collection_remove';
  smongoc_collection_delete_one: String = 'mongoc_collection_delete_one';
  smongoc_collection_delete_many: String = 'mongoc_collection_delete_many';
  smongoc_collection_rename: String = 'mongoc_collection_rename';
  smongoc_collection_rename_with_opts: String = 'mongoc_collection_rename_with_opts';
  ...
  smongoc_collection_create_bulk_operation_with_opts: String = 'mongoc_collection_create_bulk_operation_with_opts';
  ...
  // mongoc-read-concern.h
  smongoc_read_concern_new: String = 'mongoc_read_concern_new';
  smongoc_read_concern_copy: String = 'mongoc_read_concern_copy';
  smongoc_read_concern_destroy: String = 'mongoc_read_concern_destroy';
  smongoc_read_concern_get_level: String = 'mongoc_read_concern_get_level';
  smongoc_read_concern_set_level: String = 'mongoc_read_concern_set_level';
...
const
  C_MongoDll1: String = 'libmongoc-1.0' + C_FD_DLLExt;
  C_MongoDll2: String = 'mongoc-1.0' + C_FD_DLLExt;
var
  sDLLName: String;
  aMongoDllNames: array of String;
begin
  sDLLName := AVendorHome;
  if sDLLName <> '' then
    sDLLName := FDNormPath(FDNormPath(sDLLName) + C_FD_DLLFolder);
  if AVendorLib <> '' then begin
    SetLength(aMongoDllNames, 1);
    aMongoDllNames[0] := sDLLName + AVendorLib;
  end
  else begin
    SetLength(aMongoDllNames, 2);
    aMongoDllNames[0] := sDLLName + C_MongoDll1;
    aMongoDllNames[1] := sDLLName + C_MongoDll2;
  end;
  inherited Load(aMongoDllNames, True);
end;
...
{-------------------------------------------------------------------------------}
procedure TMongoClientLibExt.LoadEntries;
begin
  inherited LoadEntries;

  // mongoc-client-session.h
  Fmongoc_client_start_session := GetProc(smongoc_client_start_session, False);
  if Assigned(Fmongoc_client_start_session) then begin
    Fmongoc_client_session_destroy := GetProc(smongoc_client_session_destroy);
    Fmongoc_client_session_start_transaction := GetProc(smongoc_client_session_start_transaction);
    Fmongoc_client_session_in_transaction := GetProc(smongoc_client_session_in_transaction);
    Fmongoc_client_session_get_transaction_state := GetProc(smongoc_client_session_get_transaction_state);
    Fmongoc_client_session_commit_transaction := GetProc(smongoc_client_session_commit_transaction);
    Fmongoc_client_session_abort_transaction := GetProc(smongoc_client_session_abort_transaction);
    Fmongoc_client_session_append := GetProc(smongoc_client_session_append);
    Fmongoc_transaction_opts_new := GetProc(smongoc_transaction_opts_new);
    Fmongoc_transaction_opts_clone := GetProc(smongoc_transaction_opts_clone);
    Fmongoc_transaction_opts_destroy := GetProc(smongoc_transaction_opts_destroy);
    Fmongoc_transaction_opts_set_max_commit_time_ms := GetProc(smongoc_transaction_opts_set_max_commit_time_ms);
    Fmongoc_transaction_opts_get_max_commit_time_ms := GetProc(smongoc_transaction_opts_get_max_commit_time_ms);
    Fmongoc_transaction_opts_set_read_concern := GetProc(smongoc_transaction_opts_set_read_concern);
    Fmongoc_transaction_opts_get_read_concern := GetProc(smongoc_transaction_opts_get_read_concern);
    Fmongoc_transaction_opts_set_write_concern := GetProc(smongoc_transaction_opts_set_write_concern);
    Fmongoc_transaction_opts_get_write_concern := GetProc(smongoc_transaction_opts_get_write_concern);
    Fmongoc_transaction_opts_set_read_prefs := GetProc(smongoc_transaction_opts_set_read_prefs);
    Fmongoc_transaction_opts_get_read_prefs := GetProc(smongoc_transaction_opts_get_read_prefs);

    Fmongoc_session_opts_new := GetProc(smongoc_session_opts_new);
    Fmongoc_session_opts_clone := GetProc(smongoc_session_opts_clone);
    Fmongoc_session_opts_destroy := GetProc(smongoc_session_opts_destroy);
    Fmongoc_session_opts_set_causal_consistency := GetProc(smongoc_session_opts_set_causal_consistency);
    Fmongoc_session_opts_get_causal_consistency := GetProc(smongoc_session_opts_get_causal_consistency);
    Fmongoc_session_opts_set_default_transaction_opts := GetProc(smongoc_session_opts_set_default_transaction_opts);
    Fmongoc_session_opts_get_default_transaction_opts := GetProc(smongoc_session_opts_get_default_transaction_opts);
    Fmongoc_session_opts_get_transaction_opts := GetProc(smongoc_session_opts_get_transaction_opts);

    // mongoc-error.h
    Fmongoc_error_has_label := GetProc(smongoc_error_has_label);

    // mongoc-collection.h
    Fmongoc_collection_drop_with_opts := GetProc(smongoc_collection_drop_with_opts);
    Fmongoc_collection_rename_with_opts := GetProc(smongoc_collection_rename_with_opts);
    Fmongoc_collection_find_indexes_with_opts := GetProc(smongoc_collection_find_indexes_with_opts);
    Fmongoc_collection_create_index_with_opts := GetProc(smongoc_collection_create_index_with_opts);
    Fmongoc_collection_drop_index_with_opts := GetProc(smongoc_collection_drop_index_with_opts);
    Fmongoc_collection_create_bulk_operation_with_opts := GetProc(smongoc_collection_create_bulk_operation_with_opts);
    Fmongoc_collection_insert_one := GetProc(smongoc_collection_insert_one);
    Fmongoc_collection_delete_one := GetProc(smongoc_collection_delete_one);
    Fmongoc_collection_delete_many := GetProc(smongoc_collection_delete_many);
    Fmongoc_collection_update_one := GetProc(smongoc_collection_update_one);
    Fmongoc_collection_update_many := GetProc(smongoc_collection_update_many);
    Fmongoc_collection_find_with_opts := GetProc(smongoc_collection_find_with_opts);

    // mongoc-read-concern.h
    Fmongoc_read_concern_new := GetProc(smongoc_read_concern_new);
    Fmongoc_read_concern_copy := GetProc(smongoc_read_concern_copy);
    Fmongoc_read_concern_destroy := GetProc(smongoc_read_concern_destroy);
    Fmongoc_read_concern_get_level := GetProc(smongoc_read_concern_get_level);
    Fmongoc_read_concern_set_level := GetProc(smongoc_read_concern_set_level);
  end;
end;

{-------------------------------------------------------------------------------}
procedure TMongoClientLibExt2.LoadEntries;
begin
  inherited LoadEntries;

  Fmongoc_get_version := GetProc(smongoc_get_version, False);
  if Assigned(Fmongoc_get_version) then begin
    FVersionStr := TFDEncoder.Deco(Fmongoc_get_version(), -1, ecANSI);
...
const
  C_BSONDll1: String = 'libbson';
  C_BSONDll2: String = 'bson';

  function GetBSONPath(const AName: string): string;
  var
    i: Integer;
  begin
    Result := ExtractFilePath(FCLib.DLLName) + AName;
    i := FCLib.DLLName.LastDelimiter('-');
    if i >= 0 then
      Result := Result + FCLib.DLLName.Substring(i)
    else
      Result := Result + C_FD_DLLExt;
  end;
...
//{$ENDIF}
begin
  inherited Load([GetBSONPath(C_BSONDll1), GetBSONPath(C_BSONDll2)], True);
...
begin
  ...
  FDoc := ADoc;
  ExtendedJsonMode := TJsonExtendedJsonMode.StrictMode;
  DateTimeZoneHandling := ADoc.Env.DateTimeZoneHandling;
end;
...
begin
  ...
  Result.DateTimeZoneHandling := AWriter.DateTimeZoneHandling;
end;
...
begin
  ...
  FReader.DateTimeZoneHandling := ADoc.Env.DateTimeZoneHandling;
...
begin
  ...
  FWriter.DateTimeZoneHandling := AEnv.DateTimeZoneHandling;
...
begin
  FBuilder.ExtendedJsonMode := ASource.FBuilder.ExtendedJsonMode;
  FBuilder.DateTimeZoneHandling := ASource.FBuilder.DateTimeZoneHandling;
  FBuilder
    .Clear
    .BeginObject
...
{ TMongoReadConcern                                                             }
{-------------------------------------------------------------------------------}
constructor TMongoReadConcern.Create(AEnv: TMongoEnv; AOwningObj: TObject;
  AHandle: Pmongoc_read_concern_t);

{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_read_concern_new, []);
  end;
{$ENDIF}
...
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
    FHandle := TMongoClientLibExt(CLib).Fmongoc_read_concern_new();
  end
  else begin
    FHandle := AHandle;
    FOwnHandle := False;
...
{-------------------------------------------------------------------------------}
procedure TMongoReadConcern.InternalFreeHandle;

{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_read_concern_destroy, ['read_concern', Handle]);
  end;
{$ENDIF}
...
{$IFDEF FireDAC_MONITOR}
  if Env.Tracing then Trace1;
{$ENDIF}
  TMongoClientLibExt(CLib).Fmongoc_read_concern_destroy(Handle);
end;

{-------------------------------------------------------------------------------}
procedure TMongoReadConcern.Assign(ASource: TMongoReadConcern);
begin
  Level := ASource.Level;
end;

{-------------------------------------------------------------------------------}
function TMongoReadConcern.GetLevel: TReadLevel;

{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_read_concern_get_level, ['read_concern', Handle]);
  end;
{$ENDIF}

var
  pLevel: PFDAnsiString;
  sLevel: string;
begin
{$IFDEF FireDAC_MONITOR}
  if Env.Tracing then Trace1;
{$ENDIF}
  pLevel := TMongoClientLibExt(CLib).Fmongoc_read_concern_get_level(Handle);
  sLevel := Env.ANSI.Decode(pLevel, -1);
  if SameText(sLevel, MONGOC_READ_CONCERN_LEVEL_AVAILABLE) then
    Result := TReadLevel.Available
  else if SameText(sLevel, MONGOC_READ_CONCERN_LEVEL_LOCAL) then
    Result := TReadLevel.Local
  else if SameText(sLevel, MONGOC_READ_CONCERN_LEVEL_MAJORITY) then
    Result := TReadLevel.Majority
  else if SameText(sLevel, MONGOC_READ_CONCERN_LEVEL_LINEARIZABLE) then
    Result := TReadLevel.Linearizable
  else if SameText(sLevel, MONGOC_READ_CONCERN_LEVEL_SNAPSHOT) then
    Result := TReadLevel.Snapshot
  else
    Result := TReadLevel.Default;
end;

{-------------------------------------------------------------------------------}
procedure TMongoReadConcern.SetLevel(const AValue: TReadLevel);
var
  pLevel: PFDAnsiString;
  sLevel: string;
...
{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_read_concern_set_level, ['read_concern', Handle, 'level', sLevel]);
  end;
{$ENDIF}
...
begin
  ...
  TReadLevel.Default:
    sLevel := '';
  TReadLevel.Available:
    sLevel := MONGOC_READ_CONCERN_LEVEL_AVAILABLE;
  TReadLevel.Local:
    sLevel := MONGOC_READ_CONCERN_LEVEL_LOCAL;
  TReadLevel.Majority:
    sLevel := MONGOC_READ_CONCERN_LEVEL_MAJORITY;
  TReadLevel.Linearizable:
    sLevel := MONGOC_READ_CONCERN_LEVEL_LINEARIZABLE;
  TReadLevel.Snapshot:
    sLevel := MONGOC_READ_CONCERN_LEVEL_SNAPSHOT;
  end;
  if sLevel = '' then
    pLevel := nil
  else
    pLevel := PFDAnsiString(Env.ANSI.Encode(sLevel));
{$IFDEF FireDAC_MONITOR}
  if Env.Tracing then Trace1;
{$ENDIF}
  TMongoClientLibExt(CLib).Fmongoc_read_concern_set_level(Handle, pLevel);
end;
...
{-------------------------------------------------------------------------------}
{ TMongoPipeline.TSample                                                        }
{-------------------------------------------------------------------------------}
class function TMongoPipeline.TSample.GetOperator: String;
begin
  Result := '$sample';
end;

{-------------------------------------------------------------------------------}
procedure TMongoPipeline.TSample.SetValue(const AValue: Integer);
begin
  FWriter.Clear;
  FWriter.Add('size', AValue);
end;
...
{-------------------------------------------------------------------------------}
{ TMongoPipeline.TLookup                                                        }
{-------------------------------------------------------------------------------}
class function TMongoPipeline.TLookup.GetOperator: String;
begin
  Result := '$lookup';
end;

{-------------------------------------------------------------------------------}
procedure TMongoPipeline.TLookup.Setup(const AFrom, ALocalField, AForeignField, AAs: String);
begin
  FWriter.Clear;
  FWriter.Add('from', AFrom);
  FWriter.Add('localField', ALocalField);
  FWriter.Add('foreignField', AForeignField);
  FWriter.Add('as', AAs);
end;
...
{-------------------------------------------------------------------------------}
{ TMongoPipeline.TIndexStats                                                    }
{-------------------------------------------------------------------------------}
class function TMongoPipeline.TIndexStats.GetOperator: String;
begin
  Result := '$indexStats';
end;

{-------------------------------------------------------------------------------}
procedure TMongoPipeline.TIndexStats.Setup;
begin
  FWriter.Clear;
end;
...
{-------------------------------------------------------------------------------}
{ TMongoPipeline.TGeoNear.TQuery                                                }
{-------------------------------------------------------------------------------}
function TMongoPipeline.TGeoNear.TQuery.&End: TGeoNear;
begin
  Result := FDoc.FParentObj as TGeoNear;
  Result.FWriter.BeginObject('query');
  Result.FWriter.Append(FDoc);
  Result.FWriter.EndObject;
end;

{-------------------------------------------------------------------------------}
{ TMongoPipeline.TGeoNear                                                       }
{-------------------------------------------------------------------------------}
destructor TMongoPipeline.TGeoNear.Destroy;
begin
  FDFreeAndNil(FQuery);
  inherited Destroy;
end;
...
{-------------------------------------------------------------------------------}
class function TMongoPipeline.TGeoNear.GetOperator: String;
begin
  Result := '$geoNear';
end;

{-------------------------------------------------------------------------------}
function TMongoPipeline.TGeoNear.Clear: TGeoNear;
begin
  FWriter.Clear;
  if FQuery <> nil then
    FQuery.Clear;
...
{-------------------------------------------------------------------------------}
function TMongoPipeline.TGeoNear.Append(const AJSON: String): TGeoNear;
begin
  FWriter.Append(AJSON);
  Result := Self;
end;
...
{-------------------------------------------------------------------------------}
function TMongoPipeline.TGeoNear.Near(ALatitude, ALongitude: Extended): TGeoNear;
begin
  FWriter.BeginObject('near');
  FWriter.Add('type', 'Point');
  FWriter.BeginArray('coordinates');
  FWriter.Add('0', ALatitude);
  FWriter.Add('1', ALongitude);
  FWriter.EndArray;
  FWriter.EndObject;
  Result := Self;
end;
...
{-------------------------------------------------------------------------------}
function TMongoPipeline.TGeoNear.Spherical(AValue: Boolean): TGeoNear;
begin
  FWriter.Add('spherical', AValue);
  Result := Self;
end;

{-------------------------------------------------------------------------------}
function TMongoPipeline.TGeoNear.Limit(AValue: Integer): TGeoNear;
begin
  FWriter.Add('limit', AValue);
  Result := Self;
end;

{-------------------------------------------------------------------------------}
function TMongoPipeline.TGeoNear.Distance(AMin, AMax: Integer): TGeoNear;
begin
  if AMin >= 0 then
    FWriter.Add('minDistance', AMin);
  if AMax >= 0 then
    FWriter.Add('maxDistance', AMax);
  Result := Self;
end;

{-------------------------------------------------------------------------------}
function TMongoPipeline.TGeoNear.Output(const ADistField, ALocsField: String): TGeoNear;
begin
  FWriter.Add('distanceField', ADistField);
  if ALocsField <> '' then
    FWriter.Add('includeLocs', ALocsField);
  Result := Self;
end;

{-------------------------------------------------------------------------------}
function TMongoPipeline.TGeoNear.Query(const AJSON: String): TQuery;
begin
  if FQuery = nil then
    FQuery := TQuery.Create(FPipeline.FEnv, FPipeline.FOwningObj, Self);
  Result := FQuery;
end;
...
constructor TMongoPipeline.Create(AEnv: TMongoEnv; AOwningObj: TObject;
  const AGetCursor: TMongoPipeline.TGetCursor);
begin
  Create(AEnv);
  FOwningObj := AOwningObj;
...
begin
  TSkip(GetOperation(TSkip, '', '')).SetValue(AValue);
  Result := Self;
end;
...
{-------------------------------------------------------------------------------}
function TMongoPipeline.Sample(const AValue: Integer): TMongoPipeline;
begin
  TSample(GetOperation(TSample, '', '')).SetValue(AValue);
  Result := Self;
end;
...
{-------------------------------------------------------------------------------}
function TMongoPipeline.GeoNear(const AJSON: String): TGeoNear;
begin
  Result := TGeoNear(GetOperation(TGeoNear, '', AJSON));
end;

{-------------------------------------------------------------------------------}
function TMongoPipeline.Lookup(const AFrom, ALocalField, AForeignField,
  AAs: String): TMongoPipeline;
begin
  TLookup(GetOperation(TLookup, '', '')).Setup(AFrom, ALocalField, AForeignField, AAs);
  Result := Self;
end;
...
{-------------------------------------------------------------------------------}
function TMongoPipeline.IndexStats(): TMongoPipeline;
begin
  TIndexStats(GetOperation(TIndexStats, '', '')).Setup;
  Result := Self;
end;

{-------------------------------------------------------------------------------}
function TMongoPipeline.Stage(const AName, AJSON: String): TExpression;
begin
  Result := TExpression(GetOperation(nil, AName, AJSON));
end;
...
{-------------------------------------------------------------------------------}
procedure TMongoQueryHelper.SaveToOpts(AFlags: TMongoQueryFlags; AWriter: TMongoDocument);
begin
  if TMongoQueryFlag.TailableCursors in AFlags then
    AWriter.Add('tailable', True);
  if TMongoQueryFlag.NoCursorTimeout in AFlags then
    AWriter.Add('noCursorTimeout', True);
  if TMongoQueryFlag.AwaitData in AFlags then
    AWriter.Add('awaitData', True);
  if TMongoQueryFlag.Exhaust in AFlags then
    AWriter.Add('exhaust', True);
  if TMongoQueryFlag.Partial in AFlags then
    AWriter.Add('allowPartialResults', True);

  if FSkip > 0 then
    AWriter.Add('skip', Int64(FSkip));
  if FLimit > 0 then
    AWriter.Add('limit', Int64(FLimit));
  if Options.BatchSize > 0 then
    AWriter.Add('limit', Int64(Options.BatchSize));

  if FOptions <> nil then begin
    if FOptions.Comment <> '' then
      AWriter.Add('comment', FOptions.Comment);
    if FOptions.Hint <> '' then
      AWriter.Append('{"hint":' + FOptions.Hint + '}');
    if FOptions.MaxTimeMS > 0 then
      AWriter.Add('maxTimeMS', FOptions.MaxTimeMS);
    if FOptions.ReturnKey then
      AWriter.Add('returnKey', True);
  end;

  if FProject <> nil then begin
    AWriter.BeginObject('projection');
    AWriter.Append(FProject.FWriter);
    AWriter.EndObject();
  end;

  if FSort <> nil then begin
    AWriter.BeginObject('sort');
    AWriter.Append(FSort.FWriter);
    AWriter.EndObject();
  end;
end;
...
{-------------------------------------------------------------------------------}
function TMongoIndex.TKeys.Field(const AName, AKind: String): TKeys;
begin
  FWriter.Add(AName, AKind);
  Result := Self;
end;
...
procedure TMongoConnection.SSLInit(const APEMFile, APEMPwd, ACAFile, ACADir,
  ACRLFile: String; AWeakValid, AInvHostsValid: Boolean);

{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_client_set_ssl_opts, ['pem_file', APEMFile, 'pem_pwd', APEMPwd,
      'ca_file', ACAFile, 'ca_dir', ACADir, 'crl_file', ACRLFile,
      'weak_cert_validation', AWeakValid, 'allow_invalid_hostname',
      PBoolean(NativeUInt(@Fmongoc_ssl_opt.weak_cert_validation) + SizeOf(Boolean))^]);
  end;
{$ENDIF}
...
{$ENDIF}
  ...
  Fmongoc_ssl_opt.allow_invalid_hostname := AInvHostsValid;
...
var
  oDoc: TMongoDocument;
begin
  oDoc := CommandSimple('test', '{"ping": 1}');
  FDFree(oDoc);
end;
...
function TMongoConnection_GetServerVersionStr(Self: TMongoConnection): String;
var
  oReply: TMongoDocument;
  oIter: TJSONIterator;
begin
  oReply := Self.CommandSimple('test', '{"buildInfo": 1}');
  oIter := oReply.Iterator;
  try
    if oIter.Next('version') then
      Result := oIter.AsString
    else
      Result := '';
  finally
    FDFree(oIter);
...
begin
  Result := FDVerStr2Int(TMongoConnection_GetServerVersionStr(Self));
end;
...
{-------------------------------------------------------------------------------}
function TMongoConnectionHelper.NewSession: TMongoSession;
var
  hSes: Pmongoc_client_session_t;
begin
  if not ((CLib is TMongoClientLibExt) and
          Assigned(TMongoClientLibExt(CLib).Fmongoc_client_start_session)) then
    FDCapabilityNotSupported(OwningObj, [S_FD_LPhys, Env.CLib.DriverID]);
                                      
  hSes := TMongoClientLibExt(CLib).Fmongoc_client_start_session(Handle, nil,
    @Env.Error.FBError);
  if hSes = nil then
    Env.Error.CheckError(OwningObj, smongoc_client_start_session);
  Result := TMongoSession.CreateUsingHandle(Env, OwningObj, hSes);
end;

{-------------------------------------------------------------------------------}
{ TMongoTransactionOptions                                                      }
{-------------------------------------------------------------------------------}
constructor TMongoTransactionOptions.Create(AEnv: TMongoEnv; AOwningObj: TObject);
begin
  inherited Create(AEnv, AOwningObj);
  FCommitTimeout := 5000;
  FReadPreference := TMongoReadPreference.Create(AEnv, AOwningObj, nil);
  FWriteConcern := TMongoWriteConcern.Create(AEnv, AOwningObj, nil);
  FReadConcern := TMongoReadConcern.Create(AEnv, AOwningObj, nil);
  FHandle := TMongoClientLibExt(CLib).Fmongoc_transaction_opts_new();
  HandleAllocated;
end;

{-------------------------------------------------------------------------------}
destructor TMongoTransactionOptions.Destroy;
begin
  inherited Destroy;
  FDFreeAndNil(FReadPreference);
  FDFreeAndNil(FWriteConcern);
  FDFreeAndNil(FReadConcern);
end;

{-------------------------------------------------------------------------------}
procedure TMongoTransactionOptions.HandleAllocated;
begin
  inherited HandleAllocated;
  Update;
end;
...
{-------------------------------------------------------------------------------}
procedure TMongoTransactionOptions.InternalFreeHandle;
begin
  TMongoClientLibExt(CLib).Fmongoc_transaction_opts_destroy(Handle);
end;

{-------------------------------------------------------------------------------}
procedure TMongoTransactionOptions.Update;
begin
  TMongoClientLibExt(CLib).Fmongoc_transaction_opts_set_read_prefs(Handle, FReadPreference.Handle);
  TMongoClientLibExt(CLib).Fmongoc_transaction_opts_set_write_concern(Handle, FWriteConcern.Handle);
  TMongoClientLibExt(CLib).Fmongoc_transaction_opts_set_read_concern(Handle, FReadConcern.Handle);
end;

{-------------------------------------------------------------------------------}
{ TMongoSession                                                                 }
{-------------------------------------------------------------------------------}
constructor TMongoSession.CreateUsingHandle(AEnv: TMongoEnv;
  AOwningObj: TObject; AHandle: Pmongoc_client_session_t);
begin
  inherited Create(AEnv, AOwningObj, AHandle);
  FClients := TList.Create;
  FOptions := TMongoTransactionOptions.Create(AEnv, AOwningObj);
  if Handle <> nil then
    HandleAllocated;
end;

{-------------------------------------------------------------------------------}
destructor TMongoSession.Destroy;
begin
...
{-------------------------------------------------------------------------------}
procedure TMongoSession.AddClient(AClient: TMongoObject);
begin
  if FClients.IndexOf(AClient) = -1 then
    FClients.Add(AClient);
end;

{-------------------------------------------------------------------------------}
procedure TMongoSession.Cleanup;
var
  i: Integer;
begin
  for i := FClients.Count - 1 downto 0 do
    if TMongoObject(FClients[i]) is TMongoCollection then
      TMongoCollection(FClients[i]).Session := nil;
end;

{-------------------------------------------------------------------------------}
{$HINTS OFF}
procedure TMongoSession.RemoveClient(AClient: TMongoObject);
begin
...
{-------------------------------------------------------------------------------}
procedure TMongoSession.Append(ADocument: TMongoDocument);
var
  oIter1,
  oIter2: TJSONIterator;
begin
  oIter1 := FCmdOpts.Iterator;
  oIter2 := ADocument.Iterator;
  try
    if oIter1.Find('sessionId') and not oIter2.Find('sessionId') then
      ADocument.Add('sessionId', oIter1.AsInt64);
  finally
    oIter1.Free;
    oIter2.Free;
  end;
...
{-------------------------------------------------------------------------------}
procedure TMongoSession.HandleAllocated;
begin
  inherited HandleAllocated;
  FCmdOpts := TMongoDocument.Create(Env);
  if not TMongoClientLibExt(CLib).Fmongoc_client_session_append(Handle,
      FCmdOpts.AsWriteHandle, @Env.Error.FBError) then
    Env.Error.CheckError(OwningObj, smongoc_client_session_append);
end;

{-------------------------------------------------------------------------------}
procedure TMongoSession.InternalFreeHandle;

{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_client_session_destroy, ['session', Handle]);
  end;
{$ENDIF}
...
{$IFDEF FireDAC_MONITOR}
  if Env.Tracing then Trace1;
{$ENDIF}
  TMongoClientLibExt(CLib).Fmongoc_client_session_destroy(Handle);
  FDFreeAndNil(FCmdOpts);
end;

{-------------------------------------------------------------------------------}
function TMongoSession.GetCmdOptsHandle: Pbson_t;
begin
  if FCmdOpts <> nil then
    Result := FCmdOpts.Handle
  else
    Result := nil;
end;

{-------------------------------------------------------------------------------}
function TMongoSession.GetInTransaction: Boolean;

{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_client_session_in_transaction, ['session', Handle]);
  end;
{$ENDIF}
...
{$IFDEF FireDAC_MONITOR}
  if Env.Tracing then Trace1;
{$ENDIF}
  Result := TMongoClientLibExt(CLib).Fmongoc_client_session_in_transaction(Handle);
end;

{-------------------------------------------------------------------------------}
function TMongoSession.GetTransactionState: Cardinal;

{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_client_session_get_transaction_state, ['session', Handle]);
  end;
{$ENDIF}
...
{$IFDEF FireDAC_MONITOR}
  if Env.Tracing then Trace1;
{$ENDIF}
  Result := TMongoClientLibExt(CLib).Fmongoc_client_session_get_transaction_state(Handle);
end;

{-------------------------------------------------------------------------------}
procedure TMongoSession.StartTransaction;

{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_client_session_start_transaction, ['session', Handle,
      'opts', FOptions.Handle]);
  end;
{$ENDIF}
...
{$ENDIF}
  FOptions.Update;
  if not TMongoClientLibExt(CLib).Fmongoc_client_session_start_transaction(Handle,
      FOptions.Handle, @Env.Error.FBError) then
    Env.Error.CheckError(OwningObj, smongoc_client_session_start_transaction);
end;

{-------------------------------------------------------------------------------}
function TMongoSession.CommitTransaction: Boolean;

{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_client_session_commit_transaction, ['session', Handle]);
  end;
{$ENDIF}
...
{$IFDEF FireDAC_MONITOR}
      if Env.Tracing then Trace1;
{$ENDIF}
      if TMongoClientLibExt(CLib).Fmongoc_client_session_commit_transaction(
          Handle, oReply.AsWriteHandle, @Env.Error.FBError) then
        Break;
      if TMongoClientLibExt(CLib).Fmongoc_error_has_label(oReply.AsReadHandle,
          PFDAnsiString(PByte(Env.ANSI.Encode('TransientTransactionError')))) then
                                                                 
        Exit(False);
      if TMongoClientLibExt(CLib).Fmongoc_error_has_label(oReply.AsReadHandle,
          PFDAnsiString(PByte(Env.ANSI.Encode('UnknownTransactionCommitResult')))) and
          not TThread.IsTimeout(iStart, Options.CommitTimeout) then
        Continue;
      Env.Error.CheckError(OwningObj, smongoc_client_session_commit_transaction);
    finally
      FDFree(oReply);
    end;
  end;
...
{-------------------------------------------------------------------------------}
procedure TMongoSession.AbortTransaction;

{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_client_session_abort_transaction, ['session', Handle]);
  end;
{$ENDIF}
...
{$IFDEF FireDAC_MONITOR}
  if Env.Tracing then Trace1;
{$ENDIF}
  if not TMongoClientLibExt(CLib).Fmongoc_client_session_abort_transaction(
      Handle, @Env.Error.FBError) then
    Env.Error.CheckError(OwningObj, smongoc_client_session_abort_transaction);
 end;
...
begin
  Result := Env.ANSI.Decode(Pointer(@P_mongoc_collection_t2(Handle)^.db[0]));
end;

{-------------------------------------------------------------------------------}
function TMongoCollection.GetNS: String;
begin
  Result := Env.ANSI.Decode(Pointer(@P_mongoc_collection_t2(Handle)^.ns[0]),
    P_mongoc_collection_t2(Handle)^.nslen);
end;
...
{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(sProc, ['collection', Handle]);
  end;
{$ENDIF}

begin
  if Session <> nil then begin
    sProc := smongoc_collection_drop_with_opts;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
    lRes := TMongoClientLibExt(CLib).Fmongoc_collection_drop_with_opts(Handle,
      Session.CmdOptsHandle, @Env.Error.FBError);
  end
  else begin
    sProc := smongoc_collection_drop;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
    lRes := CLib.Fmongoc_collection_drop(Handle, @Env.Error.FBError);
  end;
  if not lRes and
     ((Env.Error.FBError.code <> MONGOC_ERROR_QUERY_COMMAND_NOT_FOUND) or
      not AIgnoreObjNotExists) then
    Env.Error.CheckError(OwningObj, sProc);
end;
...
begin
  if Session <> nil then begin
    sProc := smongoc_collection_rename_with_opts;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
    lRes := TMongoClientLibExt(CLib).Fmongoc_collection_rename_with_opts(Handle,
      PFDAnsiString(PByte(Env.ANSI.Encode(ANewDB))),
      PFDAnsiString(PByte(Env.ANSI.Encode(ANewName))),
      ADropTarget, Session.CmdOptsHandle, @Env.Error.FBError)
  end
  else begin
    sProc := smongoc_collection_rename;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
    lRes := CLib.Fmongoc_collection_rename(Handle,
      PFDAnsiString(PByte(Env.ANSI.Encode(ANewDB))),
      PFDAnsiString(PByte(Env.ANSI.Encode(ANewName))),
      ADropTarget, @Env.Error.FBError)
  end;
  if not lRes then
    Env.Error.CheckError(OwningObj, sProc);
end;
...
begin
  if Session <> nil then begin
    sProc := smongoc_collection_find_indexes_with_opts;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
    hCrs := TMongoClientLibExt(CLib).Fmongoc_collection_find_indexes_with_opts(
      Handle, Session.CmdOptsHandle);
  end
  else begin
    sProc := smongoc_collection_find_indexes;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
...
begin
  if Session <> nil then begin
    sProc := smongoc_collection_create_index_with_opts;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
    lRes := TMongoClientLibExt(CLib).Fmongoc_collection_create_index_with_opts(Handle,
      AIndex.FKeys.FWriter.AsReadHandle, @AIndex.FOptions.FOpts,
      Session.CmdOptsHandle, nil, @Env.Error.FBError);
  end
  else begin
    sProc := smongoc_collection_create_index;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
    lRes := CLib.Fmongoc_collection_create_index(Handle,
      AIndex.FKeys.FWriter.AsReadHandle, @AIndex.FOptions.FOpts, @Env.Error.FBError);
  end;
  if not lRes then
    Env.Error.CheckError(OwningObj, sProc);
end;
...
{-------------------------------------------------------------------------------}
procedure TMongoCollection.DropIndex(const AName: String; AIgnoreObjNotExists: Boolean = False);
var
  lRes: Boolean;
  sProc: String;
...
{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(sProc, ['collection', Handle, 'index_name', AName]);
  end;
{$ENDIF}

begin
  if Session <> nil then begin
    sProc := smongoc_collection_drop_index_with_opts;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
    lRes := TMongoClientLibExt(CLib).Fmongoc_collection_drop_index_with_opts(
      Handle, PFDAnsiString(PByte(Env.ANSI.Encode(AName))), Session.CmdOptsHandle,
      @Env.Error.FBError);
  end
  else begin
    sProc := smongoc_collection_drop_index;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
    lRes := CLib.Fmongoc_collection_drop_index(Handle,
      PFDAnsiString(PByte(Env.ANSI.Encode(AName))), @Env.Error.FBError);
  end;
  try
    if not lRes then
...
{-------------------------------------------------------------------------------}
procedure TMongoCollection.ResetCounts(const AValue: Int64);
begin
  FDocsInserted := AValue;
  FDocsMatched := AValue;
  FDocsModified := AValue;
  FDocsRemoved := AValue;
  FDocsUpserted := AValue;
end;

{-------------------------------------------------------------------------------}
procedure TMongoCollection.ProcessWriteResult(AReply: TMongoDocument; ABulk, AFailed: Boolean);

  procedure ProcessErrors(AIter: TJSONIterator; AExc: EMongoNativeException; var AReset: Boolean);
  var
    iIndex: Integer;
    iCode: Integer;
    sMsg: string;
  begin
    AIter.Recurse;
    while AIter.Next do begin
      AIter.Recurse;
      iIndex := -1;
      iCode := -1;
      sMsg := '';
      if AIter.Next('index') then
        iIndex := AIter.AsInteger;
      if AIter.Next('code') then
        iCode := AIter.AsInteger;
      if AIter.Next('errmsg') then
        sMsg := AIter.AsString;
      if AReset then begin
        AExc.Clear;
        AReset := False;
      end;
      AExc.AppendError(AExc.ErrorCount + 1, iCode, 0, sMsg, iIndex);
      AIter.Return;
    end;
    AIter.Return;
  end;
...
begin
  ...
  try
    while oIter.Next do
      if (oIter.Key = 'nInserted') or (oIter.Key = 'insertedCount') then
        FDocsInserted := oIter.AsInteger
      else if (oIter.Key = 'nMatched') or (oIter.Key = 'matchedCount') then
        FDocsMatched := oIter.AsInteger
      else if (oIter.Key = 'nModified') or (oIter.Key = 'modifiedCount') then
        FDocsModified := oIter.AsInteger
      else if (oIter.Key = 'nRemoved') or (oIter.Key = 'deletedCount') then
        FDocsRemoved := oIter.AsInteger
      else if (oIter.Key = 'nUpserted') or (oIter.Key = 'upsertedCount') then
        FDocsUpserted := oIter.AsInteger
      else if (oIter.Key = 'writeErrors') or (oIter.Key = 'writeConcernError') then
        if ABulk and AFailed and
           (ExceptObject <> nil) and (ExceptObject is EMongoNativeException) then begin
          oExc := EMongoNativeException(ExceptObject);
          lReset := True;
          ProcessErrors(oIter, oExc, lReset);
          ProcessErrors(oIter, oExc, lReset);
        end;
  finally
    FDFree(oIter);
...
begin
  ...
  if FLastError.FHandleType <> TMongoDocument.THandleType.WriteExternal then
...
{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(sProc, ['collection', Handle, 'ordered', AOrdered]);
  end;
{$ENDIF}
...
begin
  ...
  ResetCounts(-1);
  if Session <> nil then begin
    sProc := smongoc_collection_create_bulk_operation_with_opts;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
    FBulkHandle := TMongoClientLibExt(CLib).Fmongoc_collection_create_bulk_operation_with_opts(
      Handle, Session.CmdOptsHandle);
  end
  else begin
    sProc := smongoc_collection_create_bulk_operation;
{$IFDEF FireDAC_MONITOR}
    if Env.Tracing then Trace1;
{$ENDIF}
...
{$ENDIF}
    ...
    ProcessWriteResult(oReply, True, lFailed);
    CancelBulk;
    FDFree(oReply);
  end;
end;
...
{$IFDEF FireDAC_MONITOR}
  ...
  procedure Trace2;
  begin
    Env.Trace(smongoc_collection_insert_one, ['collection', Handle, 'flags', iFlags,
      'noValidate', TInsertFlag.NoValidate in AFlags]);
  end;
...
{$ENDIF}
    ...
    try
      ...
      if Session <> nil then begin
        oOpts := TMongoDocument.Create(Env);
        try
          Session.Append(oOpts);
          if TInsertFlag.NoValidate in AFlags then
            oOpts.Add('validate', False);

{$IFDEF FireDAC_MONITOR}
          if Env.Tracing then Trace2;
{$ENDIF}
          if not TMongoClientLibExt(CLib).Fmongoc_collection_insert_one(Handle,
              ADocument.AsReadHandle, oOpts.AsReadHandle, LastError.AsWriteHandle,
              @Env.Error.FBError) then
            Env.Error.CheckError(OwningObj, smongoc_collection_insert_one);
        finally
          FDFree(oOpts);
        end;
      end
...
{$ENDIF}
      ...
      ProcessWriteResult(LastError, False, lFailed);
    end;
  end;
end;
...
{$IFDEF FireDAC_MONITOR}
  ...
  procedure Trace3;
  begin
    Env.Trace(smongoc_collection_delete_one, ['collection', Handle,
      'selector', ASelector.FinalMatchBSON.AsJSON]);
  end;

  procedure Trace4;
  begin
    Env.Trace(smongoc_collection_delete_many, ['collection', Handle,
      'selector', ASelector.FinalMatchBSON.AsJSON]);
  end;
...
{$IFDEF FireDAC_MONITOR}
              if Env.Tracing then Trace3;
{$ENDIF}
              if not TMongoClientLibExt(CLib).Fmongoc_collection_delete_one(Handle,
                  ASelector.FinalMatchBSON.AsReadHandle, oOpts.AsReadHandle, LastError.AsWriteHandle,
                  @Env.Error.FBError) then
                Env.Error.CheckError(OwningObj, smongoc_collection_delete_one);
            end
            else begin
{$IFDEF FireDAC_MONITOR}
              if Env.Tracing then Trace4;
{$ENDIF}
              if not TMongoClientLibExt(CLib).Fmongoc_collection_delete_many(Handle,
                  ASelector.FinalMatchBSON.AsReadHandle, oOpts.AsReadHandle, LastError.AsWriteHandle,
                  @Env.Error.FBError) then
                Env.Error.CheckError(OwningObj, smongoc_collection_delete_many);
            end;
          finally
            FDFree(oOpts);
          end;
...
{$IFDEF FireDAC_MONITOR}
  ...
  procedure Trace3;
  begin
    Env.Trace(smongoc_collection_update_many, ['collection', Handle,
      'selector', AUpdate.FinalMatchBSON.AsJSON,
      'document', AUpdate.FinalModifyBSON.AsJSON]);
  end;
  ...
  procedure Trace4;
  begin
    Env.Trace(smongoc_collection_update_one, ['collection', Handle,
      'selector', AUpdate.FinalMatchBSON.AsJSON,
      'document', AUpdate.FinalModifyBSON.AsJSON]);
  end;
      ...
      if Session <> nil then begin
        ...
        try
          ...
          if TUpdateFlag.Upsert in AFlags then
            oOpts.Add('upsert', True);
          if TUpdateFlag.MultiUpdate in AFlags then begin
{$IFDEF FireDAC_MONITOR}
            if Env.Tracing then Trace3;
{$ENDIF}
            if not TMongoClientLibExt(CLib).Fmongoc_collection_update_many(Handle,
                AUpdate.FinalMatchBSON.AsReadHandle, AUpdate.FinalModifyBSON.AsReadHandle,
                oOpts.AsReadHandle, LastError.AsWriteHandle, @Env.Error.FBError) then
              Env.Error.CheckError(OwningObj, smongoc_collection_update_many);
          end
          else begin
{$IFDEF FireDAC_MONITOR}
            if Env.Tracing then Trace4;
{$ENDIF}
            if not TMongoClientLibExt(CLib).Fmongoc_collection_update_one(Handle,
                AUpdate.FinalMatchBSON.AsReadHandle, AUpdate.FinalModifyBSON.AsReadHandle,
                oOpts.AsReadHandle, LastError.AsWriteHandle, @Env.Error.FBError) then
              Env.Error.CheckError(OwningObj, smongoc_collection_update_one);
          end;
        finally
          FDFree(oOpts);
        end;
...
begin
  ...
  try
    ...
    if Session <> nil then begin
      sProc := smongoc_collection_count_with_opts;
  {$IFDEF FireDAC_MONITOR}
      if Env.Tracing then Trace1;
  {$ENDIF}
      Result := CLib.Fmongoc_collection_count_with_opts(Handle, iFlags,
        AQuery.FinalCountBSON.AsReadHandle, AQuery.FSkip, AQuery.FLimit,
        Session.CmdOptsHandle, nil, @Env.Error.FBError);
    end

    else begin
      sProc := smongoc_collection_count;
  {$IFDEF FireDAC_MONITOR}
      if Env.Tracing then Trace1;
  {$ENDIF}
...
{$IFDEF FireDAC_MONITOR}
  if Env.Tracing then Trace1;
{$ENDIF}
  oOpts := APipeline.FinalOptionsBSON;
  lDestroy := oOpts = nil;
  if Session <> nil then begin
    if lDestroy then
      oOpts := TMongoDocument.Create(Env);
...
{$IFDEF FireDAC_MONITOR}
  procedure Trace1;
  begin
    Env.Trace(smongoc_collection_find_with_opts, ['collection', Handle,
      'filter', AQuery.FMatch.Doc.AsJSON, 'opts', oOpts.AsJSON]);
  end;
...
begin
  ...
  try
    if Session <> nil then begin
      ...
      try
        Session.Append(oOpts);
        AQuery.SaveToOpts(AFlags, oOpts);
{$IFDEF FireDAC_MONITOR}
      if Env.Tracing then Trace1;
{$ENDIF}
        hCrs := TMongoClientLibExt(CLib).Fmongoc_collection_find_with_opts(Handle,
          AQuery.FMatch.Doc.AsReadHandle, oOpts.AsReadHandle, nil);
        if hCrs = nil then
          Env.Error.CheckError(OwningObj, smongoc_collection_find_with_opts);
      finally
        FDFree(oOpts);
      end;
    end
...
{-------------------------------------------------------------------------------}
var
  FSessionDict: TDictionary<TMongoCollection, TMongoSession> = nil;

function TMongoCollectionHelper.GetSession: TMongoSession;
begin
  if FSessionDict = nil then
    Exit(nil);
  TMonitor.Enter(FSessionDict);
  try
    FSessionDict.TryGetValue(Self, Result);
  finally
    TMonitor.Exit(FSessionDict);
  end;
end;

{-------------------------------------------------------------------------------}
procedure TMongoCollectionHelper.SetSession(const AValue: TMongoSession);
begin
  if FSessionDict = nil then
    Exit;
  TMonitor.Enter(FSessionDict);
  try
    if Session <> AValue then begin
      if Session <> nil then begin
        Session.RemoveClient(Self);
        FSessionDict.Remove(Self);
      end;
      if AValue <> nil then begin
        FSessionDict.AddOrSetValue(Self, AValue);
        Session.AddClient(Self);
      end;
    end;
  finally
    TMonitor.Exit(FSessionDict);
...
initialization
  ...
  FSessionDict := TDictionary<TMongoCollection, TMongoSession>.Create;

finalization
  FDFreeAndNil(FSessionDict);
