...
const
  C_FDSQLiteEncrypt: array[TFDSQLiteEncrypt] of String = ('No', 'aes-128', 'aes-192', 'aes-256', 'aes-ctr-128', 'aes-ctr-192', 'aes-ctr-256', 'aes-ecb-128', 'aes-ecb-192', 'aes-ecb-256');
...
begin
  FDef.AsString[S_FD_ConnParam_SQLite_Encrypt] := C_FDSQLiteEncrypt[AValue];
end;
