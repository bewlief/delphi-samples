...
uses System.Classes, Data.DB, Vcl.ActnList;
...
begin
  LDataSet := GetDataSet(Target);
  Enabled := LDataSet.Active and not LDataSet.Eof;
end;
...
begin
  LDataSet := GetDataSet(Target);
  Enabled := LDataSet.Active and LDataSet.CanModify;
end;
...
begin
  LDataSet := GetDataSet(Target);
  Enabled := LDataSet.Active and LDataSet.CanModify and (LDataSet.State in dsEditModes);
end;
...
begin
  LDataSet := GetDataSet(Target);
  Enabled := LDataSet.Active and LDataSet.CanModify and not (LDataSet.State in dsEditModes);
end;
...
begin
  LDataSet := GetDataSet(Target);
  Enabled := LDataSet.Active and LDataSet.CanModify and not (LDataSet.Bof and LDataSet.Eof);
end;
