...
{ TSQLTimeStampData }
  ...
  private
    ...
    procedure SetFractions(const Value: Cardinal);
  ...
  published
    ...
    property Fractions: Cardinal read FDateTime.Fractions write SetFractions;
...
procedure TSQLTimeStampData.SetFractions(const Value: Cardinal);
begin
