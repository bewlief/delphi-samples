...
uses System.Classes, System.JSON, System.SysUtils, System.Generics.Collections,
...
type
  ...
  /// <summary>Regions which can be used with Amazon Services.
  /// For details see https://docs.aws.amazon.com/general/latest/gr/rande.html</summary>
  TAmazonRegion = string;
const
  amzrNotSpecified = '';
  amzrEUWest1 = 'eu-west-1';
  amzrEUWest2 = 'eu-west-2';
  amzrEUWest3 = 'eu-west-3';
  amzrEUCentral1 = 'eu-central-1';
  amzrUSEast1 = 'us-east-1';
  amzrUSEast2 = 'us-east-2';
  amzrUSWest1 = 'us-west-1';
  amzrUSWest2 = 'us-west-2';
  amzrAPEast1 = 'ap-east-1';
  amzrAPSouth1 = 'ap-south-1';
  amzrAPSoutheast1 = 'ap-southeast-1';
  amzrAPSoutheast2 = 'ap-southeast-2';
  amzrAPNortheast1 = 'ap-northeast-1';
  amzrAPNortheast2 = 'ap-northeast-2';
  amzrAPNortheast3 = 'ap-northeast-3';
  amzrCACentral1 = 'ca-central-1';
  amzrSAEast1 = 'sa-east-1';
  amzrUSClassic = 'us-east-1'; // deprecated
  amzrEU = 'eu-west-1'; // deprecated
  amzrCNNorth1 = 'cn-north-1';
  amzrCNNorthwest1 = 'cn-northwest-1';
  azmrEUNorth1 = 'eu-north-1';
  azmrMESouth1 = 'me-south-1';

type
  TAmazonStorageService = class;
  ...
  private
    ...
    FAutoDetectBucketRegion: Boolean;
    FBucketRegionDict: TDictionary<string, string>;

    function ResolveRegion(const ARegion: TAmazonRegion; AUseDefault: Boolean): TAmazonRegion;
    function GetServiceURL(const AHost: string): string; overload;
    function GetServiceURL(const AHost, ARegionHost: string; const ARegion: TAmazonRegion): string; overload;
    ...
    function GetVirtualHost(const AHost, ARegionHost: string; const ARegion: TAmazonRegion): string;
    function IsRegionStored: Boolean;
  public
    ...
    /// <param name="AStorage">The storage service to use to retrieve bucket region</param>
    ...
    function StorageVirtualHost(const ABucketName: string = ''; const ARegion: TAmazonRegion = amzrNotSpecified;
      const AStorage: TAmazonStorageService = nil): string;
    ...
    /// <summary>Removes bucket from regions cache.</summary>
    procedure BucketRemoved(const ABucketName: string);
  published
    ...
    /// <summary>The region to use to use when connecting with the S3 (Storage) service.</summary>
    property Region: TAmazonRegion read GetRegion write SetRegion stored IsRegionStored;
    /// <summary>True to auto detect bucket region when connecting with the S3 (Storage) service.</summary>
    property AutoDetectBucketRegion: Boolean read FAutoDetectBucketRegion write FAutoDetectBucketRegion default False;
    /// <summary>True to use the default service URLs, false to use endpoints from the endpoint properties.</summary>
  ...
  public
    ...
    /// <param name="AQueueURL">The URL of the queue to add the message to</param>
    /// <param name="AMessageText">The text of the message</param>
    /// <param name="AMessageGroupId">The message group ID</param>
    /// <param name="AMessageId">The Id of the message in the queue, or empty string if add failed.</param>
    /// <param name="AResponseInfo">The class for storing response info into</param>
    /// <returns>True if the message was added successfully, false otherwise.</returns>
    function SendMessage(const AQueueURL, AMessageText, AMessageGroupId: string;
      out AMessageId: string; const AResponseInfo: TCloudResponseInfo): Boolean; overload;
  ...
  public
    ...
    /// <summary>Properties to set onto the target object, if 'CopyMetadata' is False.</summary>
  ...
  TPreprocessBucketXMLProc = reference to procedure (AService: TAmazonStorageService;
    var AXML: string);
  ...
  private
    function InitHeaders(const BucketName: string; const BucketRegion: TAmazonRegion): TStringList;
    ...
    function GetBucketXMLInternal(const BucketName: string; OptionalParams: TStrings;
      VersionInfo: Boolean; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): string;
    ...
    function GetObjectInternal(const BucketName, ObjectName, VersionId: string;
      ...
      ObjectStream: TStream; const BucketRegion: TAmazonRegion): Boolean;
    function GetRegionFromEndpoint(const Endpoint: string): string;
    function BuildObjectURL(const BucketName, ObjectName: string; const ARegion: TAmazonRegion): string;
    function ValidateXMLResponse(const ResponseInfo: TCloudResponseInfo; const AHttp: TCloudHTTP;
      var ResultString: string; const AResetIfNotXML: Boolean = True): Boolean;
  protected
  ...
  public
    ...
    function GetBucketACL(const BucketName: string;
                          ResponseInfo: TCloudResponseInfo = nil;
                          const BucketRegion: TAmazonRegion = amzrNotSpecified): TList<TAmazonGrant>;
    ...
    function GetBucketLogging(const BucketName: string;
                              ResponseInfo: TCloudResponseInfo = nil;
                              const BucketRegion: TAmazonRegion = amzrNotSpecified): TAmazonBucketLoggingInfo;
    ...
    function ListMultipartUploads(const BucketName: string;
                                  const OptionalParams: TStrings;
                                  ResponseInfo: TCloudResponseInfo = nil;
                                  const BucketRegion: TAmazonRegion = amzrNotSpecified): TAmazonMultipartUploadsResult;
    ...
    function SetObjectMetadata(const BucketName, ObjectName: string; Metadata: TStrings;
                               ResponseInfo: TCloudResponseInfo = nil;
                               const BucketRegion: TAmazonRegion = amzrNotSpecified): Boolean;
    /// <summary>Sets the properties and metadata on the given object.</summary>
    /// <remarks>This performs a copy object, with the source and destination the same.
    ///          Any previous metadata on the object will be lost.
    /// </remarks>
    /// <param name="BucketName">The name of the bucket the object is in.</param>
    /// <param name="ObjectName">The object to set the metadata for</param>
    /// <param name="Properties">The properties to set on the object</param>
    /// <param name="Metadata">The metadata to set on the object</param>
    /// <param name="ResponseInfo">The optional class for storing response info into</param>
    /// <param name="BucketRegion">The region of the bucket</param>
    /// <returns>True if successful, false otherwise.</returns>
    function SetObjectProperties(const BucketName, ObjectName: string; Properties, Metadata: TStrings;
                                 ResponseInfo: TCloudResponseInfo = nil;
                                 const BucketRegion: TAmazonRegion = amzrNotSpecified): Boolean;
    ...
    function ListMultipartUploadParts(const BucketName, ObjectName, UploadId: string;
                                      MaxParts: Integer = 0; PartNumberMarker: Integer = 0;
                                      ResponseInfo: TCloudResponseInfo = nil;
                                      const BucketRegion: TAmazonRegion = amzrNotSpecified): TAmazonListPartsResult;
  ...
  TAmazonStorageServiceHelper = class helper for TAmazonStorageService
  private
    class var FOnPreprocessBucketXML: TPreprocessBucketXMLProc;
  public
    class property OnPreprocessBucketXML: TPreprocessBucketXMLProc
      read FOnPreprocessBucketXML write FOnPreprocessBucketXML;
  end;
...
begin
  ...
  // metadata header name with 'x-amz-meta-' if it wasn't already.
...
begin
  ...
  FBucketRegionDict := TDictionary<string, string>.Create;
end;

destructor TAmazonConnectionInfo.Destroy;
begin
  FreeAndNil(FBucketRegionDict);
  inherited Destroy;
end;
...
begin
  FRegion := AValue;
//  if not SameText(AValue, DefaultRegion) then
//    UseDefaultEndpoints := False;
end;
...
class function TAmazonConnectionInfo.GetRegionString(const Region: TAmazonRegion): string;
begin
  Result := Region;
end;

function TAmazonConnectionInfo.ResolveRegion(const ARegion: TAmazonRegion; AUseDefault: Boolean): TAmazonRegion;
begin
  Result := ARegion;
  if UseDefaultEndpoints and AUseDefault then
  begin
    if SameText(Result, amzrNotSpecified) then
      Result := Region;
    if SameText(Result, amzrNotSpecified) then
      Result := DefaultRegion;
  end;
...
function TAmazonConnectionInfo.GetVirtualHost(const AHost, ARegionHost: string;
  const ARegion: TAmazonRegion): string;
var
  LRegion: TAmazonRegion;
begin
  LRegion := ResolveRegion(ARegion, True);
  if not SameText(LRegion, amzrNotSpecified) then
    Result := Format(ARegionHost, [LRegion])
  else
    Result := AHost;
end;

function TAmazonConnectionInfo.IsRegionStored: Boolean;
begin
  Result := not SameText(Region, DefaultRegion);
end;
...
function TAmazonConnectionInfo.GetServiceURL(const AHost, ARegionHost: string; const ARegion: TAmazonRegion): string;
begin
...
var
  LRegion: TAmazonRegion;
begin
  LRegion := ResolveRegion(amzrNotSpecified, True);
  Result := GetServiceURL(QueueEndpoint, RegionQueueEndpoint, LRegion);
end;

function TAmazonConnectionInfo.GetTableURL: string;
var
  LRegion: TAmazonRegion;
  LRegionEndpoint: string;
begin
  LRegion := ResolveRegion(amzrNotSpecified, True);
  if SameText(LRegion, amzrUSEast1) then
    LRegionEndpoint := TableEndpoint
  else
    LRegionEndpoint := RegionTableEndpoint;
  Result := GetServiceURL(TableEndpoint, LRegionEndpoint, amzrNotSpecified);
end;

function TAmazonConnectionInfo.StorageVirtualHost(const ABucketName: string;
  const ARegion: TAmazonRegion; const AStorage: TAmazonStorageService): string;
var
  LRegion: TAmazonRegion;
begin
  LRegion := ResolveRegion(ARegion, not AutoDetectBucketRegion);
  if SameText(LRegion, amzrNotSpecified) and AutoDetectBucketRegion then
  begin
    TMonitor.Enter(FBucketRegionDict);
    try
      if not FBucketRegionDict.TryGetValue(ABucketName, LRegion) then
      begin
        if Assigned(AStorage) then
          LRegion := AStorage.GetBucketLocation(ABucketName);
        if not SameText(LRegion, amzrNotSpecified) then
          FBucketRegionDict.Add(ABucketName, LRegion);
      end;
    finally
      TMonitor.Exit(FBucketRegionDict);
    end;
  end;
  Result := GetVirtualHost(StorageEndpoint, RegionStorageEndpoint, LRegion);
  if ABucketName <> EmptyStr then
    Result := Format('%s.%s', [ABucketName, Result]);
end;

function TAmazonConnectionInfo.StorageURL(const ABucketName: string; const ARegion: TAmazonRegion;
  const AStorage: TAmazonStorageService): string;
begin
  Result := GetServiceURL(StorageVirtualHost(ABucketName, ARegion, AStorage));
end;

procedure TAmazonConnectionInfo.BucketRemoved(const ABucketName: string);
begin
  TMonitor.Enter(FBucketRegionDict);
  try
    FBucketRegionDict.Remove(ABucketName);
  finally
    TMonitor.Exit(FBucketRegionDict);
  end;
end;
...
begin
  ...
  try
    ...
    if not Result or xml.IsEmpty then
      Exit;
...
function TAmazonQueueService.SendMessage(const AQueueURL, AMessageText: string; out AMessageId: string;
  const AResponseInfo: TCloudResponseInfo): Boolean;
begin
  Result := SendMessage(AQueueURL, AMessageText, '', AMessageId, AResponseInfo);
end;

function TAmazonQueueService.SendMessage(const AQueueURL, AMessageText, AMessageGroupId: string;
  out AMessageId: string; const AResponseInfo: TCloudResponseInfo): Boolean;
var
  LResponse: TCloudHTTP;
  LQueryParams: TStringList;
  LXML: string;
...
begin
  ...
  try
    ...
    if not AMessageGroupId.IsEmpty then
      LQueryParams.Values['MessageGroupId'] := AMessageGroupId;

    LResponse := IssueRequest(AQueueURL, LQueryParams, AResponseInfo, LXML);
    Result := (LResponse <> nil) and (LResponse.ResponseCode = 200);

    //parse the XML to get the MessageId
    if not Result or LXML.IsEmpty then
      Exit;
...
begin
  ...
  try
    ...
    //parse the XML to get the MessageId
    if not LResult or LXML.IsEmpty then
      Exit;
...
function TAmazonBasicService.IssueRequest(const URL: string; QueryParams: TStringList; ResponseInfo: TCloudResponseInfo;
  ...
  begin
    ...
    begin
      ...
      for I := 0 to Properties.Count - 1 do
        Headers.Values[Properties.Names[I]] := Properties.ValueFromIndex[I];
    end;
...
function TAmazonStorageService.BuildObjectURL(const BucketName, ObjectName: string;
  const ARegion: TAmazonRegion): string;
begin
  Result := GetConnectionInfo.StorageURL(BucketName, ARegion, Self) + '/' +
    TNetEncoding.URL.Encode(ObjectName, [Ord('#'), Ord('+')], []);
end;
...
begin
  ...
  try
    ...
    // Keep unsafe characters here in sync with BuildObjectURL
    CanRequest := CanRequest + TNetEncoding.URL.EncodePath(URLrec.Path,
      [Ord('"'), Ord(''''), Ord(':'), Ord(';'), Ord('<'), Ord('='), Ord('>'),
      Ord('@'), Ord('['), Ord(']'), Ord('^'), Ord('`'), Ord('{'), Ord('}'),
      Ord('|'), Ord('/'), Ord('\'), Ord('?'), Ord('#'), Ord('&'), Ord('!'),
      Ord('$'), Ord('('), Ord(')'), Ord(','), Ord('+')]) + #10;
...
begin
  ...
  begin
    ...
    begin
      ...
      LStartIdx := 0;
      repeat
        i1 := Pos('s3.', EndPoint, i);
        if i1 = 0 then
          i1 := Pos('s3-', EndPoint, i);
        if (i1 = 1) or (i1 > 1) and (EndPoint[i1 - 1] = '.') then
        begin
          LStartIdx := i1 + 2;
          i := i1 + 1;
        end
...
class function TAmazonStorageService.GetRegionString(const Region: TAmazonRegion): string;
begin
  Result := Region;
end;
...
begin
  Result := GetConnectionInfo.StorageVirtualHost('', ARegion, Self);
end;
...
function TAmazonStorageService.InitHeaders(const BucketName: string; const BucketRegion: TAmazonRegion): TStringList;
begin
  Result := TStringList.Create;
  Result.CaseSensitive := false;
  Result.Duplicates := TDuplicates.dupIgnore;
  Result.Values['host'] := GetConnectionInfo.StorageVirtualHost(BucketName, BucketRegion, Self);
...
function TAmazonStorageService.ValidateXMLResponse(const ResponseInfo: TCloudResponseInfo;
                                                   const AHttp: TCloudHTTP;
                                                   var ResultString: string;
                                                   const AResetIfNotXML: Boolean): Boolean;
var
  i: Integer;
begin
  Result := True;
  if SameText(AHttp.Response.HeaderValue[sContentType], 'application/xml') then
    Exit;
  i := Pos('<?xml', ResultString) - 1;
  while (i > 0) and (ResultString[i] = ' ') do
    Dec(i);
  if i = 0 then
    Exit;
  Result := False;
  if AResetIfNotXML then
    ResultString := '';
end;
...
begin
  ...
  url := GetConnectionInfo.StorageURL(BucketName, BucketRegion, Self) + '/';
  virtualhost := GetConnectionInfo.StorageVirtualHost(BucketName, BucketRegion, Self);
...
var
  ...
  Response: TCloudHTTP;
begin
  url := GetConnectionInfo.StorageURL('', TAmazonConnectionInfo.DefaultRegion, Self);
  ...
  try
    ...
    ValidateXMLResponse(ResponseInfo, Response, Result);
...
begin
  ...
  try
    ...
    if Result then
      GetConnectionInfo.BucketRemoved(BucketName);
  finally
    Response.Free;
    Headers.Free;
  end;
...
var
  ...
  RespStr: string;
begin
  url := GetConnectionInfo.StorageURL(BucketName, BucketRegion, Self) + '/?policy=';
  Headers := InitHeaders(BucketName, BucketRegion);
...
function TAmazonStorageService.GetBucketXML(const BucketName: string; OptionalParams: TStrings;
                                            ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): string;
begin
...
begin
  ...
  try
    ...
    if Assigned(OnPreprocessBucketXML) then
      OnPreprocessBucketXML(Self, Result);
    ValidateXMLResponse(ResponseInfo, Response, Result);
    ParseResponseError(ResponseInfo, Result);
  finally
    Response.Free;
...
var
  ...
  Response: TCloudHTTP;
begin
  url := GetConnectionInfo.StorageURL(BucketName, BucketRegion, Self) + '/?acl=';
  Headers := InitHeaders(BucketName, BucketRegion);
...
function TAmazonStorageService.GetBucketACL(const BucketName: string;
  ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): TList<TAmazonGrant>;
var
  xml: string;
  xmlDoc: IXMLDocument;
...
begin
  ...
  try
    Response := IssueGetRequest(url, Headers, nil, QueryPrefix, ResponseInfo, Result);
    if ValidateXMLResponse(ResponseInfo, Response, Result, False) then
      ParseResponseError(ResponseInfo, Result);
  finally
    Response.Free;
    Headers.Free;
...
function TAmazonStorageService.GetBucketPolicy(const BucketName: string;
  ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): TJSONObject;
var
  jsonString: string;
begin
  Result := nil;
...
begin
  ...
  if ((ResponseInfo <> nil) and (ResponseInfo.StatusCode <> 200)) or xml.IsEmpty then
    Exit;
...
var
  ...
  Response: TCloudHTTP;
begin
  url := GetConnectionInfo.StorageURL(BucketName, BucketRegion, Self) + '/?logging=';
...
function TAmazonStorageService.GetBucketLogging(const BucketName: string;
  ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): TAmazonBucketLoggingInfo;
var
  xml: string;
  xmlDoc: IXMLDocument;
  RootNode, ItemNode, Aux: IXMLNode;
...
begin
  ...
  Headers := nil;
  try
    url := GetConnectionInfo.StorageURL(BucketName, BucketRegion, Self) + '/?notification=';
    Headers := InitHeaders(BucketName, BucketRegion);
...
function TAmazonStorageService.GetBucketNotification(const BucketName: string;
  ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): TList<TAmazonNotificationEvent>;
var
  xml: string;
  xmlDoc: IXMLDocument;
...
function TAmazonStorageService.GetBucketObjectVersionsXML(const BucketName: string;
  OptionalParams: TStrings; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): string;
begin
...
function TAmazonStorageService.GetBucketObjectVersions(const BucketName: string;
  OptionalParams: TStrings; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): TAmazonBucketResult;
var
  xml: string;
begin
...
var
  ...
  Response: TCloudHTTP;
begin
  url := GetConnectionInfo.StorageURL(BucketName, BucketRegion, Self) + '/?requestPayment=';
  Headers := InitHeaders(BucketName, BucketRegion);
...
function TAmazonStorageService.GetRequestPayment(const BucketName: string;
  ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): TAmazonPayer;
var
  xml: string;
  xmlDoc: IXMLDocument;
...
var
  ...
  Response: TCloudHTTP;
begin
  url := GetConnectionInfo.StorageURL(BucketName, BucketRegion, Self) + '/?versioning=';
  Headers := InitHeaders(BucketName, BucketRegion);
...
function TAmazonStorageService.GetBucketLifecycleXML(const ABucketName: string;
  AResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): string;
var
  LUrl: string;
...
begin
  ...
  LHeaders := nil;
  try
    LUrl := GetConnectionInfo.StorageURL(ABucketName, BucketRegion, Self) + '/?lifecycle=';
    LHeaders := InitHeaders(ABucketName, BucketRegion);
    LResponse := IssueGetRequest(LUrl, LHeaders, nil, '', AResponseInfo, Result);
    ValidateXMLResponse(AResponseInfo, LResponse, Result);
...
function TAmazonStorageService.ListMultipartUploadsXML(const BucketName: string;
  const OptionalParams: TStrings; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): string;
var
  url: string;
  Headers: TStringList;
  QueryParams: TStringList;
...
function TAmazonStorageService.ListMultipartUploads(const BucketName: string;
  ...
  const BucketRegion: TAmazonRegion): TAmazonMultipartUploadsResult;
var
  xml: string;
  xmlDoc: IXMLDocument;
...
function TAmazonStorageService.SetBucketPolicy(const BucketName: string;
  Policy: TJSONObject; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): Boolean;
var
  policyString: string;
  url: string;
  Headers: TStringList;
...
function TAmazonStorageService.SetBucketRequestPayment(const BucketName: string;
  Payer: TAmazonPayer; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): Boolean;
var
  sb: TStringBuilder;
  xml: string;
  url: string;
...
begin
  ...
  LContentStream := nil;
  try
    LUrl := GetConnectionInfo.StorageURL(BucketName, BucketRegion, Self) + '/?lifecycle=';
    LXml := LifeCycle.XML;
...
function TAmazonStorageService.GetObject(const BucketName, ObjectName: string;
  ObjectStream: TStream; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): Boolean;
begin
...
function TAmazonStorageService.GetObjectMetadata(const BucketName, ObjectName: string;
  OptionalParams: TAmazonGetObjectOptionals; ResponseInfo: TCloudResponseInfo;
  const BucketRegion: TAmazonRegion): TStrings;
var
  Properties: TStrings;
begin
...
function TAmazonStorageService.GetObjectMetadata(const BucketName, ObjectName: string;
  ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): TStrings;
begin
...
function TAmazonStorageService.UploadObject(const BucketName, ObjectName: string;
  ...
  ACL: TAmazonACLType; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): Boolean;
var
  url: string;
  LHeaders: TStringList;
  QueryPrefix: string;
...
function TAmazonStorageService.SetObjectMetadata(const BucketName, ObjectName: string;
  Metadata: TStrings; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): Boolean;
var
...
function TAmazonStorageService.SetObjectProperties(const BucketName, ObjectName: string;
  Properties, Metadata: TStrings; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): Boolean;
var
  Optionals: TAmazonCopyObjectOptionals;
begin
  Optionals := TAmazonCopyObjectOptionals.Create;
  try
    Optionals.FCopyMetadata := False;
    Optionals.FMetadata.AddStrings(Metadata);
    Optionals.FProperties.AddStrings(Properties);
...
begin
  ...
  if SourceVersionId <> EmptyStr then
    Headers.Values['x-amz-copy-source'] := Format('/%s/%s?versionId=%s',
      [LSourceBucketName, TNetEncoding.URL.EncodeForm(SourceObjectName), SourceVersionId])
  else
    Headers.Values['x-amz-copy-source'] := Format('/%s/%s',
      [LSourceBucketName, TNetEncoding.URL.EncodeForm(SourceObjectName)]);
...
function TAmazonStorageService.InitiateMultipartUploadXML(const BucketName, ObjectName: string;
  ...
  const BucketRegion: TAmazonRegion): string;
var
  url: string;
  LHeaders: TStringList;
  QueryPrefix: string;
...
function TAmazonStorageService.UploadPart(const BucketName, ObjectName, UploadId: string;
  ...
  const ContentMD5: string; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): Boolean;
var
  url: string;
  Headers: TStringList;
  QueryPrefix: string;
...
function TAmazonStorageService.CompleteMultipartUpload(const BucketName, ObjectName, UploadId: string;
  Parts: TList<TAmazonMultipartPart>; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): Boolean;
var
  xml: string;
  url: string;
  Headers: TStringList;
...
function TAmazonStorageService.ListMultipartUploadPartsXML(const BucketName, ObjectName, UploadId: string;
  MaxParts, PartNumberMarker: Integer; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): string;
var
  url: string;
  Headers: TStringList;
  QueryPrefix: string;
...
function TAmazonStorageService.ListMultipartUploadParts(const BucketName, ObjectName, UploadId: string;
  MaxParts, PartNumberMarker: Integer; ResponseInfo: TCloudResponseInfo; const BucketRegion: TAmazonRegion): TAmazonListPartsResult;
var
  xml: string;
  xmlDoc: IXMLDocument;
