...
uses Data.DBXClientResStrs, Data.DBXCommon, System.StrUtils, System.Generics.Collections, System.SysUtils
{$IFDEF MACOS}
...
//    TDSProxyParamAccess.Create('System::UnicodeString', 'GetString', 'SetString'));
...
begin
  ...
  if CustomTypeMap.TryGetValue(Pair, Item) and not IsKnownDBXValueTypeName(Param.TypeName) then
