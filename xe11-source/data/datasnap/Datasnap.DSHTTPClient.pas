...
type
  ...
  private
    ...
    function GetOnSelectClientCertificate: TNeedClientCertificateEvent;
    procedure SetOnSelectClientCertificate(const Value: TNeedClientCertificateEvent);
...
begin
  ...
  begin
    ...
    if not MyCredential.IsEmpty then
    begin
...
function TDSHTTP.GetSecureProtocols: THTTPSecureProtocols;
begin
...
procedure TDSHTTP.SetSecureProtocols(const Value: THTTPSecureProtocols);
begin
  FHTTPClient.SecureProtocols := Value;
end;

function TDSHTTP.GetOnSelectClientCertificate: TNeedClientCertificateEvent;
begin
  Result := FHTTPClient.OnNeedClientCertificate;
end;

procedure TDSHTTP.SetOnSelectClientCertificate(const Value: TNeedClientCertificateEvent);
begin
