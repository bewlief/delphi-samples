...
type
  ...
  /// <summary>Server methods that can be called in DSAdmin.</summary>
  ...
  /// <summary>Columns used by the TDSClassEntity collection.</summary>
  ...
  /// <summary>Columns used by TDSConnectionEntity collection.</summary>
  ...
  /// <summary>Property values used by TDSCustomServerClass.LifeCycle
  /// property.</summary>
  TDSLifeCycle = class
  public
  ...
  /// <summary>Method names used in the DSMetadata server class.</summary>
  ...
  /// <summary>Columns used by the TDSMethodEntity collection.</summary>
  ...
  public
    ...
    /// <summary> <c>DbxSubDataType</c> subtype that used for this parameter type.
    /// </summary>
    const DbxSubDataType = 'DBXSubType';
  ...
  /// <summary>Columns used by the TDSPackageEntity collection.</summary>
