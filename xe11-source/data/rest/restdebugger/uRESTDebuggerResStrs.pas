...
resourcestring
  ...
  RSUnableToValidateCertifcate = 'Unable to validate "%s" certificate of this website.  Continue with this request?';
  RSSelectClientCertificate = 'Select client certificate requested by this website.';
