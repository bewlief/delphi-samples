...
uses
  System.Rtti, System.Net.HttpClient,
  REST.JSON.Types,
...
begin
  ...
  try
    ...
    LClient.ConnectTimeout := FRESTClient.ConnectTimeout;
    LClient.ReadTimeout := FRESTClient.ReadTimeout;
    LRequest.URLAlreadyEncoded := true;
...
class operator TKinveyApi.TConnectionInfo.Initialize(out Dest: TConnectionInfo);
begin
  Dest.ProxyPort := 0;
