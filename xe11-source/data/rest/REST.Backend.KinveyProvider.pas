...
function TCustomKinveyConnectionInfo.GetConnectTimeout: Integer;
begin
...
function TCustomKinveyConnectionInfo.GetReadTimeout: Integer;
begin
...
procedure TCustomKinveyConnectionInfo.SetConnectTimeout(const Value: Integer);
begin
...
procedure TCustomKinveyConnectionInfo.SetReadTimeout(const Value: Integer);
begin
