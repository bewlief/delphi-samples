...
(*$HPPEMIT'  {' *)
(*$HPPEMIT'  public:' *)
(*$HPPEMIT'    virtual HRESULT __stdcall AS_ApplyUpdates(BSTR ProviderName, VARIANT Delta, int MaxErrors, int* ErrorCount, VARIANT* OwnerData, VARIANT* AS_ApplyUpdates_result) = 0 ;' *)
(*$HPPEMIT'    virtual HRESULT __stdcall AS_GetRecords(BSTR ProviderName, int Count, int* RecsOut, int Options, BSTR CommandText, VARIANT* Params, VARIANT* OwnerData, VARIANT* AS_GetRecords_result) = 0 ;' *)
...
(*$HPPEMIT'    virtual HRESULT __stdcall AS_RowRequest(BSTR ProviderName, VARIANT Row, int RequestType, VARIANT* OwnerData, VARIANT* AS_RowRequest_result) = 0 ;' *)
