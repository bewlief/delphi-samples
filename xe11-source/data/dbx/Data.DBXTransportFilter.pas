...
type
  ...
  /// <summary>Implements a TCP communication where you can insert filters to
  /// process (compress, encrypt) the byte flow.</summary>
...
begin
  ...
  // Break ARC cycle, which is result of Chanel calls
