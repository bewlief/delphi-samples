  ...
  if Value = nil then
    ...
    case DataType of
      ...
      TDBXDataTypes.UInt16Type:
        Result := TJSONNumber.Create(Value.AsInt32);
...
{$IFNDEF NEXTGEN}
      TDBXDataTypes.AnsiStringType:
        Value.SetAnsiString(AnsiString(TJSONObject(Data).ToJSON));
{$ELSE}
      TDBXDataTypes.AnsiStringType,
{$ENDIF !NEXTGEN}
      TDBXDataTypes.WideStringType:
        Value.SetWideString(TJSONObject(Data).ToJSON);
      else
        raise TDBXError.Create(0, Format(SNoConversionToDBX, [Data.ToString,TDBXValueType.DataTypeName(DataType)]));
    end
...
{$IFNDEF NEXTGEN}
      TDBXDataTypes.AnsiStringType:
        Value.SetAnsiString(AnsiString(TJSONArray(Data).ToJSON));
{$ELSE}
      TDBXDataTypes.AnsiStringType,
{$ENDIF !NEXTGEN}
      TDBXDataTypes.WideStringType:
        Value.SetWideString(TJSONArray(Data).ToJSON);
      TDBXDataTypes.BlobType,
      TDBXDataTypes.BinaryBlobType:
        begin
