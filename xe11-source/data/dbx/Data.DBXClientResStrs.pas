...
resourcestring
  ...
  SNotInputParameter    = 'Server''s method %0:s %1:d parameter in not an input parameter. Either call with less parameters or change the method definition.';
  ...
  STooManyInputParams   = 'Server method %0:s consumed only %1:d input parameters out of %2:d. Either call with more parameters or change method definition.';
  ...
  SCertInvalidFile = 'Invalid certificate File.';
