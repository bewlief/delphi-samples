...
type
  ...
  DBXTraceCallback = function(Handle: DBXCallbackHandle; TraceCategory: Longint;
  ...
  TDBXCommon_GetErrorMessageLength = function(Handle: TDBXCommonHandle;
    LastErrorCode: TDBXErrorCode; out ErrorLen: Longint): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  ...
  TDBXRow_GetFixedBytes = function(Handle: TDBXRowHandle; Ordinal: Longint;
    const Value: array of Byte; ValueOffset: Longint;
    out IsNull: LongBool): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXRow_GetByteLength = function(Handle: TDBXRowHandle; Ordinal: Longint;
    out Length: Int64; out IsNull: LongBool): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXRow_GetObjectTypeName = function(Handle: TDBXRowHandle; Ordinal: Longint;
  ...
  TDBXWritableRow_SetNull = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetString = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; const Value: TDBXAnsiString; Length: Int64): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetWideString = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; const Value: TDBXWideString; Length: Int64): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetBoolean = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; Value: LongBool): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetUInt8 = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; Value: Byte): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetInt8 = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; Value: ShortInt): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetInt16 = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; Value: SmallInt): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetInt32 = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; Value: LongInt): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetInt64 = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; Value: Int64): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetSingle = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; Value: single): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetDouble = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; Value: double): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetBcd = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; Value: TBcd): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetTimeStamp = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; var Value: TSQLTimeStamp): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetTimeStampOffset = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; var Value: TSQLTimeStampOffset): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetTime = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; Value: TDBXTime): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetDate = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; Value: TDBXDate): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXWritableRow_SetBytes = function(Handle: TDBXWritableRowHandle;
    Ordinal: Longint; BlobOffset: Int64; Value: TArray<Byte>; LastIndex: Longint; { dummy to simulate native "open array" }
    ValueOffset: Int64; Length: Int64): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}

  TDBXLoader_GetDriver = function(Count: Longint; Names: TWideStringArray;
  ...
  TDBXDriver_GetVersion = function(
    ...
    MaxLength: Longint): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXConnection_Connect = function(Handle: TDBXConnectionHandle; Count: Longint;
  ...
  TDBXConnection_BeginTransaction = function(Handle: TDBXConnectionHandle;
    out TransactionHandle: TDBXTransactionHandle; IsolationLevel: Longint)
    : TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  ...
  TDBXConnection_GetIsolation = function(Handle: TDBXConnectionHandle;
    out IsolationLevel: Longint): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  ...
  TDBXCommand_Prepare = function(Handle: TDBXCommandHandle;
    const SQL: TDBXWideString; Count: Longint): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  ...
  TDBXCommand_GetParameterCount = function(Handle: TDBXCommandHandle;
    out ParameterCount: Longint): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXCommand_GetParameterType = function(Handle: TDBXCommandHandle;
    Ordinal: Longint; out DBXType: Longint; out DBXSubType: Longint; out Size: Int64;
    out Precision: Int64; out Scale: Longint; out Nullable: LongBool)
    : TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXParameterRow_SetParameterType = function(Handle: TDBXRowHandle;
    Ordinal: Longint; const Name: TDBXWideString; ChildPosition: Longint;
    ParamDirection: TDBXParameterDirection; DBXType: Longint; DBXSubType: Longint;
    Size: Int64; Precision: Int64; Scale: Longint): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXReader_GetColumnCount = function(Handle: TDBXReaderHandle;
    out ColumnCount: Longint): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
  TDBXReader_GetColumnMetadata = function(Handle: TDBXReaderHandle;
    ...
    out Scale: Longint; out flags: Longint): TDBXErrorCode; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
...
{$ENDIF MACOS}
  begin
{$IF not ((DEFINED(CPUARM) and DEFINED(IOS)) or DEFINED(ANDROID))}
    LoadDriverLibrary(Properties, DBXContext);
{$ENDIF not ((CPUARM and IOS) or ANDROID)}
...
function NativeDBXCallback(Handle: DBXCallbackHandle;
 TraceCategory: Longint; TraceMessage: TDBXWideString): CBRType; {$IFDEF POSIX} cdecl; {$ELSE} stdcall; {$ENDIF}
begin
...
begin
  ...
  if DBXError = TDBXErrorCodes.NotSupported then
    IsolationLevel := Longint(TDBXIsolations.DirtyRead)
  else
...
var
  Ordinal, ParameterCount, DataType, SubType, Scale: Longint;
...
var
  Ordinal, Length, ColumnType, ColumnSubType, Precision, Scale, Flags,
  ColumnCount, MaxIdentifier: Longint;
...
var
  ...
  LValue: Longint;
begin
  DBXResult := FMethodTable.FDBXRow_GetInt32(FRowHandle, DbxValue.ValueType.Ordinal, LValue, IsNull);
  Value := TInt32(LValue);
  if DBXResult <> TDBXErrorCodes.None then
    FMethodTable.RaiseError(FDbxContext, DBXResult, FRowHandle);
end;
