...
const
  ...
  VariantSize: array[0..varInt64] of Word  = (0, 0, SizeOf(SmallInt), SizeOf(Integer),
    ...
    SizeOf(Word), SizeOf(LongWord), SizeOf(Int64));
...
begin
  ...
  if VType and varArray <> 0 then
    ...
    case (VType and varTypeMask) of
      ...
      varOleStr:
      begin
        ByteArray := TEncoding.Unicode.GetBytes(String(Value));
...
begin
  ...
  begin
    ...
    TMemoryStream(Stream).SetSize(Int64(Size+8+Stream.Position));
    Stream.Write(Size, 8);
