      ...
      TDBXDataTypes.BcdType:
        begin
          ...
          ErrorCode := SQLBindParameter(FCommandHandle, I+1, GetOdbcParameterDirection(FParameters[I].ParameterDirection),
                                        ...
                                        SQLPOINTER(@FParameterRow.FBlock.Buffer[FParameterRow.FOffsets[I]]),
                                        Size,
                                        PSqlLen(@FParameterRow.FBlock.Buffer[FParameterRow.FOffsets[I]+Int64(Size)]));
        end;
      TDBXDataTypes.BytesType, TDBXDataTypes.VarBytesType:
        begin
          if (FParameters[I].ParameterDirection = TDBXParameterDirections.InParameter) or
...
begin
  ...
  begin
    ...
    PSQLTimeStamp(@Value[0])^.Fractions := PSQLTimeStamp(@Value[0])^.Fractions div 1000000;
  end
  else
    IsNull := True;
end;
...
begin
  ...
  begin
    ...
    PSQLTimeStampOffset(@Value[0])^.Fractions := PSQLTimeStampOffset(@Value[0])^.Fractions div 1000000;
  end
  else
    IsNull := True;
end;
