...
function TDBXFirebirdCustomMetaDataReader.GetSqlIdentifierQuotePrefix: string;
begin
  Result := FQuoteChar;
end;

function TDBXFirebirdCustomMetaDataReader.GetSqlIdentifierQuoteSuffix: string;
begin
  Result := FQuoteChar;
end;

function TDBXFirebirdCustomMetaDataReader.GetSqlIdentifierQuoteChar: string;
begin
  Result := FQuoteChar;
end;
...
function TDBXFirebirdCustomMetaDataReader.FetchColumns(const Catalog: string; const Schema: string; const Table: string): TDBXTable;
var
...
function TDBXFirebirdCustomMetaDataReader.FetchProcedureParameters(const Catalog: string; const Schema: string; const Proc: string; const Parameter: string): TDBXTable;
var
  ParameterNames: TDBXStringArray;
  ParameterValues: TDBXStringArray;
  Cursor: TDBXTable;
...
function TDBXFirebirdMetaDataReader.GetProductName: string;
begin
  Result := 'Firebird';
end;
...
function TDBXFirebirdMetaDataReader.FetchSchemas(const CatalogName: string): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXFirebirdMetaDataReader.GetSqlForTables: string;
begin
...
function TDBXFirebirdMetaDataReader.GetSqlForViews: string;
begin
...
function TDBXFirebirdMetaDataReader.GetSqlForColumns: string;
begin
...
function TDBXFirebirdMetaDataReader.FetchColumnConstraints(const CatalogName: string; const SchemaName: string; const TableName: string): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXFirebirdMetaDataReader.GetSqlForIndexes: string;
begin
...
function TDBXFirebirdMetaDataReader.GetSqlForIndexColumns: string;
begin
...
function TDBXFirebirdMetaDataReader.GetSqlForForeignKeys: string;
begin
...
function TDBXFirebirdMetaDataReader.GetSqlForForeignKeyColumns: string;
begin
...
function TDBXFirebirdMetaDataReader.FetchSynonyms(const CatalogName: string; const SchemaName: string; const SynonymName: string): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXFirebirdMetaDataReader.GetSqlForProcedures: string;
begin
...
function TDBXFirebirdMetaDataReader.GetSqlForProcedureSources: string;
begin
...
function TDBXFirebirdMetaDataReader.GetSqlForProcedureParameters: string;
begin
...
function TDBXFirebirdMetaDataReader.FetchPackages(const CatalogName: string; const SchemaName: string; const PackageName: string): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXFirebirdMetaDataReader.FetchPackageProcedures(const CatalogName: string; const SchemaName: string; const PackageName: string; const ProcedureName: string; const ProcedureType: string): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXFirebirdMetaDataReader.FetchPackageProcedureParameters(const CatalogName: string; const SchemaName: string; const PackageName: string; const ProcedureName: string; const ParameterName: string): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXFirebirdMetaDataReader.FetchPackageSources(const CatalogName: string; const SchemaName: string; const PackageName: string): TDBXTable;
var
  Columns: TDBXValueTypeArray;
begin
...
function TDBXFirebirdMetaDataReader.GetSqlForUsers: string;
begin
  Result := 'SELECT DISTINCT RDB$USER FROM RDB$USER_PRIVILEGES ORDER BY 1';
end;

function TDBXFirebirdMetaDataReader.GetSqlForRoles: string;
begin
...
constructor TDBXFirebirdTypeFilterCursor.Create(const Provider: TDBXFirebirdCustomMetaDataReader; const MetadataCollectionName: string; const Columns: TDBXValueTypeArray; const Cursor: TDBXTable; const OrdinalTypeName: Integer; const OrdinalFieldType: Integer; const OrdinalSubType: Integer; const OrdinalScale: Integer; const OrdinalDefaultValue: Integer);
begin
...
function TDBXFirebirdTypeFilterCursor.ComputeTypeName: string;
var
  SubType: SmallInt;
begin
...
function TDBXFirebirdTypeFilterCursor.ComputeDefaultValue: string;
var
  DefaultValue: string;
begin
