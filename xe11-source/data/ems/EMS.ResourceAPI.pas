...
uses
  ...
  System.JSON.Writers, System.JSON.Readers, System.Net.Mime;
...
function TEMSBaseResource.GetParamValue(AContext: TEndpointContext;
  const AName: string; AIndex: Integer): string;
var
  LFound: Boolean;
...
finalization
  TEMSEndpointEnvironment.FInstance.DisposeOf;
  TEMSEndpointManager.FInstance.DisposeOf;
  TEMSEndpointAuthorization.FInstance.DisposeOf;
