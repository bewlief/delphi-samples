...
uses EMSHosting.Helpers, System.JSON.Builders,
    System.Generics.Defaults, System.Generics.Collections, System.Variants;
  ...
  for LEMSResource in LEMSEndpointManager.Resources do
    ...
    begin
      ...
      if LAddDefinitions then
        ...
        else if LEMSTypeInfoResource.JSONDefinitions <> '' then
        begin
...
begin
  ...
  try
    ...
    AResponse.Body.SetStream(TStringStream.Create(LAPIDoc.GetAPIDocYaml, TEncoding.UTF8),
