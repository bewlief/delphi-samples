...
type
  ...
  protected
    ...
    function GetContentFields: TStringKeyValues; override;
    ...
    function GetFile(AIndex: Integer; out AFieldName, AFileName, AContentType: string;
      out AStream: TStream): Boolean; override;
  public
...
function TEdgeReaderHostRequest.GetClientHost: string;
begin
  Result := FEdgeRequest.ClientHost;
end;
...
begin
  ...
  if SameText(AName, TEMSHostRequestProps.THeaderNames.TenantId) then
    Result := FEdgeRequest.TenantId;
end;
...
function TEdgeReaderHostRequest.GetContentFields: TStringKeyValues;
begin
  Result := nil;
end;
...
function TEdgeReaderHostRequest.GetFile(AIndex: Integer; out AFieldName,
