...
type
  TEMSHostMethodType = (Get, Put, Post, Head, Delete, Patch);
  ...
  IEMSHostRequest = interface
    ...
    property ContentFields: TStringKeyValues read GetContentFields;
  ...
  protected
    ...
    function GetContentFields: TStringKeyValues; virtual; abstract;
    ...
    function GetFile(AIndex: Integer; out AFieldName, AFileName, AContentType: string;
      out AStream: TStream): Boolean; virtual; abstract;
  end;
